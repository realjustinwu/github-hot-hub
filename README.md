...
1. [x1xhlol / system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools)
    ...
    - language: **无** &nbsp;&nbsp; stars: **82,477** &nbsp;&nbsp; folks: **22,942**  &nbsp;&nbsp; `619 stars today`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **66,290** &nbsp;&nbsp; folks: **5,629**  &nbsp;&nbsp; `430 stars today`
...
1. [juspay / hyperswitch](https://github.com/juspay/hyperswitch)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **32,314** &nbsp;&nbsp; folks: **4,150**  &nbsp;&nbsp; `834 stars today`
...
1. [immich-app / immich](https://github.com/immich-app/immich)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **76,083** &nbsp;&nbsp; folks: **4,025**  &nbsp;&nbsp; `519 stars today`

1. [HKUDS / AutoAgent](https://github.com/HKUDS/AutoAgent)
    - "AutoAgent: Fully-Automated and Zero-Code LLM Agent Framework"
    - language: **Python** &nbsp;&nbsp; stars: **6,182** &nbsp;&nbsp; folks: **848**  &nbsp;&nbsp; `59 stars today`
...
1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,228** &nbsp;&nbsp; folks: **679**  &nbsp;&nbsp; `2,846 stars this week`

1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **44,947** &nbsp;&nbsp; folks: **3,269**  &nbsp;&nbsp; `4,651 stars this week`

1. [LukeGus / Termix](https://github.com/LukeGus/Termix)
    - Termix is a web-based server management platform with SSH terminal, tunneling, and file editing capabilities.
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,343** &nbsp;&nbsp; folks: **128**  &nbsp;&nbsp; `1,487 stars this week`
...
1. [aquasecurity / trivy](https://github.com/aquasecurity/trivy)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **28,793** &nbsp;&nbsp; folks: **2,745**  &nbsp;&nbsp; `662 stars this week`

1. [trufflesecurity / trufflehog](https://github.com/trufflesecurity/trufflehog)
    - Find, verify, and analyze leaked credentials
    - language: **Go** &nbsp;&nbsp; stars: **21,317** &nbsp;&nbsp; folks: **2,010**  &nbsp;&nbsp; `866 stars this week`

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **11,139** &nbsp;&nbsp; folks: **887**  &nbsp;&nbsp; `2,730 stars this week`
...
1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **66,290** &nbsp;&nbsp; folks: **5,629**  &nbsp;&nbsp; `1,145 stars this week`
...
1. [kestra-io / kestra](https://github.com/kestra-io/kestra)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **21,023** &nbsp;&nbsp; folks: **1,793**  &nbsp;&nbsp; `534 stars this week`
...
1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,589** &nbsp;&nbsp; folks: **3,108**  &nbsp;&nbsp; `11,330 stars this month`
...
1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **9,063** &nbsp;&nbsp; folks: **274**  &nbsp;&nbsp; `5,685 stars this month`

1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Open-source platform to build and deploy AI agent workflows.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,549** &nbsp;&nbsp; folks: **1,793**  &nbsp;&nbsp; `7,496 stars this month`
...
1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **44,947** &nbsp;&nbsp; folks: **3,269**  &nbsp;&nbsp; `8,142 stars this month`
...
1. [dtyq / magic](https://github.com/dtyq/magic)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **4,060** &nbsp;&nbsp; folks: **404**  &nbsp;&nbsp; `2,642 stars this month`
