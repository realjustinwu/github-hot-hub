...
`更新时间：2025-07-19 16:32:38 +0800`

## 今日热门仓库

1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    - Python tool for converting files and office documents to Markdown.
    - language: **Python** &nbsp;&nbsp; stars: **68,116** &nbsp;&nbsp; folks: **3,604**  &nbsp;&nbsp; `1,382 stars today`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **5,117** &nbsp;&nbsp; folks: **726**  &nbsp;&nbsp; `322 stars today`
...
1. [hyprwm / Hyprland](https://github.com/hyprwm/Hyprland)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **27,249** &nbsp;&nbsp; folks: **1,154**  &nbsp;&nbsp; `62 stars today`

1. [gitleaks / gitleaks](https://github.com/gitleaks/gitleaks)
    - Find secrets with Gitleaks 🔑
    - language: **Go** &nbsp;&nbsp; stars: **22,053** &nbsp;&nbsp; folks: **1,703**  &nbsp;&nbsp; `328 stars today`

1. [soxoj / maigret](https://github.com/soxoj/maigret)
    - 🕵️‍♂️ Collect a dossier on a person by username from thousands of sites
    - language: **Python** &nbsp;&nbsp; stars: **16,577** &nbsp;&nbsp; folks: **1,129**  &nbsp;&nbsp; `524 stars today`
...
1. [arc53 / DocsGPT](https://github.com/arc53/DocsGPT)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,498** &nbsp;&nbsp; folks: **1,723**  &nbsp;&nbsp; `35 stars today`
...
1. [influxdata / telegraf](https://github.com/influxdata/telegraf)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **15,861** &nbsp;&nbsp; folks: **5,669**  &nbsp;&nbsp; `7 stars today`

1. [PromtEngineer / localGPT](https://github.com/PromtEngineer/localGPT)
    - Chat with your documents on your local device using GPT models. No data leaves your device and 100% private.
    - language: **Python** &nbsp;&nbsp; stars: **21,616** &nbsp;&nbsp; folks: **2,376**  &nbsp;&nbsp; `250 stars today`

1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    - Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.
    - language: **TypeScript** &nbsp;&nbsp; stars: **120,599** &nbsp;&nbsp; folks: **36,283**  &nbsp;&nbsp; `710 stars today`

1. [remoteintech / remote-jobs](https://github.com/remoteintech/remote-jobs)
    - A list of semi to fully remote-friendly companies (jobs) in tech.
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,375** &nbsp;&nbsp; folks: **3,380**  &nbsp;&nbsp; `68 stars today`
...
1. [pydantic / pydantic-ai](https://github.com/pydantic/pydantic-ai)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,067** &nbsp;&nbsp; folks: **1,049**  &nbsp;&nbsp; `52 stars today`

1. [strapi / strapi](https://github.com/strapi/strapi)
    - 🚀 Strapi is the leading open-source headless CMS. It’s 100% JavaScript/TypeScript, fully customizable, and developer-first.
    - language: **TypeScript** &nbsp;&nbsp; stars: **68,292** &nbsp;&nbsp; folks: **8,757**  &nbsp;&nbsp; `260 stars today`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    - Python tool for converting files and office documents to Markdown.
    - language: **Python** &nbsp;&nbsp; stars: **68,116** &nbsp;&nbsp; folks: **3,604**  &nbsp;&nbsp; `7,369 stars this week`

1. [gorhill / uBlock](https://github.com/gorhill/uBlock)
    - uBlock Origin - An efficient blocker for Chromium and Firefox. Fast and lean.
    - language: **JavaScript** &nbsp;&nbsp; stars: **56,386** &nbsp;&nbsp; folks: **3,595**  &nbsp;&nbsp; `1,317 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **24,511** &nbsp;&nbsp; folks: **1,335**  &nbsp;&nbsp; `5,616 stars this week`
...
1. [Alibaba-NLP / WebAgent](https://github.com/Alibaba-NLP/WebAgent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,617** &nbsp;&nbsp; folks: **346**  &nbsp;&nbsp; `1,061 stars this week`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **43,204** &nbsp;&nbsp; folks: **3,869**  &nbsp;&nbsp; `914 stars this week`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **32,463** &nbsp;&nbsp; folks: **7,790**  &nbsp;&nbsp; `8,908 stars this month`
...
1. [humanlayer / 12-factor-agents](https://github.com/humanlayer/12-factor-agents)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,525** &nbsp;&nbsp; folks: **612**  &nbsp;&nbsp; `5,027 stars this month`

1. [twentyhq / twenty](https://github.com/twentyhq/twenty)
    - Building a modern alternative to Salesforce, powered by the community.
    - language: **TypeScript** &nbsp;&nbsp; stars: **34,123** &nbsp;&nbsp; folks: **3,829**  &nbsp;&nbsp; `5,909 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **24,511** &nbsp;&nbsp; folks: **1,335**  &nbsp;&nbsp; `10,926 stars this month`
...
1. [datawhalechina / happy-llm](https://github.com/datawhalechina/happy-llm)
    - 📚 从零开始的大语言模型原理与实践教程
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **12,048** &nbsp;&nbsp; folks: **889**  &nbsp;&nbsp; `8,417 stars this month`
...
1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **75,005** &nbsp;&nbsp; folks: **16,553**  &nbsp;&nbsp; `2,340 stars this month`

1. [DataExpert-io / data-engineer-handbook](https://github.com/DataExpert-io/data-engineer-handbook)
    - This is a repo with links to everything you'd ever want to learn about data engineering
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **35,667** &nbsp;&nbsp; folks: **6,856**  &nbsp;&nbsp; `6,018 stars this month`
...
1. [snailyp / gemini-balance](https://github.com/snailyp/gemini-balance)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,419** &nbsp;&nbsp; folks: **599**  &nbsp;&nbsp; `1,619 stars this month`
...
1. [RSSNext / Folo](https://github.com/RSSNext/Folo)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,789** &nbsp;&nbsp; folks: **1,332**  &nbsp;&nbsp; `3,172 stars this month`
