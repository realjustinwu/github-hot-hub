...
1. [trufflesecurity / trufflehog](https://github.com/trufflesecurity/trufflehog)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **20,713** &nbsp;&nbsp; folks: **1,981**  &nbsp;&nbsp; `218 stars today`
...
1. [EvolutionAPI / evolution-api](https://github.com/EvolutionAPI/evolution-api)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,131** &nbsp;&nbsp; folks: **4,099**  &nbsp;&nbsp; `67 stars today`

1. [appcypher / awesome-mcp-servers](https://github.com/appcypher/awesome-mcp-servers)
    - Awesome MCP Servers - A curated list of Model Context Protocol servers
    - language: **无** &nbsp;&nbsp; stars: **4,286** &nbsp;&nbsp; folks: **376**  &nbsp;&nbsp; `137 stars today`

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **8,870** &nbsp;&nbsp; folks: **742**  &nbsp;&nbsp; `308 stars today`
...
1. [AI4Finance-Foundation / FinGPT](https://github.com/AI4Finance-Foundation/FinGPT)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **17,272** &nbsp;&nbsp; folks: **2,468**  &nbsp;&nbsp; `49 stars today`

1. [TapXWorld / ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook)
    - 所有小初高、大学PDF教材。
    - language: **Roff** &nbsp;&nbsp; stars: **48,450** &nbsp;&nbsp; folks: **10,867**  &nbsp;&nbsp; `242 stars today`
...
1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    - Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,146** &nbsp;&nbsp; folks: **528**  &nbsp;&nbsp; `1,696 stars this week`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **12,893** &nbsp;&nbsp; folks: **1,074**  &nbsp;&nbsp; `10,892 stars this month`

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **11,616** &nbsp;&nbsp; folks: **2,011**  &nbsp;&nbsp; `6,390 stars this month`

1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    - Collection of extracted System Prompts from popular chatbots like ChatGPT, Claude & Gemini
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,015** &nbsp;&nbsp; folks: **3,035**  &nbsp;&nbsp; `10,750 stars this month`
...
1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **8,771** &nbsp;&nbsp; folks: **264**  &nbsp;&nbsp; `5,295 stars this month`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **38,801** &nbsp;&nbsp; folks: **4,476**  &nbsp;&nbsp; `6,960 stars this month`

1. [basecamp / omarchy](https://github.com/basecamp/omarchy)
    - Opinionated Arch/Hyprland Setup
    - language: **Shell** &nbsp;&nbsp; stars: **6,908** &nbsp;&nbsp; folks: **836**  &nbsp;&nbsp; `3,975 stars this month`
