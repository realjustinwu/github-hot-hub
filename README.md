...
`更新时间：2025-08-17 18:25:35 +0800`

## 今日热门仓库

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **6,937** &nbsp;&nbsp; folks: **1,376**  &nbsp;&nbsp; `273 stars today`

1. [microsoft / poml](https://github.com/microsoft/poml)
    - Prompt Orchestration Markup Language
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,997** &nbsp;&nbsp; folks: **125**  &nbsp;&nbsp; `252 stars today`

1. [LMCache / LMCache](https://github.com/LMCache/LMCache)
    - Supercharge Your LLM with the Fastest KV Cache Layer
    - language: **Python** &nbsp;&nbsp; stars: **4,395** &nbsp;&nbsp; folks: **494**  &nbsp;&nbsp; `25 stars today`

1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    - Master programming by recreating your favorite technologies from scratch.
    - language: **Markdown** &nbsp;&nbsp; stars: **411,221** &nbsp;&nbsp; folks: **38,557**  &nbsp;&nbsp; `345 stars today`
...
1. [jaywcjlove / awesome-mac](https://github.com/jaywcjlove/awesome-mac)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **87,125** &nbsp;&nbsp; folks: **6,699**  &nbsp;&nbsp; `546 stars today`
...
1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,281** &nbsp;&nbsp; folks: **427**  &nbsp;&nbsp; `411 stars today`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **3,778** &nbsp;&nbsp; folks: **157**  &nbsp;&nbsp; `248 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **58,475** &nbsp;&nbsp; folks: **6,992**  &nbsp;&nbsp; `479 stars today`
...
1. [dtyq / magic](https://github.com/dtyq/magic)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **2,098** &nbsp;&nbsp; folks: **236**  &nbsp;&nbsp; `55 stars today`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **6,937** &nbsp;&nbsp; folks: **1,376**  &nbsp;&nbsp; `791 stars this week`
...
1. [xiaoyaocz / dart_simple_live](https://github.com/xiaoyaocz/dart_simple_live)
    - 简简单单的看直播
    - language: **Dart** &nbsp;&nbsp; stars: **12,540** &nbsp;&nbsp; folks: **1,024**  &nbsp;&nbsp; `560 stars this week`
...
1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,906** &nbsp;&nbsp; folks: **697**  &nbsp;&nbsp; `1,912 stars this week`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,110** &nbsp;&nbsp; folks: **1,534**  &nbsp;&nbsp; `1,136 stars this week`
...
1. [conductor-oss / conductor](https://github.com/conductor-oss/conductor)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **26,031** &nbsp;&nbsp; folks: **674**  &nbsp;&nbsp; `1,269 stars this week`
...
1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,127** &nbsp;&nbsp; folks: **1,256**  &nbsp;&nbsp; `11,151 stars this month`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Financial data aggregator for humans and AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **49,559** &nbsp;&nbsp; folks: **4,627**  &nbsp;&nbsp; `6,652 stars this month`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **6,937** &nbsp;&nbsp; folks: **1,376**  &nbsp;&nbsp; `934 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,451** &nbsp;&nbsp; folks: **9,426**  &nbsp;&nbsp; `3,093 stars this month`

1. [OpenPipe / ART](https://github.com/OpenPipe/ART)
    - Agent Reinforcement Trainer: train multi-step agents for real-world tasks using GRPO. Give your agents on-the-job training. Reinforcement learning for Qwen2.5, Qwen3, Llama, and more!
    - language: **Python** &nbsp;&nbsp; stars: **5,784** &nbsp;&nbsp; folks: **361**  &nbsp;&nbsp; `3,281 stars this month`
