...
1. [Worklenz / worklenz](https://github.com/Worklenz/worklenz)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,392** &nbsp;&nbsp; folks: **189**  &nbsp;&nbsp; `117 stars today`

1. [mishushakov / llm-scraper](https://github.com/mishushakov/llm-scraper)
    - Turn any webpage into structured data using LLMs
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,610** &nbsp;&nbsp; folks: **330**  &nbsp;&nbsp; `131 stars today`
...
1. [Freika / dawarich](https://github.com/Freika/dawarich)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **5,700** &nbsp;&nbsp; folks: **165**  &nbsp;&nbsp; `68 stars today`

1. [roboflow / supervision](https://github.com/roboflow/supervision)
    - We write your reusable computer vision tools. 💜
    - language: **Python** &nbsp;&nbsp; stars: **28,698** &nbsp;&nbsp; folks: **2,254**  &nbsp;&nbsp; `927 stars today`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **68,750** &nbsp;&nbsp; folks: **3,662**  &nbsp;&nbsp; `8,396 stars this week`

1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    - Improve your resumes with Resume Matcher. Get insights, keyword suggestions and tune your resumes to job descriptions.
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,045** &nbsp;&nbsp; folks: **3,602**  &nbsp;&nbsp; `799 stars this week`

1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The personal finance app for everyone
    - language: **Ruby** &nbsp;&nbsp; stars: **48,677** &nbsp;&nbsp; folks: **3,606**  &nbsp;&nbsp; `2,455 stars this week`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **5,748** &nbsp;&nbsp; folks: **792**  &nbsp;&nbsp; `1,120 stars this week`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,507** &nbsp;&nbsp; folks: **489**  &nbsp;&nbsp; `2,770 stars this week`

1. [getzep / graphiti](https://github.com/getzep/graphiti)
    - Build Real-Time Knowledge Graphs for AI Agents
    - language: **Python** &nbsp;&nbsp; stars: **14,447** &nbsp;&nbsp; folks: **1,214**  &nbsp;&nbsp; `1,493 stars this week`
...
1. [hyprwm / Hyprland](https://github.com/hyprwm/Hyprland)
    - Hyprland is an independent, highly customizable, dynamic tiling Wayland compositor that doesn't sacrifice on its looks.
    - language: **C++** &nbsp;&nbsp; stars: **28,252** &nbsp;&nbsp; folks: **1,197**  &nbsp;&nbsp; `1,143 stars this week`

1. [gorhill / uBlock](https://github.com/gorhill/uBlock)
    - uBlock Origin - An efficient blocker for Chromium and Firefox. Fast and lean.
    - language: **JavaScript** &nbsp;&nbsp; stars: **56,550** &nbsp;&nbsp; folks: **3,606**  &nbsp;&nbsp; `952 stars this week`
...
1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    ...
    - language: **PowerShell** &nbsp;&nbsp; stars: **25,019** &nbsp;&nbsp; folks: **1,370**  &nbsp;&nbsp; `5,270 stars this week`

1. [freeCodeCamp / freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
    - freeCodeCamp.org's open-source codebase and curriculum. Learn math, programming, and computer science for free.
    - language: **TypeScript** &nbsp;&nbsp; stars: **423,817** &nbsp;&nbsp; folks: **40,902**  &nbsp;&nbsp; `996 stars this week`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **32,897** &nbsp;&nbsp; folks: **7,856**  &nbsp;&nbsp; `9,203 stars this month`
...
1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **7,473** &nbsp;&nbsp; folks: **550**  &nbsp;&nbsp; `5,910 stars this month`
...
1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **25,019** &nbsp;&nbsp; folks: **1,370**  &nbsp;&nbsp; `10,940 stars this month`
...
1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **75,187** &nbsp;&nbsp; folks: **16,615**  &nbsp;&nbsp; `2,463 stars this month`

1. [datawhalechina / happy-llm](https://github.com/datawhalechina/happy-llm)
    - 📚 从零开始的大语言模型原理与实践教程
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **12,417** &nbsp;&nbsp; folks: **916**  &nbsp;&nbsp; `8,534 stars this month`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,157** &nbsp;&nbsp; folks: **425**  &nbsp;&nbsp; `3,811 stars this month`
...
1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The personal finance app for everyone
    - language: **Ruby** &nbsp;&nbsp; stars: **48,677** &nbsp;&nbsp; folks: **3,606**  &nbsp;&nbsp; `3,124 stars this month`

1. [RSSNext / Folo](https://github.com/RSSNext/Folo)
    - 🧡 Follow everything in one place
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,929** &nbsp;&nbsp; folks: **1,342**  &nbsp;&nbsp; `3,288 stars this month`
