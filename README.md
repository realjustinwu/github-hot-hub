...
1. [HotCakeX / Harden-Windows-Security](https://github.com/HotCakeX/Harden-Windows-Security)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **2,777** &nbsp;&nbsp; folks: **223**  &nbsp;&nbsp; `12 stars today`

1. [ikawrakow / ik_llama.cpp](https://github.com/ikawrakow/ik_llama.cpp)
    - llama.cpp fork with additional SOTA quants and improved performance
    - language: **C++** &nbsp;&nbsp; stars: **731** &nbsp;&nbsp; folks: **71**  &nbsp;&nbsp; `8 stars today`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **68,391** &nbsp;&nbsp; folks: **3,632**  &nbsp;&nbsp; `8,235 stars this week`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,114** &nbsp;&nbsp; folks: **457**  &nbsp;&nbsp; `2,600 stars this week`
...
1. [getzep / graphiti](https://github.com/getzep/graphiti)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **14,261** &nbsp;&nbsp; folks: **1,198**  &nbsp;&nbsp; `1,647 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **24,657** &nbsp;&nbsp; folks: **1,352**  &nbsp;&nbsp; `5,628 stars this week`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **5,295** &nbsp;&nbsp; folks: **747**  &nbsp;&nbsp; `886 stars this week`

1. [gitleaks / gitleaks](https://github.com/gitleaks/gitleaks)
    - Find secrets with Gitleaks 🔑
    - language: **Go** &nbsp;&nbsp; stars: **22,178** &nbsp;&nbsp; folks: **1,708**  &nbsp;&nbsp; `676 stars this week`

1. [strapi / strapi](https://github.com/strapi/strapi)
    - 🚀 Strapi is the leading open-source headless CMS. It’s 100% JavaScript/TypeScript, fully customizable, and developer-first.
    - language: **TypeScript** &nbsp;&nbsp; stars: **68,434** &nbsp;&nbsp; folks: **8,768**  &nbsp;&nbsp; `775 stars this week`

1. [RSSNext / Folo](https://github.com/RSSNext/Folo)
    - 🧡 Follow everything in one place
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,846** &nbsp;&nbsp; folks: **1,336**  &nbsp;&nbsp; `1,090 stars this week`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **32,574** &nbsp;&nbsp; folks: **7,806**  &nbsp;&nbsp; `9,069 stars this month`
...
1. [Alibaba-NLP / WebAgent](https://github.com/Alibaba-NLP/WebAgent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,670** &nbsp;&nbsp; folks: **347**  &nbsp;&nbsp; `3,602 stars this month`
...
1. [GraphiteEditor / Graphite](https://github.com/GraphiteEditor/Graphite)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **19,558** &nbsp;&nbsp; folks: **816**  &nbsp;&nbsp; `6,566 stars this month`

1. [humanlayer / 12-factor-agents](https://github.com/humanlayer/12-factor-agents)
    - What are the principles we can use to build LLM-powered software that is actually good enough to put in the hands of production customers?
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,601** &nbsp;&nbsp; folks: **616**  &nbsp;&nbsp; `5,156 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **24,657** &nbsp;&nbsp; folks: **1,352**  &nbsp;&nbsp; `10,967 stars this month`

1. [twentyhq / twenty](https://github.com/twentyhq/twenty)
    - Building a modern alternative to Salesforce, powered by the community.
    - language: **TypeScript** &nbsp;&nbsp; stars: **34,165** &nbsp;&nbsp; folks: **3,833**  &nbsp;&nbsp; `5,954 stars this month`

1. [GyulyVGC / sniffnet](https://github.com/GyulyVGC/sniffnet)
    - Comfortably monitor your Internet traffic 🕵️‍♂️
    - language: **Rust** &nbsp;&nbsp; stars: **28,805** &nbsp;&nbsp; folks: **958**  &nbsp;&nbsp; `4,355 stars this month`

1. [datawhalechina / happy-llm](https://github.com/datawhalechina/happy-llm)
    - 📚 从零开始的大语言模型原理与实践教程
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **12,126** &nbsp;&nbsp; folks: **891**  &nbsp;&nbsp; `8,479 stars this month`
...
1. [embabel / embabel-agent](https://github.com/embabel/embabel-agent)
    ...
    - language: **Kotlin** &nbsp;&nbsp; stars: **2,196** &nbsp;&nbsp; folks: **174**  &nbsp;&nbsp; `1,728 stars this month`

1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 26 lessons, 52 quizzes, classic Machine Learning for all
    - language: **HTML** &nbsp;&nbsp; stars: **75,058** &nbsp;&nbsp; folks: **16,577**  &nbsp;&nbsp; `2,385 stars this month`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,991** &nbsp;&nbsp; folks: **412**  &nbsp;&nbsp; `3,747 stars this month`
...
1. [stanford-oval / storm](https://github.com/stanford-oval/storm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **26,796** &nbsp;&nbsp; folks: **2,412**  &nbsp;&nbsp; `2,248 stars this month`
