...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,491** &nbsp;&nbsp; folks: **1,164**  &nbsp;&nbsp; `1,504 stars today`
...
1. [bitwarden / clients](https://github.com/bitwarden/clients)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,840** &nbsp;&nbsp; folks: **1,461**  &nbsp;&nbsp; `170 stars today`
...
1. [Budibase / budibase](https://github.com/Budibase/budibase)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,517** &nbsp;&nbsp; folks: **1,846**  &nbsp;&nbsp; `21 stars today`

1. [firecrawl / firecrawl](https://github.com/firecrawl/firecrawl)
    - The Web Data API for AI - Turn entire websites into LLM-ready markdown or structured data 🔥
    - language: **TypeScript** &nbsp;&nbsp; stars: **50,333** &nbsp;&nbsp; folks: **4,416**  &nbsp;&nbsp; `600 stars today`

1. [HunxByts / GhostTrack](https://github.com/HunxByts/GhostTrack)
    - Useful tool to track location or mobile number
    - language: **Python** &nbsp;&nbsp; stars: **2,496** &nbsp;&nbsp; folks: **353**  &nbsp;&nbsp; `90 stars today`

1. [nextjs / saas-starter](https://github.com/nextjs/saas-starter)
    - Get started quickly with Next.js, Postgres, Stripe, and shadcn/ui.
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,608** &nbsp;&nbsp; folks: **2,000**  &nbsp;&nbsp; `245 stars today`
...
1. [HeyPuter / puter](https://github.com/HeyPuter/puter)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **35,376** &nbsp;&nbsp; folks: **2,712**  &nbsp;&nbsp; `40 stars today`

1. [puppeteer / puppeteer](https://github.com/puppeteer/puppeteer)
    - JavaScript API for Chrome and Firefox
    - language: **TypeScript** &nbsp;&nbsp; stars: **91,970** &nbsp;&nbsp; folks: **9,279**  &nbsp;&nbsp; `169 stars today`

1. [skills / introduction-to-github](https://github.com/skills/introduction-to-github)
    - Get started using GitHub in less than an hour.
    - language: **无** &nbsp;&nbsp; stars: **9,244** &nbsp;&nbsp; folks: **11,990**  &nbsp;&nbsp; `12 stars today`
...
1. [microsoft / poml](https://github.com/microsoft/poml)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,676** &nbsp;&nbsp; folks: **167**  &nbsp;&nbsp; `2,051 stars this week`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **4,908** &nbsp;&nbsp; folks: **329**  &nbsp;&nbsp; `1,080 stars this week`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **60,897** &nbsp;&nbsp; folks: **7,325**  &nbsp;&nbsp; `3,373 stars this week`

1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    - Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!
    - language: **Python** &nbsp;&nbsp; stars: **9,420** &nbsp;&nbsp; folks: **722**  &nbsp;&nbsp; `1,387 stars this week`
...
1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,562** &nbsp;&nbsp; folks: **1,312**  &nbsp;&nbsp; `11,521 stars this month`

1. [QwenLM / Qwen3-Coder](https://github.com/QwenLM/Qwen3-Coder)
    - Qwen3-Coder is the code version of Qwen3, the large language model series developed by Qwen team, Alibaba Cloud.
    - language: **Python** &nbsp;&nbsp; stars: **12,440** &nbsp;&nbsp; folks: **850**  &nbsp;&nbsp; `7,368 stars this month`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Financial data platform for analysts, quants and AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **50,888** &nbsp;&nbsp; folks: **4,770**  &nbsp;&nbsp; `7,602 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,481** &nbsp;&nbsp; folks: **1,078**  &nbsp;&nbsp; `8,078 stars this month`

1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **4,908** &nbsp;&nbsp; folks: **329**  &nbsp;&nbsp; `1,652 stars this month`

1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    - A high-performance algorithmic trading platform and event-driven backtester
    - language: **Rust** &nbsp;&nbsp; stars: **14,329** &nbsp;&nbsp; folks: **1,540**  &nbsp;&nbsp; `4,534 stars this month`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **22,796** &nbsp;&nbsp; folks: **4,358**  &nbsp;&nbsp; `13,341 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,938** &nbsp;&nbsp; folks: **9,549**  &nbsp;&nbsp; `3,238 stars this month`

1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Sim is an open-source AI agent workflow builder. Sim Studio's interface is a lightweight, intuitive way to quickly build and deploy LLMs that connect with your favorite tools.
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,491** &nbsp;&nbsp; folks: **1,164**  &nbsp;&nbsp; `2,970 stars this month`
