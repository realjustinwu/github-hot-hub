...
`更新时间：2025-08-16 21:30:48 +0800`

## 今日热门仓库

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **6,089** &nbsp;&nbsp; folks: **1,267**  &nbsp;&nbsp; `318 stars today`

1. [microsoft / poml](https://github.com/microsoft/poml)
    - Prompt Orchestration Markup Language
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,676** &nbsp;&nbsp; folks: **110**  &nbsp;&nbsp; `511 stars today`
...
1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    ...
    - language: **Markdown** &nbsp;&nbsp; stars: **410,765** &nbsp;&nbsp; folks: **38,525**  &nbsp;&nbsp; `484 stars today`
...
1. [farhanashrafdev / 90DaysOfCyberSecurity](https://github.com/farhanashrafdev/90DaysOfCyberSecurity)
    ...
    - language: **无** &nbsp;&nbsp; stars: **10,715** &nbsp;&nbsp; folks: **1,219**  &nbsp;&nbsp; `295 stars today`

1. [jaywcjlove / awesome-mac](https://github.com/jaywcjlove/awesome-mac)
    -  Now we have become very big, Different from the original idea. Collect premium software in various categories.
    - language: **JavaScript** &nbsp;&nbsp; stars: **86,808** &nbsp;&nbsp; folks: **6,683**  &nbsp;&nbsp; `576 stars today`
...
1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,913** &nbsp;&nbsp; folks: **393**  &nbsp;&nbsp; `409 stars today`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **3,358** &nbsp;&nbsp; folks: **142**  &nbsp;&nbsp; `214 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **58,116** &nbsp;&nbsp; folks: **6,948**  &nbsp;&nbsp; `445 stars today`
...
1. [dtyq / magic](https://github.com/dtyq/magic)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **1,845** &nbsp;&nbsp; folks: **215**  &nbsp;&nbsp; `146 stars today`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **6,089** &nbsp;&nbsp; folks: **1,267**  &nbsp;&nbsp; `566 stars this week`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,685** &nbsp;&nbsp; folks: **1,478**  &nbsp;&nbsp; `920 stars this week`

1. [idosal / git-mcp](https://github.com/idosal/git-mcp)
    - Put an end to code hallucinations! GitMCP is a free, open-source, remote MCP server for any GitHub project
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,259** &nbsp;&nbsp; folks: **392**  &nbsp;&nbsp; `1,205 stars this week`
...
1. [polarsource / polar](https://github.com/polarsource/polar)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,901** &nbsp;&nbsp; folks: **421**  &nbsp;&nbsp; `646 stars this week`
...
1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,043** &nbsp;&nbsp; folks: **1,242**  &nbsp;&nbsp; `11,064 stars this month`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Financial data aggregator for humans and AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **49,367** &nbsp;&nbsp; folks: **4,607**  &nbsp;&nbsp; `6,882 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,815** &nbsp;&nbsp; folks: **589**  &nbsp;&nbsp; `6,775 stars this month`

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **6,089** &nbsp;&nbsp; folks: **1,267**  &nbsp;&nbsp; `695 stars this month`
