...
1. [FreeTubeApp / FreeTube](https://github.com/FreeTubeApp/FreeTube)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,403** &nbsp;&nbsp; folks: **919**  &nbsp;&nbsp; `26 stars today`

1. [mountain-loop / yaak](https://github.com/mountain-loop/yaak)
    - The most intuitive desktop API client. Organize and execute REST, GraphQL, WebSockets, Server Sent Events, and gRPC 🦬
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,525** &nbsp;&nbsp; folks: **101**  &nbsp;&nbsp; `277 stars today`

1. [NationalSecurityAgency / ghidra](https://github.com/NationalSecurityAgency/ghidra)
    - Ghidra is a software reverse engineering (SRE) framework
    - language: **Java** &nbsp;&nbsp; stars: **54,477** &nbsp;&nbsp; folks: **6,125**  &nbsp;&nbsp; `195 stars today`

1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    - Master programming by recreating your favorite technologies from scratch.
    - language: **Markdown** &nbsp;&nbsp; stars: **339,290** &nbsp;&nbsp; folks: **31,413**  &nbsp;&nbsp; `791 stars today`

1. [godotengine / godot](https://github.com/godotengine/godot)
    - Godot Engine – Multi-platform 2D and 3D game engine
    - language: **C++** &nbsp;&nbsp; stars: **94,236** &nbsp;&nbsp; folks: **21,743**  &nbsp;&nbsp; `28 stars today`
...
1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,538** &nbsp;&nbsp; folks: **1,257**  &nbsp;&nbsp; `10,172 stars this week`

1. [FujiwaraChoki / MoneyPrinterV2](https://github.com/FujiwaraChoki/MoneyPrinterV2)
    - Automate the process of making money online.
    - language: **Python** &nbsp;&nbsp; stars: **10,270** &nbsp;&nbsp; folks: **995**  &nbsp;&nbsp; `3,353 stars this week`
...
1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **12,220** &nbsp;&nbsp; folks: **1,292**  &nbsp;&nbsp; `2,984 stars this week`
...
1. [geekan / MetaGPT](https://github.com/geekan/MetaGPT)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **47,302** &nbsp;&nbsp; folks: **5,623**  &nbsp;&nbsp; `906 stars this week`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **71,134** &nbsp;&nbsp; folks: **10,379**  &nbsp;&nbsp; `3,600 stars this week`

1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding.
    - language: **TypeScript** &nbsp;&nbsp; stars: **39,311** &nbsp;&nbsp; folks: **3,471**  &nbsp;&nbsp; `2,874 stars this week`

1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    - Python tool for converting files and office documents to Markdown.
    - language: **HTML** &nbsp;&nbsp; stars: **38,638** &nbsp;&nbsp; folks: **1,780**  &nbsp;&nbsp; `1,284 stars this week`
...
1. [microsoft / data-formulator](https://github.com/microsoft/data-formulator)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,151** &nbsp;&nbsp; folks: **616**  &nbsp;&nbsp; `1,748 stars this week`
...
1. [deepseek-ai / awesome-deepseek-integration](https://github.com/deepseek-ai/awesome-deepseek-integration)
    - 无
    - language: **无** &nbsp;&nbsp; stars: **19,356** &nbsp;&nbsp; folks: **2,147**  &nbsp;&nbsp; `16,936 stars this month`

1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    - A simple screen parsing tool towards pure vision based GUI agent
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,538** &nbsp;&nbsp; folks: **1,257**  &nbsp;&nbsp; `10,707 stars this month`
...
1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **77,909** &nbsp;&nbsp; folks: **9,255**  &nbsp;&nbsp; `19,871 stars this month`
...
1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **71,134** &nbsp;&nbsp; folks: **10,379**  &nbsp;&nbsp; `11,536 stars this month`
...
1. [Mintplex-Labs / anything-llm](https://github.com/Mintplex-Labs/anything-llm)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **38,528** &nbsp;&nbsp; folks: **3,706**  &nbsp;&nbsp; `7,908 stars this month`
...
1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    - 🚀🚀 「大模型」2小时完全从0训练26M的小参数GPT！🌏 Train a 26M-parameter GPT from scratch in just 2h!
    - language: **Python** &nbsp;&nbsp; stars: **12,220** &nbsp;&nbsp; folks: **1,292**  &nbsp;&nbsp; `5,786 stars this month`
...
1. [ggml-org / llama.cpp](https://github.com/ggml-org/llama.cpp)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **75,051** &nbsp;&nbsp; folks: **10,844**  &nbsp;&nbsp; `4,214 stars this month`
...
1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    - Make websites accessible for AI agents
    - language: **Python** &nbsp;&nbsp; stars: **31,420** &nbsp;&nbsp; folks: **3,242**  &nbsp;&nbsp; `15,350 stars this month`
