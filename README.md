...
`更新时间：2025-05-04 20:45:23 +0800`

## 今日热门仓库

1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    - real time face swap and one-click video deepfake with only a single image
    - language: **Python** &nbsp;&nbsp; stars: **60,013** &nbsp;&nbsp; folks: **8,419**  &nbsp;&nbsp; `1,511 stars today`

1. [jj-vcs / jj](https://github.com/jj-vcs/jj)
    - A Git-compatible VCS that is both simple and powerful
    - language: **Rust** &nbsp;&nbsp; stars: **13,263** &nbsp;&nbsp; folks: **479**  &nbsp;&nbsp; `365 stars today`
...
1. [aipotheosis-labs / aci](https://github.com/aipotheosis-labs/aci)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,048** &nbsp;&nbsp; folks: **148**  &nbsp;&nbsp; `355 stars today`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **298,032** &nbsp;&nbsp; folks: **49,517**  &nbsp;&nbsp; `164 stars today`

1. [cloudflare / mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare)
    - 无
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,783** &nbsp;&nbsp; folks: **128**  &nbsp;&nbsp; `138 stars today`

1. [521xueweihan / HelloGitHub](https://github.com/521xueweihan/HelloGitHub)
    - 分享 GitHub 上有趣、入门级的开源项目。Share interesting, entry-level open source projects on GitHub.
    - language: **Python** &nbsp;&nbsp; stars: **103,305** &nbsp;&nbsp; folks: **9,926**  &nbsp;&nbsp; `382 stars today`

1. [unionlabs / union](https://github.com/unionlabs/union)
    - The trust-minimized, zero-knowledge bridging protocol, designed for censorship resistance, extremely high security, and usage in decentralized finance.
    - language: **Rust** &nbsp;&nbsp; stars: **56,975** &nbsp;&nbsp; folks: **2,858**  &nbsp;&nbsp; `509 stars today`

1. [BasedHardware / omi](https://github.com/BasedHardware/omi)
    - AI wearables. Put it on, speak, transcribe, automatically
    - language: **C** &nbsp;&nbsp; stars: **5,461** &nbsp;&nbsp; folks: **783**  &nbsp;&nbsp; `16 stars today`

1. [daytonaio / daytona](https://github.com/daytonaio/daytona)
    - Daytona is a Secure and Elastic Infrastructure for Running AI-Generated Code
    - language: **TypeScript** &nbsp;&nbsp; stars: **19,075** &nbsp;&nbsp; folks: **2,035**  &nbsp;&nbsp; `653 stars today`

1. [LadybirdBrowser / ladybird](https://github.com/LadybirdBrowser/ladybird)
    - Truly independent web browser
    - language: **C++** &nbsp;&nbsp; stars: **38,320** &nbsp;&nbsp; folks: **1,595**  &nbsp;&nbsp; `119 stars today`

1. [nodejs / node](https://github.com/nodejs/node)
    - Node.js JavaScript runtime ✨🐢🚀✨
    - language: **JavaScript** &nbsp;&nbsp; stars: **110,969** &nbsp;&nbsp; folks: **31,448**  &nbsp;&nbsp; `26 stars today`
...
1. [Klipper3d / klipper](https://github.com/Klipper3d/klipper)
    ...
    - language: **C** &nbsp;&nbsp; stars: **10,192** &nbsp;&nbsp; folks: **5,526**  &nbsp;&nbsp; `7 stars today`

1. [FreeCAD / FreeCAD](https://github.com/FreeCAD/FreeCAD)
    - This is the official source code of FreeCAD, a free and opensource multiplatform 3D parametric modeler.
    - language: **C++** &nbsp;&nbsp; stars: **24,176** &nbsp;&nbsp; folks: **4,521**  &nbsp;&nbsp; `9 stars today`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **HTML** &nbsp;&nbsp; stars: **356,162** &nbsp;&nbsp; folks: **63,282**  &nbsp;&nbsp; `102 stars today`
...
1. [juanfont / headscale](https://github.com/juanfont/headscale)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **27,733** &nbsp;&nbsp; folks: **1,492**  &nbsp;&nbsp; `154 stars today`
...
1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    - real time face swap and one-click video deepfake with only a single image
    - language: **Python** &nbsp;&nbsp; stars: **60,013** &nbsp;&nbsp; folks: **8,419**  &nbsp;&nbsp; `8,191 stars this week`

1. [jujumilk3 / leaked-system-prompts](https://github.com/jujumilk3/leaked-system-prompts)
    - Collection of leaked system prompts
    - language: **无** &nbsp;&nbsp; stars: **5,927** &nbsp;&nbsp; folks: **656**  &nbsp;&nbsp; `2,073 stars this week`

1. [kortix-ai / suna](https://github.com/kortix-ai/suna)
    - Suna - Open Source Generalist AI Agent
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,679** &nbsp;&nbsp; folks: **1,212**  &nbsp;&nbsp; `3,427 stars this week`

1. [LadybirdBrowser / ladybird](https://github.com/LadybirdBrowser/ladybird)
    - Truly independent web browser
    - language: **C++** &nbsp;&nbsp; stars: **38,320** &nbsp;&nbsp; folks: **1,595**  &nbsp;&nbsp; `713 stars this week`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **317,279** &nbsp;&nbsp; folks: **41,164**  &nbsp;&nbsp; `1,300 stars this week`

1. [microsoft / generative-ai-for-beginners](https://github.com/microsoft/generative-ai-for-beginners)
    - 21 Lessons, Get Started Building with Generative AI 🔗 https://microsoft.github.io/generative-ai-for-beginners/
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **82,193** &nbsp;&nbsp; folks: **42,197**  &nbsp;&nbsp; `2,158 stars this week`

1. [drawdb-io / drawdb](https://github.com/drawdb-io/drawdb)
    - Free, simple, and intuitive online database diagram editor and SQL generator.
    - language: **JavaScript** &nbsp;&nbsp; stars: **29,555** &nbsp;&nbsp; folks: **2,066**  &nbsp;&nbsp; `1,217 stars this week`
...
1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    - real time face swap and one-click video deepfake with only a single image
    - language: **Python** &nbsp;&nbsp; stars: **60,013** &nbsp;&nbsp; folks: **8,419**  &nbsp;&nbsp; `9,615 stars this month`
...
1. [jujumilk3 / leaked-system-prompts](https://github.com/jujumilk3/leaked-system-prompts)
    - Collection of leaked system prompts
    - language: **无** &nbsp;&nbsp; stars: **5,927** &nbsp;&nbsp; folks: **656**  &nbsp;&nbsp; `3,709 stars this month`

1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    - Python tool for converting files and office documents to Markdown.
    - language: **Python** &nbsp;&nbsp; stars: **55,923** &nbsp;&nbsp; folks: **2,838**  &nbsp;&nbsp; `14,113 stars this month`

1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    - Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.
    - language: **TypeScript** &nbsp;&nbsp; stars: **88,643** &nbsp;&nbsp; folks: **24,238**  &nbsp;&nbsp; `14,302 stars this month`
...
1. [jlowin / fastmcp](https://github.com/jlowin/fastmcp)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,459** &nbsp;&nbsp; folks: **439**  &nbsp;&nbsp; `4,845 stars this month`
...
1. [drawdb-io / drawdb](https://github.com/drawdb-io/drawdb)
    - Free, simple, and intuitive online database diagram editor and SQL generator.
    - language: **JavaScript** &nbsp;&nbsp; stars: **29,555** &nbsp;&nbsp; folks: **2,066**  &nbsp;&nbsp; `3,247 stars this month`

1. [QwenLM / Qwen3](https://github.com/QwenLM/Qwen3)
    - Qwen3 is the large language model series developed by Qwen team, Alibaba Cloud.
    - language: **Shell** &nbsp;&nbsp; stars: **20,127** &nbsp;&nbsp; folks: **1,316**  &nbsp;&nbsp; `3,657 stars this month`
...
1. [mark3labs / mcp-go](https://github.com/mark3labs/mcp-go)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **4,420** &nbsp;&nbsp; folks: **355**  &nbsp;&nbsp; `2,456 stars this month`
