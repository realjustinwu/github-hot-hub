...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,088** &nbsp;&nbsp; folks: **876**  &nbsp;&nbsp; `561 stars today`

1. [11cafe / jaaz](https://github.com/11cafe/jaaz)
    - The world's first open-source multimodal creative assistant This is a substitute for Canva and Manus that prioritizes privacy and is usable locally.
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,714** &nbsp;&nbsp; folks: **264**  &nbsp;&nbsp; `67 stars today`
...
1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,003** &nbsp;&nbsp; folks: **634**  &nbsp;&nbsp; `2,808 stars this week`

1. [pedroslopez / whatsapp-web.js](https://github.com/pedroslopez/whatsapp-web.js)
    - A WhatsApp client library for NodeJS that connects through the WhatsApp Web browser app
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,288** &nbsp;&nbsp; folks: **4,474**  &nbsp;&nbsp; `1,444 stars this week`
...
1. [trufflesecurity / trufflehog](https://github.com/trufflesecurity/trufflehog)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **21,234** &nbsp;&nbsp; folks: **2,007**  &nbsp;&nbsp; `771 stars this week`
...
1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **97,857** &nbsp;&nbsp; folks: **14,338**  &nbsp;&nbsp; `1,059 stars this week`
...
1. [juspay / hyperswitch](https://github.com/juspay/hyperswitch)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **30,930** &nbsp;&nbsp; folks: **4,106**  &nbsp;&nbsp; `3,816 stars this week`

1. [uutils / coreutils](https://github.com/uutils/coreutils)
    - Cross-platform Rust rewrite of the GNU coreutils
    - language: **Rust** &nbsp;&nbsp; stars: **21,247** &nbsp;&nbsp; folks: **1,538**  &nbsp;&nbsp; `91 stars this week`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **13,170** &nbsp;&nbsp; folks: **1,112**  &nbsp;&nbsp; `11,321 stars this month`

1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    - Collection of extracted System Prompts from popular chatbots like ChatGPT, Claude & Gemini
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,416** &nbsp;&nbsp; folks: **3,086**  &nbsp;&nbsp; `11,196 stars this month`

1. [ubicloud / ubicloud](https://github.com/ubicloud/ubicloud)
    - Open source alternative to AWS. Elastic compute, block storage (non replicated), firewall and load balancer, managed Postgres, K8s, AI inference, and IAM services.
    - language: **Ruby** &nbsp;&nbsp; stars: **10,209** &nbsp;&nbsp; folks: **459**  &nbsp;&nbsp; `4,931 stars this month`
...
1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **8,991** &nbsp;&nbsp; folks: **270**  &nbsp;&nbsp; `5,613 stars this month`

1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Open-source platform to build and deploy AI agent workflows.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,449** &nbsp;&nbsp; folks: **1,768**  &nbsp;&nbsp; `7,551 stars this month`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **39,453** &nbsp;&nbsp; folks: **4,572**  &nbsp;&nbsp; `7,377 stars this month`
...
1. [basecamp / omarchy](https://github.com/basecamp/omarchy)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **7,266** &nbsp;&nbsp; folks: **858**  &nbsp;&nbsp; `4,010 stars this month`
