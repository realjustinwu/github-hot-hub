...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,314** &nbsp;&nbsp; folks: **890**  &nbsp;&nbsp; `558 stars today`

1. [11cafe / jaaz](https://github.com/11cafe/jaaz)
    - The world's first open-source multimodal creative assistant This is a substitute for Canva and Manus that prioritizes privacy and is usable locally.
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,088** &nbsp;&nbsp; folks: **282**  &nbsp;&nbsp; `103 stars today`
...
1. [dockur / windows](https://github.com/dockur/windows)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **44,860** &nbsp;&nbsp; folks: **3,261**  &nbsp;&nbsp; `4,651 stars this week`

1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    - Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,098** &nbsp;&nbsp; folks: **654**  &nbsp;&nbsp; `2,846 stars this week`

1. [pedroslopez / whatsapp-web.js](https://github.com/pedroslopez/whatsapp-web.js)
    - A WhatsApp client library for NodeJS that connects through the WhatsApp Web browser app
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,312** &nbsp;&nbsp; folks: **4,481**  &nbsp;&nbsp; `1,263 stars this week`

1. [resemble-ai / chatterbox](https://github.com/resemble-ai/chatterbox)
    - SoTA open-source TTS
    - language: **Python** &nbsp;&nbsp; stars: **12,402** &nbsp;&nbsp; folks: **1,558**  &nbsp;&nbsp; `1,475 stars this week`
...
1. [aquasecurity / trivy](https://github.com/aquasecurity/trivy)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **28,763** &nbsp;&nbsp; folks: **2,744**  &nbsp;&nbsp; `662 stars this week`
...
1. [chiphuyen / aie-book](https://github.com/chiphuyen/aie-book)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **8,156** &nbsp;&nbsp; folks: **1,076**  &nbsp;&nbsp; `1,873 stars this week`
...
1. [google / comprehensive-rust](https://github.com/google/comprehensive-rust)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **31,827** &nbsp;&nbsp; folks: **1,889**  &nbsp;&nbsp; `655 stars this week`
...
1. [juspay / hyperswitch](https://github.com/juspay/hyperswitch)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **31,649** &nbsp;&nbsp; folks: **4,129**  &nbsp;&nbsp; `3,985 stars this week`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **13,217** &nbsp;&nbsp; folks: **1,115**  &nbsp;&nbsp; `11,405 stars this month`

1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    - Collection of extracted System Prompts from popular chatbots like ChatGPT, Claude & Gemini
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,498** &nbsp;&nbsp; folks: **3,098**  &nbsp;&nbsp; `11,330 stars this month`
...
1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **9,030** &nbsp;&nbsp; folks: **273**  &nbsp;&nbsp; `5,685 stars this month`
...
1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **44,860** &nbsp;&nbsp; folks: **3,261**  &nbsp;&nbsp; `8,142 stars this month`

1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **39,604** &nbsp;&nbsp; folks: **4,597**  &nbsp;&nbsp; `7,094 stars this month`
