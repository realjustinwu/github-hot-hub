...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,984** &nbsp;&nbsp; folks: **1,425**  &nbsp;&nbsp; `218 stars today`

1. [FiloSottile / mkcert](https://github.com/FiloSottile/mkcert)
    - A simple zero-config tool to make locally trusted development certificates with any names you'd like.
    - language: **Go** &nbsp;&nbsp; stars: **55,656** &nbsp;&nbsp; folks: **2,913**  &nbsp;&nbsp; `328 stars today`

1. [filamentphp / filament](https://github.com/filamentphp/filament)
    - A powerful open source UI framework for Laravel • Build and ship admin panels & apps fast with Livewire
    - language: **PHP** &nbsp;&nbsp; stars: **25,534** &nbsp;&nbsp; folks: **3,649**  &nbsp;&nbsp; `36 stars today`
...
1. [nomic-ai / gpt4all](https://github.com/nomic-ai/gpt4all)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **76,226** &nbsp;&nbsp; folks: **8,212**  &nbsp;&nbsp; `302 stars today`
...
1. [conductor-oss / conductor](https://github.com/conductor-oss/conductor)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **25,287** &nbsp;&nbsp; folks: **664**  &nbsp;&nbsp; `282 stars today`

1. [microsoft / poml](https://github.com/microsoft/poml)
    - Prompt Orchestration Markup Language
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,533** &nbsp;&nbsp; folks: **49**  &nbsp;&nbsp; `763 stars today`
...
1. [x1xhlol / system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools)
    ...
    - language: **无** &nbsp;&nbsp; stars: **75,918** &nbsp;&nbsp; folks: **21,309**  &nbsp;&nbsp; `573 stars today`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **34,782** &nbsp;&nbsp; folks: **3,969**  &nbsp;&nbsp; `2,867 stars this week`
...
1. [openai / openai-cookbook](https://github.com/openai/openai-cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **67,016** &nbsp;&nbsp; folks: **11,111**  &nbsp;&nbsp; `1,224 stars this week`
...
1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,664** &nbsp;&nbsp; folks: **1,195**  &nbsp;&nbsp; `4,187 stars this week`

1. [menloresearch / jan](https://github.com/menloresearch/jan)
    - Jan is an open source alternative to ChatGPT that runs 100% offline on your computer
    - language: **TypeScript** &nbsp;&nbsp; stars: **36,682** &nbsp;&nbsp; folks: **2,144**  &nbsp;&nbsp; `1,067 stars this week`

1. [patchy631 / ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)
    - In-depth tutorials on LLMs, RAGs and real-world AI agent applications.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **17,091** &nbsp;&nbsp; folks: **2,866**  &nbsp;&nbsp; `1,300 stars this week`
...
1. [umami-software / umami](https://github.com/umami-software/umami)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,768** &nbsp;&nbsp; folks: **5,368**  &nbsp;&nbsp; `1,856 stars this week`

1. [jesseduffield / lazygit](https://github.com/jesseduffield/lazygit)
    - simple terminal UI for git commands
    - language: **Go** &nbsp;&nbsp; stars: **63,532** &nbsp;&nbsp; folks: **2,186**  &nbsp;&nbsp; `853 stars this week`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,107** &nbsp;&nbsp; folks: **9,349**  &nbsp;&nbsp; `1,002 stars this week`

1. [openai / openai-go](https://github.com/openai/openai-go)
    - The official Go library for the OpenAI API
    - language: **Go** &nbsp;&nbsp; stars: **2,248** &nbsp;&nbsp; folks: **190**  &nbsp;&nbsp; `68 stars this week`
...
1. [hao-ai-lab / FastVideo](https://github.com/hao-ai-lab/FastVideo)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,956** &nbsp;&nbsp; folks: **140**  &nbsp;&nbsp; `168 stars this week`

1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    - Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!
    - language: **Python** &nbsp;&nbsp; stars: **8,005** &nbsp;&nbsp; folks: **643**  &nbsp;&nbsp; `962 stars this week`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **106,527** &nbsp;&nbsp; folks: **14,372**  &nbsp;&nbsp; `1,200 stars this week`
...
1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,664** &nbsp;&nbsp; folks: **1,195**  &nbsp;&nbsp; `10,590 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,701** &nbsp;&nbsp; folks: **944**  &nbsp;&nbsp; `9,034 stars this month`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **7,540** &nbsp;&nbsp; folks: **995**  &nbsp;&nbsp; `3,192 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,393** &nbsp;&nbsp; folks: **567**  &nbsp;&nbsp; `6,505 stars this month`
...
1. [sst / opencode](https://github.com/sst/opencode)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **19,280** &nbsp;&nbsp; folks: **1,224**  &nbsp;&nbsp; `7,499 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,107** &nbsp;&nbsp; folks: **9,349**  &nbsp;&nbsp; `3,015 stars this month`
