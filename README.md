...
1. [louis-e / arnis](https://github.com/louis-e/arnis)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **2,606** &nbsp;&nbsp; folks: **53**  &nbsp;&nbsp; `560 stars today`

1. [deepseek-ai / DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
    - DeepSeek Coder: Let the Code Write Itself
    - language: **Python** &nbsp;&nbsp; stars: **9,196** &nbsp;&nbsp; folks: **606**  &nbsp;&nbsp; `1,336 stars today`
...
1. [stanford-oval / storm](https://github.com/stanford-oval/storm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **14,495** &nbsp;&nbsp; folks: **1,361**  &nbsp;&nbsp; `285 stars today`
...
1. [intuitem / ciso-assistant-community](https://github.com/intuitem/ciso-assistant-community)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,499** &nbsp;&nbsp; folks: **200**  &nbsp;&nbsp; `53 stars today`
...
1. [gitroomhq / postiz-app](https://github.com/gitroomhq/postiz-app)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,987** &nbsp;&nbsp; folks: **2,626**  &nbsp;&nbsp; `356 stars today`

1. [caddyserver / caddy](https://github.com/caddyserver/caddy)
    - Fast and extensible multi-platform HTTP/1-2-3 web server with automatic HTTPS
    - language: **Go** &nbsp;&nbsp; stars: **59,858** &nbsp;&nbsp; folks: **4,095**  &nbsp;&nbsp; `40 stars today`
...
1. [anti-work / shortest](https://github.com/anti-work/shortest)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,662** &nbsp;&nbsp; folks: **193**  &nbsp;&nbsp; `1,950 stars this week`

1. [imputnet / cobalt](https://github.com/imputnet/cobalt)
    - best way to save what you love
    - language: **Svelte** &nbsp;&nbsp; stars: **24,609** &nbsp;&nbsp; folks: **1,982**  &nbsp;&nbsp; `3,482 stars this week`

1. [OpenSPG / KAG](https://github.com/OpenSPG/KAG)
    - KAG is a logical form-guided reasoning and retrieval framework based on OpenSPG engine and LLMs. It is used to build logical reasoning and factual Q&A solutions for professional domain knowledge bases. It can effectively overcome the shortcomings of the traditional RAG vector similarity calculation model.
    - language: **Python** &nbsp;&nbsp; stars: **2,883** &nbsp;&nbsp; folks: **176**  &nbsp;&nbsp; `1,457 stars this week`

1. [elizaOS / eliza](https://github.com/elizaOS/eliza)
    - Autonomous agents for everyone
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,732** &nbsp;&nbsp; folks: **2,297**  &nbsp;&nbsp; `2,463 stars this week`

1. [siyuan-note / siyuan](https://github.com/siyuan-note/siyuan)
    - A privacy-first, self-hosted, fully open source personal knowledge management software, written in typescript and golang.
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,723** &nbsp;&nbsp; folks: **1,736**  &nbsp;&nbsp; `1,700 stars this week`

1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    - A collective list of free APIs
    - language: **Python** &nbsp;&nbsp; stars: **322,806** &nbsp;&nbsp; folks: **34,254**  &nbsp;&nbsp; `2,087 stars this week`

1. [microsoft / PromptWizard](https://github.com/microsoft/PromptWizard)
    - Task-Aware Agent-driven Prompt Optimization Framework
    - language: **Python** &nbsp;&nbsp; stars: **1,599** &nbsp;&nbsp; folks: **117**  &nbsp;&nbsp; `637 stars this week`

1. [cline / cline](https://github.com/cline/cline)
    - Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way.
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,555** &nbsp;&nbsp; folks: **1,550**  &nbsp;&nbsp; `2,106 stars this week`
...
1. [upscayl / upscayl](https://github.com/upscayl/upscayl)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **32,893** &nbsp;&nbsp; folks: **1,508**  &nbsp;&nbsp; `867 stars this week`

1. [practical-tutorials / project-based-learning](https://github.com/practical-tutorials/project-based-learning)
    - Curated list of project-based tutorials
    - language: **无** &nbsp;&nbsp; stars: **210,053** &nbsp;&nbsp; folks: **27,435**  &nbsp;&nbsp; `1,075 stars this week`
...
1. [ManimCommunity / manim](https://github.com/ManimCommunity/manim)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **28,446** &nbsp;&nbsp; folks: **1,982**  &nbsp;&nbsp; `910 stars this week`
...
1. [janhq / jan](https://github.com/janhq/jan)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,158** &nbsp;&nbsp; folks: **1,450**  &nbsp;&nbsp; `724 stars this week`
...
1. [elizaOS / eliza](https://github.com/elizaOS/eliza)
    - Autonomous agents for everyone
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,732** &nbsp;&nbsp; folks: **2,297**  &nbsp;&nbsp; `5,999 stars this month`

1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    - PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/Docker
    - language: **Python** &nbsp;&nbsp; stars: **13,275** &nbsp;&nbsp; folks: **967**  &nbsp;&nbsp; `9,615 stars this month`
...
1. [DrewThomasson / ebook2audiobook](https://github.com/DrewThomasson/ebook2audiobook)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,575** &nbsp;&nbsp; folks: **299**  &nbsp;&nbsp; `3,239 stars this month`

1. [imputnet / cobalt](https://github.com/imputnet/cobalt)
    - best way to save what you love
    - language: **Svelte** &nbsp;&nbsp; stars: **24,609** &nbsp;&nbsp; folks: **1,982**  &nbsp;&nbsp; `6,934 stars this month`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **345,815** &nbsp;&nbsp; folks: **62,351**  &nbsp;&nbsp; `5,518 stars this month`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **284,181** &nbsp;&nbsp; folks: **47,467**  &nbsp;&nbsp; `6,477 stars this month`

1. [cline / cline](https://github.com/cline/cline)
    - Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way.
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,555** &nbsp;&nbsp; folks: **1,550**  &nbsp;&nbsp; `5,210 stars this month`
