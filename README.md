...
1. [enescingoz / awesome-n8n-templates](https://github.com/enescingoz/awesome-n8n-templates)
    ...
    - language: **无** &nbsp;&nbsp; stars: **9,085** &nbsp;&nbsp; folks: **2,696**  &nbsp;&nbsp; `139 stars today`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **4,433** &nbsp;&nbsp; folks: **180**  &nbsp;&nbsp; `496 stars today`

1. [immich-app / immich](https://github.com/immich-app/immich)
    - High performance self-hosted photo and video management solution.
    - language: **TypeScript** &nbsp;&nbsp; stars: **73,222** &nbsp;&nbsp; folks: **3,864**  &nbsp;&nbsp; `138 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **59,487** &nbsp;&nbsp; folks: **7,133**  &nbsp;&nbsp; `816 stars today`
...
1. [mfts / papermark](https://github.com/mfts/papermark)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,155** &nbsp;&nbsp; folks: **985**  &nbsp;&nbsp; `64 stars today`
...
1. [apple / embedding-atlas](https://github.com/apple/embedding-atlas)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,711** &nbsp;&nbsp; folks: **119**  &nbsp;&nbsp; `1,846 stars this week`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,373** &nbsp;&nbsp; folks: **1,570**  &nbsp;&nbsp; `1,646 stars this week`
...
1. [denizsafak / abogen](https://github.com/denizsafak/abogen)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,779** &nbsp;&nbsp; folks: **142**  &nbsp;&nbsp; `1,280 stars this week`
...
1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,028** &nbsp;&nbsp; folks: **707**  &nbsp;&nbsp; `1,713 stars this week`
...
1. [librespot-org / librespot](https://github.com/librespot-org/librespot)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **5,494** &nbsp;&nbsp; folks: **718**  &nbsp;&nbsp; `53 stars this week`

1. [filamentphp / filament](https://github.com/filamentphp/filament)
    - A powerful open source UI framework for Laravel • Build and ship admin panels & apps fast with Livewire
    - language: **PHP** &nbsp;&nbsp; stars: **25,818** &nbsp;&nbsp; folks: **3,686**  &nbsp;&nbsp; `422 stars this week`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **22,486** &nbsp;&nbsp; folks: **4,336**  &nbsp;&nbsp; `13,297 stars this month`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Financial data aggregator for humans and AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **50,170** &nbsp;&nbsp; folks: **4,684**  &nbsp;&nbsp; `6,794 stars this month`

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **8,754** &nbsp;&nbsp; folks: **1,570**  &nbsp;&nbsp; `1,987 stars this month`

1. [roboflow / supervision](https://github.com/roboflow/supervision)
    - We write your reusable computer vision tools. 💜
    - language: **Python** &nbsp;&nbsp; stars: **34,012** &nbsp;&nbsp; folks: **2,741**  &nbsp;&nbsp; `6,997 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,794** &nbsp;&nbsp; folks: **1,020**  &nbsp;&nbsp; `8,385 stars this month`

1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    - A high-performance algorithmic trading platform and event-driven backtester
    - language: **Rust** &nbsp;&nbsp; stars: **14,165** &nbsp;&nbsp; folks: **1,519**  &nbsp;&nbsp; `4,425 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,317** &nbsp;&nbsp; folks: **612**  &nbsp;&nbsp; `6,928 stars this month`
