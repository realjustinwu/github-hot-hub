...
`更新时间：2025-06-10 17:27:33 +0800`

## 今日热门仓库

1. [alphacep / vosk-api](https://github.com/alphacep/vosk-api)
    - Offline speech recognition API for Android, iOS, Raspberry Pi and servers with Python, Java, C# and Node
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **11,206** &nbsp;&nbsp; folks: **1,382**  &nbsp;&nbsp; `221 stars today`
...
1. [linsomniac / spotify_to_ytmusic](https://github.com/linsomniac/spotify_to_ytmusic)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,498** &nbsp;&nbsp; folks: **254**  &nbsp;&nbsp; `53 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **34,211** &nbsp;&nbsp; folks: **3,911**  &nbsp;&nbsp; `337 stars today`

1. [blakeblackshear / frigate](https://github.com/blakeblackshear/frigate)
    - NVR with realtime local object detection for IP cameras
    - language: **TypeScript** &nbsp;&nbsp; stars: **23,171** &nbsp;&nbsp; folks: **2,158**  &nbsp;&nbsp; `39 stars today`
...
1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,874** &nbsp;&nbsp; folks: **1,112**  &nbsp;&nbsp; `6,700 stars this week`
...
1. [gitroomhq / postiz-app](https://github.com/gitroomhq/postiz-app)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,471** &nbsp;&nbsp; folks: **3,346**  &nbsp;&nbsp; `1,383 stars this week`

1. [netbirdio / netbird](https://github.com/netbirdio/netbird)
    - Connect your devices into a secure WireGuard®-based overlay network with SSO, MFA and granular access controls.
    - language: **Go** &nbsp;&nbsp; stars: **15,337** &nbsp;&nbsp; folks: **724**  &nbsp;&nbsp; `1,465 stars this week`

1. [datawhalechina / self-llm](https://github.com/datawhalechina/self-llm)
    - 《开源大模型食用指南》针对中国宝宝量身打造的基于Linux环境快速微调（全参数/Lora）、部署国内外开源大模型（LLM）/多模态大模型（MLLM）教程
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,696** &nbsp;&nbsp; folks: **1,827**  &nbsp;&nbsp; `721 stars this week`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **305,303** &nbsp;&nbsp; folks: **50,485**  &nbsp;&nbsp; `2,703 stars this week`

1. [scrapy / scrapy](https://github.com/scrapy/scrapy)
    - Scrapy, a fast high-level web crawling & scraping framework for Python.
    - language: **Python** &nbsp;&nbsp; stars: **56,874** &nbsp;&nbsp; folks: **10,910**  &nbsp;&nbsp; `1,429 stars this week`
...
1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    ...
    - language: **Dockerfile** &nbsp;&nbsp; stars: **88,665** &nbsp;&nbsp; folks: **10,191**  &nbsp;&nbsp; `2,605 stars this week`

1. [eyaltoledano / claude-task-master](https://github.com/eyaltoledano/claude-task-master)
    - An AI-powered task-management system you can drop into Cursor, Lovable, Windsurf, Roo, and others.
    - language: **JavaScript** &nbsp;&nbsp; stars: **13,603** &nbsp;&nbsp; folks: **1,403**  &nbsp;&nbsp; `1,789 stars this week`

1. [clash-verge-rev / clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev)
    - A modern GUI client based on Tauri, designed to run in Windows, macOS and Linux for tailored proxy experience
    - language: **TypeScript** &nbsp;&nbsp; stars: **61,003** &nbsp;&nbsp; folks: **4,658**  &nbsp;&nbsp; `842 stars this week`
...
1. [xming521 / WeClone](https://github.com/xming521/WeClone)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **13,390** &nbsp;&nbsp; folks: **997**  &nbsp;&nbsp; `10,153 stars this month`

1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    - The Cursor for Designers • An Open-Source Visual Vibecoding Editor • Visually build, style, and edit your React App with AI
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,874** &nbsp;&nbsp; folks: **1,112**  &nbsp;&nbsp; `8,395 stars this month`

1. [mem0ai / mem0](https://github.com/mem0ai/mem0)
    - Memory for AI Agents; SOTA in AI Agent Memory; Announcing OpenMemory MCP - local and secure memory management.
    - language: **Python** &nbsp;&nbsp; stars: **34,120** &nbsp;&nbsp; folks: **3,389**  &nbsp;&nbsp; `5,267 stars this month`

1. [mindsdb / mindsdb](https://github.com/mindsdb/mindsdb)
    - AI's query engine - Platform for building AI that can answer questions over large scale federated data. - The only MCP Server you'll ever need
    - language: **Python** &nbsp;&nbsp; stars: **31,903** &nbsp;&nbsp; folks: **5,266**  &nbsp;&nbsp; `4,101 stars this month`

1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    - 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
    - language: **Python** &nbsp;&nbsp; stars: **36,196** &nbsp;&nbsp; folks: **5,152**  &nbsp;&nbsp; `8,312 stars this month`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **350,511** &nbsp;&nbsp; folks: **36,849**  &nbsp;&nbsp; `12,099 stars this month`
...
1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **35,420** &nbsp;&nbsp; folks: **6,156**  &nbsp;&nbsp; `8,435 stars this month`
...
1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    ...
    - language: **无** &nbsp;&nbsp; stars: **55,080** &nbsp;&nbsp; folks: **5,874**  &nbsp;&nbsp; `5,083 stars this month`
...
1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **128,402** &nbsp;&nbsp; folks: **17,019**  &nbsp;&nbsp; `4,471 stars this month`
