...
1. [nexus-xyz / network-api](https://github.com/nexus-xyz/network-api)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **446** &nbsp;&nbsp; folks: **182**  &nbsp;&nbsp; `26 stars today`

1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    - A simple screen parsing tool towards pure vision based GUI agent
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,389** &nbsp;&nbsp; folks: **1,164**  &nbsp;&nbsp; `1,795 stars today`

1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    - 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
    - language: **Python** &nbsp;&nbsp; stars: **23,352** &nbsp;&nbsp; folks: **3,421**  &nbsp;&nbsp; `464 stars today`

1. [hpcaitech / ColossalAI](https://github.com/hpcaitech/ColossalAI)
    - Making large AI models cheaper, faster and more accessible
    - language: **Python** &nbsp;&nbsp; stars: **40,146** &nbsp;&nbsp; folks: **4,455**  &nbsp;&nbsp; `255 stars today`

1. [NVIDIA / cutlass](https://github.com/NVIDIA/cutlass)
    - CUDA Templates for Linear Algebra Subroutines
    - language: **C++** &nbsp;&nbsp; stars: **6,320** &nbsp;&nbsp; folks: **1,079**  &nbsp;&nbsp; `16 stars today`
...
1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    - A simple screen parsing tool towards pure vision based GUI agent
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,389** &nbsp;&nbsp; folks: **1,164**  &nbsp;&nbsp; `9,283 stars this week`
...
1. [microsoft / data-formulator](https://github.com/microsoft/data-formulator)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,858** &nbsp;&nbsp; folks: **590**  &nbsp;&nbsp; `2,323 stars this week`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **70,232** &nbsp;&nbsp; folks: **10,230**  &nbsp;&nbsp; `3,460 stars this week`
...
1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    - 🚀🚀 「大模型」2小时完全从0训练26M的小参数GPT！🌏 Train a 26M-parameter GPT from scratch in just 2h!
    - language: **Python** &nbsp;&nbsp; stars: **11,257** &nbsp;&nbsp; folks: **1,178**  &nbsp;&nbsp; `2,223 stars this week`
...
1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    - 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
    - language: **Python** &nbsp;&nbsp; stars: **23,352** &nbsp;&nbsp; folks: **3,421**  &nbsp;&nbsp; `1,524 stars this week`

1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding.
    - language: **TypeScript** &nbsp;&nbsp; stars: **38,293** &nbsp;&nbsp; folks: **3,392**  &nbsp;&nbsp; `2,681 stars this week`

1. [vercel / ai-chatbot](https://github.com/vercel/ai-chatbot)
    - A full-featured, hackable Next.js AI chatbot built by Vercel
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,182** &nbsp;&nbsp; folks: **3,359**  &nbsp;&nbsp; `846 stars this week`
...
1. [labring / FastGPT](https://github.com/labring/FastGPT)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,480** &nbsp;&nbsp; folks: **5,524**  &nbsp;&nbsp; `662 stars this week`
...
1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **51,349** &nbsp;&nbsp; folks: **4,231**  &nbsp;&nbsp; `1,496 stars this week`
...
1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    - A simple screen parsing tool towards pure vision based GUI agent
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,389** &nbsp;&nbsp; folks: **1,164**  &nbsp;&nbsp; `9,432 stars this month`

1. [deepseek-ai / DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
    - DeepSeek Coder: Let the Code Write Itself
    - language: **Python** &nbsp;&nbsp; stars: **20,073** &nbsp;&nbsp; folks: **2,231**  &nbsp;&nbsp; `9,875 stars this month`

1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **128,139** &nbsp;&nbsp; folks: **10,429**  &nbsp;&nbsp; `19,909 stars this month`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **77,056** &nbsp;&nbsp; folks: **9,136**  &nbsp;&nbsp; `19,842 stars this month`
...
1. [unslothai / unsloth](https://github.com/unslothai/unsloth)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **31,036** &nbsp;&nbsp; folks: **2,062**  &nbsp;&nbsp; `10,135 stars this month`

1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    - Make websites accessible for AI agents
    - language: **Python** &nbsp;&nbsp; stars: **30,167** &nbsp;&nbsp; folks: **3,124**  &nbsp;&nbsp; `14,912 stars this month`
...
1. [Mintplex-Labs / anything-llm](https://github.com/Mintplex-Labs/anything-llm)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **38,185** &nbsp;&nbsp; folks: **3,679**  &nbsp;&nbsp; `7,741 stars this month`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **70,232** &nbsp;&nbsp; folks: **10,230**  &nbsp;&nbsp; `10,899 stars this month`

1. [Bin-Huang / chatbox](https://github.com/Bin-Huang/chatbox)
    - User-friendly Desktop Client App for AI Models/LLMs (GPT, Claude, Gemini, Ollama...)
    - language: **TypeScript** &nbsp;&nbsp; stars: **31,550** &nbsp;&nbsp; folks: **2,990**  &nbsp;&nbsp; `6,729 stars this month`
...
1. [ggml-org / llama.cpp](https://github.com/ggml-org/llama.cpp)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **74,873** &nbsp;&nbsp; folks: **10,819**  &nbsp;&nbsp; `4,219 stars this month`

1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **24,443** &nbsp;&nbsp; folks: **1,457**  &nbsp;&nbsp; `5,684 stars this month`
