...
`更新时间：2025-08-17 16:32:08 +0800`

## 今日热门仓库

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **6,871** &nbsp;&nbsp; folks: **1,371**  &nbsp;&nbsp; `273 stars today`

1. [microsoft / poml](https://github.com/microsoft/poml)
    - Prompt Orchestration Markup Language
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,967** &nbsp;&nbsp; folks: **123**  &nbsp;&nbsp; `252 stars today`
...
1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    ...
    - language: **Markdown** &nbsp;&nbsp; stars: **411,175** &nbsp;&nbsp; folks: **38,550**  &nbsp;&nbsp; `345 stars today`
...
1. [farhanashrafdev / 90DaysOfCyberSecurity](https://github.com/farhanashrafdev/90DaysOfCyberSecurity)
    ...
    - language: **无** &nbsp;&nbsp; stars: **11,004** &nbsp;&nbsp; folks: **1,234**  &nbsp;&nbsp; `279 stars today`

1. [jaywcjlove / awesome-mac](https://github.com/jaywcjlove/awesome-mac)
    -  Now we have become very big, Different from the original idea. Collect premium software in various categories.
    - language: **JavaScript** &nbsp;&nbsp; stars: **87,095** &nbsp;&nbsp; folks: **6,697**  &nbsp;&nbsp; `546 stars today`
...
1. [IBM / mcp-context-forge](https://github.com/IBM/mcp-context-forge)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,295** &nbsp;&nbsp; folks: **199**  &nbsp;&nbsp; `63 stars today`

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **4,247** &nbsp;&nbsp; folks: **422**  &nbsp;&nbsp; `411 stars today`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **3,736** &nbsp;&nbsp; folks: **156**  &nbsp;&nbsp; `248 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **58,440** &nbsp;&nbsp; folks: **6,990**  &nbsp;&nbsp; `479 stars today`
...
1. [dtyq / magic](https://github.com/dtyq/magic)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **2,073** &nbsp;&nbsp; folks: **235**  &nbsp;&nbsp; `55 stars today`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **6,871** &nbsp;&nbsp; folks: **1,371**  &nbsp;&nbsp; `791 stars this week`
...
1. [xiaoyaocz / dart_simple_live](https://github.com/xiaoyaocz/dart_simple_live)
    - 简简单单的看直播
    - language: **Dart** &nbsp;&nbsp; stars: **12,536** &nbsp;&nbsp; folks: **1,020**  &nbsp;&nbsp; `560 stars this week`
...
1. [umami-software / umami](https://github.com/umami-software/umami)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **30,069** &nbsp;&nbsp; folks: **5,389**  &nbsp;&nbsp; `2,248 stars this week`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,084** &nbsp;&nbsp; folks: **1,534**  &nbsp;&nbsp; `1,136 stars this week`

1. [idosal / git-mcp](https://github.com/idosal/git-mcp)
    - Put an end to code hallucinations! GitMCP is a free, open-source, remote MCP server for any GitHub project
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,308** &nbsp;&nbsp; folks: **395**  &nbsp;&nbsp; `1,139 stars this week`
...
1. [polarsource / polar](https://github.com/polarsource/polar)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,958** &nbsp;&nbsp; folks: **425**  &nbsp;&nbsp; `631 stars this week`
...
1. [jitsi / jitsi-meet](https://github.com/jitsi/jitsi-meet)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **26,696** &nbsp;&nbsp; folks: **7,369**  &nbsp;&nbsp; `509 stars this week`
...
1. [filamentphp / filament](https://github.com/filamentphp/filament)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **25,762** &nbsp;&nbsp; folks: **3,680**  &nbsp;&nbsp; `406 stars this week`
...
1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,121** &nbsp;&nbsp; folks: **1,255**  &nbsp;&nbsp; `11,151 stars this month`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Financial data aggregator for humans and AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **49,544** &nbsp;&nbsp; folks: **4,627**  &nbsp;&nbsp; `6,652 stars this month`
...
1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **14,077** &nbsp;&nbsp; folks: **1,509**  &nbsp;&nbsp; `4,385 stars this month`

1. [frappe / hrms](https://github.com/frappe/hrms)
    - Open Source HR and Payroll Software
    - language: **Python** &nbsp;&nbsp; stars: **6,256** &nbsp;&nbsp; folks: **1,555**  &nbsp;&nbsp; `3,502 stars this month`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **10,972** &nbsp;&nbsp; folks: **597**  &nbsp;&nbsp; `6,821 stars this month`

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **6,871** &nbsp;&nbsp; folks: **1,371**  &nbsp;&nbsp; `934 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,448** &nbsp;&nbsp; folks: **9,426**  &nbsp;&nbsp; `3,093 stars this month`
