...
1. [themactep / thingino-firmware](https://github.com/themactep/thingino-firmware)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **915** &nbsp;&nbsp; folks: **125**  &nbsp;&nbsp; `221 stars today`

1. [dstotijn / hetty](https://github.com/dstotijn/hetty)
    - An HTTP toolkit for security research.
    - language: **Go** &nbsp;&nbsp; stars: **7,624** &nbsp;&nbsp; folks: **432**  &nbsp;&nbsp; `154 stars today`
...
1. [9001 / copyparty](https://github.com/9001/copyparty)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **21,091** &nbsp;&nbsp; folks: **730**  &nbsp;&nbsp; `11,747 stars this week`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,266** &nbsp;&nbsp; folks: **980**  &nbsp;&nbsp; `5,875 stars this week`
...
1. [microsoft / mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,486** &nbsp;&nbsp; folks: **1,985**  &nbsp;&nbsp; `1,021 stars this week`

1. [cloudwego / eino](https://github.com/cloudwego/eino)
    - The ultimate LLM/AI application development framework in Golang.
    - language: **Go** &nbsp;&nbsp; stars: **6,499** &nbsp;&nbsp; folks: **502**  &nbsp;&nbsp; `911 stars this week`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **55,900** &nbsp;&nbsp; folks: **6,589**  &nbsp;&nbsp; `2,296 stars this week`

1. [charmbracelet / bubbletea](https://github.com/charmbracelet/bubbletea)
    - A powerful little TUI framework 🏗
    - language: **Go** &nbsp;&nbsp; stars: **33,986** &nbsp;&nbsp; folks: **962**  &nbsp;&nbsp; `327 stars this week`
...
1. [workadventure / workadventure](https://github.com/workadventure/workadventure)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,772** &nbsp;&nbsp; folks: **698**  &nbsp;&nbsp; `115 stars this week`
...
1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **95,183** &nbsp;&nbsp; folks: **13,930**  &nbsp;&nbsp; `1,064 stars this week`
...
1. [rasbt / LLMs-from-scratch](https://github.com/rasbt/LLMs-from-scratch)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **62,491** &nbsp;&nbsp; folks: **8,749**  &nbsp;&nbsp; `2,050 stars this week`

1. [comfyanonymous / ComfyUI](https://github.com/comfyanonymous/ComfyUI)
    - The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface.
    - language: **Python** &nbsp;&nbsp; stars: **84,599** &nbsp;&nbsp; folks: **9,385**  &nbsp;&nbsp; `729 stars this week`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,619** &nbsp;&nbsp; folks: **786**  &nbsp;&nbsp; `1,749 stars this week`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **48,390** &nbsp;&nbsp; folks: **4,454**  &nbsp;&nbsp; `6,091 stars this month`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,266** &nbsp;&nbsp; folks: **980**  &nbsp;&nbsp; `6,453 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,619** &nbsp;&nbsp; folks: **786**  &nbsp;&nbsp; `7,354 stars this month`
...
1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **8,941** &nbsp;&nbsp; folks: **649**  &nbsp;&nbsp; `7,198 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **28,272** &nbsp;&nbsp; folks: **1,591**  &nbsp;&nbsp; `10,733 stars this month`
...
1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **7,158** &nbsp;&nbsp; folks: **948**  &nbsp;&nbsp; `2,914 stars this month`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **8,899** &nbsp;&nbsp; folks: **462**  &nbsp;&nbsp; `6,085 stars this month`
...
1. [humanlayer / 12-factor-agents](https://github.com/humanlayer/12-factor-agents)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,671** &nbsp;&nbsp; folks: **784**  &nbsp;&nbsp; `5,882 stars this month`

1. [sst / opencode](https://github.com/sst/opencode)
    - AI coding agent, built for the terminal.
    - language: **Go** &nbsp;&nbsp; stars: **17,656** &nbsp;&nbsp; folks: **1,099**  &nbsp;&nbsp; `8,597 stars this month`
