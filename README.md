...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,145** &nbsp;&nbsp; folks: **1,436**  &nbsp;&nbsp; `207 stars today`

1. [FiloSottile / mkcert](https://github.com/FiloSottile/mkcert)
    - A simple zero-config tool to make locally trusted development certificates with any names you'd like.
    - language: **Go** &nbsp;&nbsp; stars: **55,823** &nbsp;&nbsp; folks: **2,918**  &nbsp;&nbsp; `327 stars today`
...
1. [conductor-oss / conductor](https://github.com/conductor-oss/conductor)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **25,376** &nbsp;&nbsp; folks: **667**  &nbsp;&nbsp; `283 stars today`

1. [microsoft / poml](https://github.com/microsoft/poml)
    - Prompt Orchestration Markup Language
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,757** &nbsp;&nbsp; folks: **57**  &nbsp;&nbsp; `755 stars today`
...
1. [x1xhlol / system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools)
    ...
    - language: **无** &nbsp;&nbsp; stars: **76,160** &nbsp;&nbsp; folks: **21,342**  &nbsp;&nbsp; `577 stars today`
...
1. [ollama / ollama](https://github.com/ollama/ollama)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **150,144** &nbsp;&nbsp; folks: **12,807**  &nbsp;&nbsp; `1,196 stars this week`
...
1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,748** &nbsp;&nbsp; folks: **1,205**  &nbsp;&nbsp; `2,501 stars this week`

1. [menloresearch / jan](https://github.com/menloresearch/jan)
    - Jan is an open source alternative to ChatGPT that runs 100% offline on your computer
    - language: **TypeScript** &nbsp;&nbsp; stars: **36,831** &nbsp;&nbsp; folks: **2,152**  &nbsp;&nbsp; `1,273 stars this week`

1. [patchy631 / ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)
    - In-depth tutorials on LLMs, RAGs and real-world AI agent applications.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **17,150** &nbsp;&nbsp; folks: **2,873**  &nbsp;&nbsp; `1,440 stars this week`
...
1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **55,162** &nbsp;&nbsp; folks: **9,362**  &nbsp;&nbsp; `935 stars this week`
...
1. [browserbase / stagehand](https://github.com/browserbase/stagehand)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,312** &nbsp;&nbsp; folks: **966**  &nbsp;&nbsp; `1,106 stars this week`

1. [datalab-to / surya](https://github.com/datalab-to/surya)
    - OCR, layout analysis, reading order, table recognition in 90+ languages
    - language: **Python** &nbsp;&nbsp; stars: **18,165** &nbsp;&nbsp; folks: **1,225**  &nbsp;&nbsp; `115 stars this week`
...
1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    - Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!
    - language: **Python** &nbsp;&nbsp; stars: **8,267** &nbsp;&nbsp; folks: **657**  &nbsp;&nbsp; `1,129 stars this week`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **106,605** &nbsp;&nbsp; folks: **14,387**  &nbsp;&nbsp; `1,134 stars this week`
...
1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,748** &nbsp;&nbsp; folks: **1,205**  &nbsp;&nbsp; `10,795 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,828** &nbsp;&nbsp; folks: **955**  &nbsp;&nbsp; `9,223 stars this month`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **7,584** &nbsp;&nbsp; folks: **1,001**  &nbsp;&nbsp; `3,239 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,480** &nbsp;&nbsp; folks: **569**  &nbsp;&nbsp; `6,628 stars this month`
...
1. [sst / opencode](https://github.com/sst/opencode)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **19,386** &nbsp;&nbsp; folks: **1,234**  &nbsp;&nbsp; `7,492 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,162** &nbsp;&nbsp; folks: **9,362**  &nbsp;&nbsp; `3,071 stars this month`
