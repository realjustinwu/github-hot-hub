...
`更新时间：2025-09-14 23:20:39 +0800`

## 今日热门仓库

1. [PowerShell / PowerShell](https://github.com/PowerShell/PowerShell)
    - PowerShell for every system!
    - language: **C#** &nbsp;&nbsp; stars: **49,293** &nbsp;&nbsp; folks: **7,885**  &nbsp;&nbsp; `691 stars today`

1. [trueadm / ripple](https://github.com/trueadm/ripple)
    - the elegant TypeScript UI framework
    - language: **JavaScript** &nbsp;&nbsp; stars: **4,392** &nbsp;&nbsp; folks: **156**  &nbsp;&nbsp; `311 stars today`
...
1. [SkyworkAI / DeepResearchAgent](https://github.com/SkyworkAI/DeepResearchAgent)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **1,760** &nbsp;&nbsp; folks: **274**  &nbsp;&nbsp; `84 stars today`

1. [ccxt / ccxt](https://github.com/ccxt/ccxt)
    - A cryptocurrency trading API with more than 100 exchanges in JavaScript / TypeScript / Python / C# / PHP / Go
    - language: **Python** &nbsp;&nbsp; stars: **38,108** &nbsp;&nbsp; folks: **8,162**  &nbsp;&nbsp; `40 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **68,288** &nbsp;&nbsp; folks: **8,591**  &nbsp;&nbsp; `364 stars today`

1. [ItzCrazyKns / Perplexica](https://github.com/ItzCrazyKns/Perplexica)
    - Perplexica is an AI-powered search engine. It is an Open source alternative to Perplexity AI
    - language: **TypeScript** &nbsp;&nbsp; stars: **24,170** &nbsp;&nbsp; folks: **2,536**  &nbsp;&nbsp; `31 stars today`
...
1. [ReVanced / revanced-patches](https://github.com/ReVanced/revanced-patches)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **4,451** &nbsp;&nbsp; folks: **551**  &nbsp;&nbsp; `185 stars today`
...
1. [modelcontextprotocol / registry](https://github.com/modelcontextprotocol/registry)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **4,069** &nbsp;&nbsp; folks: **306**  &nbsp;&nbsp; `1,841 stars this week`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **67,187** &nbsp;&nbsp; folks: **5,687**  &nbsp;&nbsp; `2,016 stars this week`

1. [firebase / genkit](https://github.com/firebase/genkit)
    - Google's multi-model AI framework in Javascript, Go and Python
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,337** &nbsp;&nbsp; folks: **402**  &nbsp;&nbsp; `446 stars this week`
...
1. [PowerShell / PowerShell](https://github.com/PowerShell/PowerShell)
    - PowerShell for every system!
    - language: **C#** &nbsp;&nbsp; stars: **49,293** &nbsp;&nbsp; folks: **7,885**  &nbsp;&nbsp; `337 stars this week`

1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    - 12 Lessons to Get Started Building AI Agents
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **38,346** &nbsp;&nbsp; folks: **12,350**  &nbsp;&nbsp; `1,882 stars this week`

1. [Zie619 / n8n-workflows](https://github.com/Zie619/n8n-workflows)
    - all of the workflows of n8n i could find (also from the site itself)
    - language: **HTML** &nbsp;&nbsp; stars: **29,668** &nbsp;&nbsp; folks: **1,304**  &nbsp;&nbsp; `2,990 stars this week`
...
1. [11cafe / jaaz](https://github.com/11cafe/jaaz)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,478** &nbsp;&nbsp; folks: **363**  &nbsp;&nbsp; `1,914 stars this week`
...
1. [trufflesecurity / trufflehog](https://github.com/trufflesecurity/trufflehog)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **21,630** &nbsp;&nbsp; folks: **2,029**  &nbsp;&nbsp; `648 stars this week`

1. [zama-ai / fhevm](https://github.com/zama-ai/fhevm)
    - FHEVM, a full-stack framework for integrating Fully Homomorphic Encryption (FHE) with blockchain applications
    - language: **Rust** &nbsp;&nbsp; stars: **18,818** &nbsp;&nbsp; folks: **789**  &nbsp;&nbsp; `1,672 stars this week`
...
1. [aaPanel / BillionMail](https://github.com/aaPanel/BillionMail)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **10,530** &nbsp;&nbsp; folks: **928**  &nbsp;&nbsp; `876 stars this week`

1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **40,667** &nbsp;&nbsp; folks: **4,739**  &nbsp;&nbsp; `1,586 stars this week`
...
1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **20,240** &nbsp;&nbsp; folks: **3,195**  &nbsp;&nbsp; `11,968 stars this month`
...
1. [plait-board / drawnix](https://github.com/plait-board/drawnix)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,239** &nbsp;&nbsp; folks: **846**  &nbsp;&nbsp; `7,032 stars this month`
...
1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **40,667** &nbsp;&nbsp; folks: **4,739**  &nbsp;&nbsp; `5,982 stars this month`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **68,288** &nbsp;&nbsp; folks: **8,591**  &nbsp;&nbsp; `10,979 stars this month`
...
1. [microsoft / qlib](https://github.com/microsoft/qlib)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **30,470** &nbsp;&nbsp; folks: **4,716**  &nbsp;&nbsp; `2,360 stars this month`
...
1. [trufflesecurity / trufflehog](https://github.com/trufflesecurity/trufflehog)
    - Find, verify, and analyze leaked credentials
    - language: **Go** &nbsp;&nbsp; stars: **21,630** &nbsp;&nbsp; folks: **2,029**  &nbsp;&nbsp; `1,396 stars this month`
