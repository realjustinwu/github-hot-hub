...
1. [codexu / note-gen](https://github.com/codexu/note-gen)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,686** &nbsp;&nbsp; folks: **232**  &nbsp;&nbsp; `337 stars today`

1. [scrapy / scrapy](https://github.com/scrapy/scrapy)
    - Scrapy, a fast high-level web crawling & scraping framework for Python.
    - language: **Python** &nbsp;&nbsp; stars: **56,575** &nbsp;&nbsp; folks: **10,897**  &nbsp;&nbsp; `54 stars today`
...
1. [DavidHDev / react-bits](https://github.com/DavidHDev/react-bits)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,978** &nbsp;&nbsp; folks: **482**  &nbsp;&nbsp; `122 stars today`

1. [jwohlwend / boltz](https://github.com/jwohlwend/boltz)
    - Official repository for the Boltz biomolecular interaction models
    - language: **Python** &nbsp;&nbsp; stars: **2,048** &nbsp;&nbsp; folks: **331**  &nbsp;&nbsp; `90 stars today`

1. [deepsense-ai / ragbits](https://github.com/deepsense-ai/ragbits)
    - Building blocks for rapid development of GenAI applications
    - language: **Python** &nbsp;&nbsp; stars: **1,066** &nbsp;&nbsp; folks: **83**  &nbsp;&nbsp; `239 stars today`

1. [stanfordnlp / dspy](https://github.com/stanfordnlp/dspy)
    - DSPy: The framework for programming—not prompting—language models
    - language: **Python** &nbsp;&nbsp; stars: **25,016** &nbsp;&nbsp; folks: **1,940**  &nbsp;&nbsp; `154 stars today`
...
1. [Daymychen / art-design-pro](https://github.com/Daymychen/art-design-pro)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **1,800** &nbsp;&nbsp; folks: **307**  &nbsp;&nbsp; `38 stars today`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **101,958** &nbsp;&nbsp; folks: **15,306**  &nbsp;&nbsp; `459 stars today`

1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **无** &nbsp;&nbsp; stars: **54,822** &nbsp;&nbsp; folks: **5,840**  &nbsp;&nbsp; `205 stars today`

1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    - A collective list of free APIs
    - language: **Python** &nbsp;&nbsp; stars: **350,039** &nbsp;&nbsp; folks: **36,797**  &nbsp;&nbsp; `237 stars today`

1. [langchain4j / langchain4j](https://github.com/langchain4j/langchain4j)
    - Java version of LangChain
    - language: **Java** &nbsp;&nbsp; stars: **7,872** &nbsp;&nbsp; folks: **1,443**  &nbsp;&nbsp; `11 stars today`

1. [iib0011 / omni-tools](https://github.com/iib0011/omni-tools)
    - Self-hosted collection of powerful web-based tools for everyday tasks. No ads, no tracking, just fast, accessible utilities right from your browser!
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,802** &nbsp;&nbsp; folks: **121**  &nbsp;&nbsp; `352 stars today`

1. [vinta / awesome-python](https://github.com/vinta/awesome-python)
    - An opinionated list of awesome Python frameworks, libraries, software and resources.
    - language: **Python** &nbsp;&nbsp; stars: **245,922** &nbsp;&nbsp; folks: **25,764**  &nbsp;&nbsp; `145 stars today`

1. [alphacep / vosk-api](https://github.com/alphacep/vosk-api)
    - Offline speech recognition API for Android, iOS, Raspberry Pi and servers with Python, Java, C# and Node
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **10,049** &nbsp;&nbsp; folks: **1,310**  &nbsp;&nbsp; `40 stars today`
...
1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,228** &nbsp;&nbsp; folks: **1,033**  &nbsp;&nbsp; `2,193 stars this week`

1. [anthropics / prompt-eng-interactive-tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial)
    - Anthropic's Interactive Prompt Engineering Tutorial
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **11,081** &nbsp;&nbsp; folks: **1,010**  &nbsp;&nbsp; `4,546 stars this week`
...
1. [Fosowl / agenticSeek](https://github.com/Fosowl/agenticSeek)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,311** &nbsp;&nbsp; folks: **1,628**  &nbsp;&nbsp; `3,349 stars this week`
...
1. [netbirdio / netbird](https://github.com/netbirdio/netbird)
    - Connect your devices into a secure WireGuard®-based overlay network with SSO, MFA and granular access controls.
    - language: **Go** &nbsp;&nbsp; stars: **15,057** &nbsp;&nbsp; folks: **708**  &nbsp;&nbsp; `1,104 stars this week`
...
1. [MervinPraison / PraisonAI](https://github.com/MervinPraison/PraisonAI)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,804** &nbsp;&nbsp; folks: **664**  &nbsp;&nbsp; `489 stars this week`

1. [block / goose](https://github.com/block/goose)
    - an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM
    - language: **Rust** &nbsp;&nbsp; stars: **14,128** &nbsp;&nbsp; folks: **1,112**  &nbsp;&nbsp; `860 stars this week`
...
1. [scrapy / scrapy](https://github.com/scrapy/scrapy)
    - Scrapy, a fast high-level web crawling & scraping framework for Python.
    - language: **Python** &nbsp;&nbsp; stars: **56,575** &nbsp;&nbsp; folks: **10,897**  &nbsp;&nbsp; `1,007 stars this week`
...
1. [Fosowl / agenticSeek](https://github.com/Fosowl/agenticSeek)
    - Fully Local Manus AI. No APIs, No $200 monthly bills. Enjoy an autonomous agent that thinks, browses the web, and code for the sole cost of electricity. 🔔 Official updates only via twitter @Martin993886460. Any other account is fake.
    - language: **Python** &nbsp;&nbsp; stars: **17,311** &nbsp;&nbsp; folks: **1,628**  &nbsp;&nbsp; `15,093 stars this month`
...
1. [xming521 / WeClone](https://github.com/xming521/WeClone)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **13,236** &nbsp;&nbsp; folks: **988**  &nbsp;&nbsp; `10,171 stars this month`

1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    - 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
    - language: **Python** &nbsp;&nbsp; stars: **35,910** &nbsp;&nbsp; folks: **5,099**  &nbsp;&nbsp; `9,022 stars this month`

1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    - The Cursor for Designers • An Open-Source Visual Vibecoding Editor • Visually build, style, and edit your React App with AI
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,258** &nbsp;&nbsp; folks: **1,064**  &nbsp;&nbsp; `7,895 stars this month`

1. [mindsdb / mindsdb](https://github.com/mindsdb/mindsdb)
    - AI's query engine - Platform for building AI that can answer questions over large scale federated data. - The only MCP Server you'll ever need
    - language: **Python** &nbsp;&nbsp; stars: **31,782** &nbsp;&nbsp; folks: **5,248**  &nbsp;&nbsp; `3,999 stars this month`
...
1. [microsoft / qlib](https://github.com/microsoft/qlib)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **24,500** &nbsp;&nbsp; folks: **3,786**  &nbsp;&nbsp; `5,522 stars this month`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **326,443** &nbsp;&nbsp; folks: **42,006**  &nbsp;&nbsp; `9,174 stars this month`
...
1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **无** &nbsp;&nbsp; stars: **54,822** &nbsp;&nbsp; folks: **5,840**  &nbsp;&nbsp; `4,861 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **11,741** &nbsp;&nbsp; folks: **652**  &nbsp;&nbsp; `3,402 stars this month`
...
1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **35,088** &nbsp;&nbsp; folks: **6,108**  &nbsp;&nbsp; `8,206 stars this month`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    - A collective list of free APIs
    - language: **Python** &nbsp;&nbsp; stars: **350,039** &nbsp;&nbsp; folks: **36,797**  &nbsp;&nbsp; `11,566 stars this month`
