...
1. [kestra-io / kestra](https://github.com/kestra-io/kestra)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **20,770** &nbsp;&nbsp; folks: **1,768**  &nbsp;&nbsp; `203 stars today`

1. [AI4Finance-Foundation / FinGPT](https://github.com/AI4Finance-Foundation/FinGPT)
    - FinGPT: Open-Source Financial Large Language Models! Revolutionize 🔥 We release the trained model on HuggingFace.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **17,230** &nbsp;&nbsp; folks: **2,466**  &nbsp;&nbsp; `49 stars today`
...
1. [apache / airflow](https://github.com/apache/airflow)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **41,899** &nbsp;&nbsp; folks: **15,525**  &nbsp;&nbsp; `22 stars today`

1. [wazuh / wazuh](https://github.com/wazuh/wazuh)
    - Wazuh - The Open Source Security Platform. Unified XDR and SIEM protection for endpoints and cloud workloads.
    - language: **C** &nbsp;&nbsp; stars: **13,284** &nbsp;&nbsp; folks: **1,959**  &nbsp;&nbsp; `14 stars today`
...
1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    - Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,047** &nbsp;&nbsp; folks: **520**  &nbsp;&nbsp; `1,696 stars this week`
...
1. [dotnet / eShop](https://github.com/dotnet/eShop)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **8,935** &nbsp;&nbsp; folks: **3,016**  &nbsp;&nbsp; `203 stars this week`

1. [HKUDS / DeepCode](https://github.com/HKUDS/DeepCode)
    - "DeepCode: Open Agentic Coding (Paper2Code & Text2Web & Text2Backend)"
    - language: **Python** &nbsp;&nbsp; stars: **5,581** &nbsp;&nbsp; folks: **710**  &nbsp;&nbsp; `1,161 stars this week`
...
1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **8,754** &nbsp;&nbsp; folks: **264**  &nbsp;&nbsp; `5,295 stars this month`

1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Open-source platform to build and deploy AI agent workflows.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,151** &nbsp;&nbsp; folks: **1,717**  &nbsp;&nbsp; `7,811 stars this month`

1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **38,756** &nbsp;&nbsp; folks: **4,473**  &nbsp;&nbsp; `6,960 stars this month`
...
1. [oraios / serena](https://github.com/oraios/serena)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,517** &nbsp;&nbsp; folks: **801**  &nbsp;&nbsp; `4,245 stars this month`
