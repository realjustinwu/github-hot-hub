...
1. [QuentinFuxa / WhisperLiveKit](https://github.com/QuentinFuxa/WhisperLiveKit)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,175** &nbsp;&nbsp; folks: **314**  &nbsp;&nbsp; `272 stars today`

1. [microsoft / mcp](https://github.com/microsoft/mcp)
    - Catalog of official Microsoft MCP (Model Context Protocol) server implementations for AI-powered data access and tool integration
    - language: **C#** &nbsp;&nbsp; stars: **1,252** &nbsp;&nbsp; folks: **115**  &nbsp;&nbsp; `74 stars today`
...
1. [Canner / WrenAI](https://github.com/Canner/WrenAI)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,826** &nbsp;&nbsp; folks: **1,094**  &nbsp;&nbsp; `547 stars today`

1. [OpenBMB / MiniCPM-V](https://github.com/OpenBMB/MiniCPM-V)
    - MiniCPM-V 4.5: A GPT-4o Level MLLM for Single Image, Multi Image and High-FPS Video Understanding on Your Phone
    - language: **Python** &nbsp;&nbsp; stars: **20,506** &nbsp;&nbsp; folks: **1,500**  &nbsp;&nbsp; `73 stars today`

1. [twbs / bootstrap](https://github.com/twbs/bootstrap)
    - The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web.
    - language: **MDX** &nbsp;&nbsp; stars: **173,241** &nbsp;&nbsp; folks: **79,151**  &nbsp;&nbsp; `126 stars today`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **205,196** &nbsp;&nbsp; folks: **47,557**  &nbsp;&nbsp; `195 stars today`
...
1. [humanlayer / humanlayer](https://github.com/humanlayer/humanlayer)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,530** &nbsp;&nbsp; folks: **147**  &nbsp;&nbsp; `57 stars today`

1. [nats-io / nats-server](https://github.com/nats-io/nats-server)
    - High-Performance server for NATS.io, the cloud and edge native messaging system.
    - language: **Go** &nbsp;&nbsp; stars: **18,015** &nbsp;&nbsp; folks: **1,625**  &nbsp;&nbsp; `26 stars today`
...
1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **17,188** &nbsp;&nbsp; folks: **2,816**  &nbsp;&nbsp; `2,081 stars today`
...
1. [opf / openproject](https://github.com/opf/openproject)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **12,456** &nbsp;&nbsp; folks: **2,782**  &nbsp;&nbsp; `235 stars today`
...
1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **96,711** &nbsp;&nbsp; folks: **14,197**  &nbsp;&nbsp; `87 stars today`

1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **无** &nbsp;&nbsp; stars: **60,940** &nbsp;&nbsp; folks: **6,643**  &nbsp;&nbsp; `188 stars today`
...
1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    - Collection of extracted System Prompts from popular chatbots like ChatGPT, Claude & Gemini
    - language: **JavaScript** &nbsp;&nbsp; stars: **17,188** &nbsp;&nbsp; folks: **2,816**  &nbsp;&nbsp; `8,467 stars this week`

1. [plait-board / drawnix](https://github.com/plait-board/drawnix)
    - 开源白板工具（SaaS），一体化白板，包含思维导图、流程图、自由画等。All in one open-source whiteboard tool with mind, flowchart, freehand and etc.
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,883** &nbsp;&nbsp; folks: **717**  &nbsp;&nbsp; `4,826 stars this week`

1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **11,796** &nbsp;&nbsp; folks: **929**  &nbsp;&nbsp; `5,324 stars this week`
...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,991** &nbsp;&nbsp; folks: **1,514**  &nbsp;&nbsp; `2,337 stars this week`
...
1. [twbs / bootstrap](https://github.com/twbs/bootstrap)
    - The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web.
    - language: **MDX** &nbsp;&nbsp; stars: **173,241** &nbsp;&nbsp; folks: **79,151**  &nbsp;&nbsp; `354 stars this week`
...
1. [microsoft / qlib](https://github.com/microsoft/qlib)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **29,273** &nbsp;&nbsp; folks: **4,520**  &nbsp;&nbsp; `553 stars this week`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,177** &nbsp;&nbsp; folks: **1,928**  &nbsp;&nbsp; `5,980 stars this month`

1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **11,796** &nbsp;&nbsp; folks: **929**  &nbsp;&nbsp; `10,025 stars this month`

1. [charmbracelet / crush](https://github.com/charmbracelet/crush)
    - The glamourous AI coding agent for your favourite terminal 💘
    - language: **Go** &nbsp;&nbsp; stars: **11,217** &nbsp;&nbsp; folks: **546**  &nbsp;&nbsp; `11,145 stars this month`
...
1. [plait-board / drawnix](https://github.com/plait-board/drawnix)
    - 开源白板工具（SaaS），一体化白板，包含思维导图、流程图、自由画等。All in one open-source whiteboard tool with mind, flowchart, freehand and etc.
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,883** &nbsp;&nbsp; folks: **717**  &nbsp;&nbsp; `6,830 stars this month`

1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Sim is an open-source AI agent workflow builder. Sim's interface is a lightweight, intuitive way to rapidly build and deploy LLMs that connect with your favorite tools.
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,991** &nbsp;&nbsp; folks: **1,514**  &nbsp;&nbsp; `6,780 stars this month`

1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    - Collection of extracted System Prompts from popular chatbots like ChatGPT, Claude & Gemini
    - language: **JavaScript** &nbsp;&nbsp; stars: **17,188** &nbsp;&nbsp; folks: **2,816**  &nbsp;&nbsp; `9,005 stars this month`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **37,374** &nbsp;&nbsp; folks: **4,296**  &nbsp;&nbsp; `5,959 stars this month`

1. [9001 / copyparty](https://github.com/9001/copyparty)
    - Portable file server with accelerated resumable uploads, dedup, WebDAV, FTP, TFTP, zeroconf, media indexer, thumbnails++ all in one file, no deps
    - language: **Python** &nbsp;&nbsp; stars: **27,743** &nbsp;&nbsp; folks: **1,040**  &nbsp;&nbsp; `18,691 stars this month`
