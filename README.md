...
`更新时间：2024-12-22 22:18:39 +0800`

## 今日热门仓库

1. [nicbarker / clay](https://github.com/nicbarker/clay)
    - High performance UI layout library in C.
    - language: **C** &nbsp;&nbsp; stars: **4,904** &nbsp;&nbsp; folks: **129**  &nbsp;&nbsp; `1,532 stars today`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **280,737** &nbsp;&nbsp; folks: **47,004**  &nbsp;&nbsp; `440 stars today`

1. [Genesis-Embodied-AI / Genesis](https://github.com/Genesis-Embodied-AI/Genesis)
    - A generative world for general-purpose robotics & embodied AI learning.
    - language: **Python** &nbsp;&nbsp; stars: **17,262** &nbsp;&nbsp; folks: **1,207**  &nbsp;&nbsp; `1,320 stars today`

1. [tldraw / tldraw](https://github.com/tldraw/tldraw)
    - whiteboard / infinite canvas SDK
    - language: **TypeScript** &nbsp;&nbsp; stars: **36,922** &nbsp;&nbsp; folks: **2,261**  &nbsp;&nbsp; `312 stars today`
...
1. [bytedance / monolith](https://github.com/bytedance/monolith)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,905** &nbsp;&nbsp; folks: **277**  &nbsp;&nbsp; `306 stars today`
...
1. [anthropics / anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **7,732** &nbsp;&nbsp; folks: **951**  &nbsp;&nbsp; `200 stars today`

1. [taichi-dev / taichi](https://github.com/taichi-dev/taichi)
    - Productive, portable, and performant GPU programming in Python.
    - language: **C++** &nbsp;&nbsp; stars: **26,201** &nbsp;&nbsp; folks: **2,304**  &nbsp;&nbsp; `130 stars today`

1. [gorhill / uBlock](https://github.com/gorhill/uBlock)
    - uBlock Origin - An efficient blocker for Chromium and Firefox. Fast and lean.
    - language: **JavaScript** &nbsp;&nbsp; stars: **48,226** &nbsp;&nbsp; folks: **3,186**  &nbsp;&nbsp; `118 stars today`

1. [Helicone / helicone](https://github.com/Helicone/helicone)
    - 🧊 Open source LLM observability platform. One line of code to monitor, evaluate, and experiment. YC W23 🍓
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,550** &nbsp;&nbsp; folks: **277**  &nbsp;&nbsp; `138 stars today`

1. [Zipstack / unstract](https://github.com/Zipstack/unstract)
    - No-code LLM Platform to launch APIs and ETL Pipelines to structure unstructured documents
    - language: **Python** &nbsp;&nbsp; stars: **2,820** &nbsp;&nbsp; folks: **177**  &nbsp;&nbsp; `173 stars today`
...
1. [browserbase / stagehand](https://github.com/browserbase/stagehand)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,960** &nbsp;&nbsp; folks: **83**  &nbsp;&nbsp; `114 stars today`

1. [shardeum / shardeum](https://github.com/shardeum/shardeum)
    - Shardeum is an EVM based autoscaling blockchain
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,507** &nbsp;&nbsp; folks: **481**  &nbsp;&nbsp; `797 stars today`
...
1. [google-gemini / cookbook](https://github.com/google-gemini/cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **9,180** &nbsp;&nbsp; folks: **1,084**  &nbsp;&nbsp; `3,214 stars this week`
...
1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,305** &nbsp;&nbsp; folks: **719**  &nbsp;&nbsp; `3,825 stars this week`
...
1. [wavetermdev / waveterm](https://github.com/wavetermdev/waveterm)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,439** &nbsp;&nbsp; folks: **215**  &nbsp;&nbsp; `2,006 stars this week`
...
1. [0xPlaygrounds / rig](https://github.com/0xPlaygrounds/rig)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **1,322** &nbsp;&nbsp; folks: **105**  &nbsp;&nbsp; `387 stars this week`
...
1. [bigskysoftware / htmx](https://github.com/bigskysoftware/htmx)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **41,601** &nbsp;&nbsp; folks: **1,350**  &nbsp;&nbsp; `2,582 stars this week`

1. [shardeum / shardeum](https://github.com/shardeum/shardeum)
    - Shardeum is an EVM based autoscaling blockchain
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,507** &nbsp;&nbsp; folks: **481**  &nbsp;&nbsp; `3,395 stars this week`

1. [Lissy93 / dashy](https://github.com/Lissy93/dashy)
    - 🚀 A self-hostable personal dashboard built for you. Includes status-checking, widgets, themes, icon packs, a UI editor and tons more!
    - language: **Vue** &nbsp;&nbsp; stars: **18,661** &nbsp;&nbsp; folks: **1,406**  &nbsp;&nbsp; `290 stars this week`

1. [anthropics / anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook)
    - A collection of notebooks/recipes showcasing some fun and effective ways of using Claude.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **7,732** &nbsp;&nbsp; folks: **951**  &nbsp;&nbsp; `344 stars this week`

1. [ByteByteGoHq / system-design-101](https://github.com/ByteByteGoHq/system-design-101)
    - Explain complex systems using visuals and simple terms. Help you prepare for system design interviews.
    - language: **无** &nbsp;&nbsp; stars: **66,822** &nbsp;&nbsp; folks: **7,013**  &nbsp;&nbsp; `1,665 stars this week`
...
1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    - PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/Docker
    - language: **Python** &nbsp;&nbsp; stars: **10,305** &nbsp;&nbsp; folks: **719**  &nbsp;&nbsp; `7,553 stars this month`

1. [google-gemini / cookbook](https://github.com/google-gemini/cookbook)
    - Examples and guides for using the Gemini API
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **9,180** &nbsp;&nbsp; folks: **1,084**  &nbsp;&nbsp; `3,711 stars this month`
...
1. [krahets / hello-algo](https://github.com/krahets/hello-algo)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **103,904** &nbsp;&nbsp; folks: **13,029**  &nbsp;&nbsp; `4,861 stars this month`

1. [langflow-ai / langflow](https://github.com/langflow-ai/langflow)
    - Langflow is a low-code app builder for RAG and multi-agent AI applications. It’s Python-based and agnostic to any model, API, or database.
    - language: **Python** &nbsp;&nbsp; stars: **40,103** &nbsp;&nbsp; folks: **4,529**  &nbsp;&nbsp; `5,112 stars this month`
...
1. [lobehub / lobe-chat](https://github.com/lobehub/lobe-chat)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **49,333** &nbsp;&nbsp; folks: **10,707**  &nbsp;&nbsp; `4,746 stars this month`
...
1. [DS4SD / docling](https://github.com/DS4SD/docling)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,146** &nbsp;&nbsp; folks: **827**  &nbsp;&nbsp; `5,731 stars this month`

1. [seleniumbase / SeleniumBase](https://github.com/seleniumbase/SeleniumBase)
    - Python APIs for web automation, testing, and bypassing bot-detection.
    - language: **Python** &nbsp;&nbsp; stars: **7,540** &nbsp;&nbsp; folks: **1,061**  &nbsp;&nbsp; `1,911 stars this month`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **342,320** &nbsp;&nbsp; folks: **62,065**  &nbsp;&nbsp; `4,222 stars this month`
...
1. [Guovin / iptv-api](https://github.com/Guovin/iptv-api)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,713** &nbsp;&nbsp; folks: **2,065**  &nbsp;&nbsp; `3,821 stars this month`
