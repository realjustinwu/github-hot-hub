...
1. [codexu / note-gen](https://github.com/codexu/note-gen)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,629** &nbsp;&nbsp; folks: **229**  &nbsp;&nbsp; `337 stars today`

1. [scrapy / scrapy](https://github.com/scrapy/scrapy)
    - Scrapy, a fast high-level web crawling & scraping framework for Python.
    - language: **Python** &nbsp;&nbsp; stars: **56,493** &nbsp;&nbsp; folks: **10,896**  &nbsp;&nbsp; `54 stars today`
...
1. [DavidHDev / react-bits](https://github.com/DavidHDev/react-bits)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,913** &nbsp;&nbsp; folks: **481**  &nbsp;&nbsp; `122 stars today`
...
1. [deepsense-ai / ragbits](https://github.com/deepsense-ai/ragbits)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,041** &nbsp;&nbsp; folks: **80**  &nbsp;&nbsp; `239 stars today`
...
1. [Daymychen / art-design-pro](https://github.com/Daymychen/art-design-pro)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **1,775** &nbsp;&nbsp; folks: **305**  &nbsp;&nbsp; `38 stars today`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **101,879** &nbsp;&nbsp; folks: **15,302**  &nbsp;&nbsp; `459 stars today`

1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **无** &nbsp;&nbsp; stars: **54,787** &nbsp;&nbsp; folks: **5,839**  &nbsp;&nbsp; `205 stars today`

1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    - A collective list of free APIs
    - language: **Python** &nbsp;&nbsp; stars: **349,955** &nbsp;&nbsp; folks: **36,792**  &nbsp;&nbsp; `237 stars today`
...
1. [iib0011 / omni-tools](https://github.com/iib0011/omni-tools)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,743** &nbsp;&nbsp; folks: **115**  &nbsp;&nbsp; `352 stars today`

1. [vinta / awesome-python](https://github.com/vinta/awesome-python)
    - An opinionated list of awesome Python frameworks, libraries, software and resources.
    - language: **Python** &nbsp;&nbsp; stars: **245,885** &nbsp;&nbsp; folks: **25,763**  &nbsp;&nbsp; `145 stars today`

1. [alphacep / vosk-api](https://github.com/alphacep/vosk-api)
    - Offline speech recognition API for Android, iOS, Raspberry Pi and servers with Python, Java, C# and Node
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **10,007** &nbsp;&nbsp; folks: **1,307**  &nbsp;&nbsp; `40 stars today`
...
1. [frdel / agent-zero](https://github.com/frdel/agent-zero)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,132** &nbsp;&nbsp; folks: **1,791**  &nbsp;&nbsp; `2,239 stars this week`

1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    - A high-performance algorithmic trading platform and event-driven backtester
    - language: **Python** &nbsp;&nbsp; stars: **8,212** &nbsp;&nbsp; folks: **1,031**  &nbsp;&nbsp; `2,193 stars this week`

1. [anthropics / prompt-eng-interactive-tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial)
    - Anthropic's Interactive Prompt Engineering Tutorial
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **11,008** &nbsp;&nbsp; folks: **1,006**  &nbsp;&nbsp; `4,546 stars this week`

1. [anthropics / courses](https://github.com/anthropics/courses)
    - Anthropic's educational courses
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **14,771** &nbsp;&nbsp; folks: **1,260**  &nbsp;&nbsp; `2,159 stars this week`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **304,725** &nbsp;&nbsp; folks: **50,405**  &nbsp;&nbsp; `3,314 stars this week`
...
1. [Fosowl / agenticSeek](https://github.com/Fosowl/agenticSeek)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,281** &nbsp;&nbsp; folks: **1,624**  &nbsp;&nbsp; `3,349 stars this week`

1. [imputnet / cobalt](https://github.com/imputnet/cobalt)
    - best way to save what you love
    - language: **Svelte** &nbsp;&nbsp; stars: **33,803** &nbsp;&nbsp; folks: **2,801**  &nbsp;&nbsp; `1,265 stars this week`

1. [netbirdio / netbird](https://github.com/netbirdio/netbird)
    - Connect your devices into a secure WireGuard®-based overlay network with SSO, MFA and granular access controls.
    - language: **Go** &nbsp;&nbsp; stars: **15,022** &nbsp;&nbsp; folks: **707**  &nbsp;&nbsp; `1,104 stars this week`
...
1. [MervinPraison / PraisonAI](https://github.com/MervinPraison/PraisonAI)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,795** &nbsp;&nbsp; folks: **663**  &nbsp;&nbsp; `489 stars this week`

1. [block / goose](https://github.com/block/goose)
    - an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM
    - language: **Rust** &nbsp;&nbsp; stars: **14,124** &nbsp;&nbsp; folks: **1,110**  &nbsp;&nbsp; `860 stars this week`

1. [datawhalechina / self-llm](https://github.com/datawhalechina/self-llm)
    - 《开源大模型食用指南》针对中国宝宝量身打造的基于Linux环境快速微调（全参数/Lora）、部署国内外开源大模型（LLM）/多模态大模型（MLLM）教程
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,385** &nbsp;&nbsp; folks: **1,807**  &nbsp;&nbsp; `609 stars this week`

1. [scrapy / scrapy](https://github.com/scrapy/scrapy)
    - Scrapy, a fast high-level web crawling & scraping framework for Python.
    - language: **Python** &nbsp;&nbsp; stars: **56,493** &nbsp;&nbsp; folks: **10,896**  &nbsp;&nbsp; `1,007 stars this week`
...
1. [Fosowl / agenticSeek](https://github.com/Fosowl/agenticSeek)
    - Fully Local Manus AI. No APIs, No $200 monthly bills. Enjoy an autonomous agent that thinks, browses the web, and code for the sole cost of electricity. 🔔 Official updates only via twitter @Martin993886460. Any other account is fake.
    - language: **Python** &nbsp;&nbsp; stars: **17,281** &nbsp;&nbsp; folks: **1,624**  &nbsp;&nbsp; `15,093 stars this month`
...
1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **35,886** &nbsp;&nbsp; folks: **5,095**  &nbsp;&nbsp; `9,022 stars this month`

1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    - The Cursor for Designers • An Open-Source Visual Vibecoding Editor • Visually build, style, and edit your React App with AI
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,200** &nbsp;&nbsp; folks: **1,059**  &nbsp;&nbsp; `7,895 stars this month`

1. [mindsdb / mindsdb](https://github.com/mindsdb/mindsdb)
    - AI's query engine - Platform for building AI that can answer questions over large scale federated data. - The only MCP Server you'll ever need
    - language: **Python** &nbsp;&nbsp; stars: **31,770** &nbsp;&nbsp; folks: **5,245**  &nbsp;&nbsp; `3,999 stars this month`

1. [mem0ai / mem0](https://github.com/mem0ai/mem0)
    - Memory for AI Agents; SOTA in AI Agent Memory; Announcing OpenMemory MCP - local and secure memory management.
    - language: **Python** &nbsp;&nbsp; stars: **33,949** &nbsp;&nbsp; folks: **3,363**  &nbsp;&nbsp; `5,272 stars this month`
...
1. [bytedance / flowgram.ai](https://github.com/bytedance/flowgram.ai)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,953** &nbsp;&nbsp; folks: **353**  &nbsp;&nbsp; `3,750 stars this month`

1. [voideditor / void](https://github.com/voideditor/void)
    - 无
    - language: **TypeScript** &nbsp;&nbsp; stars: **23,195** &nbsp;&nbsp; folks: **1,511**  &nbsp;&nbsp; `10,721 stars this month`

1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
    - language: **TypeScript** &nbsp;&nbsp; stars: **326,417** &nbsp;&nbsp; folks: **42,004**  &nbsp;&nbsp; `9,174 stars this month`
...
1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **无** &nbsp;&nbsp; stars: **54,787** &nbsp;&nbsp; folks: **5,839**  &nbsp;&nbsp; `4,861 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **11,722** &nbsp;&nbsp; folks: **651**  &nbsp;&nbsp; `3,402 stars this month`

1. [anthropics / courses](https://github.com/anthropics/courses)
    - Anthropic's educational courses
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **14,771** &nbsp;&nbsp; folks: **1,260**  &nbsp;&nbsp; `3,382 stars this month`

1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    - An AI Hedge Fund Team
    - language: **Python** &nbsp;&nbsp; stars: **35,065** &nbsp;&nbsp; folks: **6,101**  &nbsp;&nbsp; `8,206 stars this month`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Build like a team of hundreds_
    - language: **TypeScript** &nbsp;&nbsp; stars: **51,015** &nbsp;&nbsp; folks: **4,469**  &nbsp;&nbsp; `2,708 stars this month`

1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    - This repo includes ChatGPT prompt curation to use ChatGPT and other LLM tools better.
    - language: **JavaScript** &nbsp;&nbsp; stars: **128,219** &nbsp;&nbsp; folks: **17,002**  &nbsp;&nbsp; `4,412 stars this month`

1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    - A collective list of free APIs
    - language: **Python** &nbsp;&nbsp; stars: **349,955** &nbsp;&nbsp; folks: **36,792**  &nbsp;&nbsp; `11,566 stars this month`
