...
1. [ed-donner / llm_engineering](https://github.com/ed-donner/llm_engineering)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **2,771** &nbsp;&nbsp; folks: **2,270**  &nbsp;&nbsp; `154 stars today`

1. [junegunn / fzf](https://github.com/junegunn/fzf)
    - 🌸 A command-line fuzzy finder
    - language: **Go** &nbsp;&nbsp; stars: **71,641** &nbsp;&nbsp; folks: **2,540**  &nbsp;&nbsp; `40 stars today`
...
1. [zaidmukaddam / scira](https://github.com/zaidmukaddam/scira)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,609** &nbsp;&nbsp; folks: **1,173**  &nbsp;&nbsp; `990 stars this week`

1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    - MCP Toolbox for Databases is an open source MCP server for databases.
    - language: **Go** &nbsp;&nbsp; stars: **3,429** &nbsp;&nbsp; folks: **299**  &nbsp;&nbsp; `1,056 stars this week`
...
1. [GyulyVGC / sniffnet](https://github.com/GyulyVGC/sniffnet)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **27,405** &nbsp;&nbsp; folks: **890**  &nbsp;&nbsp; `1,805 stars this week`

1. [LadybirdBrowser / ladybird](https://github.com/LadybirdBrowser/ladybird)
    - Truly independent web browser
    - language: **C++** &nbsp;&nbsp; stars: **45,054** &nbsp;&nbsp; folks: **1,921**  &nbsp;&nbsp; `1,007 stars this week`

1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    - Master programming by recreating your favorite technologies from scratch.
    - language: **Markdown** &nbsp;&nbsp; stars: **397,602** &nbsp;&nbsp; folks: **37,119**  &nbsp;&nbsp; `4,170 stars this week`
...
1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **74,148** &nbsp;&nbsp; folks: **16,318**  &nbsp;&nbsp; `654 stars this week`
...
1. [Infisical / infisical](https://github.com/Infisical/infisical)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,705** &nbsp;&nbsp; folks: **1,248**  &nbsp;&nbsp; `503 stars this week`

1. [directus / directus](https://github.com/directus/directus)
    - The flexible backend for all your projects 🐰 Turn your DB into a headless CMS, admin panels, or apps with a custom UI, instant APIs, auth & more.
    - language: **TypeScript** &nbsp;&nbsp; stars: **31,510** &nbsp;&nbsp; folks: **4,290**  &nbsp;&nbsp; `487 stars this week`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **49,132** &nbsp;&nbsp; folks: **5,671**  &nbsp;&nbsp; `15,636 stars this month`
...
1. [menloresearch / jan](https://github.com/menloresearch/jan)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **34,444** &nbsp;&nbsp; folks: **2,011**  &nbsp;&nbsp; `5,085 stars this month`
...
1. [twentyhq / twenty](https://github.com/twentyhq/twenty)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **33,552** &nbsp;&nbsp; folks: **3,725**  &nbsp;&nbsp; `5,414 stars this month`
...
1. [datawhalechina / happy-llm](https://github.com/datawhalechina/happy-llm)
    - 📚 从零开始的大语言模型原理与实践教程
    - language: **无** &nbsp;&nbsp; stars: **9,811** &nbsp;&nbsp; folks: **709**  &nbsp;&nbsp; `7,263 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **18,265** &nbsp;&nbsp; folks: **1,028**  &nbsp;&nbsp; `6,357 stars this month`

1. [anthropics / anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook)
    - A collection of notebooks/recipes showcasing some fun and effective ways of using Claude.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **17,860** &nbsp;&nbsp; folks: **1,849**  &nbsp;&nbsp; `4,850 stars this month`
...
1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    - MCP Toolbox for Databases is an open source MCP server for databases.
    - language: **Go** &nbsp;&nbsp; stars: **3,429** &nbsp;&nbsp; folks: **299**  &nbsp;&nbsp; `1,466 stars this month`
...
1. [microsoft / Web-Dev-For-Beginners](https://github.com/microsoft/Web-Dev-For-Beginners)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **90,319** &nbsp;&nbsp; folks: **13,653**  &nbsp;&nbsp; `2,009 stars this month`
