...
1. [remoteintech / remote-jobs](https://github.com/remoteintech/remote-jobs)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **36,178** &nbsp;&nbsp; folks: **3,564**  &nbsp;&nbsp; `614 stars today`
...
1. [Sjj1024 / PakePlus](https://github.com/Sjj1024/PakePlus)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **4,884** &nbsp;&nbsp; folks: **3,265**  &nbsp;&nbsp; `225 stars today`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **32,774** &nbsp;&nbsp; folks: **4,060**  &nbsp;&nbsp; `99 stars today`

1. [jj-vcs / jj](https://github.com/jj-vcs/jj)
    - A Git-compatible VCS that is both simple and powerful
    - language: **Rust** &nbsp;&nbsp; stars: **17,930** &nbsp;&nbsp; folks: **592**  &nbsp;&nbsp; `163 stars today`

1. [steven2358 / awesome-generative-ai](https://github.com/steven2358/awesome-generative-ai)
    - A curated list of modern Generative Artificial Intelligence projects and services
    - language: **无** &nbsp;&nbsp; stars: **9,051** &nbsp;&nbsp; folks: **1,021**  &nbsp;&nbsp; `35 stars today`

1. [QwenLM / Qwen3](https://github.com/QwenLM/Qwen3)
    - Qwen3 is the large language model series developed by Qwen team, Alibaba Cloud.
    - language: **Python** &nbsp;&nbsp; stars: **22,902** &nbsp;&nbsp; folks: **1,554**  &nbsp;&nbsp; `150 stars today`
...
1. [C4illin / ConvertX](https://github.com/C4illin/ConvertX)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,966** &nbsp;&nbsp; folks: **241**  &nbsp;&nbsp; `711 stars today`
...
1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The personal finance app for everyone
    - language: **Ruby** &nbsp;&nbsp; stars: **51,403** &nbsp;&nbsp; folks: **3,794**  &nbsp;&nbsp; `5,414 stars this week`
...
1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **6,116** &nbsp;&nbsp; folks: **830**  &nbsp;&nbsp; `1,664 stars this week`
...
1. [sherlock-project / sherlock](https://github.com/sherlock-project/sherlock)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **67,179** &nbsp;&nbsp; folks: **7,714**  &nbsp;&nbsp; `501 stars this week`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **6,127** &nbsp;&nbsp; folks: **310**  &nbsp;&nbsp; `1,805 stars this week`
...
1. [ChatGPTNextWeb / NextChat](https://github.com/ChatGPTNextWeb/NextChat)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **84,977** &nbsp;&nbsp; folks: **61,110**  &nbsp;&nbsp; `656 stars this week`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,312** &nbsp;&nbsp; folks: **7,915**  &nbsp;&nbsp; `9,590 stars this month`
...
1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The personal finance app for everyone
    - language: **Ruby** &nbsp;&nbsp; stars: **51,403** &nbsp;&nbsp; folks: **3,794**  &nbsp;&nbsp; `5,760 stars this month`
...
1. [twentyhq / twenty](https://github.com/twentyhq/twenty)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **34,351** &nbsp;&nbsp; folks: **3,857**  &nbsp;&nbsp; `6,075 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **25,556** &nbsp;&nbsp; folks: **1,396**  &nbsp;&nbsp; `11,047 stars this month`
...
1. [snailyp / gemini-balance](https://github.com/snailyp/gemini-balance)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,663** &nbsp;&nbsp; folks: **648**  &nbsp;&nbsp; `1,818 stars this month`
