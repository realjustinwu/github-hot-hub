...
1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **114,844** &nbsp;&nbsp; folks: **15,672**  &nbsp;&nbsp; `158 stars today`
...
1. [anti-work / shortest](https://github.com/anti-work/shortest)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,564** &nbsp;&nbsp; folks: **192**  &nbsp;&nbsp; `2,454 stars this week`

1. [imputnet / cobalt](https://github.com/imputnet/cobalt)
    - best way to save what you love
    - language: **Svelte** &nbsp;&nbsp; stars: **24,405** &nbsp;&nbsp; folks: **1,971**  &nbsp;&nbsp; `3,603 stars this week`

1. [OpenSPG / KAG](https://github.com/OpenSPG/KAG)
    - KAG is a logical form-guided reasoning and retrieval framework based on OpenSPG engine and LLMs. It is used to build logical reasoning and factual Q&A solutions for professional domain knowledge bases. It can effectively overcome the shortcomings of the traditional RAG vector similarity calculation model.
    - language: **Python** &nbsp;&nbsp; stars: **2,780** &nbsp;&nbsp; folks: **171**  &nbsp;&nbsp; `1,593 stars this week`

1. [elizaOS / eliza](https://github.com/elizaOS/eliza)
    - Autonomous agents for everyone
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,458** &nbsp;&nbsp; folks: **2,240**  &nbsp;&nbsp; `1,974 stars this week`

1. [siyuan-note / siyuan](https://github.com/siyuan-note/siyuan)
    - A privacy-first, self-hosted, fully open source personal knowledge management software, written in typescript and golang.
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,639** &nbsp;&nbsp; folks: **1,732**  &nbsp;&nbsp; `1,916 stars this week`

1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    - A collective list of free APIs
    - language: **Python** &nbsp;&nbsp; stars: **322,680** &nbsp;&nbsp; folks: **34,248**  &nbsp;&nbsp; `1,940 stars this week`
...
1. [cline / cline](https://github.com/cline/cline)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,331** &nbsp;&nbsp; folks: **1,521**  &nbsp;&nbsp; `1,887 stars this week`
...
1. [upscayl / upscayl](https://github.com/upscayl/upscayl)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **32,816** &nbsp;&nbsp; folks: **1,503**  &nbsp;&nbsp; `804 stars this week`

1. [practical-tutorials / project-based-learning](https://github.com/practical-tutorials/project-based-learning)
    - Curated list of project-based tutorials
    - language: **无** &nbsp;&nbsp; stars: **209,942** &nbsp;&nbsp; folks: **27,420**  &nbsp;&nbsp; `1,240 stars this week`
...
1. [elizaOS / eliza](https://github.com/elizaOS/eliza)
    - Autonomous agents for everyone
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,458** &nbsp;&nbsp; folks: **2,240**  &nbsp;&nbsp; `5,510 stars this month`

1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    - PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/Docker
    - language: **Python** &nbsp;&nbsp; stars: **13,087** &nbsp;&nbsp; folks: **953**  &nbsp;&nbsp; `9,146 stars this month`

1. [pydantic / pydantic-ai](https://github.com/pydantic/pydantic-ai)
    - Agent Framework / shim to use Pydantic with LLMs
    - language: **Python** &nbsp;&nbsp; stars: **4,679** &nbsp;&nbsp; folks: **309**  &nbsp;&nbsp; `4,551 stars this month`

1. [DrewThomasson / ebook2audiobook](https://github.com/DrewThomasson/ebook2audiobook)
    - Convert ebooks to audiobooks with chapters and metadata using dynamic AI models and voice cloning. Supports 1,107+ languages!
    - language: **Python** &nbsp;&nbsp; stars: **4,314** &nbsp;&nbsp; folks: **294**  &nbsp;&nbsp; `2,704 stars this month`

1. [imputnet / cobalt](https://github.com/imputnet/cobalt)
    - best way to save what you love
    - language: **Svelte** &nbsp;&nbsp; stars: **24,405** &nbsp;&nbsp; folks: **1,971**  &nbsp;&nbsp; `6,614 stars this month`
...
1. [seleniumbase / SeleniumBase](https://github.com/seleniumbase/SeleniumBase)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,439** &nbsp;&nbsp; folks: **1,116**  &nbsp;&nbsp; `2,938 stars this month`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **HTML** &nbsp;&nbsp; stars: **345,713** &nbsp;&nbsp; folks: **62,346**  &nbsp;&nbsp; `5,296 stars this month`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **284,064** &nbsp;&nbsp; folks: **47,451**  &nbsp;&nbsp; `6,395 stars this month`

1. [cline / cline](https://github.com/cline/cline)
    - Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way.
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,331** &nbsp;&nbsp; folks: **1,521**  &nbsp;&nbsp; `4,971 stars this month`

1. [browserbase / stagehand](https://github.com/browserbase/stagehand)
    - An AI web browsing framework focused on simplicity and extensibility.
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,820** &nbsp;&nbsp; folks: **135**  &nbsp;&nbsp; `1,544 stars this month`

1. [ruanyf / weekly](https://github.com/ruanyf/weekly)
    - 科技爱好者周刊，每周五发布
    - language: **无** &nbsp;&nbsp; stars: **50,741** &nbsp;&nbsp; folks: **3,039**  &nbsp;&nbsp; `2,401 stars this month`

1. [jdx / mise](https://github.com/jdx/mise)
    - dev tools, env vars, task runner
    - language: **Rust** &nbsp;&nbsp; stars: **12,384** &nbsp;&nbsp; folks: **344**  &nbsp;&nbsp; `2,048 stars this month`

1. [sxyazi / yazi](https://github.com/sxyazi/yazi)
    - 💥 Blazing fast terminal file manager written in Rust, based on async I/O.
    - language: **Rust** &nbsp;&nbsp; stars: **19,779** &nbsp;&nbsp; folks: **445**  &nbsp;&nbsp; `2,796 stars this month`
