...
1. [Fosowl / agenticSeek](https://github.com/Fosowl/agenticSeek)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **14,068** &nbsp;&nbsp; folks: **1,188**  &nbsp;&nbsp; `10,499 stars this week`

1. [microsoft / qlib](https://github.com/microsoft/qlib)
    - Qlib is an AI-oriented Quant investment platform that aims to use AI tech to empower Quant Research, from exploring ideas to implementing productions. Qlib supports diverse ML modeling paradigms, including supervised learning, market dynamics modeling, and RL, and is now equipped with https://github.com/microsoft/RD-Agent to automate R&D process.
    - language: **Python** &nbsp;&nbsp; stars: **23,469** &nbsp;&nbsp; folks: **3,631**  &nbsp;&nbsp; `3,114 stars this week`

1. [mindsdb / mindsdb](https://github.com/mindsdb/mindsdb)
    - AI's query engine - Platform for building AI that can answer questions over large scale federated data. - The only MCP Server you'll ever need
    - language: **Python** &nbsp;&nbsp; stars: **31,026** &nbsp;&nbsp; folks: **5,191**  &nbsp;&nbsp; `1,878 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **10,820** &nbsp;&nbsp; folks: **602**  &nbsp;&nbsp; `1,284 stars this week`

1. [anthropics / courses](https://github.com/anthropics/courses)
    - Anthropic's educational courses
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **12,695** &nbsp;&nbsp; folks: **1,128**  &nbsp;&nbsp; `969 stars this week`

1. [wg-easy / wg-easy](https://github.com/wg-easy/wg-easy)
    - The easiest way to run WireGuard VPN + Web-based Admin UI.
    - language: **TypeScript** &nbsp;&nbsp; stars: **19,472** &nbsp;&nbsp; folks: **1,843**  &nbsp;&nbsp; `698 stars this week`

1. [simonw / llm](https://github.com/simonw/llm)
    - Access large language models from the command-line
    - language: **Python** &nbsp;&nbsp; stars: **8,132** &nbsp;&nbsp; folks: **483**  &nbsp;&nbsp; `483 stars this week`
...
1. [KwaiVGI / LivePortrait](https://github.com/KwaiVGI/LivePortrait)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,724** &nbsp;&nbsp; folks: **1,643**  &nbsp;&nbsp; `800 stars this week`

1. [microsoft / typescript-go](https://github.com/microsoft/typescript-go)
    - Staging repo for development of native port of TypeScript
    - language: **Go** &nbsp;&nbsp; stars: **20,510** &nbsp;&nbsp; folks: **634**  &nbsp;&nbsp; `611 stars this week`
...
1. [Fosowl / agenticSeek](https://github.com/Fosowl/agenticSeek)
    - Fully Local Manus AI. No APIs, No $200 monthly bills. Enjoy an autonomous agent that thinks, browses the web, and code for the sole cost of electricity.
    - language: **Python** &nbsp;&nbsp; stars: **14,068** &nbsp;&nbsp; folks: **1,188**  &nbsp;&nbsp; `12,554 stars this month`

1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    - 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
    - language: **Python** &nbsp;&nbsp; stars: **35,122** &nbsp;&nbsp; folks: **4,974**  &nbsp;&nbsp; `8,903 stars this month`
...
1. [xming521 / WeClone](https://github.com/xming521/WeClone)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **12,617** &nbsp;&nbsp; folks: **942**  &nbsp;&nbsp; `9,873 stars this month`

1. [voideditor / void](https://github.com/voideditor/void)
    - 无
    - language: **TypeScript** &nbsp;&nbsp; stars: **22,509** &nbsp;&nbsp; folks: **1,445**  &nbsp;&nbsp; `10,453 stars this month`
...
1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **70,128** &nbsp;&nbsp; folks: **9,915**  &nbsp;&nbsp; `16,098 stars this month`
...
1. [bytedance / flowgram.ai](https://github.com/bytedance/flowgram.ai)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,493** &nbsp;&nbsp; folks: **310**  &nbsp;&nbsp; `3,294 stars this month`

1. [mem0ai / mem0](https://github.com/mem0ai/mem0)
    - Memory for AI Agents; SOTA in AI Agent Memory; Announcing OpenMemory MCP - local and secure memory management.
    - language: **Python** &nbsp;&nbsp; stars: **33,295** &nbsp;&nbsp; folks: **3,275**  &nbsp;&nbsp; `5,122 stars this month`

1. [LadybirdBrowser / ladybird](https://github.com/LadybirdBrowser/ladybird)
    - Truly independent web browser
    - language: **C++** &nbsp;&nbsp; stars: **43,154** &nbsp;&nbsp; folks: **1,831**  &nbsp;&nbsp; `5,382 stars this month`

1. [mindsdb / mindsdb](https://github.com/mindsdb/mindsdb)
    - AI's query engine - Platform for building AI that can answer questions over large scale federated data. - The only MCP Server you'll ever need
    - language: **Python** &nbsp;&nbsp; stars: **31,026** &nbsp;&nbsp; folks: **5,191**  &nbsp;&nbsp; `3,287 stars this month`
...
1. [MODSetter / SurfSense](https://github.com/MODSetter/SurfSense)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,809** &nbsp;&nbsp; folks: **340**  &nbsp;&nbsp; `3,107 stars this month`

1. [microsoft / qlib](https://github.com/microsoft/qlib)
    - Qlib is an AI-oriented Quant investment platform that aims to use AI tech to empower Quant Research, from exploring ideas to implementing productions. Qlib supports diverse ML modeling paradigms, including supervised learning, market dynamics modeling, and RL, and is now equipped with https://github.com/microsoft/RD-Agent to automate R&D process.
    - language: **Python** &nbsp;&nbsp; stars: **23,469** &nbsp;&nbsp; folks: **3,631**  &nbsp;&nbsp; `4,556 stars this month`

1. [jujumilk3 / leaked-system-prompts](https://github.com/jujumilk3/leaked-system-prompts)
    - Collection of leaked system prompts
    - language: **无** &nbsp;&nbsp; stars: **8,823** &nbsp;&nbsp; folks: **1,099**  &nbsp;&nbsp; `3,402 stars this month`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **324,862** &nbsp;&nbsp; folks: **41,869**  &nbsp;&nbsp; `8,635 stars this month`

1. [zed-industries / zed](https://github.com/zed-industries/zed)
    - Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter.
    - language: **Rust** &nbsp;&nbsp; stars: **60,728** &nbsp;&nbsp; folks: **4,393**  &nbsp;&nbsp; `3,436 stars this month`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Build like a team of hundreds_
    - language: **TypeScript** &nbsp;&nbsp; stars: **50,629** &nbsp;&nbsp; folks: **4,428**  &nbsp;&nbsp; `2,403 stars this month`

1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    - This repo includes ChatGPT prompt curation to use ChatGPT and other LLM tools better.
    - language: **JavaScript** &nbsp;&nbsp; stars: **127,516** &nbsp;&nbsp; folks: **16,937**  &nbsp;&nbsp; `3,959 stars this month`

1. [modular / modular](https://github.com/modular/modular)
    - The Modular Platform (includes MAX & Mojo)
    - language: **Mojo** &nbsp;&nbsp; stars: **24,169** &nbsp;&nbsp; folks: **2,616**  &nbsp;&nbsp; `348 stars this month`

1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    - A collective list of free APIs
    - language: **Python** &nbsp;&nbsp; stars: **348,265** &nbsp;&nbsp; folks: **36,615**  &nbsp;&nbsp; `10,442 stars this month`

1. [QwenLM / Qwen-Agent](https://github.com/QwenLM/Qwen-Agent)
    - Agent framework and applications built upon Qwen>=3.0, featuring Function Calling, MCP, Code Interpreter, RAG, Chrome extension, etc.
    - language: **Python** &nbsp;&nbsp; stars: **9,154** &nbsp;&nbsp; folks: **771**  &nbsp;&nbsp; `1,887 stars this month`
