...
1. [bknd-io / bknd](https://github.com/bknd-io/bknd)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,955** &nbsp;&nbsp; folks: **93**  &nbsp;&nbsp; `341 stars today`

1. [TheOdinProject / css-exercises](https://github.com/TheOdinProject/css-exercises)
    - 无
    - language: **HTML** &nbsp;&nbsp; stars: **2,015** &nbsp;&nbsp; folks: **82,006**  &nbsp;&nbsp; `14 stars today`

1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    - Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.
    - language: **TypeScript** &nbsp;&nbsp; stars: **121,866** &nbsp;&nbsp; folks: **36,595**  &nbsp;&nbsp; `581 stars today`

1. [panaversity / learn-agentic-ai](https://github.com/panaversity/learn-agentic-ai)
    - Learn Agentic AI using Dapr Agentic Cloud Ascent (DACA) Design Pattern and Agent-Native Cloud Technologies: OpenAI Agents SDK, Memory, MCP, A2A, Knowledge Graphs, Dapr, Rancher Desktop, and Kubernetes.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **3,360** &nbsp;&nbsp; folks: **694**  &nbsp;&nbsp; `20 stars today`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **68,706** &nbsp;&nbsp; folks: **3,657**  &nbsp;&nbsp; `8,396 stars this week`
...
1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **5,670** &nbsp;&nbsp; folks: **783**  &nbsp;&nbsp; `1,120 stars this week`
...
1. [gorhill / uBlock](https://github.com/gorhill/uBlock)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **56,533** &nbsp;&nbsp; folks: **3,605**  &nbsp;&nbsp; `952 stars this week`

1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The personal finance app for everyone
    - language: **Ruby** &nbsp;&nbsp; stars: **48,102** &nbsp;&nbsp; folks: **3,569**  &nbsp;&nbsp; `2,455 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **24,960** &nbsp;&nbsp; folks: **1,364**  &nbsp;&nbsp; `5,270 stars this week`
...
1. [hyprwm / Hyprland](https://github.com/hyprwm/Hyprland)
    - Hyprland is an independent, highly customizable, dynamic tiling Wayland compositor that doesn't sacrifice on its looks.
    - language: **C++** &nbsp;&nbsp; stars: **28,178** &nbsp;&nbsp; folks: **1,192**  &nbsp;&nbsp; `1,143 stars this week`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **32,844** &nbsp;&nbsp; folks: **7,849**  &nbsp;&nbsp; `9,203 stars this month`
...
1. [Alibaba-NLP / WebAgent](https://github.com/Alibaba-NLP/WebAgent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,772** &nbsp;&nbsp; folks: **354**  &nbsp;&nbsp; `3,660 stars this month`
...
1. [humanlayer / 12-factor-agents](https://github.com/humanlayer/12-factor-agents)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,780** &nbsp;&nbsp; folks: **630**  &nbsp;&nbsp; `5,260 stars this month`
...
1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **24,960** &nbsp;&nbsp; folks: **1,364**  &nbsp;&nbsp; `10,940 stars this month`
...
1. [datawhalechina / happy-llm](https://github.com/datawhalechina/happy-llm)
    - 📚 从零开始的大语言模型原理与实践教程
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **12,372** &nbsp;&nbsp; folks: **909**  &nbsp;&nbsp; `8,534 stars this month`
...
1. [embabel / embabel-agent](https://github.com/embabel/embabel-agent)
    ...
    - language: **Kotlin** &nbsp;&nbsp; stars: **2,220** &nbsp;&nbsp; folks: **177**  &nbsp;&nbsp; `1,743 stars this month`

1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 26 lessons, 52 quizzes, classic Machine Learning for all
    - language: **HTML** &nbsp;&nbsp; stars: **75,166** &nbsp;&nbsp; folks: **16,610**  &nbsp;&nbsp; `2,463 stars this month`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,120** &nbsp;&nbsp; folks: **422**  &nbsp;&nbsp; `3,811 stars this month`

1. [snailyp / gemini-balance](https://github.com/snailyp/gemini-balance)
    - Gemini polling proxy service （gemini轮询代理服务）
    - language: **Python** &nbsp;&nbsp; stars: **3,530** &nbsp;&nbsp; folks: **615**  &nbsp;&nbsp; `1,725 stars this month`
