...
`更新时间：2025-04-17 18:26:12 +0800`

## 今日热门仓库

1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    - An AI Hedge Fund Team
    - language: **Python** &nbsp;&nbsp; stars: **24,749** &nbsp;&nbsp; folks: **4,270**  &nbsp;&nbsp; `1,590 stars today`

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **74,090** &nbsp;&nbsp; folks: **9,144**  &nbsp;&nbsp; `1,010 stars today`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **18,383** &nbsp;&nbsp; folks: **2,207**  &nbsp;&nbsp; `1,032 stars today`
...
1. [Zackriya-Solutions / meeting-minutes](https://github.com/Zackriya-Solutions/meeting-minutes)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,487** &nbsp;&nbsp; folks: **244**  &nbsp;&nbsp; `384 stars today`

1. [NirDiamant / RAG_Techniques](https://github.com/NirDiamant/RAG_Techniques)
    - This repository showcases various advanced techniques for Retrieval-Augmented Generation (RAG) systems. RAG systems combine information retrieval with generative models to provide accurate and contextually rich responses.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **14,641** &nbsp;&nbsp; folks: **1,487**  &nbsp;&nbsp; `252 stars today`
...
1. [svcvit / Awesome-Dify-Workflow](https://github.com/svcvit/Awesome-Dify-Workflow)
    ...
    - language: **无** &nbsp;&nbsp; stars: **6,088** &nbsp;&nbsp; folks: **596**  &nbsp;&nbsp; `394 stars today`
...
1. [kestra-io / kestra](https://github.com/kestra-io/kestra)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **17,236** &nbsp;&nbsp; folks: **1,450**  &nbsp;&nbsp; `76 stars today`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    - [Support 0.48.x]（Reset Cursor AI MachineID & Bypass Higher Token Limit） Cursor Ai ，自动重置机器ID ， 免费升级使用Pro功能: You've reached your trial request limit. / Too many free trial accounts used on this machine. Please upgrade to pro. We have this limit in place to prevent abuse. Please let us know if you believe this is a mistake.
    - language: **Python** &nbsp;&nbsp; stars: **18,383** &nbsp;&nbsp; folks: **2,207**  &nbsp;&nbsp; `10,598 stars this week`

1. [Zackriya-Solutions / meeting-minutes](https://github.com/Zackriya-Solutions/meeting-minutes)
    - A free and open source, self hosted Ai based live meeting note taker and minutes summary generator that can completely run in your Local device (Mac OS and windows OS Support added. Working on adding linux support soon) https://meetily.zackriya.com/
    - language: **C++** &nbsp;&nbsp; stars: **3,487** &nbsp;&nbsp; folks: **244**  &nbsp;&nbsp; `1,672 stars this week`
...
1. [juliangarnier / anime](https://github.com/juliangarnier/anime)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **57,847** &nbsp;&nbsp; folks: **3,955**  &nbsp;&nbsp; `1,626 stars this week`

1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    - 10 Lessons to Get Started Building AI Agents
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,386** &nbsp;&nbsp; folks: **3,709**  &nbsp;&nbsp; `3,903 stars this week`
...
1. [clockworklabs / SpacetimeDB](https://github.com/clockworklabs/SpacetimeDB)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **14,130** &nbsp;&nbsp; folks: **457**  &nbsp;&nbsp; `1,896 stars this week`

1. [vercel / ai-chatbot](https://github.com/vercel/ai-chatbot)
    - A full-featured, hackable Next.js AI chatbot built by Vercel
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,322** &nbsp;&nbsp; folks: **4,040**  &nbsp;&nbsp; `792 stars this week`

1. [CVEProject / cvelistV5](https://github.com/CVEProject/cvelistV5)
    - CVE cache of the official CVE List in CVE JSON 5 format
    - language: **无** &nbsp;&nbsp; stars: **1,216** &nbsp;&nbsp; folks: **381**  &nbsp;&nbsp; `131 stars this week`
...
1. [kestra-io / kestra](https://github.com/kestra-io/kestra)
    - ⚡ Workflow Automation Platform. Orchestrate & Schedule code in any language, run anywhere, 600+ plugins. Alternative to Airflow, VMware vRealize Automation, Rundeck...
    - language: **Java** &nbsp;&nbsp; stars: **17,236** &nbsp;&nbsp; folks: **1,450**  &nbsp;&nbsp; `231 stars this week`
...
1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **43,342** &nbsp;&nbsp; folks: **3,124**  &nbsp;&nbsp; `673 stars this week`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    - [Support 0.48.x]（Reset Cursor AI MachineID & Bypass Higher Token Limit） Cursor Ai ，自动重置机器ID ， 免费升级使用Pro功能: You've reached your trial request limit. / Too many free trial accounts used on this machine. Please upgrade to pro. We have this limit in place to prevent abuse. Please let us know if you believe this is a mistake.
    - language: **Python** &nbsp;&nbsp; stars: **18,383** &nbsp;&nbsp; folks: **2,207**  &nbsp;&nbsp; `15,200 stars this month`

1. [punkpeye / awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)
    - A collection of MCP servers.
    - language: **无** &nbsp;&nbsp; stars: **38,923** &nbsp;&nbsp; folks: **2,764**  &nbsp;&nbsp; `28,848 stars this month`
...
1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    - 10 Lessons to Get Started Building AI Agents
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,386** &nbsp;&nbsp; folks: **3,709**  &nbsp;&nbsp; `10,605 stars this month`
...
1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **50,308** &nbsp;&nbsp; folks: **7,453**  &nbsp;&nbsp; `5,815 stars this month`
...
1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **82,152** &nbsp;&nbsp; folks: **21,953**  &nbsp;&nbsp; `14,388 stars this month`
