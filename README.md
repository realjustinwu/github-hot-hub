...
1. [shadps4-emu / shadPS4](https://github.com/shadps4-emu/shadPS4)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **24,652** &nbsp;&nbsp; folks: **1,588**  &nbsp;&nbsp; `1,054 stars today`

1. [soxoj / maigret](https://github.com/soxoj/maigret)
    - 🕵️‍♂️ Collect a dossier on a person by username from thousands of sites
    - language: **Python** &nbsp;&nbsp; stars: **16,897** &nbsp;&nbsp; folks: **1,141**  &nbsp;&nbsp; `321 stars today`

1. [github / github-mcp-server](https://github.com/github/github-mcp-server)
    - GitHub's official MCP Server
    - language: **Go** &nbsp;&nbsp; stars: **18,095** &nbsp;&nbsp; folks: **1,438**  &nbsp;&nbsp; `257 stars today`

1. [remoteintech / remote-jobs](https://github.com/remoteintech/remote-jobs)
    - A list of semi to fully remote-friendly companies (jobs) in tech.
    - language: **JavaScript** &nbsp;&nbsp; stars: **33,044** &nbsp;&nbsp; folks: **3,416**  &nbsp;&nbsp; `361 stars today`
...
1. [mrdbourke / pytorch-deep-learning](https://github.com/mrdbourke/pytorch-deep-learning)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **14,719** &nbsp;&nbsp; folks: **4,064**  &nbsp;&nbsp; `43 stars today`

1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    - Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.
    - language: **TypeScript** &nbsp;&nbsp; stars: **121,189** &nbsp;&nbsp; folks: **36,424**  &nbsp;&nbsp; `695 stars today`
...
1. [Kyome22 / RunCat365](https://github.com/Kyome22/RunCat365)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **8,490** &nbsp;&nbsp; folks: **705**  &nbsp;&nbsp; `132 stars today`
...
1. [strapi / strapi](https://github.com/strapi/strapi)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **68,491** &nbsp;&nbsp; folks: **8,771**  &nbsp;&nbsp; `236 stars today`
...
1. [ikawrakow / ik_llama.cpp](https://github.com/ikawrakow/ik_llama.cpp)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **750** &nbsp;&nbsp; folks: **71**  &nbsp;&nbsp; `8 stars today`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **68,438** &nbsp;&nbsp; folks: **3,637**  &nbsp;&nbsp; `8,235 stars this week`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,186** &nbsp;&nbsp; folks: **461**  &nbsp;&nbsp; `2,600 stars this week`
...
1. [getzep / graphiti](https://github.com/getzep/graphiti)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **14,291** &nbsp;&nbsp; folks: **1,198**  &nbsp;&nbsp; `1,647 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **24,707** &nbsp;&nbsp; folks: **1,356**  &nbsp;&nbsp; `5,628 stars this week`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **5,369** &nbsp;&nbsp; folks: **753**  &nbsp;&nbsp; `886 stars this week`
...
1. [strapi / strapi](https://github.com/strapi/strapi)
    - 🚀 Strapi is the leading open-source headless CMS. It’s 100% JavaScript/TypeScript, fully customizable, and developer-first.
    - language: **TypeScript** &nbsp;&nbsp; stars: **68,491** &nbsp;&nbsp; folks: **8,771**  &nbsp;&nbsp; `775 stars this week`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **32,638** &nbsp;&nbsp; folks: **7,815**  &nbsp;&nbsp; `9,069 stars this month`
...
1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **24,707** &nbsp;&nbsp; folks: **1,356**  &nbsp;&nbsp; `10,967 stars this month`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,023** &nbsp;&nbsp; folks: **413**  &nbsp;&nbsp; `3,747 stars this month`
