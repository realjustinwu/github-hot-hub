...
`更新时间：2024-12-23 18:23:51 +0800`

## 今日热门仓库

1. [nicbarker / clay](https://github.com/nicbarker/clay)
    - High performance UI layout library in C.
    - language: **C** &nbsp;&nbsp; stars: **6,118** &nbsp;&nbsp; folks: **168**  &nbsp;&nbsp; `1,544 stars today`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **281,590** &nbsp;&nbsp; folks: **47,122**  &nbsp;&nbsp; `418 stars today`

1. [Genesis-Embodied-AI / Genesis](https://github.com/Genesis-Embodied-AI/Genesis)
    - A generative world for general-purpose robotics & embodied AI learning.
    - language: **Python** &nbsp;&nbsp; stars: **18,207** &nbsp;&nbsp; folks: **1,298**  &nbsp;&nbsp; `1,337 stars today`

1. [tldraw / tldraw](https://github.com/tldraw/tldraw)
    - whiteboard / infinite canvas SDK
    - language: **TypeScript** &nbsp;&nbsp; stars: **37,196** &nbsp;&nbsp; folks: **2,275**  &nbsp;&nbsp; `305 stars today`
...
1. [bytedance / monolith](https://github.com/bytedance/monolith)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,296** &nbsp;&nbsp; folks: **305**  &nbsp;&nbsp; `306 stars today`

1. [fchollet / ARC-AGI](https://github.com/fchollet/ARC-AGI)
    - The Abstraction and Reasoning Corpus
    - language: **JavaScript** &nbsp;&nbsp; stars: **3,901** &nbsp;&nbsp; folks: **613**  &nbsp;&nbsp; `69 stars today`
...
1. [taichi-dev / taichi](https://github.com/taichi-dev/taichi)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **26,369** &nbsp;&nbsp; folks: **2,311**  &nbsp;&nbsp; `127 stars today`

1. [gorhill / uBlock](https://github.com/gorhill/uBlock)
    - uBlock Origin - An efficient blocker for Chromium and Firefox. Fast and lean.
    - language: **JavaScript** &nbsp;&nbsp; stars: **48,369** &nbsp;&nbsp; folks: **3,190**  &nbsp;&nbsp; `48 stars today`

1. [Helicone / helicone](https://github.com/Helicone/helicone)
    - 🧊 Open source LLM observability platform. One line of code to monitor, evaluate, and experiment. YC W23 🍓
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,665** &nbsp;&nbsp; folks: **281**  &nbsp;&nbsp; `26 stars today`
...
1. [google-gemini / cookbook](https://github.com/google-gemini/cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **9,250** &nbsp;&nbsp; folks: **1,090**  &nbsp;&nbsp; `2,851 stars this week`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **7,829** &nbsp;&nbsp; folks: **812**  &nbsp;&nbsp; `1,318 stars this week`
...
1. [wavetermdev / waveterm](https://github.com/wavetermdev/waveterm)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,603** &nbsp;&nbsp; folks: **219**  &nbsp;&nbsp; `1,299 stars this week`

1. [LazyVim / LazyVim](https://github.com/LazyVim/LazyVim)
    - Neovim config for the lazy
    - language: **Lua** &nbsp;&nbsp; stars: **18,413** &nbsp;&nbsp; folks: **1,291**  &nbsp;&nbsp; `488 stars this week`
...
1. [TEN-framework / TEN-Agent](https://github.com/TEN-framework/TEN-Agent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,666** &nbsp;&nbsp; folks: **349**  &nbsp;&nbsp; `1,002 stars this week`

1. [0xPlaygrounds / rig](https://github.com/0xPlaygrounds/rig)
    - ⚙️🦀 Build portable, modular & lightweight Fullstack Agents
    - language: **Rust** &nbsp;&nbsp; stars: **1,521** &nbsp;&nbsp; folks: **115**  &nbsp;&nbsp; `419 stars this week`
...
1. [1Panel-dev / 1Panel](https://github.com/1Panel-dev/1Panel)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **24,029** &nbsp;&nbsp; folks: **2,178**  &nbsp;&nbsp; `515 stars this week`
...
1. [shardeum / shardeum](https://github.com/shardeum/shardeum)
    - Shardeum is an EVM based autoscaling blockchain
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,904** &nbsp;&nbsp; folks: **490**  &nbsp;&nbsp; `4,230 stars this week`
...
1. [PatrickJS / awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules)
    ...
    - language: **无** &nbsp;&nbsp; stars: **4,182** &nbsp;&nbsp; folks: **243**  &nbsp;&nbsp; `455 stars this week`
...
1. [elizaOS / eliza](https://github.com/elizaOS/eliza)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,697** &nbsp;&nbsp; folks: **1,680**  &nbsp;&nbsp; `3,741 stars this month`
...
1. [google-gemini / cookbook](https://github.com/google-gemini/cookbook)
    - Examples and guides for using the Gemini API
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **9,250** &nbsp;&nbsp; folks: **1,090**  &nbsp;&nbsp; `3,817 stars this month`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **7,829** &nbsp;&nbsp; folks: **812**  &nbsp;&nbsp; `3,391 stars this month`
...
1. [TEN-framework / TEN-Agent](https://github.com/TEN-framework/TEN-Agent)
    - TEN Agent is a conversational AI powered by the TEN, integrating Gemini 2.0 Live, OpenAI Realtime, RTC, and more. It delivers real-time capabilities to see, hear, and speak, while being fully compatible with popular workflow platforms like Dify and Coze.
    - language: **Python** &nbsp;&nbsp; stars: **3,666** &nbsp;&nbsp; folks: **349**  &nbsp;&nbsp; `2,036 stars this month`
...
1. [krahets / hello-algo](https://github.com/krahets/hello-algo)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **103,992** &nbsp;&nbsp; folks: **13,042**  &nbsp;&nbsp; `4,709 stars this month`

1. [langflow-ai / langflow](https://github.com/langflow-ai/langflow)
    - Langflow is a low-code app builder for RAG and multi-agent AI applications. It’s Python-based and agnostic to any model, API, or database.
    - language: **Python** &nbsp;&nbsp; stars: **40,237** &nbsp;&nbsp; folks: **4,537**  &nbsp;&nbsp; `5,149 stars this month`
...
1. [lobehub / lobe-chat](https://github.com/lobehub/lobe-chat)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **49,397** &nbsp;&nbsp; folks: **10,724**  &nbsp;&nbsp; `4,768 stars this month`
...
1. [seleniumbase / SeleniumBase](https://github.com/seleniumbase/SeleniumBase)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,629** &nbsp;&nbsp; folks: **1,068**  &nbsp;&nbsp; `2,140 stars this month`

1. [awslabs / multi-agent-orchestrator](https://github.com/awslabs/multi-agent-orchestrator)
    - Flexible and powerful framework for managing multiple AI agents and handling complex conversations
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,237** &nbsp;&nbsp; folks: **230**  &nbsp;&nbsp; `1,313 stars this month`
