...
`更新时间：2025-07-30 04:30:42 +0800`

## 今日热门仓库

1. [9001 / copyparty](https://github.com/9001/copyparty)
    - Portable file server with accelerated resumable uploads, dedup, WebDAV, FTP, TFTP, zeroconf, media indexer, thumbnails++ all in one file, no deps
    - language: **Python** &nbsp;&nbsp; stars: **10,030** &nbsp;&nbsp; folks: **289**  &nbsp;&nbsp; `4,365 stars today`

1. [cloudwego / eino](https://github.com/cloudwego/eino)
    - The ultimate LLM/AI application development framework in Golang.
    - language: **Go** &nbsp;&nbsp; stars: **5,635** &nbsp;&nbsp; folks: **454**  &nbsp;&nbsp; `105 stars today`

1. [n0-computer / iroh](https://github.com/n0-computer/iroh)
    - peer-2-peer that just works
    - language: **Rust** &nbsp;&nbsp; stars: **6,218** &nbsp;&nbsp; folks: **279**  &nbsp;&nbsp; `168 stars today`

1. [tldr-pages / tldr](https://github.com/tldr-pages/tldr)
    - 📚 Collaborative cheatsheets for console commands
    - language: **Markdown** &nbsp;&nbsp; stars: **57,533** &nbsp;&nbsp; folks: **4,624**  &nbsp;&nbsp; `380 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **53,476** &nbsp;&nbsp; folks: **6,217**  &nbsp;&nbsp; `639 stars today`

1. [microsoft / PowerToys](https://github.com/microsoft/PowerToys)
    - Windows system utilities to maximize productivity
    - language: **C#** &nbsp;&nbsp; stars: **121,412** &nbsp;&nbsp; folks: **7,221**  &nbsp;&nbsp; `129 stars today`

1. [lapce / lapce](https://github.com/lapce/lapce)
    - Lightning-fast and Powerful Code Editor written in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **36,896** &nbsp;&nbsp; folks: **1,164**  &nbsp;&nbsp; `54 stars today`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **20,750** &nbsp;&nbsp; folks: **4,187**  &nbsp;&nbsp; `8,664 stars this week`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **46,897** &nbsp;&nbsp; folks: **4,272**  &nbsp;&nbsp; `3,244 stars this week`

1. [frappe / hrms](https://github.com/frappe/hrms)
    - Open Source HR and Payroll Software
    - language: **Python** &nbsp;&nbsp; stars: **5,180** &nbsp;&nbsp; folks: **1,436**  &nbsp;&nbsp; `2,296 stars this week`

1. [remoteintech / remote-jobs](https://github.com/remoteintech/remote-jobs)
    - A list of semi to fully remote-friendly companies (jobs) in tech.
    - language: **JavaScript** &nbsp;&nbsp; stars: **37,532** &nbsp;&nbsp; folks: **3,651**  &nbsp;&nbsp; `2,814 stars this week`

1. [roboflow / supervision](https://github.com/roboflow/supervision)
    - We write your reusable computer vision tools. 💜
    - language: **Python** &nbsp;&nbsp; stars: **31,298** &nbsp;&nbsp; folks: **2,482**  &nbsp;&nbsp; `1,749 stars this week`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **313,548** &nbsp;&nbsp; folks: **51,487**  &nbsp;&nbsp; `1,537 stars this week`
...
1. [QwenLM / Qwen3](https://github.com/QwenLM/Qwen3)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **23,531** &nbsp;&nbsp; folks: **1,583**  &nbsp;&nbsp; `854 stars this week`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **53,476** &nbsp;&nbsp; folks: **6,217**  &nbsp;&nbsp; `2,493 stars this week`

1. [myshell-ai / OpenVoice](https://github.com/myshell-ai/OpenVoice)
    - Instant voice cloning by MIT and MyShell. Audio foundation model.
    - language: **Python** &nbsp;&nbsp; stars: **33,649** &nbsp;&nbsp; folks: **3,591**  &nbsp;&nbsp; `436 stars this week`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **46,897** &nbsp;&nbsp; folks: **4,272**  &nbsp;&nbsp; `4,674 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,555** &nbsp;&nbsp; folks: **625**  &nbsp;&nbsp; `5,972 stars this month`
...
1. [snailyp / gemini-balance](https://github.com/snailyp/gemini-balance)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,900** &nbsp;&nbsp; folks: **694**  &nbsp;&nbsp; `2,045 stars this month`
