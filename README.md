...
1. [enescingoz / awesome-n8n-templates](https://github.com/enescingoz/awesome-n8n-templates)
    ...
    - language: **无** &nbsp;&nbsp; stars: **9,289** &nbsp;&nbsp; folks: **2,709**  &nbsp;&nbsp; `130 stars today`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **4,537** &nbsp;&nbsp; folks: **182**  &nbsp;&nbsp; `500 stars today`

1. [immich-app / immich](https://github.com/immich-app/immich)
    - High performance self-hosted photo and video management solution.
    - language: **TypeScript** &nbsp;&nbsp; stars: **73,343** &nbsp;&nbsp; folks: **3,869**  &nbsp;&nbsp; `114 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **59,678** &nbsp;&nbsp; folks: **7,161**  &nbsp;&nbsp; `804 stars today`
...
1. [MotiaDev / motia](https://github.com/MotiaDev/motia)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,523** &nbsp;&nbsp; folks: **503**  &nbsp;&nbsp; `310 stars today`
...
1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,730** &nbsp;&nbsp; folks: **133**  &nbsp;&nbsp; `196 stars today`
...
1. [mfts / papermark](https://github.com/mfts/papermark)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,236** &nbsp;&nbsp; folks: **989**  &nbsp;&nbsp; `77 stars today`
...
1. [ubicloud / ubicloud](https://github.com/ubicloud/ubicloud)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **9,793** &nbsp;&nbsp; folks: **425**  &nbsp;&nbsp; `3,807 stars this week`

1. [apple / embedding-atlas](https://github.com/apple/embedding-atlas)
    - Embedding Atlas is a tool that provides interactive visualizations for large embeddings. It allows you to visualize, cross-filter, and search embeddings and metadata.
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,744** &nbsp;&nbsp; folks: **119**  &nbsp;&nbsp; `1,845 stars this week`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,475** &nbsp;&nbsp; folks: **1,590**  &nbsp;&nbsp; `1,821 stars this week`

1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **2,746** &nbsp;&nbsp; folks: **273**  &nbsp;&nbsp; `1,136 stars this week`

1. [denizsafak / abogen](https://github.com/denizsafak/abogen)
    - Generate audiobooks from EPUBs, PDFs and text with synchronized captions.
    - language: **Python** &nbsp;&nbsp; stars: **2,815** &nbsp;&nbsp; folks: **142**  &nbsp;&nbsp; `840 stars this week`
...
1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,085** &nbsp;&nbsp; folks: **709**  &nbsp;&nbsp; `1,743 stars this week`

1. [syncthing / syncthing](https://github.com/syncthing/syncthing)
    - Open Source Continuous File Synchronization
    - language: **Go** &nbsp;&nbsp; stars: **75,175** &nbsp;&nbsp; folks: **4,706**  &nbsp;&nbsp; `912 stars this week`
...
1. [librespot-org / librespot](https://github.com/librespot-org/librespot)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **5,505** &nbsp;&nbsp; folks: **718**  &nbsp;&nbsp; `75 stars this week`

1. [filamentphp / filament](https://github.com/filamentphp/filament)
    - A powerful open source UI framework for Laravel • Build and ship admin panels & apps fast with Livewire
    - language: **PHP** &nbsp;&nbsp; stars: **25,832** &nbsp;&nbsp; folks: **3,685**  &nbsp;&nbsp; `430 stars this week`
...
1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,331** &nbsp;&nbsp; folks: **1,281**  &nbsp;&nbsp; `11,338 stars this month`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **9,114** &nbsp;&nbsp; folks: **1,614**  &nbsp;&nbsp; `3,278 stars this month`

1. [roboflow / supervision](https://github.com/roboflow/supervision)
    - We write your reusable computer vision tools. 💜
    - language: **Python** &nbsp;&nbsp; stars: **34,054** &nbsp;&nbsp; folks: **2,744**  &nbsp;&nbsp; `6,956 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,853** &nbsp;&nbsp; folks: **1,025**  &nbsp;&nbsp; `8,154 stars this month`
...
1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **55,636** &nbsp;&nbsp; folks: **9,472**  &nbsp;&nbsp; `3,097 stars this month`
