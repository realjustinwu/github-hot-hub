...
1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **4,861** &nbsp;&nbsp; folks: **378**  &nbsp;&nbsp; `1,046 stars today`

1. [LMCache / LMCache](https://github.com/LMCache/LMCache)
    - Supercharge Your LLM with the Fastest KV Cache Layer
    - language: **Python** &nbsp;&nbsp; stars: **2,814** &nbsp;&nbsp; folks: **320**  &nbsp;&nbsp; `148 stars today`
...
1. [ByteByteGoHq / system-design-101](https://github.com/ByteByteGoHq/system-design-101)
    ...
    - language: **无** &nbsp;&nbsp; stars: **74,170** &nbsp;&nbsp; folks: **7,931**  &nbsp;&nbsp; `192 stars today`

1. [snap-stanford / Biomni](https://github.com/snap-stanford/Biomni)
    - Biomni: a general-purpose biomedical AI agent
    - language: **Python** &nbsp;&nbsp; stars: **974** &nbsp;&nbsp; folks: **104**  &nbsp;&nbsp; `338 stars today`
...
1. [helm / helm](https://github.com/helm/helm)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **28,163** &nbsp;&nbsp; folks: **7,278**  &nbsp;&nbsp; `10 stars today`
...
1. [HandsOnLLM / Hands-On-Large-Language-Models](https://github.com/HandsOnLLM/Hands-On-Large-Language-Models)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **11,889** &nbsp;&nbsp; folks: **2,773**  &nbsp;&nbsp; `286 stars today`

1. [volcengine / verl](https://github.com/volcengine/verl)
    - verl: Volcano Engine Reinforcement Learning for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **10,725** &nbsp;&nbsp; folks: **1,771**  &nbsp;&nbsp; `58 stars today`

1. [hashicorp / terraform](https://github.com/hashicorp/terraform)
    - Terraform enables you to safely and predictably create, change, and improve infrastructure. It is a source-available tool that codifies APIs into declarative configuration files that can be shared amongst team members, treated as code, edited, reviewed, and versioned.
    - language: **Go** &nbsp;&nbsp; stars: **45,624** &nbsp;&nbsp; folks: **9,926**  &nbsp;&nbsp; `10 stars today`
...
1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    - MCP Toolbox for Databases is an open source MCP server for databases.
    - language: **Go** &nbsp;&nbsp; stars: **4,861** &nbsp;&nbsp; folks: **378**  &nbsp;&nbsp; `1,929 stars this week`
...
1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    ...
    - language: **Markdown** &nbsp;&nbsp; stars: **398,653** &nbsp;&nbsp; folks: **37,208**  &nbsp;&nbsp; `4,512 stars this week`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,137** &nbsp;&nbsp; folks: **328**  &nbsp;&nbsp; `2,307 stars this week`
...
1. [twentyhq / twenty](https://github.com/twentyhq/twenty)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **33,648** &nbsp;&nbsp; folks: **3,744**  &nbsp;&nbsp; `5,494 stars this month`

1. [datawhalechina / happy-llm](https://github.com/datawhalechina/happy-llm)
    - 📚 从零开始的大语言模型原理与实践教程
    - language: **无** &nbsp;&nbsp; stars: **10,152** &nbsp;&nbsp; folks: **734**  &nbsp;&nbsp; `7,210 stars this month`
...
1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    ...
    - language: **PowerShell** &nbsp;&nbsp; stars: **18,607** &nbsp;&nbsp; folks: **1,056**  &nbsp;&nbsp; `6,396 stars this month`
...
1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    ...
    - language: **无** &nbsp;&nbsp; stars: **380,864** &nbsp;&nbsp; folks: **30,443**  &nbsp;&nbsp; `16,604 stars this month`

1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    - MCP Toolbox for Databases is an open source MCP server for databases.
    - language: **Go** &nbsp;&nbsp; stars: **4,861** &nbsp;&nbsp; folks: **378**  &nbsp;&nbsp; `2,324 stars this month`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    - Open Source AI coding assistant for planning, building, and fixing code. We're a superset of Roo, Cline, and our own features. Follow us: kilocode.ai/social
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,137** &nbsp;&nbsp; folks: **328**  &nbsp;&nbsp; `3,136 stars this month`
...
1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 26 lessons, 52 quizzes, classic Machine Learning for all
    - language: **HTML** &nbsp;&nbsp; stars: **74,310** &nbsp;&nbsp; folks: **16,356**  &nbsp;&nbsp; `1,639 stars this month`
