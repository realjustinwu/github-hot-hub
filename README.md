...
1. [BeehiveInnovations / zen-mcp-server](https://github.com/BeehiveInnovations/zen-mcp-server)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,691** &nbsp;&nbsp; folks: **727**  &nbsp;&nbsp; `1,276 stars this week`
...
1. [dgtlmoon / changedetection.io](https://github.com/dgtlmoon/changedetection.io)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **27,758** &nbsp;&nbsp; folks: **1,547**  &nbsp;&nbsp; `1,015 stars this week`

1. [hsliuping / TradingAgents-CN](https://github.com/hsliuping/TradingAgents-CN)
    - 基于多智能体LLM的中文金融交易框架 - TradingAgents中文增强版
    - language: **Python** &nbsp;&nbsp; stars: **10,272** &nbsp;&nbsp; folks: **2,250**  &nbsp;&nbsp; `1,254 stars this week`

1. [TapXWorld / ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook)
    - 所有小初高、大学PDF教材。
    - language: **Roff** &nbsp;&nbsp; stars: **52,969** &nbsp;&nbsp; folks: **11,878**  &nbsp;&nbsp; `2,218 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **TypeScript** &nbsp;&nbsp; stars: **37,279** &nbsp;&nbsp; folks: **2,344**  &nbsp;&nbsp; `986 stars this week`
...
1. [openemr / openemr](https://github.com/openemr/openemr)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **4,349** &nbsp;&nbsp; folks: **2,561**  &nbsp;&nbsp; `650 stars this week`

1. [MODSetter / SurfSense](https://github.com/MODSetter/SurfSense)
    - Open Source Alternative to NotebookLM / Perplexity, connected to external sources such as Search Engines, Slack, Linear, Jira, ClickUp, Confluence, Notion, YouTube, GitHub, Discord and more. Join our discord: https://discord.gg/ejRNvftDp9
    - language: **Python** &nbsp;&nbsp; stars: **9,406** &nbsp;&nbsp; folks: **729**  &nbsp;&nbsp; `956 stars this week`
...
1. [evershopcommerce / evershop](https://github.com/evershopcommerce/evershop)
    - 🛍️ Typescript E-commerce Platform
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,895** &nbsp;&nbsp; folks: **1,845**  &nbsp;&nbsp; `781 stars this week`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **47,041** &nbsp;&nbsp; folks: **5,665**  &nbsp;&nbsp; `7,074 stars this month`
...
1. [dataease / SQLBot](https://github.com/dataease/SQLBot)
    - 🔥 基于大模型和 RAG 的智能问数系统。Text-to-SQL Generation via LLMs using RAG.
    - language: **Python** &nbsp;&nbsp; stars: **3,840** &nbsp;&nbsp; folks: **377**  &nbsp;&nbsp; `2,348 stars this month`
...
1. [gin-gonic / gin](https://github.com/gin-gonic/gin)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **86,419** &nbsp;&nbsp; folks: **8,449**  &nbsp;&nbsp; `2,635 stars this month`
...
1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **210,582** &nbsp;&nbsp; folks: **48,617**  &nbsp;&nbsp; `4,008 stars this month`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **80,956** &nbsp;&nbsp; folks: **4,494**  &nbsp;&nbsp; `8,021 stars this month`
