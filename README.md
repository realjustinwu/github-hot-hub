...
`更新时间：2025-07-27 03:20:01 +0800`

## 今日热门仓库

1. [frappe / hrms](https://github.com/frappe/hrms)
    - Open Source HR and Payroll Software
    - language: **Python** &nbsp;&nbsp; stars: **4,545** &nbsp;&nbsp; folks: **1,381**  &nbsp;&nbsp; `531 stars today`

1. [QwenLM / Qwen3-Coder](https://github.com/QwenLM/Qwen3-Coder)
    - Qwen3-Coder is the code version of Qwen3, the large language model series developed by Qwen team, Alibaba Cloud.
    - language: **Python** &nbsp;&nbsp; stars: **9,272** &nbsp;&nbsp; folks: **651**  &nbsp;&nbsp; `622 stars today`
...
1. [goldbergyoni / nodebestpractices](https://github.com/goldbergyoni/nodebestpractices)
    ...
    - language: **Dockerfile** &nbsp;&nbsp; stars: **103,551** &nbsp;&nbsp; folks: **10,523**  &nbsp;&nbsp; `18 stars today`
...
1. [Raphire / Win11Debloat](https://github.com/Raphire/Win11Debloat)
    ...
    - language: **PowerShell** &nbsp;&nbsp; stars: **23,146** &nbsp;&nbsp; folks: **959**  &nbsp;&nbsp; `254 stars today`
...
1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **6,341** &nbsp;&nbsp; folks: **857**  &nbsp;&nbsp; `1,340 stars this week`
...
1. [frappe / hrms](https://github.com/frappe/hrms)
    - Open Source HR and Payroll Software
    - language: **Python** &nbsp;&nbsp; stars: **4,545** &nbsp;&nbsp; folks: **1,381**  &nbsp;&nbsp; `1,151 stars this week`

1. [hyprwm / Hyprland](https://github.com/hyprwm/Hyprland)
    - Hyprland is an independent, highly customizable, dynamic tiling Wayland compositor that doesn't sacrifice on its looks.
    - language: **C++** &nbsp;&nbsp; stars: **28,761** &nbsp;&nbsp; folks: **1,216**  &nbsp;&nbsp; `1,684 stars this week`
...
1. [BerriAI / litellm](https://github.com/BerriAI/litellm)
    - Python SDK, Proxy Server (LLM Gateway) to call 100+ LLM APIs in OpenAI format - [Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropic, Sagemaker, HuggingFace, Replicate, Groq]
    - language: **Python** &nbsp;&nbsp; stars: **26,219** &nbsp;&nbsp; folks: **3,613**  &nbsp;&nbsp; `545 stars this week`
...
1. [google-gemini / gemini-cli](https://github.com/google-gemini/gemini-cli)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **64,360** &nbsp;&nbsp; folks: **6,103**  &nbsp;&nbsp; `60,367 stars this month`
...
1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    ...
    - language: **PowerShell** &nbsp;&nbsp; stars: **26,143** &nbsp;&nbsp; folks: **1,436**  &nbsp;&nbsp; `10,913 stars this month`
