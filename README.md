...
`更新时间：2025-07-30 06:27:08 +0800`

## 今日热门仓库

1. [9001 / copyparty](https://github.com/9001/copyparty)
    - Portable file server with accelerated resumable uploads, dedup, WebDAV, FTP, TFTP, zeroconf, media indexer, thumbnails++ all in one file, no deps
    - language: **Python** &nbsp;&nbsp; stars: **10,261** &nbsp;&nbsp; folks: **293**  &nbsp;&nbsp; `4,365 stars today`

1. [cloudwego / eino](https://github.com/cloudwego/eino)
    - The ultimate LLM/AI application development framework in Golang.
    - language: **Go** &nbsp;&nbsp; stars: **5,645** &nbsp;&nbsp; folks: **455**  &nbsp;&nbsp; `105 stars today`

1. [n0-computer / iroh](https://github.com/n0-computer/iroh)
    - peer-2-peer that just works
    - language: **Rust** &nbsp;&nbsp; stars: **6,238** &nbsp;&nbsp; folks: **280**  &nbsp;&nbsp; `168 stars today`

1. [tldr-pages / tldr](https://github.com/tldr-pages/tldr)
    - 📚 Collaborative cheatsheets for console commands
    - language: **Markdown** &nbsp;&nbsp; stars: **57,555** &nbsp;&nbsp; folks: **4,625**  &nbsp;&nbsp; `380 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **53,512** &nbsp;&nbsp; folks: **6,220**  &nbsp;&nbsp; `639 stars today`
...
1. [lapce / lapce](https://github.com/lapce/lapce)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **36,909** &nbsp;&nbsp; folks: **1,164**  &nbsp;&nbsp; `54 stars today`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **20,758** &nbsp;&nbsp; folks: **4,187**  &nbsp;&nbsp; `8,664 stars this week`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **46,906** &nbsp;&nbsp; folks: **4,273**  &nbsp;&nbsp; `3,244 stars this week`

1. [frappe / hrms](https://github.com/frappe/hrms)
    - Open Source HR and Payroll Software
    - language: **Python** &nbsp;&nbsp; stars: **5,188** &nbsp;&nbsp; folks: **1,437**  &nbsp;&nbsp; `2,296 stars this week`

1. [remoteintech / remote-jobs](https://github.com/remoteintech/remote-jobs)
    - A list of semi to fully remote-friendly companies (jobs) in tech.
    - language: **JavaScript** &nbsp;&nbsp; stars: **37,540** &nbsp;&nbsp; folks: **3,651**  &nbsp;&nbsp; `2,814 stars this week`

1. [roboflow / supervision](https://github.com/roboflow/supervision)
    - We write your reusable computer vision tools. 💜
    - language: **Python** &nbsp;&nbsp; stars: **31,343** &nbsp;&nbsp; folks: **2,485**  &nbsp;&nbsp; `1,749 stars this week`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **313,554** &nbsp;&nbsp; folks: **51,488**  &nbsp;&nbsp; `1,537 stars this week`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **53,512** &nbsp;&nbsp; folks: **6,220**  &nbsp;&nbsp; `2,493 stars this week`
...
1. [langfuse / langfuse](https://github.com/langfuse/langfuse)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,352** &nbsp;&nbsp; folks: **1,322**  &nbsp;&nbsp; `312 stars this week`
...
1. [Alibaba-NLP / WebAgent](https://github.com/Alibaba-NLP/WebAgent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,233** &nbsp;&nbsp; folks: **388**  &nbsp;&nbsp; `4,055 stars this month`
...
1. [humanlayer / 12-factor-agents](https://github.com/humanlayer/12-factor-agents)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,757** &nbsp;&nbsp; folks: **708**  &nbsp;&nbsp; `5,856 stars this month`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **46,906** &nbsp;&nbsp; folks: **4,273**  &nbsp;&nbsp; `4,674 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,579** &nbsp;&nbsp; folks: **625**  &nbsp;&nbsp; `5,972 stars this month`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **7,549** &nbsp;&nbsp; folks: **376**  &nbsp;&nbsp; `5,632 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **26,701** &nbsp;&nbsp; folks: **1,475**  &nbsp;&nbsp; `10,470 stars this month`
