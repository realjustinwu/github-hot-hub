...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **60,037** &nbsp;&nbsp; folks: **7,206**  &nbsp;&nbsp; `684 stars today`
...
1. [immich-app / immich](https://github.com/immich-app/immich)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **73,487** &nbsp;&nbsp; folks: **3,879**  &nbsp;&nbsp; `347 stars today`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **4,735** &nbsp;&nbsp; folks: **192**  &nbsp;&nbsp; `392 stars today`
...
1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,982** &nbsp;&nbsp; folks: **139**  &nbsp;&nbsp; `494 stars today`

1. [HeyPuter / puter](https://github.com/HeyPuter/puter)
    - 🌐 The Internet OS! Free, Open-Source, and Self-Hostable.
    - language: **JavaScript** &nbsp;&nbsp; stars: **34,998** &nbsp;&nbsp; folks: **2,686**  &nbsp;&nbsp; `40 stars today`

1. [awslabs / mcp](https://github.com/awslabs/mcp)
    - AWS MCP Servers — helping you get the most out of AWS, wherever you use MCP.
    - language: **Python** &nbsp;&nbsp; stars: **5,596** &nbsp;&nbsp; folks: **748**  &nbsp;&nbsp; `132 stars today`
...
1. [ubicloud / ubicloud](https://github.com/ubicloud/ubicloud)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **9,841** &nbsp;&nbsp; folks: **428**  &nbsp;&nbsp; `3,807 stars this week`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,579** &nbsp;&nbsp; folks: **1,608**  &nbsp;&nbsp; `1,821 stars this week`

1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **2,870** &nbsp;&nbsp; folks: **288**  &nbsp;&nbsp; `1,136 stars this week`
...
1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,146** &nbsp;&nbsp; folks: **715**  &nbsp;&nbsp; `1,743 stars this week`
...
1. [menloresearch / jan](https://github.com/menloresearch/jan)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **37,226** &nbsp;&nbsp; folks: **2,185**  &nbsp;&nbsp; `1,151 stars this week`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **4,735** &nbsp;&nbsp; folks: **192**  &nbsp;&nbsp; `1,418 stars this week`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **9,574** &nbsp;&nbsp; folks: **1,652**  &nbsp;&nbsp; `3,278 stars this month`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **22,596** &nbsp;&nbsp; folks: **4,345**  &nbsp;&nbsp; `13,434 stars this month`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Financial data aggregator for humans and AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **50,438** &nbsp;&nbsp; folks: **4,710**  &nbsp;&nbsp; `7,132 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,999** &nbsp;&nbsp; folks: **1,033**  &nbsp;&nbsp; `8,154 stars this month`
...
1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **14,200** &nbsp;&nbsp; folks: **1,525**  &nbsp;&nbsp; `4,459 stars this month`

1. [roboflow / supervision](https://github.com/roboflow/supervision)
    - We write your reusable computer vision tools. 💜
    - language: **Python** &nbsp;&nbsp; stars: **34,109** &nbsp;&nbsp; folks: **2,750**  &nbsp;&nbsp; `6,956 stars this month`
...
1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **2,870** &nbsp;&nbsp; folks: **288**  &nbsp;&nbsp; `1,605 stars this month`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **11,492** &nbsp;&nbsp; folks: **616**  &nbsp;&nbsp; `7,087 stars this month`
