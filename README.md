...
1. [mishushakov / llm-scraper](https://github.com/mishushakov/llm-scraper)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,752** &nbsp;&nbsp; folks: **220**  &nbsp;&nbsp; `236 stars today`
...
1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **32,165** &nbsp;&nbsp; folks: **3,297**  &nbsp;&nbsp; `816 stars today`

1. [sinaptik-ai / pandas-ai](https://github.com/sinaptik-ai/pandas-ai)
    - Chat with your database or your datalake (SQL, CSV, parquet). PandasAI makes data analysis conversational using LLMs and RAG.
    - language: **Python** &nbsp;&nbsp; stars: **16,045** &nbsp;&nbsp; folks: **1,535**  &nbsp;&nbsp; `661 stars today`
...
1. [yamadashy / repomix](https://github.com/yamadashy/repomix)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,808** &nbsp;&nbsp; folks: **477**  &nbsp;&nbsp; `622 stars today`
...
1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    ...
    - language: **Markdown** &nbsp;&nbsp; stars: **340,202** &nbsp;&nbsp; folks: **31,488**  &nbsp;&nbsp; `1,059 stars today`

1. [yt-dlp / yt-dlp](https://github.com/yt-dlp/yt-dlp)
    - A feature-rich command-line audio/video downloader
    - language: **Python** &nbsp;&nbsp; stars: **101,481** &nbsp;&nbsp; folks: **7,951**  &nbsp;&nbsp; `133 stars today`
...
1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,974** &nbsp;&nbsp; folks: **1,295**  &nbsp;&nbsp; `9,419 stars this week`

1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    - 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
    - language: **Python** &nbsp;&nbsp; stars: **24,065** &nbsp;&nbsp; folks: **3,515**  &nbsp;&nbsp; `2,107 stars this week`

1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    - 🚀🚀 「大模型」2小时完全从0训练26M的小参数GPT！🌏 Train a 26M-parameter GPT from scratch in just 2h!
    - language: **Python** &nbsp;&nbsp; stars: **12,614** &nbsp;&nbsp; folks: **1,338**  &nbsp;&nbsp; `3,211 stars this week`

1. [docmost / docmost](https://github.com/docmost/docmost)
    - Docmost is an open-source collaborative wiki and documentation software. It is an open-source alternative to Confluence and Notion.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,170** &nbsp;&nbsp; folks: **464**  &nbsp;&nbsp; `1,531 stars this week`
...
1. [langgenius / dify](https://github.com/langgenius/dify)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **71,638** &nbsp;&nbsp; folks: **10,451**  &nbsp;&nbsp; `3,542 stars this week`

1. [78 / xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)
    - Build your own AI friend
    - language: **C++** &nbsp;&nbsp; stars: **6,236** &nbsp;&nbsp; folks: **1,047**  &nbsp;&nbsp; `1,105 stars this week`
...
1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **39,863** &nbsp;&nbsp; folks: **3,517**  &nbsp;&nbsp; `3,008 stars this week`

1. [hummingbot / hummingbot](https://github.com/hummingbot/hummingbot)
    - Open source software that helps you create and deploy high-frequency crypto trading bots
    - language: **Python** &nbsp;&nbsp; stars: **11,378** &nbsp;&nbsp; folks: **3,225**  &nbsp;&nbsp; `1,364 stars this week`

1. [cordx56 / rustowl](https://github.com/cordx56/rustowl)
    - Visualize Ownership and Lifetimes in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **3,794** &nbsp;&nbsp; folks: **71**  &nbsp;&nbsp; `2,220 stars this week`
...
1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **51,948** &nbsp;&nbsp; folks: **4,289**  &nbsp;&nbsp; `1,308 stars this week`
...
1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    - A simple screen parsing tool towards pure vision based GUI agent
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,974** &nbsp;&nbsp; folks: **1,295**  &nbsp;&nbsp; `11,118 stars this month`

1. [deepseek-ai / awesome-deepseek-integration](https://github.com/deepseek-ai/awesome-deepseek-integration)
    - 无
    - language: **无** &nbsp;&nbsp; stars: **20,380** &nbsp;&nbsp; folks: **2,247**  &nbsp;&nbsp; `17,549 stars this month`
...
1. [unslothai / unsloth](https://github.com/unslothai/unsloth)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **31,829** &nbsp;&nbsp; folks: **2,115**  &nbsp;&nbsp; `10,669 stars this month`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **78,242** &nbsp;&nbsp; folks: **9,294**  &nbsp;&nbsp; `19,690 stars this month`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **71,638** &nbsp;&nbsp; folks: **10,451**  &nbsp;&nbsp; `11,680 stars this month`
...
1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    - 🚀🚀 「大模型」2小时完全从0训练26M的小参数GPT！🌏 Train a 26M-parameter GPT from scratch in just 2h!
    - language: **Python** &nbsp;&nbsp; stars: **12,614** &nbsp;&nbsp; folks: **1,338**  &nbsp;&nbsp; `5,789 stars this month`
...
1. [ggml-org / llama.cpp](https://github.com/ggml-org/llama.cpp)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **75,134** &nbsp;&nbsp; folks: **10,856**  &nbsp;&nbsp; `4,217 stars this month`

1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **25,025** &nbsp;&nbsp; folks: **1,494**  &nbsp;&nbsp; `5,478 stars this month`

1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding.
    - language: **TypeScript** &nbsp;&nbsp; stars: **39,863** &nbsp;&nbsp; folks: **3,517**  &nbsp;&nbsp; `9,968 stars this month`
