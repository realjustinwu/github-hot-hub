...
`更新时间：2025-10-06 04:23:31 +0800`

## 今日热门仓库

1. [microsoft / BitNet](https://github.com/microsoft/BitNet)
    - Official inference framework for 1-bit LLMs
    - language: **Python** &nbsp;&nbsp; stars: **23,108** &nbsp;&nbsp; folks: **1,801**  &nbsp;&nbsp; `218 stars today`

1. [Flowseal / zapret-discord-youtube](https://github.com/Flowseal/zapret-discord-youtube)
    - 无
    - language: **Batchfile** &nbsp;&nbsp; stars: **16,736** &nbsp;&nbsp; folks: **1,184**  &nbsp;&nbsp; `65 stars today`
...
1. [meshery / meshery](https://github.com/meshery/meshery)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,528** &nbsp;&nbsp; folks: **2,676**  &nbsp;&nbsp; `459 stars today`
...
1. [comfyanonymous / ComfyUI](https://github.com/comfyanonymous/ComfyUI)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **90,122** &nbsp;&nbsp; folks: **10,074**  &nbsp;&nbsp; `51 stars today`

1. [hsliuping / TradingAgents-CN](https://github.com/hsliuping/TradingAgents-CN)
    - 基于多智能体LLM的中文金融交易框架 - TradingAgents中文增强版
    - language: **Python** &nbsp;&nbsp; stars: **9,236** &nbsp;&nbsp; folks: **2,053**  &nbsp;&nbsp; `192 stars today`
...
1. [kestra-io / kestra](https://github.com/kestra-io/kestra)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **21,981** &nbsp;&nbsp; folks: **1,983**  &nbsp;&nbsp; `159 stars today`
...
1. [audacity / audacity](https://github.com/audacity/audacity)
    - Audio Editor
    - language: **C++** &nbsp;&nbsp; stars: **14,675** &nbsp;&nbsp; folks: **2,398**  &nbsp;&nbsp; `165 stars today`
...
1. [aandrew-me / ytDownloader](https://github.com/aandrew-me/ytDownloader)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **2,198** &nbsp;&nbsp; folks: **191**  &nbsp;&nbsp; `239 stars today`

1. [expressjs / express](https://github.com/expressjs/express)
    - Fast, unopinionated, minimalist web framework for node.
    - language: **JavaScript** &nbsp;&nbsp; stars: **67,845** &nbsp;&nbsp; folks: **21,037**  &nbsp;&nbsp; `11 stars today`
...
1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **45,667** &nbsp;&nbsp; folks: **6,387**  &nbsp;&nbsp; `5,535 stars this week`

1. [nextcloud / server](https://github.com/nextcloud/server)
    - ☁️ Nextcloud server, a safe home for all your data
    - language: **PHP** &nbsp;&nbsp; stars: **32,734** &nbsp;&nbsp; folks: **4,557**  &nbsp;&nbsp; `1,846 stars this week`
...
1. [hsliuping / TradingAgents-CN](https://github.com/hsliuping/TradingAgents-CN)
    - 基于多智能体LLM的中文金融交易框架 - TradingAgents中文增强版
    - language: **Python** &nbsp;&nbsp; stars: **9,236** &nbsp;&nbsp; folks: **2,053**  &nbsp;&nbsp; `1,816 stars this week`
...
1. [Flowseal / zapret-discord-youtube](https://github.com/Flowseal/zapret-discord-youtube)
    - 无
    - language: **Batchfile** &nbsp;&nbsp; stars: **16,736** &nbsp;&nbsp; folks: **1,184**  &nbsp;&nbsp; `187 stars this week`
...
1. [tile-ai / tilelang](https://github.com/tile-ai/tilelang)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,158** &nbsp;&nbsp; folks: **226**  &nbsp;&nbsp; `1,458 stars this week`
...
1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    - 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
    - language: **Python** &nbsp;&nbsp; stars: **45,667** &nbsp;&nbsp; folks: **6,387**  &nbsp;&nbsp; `6,154 stars this month`
