...
1. [FreeTubeApp / FreeTube](https://github.com/FreeTubeApp/FreeTube)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,515** &nbsp;&nbsp; folks: **922**  &nbsp;&nbsp; `89 stars today`
...
1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    ...
    - language: **Markdown** &nbsp;&nbsp; stars: **339,636** &nbsp;&nbsp; folks: **31,440**  &nbsp;&nbsp; `791 stars today`

1. [godotengine / godot](https://github.com/godotengine/godot)
    - Godot Engine – Multi-platform 2D and 3D game engine
    - language: **C++** &nbsp;&nbsp; stars: **94,312** &nbsp;&nbsp; folks: **21,747**  &nbsp;&nbsp; `28 stars today`
...
1. [yamadashy / repomix](https://github.com/yamadashy/repomix)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,440** &nbsp;&nbsp; folks: **462**  &nbsp;&nbsp; `114 stars today`
...
1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,664** &nbsp;&nbsp; folks: **1,268**  &nbsp;&nbsp; `10,172 stars this week`
...
1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **12,311** &nbsp;&nbsp; folks: **1,300**  &nbsp;&nbsp; `2,984 stars this week`

1. [docmost / docmost](https://github.com/docmost/docmost)
    - Docmost is an open-source collaborative wiki and documentation software. It is an open-source alternative to Confluence and Notion.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,068** &nbsp;&nbsp; folks: **459**  &nbsp;&nbsp; `1,361 stars this week`
...
1. [78 / xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **6,116** &nbsp;&nbsp; folks: **1,023**  &nbsp;&nbsp; `970 stars this week`
...
1. [langgenius / dify](https://github.com/langgenius/dify)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **71,207** &nbsp;&nbsp; folks: **10,394**  &nbsp;&nbsp; `3,600 stars this week`
...
1. [deepseek-ai / awesome-deepseek-integration](https://github.com/deepseek-ai/awesome-deepseek-integration)
    - 无
    - language: **无** &nbsp;&nbsp; stars: **19,579** &nbsp;&nbsp; folks: **2,162**  &nbsp;&nbsp; `16,936 stars this month`

1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    - A simple screen parsing tool towards pure vision based GUI agent
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,664** &nbsp;&nbsp; folks: **1,268**  &nbsp;&nbsp; `10,707 stars this month`
...
1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **71,207** &nbsp;&nbsp; folks: **10,394**  &nbsp;&nbsp; `11,536 stars this month`
...
1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    - 🚀🚀 「大模型」2小时完全从0训练26M的小参数GPT！🌏 Train a 26M-parameter GPT from scratch in just 2h!
    - language: **Python** &nbsp;&nbsp; stars: **12,311** &nbsp;&nbsp; folks: **1,300**  &nbsp;&nbsp; `5,786 stars this month`

1. [assafelovic / gpt-researcher](https://github.com/assafelovic/gpt-researcher)
    - LLM based autonomous agent that conducts deep local and web research on any topic and generates a long report with citations.
    - language: **Python** &nbsp;&nbsp; stars: **19,100** &nbsp;&nbsp; folks: **2,471**  &nbsp;&nbsp; `3,261 stars this month`
...
1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    - Make websites accessible for AI agents
    - language: **Python** &nbsp;&nbsp; stars: **31,598** &nbsp;&nbsp; folks: **3,258**  &nbsp;&nbsp; `15,350 stars this month`
