...
1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,911** &nbsp;&nbsp; folks: **639**  &nbsp;&nbsp; `392 stars today`

1. [menloresearch / jan](https://github.com/menloresearch/jan)
    - Jan is an open source alternative to ChatGPT that runs 100% offline on your computer
    - language: **TypeScript** &nbsp;&nbsp; stars: **36,571** &nbsp;&nbsp; folks: **2,138**  &nbsp;&nbsp; `243 stars today`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,907** &nbsp;&nbsp; folks: **1,419**  &nbsp;&nbsp; `196 stars today`
...
1. [filamentphp / filament](https://github.com/filamentphp/filament)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **25,490** &nbsp;&nbsp; folks: **3,647**  &nbsp;&nbsp; `36 stars today`

1. [open-telemetry / opentelemetry-collector](https://github.com/open-telemetry/opentelemetry-collector)
    - OpenTelemetry Collector
    - language: **Go** &nbsp;&nbsp; stars: **5,593** &nbsp;&nbsp; folks: **1,706**  &nbsp;&nbsp; `85 stars today`
...
1. [conductor-oss / conductor](https://github.com/conductor-oss/conductor)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **25,218** &nbsp;&nbsp; folks: **661**  &nbsp;&nbsp; `282 stars today`

1. [microsoft / poml](https://github.com/microsoft/poml)
    - Prompt Orchestration Markup Language
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,435** &nbsp;&nbsp; folks: **46**  &nbsp;&nbsp; `763 stars today`
...
1. [x1xhlol / system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools)
    ...
    - language: **无** &nbsp;&nbsp; stars: **75,803** &nbsp;&nbsp; folks: **21,288**  &nbsp;&nbsp; `573 stars today`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **34,756** &nbsp;&nbsp; folks: **3,966**  &nbsp;&nbsp; `2,867 stars this week`
...
1. [openai / openai-cookbook](https://github.com/openai/openai-cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **66,995** &nbsp;&nbsp; folks: **11,107**  &nbsp;&nbsp; `1,224 stars this week`
...
1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,612** &nbsp;&nbsp; folks: **1,185**  &nbsp;&nbsp; `4,187 stars this week`

1. [menloresearch / jan](https://github.com/menloresearch/jan)
    - Jan is an open source alternative to ChatGPT that runs 100% offline on your computer
    - language: **TypeScript** &nbsp;&nbsp; stars: **36,571** &nbsp;&nbsp; folks: **2,138**  &nbsp;&nbsp; `1,067 stars this week`

1. [patchy631 / ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)
    - In-depth tutorials on LLMs, RAGs and real-world AI agent applications.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **17,050** &nbsp;&nbsp; folks: **2,865**  &nbsp;&nbsp; `1,300 stars this week`
...
1. [umami-software / umami](https://github.com/umami-software/umami)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,741** &nbsp;&nbsp; folks: **5,368**  &nbsp;&nbsp; `1,856 stars this week`
...
1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **55,077** &nbsp;&nbsp; folks: **9,344**  &nbsp;&nbsp; `1,002 stars this week`
...
1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    - Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!
    - language: **Python** &nbsp;&nbsp; stars: **7,911** &nbsp;&nbsp; folks: **639**  &nbsp;&nbsp; `962 stars this week`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **106,482** &nbsp;&nbsp; folks: **14,369**  &nbsp;&nbsp; `1,200 stars this week`
...
1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,612** &nbsp;&nbsp; folks: **1,185**  &nbsp;&nbsp; `10,590 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,645** &nbsp;&nbsp; folks: **939**  &nbsp;&nbsp; `9,034 stars this month`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **71,161** &nbsp;&nbsp; folks: **3,864**  &nbsp;&nbsp; `11,119 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,352** &nbsp;&nbsp; folks: **566**  &nbsp;&nbsp; `6,505 stars this month`
...
1. [sst / opencode](https://github.com/sst/opencode)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **19,228** &nbsp;&nbsp; folks: **1,220**  &nbsp;&nbsp; `7,499 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,077** &nbsp;&nbsp; folks: **9,344**  &nbsp;&nbsp; `3,015 stars this month`
