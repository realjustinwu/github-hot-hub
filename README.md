...
`更新时间：2025-09-07 05:18:47 +0800`

## 今日热门仓库

1. [zama-ai / fhevm](https://github.com/zama-ai/fhevm)
    - FHEVM, a full-stack framework for integrating Fully Homomorphic Encryption (FHE) with blockchain applications
    - language: **Rust** &nbsp;&nbsp; stars: **17,110** &nbsp;&nbsp; folks: **706**  &nbsp;&nbsp; `227 stars today`
...
1. [trufflesecurity / trufflehog](https://github.com/trufflesecurity/trufflehog)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **20,962** &nbsp;&nbsp; folks: **1,992**  &nbsp;&nbsp; `214 stars today`

1. [rails / rails](https://github.com/rails/rails)
    - Ruby on Rails
    - language: **Ruby** &nbsp;&nbsp; stars: **57,478** &nbsp;&nbsp; folks: **21,954**  &nbsp;&nbsp; `20 stars today`

1. [microsoft / BitNet](https://github.com/microsoft/BitNet)
    - Official inference framework for 1-bit LLMs
    - language: **Python** &nbsp;&nbsp; stars: **21,580** &nbsp;&nbsp; folks: **1,640**  &nbsp;&nbsp; `168 stars today`

1. [coleam00 / ottomator-agents](https://github.com/coleam00/ottomator-agents)
    - All the open source AI Agents hosted on the oTTomator Live Agent Studio platform!
    - language: **Python** &nbsp;&nbsp; stars: **3,916** &nbsp;&nbsp; folks: **1,424**  &nbsp;&nbsp; `71 stars today`

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **9,168** &nbsp;&nbsp; folks: **763**  &nbsp;&nbsp; `299 stars today`

1. [mack-a / v2ray-agent](https://github.com/mack-a/v2ray-agent)
    - Xray、Tuic、hysteria2、sing-box 八合一一键脚本
    - language: **Shell** &nbsp;&nbsp; stars: **17,093** &nbsp;&nbsp; folks: **5,100**  &nbsp;&nbsp; `174 stars today`
...
1. [apache / airflow](https://github.com/apache/airflow)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **42,130** &nbsp;&nbsp; folks: **15,542**  &nbsp;&nbsp; `198 stars today`

1. [apple / embedding-atlas](https://github.com/apple/embedding-atlas)
    - Embedding Atlas is a tool that provides interactive visualizations for large embeddings. It allows you to visualize, cross-filter, and search embeddings and metadata.
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,558** &nbsp;&nbsp; folks: **171**  &nbsp;&nbsp; `49 stars today`
...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **3,631** &nbsp;&nbsp; folks: **273**  &nbsp;&nbsp; `38 stars today`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **65,218** &nbsp;&nbsp; folks: **5,565**  &nbsp;&nbsp; `69 stars today`
...
1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,634** &nbsp;&nbsp; folks: **595**  &nbsp;&nbsp; `2,346 stars this week`
...
1. [QuentinFuxa / WhisperLiveKit](https://github.com/QuentinFuxa/WhisperLiveKit)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,434** &nbsp;&nbsp; folks: **545**  &nbsp;&nbsp; `4,205 stars this week`
...
1. [chiphuyen / aie-book](https://github.com/chiphuyen/aie-book)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **7,977** &nbsp;&nbsp; folks: **1,052**  &nbsp;&nbsp; `1,881 stars this week`
...
1. [JetBrains / koog](https://github.com/JetBrains/koog)
    ...
    - language: **Kotlin** &nbsp;&nbsp; stars: **2,930** &nbsp;&nbsp; folks: **196**  &nbsp;&nbsp; `1,260 stars this week`
...
1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **8,859** &nbsp;&nbsp; folks: **266**  &nbsp;&nbsp; `5,468 stars this month`

1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Open-source platform to build and deploy AI agent workflows.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,273** &nbsp;&nbsp; folks: **1,743**  &nbsp;&nbsp; `7,824 stars this month`
...
1. [basecamp / omarchy](https://github.com/basecamp/omarchy)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **7,046** &nbsp;&nbsp; folks: **849**  &nbsp;&nbsp; `4,037 stars this month`
