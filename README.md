...
1. [11cafe / jaaz](https://github.com/11cafe/jaaz)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,468** &nbsp;&nbsp; folks: **310**  &nbsp;&nbsp; `675 stars today`

1. [pathwaycom / pathway](https://github.com/pathwaycom/pathway)
    - Python ETL framework for stream processing, real-time analytics, LLM pipelines, and RAG.
    - language: **Python** &nbsp;&nbsp; stars: **40,747** &nbsp;&nbsp; folks: **1,239**  &nbsp;&nbsp; `1,127 stars today`

1. [ClemensElflein / OpenMower](https://github.com/ClemensElflein/OpenMower)
    - Let's upgrade cheap off-the-shelf robotic mowers to modern, smart RTK GPS based lawn mowing robots!
    - language: **C++** &nbsp;&nbsp; stars: **5,993** &nbsp;&nbsp; folks: **347**  &nbsp;&nbsp; `28 stars today`
...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **4,141** &nbsp;&nbsp; folks: **289**  &nbsp;&nbsp; `69 stars today`

1. [immich-app / immich](https://github.com/immich-app/immich)
    - High performance self-hosted photo and video management solution.
    - language: **TypeScript** &nbsp;&nbsp; stars: **76,096** &nbsp;&nbsp; folks: **4,027**  &nbsp;&nbsp; `519 stars today`

1. [HKUDS / AutoAgent](https://github.com/HKUDS/AutoAgent)
    - "AutoAgent: Fully-Automated and Zero-Code LLM Agent Framework"
    - language: **Python** &nbsp;&nbsp; stars: **6,191** &nbsp;&nbsp; folks: **850**  &nbsp;&nbsp; `59 stars today`
...
1. [pedroslopez / whatsapp-web.js](https://github.com/pedroslopez/whatsapp-web.js)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,333** &nbsp;&nbsp; folks: **4,483**  &nbsp;&nbsp; `1,263 stars this week`
...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    - Distributed query engine providing simple and reliable data processing for any modality and scale
    - language: **Rust** &nbsp;&nbsp; stars: **4,141** &nbsp;&nbsp; folks: **289**  &nbsp;&nbsp; `721 stars this week`
...
1. [trufflesecurity / trufflehog](https://github.com/trufflesecurity/trufflehog)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **21,321** &nbsp;&nbsp; folks: **2,010**  &nbsp;&nbsp; `866 stars this week`

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **11,150** &nbsp;&nbsp; folks: **888**  &nbsp;&nbsp; `2,730 stars this week`
...
1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **66,296** &nbsp;&nbsp; folks: **5,630**  &nbsp;&nbsp; `1,145 stars this week`
...
1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,595** &nbsp;&nbsp; folks: **3,108**  &nbsp;&nbsp; `11,330 stars this month`
...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,554** &nbsp;&nbsp; folks: **1,795**  &nbsp;&nbsp; `7,496 stars this month`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **39,756** &nbsp;&nbsp; folks: **4,620**  &nbsp;&nbsp; `7,094 stars this month`
