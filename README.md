...
1. [eclipse-sumo / sumo](https://github.com/eclipse-sumo/sumo)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,049** &nbsp;&nbsp; folks: **1,575**  &nbsp;&nbsp; `61 stars today`

1. [9001 / copyparty](https://github.com/9001/copyparty)
    - Portable file server with accelerated resumable uploads, dedup, WebDAV, FTP, TFTP, zeroconf, media indexer, thumbnails++ all in one file, no deps
    - language: **Python** &nbsp;&nbsp; stars: **17,403** &nbsp;&nbsp; folks: **562**  &nbsp;&nbsp; `1,667 stars today`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder | v0 / lovable / Bolt alternative | 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,928** &nbsp;&nbsp; folks: **434**  &nbsp;&nbsp; `276 stars today`
...
1. [QwenLM / Qwen3-Coder](https://github.com/QwenLM/Qwen3-Coder)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,712** &nbsp;&nbsp; folks: **743**  &nbsp;&nbsp; `2,579 stars this week`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **47,349** &nbsp;&nbsp; folks: **4,329**  &nbsp;&nbsp; `1,898 stars this week`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **54,578** &nbsp;&nbsp; folks: **6,363**  &nbsp;&nbsp; `3,013 stars this week`
...
1. [roboflow / supervision](https://github.com/roboflow/supervision)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **32,679** &nbsp;&nbsp; folks: **2,609**  &nbsp;&nbsp; `2,357 stars this week`
...
1. [daveebbelaar / ai-cookbook](https://github.com/daveebbelaar/ai-cookbook)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,517** &nbsp;&nbsp; folks: **860**  &nbsp;&nbsp; `936 stars this week`
...
1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **8,490** &nbsp;&nbsp; folks: **618**  &nbsp;&nbsp; `6,793 stars this month`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **70,002** &nbsp;&nbsp; folks: **3,777**  &nbsp;&nbsp; `10,556 stars this month`

1. [datawhalechina / happy-llm](https://github.com/datawhalechina/happy-llm)
    - 📚 从零开始的大语言模型原理与实践教程
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **13,953** &nbsp;&nbsp; folks: **1,067**  &nbsp;&nbsp; `9,091 stars this month`
...
1. [getzep / graphiti](https://github.com/getzep/graphiti)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,689** &nbsp;&nbsp; folks: **1,347**  &nbsp;&nbsp; `3,737 stars this month`
