...
`更新时间：2025-07-15 22:25:30 +0800`

## 今日热门仓库

1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    - Python tool for converting files and office documents to Markdown.
    - language: **Python** &nbsp;&nbsp; stars: **61,960** &nbsp;&nbsp; folks: **3,303**  &nbsp;&nbsp; `935 stars today`
...
1. [bluewave-labs / Checkmate](https://github.com/bluewave-labs/Checkmate)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,386** &nbsp;&nbsp; folks: **420**  &nbsp;&nbsp; `83 stars today`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **23,006** &nbsp;&nbsp; folks: **1,249**  &nbsp;&nbsp; `1,772 stars today`

1. [OpenPipe / ART](https://github.com/OpenPipe/ART)
    - Agent Reinforcement Trainer: train multi-step agents for real-world tasks using GRPO. Give your agents on-the-job training. Reinforcement learning for Qwen2.5, Qwen3, Llama, Kimi, and more!
    - language: **Python** &nbsp;&nbsp; stars: **2,083** &nbsp;&nbsp; folks: **132**  &nbsp;&nbsp; `484 stars today`

1. [beeradmoore / dlss-swapper](https://github.com/beeradmoore/dlss-swapper)
    - 无
    - language: **C#** &nbsp;&nbsp; stars: **4,450** &nbsp;&nbsp; folks: **137**  &nbsp;&nbsp; `45 stars today`

1. [AykutSarac / jsoncrack.com](https://github.com/AykutSarac/jsoncrack.com)
    - ✨ Innovative and open-source visualization application that transforms various data formats, such as JSON, YAML, XML, CSV and more, into interactive graphs.
    - language: **TypeScript** &nbsp;&nbsp; stars: **39,825** &nbsp;&nbsp; folks: **2,667**  &nbsp;&nbsp; `105 stars today`

1. [browserbase / stagehand](https://github.com/browserbase/stagehand)
    - The AI Browser Automation Framework
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,003** &nbsp;&nbsp; folks: **836**  &nbsp;&nbsp; `94 stars today`
...
1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **6,663** &nbsp;&nbsp; folks: **492**  &nbsp;&nbsp; `4,697 stars this week`
...
1. [rustfs / rustfs](https://github.com/rustfs/rustfs)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **5,027** &nbsp;&nbsp; folks: **229**  &nbsp;&nbsp; `3,303 stars this week`
...
1. [getzep / graphiti](https://github.com/getzep/graphiti)
    - Build Real-Time Knowledge Graphs for AI Agents
    - language: **Python** &nbsp;&nbsp; stars: **13,459** &nbsp;&nbsp; folks: **1,133**  &nbsp;&nbsp; `1,035 stars this week`

1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    - 小红书笔记 | 评论爬虫、抖音视频 | 评论爬虫、快手视频 | 评论爬虫、B 站视频 ｜ 评论爬虫、微博帖子 ｜ 评论爬虫、百度贴吧帖子 ｜ 百度贴吧评论回复爬虫 | 知乎问答文章｜评论爬虫
    - language: **Python** &nbsp;&nbsp; stars: **31,623** &nbsp;&nbsp; folks: **7,672**  &nbsp;&nbsp; `3,082 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **23,006** &nbsp;&nbsp; folks: **1,249**  &nbsp;&nbsp; `3,410 stars this week`

1. [RSSNext / Folo](https://github.com/RSSNext/Folo)
    - 🧡 Follow everything in one place
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,348** &nbsp;&nbsp; folks: **1,313**  &nbsp;&nbsp; `1,490 stars this week`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,401** &nbsp;&nbsp; folks: **332**  &nbsp;&nbsp; `1,290 stars this week`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    - 小红书笔记 | 评论爬虫、抖音视频 | 评论爬虫、快手视频 | 评论爬虫、B 站视频 ｜ 评论爬虫、微博帖子 ｜ 评论爬虫、百度贴吧帖子 ｜ 百度贴吧评论回复爬虫 | 知乎问答文章｜评论爬虫
    - language: **Python** &nbsp;&nbsp; stars: **31,623** &nbsp;&nbsp; folks: **7,672**  &nbsp;&nbsp; `7,971 stars this month`
...
1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    - MCP Toolbox for Databases is an open source MCP server for databases.
    - language: **Go** &nbsp;&nbsp; stars: **6,663** &nbsp;&nbsp; folks: **492**  &nbsp;&nbsp; `5,061 stars this month`
...
1. [menloresearch / jan](https://github.com/menloresearch/jan)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **34,818** &nbsp;&nbsp; folks: **2,044**  &nbsp;&nbsp; `5,446 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **23,006** &nbsp;&nbsp; folks: **1,249**  &nbsp;&nbsp; `8,567 stars this month`

1. [datawhalechina / happy-llm](https://github.com/datawhalechina/happy-llm)
    - 📚 从零开始的大语言模型原理与实践教程
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **11,380** &nbsp;&nbsp; folks: **839**  &nbsp;&nbsp; `7,969 stars this month`
...
1. [GyulyVGC / sniffnet](https://github.com/GyulyVGC/sniffnet)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **28,377** &nbsp;&nbsp; folks: **931**  &nbsp;&nbsp; `3,964 stars this month`

1. [DrKLO / Telegram](https://github.com/DrKLO/Telegram)
    - Telegram for Android source
    - language: **Java** &nbsp;&nbsp; stars: **27,144** &nbsp;&nbsp; folks: **8,807**  &nbsp;&nbsp; `948 stars this month`
...
1. [snailyp / gemini-balance](https://github.com/snailyp/gemini-balance)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,235** &nbsp;&nbsp; folks: **571**  &nbsp;&nbsp; `1,426 stars this month`

1. [stanford-oval / storm](https://github.com/stanford-oval/storm)
    - An LLM-powered knowledge curation system that researches a topic and generates a full-length report with citations.
    - language: **Python** &nbsp;&nbsp; stars: **26,606** &nbsp;&nbsp; folks: **2,396**  &nbsp;&nbsp; `2,079 stars this month`

1. [linshenkx / prompt-optimizer](https://github.com/linshenkx/prompt-optimizer)
    - 一款提示词优化器，助力于编写高质量的提示词
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,766** &nbsp;&nbsp; folks: **1,222**  &nbsp;&nbsp; `3,980 stars this month`
