...
`更新时间：2025-07-27 04:27:39 +0800`

## 今日热门仓库

1. [frappe / hrms](https://github.com/frappe/hrms)
    - Open Source HR and Payroll Software
    - language: **Python** &nbsp;&nbsp; stars: **4,563** &nbsp;&nbsp; folks: **1,381**  &nbsp;&nbsp; `531 stars today`

1. [QwenLM / Qwen3-Coder](https://github.com/QwenLM/Qwen3-Coder)
    - Qwen3-Coder is the code version of Qwen3, the large language model series developed by Qwen team, Alibaba Cloud.
    - language: **Python** &nbsp;&nbsp; stars: **9,292** &nbsp;&nbsp; folks: **652**  &nbsp;&nbsp; `622 stars today`
...
1. [Raphire / Win11Debloat](https://github.com/Raphire/Win11Debloat)
    ...
    - language: **PowerShell** &nbsp;&nbsp; stars: **23,162** &nbsp;&nbsp; folks: **959**  &nbsp;&nbsp; `254 stars today`
...
1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **6,345** &nbsp;&nbsp; folks: **859**  &nbsp;&nbsp; `1,340 stars this week`
...
1. [frappe / hrms](https://github.com/frappe/hrms)
    - Open Source HR and Payroll Software
    - language: **Python** &nbsp;&nbsp; stars: **4,563** &nbsp;&nbsp; folks: **1,381**  &nbsp;&nbsp; `1,151 stars this week`

1. [hyprwm / Hyprland](https://github.com/hyprwm/Hyprland)
    - Hyprland is an independent, highly customizable, dynamic tiling Wayland compositor that doesn't sacrifice on its looks.
    - language: **C++** &nbsp;&nbsp; stars: **28,766** &nbsp;&nbsp; folks: **1,216**  &nbsp;&nbsp; `1,684 stars this week`
...
1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **32,665** &nbsp;&nbsp; folks: **9,595**  &nbsp;&nbsp; `1,616 stars this week`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **6,806** &nbsp;&nbsp; folks: **343**  &nbsp;&nbsp; `2,300 stars this week`

1. [BerriAI / litellm](https://github.com/BerriAI/litellm)
    - Python SDK, Proxy Server (LLM Gateway) to call 100+ LLM APIs in OpenAI format - [Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropic, Sagemaker, HuggingFace, Replicate, Groq]
    - language: **Python** &nbsp;&nbsp; stars: **26,229** &nbsp;&nbsp; folks: **3,615**  &nbsp;&nbsp; `545 stars this week`

1. [hummingbot / hummingbot](https://github.com/hummingbot/hummingbot)
    - Open source software that helps you create and deploy high-frequency crypto trading bots
    - language: **Python** &nbsp;&nbsp; stars: **13,642** &nbsp;&nbsp; folks: **3,735**  &nbsp;&nbsp; `332 stars this week`

1. [Dokploy / dokploy](https://github.com/Dokploy/dokploy)
    - Open Source Alternative to Vercel, Netlify and Heroku.
    - language: **TypeScript** &nbsp;&nbsp; stars: **22,218** &nbsp;&nbsp; folks: **1,221**  &nbsp;&nbsp; `632 stars this week`
...
1. [gitleaks / gitleaks](https://github.com/gitleaks/gitleaks)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **22,606** &nbsp;&nbsp; folks: **1,734**  &nbsp;&nbsp; `687 stars this week`
...
1. [google-gemini / gemini-cli](https://github.com/google-gemini/gemini-cli)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **64,374** &nbsp;&nbsp; folks: **6,104**  &nbsp;&nbsp; `60,367 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **6,806** &nbsp;&nbsp; folks: **343**  &nbsp;&nbsp; `5,278 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,634** &nbsp;&nbsp; folks: **568**  &nbsp;&nbsp; `5,850 stars this month`

1. [GyulyVGC / sniffnet](https://github.com/GyulyVGC/sniffnet)
    - Comfortably monitor your Internet traffic 🕵️‍♂️
    - language: **Rust** &nbsp;&nbsp; stars: **29,404** &nbsp;&nbsp; folks: **980**  &nbsp;&nbsp; `4,928 stars this month`
