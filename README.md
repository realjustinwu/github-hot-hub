...
`更新时间：2025-04-20 22:21:19 +0800`

## 今日热门仓库

1. [microsoft / BitNet](https://github.com/microsoft/BitNet)
    - Official inference framework for 1-bit LLMs
    - language: **C++** &nbsp;&nbsp; stars: **14,647** &nbsp;&nbsp; folks: **1,023**  &nbsp;&nbsp; `627 stars today`

1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    - PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/Docker/Zotero
    - language: **Python** &nbsp;&nbsp; stars: **20,614** &nbsp;&nbsp; folks: **1,752**  &nbsp;&nbsp; `71 stars today`

1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    - A collective list of free APIs
    - language: **Python** &nbsp;&nbsp; stars: **336,493** &nbsp;&nbsp; folks: **35,584**  &nbsp;&nbsp; `467 stars today`

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **78,250** &nbsp;&nbsp; folks: **9,446**  &nbsp;&nbsp; `876 stars today`
...
1. [1Panel-dev / 1Panel](https://github.com/1Panel-dev/1Panel)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **27,565** &nbsp;&nbsp; folks: **2,403**  &nbsp;&nbsp; `213 stars today`
...
1. [yt-dlp / yt-dlp](https://github.com/yt-dlp/yt-dlp)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **108,237** &nbsp;&nbsp; folks: **8,508**  &nbsp;&nbsp; `108 stars today`

1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    - Python tool for converting files and office documents to Markdown.
    - language: **Python** &nbsp;&nbsp; stars: **50,039** &nbsp;&nbsp; folks: **2,419**  &nbsp;&nbsp; `489 stars today`
...
1. [ashvardanian / less_slow.cpp](https://github.com/ashvardanian/less_slow.cpp)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **1,183** &nbsp;&nbsp; folks: **49**  &nbsp;&nbsp; `140 stars today`

1. [wandb / openui](https://github.com/wandb/openui)
    - OpenUI let's you describe UI using your imagination, then see it rendered live.
    - language: **TypeScript** &nbsp;&nbsp; stars: **20,389** &nbsp;&nbsp; folks: **1,919**  &nbsp;&nbsp; `37 stars today`

1. [linera-io / linera-protocol](https://github.com/linera-io/linera-protocol)
    - Main repository for the Linera protocol
    - language: **Rust** &nbsp;&nbsp; stars: **23,990** &nbsp;&nbsp; folks: **1,475**  &nbsp;&nbsp; `460 stars today`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,803** &nbsp;&nbsp; folks: **2,426**  &nbsp;&nbsp; `8,715 stars this week`
...
1. [Zackriya-Solutions / meeting-minutes](https://github.com/Zackriya-Solutions/meeting-minutes)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,955** &nbsp;&nbsp; folks: **267**  &nbsp;&nbsp; `1,949 stars this week`
...
1. [krillinai / KrillinAI](https://github.com/krillinai/KrillinAI)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **5,432** &nbsp;&nbsp; folks: **390**  &nbsp;&nbsp; `2,436 stars this week`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    - [Support 0.48.x]（Reset Cursor AI MachineID & Bypass Higher Token Limit） Cursor Ai ，自动重置机器ID ， 免费升级使用Pro功能: You've reached your trial request limit. / Too many free trial accounts used on this machine. Please upgrade to pro. We have this limit in place to prevent abuse. Please let us know if you believe this is a mistake.
    - language: **Python** &nbsp;&nbsp; stars: **19,803** &nbsp;&nbsp; folks: **2,426**  &nbsp;&nbsp; `16,037 stars this month`

1. [punkpeye / awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)
    - A collection of MCP servers.
    - language: **无** &nbsp;&nbsp; stars: **40,409** &nbsp;&nbsp; folks: **2,888**  &nbsp;&nbsp; `28,105 stars this month`

1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    - A GUI Agent application based on UI-TARS(Vision-Language Model) that allows you to control your computer using natural language.
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,955** &nbsp;&nbsp; folks: **945**  &nbsp;&nbsp; `8,763 stars this month`
...
1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,967** &nbsp;&nbsp; folks: **3,896**  &nbsp;&nbsp; `11,106 stars this month`
