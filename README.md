...
1. [Guovin / iptv-api](https://github.com/Guovin/iptv-api)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,692** &nbsp;&nbsp; folks: **1,524**  &nbsp;&nbsp; `65 stars today`

1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    - Master programming by recreating your favorite technologies from scratch.
    - language: **Markdown** &nbsp;&nbsp; stars: **314,650** &nbsp;&nbsp; folks: **29,193**  &nbsp;&nbsp; `347 stars today`

1. [opendatalab / MinerU](https://github.com/opendatalab/MinerU)
    - A high-quality tool for convert PDF to Markdown and JSON.一站式开源高质量数据提取工具，将PDF转换成Markdown和JSON格式。
    - language: **Python** &nbsp;&nbsp; stars: **19,654** &nbsp;&nbsp; folks: **1,395**  &nbsp;&nbsp; `300 stars today`

1. [keephq / keep](https://github.com/keephq/keep)
    - The open-source alert management and AIOps platform
    - language: **Python** &nbsp;&nbsp; stars: **7,367** &nbsp;&nbsp; folks: **728**  &nbsp;&nbsp; `1,730 stars today`

1. [langflow-ai / langflow](https://github.com/langflow-ai/langflow)
    - Langflow is a low-code app builder for RAG and multi-agent AI applications. It’s Python-based and agnostic to any model, API, or database.
    - language: **JavaScript** &nbsp;&nbsp; stars: **36,556** &nbsp;&nbsp; folks: **4,293**  &nbsp;&nbsp; `150 stars today`
...
1. [kestra-io / kestra](https://github.com/kestra-io/kestra)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **13,856** &nbsp;&nbsp; folks: **1,192**  &nbsp;&nbsp; `65 stars today`

1. [QwenLM / Qwen-Agent](https://github.com/QwenLM/Qwen-Agent)
    - Agent framework and applications built upon Qwen>=2.0, featuring Function Calling, Code Interpreter, RAG, and Chrome extension.
    - language: **Python** &nbsp;&nbsp; stars: **4,064** &nbsp;&nbsp; folks: **377**  &nbsp;&nbsp; `161 stars today`
...
1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **64,271** &nbsp;&nbsp; folks: **7,836**  &nbsp;&nbsp; `3,369 stars this week`
...
1. [awslabs / multi-agent-orchestrator](https://github.com/awslabs/multi-agent-orchestrator)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,602** &nbsp;&nbsp; folks: **178**  &nbsp;&nbsp; `558 stars this week`
...
1. [jesseduffield / lazydocker](https://github.com/jesseduffield/lazydocker)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **38,838** &nbsp;&nbsp; folks: **1,234**  &nbsp;&nbsp; `1,146 stars this week`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **340,682** &nbsp;&nbsp; folks: **61,884**  &nbsp;&nbsp; `1,551 stars this week`
...
1. [black-forest-labs / flux](https://github.com/black-forest-labs/flux)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,989** &nbsp;&nbsp; folks: **1,264**  &nbsp;&nbsp; `1,157 stars this week`
...
1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    - 🔥🕷️ Crawl4AI: Crawl Smarter, Faster, Freely. For AI.
    - language: **HTML** &nbsp;&nbsp; stars: **17,390** &nbsp;&nbsp; folks: **1,284**  &nbsp;&nbsp; `874 stars this week`

1. [tmc / langchaingo](https://github.com/tmc/langchaingo)
    - LangChain for Go, the easiest way to write LLM-based programs in Go
    - language: **Go** &nbsp;&nbsp; stars: **5,055** &nbsp;&nbsp; folks: **649**  &nbsp;&nbsp; `177 stars this week`

1. [krahets / hello-algo](https://github.com/krahets/hello-algo)
    - 《Hello 算法》：动画图解、一键运行的数据结构与算法教程。支持 Python, Java, C++, C, C#, JS, Go, Swift, Rust, Ruby, Kotlin, TS, Dart 代码。简体版和繁体版同步更新，English version ongoing
    - language: **Java** &nbsp;&nbsp; stars: **100,841** &nbsp;&nbsp; folks: **12,661**  &nbsp;&nbsp; `1,011 stars this week`

1. [tailwindlabs / tailwindcss](https://github.com/tailwindlabs/tailwindcss)
    - A utility-first CSS framework for rapid UI development.
    - language: **TypeScript** &nbsp;&nbsp; stars: **83,573** &nbsp;&nbsp; folks: **4,228**  &nbsp;&nbsp; `250 stars this week`
...
1. [trungdq88 / Awesome-Black-Friday-Cyber-Monday](https://github.com/trungdq88/Awesome-Black-Friday-Cyber-Monday)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,898** &nbsp;&nbsp; folks: **1,195**  &nbsp;&nbsp; `511 stars this week`
...
1. [DS4SD / docling](https://github.com/DS4SD/docling)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,892** &nbsp;&nbsp; folks: **592**  &nbsp;&nbsp; `11,157 stars this month`

1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **30,126** &nbsp;&nbsp; folks: **2,047**  &nbsp;&nbsp; `12,189 stars this month`

1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    - Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue)
    - language: **Python** &nbsp;&nbsp; stars: **64,271** &nbsp;&nbsp; folks: **7,836**  &nbsp;&nbsp; `7,118 stars this month`

1. [ai16z / eliza](https://github.com/ai16z/eliza)
    - Conversational Agent for Twitter and Discord
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,496** &nbsp;&nbsp; folks: **735**  &nbsp;&nbsp; `2,098 stars this month`

1. [opendatalab / MinerU](https://github.com/opendatalab/MinerU)
    - A high-quality tool for convert PDF to Markdown and JSON.一站式开源高质量数据提取工具，将PDF转换成Markdown和JSON格式。
    - language: **Python** &nbsp;&nbsp; stars: **19,654** &nbsp;&nbsp; folks: **1,395**  &nbsp;&nbsp; `6,130 stars this month`
...
1. [All-Hands-AI / OpenHands](https://github.com/All-Hands-AI/OpenHands)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **37,750** &nbsp;&nbsp; folks: **4,267**  &nbsp;&nbsp; `4,537 stars this month`

1. [khoj-ai / khoj](https://github.com/khoj-ai/khoj)
    - Your AI second brain. Self-hostable. Get answers from the web or your docs. Build custom agents, schedule automations, do deep research. Turn any online or local LLM into your personal, autonomous AI (e.g gpt, claude, gemini, llama, qwen, mistral).
    - language: **Python** &nbsp;&nbsp; stars: **16,462** &nbsp;&nbsp; folks: **801**  &nbsp;&nbsp; `3,586 stars this month`

1. [payloadcms / payload](https://github.com/payloadcms/payload)
    - Payload is the open-source, fullstack Next.js framework, giving you instant backend superpowers. Get a full TypeScript backend and admin panel instantly. Use Payload as a headless CMS or for building powerful applications.
    - language: **TypeScript** &nbsp;&nbsp; stars: **28,990** &nbsp;&nbsp; folks: **1,798**  &nbsp;&nbsp; `4,215 stars this month`

1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **16,605** &nbsp;&nbsp; folks: **887**  &nbsp;&nbsp; `5,748 stars this month`

1. [microsoft / autogen](https://github.com/microsoft/autogen)
    - A programming framework for agentic AI 🤖
    - language: **Python** &nbsp;&nbsp; stars: **35,142** &nbsp;&nbsp; folks: **5,087**  &nbsp;&nbsp; `2,703 stars this month`

1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    - 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
    - language: **Python** &nbsp;&nbsp; stars: **18,521** &nbsp;&nbsp; folks: **2,836**  &nbsp;&nbsp; `1,842 stars this month`
...
1. [jesseduffield / lazydocker](https://github.com/jesseduffield/lazydocker)
    - The lazier way to manage everything docker
    - language: **Go** &nbsp;&nbsp; stars: **38,838** &nbsp;&nbsp; folks: **1,234**  &nbsp;&nbsp; `1,793 stars this month`
...
1. [ItzCrazyKns / Perplexica](https://github.com/ItzCrazyKns/Perplexica)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,809** &nbsp;&nbsp; folks: **1,571**  &nbsp;&nbsp; `2,489 stars this month`
