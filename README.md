...
`更新时间：2025-08-17 19:19:39 +0800`

## 今日热门仓库

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **6,975** &nbsp;&nbsp; folks: **1,378**  &nbsp;&nbsp; `273 stars today`

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **4,306** &nbsp;&nbsp; folks: **428**  &nbsp;&nbsp; `411 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **58,493** &nbsp;&nbsp; folks: **6,995**  &nbsp;&nbsp; `479 stars today`
...
1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **3,789** &nbsp;&nbsp; folks: **158**  &nbsp;&nbsp; `248 stars today`
...
1. [DataExpert-io / data-engineer-handbook](https://github.com/DataExpert-io/data-engineer-handbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **36,326** &nbsp;&nbsp; folks: **7,028**  &nbsp;&nbsp; `33 stars today`

1. [clash-verge-rev / clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev)
    - A modern GUI client based on Tauri, designed to run in Windows, macOS and Linux for tailored proxy experience
    - language: **TypeScript** &nbsp;&nbsp; stars: **70,416** &nbsp;&nbsp; folks: **5,324**  &nbsp;&nbsp; `118 stars today`
...
1. [MotiaDev / motia](https://github.com/MotiaDev/motia)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,047** &nbsp;&nbsp; folks: **471**  &nbsp;&nbsp; `158 stars today`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **35,266** &nbsp;&nbsp; folks: **4,032**  &nbsp;&nbsp; `2,062 stars this week`
...
1. [conductor-oss / conductor](https://github.com/conductor-oss/conductor)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **26,045** &nbsp;&nbsp; folks: **674**  &nbsp;&nbsp; `1,269 stars this week`
...
1. [idosal / git-mcp](https://github.com/idosal/git-mcp)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,316** &nbsp;&nbsp; folks: **397**  &nbsp;&nbsp; `1,139 stars this week`
...
1. [filamentphp / filament](https://github.com/filamentphp/filament)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **25,771** &nbsp;&nbsp; folks: **3,680**  &nbsp;&nbsp; `406 stars this week`
...
1. [umami-software / umami](https://github.com/umami-software/umami)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **30,080** &nbsp;&nbsp; folks: **5,391**  &nbsp;&nbsp; `2,248 stars this week`

1. [lfnovo / open-notebook](https://github.com/lfnovo/open-notebook)
    - An Open Source implementation of Notebook LM with more flexibility and features
    - language: **Python** &nbsp;&nbsp; stars: **3,533** &nbsp;&nbsp; folks: **361**  &nbsp;&nbsp; `738 stars this week`
...
1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,498** &nbsp;&nbsp; folks: **1,001**  &nbsp;&nbsp; `8,553 stars this month`

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **6,975** &nbsp;&nbsp; folks: **1,378**  &nbsp;&nbsp; `934 stars this month`
...
1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **7,909** &nbsp;&nbsp; folks: **1,046**  &nbsp;&nbsp; `3,502 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,985** &nbsp;&nbsp; folks: **598**  &nbsp;&nbsp; `6,821 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,454** &nbsp;&nbsp; folks: **9,426**  &nbsp;&nbsp; `3,093 stars this month`
