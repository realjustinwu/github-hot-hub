...
`更新时间：2025-07-30 05:26:42 +0800`

## 今日热门仓库

1. [9001 / copyparty](https://github.com/9001/copyparty)
    - Portable file server with accelerated resumable uploads, dedup, WebDAV, FTP, TFTP, zeroconf, media indexer, thumbnails++ all in one file, no deps
    - language: **Python** &nbsp;&nbsp; stars: **10,167** &nbsp;&nbsp; folks: **289**  &nbsp;&nbsp; `4,365 stars today`

1. [cloudwego / eino](https://github.com/cloudwego/eino)
    - The ultimate LLM/AI application development framework in Golang.
    - language: **Go** &nbsp;&nbsp; stars: **5,641** &nbsp;&nbsp; folks: **454**  &nbsp;&nbsp; `105 stars today`

1. [n0-computer / iroh](https://github.com/n0-computer/iroh)
    - peer-2-peer that just works
    - language: **Rust** &nbsp;&nbsp; stars: **6,227** &nbsp;&nbsp; folks: **280**  &nbsp;&nbsp; `168 stars today`

1. [tldr-pages / tldr](https://github.com/tldr-pages/tldr)
    - 📚 Collaborative cheatsheets for console commands
    - language: **Markdown** &nbsp;&nbsp; stars: **57,545** &nbsp;&nbsp; folks: **4,625**  &nbsp;&nbsp; `380 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **53,496** &nbsp;&nbsp; folks: **6,217**  &nbsp;&nbsp; `639 stars today`
...
1. [frappe / hrms](https://github.com/frappe/hrms)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,183** &nbsp;&nbsp; folks: **1,437**  &nbsp;&nbsp; `2,296 stars this week`
...
1. [roboflow / supervision](https://github.com/roboflow/supervision)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **31,320** &nbsp;&nbsp; folks: **2,484**  &nbsp;&nbsp; `1,749 stars this week`
...
1. [SillyTavern / SillyTavern](https://github.com/SillyTavern/SillyTavern)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **16,784** &nbsp;&nbsp; folks: **3,708**  &nbsp;&nbsp; `279 stars this week`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **53,496** &nbsp;&nbsp; folks: **6,217**  &nbsp;&nbsp; `2,493 stars this week`
...
1. [langfuse / langfuse](https://github.com/langfuse/langfuse)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,349** &nbsp;&nbsp; folks: **1,322**  &nbsp;&nbsp; `312 stars this week`
...
1. [humanlayer / 12-factor-agents](https://github.com/humanlayer/12-factor-agents)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,753** &nbsp;&nbsp; folks: **708**  &nbsp;&nbsp; `5,856 stars this month`
...
1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,569** &nbsp;&nbsp; folks: **625**  &nbsp;&nbsp; `5,972 stars this month`
...
1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    ...
    - language: **PowerShell** &nbsp;&nbsp; stars: **26,693** &nbsp;&nbsp; folks: **1,475**  &nbsp;&nbsp; `10,470 stars this month`
...
1. [zaidmukaddam / scira](https://github.com/zaidmukaddam/scira)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,194** &nbsp;&nbsp; folks: **1,252**  &nbsp;&nbsp; `1,834 stars this month`
...
1. [GyulyVGC / sniffnet](https://github.com/GyulyVGC/sniffnet)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **29,609** &nbsp;&nbsp; folks: **990**  &nbsp;&nbsp; `4,913 stars this month`
