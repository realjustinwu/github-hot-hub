...
1. [enescingoz / awesome-n8n-templates](https://github.com/enescingoz/awesome-n8n-templates)
    ...
    - language: **无** &nbsp;&nbsp; stars: **9,019** &nbsp;&nbsp; folks: **2,692**  &nbsp;&nbsp; `139 stars today`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **4,369** &nbsp;&nbsp; folks: **179**  &nbsp;&nbsp; `496 stars today`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **59,420** &nbsp;&nbsp; folks: **7,128**  &nbsp;&nbsp; `816 stars today`
...
1. [mfts / papermark](https://github.com/mfts/papermark)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,121** &nbsp;&nbsp; folks: **981**  &nbsp;&nbsp; `64 stars today`
...
1. [ubicloud / ubicloud](https://github.com/ubicloud/ubicloud)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **9,738** &nbsp;&nbsp; folks: **422**  &nbsp;&nbsp; `3,931 stars this week`

1. [apple / embedding-atlas](https://github.com/apple/embedding-atlas)
    - Embedding Atlas is a tool that provides interactive visualizations for large embeddings. It allows you to visualize, cross-filter, and search embeddings and metadata.
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,697** &nbsp;&nbsp; folks: **119**  &nbsp;&nbsp; `1,846 stars this week`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,344** &nbsp;&nbsp; folks: **1,562**  &nbsp;&nbsp; `1,646 stars this week`

1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **2,638** &nbsp;&nbsp; folks: **267**  &nbsp;&nbsp; `711 stars this week`
...
1. [trailofbits / buttercup](https://github.com/trailofbits/buttercup)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **904** &nbsp;&nbsp; folks: **92**  &nbsp;&nbsp; `535 stars this week`
...
1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,015** &nbsp;&nbsp; folks: **706**  &nbsp;&nbsp; `1,713 stars this week`

1. [syncthing / syncthing](https://github.com/syncthing/syncthing)
    - Open Source Continuous File Synchronization
    - language: **Go** &nbsp;&nbsp; stars: **75,131** &nbsp;&nbsp; folks: **4,700**  &nbsp;&nbsp; `839 stars this week`
...
1. [librespot-org / librespot](https://github.com/librespot-org/librespot)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **5,487** &nbsp;&nbsp; folks: **717**  &nbsp;&nbsp; `53 stars this week`

1. [filamentphp / filament](https://github.com/filamentphp/filament)
    - A powerful open source UI framework for Laravel • Build and ship admin panels & apps fast with Livewire
    - language: **PHP** &nbsp;&nbsp; stars: **25,813** &nbsp;&nbsp; folks: **3,682**  &nbsp;&nbsp; `422 stars this week`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **22,464** &nbsp;&nbsp; folks: **4,335**  &nbsp;&nbsp; `13,297 stars this month`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Financial data aggregator for humans and AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **50,127** &nbsp;&nbsp; folks: **4,683**  &nbsp;&nbsp; `6,794 stars this month`

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **8,575** &nbsp;&nbsp; folks: **1,549**  &nbsp;&nbsp; `1,987 stars this month`
...
1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,783** &nbsp;&nbsp; folks: **1,020**  &nbsp;&nbsp; `8,385 stars this month`
...
1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **8,001** &nbsp;&nbsp; folks: **1,057**  &nbsp;&nbsp; `3,326 stars this month`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **11,291** &nbsp;&nbsp; folks: **611**  &nbsp;&nbsp; `6,928 stars this month`
