...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,669** &nbsp;&nbsp; folks: **1,183**  &nbsp;&nbsp; `1,504 stars today`
...
1. [bitwarden / clients](https://github.com/bitwarden/clients)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,866** &nbsp;&nbsp; folks: **1,461**  &nbsp;&nbsp; `170 stars today`
...
1. [firecrawl / firecrawl](https://github.com/firecrawl/firecrawl)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **50,452** &nbsp;&nbsp; folks: **4,424**  &nbsp;&nbsp; `600 stars today`
...
1. [skills / introduction-to-github](https://github.com/skills/introduction-to-github)
    ...
    - language: **无** &nbsp;&nbsp; stars: **9,313** &nbsp;&nbsp; folks: **11,996**  &nbsp;&nbsp; `12 stars today`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **5,207** &nbsp;&nbsp; folks: **356**  &nbsp;&nbsp; `1,080 stars this week`
...
1. [ubicloud / ubicloud](https://github.com/ubicloud/ubicloud)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **10,006** &nbsp;&nbsp; folks: **440**  &nbsp;&nbsp; `2,449 stars this week`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **60,946** &nbsp;&nbsp; folks: **7,334**  &nbsp;&nbsp; `3,373 stars this week`

1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    - Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!
    - language: **Python** &nbsp;&nbsp; stars: **9,429** &nbsp;&nbsp; folks: **723**  &nbsp;&nbsp; `1,387 stars this week`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,866** &nbsp;&nbsp; folks: **1,660**  &nbsp;&nbsp; `1,861 stars this week`
...
1. [MotiaDev / motia](https://github.com/MotiaDev/motia)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,006** &nbsp;&nbsp; folks: **533**  &nbsp;&nbsp; `1,056 stars this week`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,093** &nbsp;&nbsp; folks: **1,752**  &nbsp;&nbsp; `4,785 stars this month`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,573** &nbsp;&nbsp; folks: **1,316**  &nbsp;&nbsp; `11,521 stars this month`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **5,207** &nbsp;&nbsp; folks: **356**  &nbsp;&nbsp; `1,652 stars this month`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **22,814** &nbsp;&nbsp; folks: **4,361**  &nbsp;&nbsp; `13,341 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,954** &nbsp;&nbsp; folks: **9,554**  &nbsp;&nbsp; `3,238 stars this month`

1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Sim is an open-source AI agent workflow builder. Sim Studio's interface is a lightweight, intuitive way to quickly build and deploy LLMs that connect with your favorite tools.
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,669** &nbsp;&nbsp; folks: **1,183**  &nbsp;&nbsp; `2,970 stars this month`
