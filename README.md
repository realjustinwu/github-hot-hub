...
`更新时间：2025-06-12 01:22:56 +0800`

## 今日热门仓库

1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    - 😎 Awesome lists about all kinds of interesting topics
    - language: **无** &nbsp;&nbsp; stars: **365,622** &nbsp;&nbsp; folks: **29,384**  &nbsp;&nbsp; `501 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **34,945** &nbsp;&nbsp; folks: **3,999**  &nbsp;&nbsp; `622 stars today`
...
1. [OpenBMB / MiniCPM](https://github.com/OpenBMB/MiniCPM)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **7,751** &nbsp;&nbsp; folks: **480**  &nbsp;&nbsp; `80 stars today`
...
1. [tensorzero / tensorzero](https://github.com/tensorzero/tensorzero)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **6,569** &nbsp;&nbsp; folks: **394**  &nbsp;&nbsp; `1,746 stars this week`
...
1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,267** &nbsp;&nbsp; folks: **1,158**  &nbsp;&nbsp; `4,678 stars this week`
...
1. [netbirdio / netbird](https://github.com/netbirdio/netbird)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **15,420** &nbsp;&nbsp; folks: **726**  &nbsp;&nbsp; `1,528 stars this week`
...
1. [datawhalechina / self-llm](https://github.com/datawhalechina/self-llm)
    - 《开源大模型食用指南》针对中国宝宝量身打造的基于Linux环境快速微调（全参数/Lora）、部署国内外开源大模型（LLM）/多模态大模型（MLLM）教程
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **17,236** &nbsp;&nbsp; folks: **1,857**  &nbsp;&nbsp; `743 stars this week`

1. [eyaltoledano / claude-task-master](https://github.com/eyaltoledano/claude-task-master)
    - An AI-powered task-management system you can drop into Cursor, Lovable, Windsurf, Roo, and others.
    - language: **JavaScript** &nbsp;&nbsp; stars: **14,051** &nbsp;&nbsp; folks: **1,445**  &nbsp;&nbsp; `2,129 stars this week`
...
1. [lastmile-ai / mcp-agent](https://github.com/lastmile-ai/mcp-agent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,535** &nbsp;&nbsp; folks: **515**  &nbsp;&nbsp; `610 stars this week`
...
1. [gitroomhq / postiz-app](https://github.com/gitroomhq/postiz-app)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,588** &nbsp;&nbsp; folks: **3,364**  &nbsp;&nbsp; `1,101 stars this week`
...
1. [Fosowl / agenticSeek](https://github.com/Fosowl/agenticSeek)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,899** &nbsp;&nbsp; folks: **1,710**  &nbsp;&nbsp; `15,404 stars this month`

1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    - The Cursor for Designers • An Open-Source Visual Vibecoding Editor • Visually build, style, and edit your React App with AI
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,267** &nbsp;&nbsp; folks: **1,158**  &nbsp;&nbsp; `8,698 stars this month`
...
1. [mindsdb / mindsdb](https://github.com/mindsdb/mindsdb)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **31,964** &nbsp;&nbsp; folks: **5,277**  &nbsp;&nbsp; `4,159 stars this month`
...
1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **35,657** &nbsp;&nbsp; folks: **6,201**  &nbsp;&nbsp; `8,567 stars this month`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **350,795** &nbsp;&nbsp; folks: **36,877**  &nbsp;&nbsp; `12,196 stars this month`
...
1. [tensorzero / tensorzero](https://github.com/tensorzero/tensorzero)
    - TensorZero creates a feedback loop for optimizing LLM applications — turning production data into smarter, faster, and cheaper models.
    - language: **Rust** &nbsp;&nbsp; stars: **6,569** &nbsp;&nbsp; folks: **394**  &nbsp;&nbsp; `2,245 stars this month`
