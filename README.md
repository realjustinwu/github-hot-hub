...
1. [x1xhlol / system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools)
    ...
    - language: **无** &nbsp;&nbsp; stars: **82,750** &nbsp;&nbsp; folks: **23,001**  &nbsp;&nbsp; `620 stars today`
...
1. [vercel / examples](https://github.com/vercel/examples)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,272** &nbsp;&nbsp; folks: **1,414**  &nbsp;&nbsp; `73 stars today`

1. [Cinnamon / kotaemon](https://github.com/Cinnamon/kotaemon)
    - An open-source RAG-based tool for chatting with your documents.
    - language: **Python** &nbsp;&nbsp; stars: **23,718** &nbsp;&nbsp; folks: **1,932**  &nbsp;&nbsp; `332 stars today`

1. [pathwaycom / llm-app](https://github.com/pathwaycom/llm-app)
    - Ready-to-run cloud templates for RAG, AI pipelines, and enterprise search with live data. 🐳Docker-friendly.⚡Always in sync with Sharepoint, Google Drive, S3, Kafka, PostgreSQL, real-time data APIs, and more.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **38,351** &nbsp;&nbsp; folks: **1,046**  &nbsp;&nbsp; `1,854 stars today`
...
1. [11cafe / jaaz](https://github.com/11cafe/jaaz)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,599** &nbsp;&nbsp; folks: **314**  &nbsp;&nbsp; `675 stars today`

1. [pathwaycom / pathway](https://github.com/pathwaycom/pathway)
    - Python ETL framework for stream processing, real-time analytics, LLM pipelines, and RAG.
    - language: **Python** &nbsp;&nbsp; stars: **40,868** &nbsp;&nbsp; folks: **1,245**  &nbsp;&nbsp; `2,045 stars today`
...
1. [juspay / hyperswitch](https://github.com/juspay/hyperswitch)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **32,418** &nbsp;&nbsp; folks: **4,158**  &nbsp;&nbsp; `1,862 stars today`
...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **4,216** &nbsp;&nbsp; folks: **290**  &nbsp;&nbsp; `59 stars today`

1. [immich-app / immich](https://github.com/immich-app/immich)
    - High performance self-hosted photo and video management solution.
    - language: **TypeScript** &nbsp;&nbsp; stars: **76,219** &nbsp;&nbsp; folks: **4,033**  &nbsp;&nbsp; `510 stars today`
...
1. [LukeGus / Termix](https://github.com/LukeGus/Termix)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,400** &nbsp;&nbsp; folks: **132**  &nbsp;&nbsp; `1,382 stars this week`
...
1. [resemble-ai / chatterbox](https://github.com/resemble-ai/chatterbox)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **12,521** &nbsp;&nbsp; folks: **1,578**  &nbsp;&nbsp; `1,130 stars this week`

1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    - Distributed query engine providing simple and reliable data processing for any modality and scale
    - language: **Rust** &nbsp;&nbsp; stars: **4,216** &nbsp;&nbsp; folks: **290**  &nbsp;&nbsp; `786 stars this week`
...
1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **11,302** &nbsp;&nbsp; folks: **896**  &nbsp;&nbsp; `2,815 stars this week`
...
1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **97,993** &nbsp;&nbsp; folks: **14,366**  &nbsp;&nbsp; `976 stars this week`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,829** &nbsp;&nbsp; folks: **2,057**  &nbsp;&nbsp; `6,630 stars this month`
...
1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **9,082** &nbsp;&nbsp; folks: **274**  &nbsp;&nbsp; `5,750 stars this month`
