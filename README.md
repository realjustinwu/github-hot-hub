...
1. [hyprwm / Hyprland](https://github.com/hyprwm/Hyprland)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **28,590** &nbsp;&nbsp; folks: **1,205**  &nbsp;&nbsp; `219 stars today`

1. [ankitects / anki](https://github.com/ankitects/anki)
    - Anki is a smart spaced repetition flashcard program
    - language: **Rust** &nbsp;&nbsp; stars: **22,700** &nbsp;&nbsp; folks: **2,415**  &nbsp;&nbsp; `37 stars today`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **68,997** &nbsp;&nbsp; folks: **3,677**  &nbsp;&nbsp; `7,091 stars this week`

1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The personal finance app for everyone
    - language: **Ruby** &nbsp;&nbsp; stars: **50,634** &nbsp;&nbsp; folks: **3,753**  &nbsp;&nbsp; `5,414 stars this week`
...
1. [hyprwm / Hyprland](https://github.com/hyprwm/Hyprland)
    - Hyprland is an independent, highly customizable, dynamic tiling Wayland compositor that doesn't sacrifice on its looks.
    - language: **C++** &nbsp;&nbsp; stars: **28,590** &nbsp;&nbsp; folks: **1,205**  &nbsp;&nbsp; `1,560 stars this week`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,962** &nbsp;&nbsp; folks: **513**  &nbsp;&nbsp; `2,328 stars this week`
...
1. [getzep / graphiti](https://github.com/getzep/graphiti)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **14,813** &nbsp;&nbsp; folks: **1,242**  &nbsp;&nbsp; `1,246 stars this week`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,217** &nbsp;&nbsp; folks: **7,906**  &nbsp;&nbsp; `9,590 stars this month`
...
1. [Alibaba-NLP / WebAgent](https://github.com/Alibaba-NLP/WebAgent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,898** &nbsp;&nbsp; folks: **365**  &nbsp;&nbsp; `3,814 stars this month`
...
1. [humanlayer / 12-factor-agents](https://github.com/humanlayer/12-factor-agents)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,025** &nbsp;&nbsp; folks: **653**  &nbsp;&nbsp; `5,519 stars this month`
...
1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    ...
    - language: **PowerShell** &nbsp;&nbsp; stars: **25,422** &nbsp;&nbsp; folks: **1,390**  &nbsp;&nbsp; `11,047 stars this month`
...
1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The personal finance app for everyone
    - language: **Ruby** &nbsp;&nbsp; stars: **50,634** &nbsp;&nbsp; folks: **3,753**  &nbsp;&nbsp; `5,760 stars this month`

1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 26 lessons, 52 quizzes, classic Machine Learning for all
    - language: **HTML** &nbsp;&nbsp; stars: **75,315** &nbsp;&nbsp; folks: **16,648**  &nbsp;&nbsp; `2,602 stars this month`
...
1. [embabel / embabel-agent](https://github.com/embabel/embabel-agent)
    ...
    - language: **Kotlin** &nbsp;&nbsp; stars: **2,255** &nbsp;&nbsp; folks: **178**  &nbsp;&nbsp; `1,766 stars this month`

1. [datawhalechina / happy-llm](https://github.com/datawhalechina/happy-llm)
    - 📚 从零开始的大语言模型原理与实践教程
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **12,703** &nbsp;&nbsp; folks: **944**  &nbsp;&nbsp; `8,775 stars this month`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,347** &nbsp;&nbsp; folks: **449**  &nbsp;&nbsp; `4,003 stars this month`

1. [snailyp / gemini-balance](https://github.com/snailyp/gemini-balance)
    - Gemini polling proxy service （gemini轮询代理服务）
    - language: **Python** &nbsp;&nbsp; stars: **3,639** &nbsp;&nbsp; folks: **641**  &nbsp;&nbsp; `1,818 stars this month`
