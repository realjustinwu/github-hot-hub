...
1. [nexus-xyz / network-api](https://github.com/nexus-xyz/network-api)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **390** &nbsp;&nbsp; folks: **172**  &nbsp;&nbsp; `28 stars today`

1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    - A simple screen parsing tool towards pure vision based GUI agent
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,040** &nbsp;&nbsp; folks: **1,131**  &nbsp;&nbsp; `1,798 stars today`

1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    - 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
    - language: **Python** &nbsp;&nbsp; stars: **23,218** &nbsp;&nbsp; folks: **3,410**  &nbsp;&nbsp; `475 stars today`

1. [hpcaitech / ColossalAI](https://github.com/hpcaitech/ColossalAI)
    - Making large AI models cheaper, faster and more accessible
    - language: **Python** &nbsp;&nbsp; stars: **40,017** &nbsp;&nbsp; folks: **4,451**  &nbsp;&nbsp; `264 stars today`
...
1. [treetrum / amazon-kindle-bulk-downloader](https://github.com/treetrum/amazon-kindle-bulk-downloader)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **240** &nbsp;&nbsp; folks: **21**  &nbsp;&nbsp; `108 stars today`

1. [wangrongding / wechat-bot](https://github.com/wangrongding/wechat-bot)
    - 🤖一个基于 WeChaty 结合 DeepSeek / ChatGPT / Kimi / 讯飞等Ai服务实现的微信机器人 ，可以用来帮助你自动回复微信消息，或者管理微信群/好友，检测僵尸粉等...
    - language: **JavaScript** &nbsp;&nbsp; stars: **6,712** &nbsp;&nbsp; folks: **881**  &nbsp;&nbsp; `48 stars today`
...
1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    - A simple screen parsing tool towards pure vision based GUI agent
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,040** &nbsp;&nbsp; folks: **1,131**  &nbsp;&nbsp; `7,663 stars this week`
...
1. [langgenius / dify](https://github.com/langgenius/dify)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **70,048** &nbsp;&nbsp; folks: **10,206**  &nbsp;&nbsp; `3,322 stars this week`
...
1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    - 🚀🚀 「大模型」2小时完全从0训练26M的小参数GPT！🌏 Train a 26M-parameter GPT from scratch in just 2h!
    - language: **Python** &nbsp;&nbsp; stars: **10,997** &nbsp;&nbsp; folks: **1,160**  &nbsp;&nbsp; `1,898 stars this week`

1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    - Python tool for converting files and office documents to Markdown.
    - language: **HTML** &nbsp;&nbsp; stars: **38,191** &nbsp;&nbsp; folks: **1,763**  &nbsp;&nbsp; `1,454 stars this week`

1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    - 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
    - language: **Python** &nbsp;&nbsp; stars: **23,218** &nbsp;&nbsp; folks: **3,410**  &nbsp;&nbsp; `1,128 stars this week`

1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding.
    - language: **TypeScript** &nbsp;&nbsp; stars: **38,163** &nbsp;&nbsp; folks: **3,390**  &nbsp;&nbsp; `2,721 stars this week`

1. [vercel / ai-chatbot](https://github.com/vercel/ai-chatbot)
    - A full-featured, hackable Next.js AI chatbot built by Vercel
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,153** &nbsp;&nbsp; folks: **3,350**  &nbsp;&nbsp; `1,067 stars this week`
...
1. [labring / FastGPT](https://github.com/labring/FastGPT)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,451** &nbsp;&nbsp; folks: **5,515**  &nbsp;&nbsp; `821 stars this week`

1. [datawhalechina / llm-cookbook](https://github.com/datawhalechina/llm-cookbook)
    - 面向开发者的 LLM 入门教程，吴恩达大模型系列课程中文版
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,288** &nbsp;&nbsp; folks: **1,912**  &nbsp;&nbsp; `1,178 stars this week`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **51,295** &nbsp;&nbsp; folks: **4,225**  &nbsp;&nbsp; `1,380 stars this week`
...
1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    - A simple screen parsing tool towards pure vision based GUI agent
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,040** &nbsp;&nbsp; folks: **1,131**  &nbsp;&nbsp; `7,735 stars this month`

1. [deepseek-ai / DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
    - DeepSeek Coder: Let the Code Write Itself
    - language: **Python** &nbsp;&nbsp; stars: **20,039** &nbsp;&nbsp; folks: **2,227**  &nbsp;&nbsp; `9,803 stars this month`

1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **128,014** &nbsp;&nbsp; folks: **10,423**  &nbsp;&nbsp; `19,747 stars this month`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **76,883** &nbsp;&nbsp; folks: **9,111**  &nbsp;&nbsp; `19,542 stars this month`

1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The OS for your personal finances
    - language: **Ruby** &nbsp;&nbsp; stars: **40,095** &nbsp;&nbsp; folks: **2,849**  &nbsp;&nbsp; `5,239 stars this month`

1. [unslothai / unsloth](https://github.com/unslothai/unsloth)
    - Finetune Llama 3.3, DeepSeek-R1 & Reasoning LLMs 2x faster with 70% less memory! 🦥
    - language: **Python** &nbsp;&nbsp; stars: **30,901** &nbsp;&nbsp; folks: **2,055**  &nbsp;&nbsp; `9,904 stars this month`

1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    - Make websites accessible for AI agents
    - language: **Python** &nbsp;&nbsp; stars: **30,061** &nbsp;&nbsp; folks: **3,099**  &nbsp;&nbsp; `14,830 stars this month`
...
1. [Mintplex-Labs / anything-llm](https://github.com/Mintplex-Labs/anything-llm)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **38,120** &nbsp;&nbsp; folks: **3,671**  &nbsp;&nbsp; `7,611 stars this month`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **70,048** &nbsp;&nbsp; folks: **10,206**  &nbsp;&nbsp; `10,456 stars this month`

1. [Bin-Huang / chatbox](https://github.com/Bin-Huang/chatbox)
    - User-friendly Desktop Client App for AI Models/LLMs (GPT, Claude, Gemini, Ollama...)
    - language: **TypeScript** &nbsp;&nbsp; stars: **31,500** &nbsp;&nbsp; folks: **2,983**  &nbsp;&nbsp; `6,599 stars this month`
...
1. [ggml-org / llama.cpp](https://github.com/ggml-org/llama.cpp)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **74,835** &nbsp;&nbsp; folks: **10,816**  &nbsp;&nbsp; `4,183 stars this month`

1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **24,333** &nbsp;&nbsp; folks: **1,448**  &nbsp;&nbsp; `5,275 stars this month`

1. [microsoft / generative-ai-for-beginners](https://github.com/microsoft/generative-ai-for-beginners)
    - 21 Lessons, Get Started Building with Generative AI 🔗 https://microsoft.github.io/generative-ai-for-beginners/
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **71,077** &nbsp;&nbsp; folks: **36,896**  &nbsp;&nbsp; `4,717 stars this month`
...
1. [assafelovic / gpt-researcher](https://github.com/assafelovic/gpt-researcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **18,876** &nbsp;&nbsp; folks: **2,441**  &nbsp;&nbsp; `3,110 stars this month`
