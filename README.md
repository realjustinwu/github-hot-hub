...
1. [andrewyng / aisuite](https://github.com/andrewyng/aisuite)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,075** &nbsp;&nbsp; folks: **292**  &nbsp;&nbsp; `1,009 stars today`

1. [wagoodman / dive](https://github.com/wagoodman/dive)
    - A tool for exploring each layer in a docker image
    - language: **Go** &nbsp;&nbsp; stars: **47,438** &nbsp;&nbsp; folks: **1,791**  &nbsp;&nbsp; `297 stars today`

1. [microsoft / graphrag](https://github.com/microsoft/graphrag)
    - A modular graph-based Retrieval-Augmented Generation (RAG) system
    - language: **Python** &nbsp;&nbsp; stars: **19,647** &nbsp;&nbsp; folks: **1,936**  &nbsp;&nbsp; `95 stars today`
...
1. [skills / introduction-to-github](https://github.com/skills/introduction-to-github)
    ...
    - language: **无** &nbsp;&nbsp; stars: **4,672** &nbsp;&nbsp; folks: **3,051**  &nbsp;&nbsp; `6 stars today`
...
1. [jesseduffield / lazydocker](https://github.com/jesseduffield/lazydocker)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **38,504** &nbsp;&nbsp; folks: **1,226**  &nbsp;&nbsp; `162 stars today`
...
1. [Azure / azure-sdk-for-net](https://github.com/Azure/azure-sdk-for-net)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **5,512** &nbsp;&nbsp; folks: **4,820**  &nbsp;&nbsp; `11 stars today`
...
1. [gitroomhq / postiz-app](https://github.com/gitroomhq/postiz-app)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,913** &nbsp;&nbsp; folks: **2,362**  &nbsp;&nbsp; `1,747 stars this week`
...
1. [DataExpert-io / data-engineer-handbook](https://github.com/DataExpert-io/data-engineer-handbook)
    ...
    - language: **Makefile** &nbsp;&nbsp; stars: **21,606** &nbsp;&nbsp; folks: **3,399**  &nbsp;&nbsp; `3,499 stars this week`
...
1. [twentyhq / twenty](https://github.com/twentyhq/twenty)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **23,627** &nbsp;&nbsp; folks: **2,433**  &nbsp;&nbsp; `2,885 stars this week`
...
1. [payloadcms / payload](https://github.com/payloadcms/payload)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **28,559** &nbsp;&nbsp; folks: **1,766**  &nbsp;&nbsp; `2,633 stars this week`
...
1. [FreeCAD / FreeCAD](https://github.com/FreeCAD/FreeCAD)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **21,082** &nbsp;&nbsp; folks: **4,131**  &nbsp;&nbsp; `1,149 stars this week`

1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    - Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue)
    - language: **Python** &nbsp;&nbsp; stars: **62,831** &nbsp;&nbsp; folks: **7,683**  &nbsp;&nbsp; `1,733 stars this week`

1. [ai16z / eliza](https://github.com/ai16z/eliza)
    - Conversational Agent for Twitter and Discord
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,255** &nbsp;&nbsp; folks: **630**  &nbsp;&nbsp; `652 stars this week`
...
1. [DS4SD / docling](https://github.com/DS4SD/docling)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,249** &nbsp;&nbsp; folks: **550**  &nbsp;&nbsp; `10,411 stars this month`
...
1. [ai16z / eliza](https://github.com/ai16z/eliza)
    - Conversational Agent for Twitter and Discord
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,255** &nbsp;&nbsp; folks: **630**  &nbsp;&nbsp; `2,157 stars this month`

1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    - Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue)
    - language: **Python** &nbsp;&nbsp; stars: **62,831** &nbsp;&nbsp; folks: **7,683**  &nbsp;&nbsp; `5,085 stars this month`
...
1. [twentyhq / twenty](https://github.com/twentyhq/twenty)
    - Building a modern alternative to Salesforce, powered by the community.
    - language: **TypeScript** &nbsp;&nbsp; stars: **23,627** &nbsp;&nbsp; folks: **2,433**  &nbsp;&nbsp; `6,058 stars this month`
...
1. [All-Hands-AI / OpenHands](https://github.com/All-Hands-AI/OpenHands)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **37,514** &nbsp;&nbsp; folks: **4,247**  &nbsp;&nbsp; `4,395 stars this month`

1. [payloadcms / payload](https://github.com/payloadcms/payload)
    - Payload is the open-source, fullstack Next.js framework, giving you instant backend superpowers. Get a full TypeScript backend and admin panel instantly. Use Payload as a headless CMS or for building powerful applications.
    - language: **TypeScript** &nbsp;&nbsp; stars: **28,559** &nbsp;&nbsp; folks: **1,766**  &nbsp;&nbsp; `3,778 stars this month`
...
1. [dgtlmoon / changedetection.io](https://github.com/dgtlmoon/changedetection.io)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,801** &nbsp;&nbsp; folks: **1,073**  &nbsp;&nbsp; `2,335 stars this month`
