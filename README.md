...
`更新时间：2025-03-15 14:30:02 +0800`

## 今日热门仓库

1. [xpipe-io / xpipe](https://github.com/xpipe-io/xpipe)
    - Access your entire server infrastructure from your local desktop
    - language: **Java** &nbsp;&nbsp; stars: **7,505** &nbsp;&nbsp; folks: **247**  &nbsp;&nbsp; `795 stars today`

1. [freeCodeCamp / freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
    - freeCodeCamp.org's open-source codebase and curriculum. Learn to code for free.
    - language: **TypeScript** &nbsp;&nbsp; stars: **412,472** &nbsp;&nbsp; folks: **39,301**  &nbsp;&nbsp; `297 stars today`

1. [glanceapp / glance](https://github.com/glanceapp/glance)
    - A self-hosted dashboard that puts all your feeds in one place
    - language: **Go** &nbsp;&nbsp; stars: **12,660** &nbsp;&nbsp; folks: **440**  &nbsp;&nbsp; `189 stars today`

1. [openai / openai-python](https://github.com/openai/openai-python)
    - The official Python library for the OpenAI API
    - language: **Python** &nbsp;&nbsp; stars: **25,440** &nbsp;&nbsp; folks: **3,684**  &nbsp;&nbsp; `47 stars today`

1. [hpcaitech / Open-Sora](https://github.com/hpcaitech/Open-Sora)
    - Open-Sora: Democratizing Efficient Video Production for All
    - language: **Python** &nbsp;&nbsp; stars: **24,539** &nbsp;&nbsp; folks: **2,405**  &nbsp;&nbsp; `356 stars today`
...
1. [yuaotian / go-cursor-help](https://github.com/yuaotian/go-cursor-help)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **13,949** &nbsp;&nbsp; folks: **1,824**  &nbsp;&nbsp; `255 stars today`
...
1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **44,026** &nbsp;&nbsp; folks: **4,477**  &nbsp;&nbsp; `7,480 stars this week`
...
1. [PatrickJS / awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules)
    ...
    - language: **无** &nbsp;&nbsp; stars: **15,595** &nbsp;&nbsp; folks: **1,068**  &nbsp;&nbsp; `3,325 stars this week`
...
1. [freeCodeCamp / freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp)
    - freeCodeCamp.org's open-source codebase and curriculum. Learn to code for free.
    - language: **TypeScript** &nbsp;&nbsp; stars: **412,472** &nbsp;&nbsp; folks: **39,301**  &nbsp;&nbsp; `1,471 stars this week`
...
1. [mendableai / firecrawl-mcp-server](https://github.com/mendableai/firecrawl-mcp-server)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **971** &nbsp;&nbsp; folks: **79**  &nbsp;&nbsp; `401 stars this week`

1. [KRTirtho / spotube](https://github.com/KRTirtho/spotube)
    - 🎧 Open source Spotify client that doesn't require Premium nor uses Electron! Available for both desktop & mobile!
    - language: **Dart** &nbsp;&nbsp; stars: **38,157** &nbsp;&nbsp; folks: **1,557**  &nbsp;&nbsp; `1,623 stars this week`
...
1. [refly-ai / refly](https://github.com/refly-ai/refly)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,524** &nbsp;&nbsp; folks: **198**  &nbsp;&nbsp; `488 stars this week`
...
1. [LadybirdBrowser / ladybird](https://github.com/LadybirdBrowser/ladybird)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **35,721** &nbsp;&nbsp; folks: **1,495**  &nbsp;&nbsp; `7,827 stars this month`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **82,217** &nbsp;&nbsp; folks: **12,081**  &nbsp;&nbsp; `15,381 stars this month`
...
1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    ...
    - language: **Markdown** &nbsp;&nbsp; stars: **357,260** &nbsp;&nbsp; folks: **33,126**  &nbsp;&nbsp; `24,252 stars this month`

1. [sinaptik-ai / pandas-ai](https://github.com/sinaptik-ai/pandas-ai)
    - Chat with your database or your datalake (SQL, CSV, parquet). PandasAI makes data analysis conversational using LLMs and RAG.
    - language: **Python** &nbsp;&nbsp; stars: **17,981** &nbsp;&nbsp; folks: **1,681**  &nbsp;&nbsp; `3,554 stars this month`

1. [78 / xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)
    - Build your own AI friend
    - language: **C++** &nbsp;&nbsp; stars: **8,852** &nbsp;&nbsp; folks: **1,570**  &nbsp;&nbsp; `3,965 stars this month`
...
1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **44,716** &nbsp;&nbsp; folks: **4,026**  &nbsp;&nbsp; `9,001 stars this month`
...
1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **67,386** &nbsp;&nbsp; folks: **16,904**  &nbsp;&nbsp; `6,916 stars this month`
...
1. [NirDiamant / GenAI_Agents](https://github.com/NirDiamant/GenAI_Agents)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **8,972** &nbsp;&nbsp; folks: **1,161**  &nbsp;&nbsp; `3,003 stars this month`

1. [mendableai / firecrawl](https://github.com/mendableai/firecrawl)
    - 🔥 Turn entire websites into LLM-ready markdown or structured data. Scrape, crawl and extract with a single API.
    - language: **TypeScript** &nbsp;&nbsp; stars: **31,130** &nbsp;&nbsp; folks: **2,644**  &nbsp;&nbsp; `5,427 stars this month`
...
1. [hiyouga / LLaMA-Factory](https://github.com/hiyouga/LLaMA-Factory)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **44,184** &nbsp;&nbsp; folks: **5,405**  &nbsp;&nbsp; `3,822 stars this month`
