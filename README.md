...
`更新时间：2025-09-03 17:25:03 +0800`

## 今日热门仓库

1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **43,669** &nbsp;&nbsp; folks: **3,165**  &nbsp;&nbsp; `1,979 stars today`

1. [crewAIInc / crewAI](https://github.com/crewAIInc/crewAI)
    - Framework for orchestrating role-playing, autonomous AI agents. By fostering collaborative intelligence, CrewAI empowers agents to work together seamlessly, tackling complex tasks.
    - language: **Python** &nbsp;&nbsp; stars: **37,320** &nbsp;&nbsp; folks: **4,936**  &nbsp;&nbsp; `189 stars today`
...
1. [JetBrains / koog](https://github.com/JetBrains/koog)
    ...
    - language: **Kotlin** &nbsp;&nbsp; stars: **2,730** &nbsp;&nbsp; folks: **179**  &nbsp;&nbsp; `584 stars today`
...
1. [ashishpatel26 / 500-AI-Agents-Projects](https://github.com/ashishpatel26/500-AI-Agents-Projects)
    ...
    - language: **无** &nbsp;&nbsp; stars: **8,892** &nbsp;&nbsp; folks: **1,600**  &nbsp;&nbsp; `1,066 stars today`
...
1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **18,435** &nbsp;&nbsp; folks: **2,959**  &nbsp;&nbsp; `7,663 stars this week`
...
1. [QuentinFuxa / WhisperLiveKit](https://github.com/QuentinFuxa/WhisperLiveKit)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,063** &nbsp;&nbsp; folks: **515**  &nbsp;&nbsp; `4,965 stars this week`

1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **43,669** &nbsp;&nbsp; folks: **3,165**  &nbsp;&nbsp; `5,312 stars this week`

1. [plait-board / drawnix](https://github.com/plait-board/drawnix)
    - 开源白板工具（SaaS），一体化白板，包含思维导图、流程图、自由画等。All in one open-source whiteboard tool with mind, flowchart, freehand and etc.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,574** &nbsp;&nbsp; folks: **782**  &nbsp;&nbsp; `1,648 stars this week`
...
1. [OpenBMB / MiniCPM-V](https://github.com/OpenBMB/MiniCPM-V)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **21,128** &nbsp;&nbsp; folks: **1,554**  &nbsp;&nbsp; `939 stars this week`
...
1. [Canner / WrenAI](https://github.com/Canner/WrenAI)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,415** &nbsp;&nbsp; folks: **1,145**  &nbsp;&nbsp; `1,369 stars this week`

1. [juspay / hyperswitch](https://github.com/juspay/hyperswitch)
    - An open source payments switch written in Rust to make payments fast, reliable and affordable
    - language: **Rust** &nbsp;&nbsp; stars: **26,455** &nbsp;&nbsp; folks: **3,994**  &nbsp;&nbsp; `1,949 stars this week`
...
1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    - Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,878** &nbsp;&nbsp; folks: **335**  &nbsp;&nbsp; `850 stars this week`
...
1. [microsoft / qlib](https://github.com/microsoft/qlib)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **29,797** &nbsp;&nbsp; folks: **4,605**  &nbsp;&nbsp; `815 stars this week`

1. [HKUDS / DeepCode](https://github.com/HKUDS/DeepCode)
    - "DeepCode: Open Agentic Coding (Paper2Code & Text2Web & Text2Backend)"
    - language: **Python** &nbsp;&nbsp; stars: **5,208** &nbsp;&nbsp; folks: **622**  &nbsp;&nbsp; `1,154 stars this week`
...
1. [twbs / bootstrap](https://github.com/twbs/bootstrap)
    ...
    - language: **MDX** &nbsp;&nbsp; stars: **173,340** &nbsp;&nbsp; folks: **79,153**  &nbsp;&nbsp; `483 stars this week`
...
1. [gunnarmorling / 1brc](https://github.com/gunnarmorling/1brc)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **7,301** &nbsp;&nbsp; folks: **2,073**  &nbsp;&nbsp; `164 stars this week`

1. [microsoft / terminal](https://github.com/microsoft/terminal)
    - The new Windows Terminal and the original Windows console host, all in the same place!
    - language: **C++** &nbsp;&nbsp; stars: **99,868** &nbsp;&nbsp; folks: **8,729**  &nbsp;&nbsp; `573 stars this week`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,460** &nbsp;&nbsp; folks: **1,988**  &nbsp;&nbsp; `6,244 stars this month`

1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **12,461** &nbsp;&nbsp; folks: **1,019**  &nbsp;&nbsp; `10,639 stars this month`

1. [plait-board / drawnix](https://github.com/plait-board/drawnix)
    - 开源白板工具（SaaS），一体化白板，包含思维导图、流程图、自由画等。All in one open-source whiteboard tool with mind, flowchart, freehand and etc.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,574** &nbsp;&nbsp; folks: **782**  &nbsp;&nbsp; `7,354 stars this month`

1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    - Collection of extracted System Prompts from popular chatbots like ChatGPT, Claude & Gemini
    - language: **JavaScript** &nbsp;&nbsp; stars: **18,435** &nbsp;&nbsp; folks: **2,959**  &nbsp;&nbsp; `10,192 stars this month`

1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Open-source platform to build and deploy AI agent workflows.
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,794** &nbsp;&nbsp; folks: **1,618**  &nbsp;&nbsp; `7,507 stars this month`
...
1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **14,931** &nbsp;&nbsp; folks: **1,617**  &nbsp;&nbsp; `4,934 stars this month`

1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **38,196** &nbsp;&nbsp; folks: **4,424**  &nbsp;&nbsp; `6,525 stars this month`
...
1. [charmbracelet / crush](https://github.com/charmbracelet/crush)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **11,739** &nbsp;&nbsp; folks: **576**  &nbsp;&nbsp; `6,342 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **57,068** &nbsp;&nbsp; folks: **9,869**  &nbsp;&nbsp; `3,294 stars this month`
...
1. [Canner / WrenAI](https://github.com/Canner/WrenAI)
    - ⚡️ GenBI (Generative BI) queries any database in natural language, generates accurate SQL (Text-to-SQL), charts (Text-to-Chart), and AI-powered insights in seconds.
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,415** &nbsp;&nbsp; folks: **1,145**  &nbsp;&nbsp; `1,925 stars this month`
...
1. [oraios / serena](https://github.com/oraios/serena)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,994** &nbsp;&nbsp; folks: **771**  &nbsp;&nbsp; `4,297 stars this month`
