...
1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    ...
    - language: **Markdown** &nbsp;&nbsp; stars: **336,387** &nbsp;&nbsp; folks: **31,124**  &nbsp;&nbsp; `1,018 stars today`

1. [hummingbot / hummingbot](https://github.com/hummingbot/hummingbot)
    - Open source software that helps you create and deploy high-frequency crypto trading bots
    - language: **Python** &nbsp;&nbsp; stars: **10,516** &nbsp;&nbsp; folks: **3,158**  &nbsp;&nbsp; `121 stars today`
...
1. [GitHubDaily / GitHubDaily](https://github.com/GitHubDaily/GitHubDaily)
    ...
    - language: **无** &nbsp;&nbsp; stars: **35,309** &nbsp;&nbsp; folks: **3,760**  &nbsp;&nbsp; `383 stars today`
...
1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    - A simple screen parsing tool towards pure vision based GUI agent
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **11,059** &nbsp;&nbsp; folks: **841**  &nbsp;&nbsp; `3,801 stars this week`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **68,688** &nbsp;&nbsp; folks: **10,013**  &nbsp;&nbsp; `3,481 stars this week`

1. [unslothai / unsloth](https://github.com/unslothai/unsloth)
    - Finetune Llama 3.3, DeepSeek-R1 & Reasoning LLMs 2x faster with 70% less memory! 🦥
    - language: **Python** &nbsp;&nbsp; stars: **30,217** &nbsp;&nbsp; folks: **1,996**  &nbsp;&nbsp; `4,194 stars this week`
...
1. [datawhalechina / llm-cookbook](https://github.com/datawhalechina/llm-cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,067** &nbsp;&nbsp; folks: **1,885**  &nbsp;&nbsp; `1,361 stars this week`

1. [FujiwaraChoki / MoneyPrinterV2](https://github.com/FujiwaraChoki/MoneyPrinterV2)
    - Automate the process of making money online.
    - language: **Python** &nbsp;&nbsp; stars: **9,387** &nbsp;&nbsp; folks: **926**  &nbsp;&nbsp; `2,283 stars this week`

1. [vercel / ai-chatbot](https://github.com/vercel/ai-chatbot)
    - A full-featured, hackable Next.js AI chatbot built by Vercel
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,972** &nbsp;&nbsp; folks: **3,303**  &nbsp;&nbsp; `1,372 stars this week`

1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding.
    - language: **Python** &nbsp;&nbsp; stars: **37,153** &nbsp;&nbsp; folks: **3,303**  &nbsp;&nbsp; `2,927 stars this week`
...
1. [n4ze3m / page-assist](https://github.com/n4ze3m/page-assist)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,920** &nbsp;&nbsp; folks: **404**  &nbsp;&nbsp; `1,008 stars this week`
...
1. [labring / FastGPT](https://github.com/labring/FastGPT)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,271** &nbsp;&nbsp; folks: **5,474**  &nbsp;&nbsp; `923 stars this week`
...
1. [hummingbot / hummingbot](https://github.com/hummingbot/hummingbot)
    - Open source software that helps you create and deploy high-frequency crypto trading bots
    - language: **Python** &nbsp;&nbsp; stars: **10,516** &nbsp;&nbsp; folks: **3,158**  &nbsp;&nbsp; `549 stars this week`

1. [Bin-Huang / chatbox](https://github.com/Bin-Huang/chatbox)
    - User-friendly Desktop Client App for AI Models/LLMs (GPT, Claude, Gemini, Ollama...)
    - language: **TypeScript** &nbsp;&nbsp; stars: **31,091** &nbsp;&nbsp; folks: **2,949**  &nbsp;&nbsp; `1,586 stars this week`

1. [Mintplex-Labs / anything-llm](https://github.com/Mintplex-Labs/anything-llm)
    - The all-in-one Desktop & Docker AI application with built-in RAG, AI agents, and more.
    - language: **JavaScript** &nbsp;&nbsp; stars: **37,567** &nbsp;&nbsp; folks: **3,610**  &nbsp;&nbsp; `1,857 stars this week`
...
1. [deepseek-ai / DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,787** &nbsp;&nbsp; folks: **2,203**  &nbsp;&nbsp; `9,588 stars this month`

1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **127,182** &nbsp;&nbsp; folks: **10,347**  &nbsp;&nbsp; `19,241 stars this month`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **75,764** &nbsp;&nbsp; folks: **8,956**  &nbsp;&nbsp; `18,842 stars this month`

1. [unslothai / unsloth](https://github.com/unslothai/unsloth)
    - Finetune Llama 3.3, DeepSeek-R1 & Reasoning LLMs 2x faster with 70% less memory! 🦥
    - language: **Python** &nbsp;&nbsp; stars: **30,217** &nbsp;&nbsp; folks: **1,996**  &nbsp;&nbsp; `9,353 stars this month`

1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    - Make websites accessible for AI agents
    - language: **Python** &nbsp;&nbsp; stars: **29,395** &nbsp;&nbsp; folks: **2,987**  &nbsp;&nbsp; `14,477 stars this month`

1. [Mintplex-Labs / anything-llm](https://github.com/Mintplex-Labs/anything-llm)
    - The all-in-one Desktop & Docker AI application with built-in RAG, AI agents, and more.
    - language: **JavaScript** &nbsp;&nbsp; stars: **37,567** &nbsp;&nbsp; folks: **3,610**  &nbsp;&nbsp; `7,001 stars this month`

1. [Bin-Huang / chatbox](https://github.com/Bin-Huang/chatbox)
    - User-friendly Desktop Client App for AI Models/LLMs (GPT, Claude, Gemini, Ollama...)
    - language: **TypeScript** &nbsp;&nbsp; stars: **31,091** &nbsp;&nbsp; folks: **2,949**  &nbsp;&nbsp; `6,273 stars this month`

1. [ggml-org / llama.cpp](https://github.com/ggml-org/llama.cpp)
    - LLM inference in C/C++
    - language: **C++** &nbsp;&nbsp; stars: **74,584** &nbsp;&nbsp; folks: **10,778**  &nbsp;&nbsp; `4,020 stars this month`
...
1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **68,688** &nbsp;&nbsp; folks: **10,013**  &nbsp;&nbsp; `9,564 stars this month`
...
1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding.
    - language: **Python** &nbsp;&nbsp; stars: **37,153** &nbsp;&nbsp; folks: **3,303**  &nbsp;&nbsp; `8,415 stars this month`

1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    - A simple screen parsing tool towards pure vision based GUI agent
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **11,059** &nbsp;&nbsp; folks: **841**  &nbsp;&nbsp; `4,050 stars this month`
...
1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **38,254** &nbsp;&nbsp; folks: **5,744**  &nbsp;&nbsp; `4,338 stars this month`
...
1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,689** &nbsp;&nbsp; folks: **1,027**  &nbsp;&nbsp; `4,441 stars this month`
