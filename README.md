...
`更新时间：2025-04-19 18:23:05 +0800`

## 今日热门仓库

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **77,233** &nbsp;&nbsp; folks: **9,362**  &nbsp;&nbsp; `1,328 stars today`

1. [jlowin / fastmcp](https://github.com/jlowin/fastmcp)
    - 🚀 The fast, Pythonic way to build MCP servers and clients
    - language: **Python** &nbsp;&nbsp; stars: **5,892** &nbsp;&nbsp; folks: **301**  &nbsp;&nbsp; `234 stars today`

1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    - An AI Hedge Fund Team
    - language: **Python** &nbsp;&nbsp; stars: **25,855** &nbsp;&nbsp; folks: **4,417**  &nbsp;&nbsp; `785 stars today`

1. [microsoft / BitNet](https://github.com/microsoft/BitNet)
    - Official inference framework for 1-bit LLMs
    - language: **C++** &nbsp;&nbsp; stars: **13,935** &nbsp;&nbsp; folks: **966**  &nbsp;&nbsp; `402 stars today`

1. [linera-io / linera-protocol](https://github.com/linera-io/linera-protocol)
    - Main repository for the Linera protocol
    - language: **Rust** &nbsp;&nbsp; stars: **23,428** &nbsp;&nbsp; folks: **1,430**  &nbsp;&nbsp; `1,605 stars today`
...
1. [NirDiamant / RAG_Techniques](https://github.com/NirDiamant/RAG_Techniques)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,245** &nbsp;&nbsp; folks: **1,520**  &nbsp;&nbsp; `342 stars today`

1. [browserbase / stagehand](https://github.com/browserbase/stagehand)
    - An AI web browsing framework focused on simplicity and extensibility.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,542** &nbsp;&nbsp; folks: **577**  &nbsp;&nbsp; `311 stars today`

1. [opf / openproject](https://github.com/opf/openproject)
    - OpenProject is the leading open source project management software.
    - language: **Ruby** &nbsp;&nbsp; stars: **10,815** &nbsp;&nbsp; folks: **2,560**  &nbsp;&nbsp; `40 stars today`

1. [1Panel-dev / 1Panel](https://github.com/1Panel-dev/1Panel)
    - 🔥 1Panel provides an intuitive web interface and MCP Server to manage websites, files, containers, databases, and LLMs on a Linux server.
    - language: **Go** &nbsp;&nbsp; stars: **27,307** &nbsp;&nbsp; folks: **2,391**  &nbsp;&nbsp; `368 stars today`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,252** &nbsp;&nbsp; folks: **2,353**  &nbsp;&nbsp; `9,428 stars this week`
...
1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    - An AI Hedge Fund Team
    - language: **Python** &nbsp;&nbsp; stars: **25,855** &nbsp;&nbsp; folks: **4,417**  &nbsp;&nbsp; `4,832 stars this week`

1. [krillinai / KrillinAI](https://github.com/krillinai/KrillinAI)
    - A video translation and dubbing tool powered by LLMs, offering professional-grade translations and one-click full-process deployment. It can generate content optimized for platforms like YouTube，TikTok, and Shorts. 基于AI大模型的视频翻译和配音工具，专业级翻译，一键部署全流程，可以生成适配抖音，小红书，哔哩哔哩，视频号，TikTok，Youtube Shorts等形态的内容
    - language: **Go** &nbsp;&nbsp; stars: **5,060** &nbsp;&nbsp; folks: **370**  &nbsp;&nbsp; `2,879 stars this week`
...
1. [Zackriya-Solutions / meeting-minutes](https://github.com/Zackriya-Solutions/meeting-minutes)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,712** &nbsp;&nbsp; folks: **253**  &nbsp;&nbsp; `2,016 stars this week`
...
1. [jlowin / fastmcp](https://github.com/jlowin/fastmcp)
    - 🚀 The fast, Pythonic way to build MCP servers and clients
    - language: **Python** &nbsp;&nbsp; stars: **5,892** &nbsp;&nbsp; folks: **301**  &nbsp;&nbsp; `1,205 stars this week`
...
1. [NirDiamant / RAG_Techniques](https://github.com/NirDiamant/RAG_Techniques)
    - This repository showcases various advanced techniques for Retrieval-Augmented Generation (RAG) systems. RAG systems combine information retrieval with generative models to provide accurate and contextually rich responses.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,245** &nbsp;&nbsp; folks: **1,520**  &nbsp;&nbsp; `1,069 stars this week`
...
1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **77,233** &nbsp;&nbsp; folks: **9,362**  &nbsp;&nbsp; `5,109 stars this week`

1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    - A high-performance algorithmic trading platform and event-driven backtester
    - language: **Python** &nbsp;&nbsp; stars: **5,633** &nbsp;&nbsp; folks: **802**  &nbsp;&nbsp; `595 stars this week`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    - [Support 0.48.x]（Reset Cursor AI MachineID & Bypass Higher Token Limit） Cursor Ai ，自动重置机器ID ， 免费升级使用Pro功能: You've reached your trial request limit. / Too many free trial accounts used on this machine. Please upgrade to pro. We have this limit in place to prevent abuse. Please let us know if you believe this is a mistake.
    - language: **Python** &nbsp;&nbsp; stars: **19,252** &nbsp;&nbsp; folks: **2,353**  &nbsp;&nbsp; `15,872 stars this month`

1. [punkpeye / awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)
    - A collection of MCP servers.
    - language: **无** &nbsp;&nbsp; stars: **39,911** &nbsp;&nbsp; folks: **2,848**  &nbsp;&nbsp; `28,346 stars this month`
...
1. [th-ch / youtube-music](https://github.com/th-ch/youtube-music)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,476** &nbsp;&nbsp; folks: **955**  &nbsp;&nbsp; `7,225 stars this month`
...
1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **83,035** &nbsp;&nbsp; folks: **22,256**  &nbsp;&nbsp; `14,840 stars this month`

1. [ourongxing / newsnow](https://github.com/ourongxing/newsnow)
    - Elegant reading of real-time and hottest news
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,943** &nbsp;&nbsp; folks: **2,484**  &nbsp;&nbsp; `4,226 stars this month`
