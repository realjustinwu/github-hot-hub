...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,929** &nbsp;&nbsp; folks: **1,248**  &nbsp;&nbsp; `566 stars this week`

1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **35,088** &nbsp;&nbsp; folks: **4,017**  &nbsp;&nbsp; `2,482 stars this week`
...
1. [menloresearch / jan](https://github.com/menloresearch/jan)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **37,006** &nbsp;&nbsp; folks: **2,162**  &nbsp;&nbsp; `1,606 stars this week`

1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    - A high-performance algorithmic trading platform and event-driven backtester
    - language: **Rust** &nbsp;&nbsp; stars: **14,014** &nbsp;&nbsp; folks: **1,503**  &nbsp;&nbsp; `1,049 stars this week`
...
1. [umami-software / umami](https://github.com/umami-software/umami)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,947** &nbsp;&nbsp; folks: **5,382**  &nbsp;&nbsp; `2,281 stars this week`
...
1. [idosal / git-mcp](https://github.com/idosal/git-mcp)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,232** &nbsp;&nbsp; folks: **389**  &nbsp;&nbsp; `1,205 stars this week`

1. [FiloSottile / mkcert](https://github.com/FiloSottile/mkcert)
    - A simple zero-config tool to make locally trusted development certificates with any names you'd like.
    - language: **Go** &nbsp;&nbsp; stars: **55,998** &nbsp;&nbsp; folks: **2,927**  &nbsp;&nbsp; `910 stars this week`

1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    - Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!
    - language: **Python** &nbsp;&nbsp; stars: **8,742** &nbsp;&nbsp; folks: **683**  &nbsp;&nbsp; `1,767 stars this week`

1. [syncthing / syncthing](https://github.com/syncthing/syncthing)
    - Open Source Continuous File Synchronization
    - language: **Go** &nbsp;&nbsp; stars: **74,944** &nbsp;&nbsp; folks: **4,694**  &nbsp;&nbsp; `757 stars this week`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,454** &nbsp;&nbsp; folks: **1,455**  &nbsp;&nbsp; `920 stars this week`

1. [filamentphp / filament](https://github.com/filamentphp/filament)
    - A powerful open source UI framework for Laravel • Build and ship admin panels & apps fast with Livewire
    - language: **PHP** &nbsp;&nbsp; stars: **25,712** &nbsp;&nbsp; folks: **3,668**  &nbsp;&nbsp; `384 stars this week`

1. [patchy631 / ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)
    - In-depth tutorials on LLMs, RAGs and real-world AI agent applications.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **17,335** &nbsp;&nbsp; folks: **2,886**  &nbsp;&nbsp; `1,542 stars this week`

1. [lfnovo / open-notebook](https://github.com/lfnovo/open-notebook)
    - An Open Source implementation of Notebook LM with more flexibility and features
    - language: **Python** &nbsp;&nbsp; stars: **3,475** &nbsp;&nbsp; folks: **354**  &nbsp;&nbsp; `865 stars this week`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **22,162** &nbsp;&nbsp; folks: **4,311**  &nbsp;&nbsp; `13,110 stars this month`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,999** &nbsp;&nbsp; folks: **1,233**  &nbsp;&nbsp; `11,064 stars this month`
...
1. [roboflow / supervision](https://github.com/roboflow/supervision)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,874** &nbsp;&nbsp; folks: **2,734**  &nbsp;&nbsp; `7,060 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,261** &nbsp;&nbsp; folks: **990**  &nbsp;&nbsp; `8,887 stars this month`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **7,810** &nbsp;&nbsp; folks: **1,032**  &nbsp;&nbsp; `3,432 stars this month`

1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    - A high-performance algorithmic trading platform and event-driven backtester
    - language: **Rust** &nbsp;&nbsp; stars: **14,014** &nbsp;&nbsp; folks: **1,503**  &nbsp;&nbsp; `4,340 stars this month`
...
1. [OpenPipe / ART](https://github.com/OpenPipe/ART)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,713** &nbsp;&nbsp; folks: **355**  &nbsp;&nbsp; `3,651 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,359** &nbsp;&nbsp; folks: **9,405**  &nbsp;&nbsp; `3,143 stars this month`
