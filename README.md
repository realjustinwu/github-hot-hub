...
1. [enescingoz / awesome-n8n-templates](https://github.com/enescingoz/awesome-n8n-templates)
    ...
    - language: **无** &nbsp;&nbsp; stars: **9,238** &nbsp;&nbsp; folks: **2,703**  &nbsp;&nbsp; `130 stars today`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **4,517** &nbsp;&nbsp; folks: **180**  &nbsp;&nbsp; `500 stars today`

1. [immich-app / immich](https://github.com/immich-app/immich)
    - High performance self-hosted photo and video management solution.
    - language: **TypeScript** &nbsp;&nbsp; stars: **73,314** &nbsp;&nbsp; folks: **3,867**  &nbsp;&nbsp; `114 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **59,630** &nbsp;&nbsp; folks: **7,151**  &nbsp;&nbsp; `804 stars today`
...
1. [mfts / papermark](https://github.com/mfts/papermark)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,215** &nbsp;&nbsp; folks: **989**  &nbsp;&nbsp; `77 stars today`
...
1. [ubicloud / ubicloud](https://github.com/ubicloud/ubicloud)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **9,785** &nbsp;&nbsp; folks: **425**  &nbsp;&nbsp; `3,807 stars this week`

1. [apple / embedding-atlas](https://github.com/apple/embedding-atlas)
    - Embedding Atlas is a tool that provides interactive visualizations for large embeddings. It allows you to visualize, cross-filter, and search embeddings and metadata.
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,735** &nbsp;&nbsp; folks: **119**  &nbsp;&nbsp; `1,845 stars this week`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,463** &nbsp;&nbsp; folks: **1,587**  &nbsp;&nbsp; `1,821 stars this week`

1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **2,726** &nbsp;&nbsp; folks: **272**  &nbsp;&nbsp; `1,136 stars this week`

1. [denizsafak / abogen](https://github.com/denizsafak/abogen)
    - Generate audiobooks from EPUBs, PDFs and text with synchronized captions.
    - language: **Python** &nbsp;&nbsp; stars: **2,808** &nbsp;&nbsp; folks: **142**  &nbsp;&nbsp; `840 stars this week`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **22,518** &nbsp;&nbsp; folks: **4,338**  &nbsp;&nbsp; `13,434 stars this month`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,325** &nbsp;&nbsp; folks: **1,281**  &nbsp;&nbsp; `11,338 stars this month`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Financial data aggregator for humans and AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **50,240** &nbsp;&nbsp; folks: **4,687**  &nbsp;&nbsp; `7,132 stars this month`

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **9,031** &nbsp;&nbsp; folks: **1,603**  &nbsp;&nbsp; `3,278 stars this month`

1. [roboflow / supervision](https://github.com/roboflow/supervision)
    - We write your reusable computer vision tools. 💜
    - language: **Python** &nbsp;&nbsp; stars: **34,046** &nbsp;&nbsp; folks: **2,743**  &nbsp;&nbsp; `6,956 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,829** &nbsp;&nbsp; folks: **1,024**  &nbsp;&nbsp; `8,154 stars this month`

1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    - A high-performance algorithmic trading platform and event-driven backtester
    - language: **Rust** &nbsp;&nbsp; stars: **14,177** &nbsp;&nbsp; folks: **1,521**  &nbsp;&nbsp; `4,459 stars this month`

1. [frappe / hrms](https://github.com/frappe/hrms)
    - Open Source HR and Payroll Software
    - language: **Python** &nbsp;&nbsp; stars: **6,347** &nbsp;&nbsp; folks: **1,558**  &nbsp;&nbsp; `3,585 stars this month`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **8,022** &nbsp;&nbsp; folks: **1,063**  &nbsp;&nbsp; `3,115 stars this month`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **11,360** &nbsp;&nbsp; folks: **615**  &nbsp;&nbsp; `7,087 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,624** &nbsp;&nbsp; folks: **9,468**  &nbsp;&nbsp; `3,097 stars this month`
