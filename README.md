...
`更新时间：2025-08-16 19:19:08 +0800`

## 今日热门仓库

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **6,003** &nbsp;&nbsp; folks: **1,258**  &nbsp;&nbsp; `318 stars today`

1. [microsoft / poml](https://github.com/microsoft/poml)
    - Prompt Orchestration Markup Language
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,635** &nbsp;&nbsp; folks: **110**  &nbsp;&nbsp; `511 stars today`
...
1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    ...
    - language: **Markdown** &nbsp;&nbsp; stars: **410,711** &nbsp;&nbsp; folks: **38,521**  &nbsp;&nbsp; `484 stars today`
...
1. [farhanashrafdev / 90DaysOfCyberSecurity](https://github.com/farhanashrafdev/90DaysOfCyberSecurity)
    ...
    - language: **无** &nbsp;&nbsp; stars: **10,680** &nbsp;&nbsp; folks: **1,217**  &nbsp;&nbsp; `295 stars today`

1. [jaywcjlove / awesome-mac](https://github.com/jaywcjlove/awesome-mac)
    -  Now we have become very big, Different from the original idea. Collect premium software in various categories.
    - language: **JavaScript** &nbsp;&nbsp; stars: **86,759** &nbsp;&nbsp; folks: **6,681**  &nbsp;&nbsp; `576 stars today`
...
1. [IBM / mcp-context-forge](https://github.com/IBM/mcp-context-forge)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,104** &nbsp;&nbsp; folks: **184**  &nbsp;&nbsp; `46 stars today`

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **3,874** &nbsp;&nbsp; folks: **388**  &nbsp;&nbsp; `409 stars today`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **3,311** &nbsp;&nbsp; folks: **140**  &nbsp;&nbsp; `214 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **58,056** &nbsp;&nbsp; folks: **6,939**  &nbsp;&nbsp; `445 stars today`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **6,003** &nbsp;&nbsp; folks: **1,258**  &nbsp;&nbsp; `566 stars this week`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **35,129** &nbsp;&nbsp; folks: **4,023**  &nbsp;&nbsp; `2,482 stars this week`
...
1. [external-secrets / external-secrets](https://github.com/external-secrets/external-secrets)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **5,529** &nbsp;&nbsp; folks: **1,042**  &nbsp;&nbsp; `245 stars this week`
...
1. [umami-software / umami](https://github.com/umami-software/umami)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,985** &nbsp;&nbsp; folks: **5,386**  &nbsp;&nbsp; `2,281 stars this week`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,584** &nbsp;&nbsp; folks: **1,467**  &nbsp;&nbsp; `920 stars this week`
...
1. [librespot-org / librespot](https://github.com/librespot-org/librespot)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **5,427** &nbsp;&nbsp; folks: **716**  &nbsp;&nbsp; `30 stars this week`
...
1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,031** &nbsp;&nbsp; folks: **1,242**  &nbsp;&nbsp; `11,064 stars this month`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Financial data aggregator for humans and AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **49,352** &nbsp;&nbsp; folks: **4,604**  &nbsp;&nbsp; `6,882 stars this month`
...
1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **14,032** &nbsp;&nbsp; folks: **1,506**  &nbsp;&nbsp; `4,340 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,800** &nbsp;&nbsp; folks: **589**  &nbsp;&nbsp; `6,775 stars this month`

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **6,003** &nbsp;&nbsp; folks: **1,258**  &nbsp;&nbsp; `695 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,388** &nbsp;&nbsp; folks: **9,414**  &nbsp;&nbsp; `3,143 stars this month`

1. [OpenPipe / ART](https://github.com/OpenPipe/ART)
    - Agent Reinforcement Trainer: train multi-step agents for real-world tasks using GRPO. Give your agents on-the-job training. Reinforcement learning for Qwen2.5, Qwen3, Llama, and more!
    - language: **Python** &nbsp;&nbsp; stars: **5,726** &nbsp;&nbsp; folks: **355**  &nbsp;&nbsp; `3,651 stars this month`
