...
1. [redis / go-redis](https://github.com/redis/go-redis)
    - Redis Go client
    - language: **Go** &nbsp;&nbsp; stars: **21,300** &nbsp;&nbsp; folks: **2,480**  &nbsp;&nbsp; `15 stars today`

1. [colmap / colmap](https://github.com/colmap/colmap)
    - COLMAP - Structure-from-Motion and Multi-View Stereo
    - language: **C++** &nbsp;&nbsp; stars: **9,250** &nbsp;&nbsp; folks: **1,726**  &nbsp;&nbsp; `39 stars today`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,284** &nbsp;&nbsp; folks: **1,447**  &nbsp;&nbsp; `334 stars today`

1. [midday-ai / midday](https://github.com/midday-ai/midday)
    - Invoicing, Time tracking, File reconciliation, Storage, Financial Overview & your own Assistant made for Freelancers
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,493** &nbsp;&nbsp; folks: **955**  &nbsp;&nbsp; `104 stars today`
...
1. [oop7 / YTSage](https://github.com/oop7/YTSage)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,459** &nbsp;&nbsp; folks: **95**  &nbsp;&nbsp; `251 stars today`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **34,941** &nbsp;&nbsp; folks: **3,992**  &nbsp;&nbsp; `2,920 stars this week`

1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    - A high-performance algorithmic trading platform and event-driven backtester
    - language: **Rust** &nbsp;&nbsp; stars: **13,920** &nbsp;&nbsp; folks: **1,499**  &nbsp;&nbsp; `3,228 stars this week`

1. [menloresearch / jan](https://github.com/menloresearch/jan)
    - Jan is an open source alternative to ChatGPT that runs 100% offline on your computer
    - language: **TypeScript** &nbsp;&nbsp; stars: **36,904** &nbsp;&nbsp; folks: **2,156**  &nbsp;&nbsp; `1,273 stars this week`
...
1. [umami-software / umami](https://github.com/umami-software/umami)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,854** &nbsp;&nbsp; folks: **5,374**  &nbsp;&nbsp; `2,139 stars this week`
...
1. [lvgl / lvgl](https://github.com/lvgl/lvgl)
    ...
    - language: **C** &nbsp;&nbsp; stars: **21,039** &nbsp;&nbsp; folks: **3,784**  &nbsp;&nbsp; `559 stars this week`

1. [patchy631 / ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)
    - In-depth tutorials on LLMs, RAGs and real-world AI agent applications.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **17,230** &nbsp;&nbsp; folks: **2,878**  &nbsp;&nbsp; `1,440 stars this week`

1. [filamentphp / filament](https://github.com/filamentphp/filament)
    - A powerful open source UI framework for Laravel • Build and ship admin panels & apps fast with Livewire
    - language: **PHP** &nbsp;&nbsp; stars: **25,649** &nbsp;&nbsp; folks: **3,661**  &nbsp;&nbsp; `256 stars this week`

1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    - The Open-sourced Multimodal AI Agent Stack connecting Cutting-edge AI Models and Agent Infra.
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,284** &nbsp;&nbsp; folks: **1,447**  &nbsp;&nbsp; `466 stars this week`
...
1. [exo-explore / exo](https://github.com/exo-explore/exo)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **29,965** &nbsp;&nbsp; folks: **1,923**  &nbsp;&nbsp; `721 stars this week`
...
1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,020** &nbsp;&nbsp; folks: **967**  &nbsp;&nbsp; `9,223 stars this month`
...
1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **7,643** &nbsp;&nbsp; folks: **1,009**  &nbsp;&nbsp; `3,239 stars this month`

1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    - A high-performance algorithmic trading platform and event-driven backtester
    - language: **Rust** &nbsp;&nbsp; stars: **13,920** &nbsp;&nbsp; folks: **1,499**  &nbsp;&nbsp; `4,191 stars this month`

1. [frappe / hrms](https://github.com/frappe/hrms)
    - Open Source HR and Payroll Software
    - language: **Python** &nbsp;&nbsp; stars: **6,163** &nbsp;&nbsp; folks: **1,548**  &nbsp;&nbsp; `3,396 stars this month`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **71,370** &nbsp;&nbsp; folks: **3,885**  &nbsp;&nbsp; `11,173 stars this month`
...
1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **55,234** &nbsp;&nbsp; folks: **9,371**  &nbsp;&nbsp; `3,071 stars this month`

1. [sst / opencode](https://github.com/sst/opencode)
    - AI coding agent, built for the terminal.
    - language: **Go** &nbsp;&nbsp; stars: **19,503** &nbsp;&nbsp; folks: **1,246**  &nbsp;&nbsp; `7,492 stars this month`
