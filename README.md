...
1. [conductor-oss / conductor](https://github.com/conductor-oss/conductor)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **25,213** &nbsp;&nbsp; folks: **661**  &nbsp;&nbsp; `282 stars today`

1. [microsoft / poml](https://github.com/microsoft/poml)
    - Prompt Orchestration Markup Language
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,415** &nbsp;&nbsp; folks: **44**  &nbsp;&nbsp; `763 stars today`
...
1. [x1xhlol / system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools)
    ...
    - language: **无** &nbsp;&nbsp; stars: **75,790** &nbsp;&nbsp; folks: **21,287**  &nbsp;&nbsp; `573 stars today`
...
1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **13,804** &nbsp;&nbsp; folks: **1,495**  &nbsp;&nbsp; `3,454 stars this week`

1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **34,749** &nbsp;&nbsp; folks: **3,966**  &nbsp;&nbsp; `2,867 stars this week`

1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with OpenAI gpt-oss, DeepSeek-R1, Gemma 3 and other models.
    - language: **Go** &nbsp;&nbsp; stars: **150,087** &nbsp;&nbsp; folks: **12,804**  &nbsp;&nbsp; `1,371 stars this week`
...
1. [lvgl / lvgl](https://github.com/lvgl/lvgl)
    ...
    - language: **C** &nbsp;&nbsp; stars: **20,982** &nbsp;&nbsp; folks: **3,780**  &nbsp;&nbsp; `542 stars this week`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,599** &nbsp;&nbsp; folks: **1,185**  &nbsp;&nbsp; `4,187 stars this week`

1. [menloresearch / jan](https://github.com/menloresearch/jan)
    - Jan is an open source alternative to ChatGPT that runs 100% offline on your computer
    - language: **TypeScript** &nbsp;&nbsp; stars: **36,551** &nbsp;&nbsp; folks: **2,137**  &nbsp;&nbsp; `1,067 stars this week`

1. [patchy631 / ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)
    - In-depth tutorials on LLMs, RAGs and real-world AI agent applications.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **17,044** &nbsp;&nbsp; folks: **2,865**  &nbsp;&nbsp; `1,300 stars this week`
...
1. [umami-software / umami](https://github.com/umami-software/umami)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,737** &nbsp;&nbsp; folks: **5,368**  &nbsp;&nbsp; `1,856 stars this week`

1. [jesseduffield / lazygit](https://github.com/jesseduffield/lazygit)
    - simple terminal UI for git commands
    - language: **Go** &nbsp;&nbsp; stars: **63,508** &nbsp;&nbsp; folks: **2,184**  &nbsp;&nbsp; `853 stars this week`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,072** &nbsp;&nbsp; folks: **9,344**  &nbsp;&nbsp; `1,002 stars this week`
...
1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    - Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!
    - language: **Python** &nbsp;&nbsp; stars: **7,892** &nbsp;&nbsp; folks: **639**  &nbsp;&nbsp; `962 stars this week`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **106,480** &nbsp;&nbsp; folks: **14,368**  &nbsp;&nbsp; `1,200 stars this week`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **49,087** &nbsp;&nbsp; folks: **4,570**  &nbsp;&nbsp; `6,905 stars this month`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,599** &nbsp;&nbsp; folks: **1,185**  &nbsp;&nbsp; `10,590 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,630** &nbsp;&nbsp; folks: **937**  &nbsp;&nbsp; `9,034 stars this month`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **71,157** &nbsp;&nbsp; folks: **3,864**  &nbsp;&nbsp; `11,119 stars this month`
...
1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    - A high-performance algorithmic trading platform and event-driven backtester
    - language: **Rust** &nbsp;&nbsp; stars: **13,804** &nbsp;&nbsp; folks: **1,495**  &nbsp;&nbsp; `4,103 stars this month`
...
1. [frappe / hrms](https://github.com/frappe/hrms)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,101** &nbsp;&nbsp; folks: **1,540**  &nbsp;&nbsp; `3,361 stars this month`

1. [hyprwm / Hyprland](https://github.com/hyprwm/Hyprland)
    - Hyprland is an independent, highly customizable, dynamic tiling Wayland compositor that doesn't sacrifice on its looks.
    - language: **C++** &nbsp;&nbsp; stars: **29,355** &nbsp;&nbsp; folks: **1,258**  &nbsp;&nbsp; `2,578 stars this month`

1. [sst / opencode](https://github.com/sst/opencode)
    - AI coding agent, built for the terminal.
    - language: **Go** &nbsp;&nbsp; stars: **19,222** &nbsp;&nbsp; folks: **1,220**  &nbsp;&nbsp; `7,499 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,072** &nbsp;&nbsp; folks: **9,344**  &nbsp;&nbsp; `3,015 stars this month`
