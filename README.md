...
`更新时间：2025-08-17 20:50:31 +0800`

## 今日热门仓库

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **7,034** &nbsp;&nbsp; folks: **1,391**  &nbsp;&nbsp; `991 stars today`

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **4,358** &nbsp;&nbsp; folks: **430**  &nbsp;&nbsp; `461 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **58,523** &nbsp;&nbsp; folks: **7,000**  &nbsp;&nbsp; `442 stars today`

1. [tsoding / nob.h](https://github.com/tsoding/nob.h)
    - Header only library for writing build recipes in C.
    - language: **C** &nbsp;&nbsp; stars: **1,549** &nbsp;&nbsp; folks: **93**  &nbsp;&nbsp; `120 stars today`
...
1. [aliasrobotics / cai](https://github.com/aliasrobotics/cai)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,476** &nbsp;&nbsp; folks: **387**  &nbsp;&nbsp; `205 stars today`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **3,825** &nbsp;&nbsp; folks: **159**  &nbsp;&nbsp; `490 stars today`
...
1. [dtyq / magic](https://github.com/dtyq/magic)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **2,118** &nbsp;&nbsp; folks: **238**  &nbsp;&nbsp; `287 stars today`

1. [LMCache / LMCache](https://github.com/LMCache/LMCache)
    - Supercharge Your LLM with the Fastest KV Cache Layer
    - language: **Python** &nbsp;&nbsp; stars: **4,408** &nbsp;&nbsp; folks: **494**  &nbsp;&nbsp; `135 stars today`
...
1. [MotiaDev / motia](https://github.com/MotiaDev/motia)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,064** &nbsp;&nbsp; folks: **473**  &nbsp;&nbsp; `158 stars today`
...
1. [menloresearch / jan](https://github.com/menloresearch/jan)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **37,095** &nbsp;&nbsp; folks: **2,169**  &nbsp;&nbsp; `1,652 stars this week`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,128** &nbsp;&nbsp; folks: **1,537**  &nbsp;&nbsp; `1,136 stars this week`
...
1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic (超级麦吉). The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **2,118** &nbsp;&nbsp; folks: **238**  &nbsp;&nbsp; `539 stars this week`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **35,271** &nbsp;&nbsp; folks: **4,033**  &nbsp;&nbsp; `2,062 stars this week`
...
1. [conductor-oss / conductor](https://github.com/conductor-oss/conductor)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **26,063** &nbsp;&nbsp; folks: **674**  &nbsp;&nbsp; `1,269 stars this week`

1. [jitsi / jitsi-meet](https://github.com/jitsi/jitsi-meet)
    - Jitsi Meet - Secure, Simple and Scalable Video Conferences that you use as a standalone app or embed in your web application.
    - language: **TypeScript** &nbsp;&nbsp; stars: **26,707** &nbsp;&nbsp; folks: **7,371**  &nbsp;&nbsp; `509 stars this week`

1. [syncthing / syncthing](https://github.com/syncthing/syncthing)
    - Open Source Continuous File Synchronization
    - language: **Go** &nbsp;&nbsp; stars: **75,021** &nbsp;&nbsp; folks: **4,696**  &nbsp;&nbsp; `810 stars this week`
...
1. [umami-software / umami](https://github.com/umami-software/umami)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **30,088** &nbsp;&nbsp; folks: **5,391**  &nbsp;&nbsp; `2,248 stars this week`

1. [lfnovo / open-notebook](https://github.com/lfnovo/open-notebook)
    - An Open Source implementation of Notebook LM with more flexibility and features
    - language: **Python** &nbsp;&nbsp; stars: **3,539** &nbsp;&nbsp; folks: **361**  &nbsp;&nbsp; `738 stars this week`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **22,297** &nbsp;&nbsp; folks: **4,318**  &nbsp;&nbsp; `13,191 stars this month`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Financial data aggregator for humans and AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **49,599** &nbsp;&nbsp; folks: **4,631**  &nbsp;&nbsp; `6,652 stars this month`

1. [roboflow / supervision](https://github.com/roboflow/supervision)
    - We write your reusable computer vision tools. 💜
    - language: **Python** &nbsp;&nbsp; stars: **33,930** &nbsp;&nbsp; folks: **2,736**  &nbsp;&nbsp; `7,106 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,511** &nbsp;&nbsp; folks: **1,001**  &nbsp;&nbsp; `8,553 stars this month`

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **7,034** &nbsp;&nbsp; folks: **1,391**  &nbsp;&nbsp; `934 stars this month`

1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    - A high-performance algorithmic trading platform and event-driven backtester
    - language: **Rust** &nbsp;&nbsp; stars: **14,085** &nbsp;&nbsp; folks: **1,510**  &nbsp;&nbsp; `4,385 stars this month`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **7,912** &nbsp;&nbsp; folks: **1,046**  &nbsp;&nbsp; `3,502 stars this month`

1. [frappe / hrms](https://github.com/frappe/hrms)
    - Open Source HR and Payroll Software
    - language: **Python** &nbsp;&nbsp; stars: **6,263** &nbsp;&nbsp; folks: **1,555**  &nbsp;&nbsp; `3,502 stars this month`
