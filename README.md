...
`更新时间：2025-08-18 04:27:13 +0800`

## 今日热门仓库

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **7,416** &nbsp;&nbsp; folks: **1,438**  &nbsp;&nbsp; `991 stars today`

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **4,728** &nbsp;&nbsp; folks: **457**  &nbsp;&nbsp; `461 stars today`
...
1. [aliasrobotics / cai](https://github.com/aliasrobotics/cai)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,601** &nbsp;&nbsp; folks: **396**  &nbsp;&nbsp; `152 stars today`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **3,945** &nbsp;&nbsp; folks: **162**  &nbsp;&nbsp; `490 stars today`
...
1. [MotiaDev / motia](https://github.com/MotiaDev/motia)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,162** &nbsp;&nbsp; folks: **485**  &nbsp;&nbsp; `99 stars today`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,207** &nbsp;&nbsp; folks: **1,545**  &nbsp;&nbsp; `1,136 stars this week`
...
1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,938** &nbsp;&nbsp; folks: **699**  &nbsp;&nbsp; `1,912 stars this week`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **35,321** &nbsp;&nbsp; folks: **4,035**  &nbsp;&nbsp; `2,062 stars this week`
...
1. [syncthing / syncthing](https://github.com/syncthing/syncthing)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **75,056** &nbsp;&nbsp; folks: **4,697**  &nbsp;&nbsp; `810 stars this week`

1. [idosal / git-mcp](https://github.com/idosal/git-mcp)
    - Put an end to code hallucinations! GitMCP is a free, open-source, remote MCP server for any GitHub project
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,342** &nbsp;&nbsp; folks: **397**  &nbsp;&nbsp; `1,139 stars this week`

1. [FiloSottile / mkcert](https://github.com/FiloSottile/mkcert)
    - A simple zero-config tool to make locally trusted development certificates with any names you'd like.
    - language: **Go** &nbsp;&nbsp; stars: **56,074** &nbsp;&nbsp; folks: **2,932**  &nbsp;&nbsp; `947 stars this week`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Financial data aggregator for humans and AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **49,759** &nbsp;&nbsp; folks: **4,638**  &nbsp;&nbsp; `6,652 stars this month`
...
1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,561** &nbsp;&nbsp; folks: **1,006**  &nbsp;&nbsp; `8,553 stars this month`

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **7,416** &nbsp;&nbsp; folks: **1,438**  &nbsp;&nbsp; `934 stars this month`
...
1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **55,490** &nbsp;&nbsp; folks: **9,434**  &nbsp;&nbsp; `3,093 stars this month`
