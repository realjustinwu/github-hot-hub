...
`更新时间：2025-06-07 04:28:09 +0800`

## 今日热门仓库

1. [netbirdio / netbird](https://github.com/netbirdio/netbird)
    - Connect your devices into a secure WireGuard®-based overlay network with SSO, MFA and granular access controls.
    - language: **Go** &nbsp;&nbsp; stars: **14,598** &nbsp;&nbsp; folks: **693**  &nbsp;&nbsp; `320 stars today`
...
1. [topoteretes / cognee](https://github.com/topoteretes/cognee)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,292** &nbsp;&nbsp; folks: **285**  &nbsp;&nbsp; `593 stars today`

1. [stanfordnlp / dspy](https://github.com/stanfordnlp/dspy)
    - DSPy: The framework for programming—not prompting—language models
    - language: **Python** &nbsp;&nbsp; stars: **24,849** &nbsp;&nbsp; folks: **1,931**  &nbsp;&nbsp; `43 stars today`
...
1. [unslothai / notebooks](https://github.com/unslothai/notebooks)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **1,254** &nbsp;&nbsp; folks: **209**  &nbsp;&nbsp; `211 stars today`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,674** &nbsp;&nbsp; folks: **918**  &nbsp;&nbsp; `14 stars today`

1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **无** &nbsp;&nbsp; stars: **54,567** &nbsp;&nbsp; folks: **5,819**  &nbsp;&nbsp; `252 stars today`
...
1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    ...
    - language: **Markdown** &nbsp;&nbsp; stars: **385,013** &nbsp;&nbsp; folks: **35,909**  &nbsp;&nbsp; `357 stars today`
...
1. [anthropics / prompt-eng-interactive-tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **10,531** &nbsp;&nbsp; folks: **964**  &nbsp;&nbsp; `5,347 stars this week`
...
1. [aaPanel / BillionMail](https://github.com/aaPanel/BillionMail)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **4,684** &nbsp;&nbsp; folks: **328**  &nbsp;&nbsp; `1,801 stars this week`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **304,518** &nbsp;&nbsp; folks: **50,377**  &nbsp;&nbsp; `3,057 stars this week`
...
1. [Fosowl / agenticSeek](https://github.com/Fosowl/agenticSeek)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,016** &nbsp;&nbsp; folks: **1,589**  &nbsp;&nbsp; `3,940 stars this week`
...
1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **11,571** &nbsp;&nbsp; folks: **641**  &nbsp;&nbsp; `825 stars this week`
...
1. [Fosowl / agenticSeek](https://github.com/Fosowl/agenticSeek)
    - Fully Local Manus AI. No APIs, No $200 monthly bills. Enjoy an autonomous agent that thinks, browses the web, and code for the sole cost of electricity. 🔔 Official updates only via twitter @Martin993886460. Any other account is fake.
    - language: **Python** &nbsp;&nbsp; stars: **17,016** &nbsp;&nbsp; folks: **1,589**  &nbsp;&nbsp; `15,049 stars this month`
...
1. [mem0ai / mem0](https://github.com/mem0ai/mem0)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,873** &nbsp;&nbsp; folks: **3,354**  &nbsp;&nbsp; `5,306 stars this month`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **326,246** &nbsp;&nbsp; folks: **41,986**  &nbsp;&nbsp; `9,209 stars this month`
...
1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **无** &nbsp;&nbsp; stars: **54,567** &nbsp;&nbsp; folks: **5,819**  &nbsp;&nbsp; `4,472 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **11,571** &nbsp;&nbsp; folks: **641**  &nbsp;&nbsp; `3,191 stars this month`
...
1. [MODSetter / SurfSense](https://github.com/MODSetter/SurfSense)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,451** &nbsp;&nbsp; folks: **383**  &nbsp;&nbsp; `2,971 stars this month`
...
1. [CopilotKit / CopilotKit](https://github.com/CopilotKit/CopilotKit)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **20,846** &nbsp;&nbsp; folks: **2,856**  &nbsp;&nbsp; `2,357 stars this month`
