...
`更新时间：2025-08-04 18:31:57 +0800`

## 今日热门仓库

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder | v0 / lovable / Bolt alternative | 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,902** &nbsp;&nbsp; folks: **653**  &nbsp;&nbsp; `751 stars today`
...
1. [eclipse-sumo / sumo](https://github.com/eclipse-sumo/sumo)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,436** &nbsp;&nbsp; folks: **1,596**  &nbsp;&nbsp; `39 stars today`

1. [trekhleb / javascript-algorithms](https://github.com/trekhleb/javascript-algorithms)
    - 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
    - language: **JavaScript** &nbsp;&nbsp; stars: **192,841** &nbsp;&nbsp; folks: **30,822**  &nbsp;&nbsp; `158 stars today`
...
1. [jellyfin / jellyfin](https://github.com/jellyfin/jellyfin)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **41,948** &nbsp;&nbsp; folks: **3,754**  &nbsp;&nbsp; `41 stars today`

1. [rasbt / LLMs-from-scratch](https://github.com/rasbt/LLMs-from-scratch)
    - Implement a ChatGPT-like LLM in PyTorch from scratch, step by step
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **61,604** &nbsp;&nbsp; folks: **8,672**  &nbsp;&nbsp; `362 stars today`
...
1. [sst / opencode](https://github.com/sst/opencode)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **17,012** &nbsp;&nbsp; folks: **1,054**  &nbsp;&nbsp; `282 stars today`

1. [TideDra / zotero-arxiv-daily](https://github.com/TideDra/zotero-arxiv-daily)
    - Recommend new arxiv papers of your interest daily according to your Zotero libarary.
    - language: **Python** &nbsp;&nbsp; stars: **2,812** &nbsp;&nbsp; folks: **2,394**  &nbsp;&nbsp; `50 stars today`
...
1. [MotiaDev / motia](https://github.com/MotiaDev/motia)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,962** &nbsp;&nbsp; folks: **383**  &nbsp;&nbsp; `291 stars today`

1. [reflex-dev / reflex](https://github.com/reflex-dev/reflex)
    - 🕸️ Web apps in pure Python 🐍
    - language: **Python** &nbsp;&nbsp; stars: **24,308** &nbsp;&nbsp; folks: **1,425**  &nbsp;&nbsp; `165 stars today`
...
1. [flydelabs / flyde](https://github.com/flydelabs/flyde)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,202** &nbsp;&nbsp; folks: **138**  &nbsp;&nbsp; `172 stars today`
...
1. [cloudwego / eino](https://github.com/cloudwego/eino)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **6,366** &nbsp;&nbsp; folks: **491**  &nbsp;&nbsp; `981 stars this week`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **55,279** &nbsp;&nbsp; folks: **6,475**  &nbsp;&nbsp; `3,271 stars this week`

1. [linshenkx / prompt-optimizer](https://github.com/linshenkx/prompt-optimizer)
    - 一款提示词优化器，助力于编写高质量的提示词
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,223** &nbsp;&nbsp; folks: **1,475**  &nbsp;&nbsp; `1,739 stars this week`
...
1. [QwenLM / Qwen3-Coder](https://github.com/QwenLM/Qwen3-Coder)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,199** &nbsp;&nbsp; folks: **763**  &nbsp;&nbsp; `1,499 stars this week`
...
1. [roboflow / supervision](https://github.com/roboflow/supervision)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,160** &nbsp;&nbsp; folks: **2,662**  &nbsp;&nbsp; `2,742 stars this week`
...
1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder | v0 / lovable / Bolt alternative | 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,902** &nbsp;&nbsp; folks: **653**  &nbsp;&nbsp; `2,157 stars this week`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer.
    - language: **Rust** &nbsp;&nbsp; stars: **94,929** &nbsp;&nbsp; folks: **13,886**  &nbsp;&nbsp; `929 stars this week`
...
1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,846** &nbsp;&nbsp; folks: **717**  &nbsp;&nbsp; `2,004 stars this week`
...
1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **8,768** &nbsp;&nbsp; folks: **631**  &nbsp;&nbsp; `6,942 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,846** &nbsp;&nbsp; folks: **717**  &nbsp;&nbsp; `6,951 stars this month`

1. [rustfs / rustfs](https://github.com/rustfs/rustfs)
    - 🚀 High-performance distributed object storage for MinIO alternative.
    - language: **Rust** &nbsp;&nbsp; stars: **6,841** &nbsp;&nbsp; folks: **306**  &nbsp;&nbsp; `6,322 stars this month`

1. [humanlayer / 12-factor-agents](https://github.com/humanlayer/12-factor-agents)
    - What are the principles we can use to build LLM-powered software that is actually good enough to put in the hands of production customers?
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,441** &nbsp;&nbsp; folks: **769**  &nbsp;&nbsp; `6,232 stars this month`

1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    - Python tool for converting files and office documents to Markdown.
    - language: **Python** &nbsp;&nbsp; stars: **70,219** &nbsp;&nbsp; folks: **3,794**  &nbsp;&nbsp; `10,628 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **27,801** &nbsp;&nbsp; folks: **1,556**  &nbsp;&nbsp; `10,665 stars this month`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **8,553** &nbsp;&nbsp; folks: **434**  &nbsp;&nbsp; `6,334 stars this month`

1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    - 小红书笔记 | 评论爬虫、抖音视频 | 评论爬虫、快手视频 | 评论爬虫、B 站视频 ｜ 评论爬虫、微博帖子 ｜ 评论爬虫、百度贴吧帖子 ｜ 百度贴吧评论回复爬虫 | 知乎问答文章｜评论爬虫
    - language: **Python** &nbsp;&nbsp; stars: **34,949** &nbsp;&nbsp; folks: **8,170**  &nbsp;&nbsp; `9,738 stars this month`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **7,024** &nbsp;&nbsp; folks: **931**  &nbsp;&nbsp; `2,812 stars this month`

1. [sst / opencode](https://github.com/sst/opencode)
    - AI coding agent, built for the terminal.
    - language: **Go** &nbsp;&nbsp; stars: **17,012** &nbsp;&nbsp; folks: **1,054**  &nbsp;&nbsp; `8,126 stars this month`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder | v0 / lovable / Bolt alternative | 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,902** &nbsp;&nbsp; folks: **653**  &nbsp;&nbsp; `2,439 stars this month`

1. [frappe / hrms](https://github.com/frappe/hrms)
    - Open Source HR and Payroll Software
    - language: **Python** &nbsp;&nbsp; stars: **5,681** &nbsp;&nbsp; folks: **1,491**  &nbsp;&nbsp; `2,942 stars this month`

1. [dockur / macos](https://github.com/dockur/macos)
    - macOS inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **15,993** &nbsp;&nbsp; folks: **670**  &nbsp;&nbsp; `3,970 stars this month`
