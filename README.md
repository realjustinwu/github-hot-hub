...
`更新时间：2025-08-19 17:26:46 +0800`

## 今日热门仓库

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **9,427** &nbsp;&nbsp; folks: **1,641**  &nbsp;&nbsp; `1,353 stars today`

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **5,883** &nbsp;&nbsp; folks: **520**  &nbsp;&nbsp; `1,129 stars today`
...
1. [rasbt / LLMs-from-scratch](https://github.com/rasbt/LLMs-from-scratch)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **65,402** &nbsp;&nbsp; folks: **9,200**  &nbsp;&nbsp; `468 stars today`
...
1. [enescingoz / awesome-n8n-templates](https://github.com/enescingoz/awesome-n8n-templates)
    ...
    - language: **无** &nbsp;&nbsp; stars: **9,450** &nbsp;&nbsp; folks: **2,719**  &nbsp;&nbsp; `130 stars today`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **4,645** &nbsp;&nbsp; folks: **187**  &nbsp;&nbsp; `500 stars today`

1. [immich-app / immich](https://github.com/immich-app/immich)
    - High performance self-hosted photo and video management solution.
    - language: **TypeScript** &nbsp;&nbsp; stars: **73,430** &nbsp;&nbsp; folks: **3,876**  &nbsp;&nbsp; `114 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **59,900** &nbsp;&nbsp; folks: **7,190**  &nbsp;&nbsp; `804 stars today`
...
1. [mfts / papermark](https://github.com/mfts/papermark)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,292** &nbsp;&nbsp; folks: **996**  &nbsp;&nbsp; `77 stars today`
...
1. [menloresearch / jan](https://github.com/menloresearch/jan)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **37,216** &nbsp;&nbsp; folks: **2,185**  &nbsp;&nbsp; `1,151 stars this week`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **22,575** &nbsp;&nbsp; folks: **4,342**  &nbsp;&nbsp; `13,434 stars this month`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Financial data aggregator for humans and AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **50,375** &nbsp;&nbsp; folks: **4,705**  &nbsp;&nbsp; `7,132 stars this month`

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **9,427** &nbsp;&nbsp; folks: **1,641**  &nbsp;&nbsp; `3,278 stars this month`
...
1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,942** &nbsp;&nbsp; folks: **1,030**  &nbsp;&nbsp; `8,154 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,444** &nbsp;&nbsp; folks: **615**  &nbsp;&nbsp; `7,087 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,680** &nbsp;&nbsp; folks: **9,490**  &nbsp;&nbsp; `3,097 stars this month`
