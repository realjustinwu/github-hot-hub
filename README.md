...
`更新时间：2025-10-12 18:22:35 +0800`

## 今日热门仓库

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **TypeScript** &nbsp;&nbsp; stars: **37,311** &nbsp;&nbsp; folks: **2,345**  &nbsp;&nbsp; `387 stars today`

1. [QwenLM / Qwen3-VL](https://github.com/QwenLM/Qwen3-VL)
    - Qwen3-VL is the multimodal large language model series developed by Qwen team, Alibaba Cloud.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **14,120** &nbsp;&nbsp; folks: **1,074**  &nbsp;&nbsp; `112 stars today`
...
1. [timelinize / timelinize](https://github.com/timelinize/timelinize)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **2,636** &nbsp;&nbsp; folks: **80**  &nbsp;&nbsp; `74 stars today`

1. [PixelGuys / Cubyz](https://github.com/PixelGuys/Cubyz)
    - Voxel sandbox game with a large render distance, procedurally generated content and some cool graphical effects.
    - language: **Zig** &nbsp;&nbsp; stars: **1,896** &nbsp;&nbsp; folks: **126**  &nbsp;&nbsp; `365 stars today`
...
1. [evershopcommerce / evershop](https://github.com/evershopcommerce/evershop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,907** &nbsp;&nbsp; folks: **1,845**  &nbsp;&nbsp; `662 stars today`

1. [CapSoftware / Cap](https://github.com/CapSoftware/Cap)
    - Open source Loom alternative. Beautiful, shareable screen recordings.
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,774** &nbsp;&nbsp; folks: **870**  &nbsp;&nbsp; `344 stars today`
...
1. [TibixDev / winboat](https://github.com/TibixDev/winboat)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,193** &nbsp;&nbsp; folks: **263**  &nbsp;&nbsp; `831 stars today`
...
1. [Stremio / stremio-web](https://github.com/Stremio/stremio-web)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **7,424** &nbsp;&nbsp; folks: **842**  &nbsp;&nbsp; `5,686 stars this week`

1. [audacity / audacity](https://github.com/audacity/audacity)
    - Audio Editor
    - language: **C++** &nbsp;&nbsp; stars: **15,349** &nbsp;&nbsp; folks: **2,438**  &nbsp;&nbsp; `920 stars this week`
...
1. [hsliuping / TradingAgents-CN](https://github.com/hsliuping/TradingAgents-CN)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,275** &nbsp;&nbsp; folks: **2,252**  &nbsp;&nbsp; `1,254 stars this week`

1. [TapXWorld / ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook)
    - 所有小初高、大学PDF教材。
    - language: **Roff** &nbsp;&nbsp; stars: **52,976** &nbsp;&nbsp; folks: **11,883**  &nbsp;&nbsp; `2,218 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **TypeScript** &nbsp;&nbsp; stars: **37,311** &nbsp;&nbsp; folks: **2,345**  &nbsp;&nbsp; `986 stars this week`

1. [airweave-ai / airweave](https://github.com/airweave-ai/airweave)
    - Airweave lets agents search any app
    - language: **Python** &nbsp;&nbsp; stars: **4,209** &nbsp;&nbsp; folks: **518**  &nbsp;&nbsp; `464 stars this week`
...
1. [evershopcommerce / evershop](https://github.com/evershopcommerce/evershop)
    - 🛍️ Typescript E-commerce Platform
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,907** &nbsp;&nbsp; folks: **1,845**  &nbsp;&nbsp; `781 stars this week`
...
1. [Alibaba-NLP / DeepResearch](https://github.com/Alibaba-NLP/DeepResearch)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,797** &nbsp;&nbsp; folks: **1,182**  &nbsp;&nbsp; `9,382 stars this month`
...
1. [sentient-agi / ROMA](https://github.com/sentient-agi/ROMA)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,893** &nbsp;&nbsp; folks: **582**  &nbsp;&nbsp; `2,556 stars this month`

1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **47,046** &nbsp;&nbsp; folks: **5,666**  &nbsp;&nbsp; `7,074 stars this month`
...
1. [audacity / audacity](https://github.com/audacity/audacity)
    - Audio Editor
    - language: **C++** &nbsp;&nbsp; stars: **15,349** &nbsp;&nbsp; folks: **2,438**  &nbsp;&nbsp; `1,203 stars this month`
...
1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **210,581** &nbsp;&nbsp; folks: **48,620**  &nbsp;&nbsp; `4,008 stars this month`
