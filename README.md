...
`更新时间：2025-07-28 15:31:11 +0800`

## 今日热门仓库

1. [Genesis-Embodied-AI / Genesis](https://github.com/Genesis-Embodied-AI/Genesis)
    - A generative world for general-purpose robotics & embodied AI learning.
    - language: **Python** &nbsp;&nbsp; stars: **26,451** &nbsp;&nbsp; folks: **2,410**  &nbsp;&nbsp; `211 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **52,500** &nbsp;&nbsp; folks: **6,133**  &nbsp;&nbsp; `488 stars today`

1. [frappe / hrms](https://github.com/frappe/hrms)
    - Open Source HR and Payroll Software
    - language: **Python** &nbsp;&nbsp; stars: **4,997** &nbsp;&nbsp; folks: **1,417**  &nbsp;&nbsp; `323 stars today`
...
1. [daveebbelaar / ai-cookbook](https://github.com/daveebbelaar/ai-cookbook)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,928** &nbsp;&nbsp; folks: **802**  &nbsp;&nbsp; `33 stars today`

1. [tldr-pages / tldr](https://github.com/tldr-pages/tldr)
    - 📚 Collaborative cheatsheets for console commands
    - language: **Markdown** &nbsp;&nbsp; stars: **56,939** &nbsp;&nbsp; folks: **4,590**  &nbsp;&nbsp; `46 stars today`

1. [Infisical / infisical](https://github.com/Infisical/infisical)
    - Infisical is the open-source platform for secrets management, PKI, and SSH access.
    - language: **TypeScript** &nbsp;&nbsp; stars: **19,485** &nbsp;&nbsp; folks: **1,286**  &nbsp;&nbsp; `284 stars today`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **46,604** &nbsp;&nbsp; folks: **4,242**  &nbsp;&nbsp; `3,213 stars this week`
...
1. [frappe / hrms](https://github.com/frappe/hrms)
    - Open Source HR and Payroll Software
    - language: **Python** &nbsp;&nbsp; stars: **4,997** &nbsp;&nbsp; folks: **1,417**  &nbsp;&nbsp; `2,019 stars this week`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,180** &nbsp;&nbsp; folks: **359**  &nbsp;&nbsp; `2,402 stars this week`
...
1. [Dokploy / dokploy](https://github.com/Dokploy/dokploy)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **22,361** &nbsp;&nbsp; folks: **1,231**  &nbsp;&nbsp; `775 stars this week`

1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    - 11 Lessons to Get Started Building AI Agents
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **32,886** &nbsp;&nbsp; folks: **9,677**  &nbsp;&nbsp; `1,679 stars this week`
...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,210** &nbsp;&nbsp; folks: **849**  &nbsp;&nbsp; `1,008 stars this week`
...
1. [Lissy93 / web-check](https://github.com/Lissy93/web-check)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,874** &nbsp;&nbsp; folks: **2,060**  &nbsp;&nbsp; `212 stars this week`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **34,064** &nbsp;&nbsp; folks: **8,033**  &nbsp;&nbsp; `10,307 stars this month`
...
1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **8,073** &nbsp;&nbsp; folks: **589**  &nbsp;&nbsp; `6,395 stars this month`

1. [humanlayer / 12-factor-agents](https://github.com/humanlayer/12-factor-agents)
    - What are the principles we can use to build LLM-powered software that is actually good enough to put in the hands of production customers?
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,536** &nbsp;&nbsp; folks: **685**  &nbsp;&nbsp; `5,789 stars this month`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **7,180** &nbsp;&nbsp; folks: **359**  &nbsp;&nbsp; `5,445 stars this month`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **46,604** &nbsp;&nbsp; folks: **4,242**  &nbsp;&nbsp; `4,427 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,902** &nbsp;&nbsp; folks: **590**  &nbsp;&nbsp; `5,690 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **26,354** &nbsp;&nbsp; folks: **1,448**  &nbsp;&nbsp; `10,513 stars this month`

1. [google-gemini / gemini-cli](https://github.com/google-gemini/gemini-cli)
    - An open-source AI agent that brings the power of Gemini directly into your terminal.
    - language: **TypeScript** &nbsp;&nbsp; stars: **64,828** &nbsp;&nbsp; folks: **6,169**  &nbsp;&nbsp; `31,091 stars this month`
...
1. [GraphiteEditor / Graphite](https://github.com/GraphiteEditor/Graphite)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **20,104** &nbsp;&nbsp; folks: **828**  &nbsp;&nbsp; `6,811 stars this month`
...
1. [GyulyVGC / sniffnet](https://github.com/GyulyVGC/sniffnet)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **29,493** &nbsp;&nbsp; folks: **985**  &nbsp;&nbsp; `4,972 stars this month`

1. [twentyhq / twenty](https://github.com/twentyhq/twenty)
    - Building a modern alternative to Salesforce, powered by the community.
    - language: **TypeScript** &nbsp;&nbsp; stars: **34,594** &nbsp;&nbsp; folks: **3,882**  &nbsp;&nbsp; `5,221 stars this month`
