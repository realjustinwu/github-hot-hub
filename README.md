...
1. [x1xhlol / system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools)
    ...
    - language: **无** &nbsp;&nbsp; stars: **75,605** &nbsp;&nbsp; folks: **21,255**  &nbsp;&nbsp; `442 stars today`
...
1. [xiaoyaocz / dart_simple_live](https://github.com/xiaoyaocz/dart_simple_live)
    - 简简单单的看直播
    - language: **Dart** &nbsp;&nbsp; stars: **12,399** &nbsp;&nbsp; folks: **954**  &nbsp;&nbsp; `108 stars today`
...
1. [ChrisTitusTech / linutil](https://github.com/ChrisTitusTech/linutil)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **4,035** &nbsp;&nbsp; folks: **324**  &nbsp;&nbsp; `32 stars today`

1. [actions / checkout](https://github.com/actions/checkout)
    - Action for checking out a repo
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,854** &nbsp;&nbsp; folks: **2,100**  &nbsp;&nbsp; `13 stars today`

1. [FiloSottile / mkcert](https://github.com/FiloSottile/mkcert)
    - A simple zero-config tool to make locally trusted development certificates with any names you'd like.
    - language: **Go** &nbsp;&nbsp; stars: **55,476** &nbsp;&nbsp; folks: **2,908**  &nbsp;&nbsp; `130 stars today`
...
1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,524** &nbsp;&nbsp; folks: **1,179**  &nbsp;&nbsp; `4,187 stars this week`
...
1. [ollama / ollama](https://github.com/ollama/ollama)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **150,054** &nbsp;&nbsp; folks: **12,799**  &nbsp;&nbsp; `1,371 stars this week`
...
1. [umami-software / umami](https://github.com/umami-software/umami)
    - Umami is a modern, privacy-focused alternative to Google Analytics.
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,628** &nbsp;&nbsp; folks: **5,360**  &nbsp;&nbsp; `1,856 stars this week`
...
1. [patchy631 / ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,973** &nbsp;&nbsp; folks: **2,858**  &nbsp;&nbsp; `1,300 stars this week`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **49,050** &nbsp;&nbsp; folks: **4,563**  &nbsp;&nbsp; `6,905 stars this month`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,524** &nbsp;&nbsp; folks: **1,179**  &nbsp;&nbsp; `10,590 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,504** &nbsp;&nbsp; folks: **929**  &nbsp;&nbsp; `9,034 stars this month`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **71,101** &nbsp;&nbsp; folks: **3,861**  &nbsp;&nbsp; `11,119 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,259** &nbsp;&nbsp; folks: **560**  &nbsp;&nbsp; `6,505 stars this month`
...
1. [sst / opencode](https://github.com/sst/opencode)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **19,158** &nbsp;&nbsp; folks: **1,212**  &nbsp;&nbsp; `7,499 stars this month`
