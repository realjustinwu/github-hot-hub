...
`更新时间：2025-04-19 14:31:00 +0800`

## 今日热门仓库

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **76,834** &nbsp;&nbsp; folks: **9,332**  &nbsp;&nbsp; `1,328 stars today`

1. [jlowin / fastmcp](https://github.com/jlowin/fastmcp)
    - 🚀 The fast, Pythonic way to build MCP servers and clients
    - language: **Python** &nbsp;&nbsp; stars: **5,836** &nbsp;&nbsp; folks: **296**  &nbsp;&nbsp; `234 stars today`

1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    - An AI Hedge Fund Team
    - language: **Python** &nbsp;&nbsp; stars: **25,824** &nbsp;&nbsp; folks: **4,410**  &nbsp;&nbsp; `785 stars today`

1. [microsoft / BitNet](https://github.com/microsoft/BitNet)
    - Official inference framework for 1-bit LLMs
    - language: **C++** &nbsp;&nbsp; stars: **13,880** &nbsp;&nbsp; folks: **964**  &nbsp;&nbsp; `402 stars today`

1. [linera-io / linera-protocol](https://github.com/linera-io/linera-protocol)
    - Main repository for the Linera protocol
    - language: **Rust** &nbsp;&nbsp; stars: **23,307** &nbsp;&nbsp; folks: **1,424**  &nbsp;&nbsp; `1,605 stars today`

1. [docmost / docmost](https://github.com/docmost/docmost)
    - Docmost is an open-source collaborative wiki and documentation software. It is an open-source alternative to Confluence and Notion.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,068** &nbsp;&nbsp; folks: **677**  &nbsp;&nbsp; `414 stars today`
...
1. [NirDiamant / RAG_Techniques](https://github.com/NirDiamant/RAG_Techniques)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,198** &nbsp;&nbsp; folks: **1,519**  &nbsp;&nbsp; `342 stars today`

1. [browserbase / stagehand](https://github.com/browserbase/stagehand)
    - An AI web browsing framework focused on simplicity and extensibility.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,505** &nbsp;&nbsp; folks: **577**  &nbsp;&nbsp; `311 stars today`

1. [opf / openproject](https://github.com/opf/openproject)
    - OpenProject is the leading open source project management software.
    - language: **Ruby** &nbsp;&nbsp; stars: **10,792** &nbsp;&nbsp; folks: **2,559**  &nbsp;&nbsp; `40 stars today`

1. [1Panel-dev / 1Panel](https://github.com/1Panel-dev/1Panel)
    - 🔥 1Panel provides an intuitive web interface and MCP Server to manage websites, files, containers, databases, and LLMs on a Linux server.
    - language: **Go** &nbsp;&nbsp; stars: **27,251** &nbsp;&nbsp; folks: **2,387**  &nbsp;&nbsp; `368 stars today`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,175** &nbsp;&nbsp; folks: **2,333**  &nbsp;&nbsp; `9,428 stars this week`
...
1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    - An AI Hedge Fund Team
    - language: **Python** &nbsp;&nbsp; stars: **25,824** &nbsp;&nbsp; folks: **4,410**  &nbsp;&nbsp; `4,832 stars this week`

1. [krillinai / KrillinAI](https://github.com/krillinai/KrillinAI)
    - A video translation and dubbing tool powered by LLMs, offering professional-grade translations and one-click full-process deployment. It can generate content optimized for platforms like YouTube，TikTok, and Shorts. 基于AI大模型的视频翻译和配音工具，专业级翻译，一键部署全流程，可以生成适配抖音，小红书，哔哩哔哩，视频号，TikTok，Youtube Shorts等形态的内容
    - language: **Go** &nbsp;&nbsp; stars: **5,043** &nbsp;&nbsp; folks: **369**  &nbsp;&nbsp; `2,879 stars this week`
...
1. [jlowin / fastmcp](https://github.com/jlowin/fastmcp)
    - 🚀 The fast, Pythonic way to build MCP servers and clients
    - language: **Python** &nbsp;&nbsp; stars: **5,836** &nbsp;&nbsp; folks: **296**  &nbsp;&nbsp; `1,205 stars this week`
...
1. [NirDiamant / RAG_Techniques](https://github.com/NirDiamant/RAG_Techniques)
    - This repository showcases various advanced techniques for Retrieval-Augmented Generation (RAG) systems. RAG systems combine information retrieval with generative models to provide accurate and contextually rich responses.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,198** &nbsp;&nbsp; folks: **1,519**  &nbsp;&nbsp; `1,069 stars this week`

1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    - 10 Lessons to Get Started Building AI Agents
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,738** &nbsp;&nbsp; folks: **3,798**  &nbsp;&nbsp; `3,295 stars this week`
...
1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **76,834** &nbsp;&nbsp; folks: **9,332**  &nbsp;&nbsp; `5,109 stars this week`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    - [Support 0.48.x]（Reset Cursor AI MachineID & Bypass Higher Token Limit） Cursor Ai ，自动重置机器ID ， 免费升级使用Pro功能: You've reached your trial request limit. / Too many free trial accounts used on this machine. Please upgrade to pro. We have this limit in place to prevent abuse. Please let us know if you believe this is a mistake.
    - language: **Python** &nbsp;&nbsp; stars: **19,175** &nbsp;&nbsp; folks: **2,333**  &nbsp;&nbsp; `15,872 stars this month`

1. [punkpeye / awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)
    - A collection of MCP servers.
    - language: **无** &nbsp;&nbsp; stars: **39,806** &nbsp;&nbsp; folks: **2,839**  &nbsp;&nbsp; `28,346 stars this month`

1. [ahmedkhaleel2004 / gitdiagram](https://github.com/ahmedkhaleel2004/gitdiagram)
    - Free, simple, fast interactive diagrams for any GitHub repository
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,842** &nbsp;&nbsp; folks: **653**  &nbsp;&nbsp; `7,074 stars this month`
...
1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    - 10 Lessons to Get Started Building AI Agents
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,738** &nbsp;&nbsp; folks: **3,798**  &nbsp;&nbsp; `10,976 stars this month`
...
1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **82,958** &nbsp;&nbsp; folks: **22,241**  &nbsp;&nbsp; `14,840 stars this month`

1. [ourongxing / newsnow](https://github.com/ourongxing/newsnow)
    - Elegant reading of real-time and hottest news
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,939** &nbsp;&nbsp; folks: **2,482**  &nbsp;&nbsp; `4,226 stars this month`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **28,548** &nbsp;&nbsp; folks: **3,214**  &nbsp;&nbsp; `8,742 stars this month`

1. [mark3labs / mcp-go](https://github.com/mark3labs/mcp-go)
    - A Go implementation of the Model Context Protocol (MCP), enabling seamless integration between LLM applications and external data sources and tools.
    - language: **Go** &nbsp;&nbsp; stars: **3,507** &nbsp;&nbsp; folks: **290**  &nbsp;&nbsp; `2,668 stars this month`

1. [executeautomation / mcp-playwright](https://github.com/executeautomation/mcp-playwright)
    - Playwright Model Context Protocol Server - Tool to automate Browsers and APIs in Claude Desktop, Cline, Cursor IDE and More 🔌
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,020** &nbsp;&nbsp; folks: **225**  &nbsp;&nbsp; `2,030 stars this month`

1. [PatrickJS / awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules)
    - 📄 A curated list of awesome .cursorrules files
    - language: **无** &nbsp;&nbsp; stars: **22,405** &nbsp;&nbsp; folks: **1,699**  &nbsp;&nbsp; `5,969 stars this month`
