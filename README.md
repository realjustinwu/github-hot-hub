...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **4,278** &nbsp;&nbsp; folks: **292**  &nbsp;&nbsp; `59 stars today`

1. [immich-app / immich](https://github.com/immich-app/immich)
    - High performance self-hosted photo and video management solution.
    - language: **TypeScript** &nbsp;&nbsp; stars: **76,323** &nbsp;&nbsp; folks: **4,038**  &nbsp;&nbsp; `510 stars today`

1. [HKUDS / AutoAgent](https://github.com/HKUDS/AutoAgent)
    - "AutoAgent: Fully-Automated and Zero-Code LLM Agent Framework"
    - language: **Python** &nbsp;&nbsp; stars: **6,394** &nbsp;&nbsp; folks: **862**  &nbsp;&nbsp; `73 stars today`
...
1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,369** &nbsp;&nbsp; folks: **695**  &nbsp;&nbsp; `2,878 stars this week`
...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    - Distributed query engine providing simple and reliable data processing for any modality and scale
    - language: **Rust** &nbsp;&nbsp; stars: **4,278** &nbsp;&nbsp; folks: **292**  &nbsp;&nbsp; `786 stars this week`
...
1. [trufflesecurity / trufflehog](https://github.com/trufflesecurity/trufflehog)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **21,360** &nbsp;&nbsp; folks: **2,013**  &nbsp;&nbsp; `943 stars this week`

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **11,432** &nbsp;&nbsp; folks: **906**  &nbsp;&nbsp; `2,815 stars this week`

1. [google / mangle](https://github.com/google/mangle)
    - 无
    - language: **Go** &nbsp;&nbsp; stars: **2,594** &nbsp;&nbsp; folks: **124**  &nbsp;&nbsp; `596 stars this week`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **66,536** &nbsp;&nbsp; folks: **5,644**  &nbsp;&nbsp; `1,394 stars this week`
...
1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **98,018** &nbsp;&nbsp; folks: **14,373**  &nbsp;&nbsp; `976 stars this week`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **13,367** &nbsp;&nbsp; folks: **1,126**  &nbsp;&nbsp; `11,404 stars this month`

1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    - Collection of extracted System Prompts from popular chatbots like ChatGPT, Claude & Gemini
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,668** &nbsp;&nbsp; folks: **3,119**  &nbsp;&nbsp; `11,489 stars this month`
...
1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **9,099** &nbsp;&nbsp; folks: **274**  &nbsp;&nbsp; `5,750 stars this month`

1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Open-source platform to build and deploy AI agent workflows.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,649** &nbsp;&nbsp; folks: **1,811**  &nbsp;&nbsp; `7,551 stars this month`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **39,901** &nbsp;&nbsp; folks: **4,631**  &nbsp;&nbsp; `6,722 stars this month`
...
1. [basecamp / omarchy](https://github.com/basecamp/omarchy)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **7,565** &nbsp;&nbsp; folks: **886**  &nbsp;&nbsp; `4,131 stars this month`

1. [aliasrobotics / cai](https://github.com/aliasrobotics/cai)
    - Cybersecurity AI (CAI), the framework for AI Security
    - language: **Python** &nbsp;&nbsp; stars: **3,760** &nbsp;&nbsp; folks: **511**  &nbsp;&nbsp; `1,740 stars this month`
