...
1. [imsyy / SPlayer](https://github.com/imsyy/SPlayer)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **4,694** &nbsp;&nbsp; folks: **835**  &nbsp;&nbsp; `29 stars today`
...
1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **4,677** &nbsp;&nbsp; folks: **188**  &nbsp;&nbsp; `500 stars today`
...
1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,905** &nbsp;&nbsp; folks: **138**  &nbsp;&nbsp; `196 stars today`

1. [HeyPuter / puter](https://github.com/HeyPuter/puter)
    - 🌐 The Internet OS! Free, Open-Source, and Self-Hostable.
    - language: **JavaScript** &nbsp;&nbsp; stars: **34,950** &nbsp;&nbsp; folks: **2,680**  &nbsp;&nbsp; `40 stars today`

1. [awslabs / mcp](https://github.com/awslabs/mcp)
    - AWS MCP Servers — helping you get the most out of AWS, wherever you use MCP.
    - language: **Python** &nbsp;&nbsp; stars: **5,539** &nbsp;&nbsp; folks: **747**  &nbsp;&nbsp; `132 stars today`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,548** &nbsp;&nbsp; folks: **1,604**  &nbsp;&nbsp; `1,821 stars this week`

1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **2,843** &nbsp;&nbsp; folks: **285**  &nbsp;&nbsp; `1,136 stars this week`
...
1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,132** &nbsp;&nbsp; folks: **715**  &nbsp;&nbsp; `1,743 stars this week`
...
1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **4,677** &nbsp;&nbsp; folks: **188**  &nbsp;&nbsp; `1,418 stars this week`

1. [trailofbits / buttercup](https://github.com/trailofbits/buttercup)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **957** &nbsp;&nbsp; folks: **96**  &nbsp;&nbsp; `479 stars this week`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **9,502** &nbsp;&nbsp; folks: **1,646**  &nbsp;&nbsp; `3,278 stars this month`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,370** &nbsp;&nbsp; folks: **1,286**  &nbsp;&nbsp; `11,338 stars this month`

1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    - Improve your resumes with Resume Matcher. Get insights, keyword suggestions and tune your resumes to job descriptions.
    - language: **Python** &nbsp;&nbsp; stars: **22,584** &nbsp;&nbsp; folks: **4,344**  &nbsp;&nbsp; `13,434 stars this month`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Financial data aggregator for humans and AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **50,401** &nbsp;&nbsp; folks: **4,706**  &nbsp;&nbsp; `7,132 stars this month`
...
1. [frappe / hrms](https://github.com/frappe/hrms)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,365** &nbsp;&nbsp; folks: **1,563**  &nbsp;&nbsp; `3,585 stars this month`
...
1. [roboflow / supervision](https://github.com/roboflow/supervision)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **34,095** &nbsp;&nbsp; folks: **2,749**  &nbsp;&nbsp; `6,956 stars this month`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **8,049** &nbsp;&nbsp; folks: **1,065**  &nbsp;&nbsp; `3,115 stars this month`

1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **2,843** &nbsp;&nbsp; folks: **285**  &nbsp;&nbsp; `1,605 stars this month`
...
1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **55,692** &nbsp;&nbsp; folks: **9,494**  &nbsp;&nbsp; `3,097 stars this month`
