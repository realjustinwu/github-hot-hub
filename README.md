...
1. [lobehub / lobe-chat](https://github.com/lobehub/lobe-chat)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **45,844** &nbsp;&nbsp; folks: **10,236**  &nbsp;&nbsp; `235 stars today`

1. [LadybirdBrowser / ladybird](https://github.com/LadybirdBrowser/ladybird)
    - Truly independent web browser
    - language: **C++** &nbsp;&nbsp; stars: **22,793** &nbsp;&nbsp; folks: **1,011**  &nbsp;&nbsp; `32 stars today`

1. [myhhub / stock](https://github.com/myhhub/stock)
    - stock股票.获取股票数据,计算股票指标,识别股票形态,综合选股,选股策略,股票验证回测,股票自动交易,支持PC及移动设备。
    - language: **Python** &nbsp;&nbsp; stars: **4,204** &nbsp;&nbsp; folks: **786**  &nbsp;&nbsp; `1,251 stars today`
...
1. [Guovin / iptv-api](https://github.com/Guovin/iptv-api)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,976** &nbsp;&nbsp; folks: **1,559**  &nbsp;&nbsp; `346 stars today`
...
1. [4gray / iptvnator](https://github.com/4gray/iptvnator)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,347** &nbsp;&nbsp; folks: **427**  &nbsp;&nbsp; `189 stars today`
...
1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    ...
    - language: **Markdown** &nbsp;&nbsp; stars: **314,899** &nbsp;&nbsp; folks: **29,204**  &nbsp;&nbsp; `536 stars today`

1. [anthropics / prompt-eng-interactive-tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial)
    - Anthropic's Interactive Prompt Engineering Tutorial
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **1,268** &nbsp;&nbsp; folks: **174**  &nbsp;&nbsp; `109 stars today`
...
1. [sdmg15 / Best-websites-a-programmer-should-visit](https://github.com/sdmg15/Best-websites-a-programmer-should-visit)
    ...
    - language: **无** &nbsp;&nbsp; stars: **62,479** &nbsp;&nbsp; folks: **7,832**  &nbsp;&nbsp; `119 stars today`

1. [skills / introduction-to-github](https://github.com/skills/introduction-to-github)
    - Get started using GitHub in less than an hour.
    - language: **无** &nbsp;&nbsp; stars: **5,323** &nbsp;&nbsp; folks: **3,257**  &nbsp;&nbsp; `164 stars today`

1. [topjohnwu / Magisk](https://github.com/topjohnwu/Magisk)
    - The Magic Mask for Android
    - language: **C++** &nbsp;&nbsp; stars: **49,048** &nbsp;&nbsp; folks: **12,614**  &nbsp;&nbsp; `25 stars today`
...
1. [kestra-io / kestra](https://github.com/kestra-io/kestra)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **13,981** &nbsp;&nbsp; folks: **1,202**  &nbsp;&nbsp; `250 stars today`
...
1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **64,415** &nbsp;&nbsp; folks: **7,854**  &nbsp;&nbsp; `3,369 stars this week`
...
1. [Guovin / iptv-api](https://github.com/Guovin/iptv-api)
    - 📺IPTV电视直播源更新工具🚀：包含💰央视、📡卫视、☘️广东及各省份地方台、🌊港·澳·台、🎬电影、🎥咪咕、🏀体育、🪁动画、🎮游戏、🎵音乐、🏛经典剧场；支持自定义增加频道；支持组播源、酒店源、订阅源、关键字搜索；每天自动更新两次，结果可用于TVBox等播放软件；支持工作流、Docker(amd64/arm64/arm v7)、命令行、GUI运行方式 | IPTV live TV source update tool
    - language: **Python** &nbsp;&nbsp; stars: **6,976** &nbsp;&nbsp; folks: **1,559**  &nbsp;&nbsp; `622 stars this week`
...
1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **17,575** &nbsp;&nbsp; folks: **1,293**  &nbsp;&nbsp; `874 stars this week`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **HTML** &nbsp;&nbsp; stars: **340,718** &nbsp;&nbsp; folks: **61,886**  &nbsp;&nbsp; `1,551 stars this week`
...
1. [myhhub / stock](https://github.com/myhhub/stock)
    - stock股票.获取股票数据,计算股票指标,识别股票形态,综合选股,选股策略,股票验证回测,股票自动交易,支持PC及移动设备。
    - language: **Python** &nbsp;&nbsp; stars: **4,204** &nbsp;&nbsp; folks: **786**  &nbsp;&nbsp; `2,370 stars this week`

1. [skills / introduction-to-github](https://github.com/skills/introduction-to-github)
    - Get started using GitHub in less than an hour.
    - language: **无** &nbsp;&nbsp; stars: **5,323** &nbsp;&nbsp; folks: **3,257**  &nbsp;&nbsp; `659 stars this week`

1. [mtdvio / every-programmer-should-know](https://github.com/mtdvio/every-programmer-should-know)
    - A collection of (mostly) technical things every software developer should know about
    - language: **无** &nbsp;&nbsp; stars: **85,261** &nbsp;&nbsp; folks: **7,885**  &nbsp;&nbsp; `1,679 stars this week`
...
1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    - Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue)
    - language: **Python** &nbsp;&nbsp; stars: **64,415** &nbsp;&nbsp; folks: **7,854**  &nbsp;&nbsp; `7,118 stars this month`

1. [DS4SD / docling](https://github.com/DS4SD/docling)
    - Get your documents ready for gen AI
    - language: **Python** &nbsp;&nbsp; stars: **11,987** &nbsp;&nbsp; folks: **599**  &nbsp;&nbsp; `11,157 stars this month`

1. [ai16z / eliza](https://github.com/ai16z/eliza)
    - Conversational Agent for Twitter and Discord
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,554** &nbsp;&nbsp; folks: **753**  &nbsp;&nbsp; `2,098 stars this month`

1. [opendatalab / MinerU](https://github.com/opendatalab/MinerU)
    - A high-quality tool for convert PDF to Markdown and JSON.一站式开源高质量数据提取工具，将PDF转换成Markdown和JSON格式。
    - language: **Python** &nbsp;&nbsp; stars: **19,888** &nbsp;&nbsp; folks: **1,414**  &nbsp;&nbsp; `6,130 stars this month`
...
1. [khoj-ai / khoj](https://github.com/khoj-ai/khoj)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,490** &nbsp;&nbsp; folks: **804**  &nbsp;&nbsp; `3,586 stars this month`

1. [vercel / ai-chatbot](https://github.com/vercel/ai-chatbot)
    - A full-featured, hackable Next.js AI chatbot built by Vercel
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,984** &nbsp;&nbsp; folks: **2,524**  &nbsp;&nbsp; `3,386 stars this month`
...
1. [CodePhiliaX / Chat2DB](https://github.com/CodePhiliaX/Chat2DB)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **17,215** &nbsp;&nbsp; folks: **1,927**  &nbsp;&nbsp; `1,690 stars this month`

1. [microsoft / autogen](https://github.com/microsoft/autogen)
    - A programming framework for agentic AI 🤖
    - language: **Python** &nbsp;&nbsp; stars: **35,202** &nbsp;&nbsp; folks: **5,090**  &nbsp;&nbsp; `2,703 stars this month`

1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    - 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
    - language: **Python** &nbsp;&nbsp; stars: **18,565** &nbsp;&nbsp; folks: **2,839**  &nbsp;&nbsp; `1,842 stars this month`

1. [AmruthPillai / Reactive-Resume](https://github.com/AmruthPillai/Reactive-Resume)
    - A one-of-a-kind resume builder that keeps your privacy in mind. Completely secure, customizable, portable, open-source and free forever. Try it out today!
    - language: **TypeScript** &nbsp;&nbsp; stars: **26,244** &nbsp;&nbsp; folks: **2,682**  &nbsp;&nbsp; `2,770 stars this month`
...
1. [AlexxIT / go2rtc](https://github.com/AlexxIT/go2rtc)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **7,248** &nbsp;&nbsp; folks: **522**  &nbsp;&nbsp; `2,174 stars this month`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **278,069** &nbsp;&nbsp; folks: **46,586**  &nbsp;&nbsp; `4,467 stars this month`
