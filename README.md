...
1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **49,143** &nbsp;&nbsp; folks: **4,762**  &nbsp;&nbsp; `419 stars today`

1. [ChatGPTNextWeb / NextChat](https://github.com/ChatGPTNextWeb/NextChat)
    - ✨ Light and Fast AI Assistant. Support: Web | iOS | MacOS | Android | Linux | Windows
    - language: **TypeScript** &nbsp;&nbsp; stars: **84,820** &nbsp;&nbsp; folks: **61,101**  &nbsp;&nbsp; `427 stars today`

1. [remoteintech / remote-jobs](https://github.com/remoteintech/remote-jobs)
    - A list of semi to fully remote-friendly companies (jobs) in tech.
    - language: **JavaScript** &nbsp;&nbsp; stars: **35,612** &nbsp;&nbsp; folks: **3,528**  &nbsp;&nbsp; `1,158 stars today`
...
1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **22,802** &nbsp;&nbsp; folks: **1,925**  &nbsp;&nbsp; `41 stars today`
...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,878** &nbsp;&nbsp; folks: **820**  &nbsp;&nbsp; `290 stars today`
...
1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The personal finance app for everyone
    - language: **Ruby** &nbsp;&nbsp; stars: **50,416** &nbsp;&nbsp; folks: **3,723**  &nbsp;&nbsp; `3,618 stars this week`
...
1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,767** &nbsp;&nbsp; folks: **507**  &nbsp;&nbsp; `2,655 stars this week`
...
1. [strapi / strapi](https://github.com/strapi/strapi)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **68,673** &nbsp;&nbsp; folks: **8,785**  &nbsp;&nbsp; `998 stars this week`
...
1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **7,598** &nbsp;&nbsp; folks: **555**  &nbsp;&nbsp; `6,045 stars this month`
...
1. [twentyhq / twenty](https://github.com/twentyhq/twenty)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **34,293** &nbsp;&nbsp; folks: **3,856**  &nbsp;&nbsp; `6,037 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **25,280** &nbsp;&nbsp; folks: **1,386**  &nbsp;&nbsp; `11,024 stars this month`

1. [GyulyVGC / sniffnet](https://github.com/GyulyVGC/sniffnet)
    - Comfortably monitor your Internet traffic 🕵️‍♂️
    - language: **Rust** &nbsp;&nbsp; stars: **29,158** &nbsp;&nbsp; folks: **972**  &nbsp;&nbsp; `4,667 stars this month`

1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The personal finance app for everyone
    - language: **Ruby** &nbsp;&nbsp; stars: **50,416** &nbsp;&nbsp; folks: **3,723**  &nbsp;&nbsp; `3,967 stars this month`
...
1. [embabel / embabel-agent](https://github.com/embabel/embabel-agent)
    ...
    - language: **Kotlin** &nbsp;&nbsp; stars: **2,247** &nbsp;&nbsp; folks: **178**  &nbsp;&nbsp; `1,755 stars this month`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,296** &nbsp;&nbsp; folks: **437**  &nbsp;&nbsp; `3,901 stars this month`
...
1. [stanford-oval / storm](https://github.com/stanford-oval/storm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **26,933** &nbsp;&nbsp; folks: **2,421**  &nbsp;&nbsp; `2,332 stars this month`

1. [gorhill / uBlock](https://github.com/gorhill/uBlock)
    - uBlock Origin - An efficient blocker for Chromium and Firefox. Fast and lean.
    - language: **JavaScript** &nbsp;&nbsp; stars: **56,644** &nbsp;&nbsp; folks: **3,610**  &nbsp;&nbsp; `2,061 stars this month`
