...
1. [unionlabs / union](https://github.com/unionlabs/union)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **28,968** &nbsp;&nbsp; folks: **1,768**  &nbsp;&nbsp; `1,266 stars today`

1. [docmost / docmost](https://github.com/docmost/docmost)
    - Docmost is an open-source collaborative wiki and documentation software. It is an open-source alternative to Confluence and Notion.
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,980** &nbsp;&nbsp; folks: **423**  &nbsp;&nbsp; `184 stars today`

1. [cordx56 / rustowl](https://github.com/cordx56/rustowl)
    - Visualize Ownership and Lifetimes in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **3,314** &nbsp;&nbsp; folks: **60**  &nbsp;&nbsp; `465 stars today`
...
1. [exo-explore / exo](https://github.com/exo-explore/exo)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **23,902** &nbsp;&nbsp; folks: **1,423**  &nbsp;&nbsp; `494 stars today`
...
1. [hummingbot / hummingbot](https://github.com/hummingbot/hummingbot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,749** &nbsp;&nbsp; folks: **3,175**  &nbsp;&nbsp; `143 stars today`

1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    - 🚀🚀 「大模型」2小时完全从0训练26M的小参数GPT！🌏 Train a 26M-parameter GPT from scratch in just 2h!
    - language: **Python** &nbsp;&nbsp; stars: **10,469** &nbsp;&nbsp; folks: **1,107**  &nbsp;&nbsp; `691 stars today`

1. [outline / outline](https://github.com/outline/outline)
    - The fastest knowledge base for growing teams. Beautiful, realtime collaborative, feature packed, and markdown compatible.
    - language: **TypeScript** &nbsp;&nbsp; stars: **30,337** &nbsp;&nbsp; folks: **2,411**  &nbsp;&nbsp; `58 stars today`
...
1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    - A simple screen parsing tool towards pure vision based GUI agent
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **13,208** &nbsp;&nbsp; folks: **1,008**  &nbsp;&nbsp; `5,862 stars this week`
...
1. [microsoft / data-formulator](https://github.com/microsoft/data-formulator)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,567** &nbsp;&nbsp; folks: **567**  &nbsp;&nbsp; `4,188 stars this week`
...
1. [hummingbot / hummingbot](https://github.com/hummingbot/hummingbot)
    - Open source software that helps you create and deploy high-frequency crypto trading bots
    - language: **Python** &nbsp;&nbsp; stars: **10,749** &nbsp;&nbsp; folks: **3,175**  &nbsp;&nbsp; `984 stars this week`
...
1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **37,644** &nbsp;&nbsp; folks: **3,344**  &nbsp;&nbsp; `2,747 stars this week`

1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    - 🚀🚀 「大模型」2小时完全从0训练26M的小参数GPT！🌏 Train a 26M-parameter GPT from scratch in just 2h!
    - language: **Python** &nbsp;&nbsp; stars: **10,469** &nbsp;&nbsp; folks: **1,107**  &nbsp;&nbsp; `1,352 stars this week`

1. [vercel / ai-chatbot](https://github.com/vercel/ai-chatbot)
    - A full-featured, hackable Next.js AI chatbot built by Vercel
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,065** &nbsp;&nbsp; folks: **3,330**  &nbsp;&nbsp; `1,145 stars this week`
...
1. [unslothai / unsloth](https://github.com/unslothai/unsloth)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **30,606** &nbsp;&nbsp; folks: **2,025**  &nbsp;&nbsp; `2,801 stars this week`

1. [andrewyng / aisuite](https://github.com/andrewyng/aisuite)
    - Simple, unified interface to multiple Generative AI providers
    - language: **Python** &nbsp;&nbsp; stars: **11,206** &nbsp;&nbsp; folks: **1,075**  &nbsp;&nbsp; `599 stars this week`
...
1. [deepseek-ai / DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,942** &nbsp;&nbsp; folks: **2,222**  &nbsp;&nbsp; `9,712 stars this month`

1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    - A simple screen parsing tool towards pure vision based GUI agent
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **13,208** &nbsp;&nbsp; folks: **1,008**  &nbsp;&nbsp; `6,199 stars this month`
...
1. [unslothai / unsloth](https://github.com/unslothai/unsloth)
    - Finetune Llama 3.3, DeepSeek-R1 & Reasoning LLMs 2x faster with 70% less memory! 🦥
    - language: **Python** &nbsp;&nbsp; stars: **30,606** &nbsp;&nbsp; folks: **2,025**  &nbsp;&nbsp; `9,659 stars this month`

1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    - Make websites accessible for AI agents
    - language: **Python** &nbsp;&nbsp; stars: **29,778** &nbsp;&nbsp; folks: **3,049**  &nbsp;&nbsp; `14,685 stars this month`
...
1. [Mintplex-Labs / anything-llm](https://github.com/Mintplex-Labs/anything-llm)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **37,911** &nbsp;&nbsp; folks: **3,647**  &nbsp;&nbsp; `7,409 stars this month`

1. [ggml-org / llama.cpp](https://github.com/ggml-org/llama.cpp)
    - LLM inference in C/C++
    - language: **C++** &nbsp;&nbsp; stars: **74,731** &nbsp;&nbsp; folks: **10,800**  &nbsp;&nbsp; `4,110 stars this month`

1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **23,902** &nbsp;&nbsp; folks: **1,423**  &nbsp;&nbsp; `4,883 stars this month`
...
1. [Bin-Huang / chatbox](https://github.com/Bin-Huang/chatbox)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **31,307** &nbsp;&nbsp; folks: **2,966**  &nbsp;&nbsp; `6,459 stars this month`
...
1. [lightpanda-io / browser](https://github.com/lightpanda-io/browser)
    ...
    - language: **Zig** &nbsp;&nbsp; stars: **6,510** &nbsp;&nbsp; folks: **130**  &nbsp;&nbsp; `5,349 stars this month`
...
1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding.
    - language: **Python** &nbsp;&nbsp; stars: **37,644** &nbsp;&nbsp; folks: **3,344**  &nbsp;&nbsp; `8,794 stars this month`
