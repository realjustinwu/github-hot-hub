...
1. [godotengine / godot](https://github.com/godotengine/godot)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **93,779** &nbsp;&nbsp; folks: **21,623**  &nbsp;&nbsp; `53 stars today`

1. [T8RIN / ImageToolbox](https://github.com/T8RIN/ImageToolbox)
    - 🖼️ Image Toolbox is a powerful app for advanced image manipulation. It offers dozens of features, from basic tools like crop and draw to filters, OCR, and a wide range of image processing options
    - language: **Kotlin** &nbsp;&nbsp; stars: **5,238** &nbsp;&nbsp; folks: **238**  &nbsp;&nbsp; `89 stars today`
...
1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **65,228** &nbsp;&nbsp; folks: **9,564**  &nbsp;&nbsp; `3,862 stars this week`

1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding.
    - language: **Python** &nbsp;&nbsp; stars: **34,214** &nbsp;&nbsp; folks: **3,085**  &nbsp;&nbsp; `3,126 stars this week`

1. [lobehub / lobe-chat](https://github.com/lobehub/lobe-chat)
    - 🤯 Lobe Chat - an open-source, modern-design AI chat framework. Supports Multi AI Providers( OpenAI / Claude 3 / Gemini / Ollama / Qwen / DeepSeek), Knowledge Base (file upload / knowledge management / RAG ), Multi-Modals (Vision/TTS/Plugins/Artifacts). One-click FREE deployment of your private ChatGPT/ Claude application.
    - language: **TypeScript** &nbsp;&nbsp; stars: **54,773** &nbsp;&nbsp; folks: **11,757**  &nbsp;&nbsp; `2,113 stars this week`
...
1. [zhayujie / chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **34,121** &nbsp;&nbsp; folks: **8,741**  &nbsp;&nbsp; `1,088 stars this week`

1. [unslothai / unsloth](https://github.com/unslothai/unsloth)
    - Finetune Llama 3.3, DeepSeek-R1 & Reasoning LLMs 2x faster with 70% less memory
    - language: **Python** &nbsp;&nbsp; stars: **26,743** &nbsp;&nbsp; folks: **1,779**  &nbsp;&nbsp; `2,886 stars this week`

1. [volcengine / verl](https://github.com/volcengine/verl)
    - veRL: Volcano Engine Reinforcement Learning for LLM
    - language: **Python** &nbsp;&nbsp; stars: **2,795** &nbsp;&nbsp; folks: **231**  &nbsp;&nbsp; `780 stars this week`

1. [mendableai / firecrawl](https://github.com/mendableai/firecrawl)
    - 🔥 Turn entire websites into LLM-ready markdown or structured data. Scrape, crawl and extract with a single API.
    - language: **TypeScript** &nbsp;&nbsp; stars: **24,883** &nbsp;&nbsp; folks: **2,024**  &nbsp;&nbsp; `1,337 stars this week`
...
1. [n4ze3m / page-assist](https://github.com/n4ze3m/page-assist)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,898** &nbsp;&nbsp; folks: **333**  &nbsp;&nbsp; `1,131 stars this week`

1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **124,114** &nbsp;&nbsp; folks: **9,993**  &nbsp;&nbsp; `5,838 stars this week`
...
1. [streamlit / streamlit](https://github.com/streamlit/streamlit)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **37,295** &nbsp;&nbsp; folks: **3,220**  &nbsp;&nbsp; `232 stars this week`
...
1. [deepseek-ai / DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **18,860** &nbsp;&nbsp; folks: **2,086**  &nbsp;&nbsp; `8,868 stars this month`

1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **124,114** &nbsp;&nbsp; folks: **9,993**  &nbsp;&nbsp; `17,406 stars this month`
...
1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **71,773** &nbsp;&nbsp; folks: **8,477**  &nbsp;&nbsp; `16,256 stars this month`

1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    - Make websites accessible for AI agents
    - language: **Python** &nbsp;&nbsp; stars: **26,723** &nbsp;&nbsp; folks: **2,663**  &nbsp;&nbsp; `13,987 stars this month`

1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **46,026** &nbsp;&nbsp; folks: **4,891**  &nbsp;&nbsp; `5,132 stars this month`

1. [TabbyML / tabby](https://github.com/TabbyML/tabby)
    - Self-hosted AI coding assistant
    - language: **Rust** &nbsp;&nbsp; stars: **29,697** &nbsp;&nbsp; folks: **1,353**  &nbsp;&nbsp; `7,318 stars this month`
...
1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,302** &nbsp;&nbsp; folks: **399**  &nbsp;&nbsp; `2,919 stars this month`
...
1. [Mintplex-Labs / anything-llm](https://github.com/Mintplex-Labs/anything-llm)
    - The all-in-one Desktop & Docker AI application with built-in RAG, AI agents, and more.
    - language: **JavaScript** &nbsp;&nbsp; stars: **35,537** &nbsp;&nbsp; folks: **3,451**  &nbsp;&nbsp; `5,538 stars this month`

1. [Bin-Huang / chatbox](https://github.com/Bin-Huang/chatbox)
    - User-friendly Desktop Client App for AI Models/LLMs (GPT, Claude, Gemini, Ollama...)
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,529** &nbsp;&nbsp; folks: **2,823**  &nbsp;&nbsp; `4,869 stars this month`
