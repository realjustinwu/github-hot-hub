...
1. [codexu / note-gen](https://github.com/codexu/note-gen)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,460** &nbsp;&nbsp; folks: **223**  &nbsp;&nbsp; `335 stars today`

1. [scrapy / scrapy](https://github.com/scrapy/scrapy)
    - Scrapy, a fast high-level web crawling & scraping framework for Python.
    - language: **Python** &nbsp;&nbsp; stars: **56,347** &nbsp;&nbsp; folks: **10,892**  &nbsp;&nbsp; `315 stars today`
...
1. [deepsense-ai / ragbits](https://github.com/deepsense-ai/ragbits)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **954** &nbsp;&nbsp; folks: **73**  &nbsp;&nbsp; `233 stars today`

1. [stanfordnlp / dspy](https://github.com/stanfordnlp/dspy)
    - DSPy: The framework for programming—not prompting—language models
    - language: **Python** &nbsp;&nbsp; stars: **24,938** &nbsp;&nbsp; folks: **1,936**  &nbsp;&nbsp; `149 stars today`
...
1. [Daymychen / art-design-pro](https://github.com/Daymychen/art-design-pro)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **1,714** &nbsp;&nbsp; folks: **300**  &nbsp;&nbsp; `45 stars today`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **101,544** &nbsp;&nbsp; folks: **15,277**  &nbsp;&nbsp; `420 stars today`

1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **无** &nbsp;&nbsp; stars: **54,699** &nbsp;&nbsp; folks: **5,830**  &nbsp;&nbsp; `205 stars today`

1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    - A collective list of free APIs
    - language: **Python** &nbsp;&nbsp; stars: **349,691** &nbsp;&nbsp; folks: **36,772**  &nbsp;&nbsp; `231 stars today`

1. [langchain4j / langchain4j](https://github.com/langchain4j/langchain4j)
    - Java version of LangChain
    - language: **Java** &nbsp;&nbsp; stars: **7,829** &nbsp;&nbsp; folks: **1,441**  &nbsp;&nbsp; `16 stars today`

1. [iib0011 / omni-tools](https://github.com/iib0011/omni-tools)
    - Self-hosted collection of powerful web-based tools for everyday tasks. No ads, no tracking, just fast, accessible utilities right from your browser!
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,517** &nbsp;&nbsp; folks: **102**  &nbsp;&nbsp; `326 stars today`
...
1. [alphacep / vosk-api](https://github.com/alphacep/vosk-api)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **9,897** &nbsp;&nbsp; folks: **1,304**  &nbsp;&nbsp; `30 stars today`
...
1. [anthropics / prompt-eng-interactive-tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **10,845** &nbsp;&nbsp; folks: **993**  &nbsp;&nbsp; `5,108 stars this week`
...
1. [gitroomhq / postiz-app](https://github.com/gitroomhq/postiz-app)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,231** &nbsp;&nbsp; folks: **3,322**  &nbsp;&nbsp; `1,230 stars this week`
...
1. [Fosowl / agenticSeek](https://github.com/Fosowl/agenticSeek)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,180** &nbsp;&nbsp; folks: **1,613**  &nbsp;&nbsp; `3,487 stars this week`

1. [imputnet / cobalt](https://github.com/imputnet/cobalt)
    - best way to save what you love
    - language: **Svelte** &nbsp;&nbsp; stars: **33,755** &nbsp;&nbsp; folks: **2,798**  &nbsp;&nbsp; `1,214 stars this week`

1. [netbirdio / netbird](https://github.com/netbirdio/netbird)
    - Connect your devices into a secure WireGuard®-based overlay network with SSO, MFA and granular access controls.
    - language: **Go** &nbsp;&nbsp; stars: **14,898** &nbsp;&nbsp; folks: **704**  &nbsp;&nbsp; `647 stars this week`
...
1. [datawhalechina / self-llm](https://github.com/datawhalechina/self-llm)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,355** &nbsp;&nbsp; folks: **1,804**  &nbsp;&nbsp; `554 stars this week`

1. [scrapy / scrapy](https://github.com/scrapy/scrapy)
    - Scrapy, a fast high-level web crawling & scraping framework for Python.
    - language: **Python** &nbsp;&nbsp; stars: **56,347** &nbsp;&nbsp; folks: **10,892**  &nbsp;&nbsp; `934 stars this week`
...
1. [Fosowl / agenticSeek](https://github.com/Fosowl/agenticSeek)
    - Fully Local Manus AI. No APIs, No $200 monthly bills. Enjoy an autonomous agent that thinks, browses the web, and code for the sole cost of electricity. 🔔 Official updates only via twitter @Martin993886460. Any other account is fake.
    - language: **Python** &nbsp;&nbsp; stars: **17,180** &nbsp;&nbsp; folks: **1,613**  &nbsp;&nbsp; `15,112 stars this month`
...
1. [xming521 / WeClone](https://github.com/xming521/WeClone)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **13,189** &nbsp;&nbsp; folks: **986**  &nbsp;&nbsp; `10,202 stars this month`

1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    - 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
    - language: **Python** &nbsp;&nbsp; stars: **35,837** &nbsp;&nbsp; folks: **5,087**  &nbsp;&nbsp; `9,208 stars this month`

1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    - The Cursor for Designers • An Open-Source Visual Vibecoding Editor • Visually build, style, and edit your React App with AI
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,114** &nbsp;&nbsp; folks: **1,047**  &nbsp;&nbsp; `7,668 stars this month`

1. [mindsdb / mindsdb](https://github.com/mindsdb/mindsdb)
    - AI's query engine - Platform for building AI that can answer questions over large scale federated data. - The only MCP Server you'll ever need
    - language: **Python** &nbsp;&nbsp; stars: **31,741** &nbsp;&nbsp; folks: **5,244**  &nbsp;&nbsp; `3,949 stars this month`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **326,352** &nbsp;&nbsp; folks: **41,998**  &nbsp;&nbsp; `9,194 stars this month`
...
1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **无** &nbsp;&nbsp; stars: **54,699** &nbsp;&nbsp; folks: **5,830**  &nbsp;&nbsp; `4,696 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **11,665** &nbsp;&nbsp; folks: **646**  &nbsp;&nbsp; `3,309 stars this month`
...
1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **34,991** &nbsp;&nbsp; folks: **6,092**  &nbsp;&nbsp; `8,127 stars this month`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Build like a team of hundreds_
    - language: **TypeScript** &nbsp;&nbsp; stars: **50,989** &nbsp;&nbsp; folks: **4,468**  &nbsp;&nbsp; `2,669 stars this month`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    - A collective list of free APIs
    - language: **Python** &nbsp;&nbsp; stars: **349,691** &nbsp;&nbsp; folks: **36,772**  &nbsp;&nbsp; `11,388 stars this month`
...
1. [CopilotKit / CopilotKit](https://github.com/CopilotKit/CopilotKit)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **20,885** &nbsp;&nbsp; folks: **2,856**  &nbsp;&nbsp; `2,393 stars this month`
