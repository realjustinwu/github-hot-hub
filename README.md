...
`更新时间：2025-06-07 12:29:46 +0800`

## 今日热门仓库

1. [netbirdio / netbird](https://github.com/netbirdio/netbird)
    - Connect your devices into a secure WireGuard®-based overlay network with SSO, MFA and granular access controls.
    - language: **Go** &nbsp;&nbsp; stars: **14,748** &nbsp;&nbsp; folks: **700**  &nbsp;&nbsp; `320 stars today`
...
1. [topoteretes / cognee](https://github.com/topoteretes/cognee)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,413** &nbsp;&nbsp; folks: **290**  &nbsp;&nbsp; `590 stars today`

1. [stanfordnlp / dspy](https://github.com/stanfordnlp/dspy)
    - DSPy: The framework for programming—not prompting—language models
    - language: **Python** &nbsp;&nbsp; stars: **24,904** &nbsp;&nbsp; folks: **1,934**  &nbsp;&nbsp; `66 stars today`
...
1. [codexu / note-gen](https://github.com/codexu/note-gen)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,361** &nbsp;&nbsp; folks: **221**  &nbsp;&nbsp; `127 stars today`
...
1. [unslothai / notebooks](https://github.com/unslothai/notebooks)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **1,361** &nbsp;&nbsp; folks: **219**  &nbsp;&nbsp; `226 stars today`

1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **319,307** &nbsp;&nbsp; folks: **79,036**  &nbsp;&nbsp; `130 stars today`

1. [deepsense-ai / ragbits](https://github.com/deepsense-ai/ragbits)
    - Building blocks for rapid development of GenAI applications
    - language: **Python** &nbsp;&nbsp; stars: **896** &nbsp;&nbsp; folks: **69**  &nbsp;&nbsp; `257 stars today`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer.
    - language: **Rust** &nbsp;&nbsp; stars: **90,026** &nbsp;&nbsp; folks: **12,929**  &nbsp;&nbsp; `105 stars today`
...
1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,046** &nbsp;&nbsp; folks: **1,043**  &nbsp;&nbsp; `551 stars today`
...
1. [anthropics / prompt-eng-interactive-tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **10,708** &nbsp;&nbsp; folks: **976**  &nbsp;&nbsp; `5,108 stars this week`
...
1. [aaPanel / BillionMail](https://github.com/aaPanel/BillionMail)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **4,717** &nbsp;&nbsp; folks: **334**  &nbsp;&nbsp; `1,516 stars this week`
...
1. [datawhalechina / self-llm](https://github.com/datawhalechina/self-llm)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,322** &nbsp;&nbsp; folks: **1,798**  &nbsp;&nbsp; `554 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **11,620** &nbsp;&nbsp; folks: **645**  &nbsp;&nbsp; `882 stars this week`

1. [syncthing / syncthing](https://github.com/syncthing/syncthing)
    - Open Source Continuous File Synchronization
    - language: **Go** &nbsp;&nbsp; stars: **72,057** &nbsp;&nbsp; folks: **4,594**  &nbsp;&nbsp; `1,405 stars this week`

1. [anthropics / anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook)
    - A collection of notebooks/recipes showcasing some fun and effective ways of using Claude.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **12,978** &nbsp;&nbsp; folks: **1,510**  &nbsp;&nbsp; `371 stars this week`
...
1. [xming521 / WeClone](https://github.com/xming521/WeClone)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **13,160** &nbsp;&nbsp; folks: **983**  &nbsp;&nbsp; `10,202 stars this month`
...
1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    - The Cursor for Designers • An Open-Source Visual Vibecoding Editor • Visually build, style, and edit your React App with AI
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,046** &nbsp;&nbsp; folks: **1,043**  &nbsp;&nbsp; `7,668 stars this month`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **326,293** &nbsp;&nbsp; folks: **41,991**  &nbsp;&nbsp; `9,194 stars this month`
...
1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **无** &nbsp;&nbsp; stars: **54,623** &nbsp;&nbsp; folks: **5,824**  &nbsp;&nbsp; `4,696 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **11,620** &nbsp;&nbsp; folks: **645**  &nbsp;&nbsp; `3,309 stars this month`
...
1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **128,157** &nbsp;&nbsp; folks: **16,998**  &nbsp;&nbsp; `4,385 stars this month`
