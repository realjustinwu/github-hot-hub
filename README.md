...
`更新时间：2025-02-03 02:28:02 +0800`

## 今日热门仓库

1. [oumi-ai / oumi](https://github.com/oumi-ai/oumi)
    - Everything you need to build state-of-the-art foundation models, end-to-end.
    - language: **Python** &nbsp;&nbsp; stars: **2,141** &nbsp;&nbsp; folks: **152**  &nbsp;&nbsp; `1,229 stars today`
...
1. [QwenLM / Qwen](https://github.com/QwenLM/Qwen)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,278** &nbsp;&nbsp; folks: **1,336**  &nbsp;&nbsp; `142 stars today`
...
1. [volcengine / verl](https://github.com/volcengine/verl)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,829** &nbsp;&nbsp; folks: **143**  &nbsp;&nbsp; `121 stars today`
...
1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **65,661** &nbsp;&nbsp; folks: **7,788**  &nbsp;&nbsp; `767 stars today`

1. [QwenLM / Qwen2.5](https://github.com/QwenLM/Qwen2.5)
    - Qwen2.5 is the large language model series developed by Qwen team, Alibaba Cloud.
    - language: **Shell** &nbsp;&nbsp; stars: **14,459** &nbsp;&nbsp; folks: **960**  &nbsp;&nbsp; `181 stars today`

1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    - Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue)
    - language: **Python** &nbsp;&nbsp; stars: **67,562** &nbsp;&nbsp; folks: **8,256**  &nbsp;&nbsp; `72 stars today`
...
1. [HITsz-TMG / FilmAgent](https://github.com/HITsz-TMG/FilmAgent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **575** &nbsp;&nbsp; folks: **83**  &nbsp;&nbsp; `46 stars today`
...
1. [deepseek-ai / DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,678** &nbsp;&nbsp; folks: **1,781**  &nbsp;&nbsp; `5,300 stars this week`

1. [deepseek-ai / awesome-deepseek-integration](https://github.com/deepseek-ai/awesome-deepseek-integration)
    - 无
    - language: **无** &nbsp;&nbsp; stars: **6,436** &nbsp;&nbsp; folks: **796**  &nbsp;&nbsp; `3,780 stars this week`
...
1. [ollama / ollama](https://github.com/ollama/ollama)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **117,668** &nbsp;&nbsp; folks: **9,387**  &nbsp;&nbsp; `6,807 stars this week`
...
1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **65,661** &nbsp;&nbsp; folks: **7,788**  &nbsp;&nbsp; `5,418 stars this week`
...
1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,440** &nbsp;&nbsp; folks: **352**  &nbsp;&nbsp; `1,714 stars this week`

1. [ggerganov / llama.cpp](https://github.com/ggerganov/llama.cpp)
    - LLM inference in C/C++
    - language: **C++** &nbsp;&nbsp; stars: **72,718** &nbsp;&nbsp; folks: **10,476**  &nbsp;&nbsp; `1,300 stars this week`

1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    - Make websites accessible for AI agents
    - language: **Python** &nbsp;&nbsp; stars: **23,049** &nbsp;&nbsp; folks: **2,266**  &nbsp;&nbsp; `5,057 stars this week`
...
1. [QwenLM / Qwen2.5](https://github.com/QwenLM/Qwen2.5)
    - Qwen2.5 is the large language model series developed by Qwen team, Alibaba Cloud.
    - language: **Shell** &nbsp;&nbsp; stars: **14,459** &nbsp;&nbsp; folks: **960**  &nbsp;&nbsp; `2,354 stars this week`
...
1. [deepseek-ai / DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
    - DeepSeek Coder: Let the Code Write Itself
    - language: **Python** &nbsp;&nbsp; stars: **16,678** &nbsp;&nbsp; folks: **1,781**  &nbsp;&nbsp; `8,843 stars this month`

1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    - Make websites accessible for AI agents
    - language: **Python** &nbsp;&nbsp; stars: **23,049** &nbsp;&nbsp; folks: **2,266**  &nbsp;&nbsp; `14,326 stars this month`

1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    - 🚀🤖 Crawl4AI: Open-source LLM Friendly Web Crawler & Scraper
    - language: **Python** &nbsp;&nbsp; stars: **28,340** &nbsp;&nbsp; folks: **2,244**  &nbsp;&nbsp; `9,400 stars this month`
...
1. [zaidmukaddam / scira](https://github.com/zaidmukaddam/scira)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,458** &nbsp;&nbsp; folks: **512**  &nbsp;&nbsp; `3,273 stars this month`
...
1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **117,668** &nbsp;&nbsp; folks: **9,387**  &nbsp;&nbsp; `11,962 stars this month`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **65,661** &nbsp;&nbsp; folks: **7,788**  &nbsp;&nbsp; `11,024 stars this month`
...
1. [TabbyML / tabby](https://github.com/TabbyML/tabby)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **29,338** &nbsp;&nbsp; folks: **1,337**  &nbsp;&nbsp; `7,045 stars this month`
...
1. [PatrickJS / awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules)
    ...
    - language: **无** &nbsp;&nbsp; stars: **8,924** &nbsp;&nbsp; folks: **586**  &nbsp;&nbsp; `4,158 stars this month`

1. [cline / cline](https://github.com/cline/cline)
    - Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way.
    - language: **TypeScript** &nbsp;&nbsp; stars: **26,599** &nbsp;&nbsp; folks: **2,439**  &nbsp;&nbsp; `8,491 stars this month`

1. [ggerganov / llama.cpp](https://github.com/ggerganov/llama.cpp)
    - LLM inference in C/C++
    - language: **C++** &nbsp;&nbsp; stars: **72,718** &nbsp;&nbsp; folks: **10,476**  &nbsp;&nbsp; `2,854 stars this month`
...
1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    - The open source Cursor for Designers. Design directly in your live React app and publish your changes to code.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,440** &nbsp;&nbsp; folks: **352**  &nbsp;&nbsp; `2,160 stars this month`
