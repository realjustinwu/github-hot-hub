...
1. [x1xhlol / system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools)
    ...
    - language: **无** &nbsp;&nbsp; stars: **75,436** &nbsp;&nbsp; folks: **21,221**  &nbsp;&nbsp; `408 stars today`
...
1. [ChrisTitusTech / linutil](https://github.com/ChrisTitusTech/linutil)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **3,985** &nbsp;&nbsp; folks: **320**  &nbsp;&nbsp; `69 stars today`

1. [actions / checkout](https://github.com/actions/checkout)
    - Action for checking out a repo
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,831** &nbsp;&nbsp; folks: **2,100**  &nbsp;&nbsp; `10 stars today`

1. [FiloSottile / mkcert](https://github.com/FiloSottile/mkcert)
    - A simple zero-config tool to make locally trusted development certificates with any names you'd like.
    - language: **Go** &nbsp;&nbsp; stars: **55,374** &nbsp;&nbsp; folks: **2,904**  &nbsp;&nbsp; `112 stars today`
...
1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **13,740** &nbsp;&nbsp; folks: **1,485**  &nbsp;&nbsp; `3,569 stars this week`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **34,634** &nbsp;&nbsp; folks: **3,956**  &nbsp;&nbsp; `2,518 stars this week`
...
1. [openai / openai-cookbook](https://github.com/openai/openai-cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **66,958** &nbsp;&nbsp; folks: **11,095**  &nbsp;&nbsp; `1,168 stars this week`
...
1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **54,981** &nbsp;&nbsp; folks: **9,321**  &nbsp;&nbsp; `969 stars this week`

1. [umami-software / umami](https://github.com/umami-software/umami)
    - Umami is a modern, privacy-focused alternative to Google Analytics.
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,542** &nbsp;&nbsp; folks: **5,360**  &nbsp;&nbsp; `1,662 stars this week`
...
1. [actualbudget / actual](https://github.com/actualbudget/actual)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,554** &nbsp;&nbsp; folks: **1,730**  &nbsp;&nbsp; `808 stars this week`
...
1. [patchy631 / ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,915** &nbsp;&nbsp; folks: **2,849**  &nbsp;&nbsp; `1,113 stars this week`

1. [openai / openai-go](https://github.com/openai/openai-go)
    - The official Go library for the OpenAI API
    - language: **Go** &nbsp;&nbsp; stars: **2,207** &nbsp;&nbsp; folks: **187**  &nbsp;&nbsp; `63 stars this week`
...
1. [OpenPipe / ART](https://github.com/OpenPipe/ART)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,507** &nbsp;&nbsp; folks: **348**  &nbsp;&nbsp; `4,562 stars this month`
...
1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    - A high-performance algorithmic trading platform and event-driven backtester
    - language: **Rust** &nbsp;&nbsp; stars: **13,740** &nbsp;&nbsp; folks: **1,485**  &nbsp;&nbsp; `3,993 stars this month`
...
1. [sst / opencode](https://github.com/sst/opencode)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **19,107** &nbsp;&nbsp; folks: **1,209**  &nbsp;&nbsp; `7,502 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,407** &nbsp;&nbsp; folks: **1,677**  &nbsp;&nbsp; `10,554 stars this month`
