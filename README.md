...
`更新时间：2024-11-30 01:20:10 +0800`

## 今日热门仓库

1. [andrewyng / aisuite](https://github.com/andrewyng/aisuite)
    - Simple, unified interface to multiple Generative AI providers
    - language: **Python** &nbsp;&nbsp; stars: **4,807** &nbsp;&nbsp; folks: **411**  &nbsp;&nbsp; `778 stars today`
...
1. [hengyoush / kyanos](https://github.com/hengyoush/kyanos)
    ...
    - language: **C** &nbsp;&nbsp; stars: **1,580** &nbsp;&nbsp; folks: **32**  &nbsp;&nbsp; `236 stars today`
...
1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    ...
    - language: **Markdown** &nbsp;&nbsp; stars: **313,798** &nbsp;&nbsp; folks: **29,143**  &nbsp;&nbsp; `249 stars today`
...
1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **50,065** &nbsp;&nbsp; folks: **8,114**  &nbsp;&nbsp; `117 stars today`
...
1. [keephq / keep](https://github.com/keephq/keep)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,268** &nbsp;&nbsp; folks: **710**  &nbsp;&nbsp; `73 stars today`

1. [typeorm / typeorm](https://github.com/typeorm/typeorm)
    - ORM for TypeScript and JavaScript. Supports MySQL, PostgreSQL, MariaDB, SQLite, MS SQL Server, Oracle, SAP Hana, WebSQL databases. Works in NodeJS, Browser, Ionic, Cordova and Electron platforms.
    - language: **TypeScript** &nbsp;&nbsp; stars: **34,429** &nbsp;&nbsp; folks: **6,334**  &nbsp;&nbsp; `120 stars today`

1. [cypress-io / cypress](https://github.com/cypress-io/cypress)
    - Fast, easy and reliable testing for anything that runs in a browser.
    - language: **JavaScript** &nbsp;&nbsp; stars: **47,435** &nbsp;&nbsp; folks: **3,198**  &nbsp;&nbsp; `147 stars today`
...
1. [yamadashy / repomix](https://github.com/yamadashy/repomix)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,592** &nbsp;&nbsp; folks: **216**  &nbsp;&nbsp; `94 stars today`
...
1. [bluesky-social / social-app](https://github.com/bluesky-social/social-app)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,155** &nbsp;&nbsp; folks: **1,685**  &nbsp;&nbsp; `1,350 stars this week`

1. [Melkeydev / go-blueprint](https://github.com/Melkeydev/go-blueprint)
    - Go-blueprint allows users to spin up a quick Go project using a popular framework
    - language: **Go** &nbsp;&nbsp; stars: **5,800** &nbsp;&nbsp; folks: **333**  &nbsp;&nbsp; `831 stars this week`
...
1. [koodo-reader / koodo-reader](https://github.com/koodo-reader/koodo-reader)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,418** &nbsp;&nbsp; folks: **1,497**  &nbsp;&nbsp; `514 stars this week`
...
1. [payloadcms / payload](https://github.com/payloadcms/payload)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **28,788** &nbsp;&nbsp; folks: **1,783**  &nbsp;&nbsp; `1,227 stars this week`
...
1. [ai16z / eliza](https://github.com/ai16z/eliza)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,364** &nbsp;&nbsp; folks: **666**  &nbsp;&nbsp; `2,141 stars this month`
...
1. [opendatalab / MinerU](https://github.com/opendatalab/MinerU)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **18,940** &nbsp;&nbsp; folks: **1,348**  &nbsp;&nbsp; `5,503 stars this month`
...
1. [freqtrade / freqtrade](https://github.com/freqtrade/freqtrade)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **31,531** &nbsp;&nbsp; folks: **6,402**  &nbsp;&nbsp; `2,971 stars this month`
...
1. [payloadcms / payload](https://github.com/payloadcms/payload)
    - Payload is the open-source, fullstack Next.js framework, giving you instant backend superpowers. Get a full TypeScript backend and admin panel instantly. Use Payload as a headless CMS or for building powerful applications.
    - language: **TypeScript** &nbsp;&nbsp; stars: **28,788** &nbsp;&nbsp; folks: **1,783**  &nbsp;&nbsp; `4,018 stars this month`
...
1. [bluesky-social / social-app](https://github.com/bluesky-social/social-app)
    - The Bluesky Social application for Web, iOS, and Android
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,155** &nbsp;&nbsp; folks: **1,685**  &nbsp;&nbsp; `3,714 stars this month`
...
1. [yamadashy / repomix](https://github.com/yamadashy/repomix)
    - 📦 Repomix (formerly Repopack) is a powerful tool that packs your entire repository into a single, AI-friendly file. Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools like Claude, ChatGPT, and Gemini.
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,592** &nbsp;&nbsp; folks: **216**  &nbsp;&nbsp; `2,433 stars this month`
