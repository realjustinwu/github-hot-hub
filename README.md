...
1. [Infisical / infisical](https://github.com/Infisical/infisical)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,987** &nbsp;&nbsp; folks: **1,268**  &nbsp;&nbsp; `16 stars today`

1. [confident-ai / deepeval](https://github.com/confident-ai/deepeval)
    - The LLM Evaluation Framework
    - language: **Python** &nbsp;&nbsp; stars: **9,444** &nbsp;&nbsp; folks: **826**  &nbsp;&nbsp; `25 stars today`
...
1. [goldbergyoni / nodebestpractices](https://github.com/goldbergyoni/nodebestpractices)
    ...
    - language: **Dockerfile** &nbsp;&nbsp; stars: **103,512** &nbsp;&nbsp; folks: **10,519**  &nbsp;&nbsp; `18 stars today`
...
1. [Raphire / Win11Debloat](https://github.com/Raphire/Win11Debloat)
    ...
    - language: **PowerShell** &nbsp;&nbsp; stars: **23,028** &nbsp;&nbsp; folks: **956**  &nbsp;&nbsp; `254 stars today`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **46,273** &nbsp;&nbsp; folks: **4,194**  &nbsp;&nbsp; `2,807 stars this week`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **6,312** &nbsp;&nbsp; folks: **850**  &nbsp;&nbsp; `1,340 stars this week`
...
1. [frappe / hrms](https://github.com/frappe/hrms)
    - Open Source HR and Payroll Software
    - language: **Python** &nbsp;&nbsp; stars: **4,459** &nbsp;&nbsp; folks: **1,372**  &nbsp;&nbsp; `1,151 stars this week`
...
1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **32,594** &nbsp;&nbsp; folks: **9,575**  &nbsp;&nbsp; `1,616 stars this week`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **6,709** &nbsp;&nbsp; folks: **339**  &nbsp;&nbsp; `2,300 stars this week`
...
1. [hummingbot / hummingbot](https://github.com/hummingbot/hummingbot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **13,629** &nbsp;&nbsp; folks: **3,733**  &nbsp;&nbsp; `332 stars this week`
...
1. [getzep / graphiti](https://github.com/getzep/graphiti)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,138** &nbsp;&nbsp; folks: **1,283**  &nbsp;&nbsp; `967 stars this week`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,818** &nbsp;&nbsp; folks: **7,990**  &nbsp;&nbsp; `10,134 stars this month`
...
1. [google-gemini / gemini-cli](https://github.com/google-gemini/gemini-cli)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **64,270** &nbsp;&nbsp; folks: **6,088**  &nbsp;&nbsp; `60,367 stars this month`

1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    - MCP Toolbox for Databases is an open source MCP server for databases.
    - language: **Go** &nbsp;&nbsp; stars: **7,893** &nbsp;&nbsp; folks: **582**  &nbsp;&nbsp; `6,314 stars this month`

1. [humanlayer / 12-factor-agents](https://github.com/humanlayer/12-factor-agents)
    - What are the principles we can use to build LLM-powered software that is actually good enough to put in the hands of production customers?
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,328** &nbsp;&nbsp; folks: **672**  &nbsp;&nbsp; `5,763 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **6,709** &nbsp;&nbsp; folks: **339**  &nbsp;&nbsp; `5,278 stars this month`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **46,273** &nbsp;&nbsp; folks: **4,194**  &nbsp;&nbsp; `3,983 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **26,100** &nbsp;&nbsp; folks: **1,432**  &nbsp;&nbsp; `10,913 stars this month`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,604** &nbsp;&nbsp; folks: **473**  &nbsp;&nbsp; `4,199 stars this month`
...
1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **75,582** &nbsp;&nbsp; folks: **16,710**  &nbsp;&nbsp; `2,808 stars this month`
