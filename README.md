...
1. [kestra-io / kestra](https://github.com/kestra-io/kestra)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **20,885** &nbsp;&nbsp; folks: **1,776**  &nbsp;&nbsp; `41 stars today`

1. [AI4Finance-Foundation / FinGPT](https://github.com/AI4Finance-Foundation/FinGPT)
    - FinGPT: Open-Source Financial Large Language Models! Revolutionize 🔥 We release the trained model on HuggingFace.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **17,381** &nbsp;&nbsp; folks: **2,473**  &nbsp;&nbsp; `80 stars today`

1. [TapXWorld / ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook)
    - 所有小初高、大学PDF教材。
    - language: **Roff** &nbsp;&nbsp; stars: **48,512** &nbsp;&nbsp; folks: **10,877**  &nbsp;&nbsp; `66 stars today`

1. [apache / airflow](https://github.com/apache/airflow)
    - Apache Airflow - A platform to programmatically author, schedule, and monitor workflows
    - language: **Python** &nbsp;&nbsp; stars: **42,039** &nbsp;&nbsp; folks: **15,530**  &nbsp;&nbsp; `40 stars today`
...
1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    - Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,413** &nbsp;&nbsp; folks: **567**  &nbsp;&nbsp; `2,346 stars this week`
...
1. [gristlabs / grist-core](https://github.com/gristlabs/grist-core)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,370** &nbsp;&nbsp; folks: **456**  &nbsp;&nbsp; `404 stars this week`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,640** &nbsp;&nbsp; folks: **2,014**  &nbsp;&nbsp; `6,466 stars this month`

1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    - Collection of extracted System Prompts from popular chatbots like ChatGPT, Claude & Gemini
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,092** &nbsp;&nbsp; folks: **3,044**  &nbsp;&nbsp; `10,962 stars this month`
...
1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **8,815** &nbsp;&nbsp; folks: **266**  &nbsp;&nbsp; `5,468 stars this month`

1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Open-source platform to build and deploy AI agent workflows.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,227** &nbsp;&nbsp; folks: **1,732**  &nbsp;&nbsp; `7,824 stars this month`

1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **38,907** &nbsp;&nbsp; folks: **4,494**  &nbsp;&nbsp; `7,190 stars this month`

1. [basecamp / omarchy](https://github.com/basecamp/omarchy)
    - Opinionated Arch/Hyprland Setup
    - language: **Shell** &nbsp;&nbsp; stars: **6,971** &nbsp;&nbsp; folks: **843**  &nbsp;&nbsp; `4,037 stars this month`
...
1. [oraios / serena](https://github.com/oraios/serena)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,583** &nbsp;&nbsp; folks: **804**  &nbsp;&nbsp; `4,149 stars this month`
