...
`更新时间：2025-01-18 23:20:00 +0800`

## 今日热门仓库

1. [OpenBMB / MiniCPM-o](https://github.com/OpenBMB/MiniCPM-o)
    - MiniCPM-o 2.6: A GPT-4o Level MLLM for Vision, Speech and Multimodal Live Streaming on Your Phone
    - language: **Python** &nbsp;&nbsp; stars: **15,412** &nbsp;&nbsp; folks: **1,118**  &nbsp;&nbsp; `963 stars today`

1. [facebook / folly](https://github.com/facebook/folly)
    - An open-source C++ library developed and used at Facebook.
    - language: **C++** &nbsp;&nbsp; stars: **28,838** &nbsp;&nbsp; folks: **5,626**  &nbsp;&nbsp; `55 stars today`

1. [unionlabs / union](https://github.com/unionlabs/union)
    - The trust-minimized, zero-knowledge bridging protocol, designed for censorship resistance, extremely high security, and usage in decentralized finance.
    - language: **Rust** &nbsp;&nbsp; stars: **12,202** &nbsp;&nbsp; folks: **765**  &nbsp;&nbsp; `4,057 stars today`
...
1. [TabbyML / tabby](https://github.com/TabbyML/tabby)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **28,263** &nbsp;&nbsp; folks: **1,288**  &nbsp;&nbsp; `5,565 stars this week`

1. [KoljaB / RealtimeSTT](https://github.com/KoljaB/RealtimeSTT)
    - A robust, efficient, low-latency speech-to-text library with advanced voice activity detection, wake word activation and instant transcription.
    - language: **Python** &nbsp;&nbsp; stars: **3,895** &nbsp;&nbsp; folks: **336**  &nbsp;&nbsp; `1,236 stars this week`

1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    - 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
    - language: **Python** &nbsp;&nbsp; stars: **20,501** &nbsp;&nbsp; folks: **3,110**  &nbsp;&nbsp; `1,129 stars this week`
...
1. [Canner / WrenAI](https://github.com/Canner/WrenAI)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,538** &nbsp;&nbsp; folks: **380**  &nbsp;&nbsp; `1,337 stars this week`
...
1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **25,701** &nbsp;&nbsp; folks: **1,974**  &nbsp;&nbsp; `1,731 stars this week`

1. [mufeedvh / code2prompt](https://github.com/mufeedvh/code2prompt)
    - A CLI tool to convert your codebase into a single LLM prompt with source tree, prompt templating, and token counting.
    - language: **Rust** &nbsp;&nbsp; stars: **3,605** &nbsp;&nbsp; folks: **217**  &nbsp;&nbsp; `924 stars this week`

1. [fixie-ai / ultravox](https://github.com/fixie-ai/ultravox)
    - A fast multimodal LLM for real-time voice
    - language: **Python** &nbsp;&nbsp; stars: **2,846** &nbsp;&nbsp; folks: **177**  &nbsp;&nbsp; `1,038 stars this week`
...
1. [NVIDIA / nv-ingest](https://github.com/NVIDIA/nv-ingest)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,178** &nbsp;&nbsp; folks: **181**  &nbsp;&nbsp; `1,228 stars this week`

1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
    - language: **TypeScript** &nbsp;&nbsp; stars: **306,176** &nbsp;&nbsp; folks: **40,079**  &nbsp;&nbsp; `1,787 stars this week`

1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **42,146** &nbsp;&nbsp; folks: **4,525**  &nbsp;&nbsp; `959 stars this week`
...
1. [stanford-oval / storm](https://github.com/stanford-oval/storm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **20,353** &nbsp;&nbsp; folks: **1,791**  &nbsp;&nbsp; `6,706 stars this month`

1. [khoj-ai / khoj](https://github.com/khoj-ai/khoj)
    - Your AI second brain. Self-hostable. Get answers from the web or your docs. Build custom agents, schedule automations, do deep research. Turn any online or local LLM into your personal, autonomous AI (gpt, claude, gemini, llama, qwen, mistral). Get started - free.
    - language: **Python** &nbsp;&nbsp; stars: **24,869** &nbsp;&nbsp; folks: **1,328**  &nbsp;&nbsp; `7,699 stars this month`

1. [elizaOS / eliza](https://github.com/elizaOS/eliza)
    - Autonomous agents for everyone
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,080** &nbsp;&nbsp; folks: **3,432**  &nbsp;&nbsp; `7,199 stars this month`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **12,765** &nbsp;&nbsp; folks: **1,375**  &nbsp;&nbsp; `5,966 stars this month`

1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    - 🚀🤖 Crawl4AI: Open-source LLM Friendly Web Crawler & Scraper
    - language: **Python** &nbsp;&nbsp; stars: **25,701** &nbsp;&nbsp; folks: **1,974**  &nbsp;&nbsp; `7,083 stars this month`
...
1. [TabbyML / tabby](https://github.com/TabbyML/tabby)
    - Self-hosted AI coding assistant
    - language: **Rust** &nbsp;&nbsp; stars: **28,263** &nbsp;&nbsp; folks: **1,288**  &nbsp;&nbsp; `5,924 stars this month`

1. [NVIDIA / nv-ingest](https://github.com/NVIDIA/nv-ingest)
    - NVIDIA Ingest is an early access set of microservices for parsing hundreds of thousands of complex, messy unstructured PDFs and other enterprise documents into metadata and text to embed into retrieval systems.
    - language: **Python** &nbsp;&nbsp; stars: **2,178** &nbsp;&nbsp; folks: **181**  &nbsp;&nbsp; `1,967 stars this month`
...
1. [OpenBMB / MiniCPM-o](https://github.com/OpenBMB/MiniCPM-o)
    - MiniCPM-o 2.6: A GPT-4o Level MLLM for Vision, Speech and Multimodal Live Streaming on Your Phone
    - language: **Python** &nbsp;&nbsp; stars: **15,412** &nbsp;&nbsp; folks: **1,118**  &nbsp;&nbsp; `1,890 stars this month`
...
1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **55,327** &nbsp;&nbsp; folks: **10,184**  &nbsp;&nbsp; `3,691 stars this month`

1. [All-Hands-AI / OpenHands](https://github.com/All-Hands-AI/OpenHands)
    - 🙌 OpenHands: Code Less, Make More
    - language: **Python** &nbsp;&nbsp; stars: **43,798** &nbsp;&nbsp; folks: **4,852**  &nbsp;&nbsp; `5,251 stars this month`
