...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,070** &nbsp;&nbsp; folks: **1,061**  &nbsp;&nbsp; `334 stars today`

1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **3,377** &nbsp;&nbsp; folks: **236**  &nbsp;&nbsp; `387 stars today`
...
1. [bitwarden / clients](https://github.com/bitwarden/clients)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,684** &nbsp;&nbsp; folks: **1,449**  &nbsp;&nbsp; `9 stars today`

1. [Leantime / leantime](https://github.com/Leantime/leantime)
    - Leantime is a goals focused project management system for non-project managers. Building with ADHD, Autism, and dyslexia in mind.
    - language: **PHP** &nbsp;&nbsp; stars: **5,929** &nbsp;&nbsp; folks: **677**  &nbsp;&nbsp; `111 stars today`
...
1. [n8n-io / self-hosted-ai-starter-kit](https://github.com/n8n-io/self-hosted-ai-starter-kit)
    ...
    - language: **无** &nbsp;&nbsp; stars: **11,581** &nbsp;&nbsp; folks: **2,825**  &nbsp;&nbsp; `157 stars today`
...
1. [epicenter-so / epicenter](https://github.com/epicenter-so/epicenter)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,288** &nbsp;&nbsp; folks: **139**  &nbsp;&nbsp; `298 stars today`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **5,070** &nbsp;&nbsp; folks: **204**  &nbsp;&nbsp; `342 stars today`

1. [microsoft / BitNet](https://github.com/microsoft/BitNet)
    - Official inference framework for 1-bit LLMs
    - language: **Python** &nbsp;&nbsp; stars: **20,824** &nbsp;&nbsp; folks: **1,574**  &nbsp;&nbsp; `41 stars today`
...
1. [ubicloud / ubicloud](https://github.com/ubicloud/ubicloud)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **9,938** &nbsp;&nbsp; folks: **432**  &nbsp;&nbsp; `3,705 stars this week`

1. [microsoft / poml](https://github.com/microsoft/poml)
    - Prompt Orchestration Markup Language
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,508** &nbsp;&nbsp; folks: **157**  &nbsp;&nbsp; `2,668 stars this week`

1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **3,026** &nbsp;&nbsp; folks: **297**  &nbsp;&nbsp; `1,346 stars this week`
...
1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **5,070** &nbsp;&nbsp; folks: **204**  &nbsp;&nbsp; `1,675 stars this week`

1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    - Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!
    - language: **Python** &nbsp;&nbsp; stars: **9,303** &nbsp;&nbsp; folks: **719**  &nbsp;&nbsp; `1,456 stars this week`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **60,574** &nbsp;&nbsp; folks: **7,277**  &nbsp;&nbsp; `3,072 stars this week`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **3,377** &nbsp;&nbsp; folks: **236**  &nbsp;&nbsp; `691 stars this week`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,921** &nbsp;&nbsp; folks: **1,709**  &nbsp;&nbsp; `4,413 stars this month`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,483** &nbsp;&nbsp; folks: **1,299**  &nbsp;&nbsp; `11,437 stars this month`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Financial data platform for analysts, quants and AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **50,691** &nbsp;&nbsp; folks: **4,744**  &nbsp;&nbsp; `7,393 stars this month`

1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    - Improve your resumes with Resume Matcher. Get insights, keyword suggestions and tune your resumes to job descriptions.
    - language: **Python** &nbsp;&nbsp; stars: **22,704** &nbsp;&nbsp; folks: **4,355**  &nbsp;&nbsp; `13,539 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,238** &nbsp;&nbsp; folks: **1,055**  &nbsp;&nbsp; `8,128 stars this month`

1. [frappe / hrms](https://github.com/frappe/hrms)
    - Open Source HR and Payroll Software
    - language: **Python** &nbsp;&nbsp; stars: **6,410** &nbsp;&nbsp; folks: **1,572**  &nbsp;&nbsp; `3,624 stars this month`

1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    - A high-performance algorithmic trading platform and event-driven backtester
    - language: **Rust** &nbsp;&nbsp; stars: **14,258** &nbsp;&nbsp; folks: **1,534**  &nbsp;&nbsp; `4,496 stars this month`

1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **3,026** &nbsp;&nbsp; folks: **297**  &nbsp;&nbsp; `1,782 stars this month`
...
1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **8,139** &nbsp;&nbsp; folks: **1,076**  &nbsp;&nbsp; `2,942 stars this month`

1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **3,377** &nbsp;&nbsp; folks: **236**  &nbsp;&nbsp; `1,380 stars this month`
