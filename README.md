...
`更新时间：2025-05-05 18:27:22 +0800`

## 今日热门仓库

1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    - real time face swap and one-click video deepfake with only a single image
    - language: **Python** &nbsp;&nbsp; stars: **61,640** &nbsp;&nbsp; folks: **8,611**  &nbsp;&nbsp; `1,484 stars today`

1. [jj-vcs / jj](https://github.com/jj-vcs/jj)
    - A Git-compatible VCS that is both simple and powerful
    - language: **Rust** &nbsp;&nbsp; stars: **13,557** &nbsp;&nbsp; folks: **487**  &nbsp;&nbsp; `369 stars today`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **298,253** &nbsp;&nbsp; folks: **49,532**  &nbsp;&nbsp; `176 stars today`
...
1. [521xueweihan / HelloGitHub](https://github.com/521xueweihan/HelloGitHub)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **103,872** &nbsp;&nbsp; folks: **9,934**  &nbsp;&nbsp; `530 stars today`

1. [unionlabs / union](https://github.com/unionlabs/union)
    - The trust-minimized, zero-knowledge bridging protocol, designed for censorship resistance, extremely high security, and usage in decentralized finance.
    - language: **Rust** &nbsp;&nbsp; stars: **57,509** &nbsp;&nbsp; folks: **2,882**  &nbsp;&nbsp; `521 stars today`

1. [BasedHardware / omi](https://github.com/BasedHardware/omi)
    - AI wearables. Put it on, speak, transcribe, automatically
    - language: **C** &nbsp;&nbsp; stars: **5,667** &nbsp;&nbsp; folks: **791**  &nbsp;&nbsp; `59 stars today`
...
1. [nodejs / node](https://github.com/nodejs/node)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **111,079** &nbsp;&nbsp; folks: **31,458**  &nbsp;&nbsp; `41 stars today`
...
1. [Klipper3d / klipper](https://github.com/Klipper3d/klipper)
    ...
    - language: **C** &nbsp;&nbsp; stars: **10,272** &nbsp;&nbsp; folks: **5,527**  &nbsp;&nbsp; `22 stars today`

1. [FreeCAD / FreeCAD](https://github.com/FreeCAD/FreeCAD)
    - This is the official source code of FreeCAD, a free and opensource multiplatform 3D parametric modeler.
    - language: **C++** &nbsp;&nbsp; stars: **24,335** &nbsp;&nbsp; folks: **4,526**  &nbsp;&nbsp; `45 stars today`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **HTML** &nbsp;&nbsp; stars: **356,394** &nbsp;&nbsp; folks: **63,290**  &nbsp;&nbsp; `115 stars today`

1. [Koenkk / zigbee2mqtt](https://github.com/Koenkk/zigbee2mqtt)
    - Zigbee 🐝 to MQTT bridge 🌉, get rid of your proprietary Zigbee bridges 🔨
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,431** &nbsp;&nbsp; folks: **1,779**  &nbsp;&nbsp; `13 stars today`
...
1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    - real time face swap and one-click video deepfake with only a single image
    - language: **Python** &nbsp;&nbsp; stars: **61,640** &nbsp;&nbsp; folks: **8,611**  &nbsp;&nbsp; `9,654 stars this week`

1. [jujumilk3 / leaked-system-prompts](https://github.com/jujumilk3/leaked-system-prompts)
    - Collection of leaked system prompts
    - language: **无** &nbsp;&nbsp; stars: **6,025** &nbsp;&nbsp; folks: **673**  &nbsp;&nbsp; `1,665 stars this week`
...
1. [simular-ai / Agent-S](https://github.com/simular-ai/Agent-S)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,081** &nbsp;&nbsp; folks: **400**  &nbsp;&nbsp; `1,270 stars this week`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **23,426** &nbsp;&nbsp; folks: **2,916**  &nbsp;&nbsp; `18,219 stars this month`

1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    - real time face swap and one-click video deepfake with only a single image
    - language: **Python** &nbsp;&nbsp; stars: **61,640** &nbsp;&nbsp; folks: **8,611**  &nbsp;&nbsp; `11,054 stars this month`
...
1. [jujumilk3 / leaked-system-prompts](https://github.com/jujumilk3/leaked-system-prompts)
    - Collection of leaked system prompts
    - language: **无** &nbsp;&nbsp; stars: **6,025** &nbsp;&nbsp; folks: **673**  &nbsp;&nbsp; `3,797 stars this month`
...
1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **88,879** &nbsp;&nbsp; folks: **24,348**  &nbsp;&nbsp; `14,306 stars this month`

1. [simular-ai / Agent-S](https://github.com/simular-ai/Agent-S)
    - Agent S: an open agentic framework that uses computers like a human
    - language: **Python** &nbsp;&nbsp; stars: **4,081** &nbsp;&nbsp; folks: **400**  &nbsp;&nbsp; `2,541 stars this month`

1. [jlowin / fastmcp](https://github.com/jlowin/fastmcp)
    - 🚀 The fast, Pythonic way to build MCP servers and clients
    - language: **Python** &nbsp;&nbsp; stars: **8,588** &nbsp;&nbsp; folks: **449**  &nbsp;&nbsp; `4,849 stars this month`
...
1. [trycua / cua](https://github.com/trycua/cua)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,635** &nbsp;&nbsp; folks: **219**  &nbsp;&nbsp; `2,048 stars this month`
...
1. [mark3labs / mcp-go](https://github.com/mark3labs/mcp-go)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **4,459** &nbsp;&nbsp; folks: **361**  &nbsp;&nbsp; `2,400 stars this month`
