...
1. [zhayujie / chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,545** &nbsp;&nbsp; folks: **8,650**  &nbsp;&nbsp; `123 stars today`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **62,642** &nbsp;&nbsp; folks: **9,299**  &nbsp;&nbsp; `421 stars today`
...
1. [songquanpeng / one-api](https://github.com/songquanpeng/one-api)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **21,503** &nbsp;&nbsp; folks: **4,634**  &nbsp;&nbsp; `89 stars today`
...
1. [metabase / metabase](https://github.com/metabase/metabase)
    ...
    - language: **Clojure** &nbsp;&nbsp; stars: **40,446** &nbsp;&nbsp; folks: **5,332**  &nbsp;&nbsp; `164 stars today`

1. [assafelovic / gpt-researcher](https://github.com/assafelovic/gpt-researcher)
    - LLM based autonomous agent that conducts deep local and web research on any topic and generates a long report with citations.
    - language: **Python** &nbsp;&nbsp; stars: **17,202** &nbsp;&nbsp; folks: **2,277**  &nbsp;&nbsp; `502 stars today`

1. [ruanyf / weekly](https://github.com/ruanyf/weekly)
    - 科技爱好者周刊，每周五发布
    - language: **无** &nbsp;&nbsp; stars: **51,983** &nbsp;&nbsp; folks: **3,096**  &nbsp;&nbsp; `45 stars today`
...
1. [block / goose](https://github.com/block/goose)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **6,474** &nbsp;&nbsp; folks: **410**  &nbsp;&nbsp; `3,965 stars this week`
...
1. [ollama / ollama](https://github.com/ollama/ollama)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **121,477** &nbsp;&nbsp; folks: **9,743**  &nbsp;&nbsp; `5,951 stars this week`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **69,170** &nbsp;&nbsp; folks: **8,188**  &nbsp;&nbsp; `5,571 stars this week`

1. [volcengine / verl](https://github.com/volcengine/verl)
    - veRL: Volcano Engine Reinforcement Learning for LLM
    - language: **Python** &nbsp;&nbsp; stars: **2,444** &nbsp;&nbsp; folks: **193**  &nbsp;&nbsp; `964 stars this week`
...
1. [ocrmypdf / OCRmyPDF](https://github.com/ocrmypdf/OCRmyPDF)
    - OCRmyPDF adds an OCR text layer to scanned PDF files, allowing them to be searched
    - language: **Python** &nbsp;&nbsp; stars: **16,970** &nbsp;&nbsp; folks: **1,160**  &nbsp;&nbsp; `1,823 stars this week`

1. [n4ze3m / page-assist](https://github.com/n4ze3m/page-assist)
    - Use your locally running AI models to assist you in your web browsing
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,148** &nbsp;&nbsp; folks: **283**  &nbsp;&nbsp; `833 stars this week`
...
1. [deepseek-ai / DeepSeek-LLM](https://github.com/deepseek-ai/DeepSeek-LLM)
    ...
    - language: **Makefile** &nbsp;&nbsp; stars: **5,604** &nbsp;&nbsp; folks: **837**  &nbsp;&nbsp; `928 stars this week`

1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **22,005** &nbsp;&nbsp; folks: **1,268**  &nbsp;&nbsp; `1,109 stars this week`
...
1. [Huanshere / VideoLingo](https://github.com/Huanshere/VideoLingo)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,554** &nbsp;&nbsp; folks: **1,003**  &nbsp;&nbsp; `1,030 stars this week`

1. [deepseek-ai / DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
    - DeepSeek Coder: Let the Code Write Itself
    - language: **Python** &nbsp;&nbsp; stars: **18,131** &nbsp;&nbsp; folks: **1,998**  &nbsp;&nbsp; `2,317 stars this week`

1. [Bin-Huang / chatbox](https://github.com/Bin-Huang/chatbox)
    - User-friendly Desktop Client App for AI Models/LLMs (GPT, Claude, Gemini, Ollama...)
    - language: **TypeScript** &nbsp;&nbsp; stars: **28,185** &nbsp;&nbsp; folks: **2,723**  &nbsp;&nbsp; `1,570 stars this week`
...
1. [deepseek-ai / DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
    - DeepSeek Coder: Let the Code Write Itself
    - language: **Python** &nbsp;&nbsp; stars: **18,131** &nbsp;&nbsp; folks: **1,998**  &nbsp;&nbsp; `8,337 stars this month`

1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    - Make websites accessible for AI agents
    - language: **Python** &nbsp;&nbsp; stars: **24,801** &nbsp;&nbsp; folks: **2,472**  &nbsp;&nbsp; `14,457 stars this month`
...
1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **121,477** &nbsp;&nbsp; folks: **9,743**  &nbsp;&nbsp; `15,141 stars this month`
...
1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **69,170** &nbsp;&nbsp; folks: **8,188**  &nbsp;&nbsp; `14,019 stars this month`

1. [TabbyML / tabby](https://github.com/TabbyML/tabby)
    - Self-hosted AI coding assistant
    - language: **Rust** &nbsp;&nbsp; stars: **29,513** &nbsp;&nbsp; folks: **1,343**  &nbsp;&nbsp; `7,185 stars this month`
...
1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **29,071** &nbsp;&nbsp; folks: **2,316**  &nbsp;&nbsp; `7,823 stars this month`
...
1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,811** &nbsp;&nbsp; folks: **800**  &nbsp;&nbsp; `4,481 stars this month`
