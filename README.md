...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **46,634** &nbsp;&nbsp; folks: **4,243**  &nbsp;&nbsp; `3,213 stars this week`
...
1. [Dokploy / dokploy](https://github.com/Dokploy/dokploy)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **22,366** &nbsp;&nbsp; folks: **1,230**  &nbsp;&nbsp; `775 stars this week`
...
1. [zephyrproject-rtos / zephyr](https://github.com/zephyrproject-rtos/zephyr)
    ...
    - language: **C** &nbsp;&nbsp; stars: **12,702** &nbsp;&nbsp; folks: **7,694**  &nbsp;&nbsp; `188 stars this week`
...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,214** &nbsp;&nbsp; folks: **849**  &nbsp;&nbsp; `1,008 stars this week`
...
1. [software-mansion / react-native-reanimated](https://github.com/software-mansion/react-native-reanimated)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,009** &nbsp;&nbsp; folks: **1,389**  &nbsp;&nbsp; `157 stars this week`

1. [Lissy93 / web-check](https://github.com/Lissy93/web-check)
    - 🕵️‍♂️ All-in-one OSINT tool for analysing any website
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,882** &nbsp;&nbsp; folks: **2,060**  &nbsp;&nbsp; `212 stars this week`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **34,083** &nbsp;&nbsp; folks: **8,036**  &nbsp;&nbsp; `10,307 stars this month`
...
1. [Alibaba-NLP / WebAgent](https://github.com/Alibaba-NLP/WebAgent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,139** &nbsp;&nbsp; folks: **381**  &nbsp;&nbsp; `4,003 stars this month`

1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    - MCP Toolbox for Databases is an open source MCP server for databases.
    - language: **Go** &nbsp;&nbsp; stars: **8,082** &nbsp;&nbsp; folks: **589**  &nbsp;&nbsp; `6,395 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **7,196** &nbsp;&nbsp; folks: **359**  &nbsp;&nbsp; `5,445 stars this month`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **46,634** &nbsp;&nbsp; folks: **4,243**  &nbsp;&nbsp; `4,427 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,940** &nbsp;&nbsp; folks: **592**  &nbsp;&nbsp; `5,690 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **26,365** &nbsp;&nbsp; folks: **1,449**  &nbsp;&nbsp; `10,513 stars this month`

1. [google-gemini / gemini-cli](https://github.com/google-gemini/gemini-cli)
    - An open-source AI agent that brings the power of Gemini directly into your terminal.
    - language: **TypeScript** &nbsp;&nbsp; stars: **64,865** &nbsp;&nbsp; folks: **6,173**  &nbsp;&nbsp; `31,091 stars this month`
...
1. [GraphiteEditor / Graphite](https://github.com/GraphiteEditor/Graphite)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **20,109** &nbsp;&nbsp; folks: **828**  &nbsp;&nbsp; `6,811 stars this month`

1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 26 lessons, 52 quizzes, classic Machine Learning for all
    - language: **HTML** &nbsp;&nbsp; stars: **75,736** &nbsp;&nbsp; folks: **16,732**  &nbsp;&nbsp; `2,560 stars this month`
...
1. [datawhalechina / happy-llm](https://github.com/datawhalechina/happy-llm)
    - 📚 从零开始的大语言模型原理与实践教程
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **13,365** &nbsp;&nbsp; folks: **1,006**  &nbsp;&nbsp; `8,858 stars this month`

1. [GyulyVGC / sniffnet](https://github.com/GyulyVGC/sniffnet)
    - Comfortably monitor your Internet traffic 🕵️‍♂️
    - language: **Rust** &nbsp;&nbsp; stars: **29,497** &nbsp;&nbsp; folks: **985**  &nbsp;&nbsp; `4,972 stars this month`

1. [twentyhq / twenty](https://github.com/twentyhq/twenty)
    - Building a modern alternative to Salesforce, powered by the community.
    - language: **TypeScript** &nbsp;&nbsp; stars: **34,600** &nbsp;&nbsp; folks: **3,882**  &nbsp;&nbsp; `5,221 stars this month`
