...
1. [FiloSottile / mkcert](https://github.com/FiloSottile/mkcert)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **55,860** &nbsp;&nbsp; folks: **2,922**  &nbsp;&nbsp; `327 stars today`

1. [filamentphp / filament](https://github.com/filamentphp/filament)
    - A powerful open source UI framework for Laravel • Build and ship admin panels & apps fast with Livewire
    - language: **PHP** &nbsp;&nbsp; stars: **25,617** &nbsp;&nbsp; folks: **3,658**  &nbsp;&nbsp; `46 stars today`
...
1. [nomic-ai / gpt4all](https://github.com/nomic-ai/gpt4all)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **76,330** &nbsp;&nbsp; folks: **8,225**  &nbsp;&nbsp; `305 stars today`
...
1. [conductor-oss / conductor](https://github.com/conductor-oss/conductor)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **25,390** &nbsp;&nbsp; folks: **667**  &nbsp;&nbsp; `283 stars today`

1. [microsoft / poml](https://github.com/microsoft/poml)
    - Prompt Orchestration Markup Language
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,810** &nbsp;&nbsp; folks: **59**  &nbsp;&nbsp; `755 stars today`
...
1. [x1xhlol / system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools)
    ...
    - language: **无** &nbsp;&nbsp; stars: **76,204** &nbsp;&nbsp; folks: **21,351**  &nbsp;&nbsp; `577 stars today`
...
1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **13,880** &nbsp;&nbsp; folks: **1,499**  &nbsp;&nbsp; `3,228 stars this week`
...
1. [ollama / ollama](https://github.com/ollama/ollama)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **150,150** &nbsp;&nbsp; folks: **12,807**  &nbsp;&nbsp; `1,196 stars this week`

1. [openai / openai-cookbook](https://github.com/openai/openai-cookbook)
    - Examples and guides for using the OpenAI API
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **67,065** &nbsp;&nbsp; folks: **11,123**  &nbsp;&nbsp; `1,142 stars this week`

1. [lvgl / lvgl](https://github.com/lvgl/lvgl)
    - Embedded graphics library to create beautiful UIs for any MCU, MPU and display type.
    - language: **C** &nbsp;&nbsp; stars: **21,020** &nbsp;&nbsp; folks: **3,784**  &nbsp;&nbsp; `559 stars this week`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,772** &nbsp;&nbsp; folks: **1,206**  &nbsp;&nbsp; `2,501 stars this week`

1. [menloresearch / jan](https://github.com/menloresearch/jan)
    - Jan is an open source alternative to ChatGPT that runs 100% offline on your computer
    - language: **TypeScript** &nbsp;&nbsp; stars: **36,852** &nbsp;&nbsp; folks: **2,154**  &nbsp;&nbsp; `1,273 stars this week`

1. [patchy631 / ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)
    - In-depth tutorials on LLMs, RAGs and real-world AI agent applications.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **17,163** &nbsp;&nbsp; folks: **2,874**  &nbsp;&nbsp; `1,440 stars this week`
...
1. [umami-software / umami](https://github.com/umami-software/umami)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,817** &nbsp;&nbsp; folks: **5,371**  &nbsp;&nbsp; `2,139 stars this week`
...
1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **55,177** &nbsp;&nbsp; folks: **9,365**  &nbsp;&nbsp; `935 stars this week`
...
1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    - Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!
    - language: **Python** &nbsp;&nbsp; stars: **8,298** &nbsp;&nbsp; folks: **657**  &nbsp;&nbsp; `1,129 stars this week`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **106,618** &nbsp;&nbsp; folks: **14,389**  &nbsp;&nbsp; `1,134 stars this week`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **49,153** &nbsp;&nbsp; folks: **4,575**  &nbsp;&nbsp; `6,987 stars this month`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,772** &nbsp;&nbsp; folks: **1,206**  &nbsp;&nbsp; `10,795 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,883** &nbsp;&nbsp; folks: **958**  &nbsp;&nbsp; `9,223 stars this month`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **71,239** &nbsp;&nbsp; folks: **3,870**  &nbsp;&nbsp; `11,173 stars this month`
...
1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    - A high-performance algorithmic trading platform and event-driven backtester
    - language: **Rust** &nbsp;&nbsp; stars: **13,880** &nbsp;&nbsp; folks: **1,499**  &nbsp;&nbsp; `4,191 stars this month`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **10,495** &nbsp;&nbsp; folks: **570**  &nbsp;&nbsp; `6,628 stars this month`
...
1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,177** &nbsp;&nbsp; folks: **9,365**  &nbsp;&nbsp; `3,071 stars this month`
