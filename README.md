...
1. [OpenSPG / KAG](https://github.com/OpenSPG/KAG)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,278** &nbsp;&nbsp; folks: **101**  &nbsp;&nbsp; `138 stars today`

1. [langchain-ai / langchain](https://github.com/langchain-ai/langchain)
    - 🦜🔗 Build context-aware reasoning applications
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **96,862** &nbsp;&nbsp; folks: **15,752**  &nbsp;&nbsp; `69 stars today`
...
1. [XiaoMi / ha_xiaomi_home](https://github.com/XiaoMi/ha_xiaomi_home)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,174** &nbsp;&nbsp; folks: **664**  &nbsp;&nbsp; `6,758 stars this week`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **282,726** &nbsp;&nbsp; folks: **47,269**  &nbsp;&nbsp; `3,114 stars this week`
...
1. [anthropics / anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **8,395** &nbsp;&nbsp; folks: **1,039**  &nbsp;&nbsp; `1,046 stars this week`
...
1. [sxyazi / yazi](https://github.com/sxyazi/yazi)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **19,120** &nbsp;&nbsp; folks: **437**  &nbsp;&nbsp; `1,278 stars this week`
...
1. [1Panel-dev / 1Panel](https://github.com/1Panel-dev/1Panel)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **24,226** &nbsp;&nbsp; folks: **2,190**  &nbsp;&nbsp; `680 stars this week`

1. [google-gemini / cookbook](https://github.com/google-gemini/cookbook)
    - Examples and guides for using the Gemini API
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **9,514** &nbsp;&nbsp; folks: **1,105**  &nbsp;&nbsp; `1,066 stars this week`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **342,632** &nbsp;&nbsp; folks: **62,108**  &nbsp;&nbsp; `1,021 stars this week`
...
1. [elizaOS / eliza](https://github.com/elizaOS/eliza)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,052** &nbsp;&nbsp; folks: **1,792**  &nbsp;&nbsp; `3,887 stars this month`

1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    - PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/Docker
    - language: **Python** &nbsp;&nbsp; stars: **11,381** &nbsp;&nbsp; folks: **821**  &nbsp;&nbsp; `8,367 stars this month`

1. [google-gemini / cookbook](https://github.com/google-gemini/cookbook)
    - Examples and guides for using the Gemini API
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **9,514** &nbsp;&nbsp; folks: **1,105**  &nbsp;&nbsp; `4,104 stars this month`
...
1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **66,134** &nbsp;&nbsp; folks: **8,035**  &nbsp;&nbsp; `4,953 stars this month`
...
1. [lobehub / lobe-chat](https://github.com/lobehub/lobe-chat)
    - 🤯 Lobe Chat - an open-source, modern-design AI chat framework. Supports Multi AI Providers( OpenAI / Claude 3 / Gemini / Ollama / Qwen / DeepSeek), Knowledge Base (file upload / knowledge management / RAG ), Multi-Modals (Vision/TTS/Plugins/Artifacts). One-click FREE deployment of your private ChatGPT/ Claude application.
    - language: **TypeScript** &nbsp;&nbsp; stars: **49,743** &nbsp;&nbsp; folks: **10,786**  &nbsp;&nbsp; `4,927 stars this month`
...
1. [krahets / hello-algo](https://github.com/krahets/hello-algo)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **104,213** &nbsp;&nbsp; folks: **13,087**  &nbsp;&nbsp; `4,265 stars this month`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **282,726** &nbsp;&nbsp; folks: **47,269**  &nbsp;&nbsp; `5,568 stars this month`
...
1. [2dust / v2rayN](https://github.com/2dust/v2rayN)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **72,284** &nbsp;&nbsp; folks: **11,834**  &nbsp;&nbsp; `2,235 stars this month`
