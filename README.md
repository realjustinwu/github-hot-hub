...
`更新时间：2025-08-17 22:22:19 +0800`

## 今日热门仓库

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **7,120** &nbsp;&nbsp; folks: **1,400**  &nbsp;&nbsp; `991 stars today`

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **4,442** &nbsp;&nbsp; folks: **438**  &nbsp;&nbsp; `461 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **58,562** &nbsp;&nbsp; folks: **7,002**  &nbsp;&nbsp; `442 stars today`

1. [tsoding / nob.h](https://github.com/tsoding/nob.h)
    - Header only library for writing build recipes in C.
    - language: **C** &nbsp;&nbsp; stars: **1,555** &nbsp;&nbsp; folks: **94**  &nbsp;&nbsp; `120 stars today`
...
1. [aliasrobotics / cai](https://github.com/aliasrobotics/cai)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,507** &nbsp;&nbsp; folks: **389**  &nbsp;&nbsp; `205 stars today`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **3,841** &nbsp;&nbsp; folks: **161**  &nbsp;&nbsp; `490 stars today`
...
1. [dtyq / magic](https://github.com/dtyq/magic)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **2,133** &nbsp;&nbsp; folks: **240**  &nbsp;&nbsp; `287 stars today`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **49,619** &nbsp;&nbsp; folks: **4,632**  &nbsp;&nbsp; `137 stars today`

1. [DataExpert-io / data-engineer-handbook](https://github.com/DataExpert-io/data-engineer-handbook)
    - This is a repo with links to everything you'd ever want to learn about data engineering
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **36,353** &nbsp;&nbsp; folks: **7,029**  &nbsp;&nbsp; `33 stars today`
...
1. [MotiaDev / motia](https://github.com/MotiaDev/motia)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,087** &nbsp;&nbsp; folks: **476**  &nbsp;&nbsp; `158 stars today`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,146** &nbsp;&nbsp; folks: **1,536**  &nbsp;&nbsp; `1,136 stars this week`

1. [external-secrets / external-secrets](https://github.com/external-secrets/external-secrets)
    - External Secrets Operator reads information from a third-party service like AWS Secrets Manager and automatically injects the values as Kubernetes Secrets.
    - language: **Go** &nbsp;&nbsp; stars: **5,563** &nbsp;&nbsp; folks: **1,046**  &nbsp;&nbsp; `272 stars this week`

1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic (超级麦吉). The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **2,133** &nbsp;&nbsp; folks: **240**  &nbsp;&nbsp; `539 stars this week`

1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    - Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!
    - language: **Python** &nbsp;&nbsp; stars: **8,919** &nbsp;&nbsp; folks: **697**  &nbsp;&nbsp; `1,912 stars this week`
...
1. [conductor-oss / conductor](https://github.com/conductor-oss/conductor)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **26,090** &nbsp;&nbsp; folks: **674**  &nbsp;&nbsp; `1,269 stars this week`

1. [jitsi / jitsi-meet](https://github.com/jitsi/jitsi-meet)
    - Jitsi Meet - Secure, Simple and Scalable Video Conferences that you use as a standalone app or embed in your web application.
    - language: **TypeScript** &nbsp;&nbsp; stars: **26,713** &nbsp;&nbsp; folks: **7,371**  &nbsp;&nbsp; `509 stars this week`
...
1. [lfnovo / open-notebook](https://github.com/lfnovo/open-notebook)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,550** &nbsp;&nbsp; folks: **361**  &nbsp;&nbsp; `738 stars this week`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **22,305** &nbsp;&nbsp; folks: **4,318**  &nbsp;&nbsp; `13,191 stars this month`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Financial data aggregator for humans and AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **49,619** &nbsp;&nbsp; folks: **4,632**  &nbsp;&nbsp; `6,652 stars this month`
...
1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,530** &nbsp;&nbsp; folks: **1,004**  &nbsp;&nbsp; `8,553 stars this month`

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **7,120** &nbsp;&nbsp; folks: **1,400**  &nbsp;&nbsp; `934 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,019** &nbsp;&nbsp; folks: **600**  &nbsp;&nbsp; `6,821 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,464** &nbsp;&nbsp; folks: **9,427**  &nbsp;&nbsp; `3,093 stars this month`
