...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **282,713** &nbsp;&nbsp; folks: **47,264**  &nbsp;&nbsp; `407 stars today`

1. [IceWhaleTech / CasaOS](https://github.com/IceWhaleTech/CasaOS)
    - CasaOS - A simple, easy-to-use, elegant open-source Personal Cloud system.
    - language: **Go** &nbsp;&nbsp; stars: **27,399** &nbsp;&nbsp; folks: **1,490**  &nbsp;&nbsp; `37 stars today`
...
1. [nammayatri / nammayatri](https://github.com/nammayatri/nammayatri)
    ...
    - language: **PureScript** &nbsp;&nbsp; stars: **1,729** &nbsp;&nbsp; folks: **194**  &nbsp;&nbsp; `11 stars today`

1. [OpenSPG / KAG](https://github.com/OpenSPG/KAG)
    - KAG is a logical form-guided reasoning and retrieval framework based on OpenSPG engine and LLMs. It is used to build logical reasoning and factual Q&A solutions for professional domain knowledge bases. It can effectively overcome the shortcomings of the traditional RAG vector similarity calculation model.
    - language: **Python** &nbsp;&nbsp; stars: **1,262** &nbsp;&nbsp; folks: **100**  &nbsp;&nbsp; `138 stars today`

1. [langchain-ai / langchain](https://github.com/langchain-ai/langchain)
    - 🦜🔗 Build context-aware reasoning applications
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **96,851** &nbsp;&nbsp; folks: **15,751**  &nbsp;&nbsp; `69 stars today`
...
1. [XiaoMi / ha_xiaomi_home](https://github.com/XiaoMi/ha_xiaomi_home)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,148** &nbsp;&nbsp; folks: **662**  &nbsp;&nbsp; `6,758 stars this week`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **282,713** &nbsp;&nbsp; folks: **47,264**  &nbsp;&nbsp; `3,114 stars this week`
...
1. [facebookresearch / AnimatedDrawings](https://github.com/facebookresearch/AnimatedDrawings)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,936** &nbsp;&nbsp; folks: **1,017**  &nbsp;&nbsp; `820 stars this week`

1. [sxyazi / yazi](https://github.com/sxyazi/yazi)
    - 💥 Blazing fast terminal file manager written in Rust, based on async I/O.
    - language: **Rust** &nbsp;&nbsp; stars: **19,114** &nbsp;&nbsp; folks: **436**  &nbsp;&nbsp; `1,278 stars this week`
...
1. [1Panel-dev / 1Panel](https://github.com/1Panel-dev/1Panel)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **24,219** &nbsp;&nbsp; folks: **2,189**  &nbsp;&nbsp; `680 stars this week`
...
1. [elizaOS / eliza](https://github.com/elizaOS/eliza)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,045** &nbsp;&nbsp; folks: **1,790**  &nbsp;&nbsp; `3,887 stars this month`

1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    - PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/Docker
    - language: **Python** &nbsp;&nbsp; stars: **11,364** &nbsp;&nbsp; folks: **817**  &nbsp;&nbsp; `8,367 stars this month`
...
1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **66,129** &nbsp;&nbsp; folks: **8,035**  &nbsp;&nbsp; `4,953 stars this month`
...
1. [lobehub / lobe-chat](https://github.com/lobehub/lobe-chat)
    - 🤯 Lobe Chat - an open-source, modern-design AI chat framework. Supports Multi AI Providers( OpenAI / Claude 3 / Gemini / Ollama / Qwen / DeepSeek), Knowledge Base (file upload / knowledge management / RAG ), Multi-Modals (Vision/TTS/Plugins/Artifacts). One-click FREE deployment of your private ChatGPT/ Claude application.
    - language: **TypeScript** &nbsp;&nbsp; stars: **49,723** &nbsp;&nbsp; folks: **10,783**  &nbsp;&nbsp; `4,927 stars this month`
...
1. [krahets / hello-algo](https://github.com/krahets/hello-algo)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **104,208** &nbsp;&nbsp; folks: **13,087**  &nbsp;&nbsp; `4,265 stars this month`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **282,713** &nbsp;&nbsp; folks: **47,264**  &nbsp;&nbsp; `5,568 stars this month`
...
1. [DS4SD / docling](https://github.com/DS4SD/docling)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,623** &nbsp;&nbsp; folks: **846**  &nbsp;&nbsp; `5,780 stars this month`
...
1. [2dust / v2rayN](https://github.com/2dust/v2rayN)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **72,274** &nbsp;&nbsp; folks: **11,833**  &nbsp;&nbsp; `2,235 stars this month`
