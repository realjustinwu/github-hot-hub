...
1. [lobehub / lobe-chat](https://github.com/lobehub/lobe-chat)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **45,690** &nbsp;&nbsp; folks: **10,224**  &nbsp;&nbsp; `217 stars today`

1. [LadybirdBrowser / ladybird](https://github.com/LadybirdBrowser/ladybird)
    - Truly independent web browser
    - language: **C++** &nbsp;&nbsp; stars: **22,644** &nbsp;&nbsp; folks: **1,008**  &nbsp;&nbsp; `32 stars today`

1. [myhhub / stock](https://github.com/myhhub/stock)
    - stock股票.获取股票数据,计算股票指标,识别股票形态,综合选股,选股策略,股票验证回测,股票自动交易,支持PC及移动设备。
    - language: **Python** &nbsp;&nbsp; stars: **4,167** &nbsp;&nbsp; folks: **782**  &nbsp;&nbsp; `1,251 stars today`
...
1. [Guovin / iptv-api](https://github.com/Guovin/iptv-api)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,940** &nbsp;&nbsp; folks: **1,556**  &nbsp;&nbsp; `346 stars today`
...
1. [kestra-io / kestra](https://github.com/kestra-io/kestra)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **13,961** &nbsp;&nbsp; folks: **1,200**  &nbsp;&nbsp; `250 stars today`

1. [Koenkk / zigbee2mqtt](https://github.com/Koenkk/zigbee2mqtt)
    - Zigbee 🐝 to MQTT bridge 🌉, get rid of your proprietary Zigbee bridges 🔨
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,250** &nbsp;&nbsp; folks: **1,690**  &nbsp;&nbsp; `10 stars today`
...
1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **64,385** &nbsp;&nbsp; folks: **7,848**  &nbsp;&nbsp; `3,369 stars this week`
...
1. [wagoodman / dive](https://github.com/wagoodman/dive)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **47,998** &nbsp;&nbsp; folks: **1,804**  &nbsp;&nbsp; `1,252 stars this week`
...
1. [Guovin / iptv-api](https://github.com/Guovin/iptv-api)
    - 📺IPTV电视直播源更新工具🚀：包含💰央视、📡卫视、☘️广东及各省份地方台、🌊港·澳·台、🎬电影、🎥咪咕、🏀体育、🪁动画、🎮游戏、🎵音乐、🏛经典剧场；支持自定义增加频道；支持组播源、酒店源、订阅源、关键字搜索；每天自动更新两次，结果可用于TVBox等播放软件；支持工作流、Docker(amd64/arm64/arm v7)、命令行、GUI运行方式 | IPTV live TV source update tool
    - language: **Python** &nbsp;&nbsp; stars: **6,940** &nbsp;&nbsp; folks: **1,556**  &nbsp;&nbsp; `622 stars this week`

1. [2dust / v2rayN](https://github.com/2dust/v2rayN)
    - A GUI client for Windows and Linux, support Xray core and others
    - language: **C#** &nbsp;&nbsp; stars: **70,816** &nbsp;&nbsp; folks: **11,656**  &nbsp;&nbsp; `705 stars this week`

1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    - 🔥🕷️ Crawl4AI: Crawl Smarter, Faster, Freely. For AI.
    - language: **HTML** &nbsp;&nbsp; stars: **17,555** &nbsp;&nbsp; folks: **1,293**  &nbsp;&nbsp; `874 stars this week`
...
1. [myhhub / stock](https://github.com/myhhub/stock)
    - stock股票.获取股票数据,计算股票指标,识别股票形态,综合选股,选股策略,股票验证回测,股票自动交易,支持PC及移动设备。
    - language: **Python** &nbsp;&nbsp; stars: **4,167** &nbsp;&nbsp; folks: **782**  &nbsp;&nbsp; `2,370 stars this week`

1. [skills / introduction-to-github](https://github.com/skills/introduction-to-github)
    - Get started using GitHub in less than an hour.
    - language: **无** &nbsp;&nbsp; stars: **5,287** &nbsp;&nbsp; folks: **3,249**  &nbsp;&nbsp; `659 stars this week`
...
1. [SagerNet / sing-box](https://github.com/SagerNet/sing-box)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **20,386** &nbsp;&nbsp; folks: **2,436**  &nbsp;&nbsp; `204 stars this week`
...
1. [dockur / windows](https://github.com/dockur/windows)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **30,160** &nbsp;&nbsp; folks: **2,051**  &nbsp;&nbsp; `12,189 stars this month`

1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    - Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue)
    - language: **Python** &nbsp;&nbsp; stars: **64,385** &nbsp;&nbsp; folks: **7,848**  &nbsp;&nbsp; `7,118 stars this month`

1. [DS4SD / docling](https://github.com/DS4SD/docling)
    - Get your documents ready for gen AI
    - language: **Python** &nbsp;&nbsp; stars: **11,975** &nbsp;&nbsp; folks: **597**  &nbsp;&nbsp; `11,157 stars this month`

1. [ai16z / eliza](https://github.com/ai16z/eliza)
    - Conversational Agent for Twitter and Discord
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,534** &nbsp;&nbsp; folks: **752**  &nbsp;&nbsp; `2,098 stars this month`

1. [opendatalab / MinerU](https://github.com/opendatalab/MinerU)
    - A high-quality tool for convert PDF to Markdown and JSON.一站式开源高质量数据提取工具，将PDF转换成Markdown和JSON格式。
    - language: **Python** &nbsp;&nbsp; stars: **19,870** &nbsp;&nbsp; folks: **1,412**  &nbsp;&nbsp; `6,130 stars this month`
...
1. [twentyhq / twenty](https://github.com/twentyhq/twenty)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **23,794** &nbsp;&nbsp; folks: **2,455**  &nbsp;&nbsp; `6,088 stars this month`

1. [All-Hands-AI / OpenHands](https://github.com/All-Hands-AI/OpenHands)
    - 🙌 OpenHands: Code Less, Make More
    - language: **Python** &nbsp;&nbsp; stars: **37,785** &nbsp;&nbsp; folks: **4,271**  &nbsp;&nbsp; `4,537 stars this month`

1. [payloadcms / payload](https://github.com/payloadcms/payload)
    - Payload is the open-source, fullstack Next.js framework, giving you instant backend superpowers. Get a full TypeScript backend and admin panel instantly. Use Payload as a headless CMS or for building powerful applications.
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,031** &nbsp;&nbsp; folks: **1,802**  &nbsp;&nbsp; `4,215 stars this month`
...
1. [microsoft / autogen](https://github.com/microsoft/autogen)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **35,193** &nbsp;&nbsp; folks: **5,090**  &nbsp;&nbsp; `2,703 stars this month`
...
1. [bluesky-social / social-app](https://github.com/bluesky-social/social-app)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,399** &nbsp;&nbsp; folks: **1,711**  &nbsp;&nbsp; `3,767 stars this month`
...
1. [AlexxIT / go2rtc](https://github.com/AlexxIT/go2rtc)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **7,242** &nbsp;&nbsp; folks: **522**  &nbsp;&nbsp; `2,174 stars this month`

1. [xtekky / gpt4free](https://github.com/xtekky/gpt4free)
    - The official gpt4free repository | various collection of powerful language models
    - language: **Python** &nbsp;&nbsp; stars: **62,436** &nbsp;&nbsp; folks: **13,405**  &nbsp;&nbsp; `1,700 stars this month`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **278,058** &nbsp;&nbsp; folks: **46,584**  &nbsp;&nbsp; `4,467 stars this month`
