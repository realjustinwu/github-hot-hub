...
1. [unionlabs / union](https://github.com/unionlabs/union)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **29,071** &nbsp;&nbsp; folks: **1,773**  &nbsp;&nbsp; `1,266 stars today`

1. [docmost / docmost](https://github.com/docmost/docmost)
    - Docmost is an open-source collaborative wiki and documentation software. It is an open-source alternative to Confluence and Notion.
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,148** &nbsp;&nbsp; folks: **426**  &nbsp;&nbsp; `228 stars today`
...
1. [exo-explore / exo](https://github.com/exo-explore/exo)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **24,027** &nbsp;&nbsp; folks: **1,429**  &nbsp;&nbsp; `494 stars today`
...
1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,567** &nbsp;&nbsp; folks: **1,116**  &nbsp;&nbsp; `691 stars today`
...
1. [datawhalechina / llm-universe](https://github.com/datawhalechina/llm-universe)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **5,935** &nbsp;&nbsp; folks: **715**  &nbsp;&nbsp; `146 stars today`
...
1. [aidenybai / react-scan](https://github.com/aidenybai/react-scan)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,243** &nbsp;&nbsp; folks: **211**  &nbsp;&nbsp; `111 stars today`
...
1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    - A simple screen parsing tool towards pure vision based GUI agent
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **13,627** &nbsp;&nbsp; folks: **1,030**  &nbsp;&nbsp; `5,862 stars this week`
...
1. [microsoft / data-formulator](https://github.com/microsoft/data-formulator)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,637** &nbsp;&nbsp; folks: **572**  &nbsp;&nbsp; `4,188 stars this week`
...
1. [langgenius / dify](https://github.com/langgenius/dify)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **69,477** &nbsp;&nbsp; folks: **10,121**  &nbsp;&nbsp; `3,352 stars this week`
...
1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **37,720** &nbsp;&nbsp; folks: **3,351**  &nbsp;&nbsp; `2,747 stars this week`

1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    - 🚀🚀 「大模型」2小时完全从0训练26M的小参数GPT！🌏 Train a 26M-parameter GPT from scratch in just 2h!
    - language: **Python** &nbsp;&nbsp; stars: **10,567** &nbsp;&nbsp; folks: **1,116**  &nbsp;&nbsp; `1,352 stars this week`
...
1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    - A simple screen parsing tool towards pure vision based GUI agent
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **13,627** &nbsp;&nbsp; folks: **1,030**  &nbsp;&nbsp; `6,199 stars this month`
...
1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **40,022** &nbsp;&nbsp; folks: **2,847**  &nbsp;&nbsp; `5,212 stars this month`
...
1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **24,028** &nbsp;&nbsp; folks: **1,429**  &nbsp;&nbsp; `4,883 stars this month`

1. [microsoft / generative-ai-for-beginners](https://github.com/microsoft/generative-ai-for-beginners)
    - 21 Lessons, Get Started Building with Generative AI 🔗 https://microsoft.github.io/generative-ai-for-beginners/
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **70,980** &nbsp;&nbsp; folks: **36,853**  &nbsp;&nbsp; `4,583 stars this month`

1. [Bin-Huang / chatbox](https://github.com/Bin-Huang/chatbox)
    - User-friendly Desktop Client App for AI Models/LLMs (GPT, Claude, Gemini, Ollama...)
    - language: **TypeScript** &nbsp;&nbsp; stars: **31,337** &nbsp;&nbsp; folks: **2,969**  &nbsp;&nbsp; `6,459 stars this month`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **69,477** &nbsp;&nbsp; folks: **10,121**  &nbsp;&nbsp; `10,023 stars this month`
...
1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding.
    - language: **Python** &nbsp;&nbsp; stars: **37,720** &nbsp;&nbsp; folks: **3,351**  &nbsp;&nbsp; `8,794 stars this month`
