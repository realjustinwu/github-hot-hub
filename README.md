...
`更新时间：2024-12-27 20:41:20 +0800`

## 今日热门仓库

1. [anti-work / shortest](https://github.com/anti-work/shortest)
    - QA via natural language AI tests
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,438** &nbsp;&nbsp; folks: **135**  &nbsp;&nbsp; `960 stars today`

1. [imputnet / cobalt](https://github.com/imputnet/cobalt)
    - best way to save what you love
    - language: **Svelte** &nbsp;&nbsp; stars: **21,540** &nbsp;&nbsp; folks: **1,771**  &nbsp;&nbsp; `566 stars today`
...
1. [OpenSPG / KAG](https://github.com/OpenSPG/KAG)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,557** &nbsp;&nbsp; folks: **111**  &nbsp;&nbsp; `227 stars today`

1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    - Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.
    - language: **TypeScript** &nbsp;&nbsp; stars: **52,836** &nbsp;&nbsp; folks: **9,096**  &nbsp;&nbsp; `233 stars today`

1. [siyuan-note / siyuan](https://github.com/siyuan-note/siyuan)
    - A privacy-first, self-hosted, fully open source personal knowledge management software, written in typescript and golang.
    - language: **TypeScript** &nbsp;&nbsp; stars: **24,417** &nbsp;&nbsp; folks: **1,684**  &nbsp;&nbsp; `300 stars today`

1. [langchain-ai / langchain](https://github.com/langchain-ai/langchain)
    - 🦜🔗 Build context-aware reasoning applications
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **96,939** &nbsp;&nbsp; folks: **15,763**  &nbsp;&nbsp; `159 stars today`

1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    - Master programming by recreating your favorite technologies from scratch.
    - language: **Markdown** &nbsp;&nbsp; stars: **318,869** &nbsp;&nbsp; folks: **29,589**  &nbsp;&nbsp; `180 stars today`

1. [shadps4-emu / shadPS4](https://github.com/shadps4-emu/shadPS4)
    - PS4 emulator for Windows,Linux,MacOS
    - language: **C++** &nbsp;&nbsp; stars: **11,738** &nbsp;&nbsp; folks: **794**  &nbsp;&nbsp; `59 stars today`

1. [apache / echarts](https://github.com/apache/echarts)
    - Apache ECharts is a powerful, interactive charting and data visualization library for browser
    - language: **TypeScript** &nbsp;&nbsp; stars: **61,208** &nbsp;&nbsp; folks: **19,643**  &nbsp;&nbsp; `184 stars today`

1. [dair-ai / Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide)
    - 🐙 Guides, papers, lecture, notebooks and resources for prompt engineering
    - language: **MDX** &nbsp;&nbsp; stars: **51,342** &nbsp;&nbsp; folks: **4,990**  &nbsp;&nbsp; `44 stars today`
...
1. [phidatahq / phidata](https://github.com/phidatahq/phidata)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,839** &nbsp;&nbsp; folks: **2,276**  &nbsp;&nbsp; `26 stars today`

1. [teableio / teable](https://github.com/teableio/teable)
    - ✨ The Next Gen Airtable Alternative: No-Code Postgres
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,904** &nbsp;&nbsp; folks: **640**  &nbsp;&nbsp; `32 stars today`

1. [microg / GmsCore](https://github.com/microg/GmsCore)
    - Free implementation of Play Services
    - language: **Java** &nbsp;&nbsp; stars: **9,043** &nbsp;&nbsp; folks: **1,773**  &nbsp;&nbsp; `118 stars today`
...
1. [Genesis-Embodied-AI / Genesis](https://github.com/Genesis-Embodied-AI/Genesis)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,765** &nbsp;&nbsp; folks: **1,488**  &nbsp;&nbsp; `6,622 stars this week`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **282,970** &nbsp;&nbsp; folks: **47,307**  &nbsp;&nbsp; `3,297 stars this week`

1. [XiaoMi / ha_xiaomi_home](https://github.com/XiaoMi/ha_xiaomi_home)
    - Xiaomi Home Integration for Home Assistant
    - language: **Python** &nbsp;&nbsp; stars: **15,441** &nbsp;&nbsp; folks: **685**  &nbsp;&nbsp; `4,563 stars this week`
...
1. [anthropics / anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **8,481** &nbsp;&nbsp; folks: **1,045**  &nbsp;&nbsp; `1,092 stars this week`
...
1. [gorhill / uBlock](https://github.com/gorhill/uBlock)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **48,629** &nbsp;&nbsp; folks: **3,225**  &nbsp;&nbsp; `603 stars this week`

1. [seleniumbase / SeleniumBase](https://github.com/seleniumbase/SeleniumBase)
    - Python APIs for web automation, testing, and bypassing bot-detection.
    - language: **Python** &nbsp;&nbsp; stars: **7,980** &nbsp;&nbsp; folks: **1,080**  &nbsp;&nbsp; `1,329 stars this week`
...
1. [1Panel-dev / 1Panel](https://github.com/1Panel-dev/1Panel)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **24,280** &nbsp;&nbsp; folks: **2,191**  &nbsp;&nbsp; `720 stars this week`

1. [raysan5 / raylib](https://github.com/raysan5/raylib)
    - A simple and easy-to-use library to enjoy videogames programming
    - language: **C** &nbsp;&nbsp; stars: **23,878** &nbsp;&nbsp; folks: **2,344**  &nbsp;&nbsp; `517 stars this week`

1. [imputnet / cobalt](https://github.com/imputnet/cobalt)
    - best way to save what you love
    - language: **Svelte** &nbsp;&nbsp; stars: **21,540** &nbsp;&nbsp; folks: **1,771**  &nbsp;&nbsp; `1,133 stars this week`
...
1. [cline / cline](https://github.com/cline/cline)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,431** &nbsp;&nbsp; folks: **1,377**  &nbsp;&nbsp; `1,045 stars this week`
...
1. [myhhub / stock](https://github.com/myhhub/stock)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,637** &nbsp;&nbsp; folks: **1,213**  &nbsp;&nbsp; `4,821 stars this month`

1. [elizaOS / eliza](https://github.com/elizaOS/eliza)
    - Autonomous agents for everyone
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,164** &nbsp;&nbsp; folks: **1,838**  &nbsp;&nbsp; `3,947 stars this month`
...
1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,589** &nbsp;&nbsp; folks: **842**  &nbsp;&nbsp; `8,448 stars this month`
...
1. [seleniumbase / SeleniumBase](https://github.com/seleniumbase/SeleniumBase)
    - Python APIs for web automation, testing, and bypassing bot-detection.
    - language: **Python** &nbsp;&nbsp; stars: **7,980** &nbsp;&nbsp; folks: **1,080**  &nbsp;&nbsp; `2,486 stars this month`

1. [langflow-ai / langflow](https://github.com/langflow-ai/langflow)
    - Langflow is a low-code app builder for RAG and multi-agent AI applications. It’s Python-based and agnostic to any model, API, or database.
    - language: **Python** &nbsp;&nbsp; stars: **40,848** &nbsp;&nbsp; folks: **4,593**  &nbsp;&nbsp; `5,278 stars this month`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **282,970** &nbsp;&nbsp; folks: **47,307**  &nbsp;&nbsp; `5,748 stars this month`

1. [imputnet / cobalt](https://github.com/imputnet/cobalt)
    - best way to save what you love
    - language: **Svelte** &nbsp;&nbsp; stars: **21,540** &nbsp;&nbsp; folks: **1,771**  &nbsp;&nbsp; `3,634 stars this month`
...
1. [modelcontextprotocol / python-sdk](https://github.com/modelcontextprotocol/python-sdk)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,048** &nbsp;&nbsp; folks: **103**  &nbsp;&nbsp; `776 stars this month`
