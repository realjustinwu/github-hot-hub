...
1. [zhayujie / chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,495** &nbsp;&nbsp; folks: **8,645**  &nbsp;&nbsp; `123 stars today`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **62,556** &nbsp;&nbsp; folks: **9,294**  &nbsp;&nbsp; `421 stars today`
...
1. [songquanpeng / one-api](https://github.com/songquanpeng/one-api)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **21,480** &nbsp;&nbsp; folks: **4,633**  &nbsp;&nbsp; `89 stars today`
...
1. [assafelovic / gpt-researcher](https://github.com/assafelovic/gpt-researcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,165** &nbsp;&nbsp; folks: **2,277**  &nbsp;&nbsp; `502 stars today`

1. [ruanyf / weekly](https://github.com/ruanyf/weekly)
    - 科技爱好者周刊，每周五发布
    - language: **无** &nbsp;&nbsp; stars: **51,948** &nbsp;&nbsp; folks: **3,096**  &nbsp;&nbsp; `45 stars today`
...
1. [block / goose](https://github.com/block/goose)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **6,463** &nbsp;&nbsp; folks: **411**  &nbsp;&nbsp; `3,965 stars this week`
...
1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **69,050** &nbsp;&nbsp; folks: **8,178**  &nbsp;&nbsp; `5,571 stars this week`

1. [volcengine / verl](https://github.com/volcengine/verl)
    - veRL: Volcano Engine Reinforcement Learning for LLM
    - language: **Python** &nbsp;&nbsp; stars: **2,427** &nbsp;&nbsp; folks: **191**  &nbsp;&nbsp; `964 stars this week`

1. [deepseek-ai / Janus](https://github.com/deepseek-ai/Janus)
    - Janus-Series: Unified Multimodal Understanding and Generation Models
    - language: **Python** &nbsp;&nbsp; stars: **14,970** &nbsp;&nbsp; folks: **1,943**  &nbsp;&nbsp; `2,488 stars this week`

1. [ocrmypdf / OCRmyPDF](https://github.com/ocrmypdf/OCRmyPDF)
    - OCRmyPDF adds an OCR text layer to scanned PDF files, allowing them to be searched
    - language: **Python** &nbsp;&nbsp; stars: **16,927** &nbsp;&nbsp; folks: **1,158**  &nbsp;&nbsp; `1,823 stars this week`

1. [n4ze3m / page-assist](https://github.com/n4ze3m/page-assist)
    - Use your locally running AI models to assist you in your web browsing
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,124** &nbsp;&nbsp; folks: **279**  &nbsp;&nbsp; `833 stars this week`
...
1. [deepseek-ai / DeepSeek-LLM](https://github.com/deepseek-ai/DeepSeek-LLM)
    ...
    - language: **Makefile** &nbsp;&nbsp; stars: **5,594** &nbsp;&nbsp; folks: **836**  &nbsp;&nbsp; `928 stars this week`

1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **21,988** &nbsp;&nbsp; folks: **1,266**  &nbsp;&nbsp; `1,109 stars this week`

1. [is-a-dev / register](https://github.com/is-a-dev/register)
    - Grab your own sweet-looking '.is-a.dev' subdomain.
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,487** &nbsp;&nbsp; folks: **9,892**  &nbsp;&nbsp; `1,008 stars this week`

1. [Huanshere / VideoLingo](https://github.com/Huanshere/VideoLingo)
    - Netflix-level subtitle cutting, translation, alignment, and even dubbing - one-click fully automated AI video subtitle team | Netflix级字幕切割、翻译、对齐、甚至加上配音，一键全自动视频搬运AI字幕组
    - language: **Python** &nbsp;&nbsp; stars: **10,540** &nbsp;&nbsp; folks: **1,003**  &nbsp;&nbsp; `1,030 stars this week`
...
1. [Bin-Huang / chatbox](https://github.com/Bin-Huang/chatbox)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **28,122** &nbsp;&nbsp; folks: **2,718**  &nbsp;&nbsp; `1,570 stars this week`
...
1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **24,775** &nbsp;&nbsp; folks: **2,469**  &nbsp;&nbsp; `14,457 stars this month`

1. [OpenBMB / MiniCPM-o](https://github.com/OpenBMB/MiniCPM-o)
    - MiniCPM-o 2.6: A GPT-4o Level MLLM for Vision, Speech and Multimodal Live Streaming on Your Phone
    - language: **Python** &nbsp;&nbsp; stars: **18,164** &nbsp;&nbsp; folks: **1,303**  &nbsp;&nbsp; `5,555 stars this month`
...
1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **39,381** &nbsp;&nbsp; folks: **2,796**  &nbsp;&nbsp; `4,719 stars this month`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **69,050** &nbsp;&nbsp; folks: **8,178**  &nbsp;&nbsp; `14,019 stars this month`
...
1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **45,687** &nbsp;&nbsp; folks: **4,865**  &nbsp;&nbsp; `5,093 stars this month`
...
1. [ggerganov / llama.cpp](https://github.com/ggerganov/llama.cpp)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **73,313** &nbsp;&nbsp; folks: **10,568**  &nbsp;&nbsp; `3,267 stars this month`
...
1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,922** &nbsp;&nbsp; folks: **371**  &nbsp;&nbsp; `2,639 stars this month`
...
1. [shadps4-emu / shadPS4](https://github.com/shadps4-emu/shadPS4)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **17,529** &nbsp;&nbsp; folks: **1,083**  &nbsp;&nbsp; `4,802 stars this month`

1. [78 / xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)
    - Build your own AI friend
    - language: **C++** &nbsp;&nbsp; stars: **4,368** &nbsp;&nbsp; folks: **682**  &nbsp;&nbsp; `3,259 stars this month`
