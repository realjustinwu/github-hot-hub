...
1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,234** &nbsp;&nbsp; folks: **628**  &nbsp;&nbsp; `128 stars today`

1. [imputnet / cobalt](https://github.com/imputnet/cobalt)
    - best way to save what you love
    - language: **Svelte** &nbsp;&nbsp; stars: **32,647** &nbsp;&nbsp; folks: **2,733**  &nbsp;&nbsp; `50 stars today`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **301,933** &nbsp;&nbsp; folks: **50,037**  &nbsp;&nbsp; `404 stars today`
...
1. [syncthing / syncthing](https://github.com/syncthing/syncthing)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **71,074** &nbsp;&nbsp; folks: **4,560**  &nbsp;&nbsp; `57 stars today`
...
1. [assimp / assimp](https://github.com/assimp/assimp)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **11,707** &nbsp;&nbsp; folks: **3,028**  &nbsp;&nbsp; `12 stars today`

1. [mui / mui-x](https://github.com/mui/mui-x)
    - MUI X: Build complex and data-rich applications using a growing list of advanced React components, like the Data Grid, Date and Time Pickers, Charts, and more!
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,062** &nbsp;&nbsp; folks: **1,466**  &nbsp;&nbsp; `36 stars today`
...
1. [GeostatsGuy / DataScienceInteractivePython](https://github.com/GeostatsGuy/DataScienceInteractivePython)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **1,431** &nbsp;&nbsp; folks: **281**  &nbsp;&nbsp; `103 stars today`
...
1. [Fosowl / agenticSeek](https://github.com/Fosowl/agenticSeek)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **14,427** &nbsp;&nbsp; folks: **1,232**  &nbsp;&nbsp; `10,499 stars this week`

1. [microsoft / qlib](https://github.com/microsoft/qlib)
    - Qlib is an AI-oriented Quant investment platform that aims to use AI tech to empower Quant Research, from exploring ideas to implementing productions. Qlib supports diverse ML modeling paradigms, including supervised learning, market dynamics modeling, and RL, and is now equipped with https://github.com/microsoft/RD-Agent to automate R&D process.
    - language: **Python** &nbsp;&nbsp; stars: **23,535** &nbsp;&nbsp; folks: **3,647**  &nbsp;&nbsp; `3,114 stars this week`

1. [mindsdb / mindsdb](https://github.com/mindsdb/mindsdb)
    - AI's query engine - Platform for building AI that can answer questions over large scale federated data. - The only MCP Server you'll ever need
    - language: **Python** &nbsp;&nbsp; stars: **31,104** &nbsp;&nbsp; folks: **5,203**  &nbsp;&nbsp; `1,878 stars this week`

1. [anthropics / courses](https://github.com/anthropics/courses)
    - Anthropic's educational courses
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **12,897** &nbsp;&nbsp; folks: **1,145**  &nbsp;&nbsp; `969 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **10,859** &nbsp;&nbsp; folks: **605**  &nbsp;&nbsp; `1,284 stars this week`
...
1. [seleniumbase / SeleniumBase](https://github.com/seleniumbase/SeleniumBase)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,724** &nbsp;&nbsp; folks: **1,342**  &nbsp;&nbsp; `536 stars this week`
...
1. [KwaiVGI / LivePortrait](https://github.com/KwaiVGI/LivePortrait)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,766** &nbsp;&nbsp; folks: **1,647**  &nbsp;&nbsp; `800 stars this week`
...
1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    - 11 Lessons to Get Started Building AI Agents
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **23,309** &nbsp;&nbsp; folks: **6,197**  &nbsp;&nbsp; `1,668 stars this week`
...
1. [Fosowl / agenticSeek](https://github.com/Fosowl/agenticSeek)
    - Fully Local Manus AI. No APIs, No $200 monthly bills. Enjoy an autonomous agent that thinks, browses the web, and code for the sole cost of electricity. 🔔 Official updates only via twitter @Martin993886460. Any other account is fake.
    - language: **Python** &nbsp;&nbsp; stars: **14,427** &nbsp;&nbsp; folks: **1,232**  &nbsp;&nbsp; `12,554 stars this month`
...
1. [voideditor / void](https://github.com/voideditor/void)
    - 无
    - language: **TypeScript** &nbsp;&nbsp; stars: **22,548** &nbsp;&nbsp; folks: **1,447**  &nbsp;&nbsp; `10,453 stars this month`
...
1. [mindsdb / mindsdb](https://github.com/mindsdb/mindsdb)
    - AI's query engine - Platform for building AI that can answer questions over large scale federated data. - The only MCP Server you'll ever need
    - language: **Python** &nbsp;&nbsp; stars: **31,104** &nbsp;&nbsp; folks: **5,203**  &nbsp;&nbsp; `3,287 stars this month`
...
1. [MODSetter / SurfSense](https://github.com/MODSetter/SurfSense)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,839** &nbsp;&nbsp; folks: **344**  &nbsp;&nbsp; `3,107 stars this month`

1. [microsoft / qlib](https://github.com/microsoft/qlib)
    - Qlib is an AI-oriented Quant investment platform that aims to use AI tech to empower Quant Research, from exploring ideas to implementing productions. Qlib supports diverse ML modeling paradigms, including supervised learning, market dynamics modeling, and RL, and is now equipped with https://github.com/microsoft/RD-Agent to automate R&D process.
    - language: **Python** &nbsp;&nbsp; stars: **23,535** &nbsp;&nbsp; folks: **3,647**  &nbsp;&nbsp; `4,556 stars this month`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **324,966** &nbsp;&nbsp; folks: **41,877**  &nbsp;&nbsp; `8,635 stars this month`

1. [zed-industries / zed](https://github.com/zed-industries/zed)
    - Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter.
    - language: **Rust** &nbsp;&nbsp; stars: **60,746** &nbsp;&nbsp; folks: **4,395**  &nbsp;&nbsp; `3,436 stars this month`
...
1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **127,574** &nbsp;&nbsp; folks: **16,943**  &nbsp;&nbsp; `3,959 stars this month`
...
1. [CopilotKit / CopilotKit](https://github.com/CopilotKit/CopilotKit)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **20,491** &nbsp;&nbsp; folks: **2,821**  &nbsp;&nbsp; `2,153 stars this month`
