...
1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **32,210** &nbsp;&nbsp; folks: **9,392**  &nbsp;&nbsp; `164 stars today`

1. [frappe / hrms](https://github.com/frappe/hrms)
    - Open Source HR and Payroll Software
    - language: **Python** &nbsp;&nbsp; stars: **3,341** &nbsp;&nbsp; folks: **1,286**  &nbsp;&nbsp; `88 stars today`
...
1. [Sjj1024 / PakePlus](https://github.com/Sjj1024/PakePlus)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **5,126** &nbsp;&nbsp; folks: **3,311**  &nbsp;&nbsp; `126 stars today`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **32,894** &nbsp;&nbsp; folks: **4,066**  &nbsp;&nbsp; `112 stars today`

1. [jj-vcs / jj](https://github.com/jj-vcs/jj)
    - A Git-compatible VCS that is both simple and powerful
    - language: **Rust** &nbsp;&nbsp; stars: **18,015** &nbsp;&nbsp; folks: **592**  &nbsp;&nbsp; `179 stars today`

1. [steven2358 / awesome-generative-ai](https://github.com/steven2358/awesome-generative-ai)
    - A curated list of modern Generative Artificial Intelligence projects and services
    - language: **无** &nbsp;&nbsp; stars: **9,187** &nbsp;&nbsp; folks: **1,028**  &nbsp;&nbsp; `54 stars today`

1. [QwenLM / Qwen3](https://github.com/QwenLM/Qwen3)
    - Qwen3 is the large language model series developed by Qwen team, Alibaba Cloud.
    - language: **Python** &nbsp;&nbsp; stars: **23,045** &nbsp;&nbsp; folks: **1,560**  &nbsp;&nbsp; `122 stars today`

1. [C4illin / ConvertX](https://github.com/C4illin/ConvertX)
    - 💾 Self-hosted online file converter. Supports 1000+ formats ⚙️
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,264** &nbsp;&nbsp; folks: **254**  &nbsp;&nbsp; `709 stars today`
...
1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The personal finance app for everyone
    - language: **Ruby** &nbsp;&nbsp; stars: **51,938** &nbsp;&nbsp; folks: **3,823**  &nbsp;&nbsp; `5,981 stars this week`

1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    - Python tool for converting files and office documents to Markdown.
    - language: **Python** &nbsp;&nbsp; stars: **69,125** &nbsp;&nbsp; folks: **3,686**  &nbsp;&nbsp; `4,981 stars this week`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **6,145** &nbsp;&nbsp; folks: **834**  &nbsp;&nbsp; `1,738 stars this week`
...
1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,248** &nbsp;&nbsp; folks: **531**  &nbsp;&nbsp; `2,174 stars this week`
...
1. [getzep / graphiti](https://github.com/getzep/graphiti)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **14,936** &nbsp;&nbsp; folks: **1,257**  &nbsp;&nbsp; `1,057 stars this week`

1. [sherlock-project / sherlock](https://github.com/sherlock-project/sherlock)
    - Hunt down social media accounts by username across social networks
    - language: **Python** &nbsp;&nbsp; stars: **67,233** &nbsp;&nbsp; folks: **7,720**  &nbsp;&nbsp; `499 stars this week`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **6,228** &nbsp;&nbsp; folks: **314**  &nbsp;&nbsp; `2,028 stars this week`
...
1. [ChatGPTNextWeb / NextChat](https://github.com/ChatGPTNextWeb/NextChat)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **85,022** &nbsp;&nbsp; folks: **61,110**  &nbsp;&nbsp; `834 stars this week`

1. [OpenPipe / ART](https://github.com/OpenPipe/ART)
    - Agent Reinforcement Trainer: train multi-step agents for real-world tasks using GRPO. Give your agents on-the-job training. Reinforcement learning for Qwen2.5, Qwen3, Llama, Kimi, and more!
    - language: **Python** &nbsp;&nbsp; stars: **3,533** &nbsp;&nbsp; folks: **212**  &nbsp;&nbsp; `994 stars this week`
...
1. [facebookresearch / segment-anything](https://github.com/facebookresearch/segment-anything)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **51,278** &nbsp;&nbsp; folks: **6,003**  &nbsp;&nbsp; `404 stars this week`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,454** &nbsp;&nbsp; folks: **7,934**  &nbsp;&nbsp; `9,726 stars this month`
...
1. [Alibaba-NLP / WebAgent](https://github.com/Alibaba-NLP/WebAgent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,952** &nbsp;&nbsp; folks: **366**  &nbsp;&nbsp; `3,859 stars this month`

1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    - MCP Toolbox for Databases is an open source MCP server for databases.
    - language: **Go** &nbsp;&nbsp; stars: **7,740** &nbsp;&nbsp; folks: **566**  &nbsp;&nbsp; `6,210 stars this month`

1. [humanlayer / 12-factor-agents](https://github.com/humanlayer/12-factor-agents)
    - What are the principles we can use to build LLM-powered software that is actually good enough to put in the hands of production customers?
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,135** &nbsp;&nbsp; folks: **663**  &nbsp;&nbsp; `5,626 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,248** &nbsp;&nbsp; folks: **531**  &nbsp;&nbsp; `5,882 stars this month`

1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The personal finance app for everyone
    - language: **Ruby** &nbsp;&nbsp; stars: **51,938** &nbsp;&nbsp; folks: **3,823**  &nbsp;&nbsp; `6,341 stars this month`
...
1. [twentyhq / twenty](https://github.com/twentyhq/twenty)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **34,374** &nbsp;&nbsp; folks: **3,857**  &nbsp;&nbsp; `6,106 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **25,682** &nbsp;&nbsp; folks: **1,405**  &nbsp;&nbsp; `10,896 stars this month`

1. [GyulyVGC / sniffnet](https://github.com/GyulyVGC/sniffnet)
    - Comfortably monitor your Internet traffic 🕵️‍♂️
    - language: **Rust** &nbsp;&nbsp; stars: **29,264** &nbsp;&nbsp; folks: **971**  &nbsp;&nbsp; `4,813 stars this month`
...
1. [datawhalechina / happy-llm](https://github.com/datawhalechina/happy-llm)
    - 📚 从零开始的大语言模型原理与实践教程
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **12,869** &nbsp;&nbsp; folks: **954**  &nbsp;&nbsp; `8,828 stars this month`
