...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **4,229** &nbsp;&nbsp; folks: **290**  &nbsp;&nbsp; `59 stars today`

1. [immich-app / immich](https://github.com/immich-app/immich)
    - High performance self-hosted photo and video management solution.
    - language: **TypeScript** &nbsp;&nbsp; stars: **76,229** &nbsp;&nbsp; folks: **4,033**  &nbsp;&nbsp; `510 stars today`

1. [HKUDS / AutoAgent](https://github.com/HKUDS/AutoAgent)
    - "AutoAgent: Fully-Automated and Zero-Code LLM Agent Framework"
    - language: **Python** &nbsp;&nbsp; stars: **6,329** &nbsp;&nbsp; folks: **859**  &nbsp;&nbsp; `73 stars today`
...
1. [LukeGus / Termix](https://github.com/LukeGus/Termix)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,405** &nbsp;&nbsp; folks: **132**  &nbsp;&nbsp; `1,382 stars this week`
...
1. [resemble-ai / chatterbox](https://github.com/resemble-ai/chatterbox)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **12,523** &nbsp;&nbsp; folks: **1,579**  &nbsp;&nbsp; `1,130 stars this week`

1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    - Distributed query engine providing simple and reliable data processing for any modality and scale
    - language: **Rust** &nbsp;&nbsp; stars: **4,229** &nbsp;&nbsp; folks: **290**  &nbsp;&nbsp; `786 stars this week`
...
1. [trufflesecurity / trufflehog](https://github.com/trufflesecurity/trufflehog)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **21,345** &nbsp;&nbsp; folks: **2,012**  &nbsp;&nbsp; `943 stars this week`

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **11,318** &nbsp;&nbsp; folks: **898**  &nbsp;&nbsp; `2,815 stars this week`

1. [google / mangle](https://github.com/google/mangle)
    - 无
    - language: **Go** &nbsp;&nbsp; stars: **2,584** &nbsp;&nbsp; folks: **124**  &nbsp;&nbsp; `596 stars this week`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **66,426** &nbsp;&nbsp; folks: **5,636**  &nbsp;&nbsp; `1,394 stars this week`
...
1. [humanlayer / humanlayer](https://github.com/humanlayer/humanlayer)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,394** &nbsp;&nbsp; folks: **220**  &nbsp;&nbsp; `328 stars this week`
...
1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,637** &nbsp;&nbsp; folks: **3,115**  &nbsp;&nbsp; `11,489 stars this month`
...
1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **9,086** &nbsp;&nbsp; folks: **274**  &nbsp;&nbsp; `5,750 stars this month`

1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Open-source platform to build and deploy AI agent workflows.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,609** &nbsp;&nbsp; folks: **1,805**  &nbsp;&nbsp; `7,551 stars this month`

1. [ubicloud / ubicloud](https://github.com/ubicloud/ubicloud)
    - Open source alternative to AWS. Elastic compute, block storage (non replicated), firewall and load balancer, managed Postgres, K8s, AI inference, and IAM services.
    - language: **Ruby** &nbsp;&nbsp; stars: **10,265** &nbsp;&nbsp; folks: **461**  &nbsp;&nbsp; `4,976 stars this month`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **39,835** &nbsp;&nbsp; folks: **4,624**  &nbsp;&nbsp; `6,722 stars this month`
...
1. [basecamp / omarchy](https://github.com/basecamp/omarchy)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **7,528** &nbsp;&nbsp; folks: **883**  &nbsp;&nbsp; `4,131 stars this month`
