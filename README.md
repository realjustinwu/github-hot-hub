...
1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,272** &nbsp;&nbsp; folks: **770**  &nbsp;&nbsp; `299 stars today`
...
1. [quarkusio / quarkus](https://github.com/quarkusio/quarkus)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **14,932** &nbsp;&nbsp; folks: **2,950**  &nbsp;&nbsp; `9 stars today`

1. [apache / airflow](https://github.com/apache/airflow)
    - Apache Airflow - A platform to programmatically author, schedule, and monitor workflows
    - language: **Python** &nbsp;&nbsp; stars: **42,175** &nbsp;&nbsp; folks: **15,544**  &nbsp;&nbsp; `198 stars today`
...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **3,729** &nbsp;&nbsp; folks: **277**  &nbsp;&nbsp; `61 stars today`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **65,325** &nbsp;&nbsp; folks: **5,573**  &nbsp;&nbsp; `89 stars today`
...
1. [dockur / windows](https://github.com/dockur/windows)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **44,599** &nbsp;&nbsp; folks: **3,241**  &nbsp;&nbsp; `6,784 stars this week`

1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    - Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,700** &nbsp;&nbsp; folks: **606**  &nbsp;&nbsp; `2,671 stars this week`
...
1. [QuentinFuxa / WhisperLiveKit](https://github.com/QuentinFuxa/WhisperLiveKit)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,460** &nbsp;&nbsp; folks: **549**  &nbsp;&nbsp; `2,964 stars this week`
...
1. [chiphuyen / aie-book](https://github.com/chiphuyen/aie-book)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **8,012** &nbsp;&nbsp; folks: **1,055**  &nbsp;&nbsp; `1,874 stars this week`
...
1. [aquasecurity / trivy](https://github.com/aquasecurity/trivy)
    - Find vulnerabilities, misconfigurations, secrets, SBOM in containers, Kubernetes, code repositories, clouds and more
    - language: **Go** &nbsp;&nbsp; stars: **28,640** &nbsp;&nbsp; folks: **2,731**  &nbsp;&nbsp; `491 stars this week`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **13,036** &nbsp;&nbsp; folks: **1,099**  &nbsp;&nbsp; `11,231 stars this month`
...
1. [langchain-ai / open-swe](https://github.com/langchain-ai/open-swe)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,714** &nbsp;&nbsp; folks: **588**  &nbsp;&nbsp; `4,644 stars this month`

1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **44,599** &nbsp;&nbsp; folks: **3,241**  &nbsp;&nbsp; `7,923 stars this month`
...
1. [OpenBMB / MiniCPM-V](https://github.com/OpenBMB/MiniCPM-V)
    - MiniCPM-V 4.5: A GPT-4o Level MLLM for Single Image, Multi Image and High-FPS Video Understanding on Your Phone
    - language: **Python** &nbsp;&nbsp; stars: **21,410** &nbsp;&nbsp; folks: **1,592**  &nbsp;&nbsp; `1,479 stars this month`
