...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,299** &nbsp;&nbsp; folks: **1,081**  &nbsp;&nbsp; `334 stars today`

1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **3,571** &nbsp;&nbsp; folks: **251**  &nbsp;&nbsp; `660 stars today`

1. [puppeteer / puppeteer](https://github.com/puppeteer/puppeteer)
    - JavaScript API for Chrome and Firefox
    - language: **TypeScript** &nbsp;&nbsp; stars: **91,823** &nbsp;&nbsp; folks: **9,269**  &nbsp;&nbsp; `15 stars today`
...
1. [Leantime / leantime](https://github.com/Leantime/leantime)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **5,998** &nbsp;&nbsp; folks: **679**  &nbsp;&nbsp; `200 stars today`
...
1. [n8n-io / self-hosted-ai-starter-kit](https://github.com/n8n-io/self-hosted-ai-starter-kit)
    ...
    - language: **无** &nbsp;&nbsp; stars: **11,616** &nbsp;&nbsp; folks: **2,829**  &nbsp;&nbsp; `157 stars today`
...
1. [epicenter-so / epicenter](https://github.com/epicenter-so/epicenter)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,333** &nbsp;&nbsp; folks: **141**  &nbsp;&nbsp; `298 stars today`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **5,111** &nbsp;&nbsp; folks: **205**  &nbsp;&nbsp; `342 stars today`

1. [microsoft / BitNet](https://github.com/microsoft/BitNet)
    - Official inference framework for 1-bit LLMs
    - language: **Python** &nbsp;&nbsp; stars: **20,843** &nbsp;&nbsp; folks: **1,575**  &nbsp;&nbsp; `41 stars today`
...
1. [ubicloud / ubicloud](https://github.com/ubicloud/ubicloud)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **9,948** &nbsp;&nbsp; folks: **433**  &nbsp;&nbsp; `3,705 stars this week`

1. [microsoft / poml](https://github.com/microsoft/poml)
    - Prompt Orchestration Markup Language
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,534** &nbsp;&nbsp; folks: **160**  &nbsp;&nbsp; `2,668 stars this week`

1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **3,038** &nbsp;&nbsp; folks: **299**  &nbsp;&nbsp; `1,346 stars this week`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,775** &nbsp;&nbsp; folks: **1,639**  &nbsp;&nbsp; `1,908 stars this week`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **5,111** &nbsp;&nbsp; folks: **205**  &nbsp;&nbsp; `1,675 stars this week`

1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    - Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!
    - language: **Python** &nbsp;&nbsp; stars: **9,323** &nbsp;&nbsp; folks: **719**  &nbsp;&nbsp; `1,456 stars this week`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **60,619** &nbsp;&nbsp; folks: **7,286**  &nbsp;&nbsp; `3,072 stars this week`
...
1. [apple / embedding-atlas](https://github.com/apple/embedding-atlas)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,971** &nbsp;&nbsp; folks: **127**  &nbsp;&nbsp; `1,695 stars this week`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **3,571** &nbsp;&nbsp; folks: **251**  &nbsp;&nbsp; `691 stars this week`
...
1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **14,267** &nbsp;&nbsp; folks: **1,534**  &nbsp;&nbsp; `4,496 stars this month`

1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **3,038** &nbsp;&nbsp; folks: **299**  &nbsp;&nbsp; `1,782 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,836** &nbsp;&nbsp; folks: **9,522**  &nbsp;&nbsp; `3,174 stars this month`

1. [roboflow / supervision](https://github.com/roboflow/supervision)
    - We write your reusable computer vision tools. 💜
    - language: **Python** &nbsp;&nbsp; stars: **34,184** &nbsp;&nbsp; folks: **2,759**  &nbsp;&nbsp; `6,786 stars this month`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **3,571** &nbsp;&nbsp; folks: **251**  &nbsp;&nbsp; `1,380 stars this month`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **11,719** &nbsp;&nbsp; folks: **629**  &nbsp;&nbsp; `7,218 stars this month`

1. [ggml-org / llama.cpp](https://github.com/ggml-org/llama.cpp)
    - LLM inference in C/C++
    - language: **C++** &nbsp;&nbsp; stars: **85,203** &nbsp;&nbsp; folks: **12,760**  &nbsp;&nbsp; `2,178 stars this month`
