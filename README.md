...
1. [puppeteer / puppeteer](https://github.com/puppeteer/puppeteer)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **91,524** &nbsp;&nbsp; folks: **9,250**  &nbsp;&nbsp; `159 stars today`

1. [kubesphere / kubesphere](https://github.com/kubesphere/kubesphere)
    - The container platform tailored for Kubernetes multi-cloud, datacenter, and edge management ⎈ 🖥 ☁️
    - language: **Go** &nbsp;&nbsp; stars: **16,292** &nbsp;&nbsp; folks: **2,450**  &nbsp;&nbsp; `37 stars today`
...
1. [9001 / copyparty](https://github.com/9001/copyparty)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,593** &nbsp;&nbsp; folks: **572**  &nbsp;&nbsp; `1,667 stars today`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder | v0 / lovable / Bolt alternative | 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,053** &nbsp;&nbsp; folks: **445**  &nbsp;&nbsp; `276 stars today`
...
1. [playcanvas / editor](https://github.com/playcanvas/editor)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **474** &nbsp;&nbsp; folks: **67**  &nbsp;&nbsp; `38 stars today`

1. [TideDra / zotero-arxiv-daily](https://github.com/TideDra/zotero-arxiv-daily)
    - Recommend new arxiv papers of your interest daily according to your Zotero libarary.
    - language: **Python** &nbsp;&nbsp; stars: **2,387** &nbsp;&nbsp; folks: **2,246**  &nbsp;&nbsp; `115 stars today`
...
1. [QwenLM / Qwen3-Coder](https://github.com/QwenLM/Qwen3-Coder)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,758** &nbsp;&nbsp; folks: **745**  &nbsp;&nbsp; `2,579 stars this week`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **47,379** &nbsp;&nbsp; folks: **4,331**  &nbsp;&nbsp; `1,898 stars this week`
...
1. [tldr-pages / tldr](https://github.com/tldr-pages/tldr)
    ...
    - language: **Markdown** &nbsp;&nbsp; stars: **58,137** &nbsp;&nbsp; folks: **4,644**  &nbsp;&nbsp; `1,534 stars this week`
...
1. [roboflow / supervision](https://github.com/roboflow/supervision)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **32,723** &nbsp;&nbsp; folks: **2,611**  &nbsp;&nbsp; `2,357 stars this week`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer.
    - language: **Rust** &nbsp;&nbsp; stars: **94,659** &nbsp;&nbsp; folks: **13,846**  &nbsp;&nbsp; `651 stars this week`
...
1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **8,498** &nbsp;&nbsp; folks: **618**  &nbsp;&nbsp; `6,793 stars this month`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **47,379** &nbsp;&nbsp; folks: **4,331**  &nbsp;&nbsp; `5,175 stars this month`

1. [humanlayer / 12-factor-agents](https://github.com/humanlayer/12-factor-agents)
    - What are the principles we can use to build LLM-powered software that is actually good enough to put in the hands of production customers?
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,153** &nbsp;&nbsp; folks: **740**  &nbsp;&nbsp; `6,129 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,189** &nbsp;&nbsp; folks: **413**  &nbsp;&nbsp; `6,139 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **27,349** &nbsp;&nbsp; folks: **1,524**  &nbsp;&nbsp; `10,710 stars this month`

1. [sst / opencode](https://github.com/sst/opencode)
    - AI coding agent, built for the terminal.
    - language: **Go** &nbsp;&nbsp; stars: **16,022** &nbsp;&nbsp; folks: **998**  &nbsp;&nbsp; `8,138 stars this month`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **6,857** &nbsp;&nbsp; folks: **915**  &nbsp;&nbsp; `2,659 stars this month`

1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    - Python tool for converting files and office documents to Markdown.
    - language: **Python** &nbsp;&nbsp; stars: **70,012** &nbsp;&nbsp; folks: **3,778**  &nbsp;&nbsp; `10,556 stars this month`
...
1. [gorhill / uBlock](https://github.com/gorhill/uBlock)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **57,052** &nbsp;&nbsp; folks: **3,632**  &nbsp;&nbsp; `2,317 stars this month`
...
1. [getzep / graphiti](https://github.com/getzep/graphiti)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,708** &nbsp;&nbsp; folks: **1,347**  &nbsp;&nbsp; `3,737 stars this month`
