...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,340** &nbsp;&nbsp; folks: **1,083**  &nbsp;&nbsp; `334 stars today`

1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **3,598** &nbsp;&nbsp; folks: **253**  &nbsp;&nbsp; `660 stars today`
...
1. [bitwarden / clients](https://github.com/bitwarden/clients)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,707** &nbsp;&nbsp; folks: **1,451**  &nbsp;&nbsp; `9 stars today`

1. [Leantime / leantime](https://github.com/Leantime/leantime)
    - Leantime is a goals focused project management system for non-project managers. Building with ADHD, Autism, and dyslexia in mind.
    - language: **PHP** &nbsp;&nbsp; stars: **6,016** &nbsp;&nbsp; folks: **681**  &nbsp;&nbsp; `200 stars today`
...
1. [n8n-io / self-hosted-ai-starter-kit](https://github.com/n8n-io/self-hosted-ai-starter-kit)
    ...
    - language: **无** &nbsp;&nbsp; stars: **11,624** &nbsp;&nbsp; folks: **2,830**  &nbsp;&nbsp; `157 stars today`
...
1. [rasbt / LLMs-from-scratch](https://github.com/rasbt/LLMs-from-scratch)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **66,250** &nbsp;&nbsp; folks: **9,304**  &nbsp;&nbsp; `513 stars today`

1. [laude-institute / terminal-bench](https://github.com/laude-institute/terminal-bench)
    - A benchmark for LLMs on complicated tasks in the terminal
    - language: **Python** &nbsp;&nbsp; stars: **475** &nbsp;&nbsp; folks: **134**  &nbsp;&nbsp; `16 stars today`
...
1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **5,127** &nbsp;&nbsp; folks: **205**  &nbsp;&nbsp; `342 stars today`
...
1. [microsoft / poml](https://github.com/microsoft/poml)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,537** &nbsp;&nbsp; folks: **160**  &nbsp;&nbsp; `2,668 stars this week`
...
1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **5,127** &nbsp;&nbsp; folks: **205**  &nbsp;&nbsp; `1,675 stars this week`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **3,598** &nbsp;&nbsp; folks: **253**  &nbsp;&nbsp; `691 stars this week`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,947** &nbsp;&nbsp; folks: **1,717**  &nbsp;&nbsp; `4,413 stars this month`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **22,718** &nbsp;&nbsp; folks: **4,357**  &nbsp;&nbsp; `13,539 stars this month`
...
1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **14,271** &nbsp;&nbsp; folks: **1,534**  &nbsp;&nbsp; `4,496 stars this month`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **3,598** &nbsp;&nbsp; folks: **253**  &nbsp;&nbsp; `1,380 stars this month`
