...
`更新时间：2025-07-22 13:30:43 +0800`

## 今日热门仓库

1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The personal finance app for everyone
    - language: **Ruby** &nbsp;&nbsp; stars: **49,727** &nbsp;&nbsp; folks: **3,659**  &nbsp;&nbsp; `1,178 stars today`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,476** &nbsp;&nbsp; folks: **278**  &nbsp;&nbsp; `386 stars today`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **5,911** &nbsp;&nbsp; folks: **803**  &nbsp;&nbsp; `319 stars today`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **312,164** &nbsp;&nbsp; folks: **51,319**  &nbsp;&nbsp; `129 stars today`

1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    - 🚀🤖 Crawl4AI: Open-source LLM Friendly Web Crawler & Scraper. Don't be shy, join here: https://discord.gg/jP8KfhDhyN
    - language: **Python** &nbsp;&nbsp; stars: **48,898** &nbsp;&nbsp; folks: **4,740**  &nbsp;&nbsp; `277 stars today`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    - Improve your resumes with Resume Matcher. Get insights, keyword suggestions and tune your resumes to job descriptions.
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,450** &nbsp;&nbsp; folks: **3,640**  &nbsp;&nbsp; `2,876 stars this week`

1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The personal finance app for everyone
    - language: **Ruby** &nbsp;&nbsp; stars: **49,727** &nbsp;&nbsp; folks: **3,659**  &nbsp;&nbsp; `3,618 stars this week`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **5,911** &nbsp;&nbsp; folks: **803**  &nbsp;&nbsp; `1,401 stars this week`
...
1. [getzep / graphiti](https://github.com/getzep/graphiti)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **14,557** &nbsp;&nbsp; folks: **1,220**  &nbsp;&nbsp; `1,313 stars this week`

1. [gitleaks / gitleaks](https://github.com/gitleaks/gitleaks)
    - Find secrets with Gitleaks 🔑
    - language: **Go** &nbsp;&nbsp; stars: **22,395** &nbsp;&nbsp; folks: **1,719**  &nbsp;&nbsp; `886 stars this week`
...
1. [gorhill / uBlock](https://github.com/gorhill/uBlock)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **56,597** &nbsp;&nbsp; folks: **3,609**  &nbsp;&nbsp; `743 stars this week`

1. [strapi / strapi](https://github.com/strapi/strapi)
    - 🚀 Strapi is the leading open-source headless CMS. It’s 100% JavaScript/TypeScript, fully customizable, and developer-first.
    - language: **TypeScript** &nbsp;&nbsp; stars: **68,624** &nbsp;&nbsp; folks: **8,779**  &nbsp;&nbsp; `998 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **25,132** &nbsp;&nbsp; folks: **1,383**  &nbsp;&nbsp; `3,691 stars this week`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **32,985** &nbsp;&nbsp; folks: **7,872**  &nbsp;&nbsp; `9,395 stars this month`
...
1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **25,132** &nbsp;&nbsp; folks: **1,383**  &nbsp;&nbsp; `11,024 stars this month`
...
1. [datawhalechina / happy-llm](https://github.com/datawhalechina/happy-llm)
    - 📚 从零开始的大语言模型原理与实践教程
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **12,497** &nbsp;&nbsp; folks: **924**  &nbsp;&nbsp; `8,693 stars this month`
...
1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The personal finance app for everyone
    - language: **Ruby** &nbsp;&nbsp; stars: **49,727** &nbsp;&nbsp; folks: **3,659**  &nbsp;&nbsp; `3,967 stars this month`

1. [RSSNext / Folo](https://github.com/RSSNext/Folo)
    - 🧡 Follow everything in one place
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,974** &nbsp;&nbsp; folks: **1,344**  &nbsp;&nbsp; `3,313 stars this month`
