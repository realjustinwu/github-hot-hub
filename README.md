...
`更新时间：2025-09-08 12:29:10 +0800`

## 今日热门仓库

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **10,074** &nbsp;&nbsp; folks: **819**  &nbsp;&nbsp; `264 stars today`

1. [zama-ai / fhevm](https://github.com/zama-ai/fhevm)
    - FHEVM, a full-stack framework for integrating Fully Homomorphic Encryption (FHE) with blockchain applications
    - language: **Rust** &nbsp;&nbsp; stars: **17,526** &nbsp;&nbsp; folks: **746**  &nbsp;&nbsp; `524 stars today`
...
1. [juspay / hyperswitch](https://github.com/juspay/hyperswitch)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **29,879** &nbsp;&nbsp; folks: **4,079**  &nbsp;&nbsp; `1,975 stars today`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,890** &nbsp;&nbsp; folks: **872**  &nbsp;&nbsp; `305 stars today`
...
1. [pathwaycom / pathway](https://github.com/pathwaycom/pathway)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **38,018** &nbsp;&nbsp; folks: **1,116**  &nbsp;&nbsp; `2,214 stars today`

1. [pathwaycom / llm-app](https://github.com/pathwaycom/llm-app)
    - Ready-to-run cloud templates for RAG, AI pipelines, and enterprise search with live data. 🐳Docker-friendly.⚡Always in sync with Sharepoint, Google Drive, S3, Kafka, PostgreSQL, real-time data APIs, and more.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **35,732** &nbsp;&nbsp; folks: **958**  &nbsp;&nbsp; `2,063 stars today`

1. [henrygd / beszel](https://github.com/henrygd/beszel)
    - Lightweight server monitoring hub with historical data, docker stats, and alerts.
    - language: **Go** &nbsp;&nbsp; stars: **14,763** &nbsp;&nbsp; folks: **453**  &nbsp;&nbsp; `53 stars today`

1. [ossu / computer-science](https://github.com/ossu/computer-science)
    - 🎓 Path to a free self-taught education in Computer Science!
    - language: **HTML** &nbsp;&nbsp; stars: **192,273** &nbsp;&nbsp; folks: **24,005**  &nbsp;&nbsp; `413 stars today`
...
1. [Vector-Wangel / XLeRobot](https://github.com/Vector-Wangel/XLeRobot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,079** &nbsp;&nbsp; folks: **199**  &nbsp;&nbsp; `225 stars today`
...
1. [dockur / windows](https://github.com/dockur/windows)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **44,724** &nbsp;&nbsp; folks: **3,249**  &nbsp;&nbsp; `6,152 stars this week`

1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    - Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,893** &nbsp;&nbsp; folks: **626**  &nbsp;&nbsp; `2,808 stars this week`
...
1. [google / mangle](https://github.com/google/mangle)
    - 无
    - language: **Go** &nbsp;&nbsp; stars: **2,450** &nbsp;&nbsp; folks: **114**  &nbsp;&nbsp; `614 stars this week`
...
1. [trufflesecurity / trufflehog](https://github.com/trufflesecurity/trufflehog)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **21,180** &nbsp;&nbsp; folks: **2,005**  &nbsp;&nbsp; `771 stars this week`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **13,112** &nbsp;&nbsp; folks: **1,107**  &nbsp;&nbsp; `11,321 stars this month`

1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    - Collection of extracted System Prompts from popular chatbots like ChatGPT, Claude & Gemini
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,342** &nbsp;&nbsp; folks: **3,072**  &nbsp;&nbsp; `11,196 stars this month`

1. [plait-board / drawnix](https://github.com/plait-board/drawnix)
    - 开源白板工具（SaaS），一体化白板，包含思维导图、流程图、自由画等。All in one open-source whiteboard tool with mind, flowchart, freehand and etc.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,828** &nbsp;&nbsp; folks: **811**  &nbsp;&nbsp; `7,175 stars this month`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **39,331** &nbsp;&nbsp; folks: **4,551**  &nbsp;&nbsp; `7,377 stars this month`

1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **44,724** &nbsp;&nbsp; folks: **3,249**  &nbsp;&nbsp; `8,022 stars this month`

1. [basecamp / omarchy](https://github.com/basecamp/omarchy)
    - Opinionated Arch/Hyprland Setup
    - language: **Shell** &nbsp;&nbsp; stars: **7,196** &nbsp;&nbsp; folks: **857**  &nbsp;&nbsp; `4,010 stars this month`

1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **4,013** &nbsp;&nbsp; folks: **402**  &nbsp;&nbsp; `2,612 stars this month`
...
1. [aliasrobotics / cai](https://github.com/aliasrobotics/cai)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,623** &nbsp;&nbsp; folks: **495**  &nbsp;&nbsp; `1,619 stars this month`
