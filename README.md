...
1. [mikf / gallery-dl](https://github.com/mikf/gallery-dl)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **14,611** &nbsp;&nbsp; folks: **1,162**  &nbsp;&nbsp; `15 stars today`

1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    - 😎 Awesome lists about all kinds of interesting topics
    - language: **无** &nbsp;&nbsp; stars: **387,174** &nbsp;&nbsp; folks: **30,906**  &nbsp;&nbsp; `485 stars today`
...
1. [ashishpatel26 / 500-AI-Agents-Projects](https://github.com/ashishpatel26/500-AI-Agents-Projects)
    ...
    - language: **无** &nbsp;&nbsp; stars: **4,056** &nbsp;&nbsp; folks: **764**  &nbsp;&nbsp; `684 stars today`
...
1. [mattermost-community / focalboard](https://github.com/mattermost-community/focalboard)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **24,338** &nbsp;&nbsp; folks: **2,263**  &nbsp;&nbsp; `30 stars today`

1. [LMCache / LMCache](https://github.com/LMCache/LMCache)
    - Supercharge Your LLM with the Fastest KV Cache Layer
    - language: **Python** &nbsp;&nbsp; stars: **3,609** &nbsp;&nbsp; folks: **410**  &nbsp;&nbsp; `88 stars today`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **20,924** &nbsp;&nbsp; folks: **4,199**  &nbsp;&nbsp; `7,747 stars this week`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **53,841** &nbsp;&nbsp; folks: **6,254**  &nbsp;&nbsp; `2,539 stars this week`

1. [roboflow / supervision](https://github.com/roboflow/supervision)
    - We write your reusable computer vision tools. 💜
    - language: **Python** &nbsp;&nbsp; stars: **31,974** &nbsp;&nbsp; folks: **2,548**  &nbsp;&nbsp; `1,833 stars this week`
...
1. [remoteintech / remote-jobs](https://github.com/remoteintech/remote-jobs)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **37,731** &nbsp;&nbsp; folks: **3,661**  &nbsp;&nbsp; `2,080 stars this week`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,584** &nbsp;&nbsp; folks: **4,122**  &nbsp;&nbsp; `965 stars this week`

1. [BerriAI / litellm](https://github.com/BerriAI/litellm)
    - Python SDK, Proxy Server (LLM Gateway) to call 100+ LLM APIs in OpenAI format - [Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropic, Sagemaker, HuggingFace, Replicate, Groq]
    - language: **Python** &nbsp;&nbsp; stars: **26,574** &nbsp;&nbsp; folks: **3,670**  &nbsp;&nbsp; `754 stars this week`
...
1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,934** &nbsp;&nbsp; folks: **646**  &nbsp;&nbsp; `6,295 stars this month`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **7,755** &nbsp;&nbsp; folks: **387**  &nbsp;&nbsp; `5,773 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **26,909** &nbsp;&nbsp; folks: **1,493**  &nbsp;&nbsp; `10,506 stars this month`

1. [sst / opencode](https://github.com/sst/opencode)
    - AI coding agent, built for the terminal.
    - language: **Go** &nbsp;&nbsp; stars: **15,561** &nbsp;&nbsp; folks: **959**  &nbsp;&nbsp; `7,905 stars this month`
