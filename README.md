...
1. [zaidmukaddam / scira](https://github.com/zaidmukaddam/scira)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,565** &nbsp;&nbsp; folks: **1,167**  &nbsp;&nbsp; `990 stars this week`
...
1. [RSSNext / Folo](https://github.com/RSSNext/Folo)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **28,021** &nbsp;&nbsp; folks: **1,239**  &nbsp;&nbsp; `884 stars this week`
...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,610** &nbsp;&nbsp; folks: **691**  &nbsp;&nbsp; `455 stars this week`
...
1. [microsoft / PowerToys](https://github.com/microsoft/PowerToys)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **120,705** &nbsp;&nbsp; folks: **7,164**  &nbsp;&nbsp; `339 stars this week`
...
1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    ...
    - language: **Markdown** &nbsp;&nbsp; stars: **397,277** &nbsp;&nbsp; folks: **37,084**  &nbsp;&nbsp; `4,170 stars this week`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **49,042** &nbsp;&nbsp; folks: **5,650**  &nbsp;&nbsp; `15,636 stars this month`

1. [DataExpert-io / data-engineer-handbook](https://github.com/DataExpert-io/data-engineer-handbook)
    - This is a repo with links to everything you'd ever want to learn about data engineering
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **35,021** &nbsp;&nbsp; folks: **6,734**  &nbsp;&nbsp; `6,111 stars this month`

1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    - 😎 Awesome lists about all kinds of interesting topics
    - language: **无** &nbsp;&nbsp; stars: **380,214** &nbsp;&nbsp; folks: **30,410**  &nbsp;&nbsp; `16,352 stars this month`
...
1. [datawhalechina / happy-llm](https://github.com/datawhalechina/happy-llm)
    - 📚 从零开始的大语言模型原理与实践教程
    - language: **无** &nbsp;&nbsp; stars: **9,695** &nbsp;&nbsp; folks: **698**  &nbsp;&nbsp; `7,263 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **18,201** &nbsp;&nbsp; folks: **1,028**  &nbsp;&nbsp; `6,357 stars this month`
...
1. [DrKLO / Telegram](https://github.com/DrKLO/Telegram)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **27,053** &nbsp;&nbsp; folks: **8,736**  &nbsp;&nbsp; `881 stars this month`

1. [linshenkx / prompt-optimizer](https://github.com/linshenkx/prompt-optimizer)
    - 一款提示词优化器，助力于编写高质量的提示词
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,161** &nbsp;&nbsp; folks: **1,149**  &nbsp;&nbsp; `3,647 stars this month`
...
1. [GyulyVGC / sniffnet](https://github.com/GyulyVGC/sniffnet)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **27,298** &nbsp;&nbsp; folks: **883**  &nbsp;&nbsp; `2,918 stars this month`

1. [datawhalechina / self-llm](https://github.com/datawhalechina/self-llm)
    - 《开源大模型食用指南》针对中国宝宝量身打造的基于Linux环境快速微调（全参数/Lora）、部署国内外开源大模型（LLM）/多模态大模型（MLLM）教程
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **21,055** &nbsp;&nbsp; folks: **2,140**  &nbsp;&nbsp; `4,645 stars this month`
...
1. [stanford-oval / storm](https://github.com/stanford-oval/storm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **26,425** &nbsp;&nbsp; folks: **2,377**  &nbsp;&nbsp; `1,942 stars this month`
