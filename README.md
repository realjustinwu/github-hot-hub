...
`更新时间：2025-10-17 02:34:45 +0800`

## 今日热门仓库

1. [nvm-sh / nvm](https://github.com/nvm-sh/nvm)
    - Node Version Manager - POSIX-compliant bash script to manage multiple active node.js versions
    - language: **Shell** &nbsp;&nbsp; stars: **87,812** &nbsp;&nbsp; folks: **9,433**  &nbsp;&nbsp; `164 stars today`
...
1. [GorvGoyl / Clone-Wars](https://github.com/GorvGoyl/Clone-Wars)
    ...
    - language: **无** &nbsp;&nbsp; stars: **31,158** &nbsp;&nbsp; folks: **2,767**  &nbsp;&nbsp; `338 stars today`
...
1. [reflex-dev / reflex](https://github.com/reflex-dev/reflex)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **26,238** &nbsp;&nbsp; folks: **1,555**  &nbsp;&nbsp; `59 stars today`
...
1. [anthropics / prompt-eng-interactive-tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **24,158** &nbsp;&nbsp; folks: **2,220**  &nbsp;&nbsp; `395 stars today`
...
1. [anthropics / prompt-eng-interactive-tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial)
    - Anthropic's Interactive Prompt Engineering Tutorial
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **24,158** &nbsp;&nbsp; folks: **2,220**  &nbsp;&nbsp; `5,108 stars this week`
...
1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **39,155** &nbsp;&nbsp; folks: **2,465**  &nbsp;&nbsp; `3,378 stars this week`

1. [davila7 / claude-code-templates](https://github.com/davila7/claude-code-templates)
    - CLI tool for configuring and monitoring Claude Code
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,401** &nbsp;&nbsp; folks: **705**  &nbsp;&nbsp; `1,521 stars this week`
...
1. [TibixDev / winboat](https://github.com/TibixDev/winboat)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,741** &nbsp;&nbsp; folks: **293**  &nbsp;&nbsp; `4,763 stars this week`

1. [QwenLM / Qwen3-VL](https://github.com/QwenLM/Qwen3-VL)
    - Qwen3-VL is the multimodal large language model series developed by Qwen team, Alibaba Cloud.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **14,793** &nbsp;&nbsp; folks: **1,135**  &nbsp;&nbsp; `872 stars this week`
...
1. [karpathy / nanoGPT](https://github.com/karpathy/nanoGPT)
    - The simplest, fastest repository for training/finetuning medium-sized GPTs.
    - language: **Python** &nbsp;&nbsp; stars: **46,146** &nbsp;&nbsp; folks: **7,808**  &nbsp;&nbsp; `824 stars this week`

1. [dair-ai / Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide)
    - 🐙 Guides, papers, lecture, notebooks and resources for prompt engineering
    - language: **MDX** &nbsp;&nbsp; stars: **64,163** &nbsp;&nbsp; folks: **6,680**  &nbsp;&nbsp; `1,474 stars this week`
...
1. [anthropics / prompt-eng-interactive-tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial)
    - Anthropic's Interactive Prompt Engineering Tutorial
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **24,158** &nbsp;&nbsp; folks: **2,220**  &nbsp;&nbsp; `5,430 stars this month`
...
1. [coinbase / x402](https://github.com/coinbase/x402)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,174** &nbsp;&nbsp; folks: **329**  &nbsp;&nbsp; `1,223 stars this month`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **47,803** &nbsp;&nbsp; folks: **5,769**  &nbsp;&nbsp; `6,954 stars this month`

1. [bitcoin / bitcoin](https://github.com/bitcoin/bitcoin)
    - Bitcoin Core integration/staging tree
    - language: **C++** &nbsp;&nbsp; stars: **86,220** &nbsp;&nbsp; folks: **38,039**  &nbsp;&nbsp; `789 stars this month`
...
1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **210,887** &nbsp;&nbsp; folks: **48,707**  &nbsp;&nbsp; `4,122 stars this month`
