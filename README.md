...
`更新时间：2025-07-30 17:34:36 +0800`

## 今日热门仓库

1. [9001 / copyparty](https://github.com/9001/copyparty)
    - Portable file server with accelerated resumable uploads, dedup, WebDAV, FTP, TFTP, zeroconf, media indexer, thumbnails++ all in one file, no deps
    - language: **Python** &nbsp;&nbsp; stars: **11,741** &nbsp;&nbsp; folks: **353**  &nbsp;&nbsp; `4,125 stars today`
...
1. [n0-computer / iroh](https://github.com/n0-computer/iroh)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **6,427** &nbsp;&nbsp; folks: **286**  &nbsp;&nbsp; `151 stars today`

1. [tldr-pages / tldr](https://github.com/tldr-pages/tldr)
    - 📚 Collaborative cheatsheets for console commands
    - language: **Markdown** &nbsp;&nbsp; stars: **57,730** &nbsp;&nbsp; folks: **4,630**  &nbsp;&nbsp; `379 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **53,735** &nbsp;&nbsp; folks: **6,241**  &nbsp;&nbsp; `638 stars today`

1. [microsoft / PowerToys](https://github.com/microsoft/PowerToys)
    - Windows system utilities to maximize productivity
    - language: **C#** &nbsp;&nbsp; stars: **121,593** &nbsp;&nbsp; folks: **7,230**  &nbsp;&nbsp; `96 stars today`

1. [lapce / lapce](https://github.com/lapce/lapce)
    - Lightning-fast and Powerful Code Editor written in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **37,020** &nbsp;&nbsp; folks: **1,167**  &nbsp;&nbsp; `35 stars today`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **20,833** &nbsp;&nbsp; folks: **4,197**  &nbsp;&nbsp; `7,747 stars this week`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **46,998** &nbsp;&nbsp; folks: **4,284**  &nbsp;&nbsp; `2,913 stars this week`

1. [frappe / hrms](https://github.com/frappe/hrms)
    - Open Source HR and Payroll Software
    - language: **Python** &nbsp;&nbsp; stars: **5,247** &nbsp;&nbsp; folks: **1,441**  &nbsp;&nbsp; `2,262 stars this week`

1. [remoteintech / remote-jobs](https://github.com/remoteintech/remote-jobs)
    - A list of semi to fully remote-friendly companies (jobs) in tech.
    - language: **JavaScript** &nbsp;&nbsp; stars: **37,649** &nbsp;&nbsp; folks: **3,656**  &nbsp;&nbsp; `2,080 stars this week`

1. [roboflow / supervision](https://github.com/roboflow/supervision)
    - We write your reusable computer vision tools. 💜
    - language: **Python** &nbsp;&nbsp; stars: **31,656** &nbsp;&nbsp; folks: **2,521**  &nbsp;&nbsp; `1,833 stars this week`
...
1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **6,636** &nbsp;&nbsp; folks: **889**  &nbsp;&nbsp; `595 stars this week`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **313,618** &nbsp;&nbsp; folks: **51,496**  &nbsp;&nbsp; `1,352 stars this week`

1. [software-mansion / react-native-reanimated](https://github.com/software-mansion/react-native-reanimated)
    - React Native's Animated library reimplemented
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,046** &nbsp;&nbsp; folks: **1,392**  &nbsp;&nbsp; `200 stars this week`

1. [SillyTavern / SillyTavern](https://github.com/SillyTavern/SillyTavern)
    - LLM Frontend for Power Users.
    - language: **JavaScript** &nbsp;&nbsp; stars: **16,822** &nbsp;&nbsp; folks: **3,710**  &nbsp;&nbsp; `483 stars this week`
...
1. [QwenLM / Qwen3](https://github.com/QwenLM/Qwen3)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **23,567** &nbsp;&nbsp; folks: **1,586**  &nbsp;&nbsp; `859 stars this week`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **53,735** &nbsp;&nbsp; folks: **6,241**  &nbsp;&nbsp; `2,539 stars this week`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **34,395** &nbsp;&nbsp; folks: **8,084**  &nbsp;&nbsp; `10,587 stars this month`
...
1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **8,288** &nbsp;&nbsp; folks: **604**  &nbsp;&nbsp; `6,628 stars this month`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **46,998** &nbsp;&nbsp; folks: **4,284**  &nbsp;&nbsp; `4,833 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,798** &nbsp;&nbsp; folks: **640**  &nbsp;&nbsp; `6,295 stars this month`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **7,648** &nbsp;&nbsp; folks: **383**  &nbsp;&nbsp; `5,773 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **26,816** &nbsp;&nbsp; folks: **1,485**  &nbsp;&nbsp; `10,506 stars this month`
...
1. [datawhalechina / happy-llm](https://github.com/datawhalechina/happy-llm)
    - 📚 从零开始的大语言模型原理与实践教程
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **13,661** &nbsp;&nbsp; folks: **1,036**  &nbsp;&nbsp; `8,998 stars this month`
...
1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **6,636** &nbsp;&nbsp; folks: **889**  &nbsp;&nbsp; `2,519 stars this month`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,912** &nbsp;&nbsp; folks: **507**  &nbsp;&nbsp; `4,358 stars this month`
