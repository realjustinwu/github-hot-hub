...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **46,729** &nbsp;&nbsp; folks: **4,258**  &nbsp;&nbsp; `3,213 stars this week`

1. [frappe / hrms](https://github.com/frappe/hrms)
    - Open Source HR and Payroll Software
    - language: **Python** &nbsp;&nbsp; stars: **5,089** &nbsp;&nbsp; folks: **1,428**  &nbsp;&nbsp; `2,019 stars this week`
...
1. [hyprwm / Hyprland](https://github.com/hyprwm/Hyprland)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **28,875** &nbsp;&nbsp; folks: **1,223**  &nbsp;&nbsp; `863 stars this week`
...
1. [Lissy93 / web-check](https://github.com/Lissy93/web-check)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,949** &nbsp;&nbsp; folks: **2,062**  &nbsp;&nbsp; `212 stars this week`

1. [zephyrproject-rtos / zephyr](https://github.com/zephyrproject-rtos/zephyr)
    - Primary Git Repository for the Zephyr Project. Zephyr is a new generation, scalable, optimized, secure RTOS for multiple hardware architectures.
    - language: **C** &nbsp;&nbsp; stars: **12,716** &nbsp;&nbsp; folks: **7,699**  &nbsp;&nbsp; `188 stars this week`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **46,729** &nbsp;&nbsp; folks: **4,258**  &nbsp;&nbsp; `4,427 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,225** &nbsp;&nbsp; folks: **605**  &nbsp;&nbsp; `5,690 stars this month`
...
1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    ...
    - language: **PowerShell** &nbsp;&nbsp; stars: **26,475** &nbsp;&nbsp; folks: **1,461**  &nbsp;&nbsp; `10,513 stars this month`
...
1. [GyulyVGC / sniffnet](https://github.com/GyulyVGC/sniffnet)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **29,530** &nbsp;&nbsp; folks: **988**  &nbsp;&nbsp; `4,972 stars this month`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,779** &nbsp;&nbsp; folks: **495**  &nbsp;&nbsp; `4,284 stars this month`
...
1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **75,767** &nbsp;&nbsp; folks: **16,746**  &nbsp;&nbsp; `2,560 stars this month`

1. [google-gemini / gemini-cli](https://github.com/google-gemini/gemini-cli)
    - An open-source AI agent that brings the power of Gemini directly into your terminal.
    - language: **TypeScript** &nbsp;&nbsp; stars: **65,049** &nbsp;&nbsp; folks: **6,203**  &nbsp;&nbsp; `31,091 stars this month`
