...
`更新时间：2025-01-23 15:20:10 +0800`

## 今日热门仓库

1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **19,386** &nbsp;&nbsp; folks: **1,091**  &nbsp;&nbsp; `131 stars today`
...
1. [yorukot / superfile](https://github.com/yorukot/superfile)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **9,883** &nbsp;&nbsp; folks: **225**  &nbsp;&nbsp; `76 stars today`

1. [Dokploy / dokploy](https://github.com/Dokploy/dokploy)
    - Open Source Alternative to Vercel, Netlify and Heroku.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,836** &nbsp;&nbsp; folks: **760**  &nbsp;&nbsp; `564 stars today`

1. [shadps4-emu / shadPS4](https://github.com/shadps4-emu/shadPS4)
    - PlayStation 4 emulator for Windows, Linux and macOS written in C++
    - language: **C++** &nbsp;&nbsp; stars: **14,422** &nbsp;&nbsp; folks: **930**  &nbsp;&nbsp; `644 stars today`
...
1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,439** &nbsp;&nbsp; folks: **692**  &nbsp;&nbsp; `202 stars today`
...
1. [OpenBMB / MiniCPM-o](https://github.com/OpenBMB/MiniCPM-o)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,519** &nbsp;&nbsp; folks: **1,255**  &nbsp;&nbsp; `4,359 stars this week`

1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **43,802** &nbsp;&nbsp; folks: **4,672**  &nbsp;&nbsp; `2,479 stars this week`

1. [KoljaB / RealtimeSTT](https://github.com/KoljaB/RealtimeSTT)
    - A robust, efficient, low-latency speech-to-text library with advanced voice activity detection, wake word activation and instant transcription.
    - language: **Python** &nbsp;&nbsp; stars: **4,598** &nbsp;&nbsp; folks: **378**  &nbsp;&nbsp; `1,896 stars this week`

1. [Dokploy / dokploy](https://github.com/Dokploy/dokploy)
    - Open Source Alternative to Vercel, Netlify and Heroku.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,836** &nbsp;&nbsp; folks: **760**  &nbsp;&nbsp; `3,737 stars this week`

1. [PatrickJS / awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules)
    - 📄 A curated list of awesome .cursorrules files
    - language: **无** &nbsp;&nbsp; stars: **7,905** &nbsp;&nbsp; folks: **521**  &nbsp;&nbsp; `1,883 stars this week`
...
1. [TabbyML / tabby](https://github.com/TabbyML/tabby)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **28,873** &nbsp;&nbsp; folks: **1,317**  &nbsp;&nbsp; `2,632 stars this week`
...
1. [getmaxun / maxun](https://github.com/getmaxun/maxun)
    - 🔥 Open-source no-code web data extraction platform. Turn websites to APIs and spreadsheets with no-code robots in minutes [In Beta]
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,394** &nbsp;&nbsp; folks: **646**  &nbsp;&nbsp; `1,044 stars this week`

1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    - 🚀🤖 Crawl4AI: Open-source LLM Friendly Web Crawler & Scraper
    - language: **Python** &nbsp;&nbsp; stars: **26,842** &nbsp;&nbsp; folks: **2,103**  &nbsp;&nbsp; `1,777 stars this week`

1. [henrygd / beszel](https://github.com/henrygd/beszel)
    - Lightweight server monitoring hub with historical data, docker stats, and alerts.
    - language: **Go** &nbsp;&nbsp; stars: **6,630** &nbsp;&nbsp; folks: **189**  &nbsp;&nbsp; `1,419 stars this week`
...
1. [ton-blockchain / ton](https://github.com/ton-blockchain/ton)
    - Main TON monorepo
    - language: **C++** &nbsp;&nbsp; stars: **3,392** &nbsp;&nbsp; folks: **1,095**  &nbsp;&nbsp; `188 stars this week`
...
1. [NVlabs / Sana](https://github.com/NVlabs/Sana)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,067** &nbsp;&nbsp; folks: **180**  &nbsp;&nbsp; `615 stars this week`
...
1. [OpenBMB / MiniCPM-o](https://github.com/OpenBMB/MiniCPM-o)
    - MiniCPM-o 2.6: A GPT-4o Level MLLM for Vision, Speech and Multimodal Live Streaming on Your Phone
    - language: **Python** &nbsp;&nbsp; stars: **17,519** &nbsp;&nbsp; folks: **1,255**  &nbsp;&nbsp; `4,912 stars this month`

1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    - 🚀🤖 Crawl4AI: Open-source LLM Friendly Web Crawler & Scraper
    - language: **Python** &nbsp;&nbsp; stars: **26,842** &nbsp;&nbsp; folks: **2,103**  &nbsp;&nbsp; `8,220 stars this month`
...
1. [elizaOS / eliza](https://github.com/elizaOS/eliza)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,669** &nbsp;&nbsp; folks: **3,666**  &nbsp;&nbsp; `7,069 stars this month`
...
1. [bytedance / monolith](https://github.com/bytedance/monolith)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,222** &nbsp;&nbsp; folks: **626**  &nbsp;&nbsp; `5,363 stars this month`

1. [cline / cline](https://github.com/cline/cline)
    - Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way.
    - language: **TypeScript** &nbsp;&nbsp; stars: **23,860** &nbsp;&nbsp; folks: **2,156**  &nbsp;&nbsp; `8,048 stars this month`

1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    - 🚀🚀 「大模型」3小时完全从0训练26M的小参数GPT！🌏 Train a 26M-parameter GPT from scratch in just 3 hours!
    - language: **Python** &nbsp;&nbsp; stars: **6,439** &nbsp;&nbsp; folks: **692**  &nbsp;&nbsp; `3,207 stars this month`
...
1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **43,802** &nbsp;&nbsp; folks: **4,672**  &nbsp;&nbsp; `3,627 stars this month`

1. [TabbyML / tabby](https://github.com/TabbyML/tabby)
    - Self-hosted AI coding assistant
    - language: **Rust** &nbsp;&nbsp; stars: **28,873** &nbsp;&nbsp; folks: **1,317**  &nbsp;&nbsp; `6,636 stars this month`

1. [microsoft / PromptWizard](https://github.com/microsoft/PromptWizard)
    - Task-Aware Agent-driven Prompt Optimization Framework
    - language: **Python** &nbsp;&nbsp; stars: **2,274** &nbsp;&nbsp; folks: **191**  &nbsp;&nbsp; `1,719 stars this month`
...
1. [patchy631 / ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)
    - 无
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **1,939** &nbsp;&nbsp; folks: **410**  &nbsp;&nbsp; `1,223 stars this month`

1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    - Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.
    - language: **TypeScript** &nbsp;&nbsp; stars: **56,087** &nbsp;&nbsp; folks: **10,527**  &nbsp;&nbsp; `4,120 stars this month`
...
1. [PatrickJS / awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules)
    - 📄 A curated list of awesome .cursorrules files
    - language: **无** &nbsp;&nbsp; stars: **7,905** &nbsp;&nbsp; folks: **521**  &nbsp;&nbsp; `3,648 stars this month`
