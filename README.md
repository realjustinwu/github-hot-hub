...
`更新时间：2025-09-06 19:16:42 +0800`

## 今日热门仓库

1. [zama-ai / fhevm](https://github.com/zama-ai/fhevm)
    - FHEVM, a full-stack framework for integrating Fully Homomorphic Encryption (FHE) with blockchain applications
    - language: **Rust** &nbsp;&nbsp; stars: **16,875** &nbsp;&nbsp; folks: **693**  &nbsp;&nbsp; `182 stars today`
...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **3,475** &nbsp;&nbsp; folks: **269**  &nbsp;&nbsp; `38 stars today`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **65,105** &nbsp;&nbsp; folks: **5,559**  &nbsp;&nbsp; `69 stars today`
...
1. [chiphuyen / aie-book](https://github.com/chiphuyen/aie-book)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **7,920** &nbsp;&nbsp; folks: **1,048**  &nbsp;&nbsp; `1,881 stars this week`

1. [OpenBMB / MiniCPM-V](https://github.com/OpenBMB/MiniCPM-V)
    - MiniCPM-V 4.5: A GPT-4o Level MLLM for Single Image, Multi Image and High-FPS Video Understanding on Your Phone
    - language: **Python** &nbsp;&nbsp; stars: **21,363** &nbsp;&nbsp; folks: **1,590**  &nbsp;&nbsp; `934 stars this week`

1. [laramies / theHarvester](https://github.com/laramies/theHarvester)
    - E-mails, subdomains and names Harvester - OSINT
    - language: **Python** &nbsp;&nbsp; stars: **14,267** &nbsp;&nbsp; folks: **2,290**  &nbsp;&nbsp; `896 stars this week`
...
1. [microsoft / RD-Agent](https://github.com/microsoft/RD-Agent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,446** &nbsp;&nbsp; folks: **774**  &nbsp;&nbsp; `203 stars this week`
...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,240** &nbsp;&nbsp; folks: **1,734**  &nbsp;&nbsp; `7,824 stars this month`

1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **38,949** &nbsp;&nbsp; folks: **4,500**  &nbsp;&nbsp; `7,190 stars this month`

1. [langchain-ai / open-swe](https://github.com/langchain-ai/open-swe)
    - An Open-Source Asynchronous Coding Agent
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,677** &nbsp;&nbsp; folks: **585**  &nbsp;&nbsp; `4,580 stars this month`
...
1. [OpenBMB / MiniCPM-V](https://github.com/OpenBMB/MiniCPM-V)
    - MiniCPM-V 4.5: A GPT-4o Level MLLM for Single Image, Multi Image and High-FPS Video Understanding on Your Phone
    - language: **Python** &nbsp;&nbsp; stars: **21,363** &nbsp;&nbsp; folks: **1,590**  &nbsp;&nbsp; `1,442 stars this month`
