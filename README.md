...
`更新时间：2025-09-08 13:23:39 +0800`

## 今日热门仓库

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **10,119** &nbsp;&nbsp; folks: **825**  &nbsp;&nbsp; `264 stars today`
...
1. [coleam00 / ottomator-agents](https://github.com/coleam00/ottomator-agents)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,057** &nbsp;&nbsp; folks: **1,445**  &nbsp;&nbsp; `99 stars today`

1. [juspay / hyperswitch](https://github.com/juspay/hyperswitch)
    - An open source payments switch written in Rust to make payments fast, reliable and affordable
    - language: **Rust** &nbsp;&nbsp; stars: **29,898** &nbsp;&nbsp; folks: **4,079**  &nbsp;&nbsp; `1,975 stars today`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,904** &nbsp;&nbsp; folks: **873**  &nbsp;&nbsp; `305 stars today`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **65,593** &nbsp;&nbsp; folks: **5,587**  &nbsp;&nbsp; `288 stars today`
...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **3,968** &nbsp;&nbsp; folks: **281**  &nbsp;&nbsp; `307 stars today`

1. [microsoft / BitNet](https://github.com/microsoft/BitNet)
    - Official inference framework for 1-bit LLMs
    - language: **Python** &nbsp;&nbsp; stars: **21,755** &nbsp;&nbsp; folks: **1,658**  &nbsp;&nbsp; `119 stars today`

1. [uutils / coreutils](https://github.com/uutils/coreutils)
    - Cross-platform Rust rewrite of the GNU coreutils
    - language: **Rust** &nbsp;&nbsp; stars: **21,194** &nbsp;&nbsp; folks: **1,537**  &nbsp;&nbsp; `32 stars today`

1. [pathwaycom / pathway](https://github.com/pathwaycom/pathway)
    - Python ETL framework for stream processing, real-time analytics, LLM pipelines, and RAG.
    - language: **Python** &nbsp;&nbsp; stars: **38,038** &nbsp;&nbsp; folks: **1,117**  &nbsp;&nbsp; `2,214 stars today`

1. [pathwaycom / llm-app](https://github.com/pathwaycom/llm-app)
    - Ready-to-run cloud templates for RAG, AI pipelines, and enterprise search with live data. 🐳Docker-friendly.⚡Always in sync with Sharepoint, Google Drive, S3, Kafka, PostgreSQL, real-time data APIs, and more.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **35,751** &nbsp;&nbsp; folks: **959**  &nbsp;&nbsp; `2,063 stars today`

1. [henrygd / beszel](https://github.com/henrygd/beszel)
    - Lightweight server monitoring hub with historical data, docker stats, and alerts.
    - language: **Go** &nbsp;&nbsp; stars: **14,781** &nbsp;&nbsp; folks: **453**  &nbsp;&nbsp; `53 stars today`

1. [ossu / computer-science](https://github.com/ossu/computer-science)
    - 🎓 Path to a free self-taught education in Computer Science!
    - language: **HTML** &nbsp;&nbsp; stars: **192,285** &nbsp;&nbsp; folks: **24,005**  &nbsp;&nbsp; `413 stars today`
...
1. [Vector-Wangel / XLeRobot](https://github.com/Vector-Wangel/XLeRobot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,100** &nbsp;&nbsp; folks: **201**  &nbsp;&nbsp; `225 stars today`
...
1. [dockur / windows](https://github.com/dockur/windows)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **44,728** &nbsp;&nbsp; folks: **3,249**  &nbsp;&nbsp; `6,152 stars this week`

1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    - Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,904** &nbsp;&nbsp; folks: **626**  &nbsp;&nbsp; `2,808 stars this week`
...
1. [QuentinFuxa / WhisperLiveKit](https://github.com/QuentinFuxa/WhisperLiveKit)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,537** &nbsp;&nbsp; folks: **560**  &nbsp;&nbsp; `2,535 stars this week`
...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    - Distributed query engine providing simple and reliable data processing for any modality and scale
    - language: **Rust** &nbsp;&nbsp; stars: **3,968** &nbsp;&nbsp; folks: **281**  &nbsp;&nbsp; `484 stars this week`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,723** &nbsp;&nbsp; folks: **2,033**  &nbsp;&nbsp; `6,543 stars this month`
...
1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **8,956** &nbsp;&nbsp; folks: **270**  &nbsp;&nbsp; `5,613 stars this month`

1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Open-source platform to build and deploy AI agent workflows.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,417** &nbsp;&nbsp; folks: **1,756**  &nbsp;&nbsp; `7,551 stars this month`
...
1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **44,728** &nbsp;&nbsp; folks: **3,249**  &nbsp;&nbsp; `8,022 stars this month`
...
1. [dtyq / magic](https://github.com/dtyq/magic)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **4,015** &nbsp;&nbsp; folks: **402**  &nbsp;&nbsp; `2,612 stars this month`
...
1. [aliasrobotics / cai](https://github.com/aliasrobotics/cai)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,625** &nbsp;&nbsp; folks: **495**  &nbsp;&nbsp; `1,619 stars this month`
