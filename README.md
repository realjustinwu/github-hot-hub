...
1. [karpathy / nanoGPT](https://github.com/karpathy/nanoGPT)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **45,719** &nbsp;&nbsp; folks: **7,763**  &nbsp;&nbsp; `299 stars today`
...
1. [EvolutionAPI / evolution-api](https://github.com/EvolutionAPI/evolution-api)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,766** &nbsp;&nbsp; folks: **4,501**  &nbsp;&nbsp; `25 stars today`
...
1. [devlikeapro / waha](https://github.com/devlikeapro/waha)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,571** &nbsp;&nbsp; folks: **930**  &nbsp;&nbsp; `330 stars today`
...
1. [dair-ai / Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide)
    ...
    - language: **MDX** &nbsp;&nbsp; stars: **63,897** &nbsp;&nbsp; folks: **6,670**  &nbsp;&nbsp; `338 stars today`

1. [nanobrowser / nanobrowser](https://github.com/nanobrowser/nanobrowser)
    - Open-Source Chrome extension for AI-powered web automation. Run multi-agent workflows using your own LLM API key. Alternative to OpenAI Operator.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,097** &nbsp;&nbsp; folks: **1,024**  &nbsp;&nbsp; `35 stars today`

1. [czlonkowski / n8n-mcp](https://github.com/czlonkowski/n8n-mcp)
    - A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8n workflows for you
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,446** &nbsp;&nbsp; folks: **1,598**  &nbsp;&nbsp; `89 stars today`
...
1. [anthropics / prompt-eng-interactive-tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial)
    - Anthropic's Interactive Prompt Engineering Tutorial
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **23,799** &nbsp;&nbsp; folks: **2,193**  &nbsp;&nbsp; `3,502 stars this week`

1. [Stremio / stremio-web](https://github.com/Stremio/stremio-web)
    - Stremio - Freedom to Stream
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,043** &nbsp;&nbsp; folks: **895**  &nbsp;&nbsp; `4,987 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **TypeScript** &nbsp;&nbsp; stars: **39,000** &nbsp;&nbsp; folks: **2,456**  &nbsp;&nbsp; `3,247 stars this week`

1. [evershopcommerce / evershop](https://github.com/evershopcommerce/evershop)
    - 🛍️ Typescript E-commerce Platform
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,547** &nbsp;&nbsp; folks: **1,911**  &nbsp;&nbsp; `1,718 stars this week`
...
1. [supermemoryai / supermemory](https://github.com/supermemoryai/supermemory)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,038** &nbsp;&nbsp; folks: **1,274**  &nbsp;&nbsp; `904 stars this week`
...
1. [nitrojs / nitro](https://github.com/nitrojs/nitro)
    - Next Generation Server Toolkit. Create web servers with everything you need and deploy them wherever you prefer.
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,726** &nbsp;&nbsp; folks: **707**  &nbsp;&nbsp; `626 stars this week`
...
1. [sapientinc / HRM](https://github.com/sapientinc/HRM)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,067** &nbsp;&nbsp; folks: **1,631**  &nbsp;&nbsp; `200 stars this week`
...
1. [daytonaio / daytona](https://github.com/daytonaio/daytona)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **23,742** &nbsp;&nbsp; folks: **2,400**  &nbsp;&nbsp; `2,091 stars this week`
...
1. [Alibaba-NLP / DeepResearch](https://github.com/Alibaba-NLP/DeepResearch)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,000** &nbsp;&nbsp; folks: **1,205**  &nbsp;&nbsp; `9,518 stars this month`
...
1. [anthropics / prompt-eng-interactive-tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial)
    - Anthropic's Interactive Prompt Engineering Tutorial
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **23,799** &nbsp;&nbsp; folks: **2,193**  &nbsp;&nbsp; `3,827 stars this month`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **47,626** &nbsp;&nbsp; folks: **5,741**  &nbsp;&nbsp; `7,013 stars this month`

1. [evershopcommerce / evershop](https://github.com/evershopcommerce/evershop)
    - 🛍️ Typescript E-commerce Platform
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,547** &nbsp;&nbsp; folks: **1,911**  &nbsp;&nbsp; `1,796 stars this month`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **372,532** &nbsp;&nbsp; folks: **64,781**  &nbsp;&nbsp; `4,773 stars this month`
...
1. [supermemoryai / supermemory](https://github.com/supermemoryai/supermemory)
    - Memory engine and app that is extremely fast, scalable. The Memory API for the AI era.
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,038** &nbsp;&nbsp; folks: **1,274**  &nbsp;&nbsp; `1,135 stars this month`

1. [elastic / elasticsearch](https://github.com/elastic/elasticsearch)
    - Free and Open Source, Distributed, RESTful Search Engine
    - language: **Java** &nbsp;&nbsp; stars: **75,040** &nbsp;&nbsp; folks: **25,550**  &nbsp;&nbsp; `1,348 stars this month`
