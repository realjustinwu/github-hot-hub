...
`更新时间：2025-06-28 22:21:49 +0800`

## 今日热门仓库

1. [twentyhq / twenty](https://github.com/twentyhq/twenty)
    - Building a modern alternative to Salesforce, powered by the community.
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,948** &nbsp;&nbsp; folks: **3,452**  &nbsp;&nbsp; `431 stars today`

1. [black-forest-labs / flux](https://github.com/black-forest-labs/flux)
    - Official inference repo for FLUX.1 models
    - language: **Python** &nbsp;&nbsp; stars: **22,869** &nbsp;&nbsp; folks: **1,626**  &nbsp;&nbsp; `126 stars today`

1. [GraphiteEditor / Graphite](https://github.com/GraphiteEditor/Graphite)
    - 2D vector & raster editor that melds traditional layers & tools with a modern node-based, non-destructive, procedural workflow.
    - language: **Rust** &nbsp;&nbsp; stars: **13,637** &nbsp;&nbsp; folks: **632**  &nbsp;&nbsp; `263 stars today`
...
1. [adityachandelgit / BookLore](https://github.com/adityachandelgit/BookLore)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,709** &nbsp;&nbsp; folks: **65**  &nbsp;&nbsp; `50 stars today`

1. [coleam00 / ottomator-agents](https://github.com/coleam00/ottomator-agents)
    - All the open source AI Agents hosted on the oTTomator Live Agent Studio platform!
    - language: **Python** &nbsp;&nbsp; stars: **2,844** &nbsp;&nbsp; folks: **1,120**  &nbsp;&nbsp; `563 stars today`

1. [rommapp / romm](https://github.com/rommapp/romm)
    - A beautiful, powerful, self-hosted rom manager and player.
    - language: **Python** &nbsp;&nbsp; stars: **4,893** &nbsp;&nbsp; folks: **205**  &nbsp;&nbsp; `35 stars today`
...
1. [GyulyVGC / sniffnet](https://github.com/GyulyVGC/sniffnet)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **24,760** &nbsp;&nbsp; folks: **784**  &nbsp;&nbsp; `28 stars today`

1. [google-gemini / cookbook](https://github.com/google-gemini/cookbook)
    - Examples and guides for using the Gemini API
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **13,635** &nbsp;&nbsp; folks: **1,876**  &nbsp;&nbsp; `42 stars today`

1. [pot-app / pot-desktop](https://github.com/pot-app/pot-desktop)
    - 🌈一个跨平台的划词翻译和OCR软件 | A cross-platform software for text translation and recognition.
    - language: **JavaScript** &nbsp;&nbsp; stars: **13,144** &nbsp;&nbsp; folks: **604**  &nbsp;&nbsp; `202 stars today`
...
1. [DrKLO / Telegram](https://github.com/DrKLO/Telegram)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **26,835** &nbsp;&nbsp; folks: **8,649**  &nbsp;&nbsp; `559 stars this week`
...
1. [twentyhq / twenty](https://github.com/twentyhq/twenty)
    - Building a modern alternative to Salesforce, powered by the community.
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,948** &nbsp;&nbsp; folks: **3,452**  &nbsp;&nbsp; `1,202 stars this week`

1. [coleam00 / ottomator-agents](https://github.com/coleam00/ottomator-agents)
    - All the open source AI Agents hosted on the oTTomator Live Agent Studio platform!
    - language: **Python** &nbsp;&nbsp; stars: **2,844** &nbsp;&nbsp; folks: **1,120**  &nbsp;&nbsp; `280 stars this week`

1. [patchy631 / ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)
    - In-depth tutorials on LLMs, RAGs and real-world AI agent applications.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **12,914** &nbsp;&nbsp; folks: **2,159**  &nbsp;&nbsp; `2,662 stars this week`

1. [typst / typst](https://github.com/typst/typst)
    - A new markup-based typesetting system that is powerful and easy to learn.
    - language: **Rust** &nbsp;&nbsp; stars: **43,378** &nbsp;&nbsp; folks: **1,158**  &nbsp;&nbsp; `1,125 stars this week`

1. [HKUDS / AutoAgent](https://github.com/HKUDS/AutoAgent)
    - "AutoAgent: Fully-Automated and Zero-Code LLM Agent Framework"
    - language: **Python** &nbsp;&nbsp; stars: **5,200** &nbsp;&nbsp; folks: **728**  &nbsp;&nbsp; `391 stars this week`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **46,709** &nbsp;&nbsp; folks: **5,329**  &nbsp;&nbsp; `14,049 stars this month`
...
1. [tensorzero / tensorzero](https://github.com/tensorzero/tensorzero)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **8,124** &nbsp;&nbsp; folks: **498**  &nbsp;&nbsp; `3,794 stars this month`

1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    - 😎 Awesome lists about all kinds of interesting topics
    - language: **无** &nbsp;&nbsp; stars: **375,299** &nbsp;&nbsp; folks: **30,031**  &nbsp;&nbsp; `13,024 stars this month`
...
1. [anthropics / anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **17,232** &nbsp;&nbsp; folks: **1,783**  &nbsp;&nbsp; `4,783 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **16,105** &nbsp;&nbsp; folks: **888**  &nbsp;&nbsp; `5,679 stars this month`
...
1. [DrKLO / Telegram](https://github.com/DrKLO/Telegram)
    - Telegram for Android source
    - language: **Java** &nbsp;&nbsp; stars: **26,835** &nbsp;&nbsp; folks: **8,649**  &nbsp;&nbsp; `697 stars this month`
...
1. [linshenkx / prompt-optimizer](https://github.com/linshenkx/prompt-optimizer)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,133** &nbsp;&nbsp; folks: **1,014**  &nbsp;&nbsp; `2,896 stars this month`
