...
1. [remoteintech / remote-jobs](https://github.com/remoteintech/remote-jobs)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **33,536** &nbsp;&nbsp; folks: **3,439**  &nbsp;&nbsp; `721 stars today`

1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The personal finance app for everyone
    - language: **Ruby** &nbsp;&nbsp; stars: **47,612** &nbsp;&nbsp; folks: **3,539**  &nbsp;&nbsp; `1,858 stars today`
...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,259** &nbsp;&nbsp; folks: **781**  &nbsp;&nbsp; `177 stars today`

1. [roboflow / supervision](https://github.com/roboflow/supervision)
    - We write your reusable computer vision tools. 💜
    - language: **Python** &nbsp;&nbsp; stars: **27,806** &nbsp;&nbsp; folks: **2,172**  &nbsp;&nbsp; `212 stars today`
...
1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **5,471** &nbsp;&nbsp; folks: **764**  &nbsp;&nbsp; `247 stars today`

1. [tracel-ai / burn](https://github.com/tracel-ai/burn)
    - Burn is a next generation Deep Learning Framework that doesn't compromise on flexibility, efficiency and portability.
    - language: **Rust** &nbsp;&nbsp; stars: **11,784** &nbsp;&nbsp; folks: **626**  &nbsp;&nbsp; `79 stars today`
...
1. [bknd-io / bknd](https://github.com/bknd-io/bknd)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,763** &nbsp;&nbsp; folks: **85**  &nbsp;&nbsp; `343 stars today`
...
1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **121,486** &nbsp;&nbsp; folks: **36,516**  &nbsp;&nbsp; `584 stars today`
...
1. [topjohnwu / Magisk](https://github.com/topjohnwu/Magisk)
    ...
    - language: **Kotlin** &nbsp;&nbsp; stars: **54,493** &nbsp;&nbsp; folks: **14,350**  &nbsp;&nbsp; `31 stars today`
...
1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **5,471** &nbsp;&nbsp; folks: **764**  &nbsp;&nbsp; `886 stars this week`
...
1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The personal finance app for everyone
    - language: **Ruby** &nbsp;&nbsp; stars: **47,612** &nbsp;&nbsp; folks: **3,539**  &nbsp;&nbsp; `2,156 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **24,806** &nbsp;&nbsp; folks: **1,360**  &nbsp;&nbsp; `5,628 stars this week`

1. [gitleaks / gitleaks](https://github.com/gitleaks/gitleaks)
    - Find secrets with Gitleaks 🔑
    - language: **Go** &nbsp;&nbsp; stars: **22,275** &nbsp;&nbsp; folks: **1,711**  &nbsp;&nbsp; `676 stars this week`
...
1. [hyprwm / Hyprland](https://github.com/hyprwm/Hyprland)
    - Hyprland is an independent, highly customizable, dynamic tiling Wayland compositor that doesn't sacrifice on its looks.
    - language: **C++** &nbsp;&nbsp; stars: **28,032** &nbsp;&nbsp; folks: **1,185**  &nbsp;&nbsp; `604 stars this week`
...
1. [humanlayer / 12-factor-agents](https://github.com/humanlayer/12-factor-agents)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,693** &nbsp;&nbsp; folks: **621**  &nbsp;&nbsp; `5,156 stars this month`
...
1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **24,806** &nbsp;&nbsp; folks: **1,360**  &nbsp;&nbsp; `10,967 stars this month`
...
1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **75,112** &nbsp;&nbsp; folks: **16,597**  &nbsp;&nbsp; `2,385 stars this month`
...
1. [stanford-oval / storm](https://github.com/stanford-oval/storm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **26,833** &nbsp;&nbsp; folks: **2,412**  &nbsp;&nbsp; `2,248 stars this month`
