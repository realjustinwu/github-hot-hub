...
1. [QuentinFuxa / WhisperLiveKit](https://github.com/QuentinFuxa/WhisperLiveKit)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,014** &nbsp;&nbsp; folks: **301**  &nbsp;&nbsp; `272 stars today`

1. [microsoft / mcp](https://github.com/microsoft/mcp)
    - Catalog of official Microsoft MCP (Model Context Protocol) server implementations for AI-powered data access and tool integration
    - language: **C#** &nbsp;&nbsp; stars: **1,162** &nbsp;&nbsp; folks: **112**  &nbsp;&nbsp; `74 stars today`
...
1. [Canner / WrenAI](https://github.com/Canner/WrenAI)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,790** &nbsp;&nbsp; folks: **1,093**  &nbsp;&nbsp; `547 stars today`
...
1. [twbs / bootstrap](https://github.com/twbs/bootstrap)
    ...
    - language: **MDX** &nbsp;&nbsp; stars: **173,227** &nbsp;&nbsp; folks: **79,149**  &nbsp;&nbsp; `126 stars today`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **205,158** &nbsp;&nbsp; folks: **47,555**  &nbsp;&nbsp; `195 stars today`
...
1. [humanlayer / humanlayer](https://github.com/humanlayer/humanlayer)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,502** &nbsp;&nbsp; folks: **146**  &nbsp;&nbsp; `57 stars today`

1. [nats-io / nats-server](https://github.com/nats-io/nats-server)
    - High-Performance server for NATS.io, the cloud and edge native messaging system.
    - language: **Go** &nbsp;&nbsp; stars: **18,001** &nbsp;&nbsp; folks: **1,625**  &nbsp;&nbsp; `26 stars today`

1. [spf13 / cobra](https://github.com/spf13/cobra)
    - A Commander for modern Go CLI interactions
    - language: **Go** &nbsp;&nbsp; stars: **41,706** &nbsp;&nbsp; folks: **2,985**  &nbsp;&nbsp; `9 stars today`

1. [microsoft / terminal](https://github.com/microsoft/terminal)
    - The new Windows Terminal and the original Windows console host, all in the same place!
    - language: **C++** &nbsp;&nbsp; stars: **99,711** &nbsp;&nbsp; folks: **8,720**  &nbsp;&nbsp; `151 stars today`
...
1. [transformerlab / transformerlab-app](https://github.com/transformerlab/transformerlab-app)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,077** &nbsp;&nbsp; folks: **374**  &nbsp;&nbsp; `54 stars today`
...
1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    ...
    - language: **无** &nbsp;&nbsp; stars: **60,879** &nbsp;&nbsp; folks: **6,631**  &nbsp;&nbsp; `188 stars today`
...
1. [plait-board / drawnix](https://github.com/plait-board/drawnix)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,869** &nbsp;&nbsp; folks: **714**  &nbsp;&nbsp; `4,826 stars this week`

1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **11,770** &nbsp;&nbsp; folks: **923**  &nbsp;&nbsp; `5,324 stars this week`
...
1. [HKUDS / DeepCode](https://github.com/HKUDS/DeepCode)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,480** &nbsp;&nbsp; folks: **457**  &nbsp;&nbsp; `3,211 stars this week`
...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,967** &nbsp;&nbsp; folks: **1,514**  &nbsp;&nbsp; `2,337 stars this week`
...
1. [TheAlgorithms / Java](https://github.com/TheAlgorithms/Java)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **63,167** &nbsp;&nbsp; folks: **20,223**  &nbsp;&nbsp; `412 stars this week`

1. [twbs / bootstrap](https://github.com/twbs/bootstrap)
    - The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web.
    - language: **MDX** &nbsp;&nbsp; stars: **173,227** &nbsp;&nbsp; folks: **79,149**  &nbsp;&nbsp; `354 stars this week`
...
1. [microsoft / qlib](https://github.com/microsoft/qlib)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **29,252** &nbsp;&nbsp; folks: **4,517**  &nbsp;&nbsp; `553 stars this week`

1. [Leantime / leantime](https://github.com/Leantime/leantime)
    - Leantime is a goals focused project management system for non-project managers. Building with ADHD, Autism, and dyslexia in mind.
    - language: **PHP** &nbsp;&nbsp; stars: **7,765** &nbsp;&nbsp; folks: **750**  &nbsp;&nbsp; `1,351 stars this week`

1. [Arindam200 / awesome-ai-apps](https://github.com/Arindam200/awesome-ai-apps)
    - A collection of projects showcasing RAG, agents, workflows, and other AI use cases
    - language: **Python** &nbsp;&nbsp; stars: **4,412** &nbsp;&nbsp; folks: **570**  &nbsp;&nbsp; `964 stars this week`

1. [microsoft / terminal](https://github.com/microsoft/terminal)
    - The new Windows Terminal and the original Windows console host, all in the same place!
    - language: **C++** &nbsp;&nbsp; stars: **99,711** &nbsp;&nbsp; folks: **8,720**  &nbsp;&nbsp; `417 stars this week`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **11,770** &nbsp;&nbsp; folks: **923**  &nbsp;&nbsp; `10,025 stars this month`

1. [charmbracelet / crush](https://github.com/charmbracelet/crush)
    - The glamourous AI coding agent for your favourite terminal 💘
    - language: **Go** &nbsp;&nbsp; stars: **11,206** &nbsp;&nbsp; folks: **546**  &nbsp;&nbsp; `11,145 stars this month`
...
1. [plait-board / drawnix](https://github.com/plait-board/drawnix)
    - 开源白板工具（SaaS），一体化白板，包含思维导图、流程图、自由画等。All in one open-source whiteboard tool with mind, flowchart, freehand and etc.
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,869** &nbsp;&nbsp; folks: **714**  &nbsp;&nbsp; `6,830 stars this month`

1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Sim is an open-source AI agent workflow builder. Sim's interface is a lightweight, intuitive way to rapidly build and deploy LLMs that connect with your favorite tools.
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,967** &nbsp;&nbsp; folks: **1,514**  &nbsp;&nbsp; `6,780 stars this month`
...
1. [9001 / copyparty](https://github.com/9001/copyparty)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **27,720** &nbsp;&nbsp; folks: **1,039**  &nbsp;&nbsp; `18,691 stars this month`
