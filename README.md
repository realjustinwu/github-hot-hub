...
`更新时间：2025-04-17 13:23:49 +0800`

## 今日热门仓库

1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    - An AI Hedge Fund Team
    - language: **Python** &nbsp;&nbsp; stars: **24,383** &nbsp;&nbsp; folks: **4,225**  &nbsp;&nbsp; `1,590 stars today`

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **73,310** &nbsp;&nbsp; folks: **9,099**  &nbsp;&nbsp; `1,010 stars today`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **18,164** &nbsp;&nbsp; folks: **2,169**  &nbsp;&nbsp; `1,032 stars today`
...
1. [Zackriya-Solutions / meeting-minutes](https://github.com/Zackriya-Solutions/meeting-minutes)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,414** &nbsp;&nbsp; folks: **238**  &nbsp;&nbsp; `384 stars today`

1. [NirDiamant / RAG_Techniques](https://github.com/NirDiamant/RAG_Techniques)
    - This repository showcases various advanced techniques for Retrieval-Augmented Generation (RAG) systems. RAG systems combine information retrieval with generative models to provide accurate and contextually rich responses.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **14,567** &nbsp;&nbsp; folks: **1,479**  &nbsp;&nbsp; `252 stars today`
...
1. [svcvit / Awesome-Dify-Workflow](https://github.com/svcvit/Awesome-Dify-Workflow)
    ...
    - language: **无** &nbsp;&nbsp; stars: **6,020** &nbsp;&nbsp; folks: **592**  &nbsp;&nbsp; `394 stars today`
...
1. [neovim / nvim-lspconfig](https://github.com/neovim/nvim-lspconfig)
    ...
    - language: **Lua** &nbsp;&nbsp; stars: **11,674** &nbsp;&nbsp; folks: **2,173**  &nbsp;&nbsp; `16 stars today`

1. [scylladb / scylladb](https://github.com/scylladb/scylladb)
    - NoSQL data store using the Seastar framework, compatible with Apache Cassandra and Amazon DynamoDB
    - language: **C++** &nbsp;&nbsp; stars: **14,388** &nbsp;&nbsp; folks: **1,371**  &nbsp;&nbsp; `24 stars today`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    - [Support 0.48.x]（Reset Cursor AI MachineID & Bypass Higher Token Limit） Cursor Ai ，自动重置机器ID ， 免费升级使用Pro功能: You've reached your trial request limit. / Too many free trial accounts used on this machine. Please upgrade to pro. We have this limit in place to prevent abuse. Please let us know if you believe this is a mistake.
    - language: **Python** &nbsp;&nbsp; stars: **18,164** &nbsp;&nbsp; folks: **2,169**  &nbsp;&nbsp; `10,598 stars this week`

1. [Zackriya-Solutions / meeting-minutes](https://github.com/Zackriya-Solutions/meeting-minutes)
    - A free and open source, self hosted Ai based live meeting note taker and minutes summary generator that can completely run in your Local device (Mac OS and windows OS Support added. Working on adding linux support soon) https://meetily.zackriya.com/
    - language: **C++** &nbsp;&nbsp; stars: **3,414** &nbsp;&nbsp; folks: **238**  &nbsp;&nbsp; `1,672 stars this week`
...
1. [juliangarnier / anime](https://github.com/juliangarnier/anime)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **57,780** &nbsp;&nbsp; folks: **3,953**  &nbsp;&nbsp; `1,626 stars this week`
...
1. [getmaxun / maxun](https://github.com/getmaxun/maxun)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,681** &nbsp;&nbsp; folks: **905**  &nbsp;&nbsp; `1,026 stars this week`

1. [clockworklabs / SpacetimeDB](https://github.com/clockworklabs/SpacetimeDB)
    - Multiplayer at the speed of light
    - language: **Rust** &nbsp;&nbsp; stars: **14,099** &nbsp;&nbsp; folks: **457**  &nbsp;&nbsp; `1,896 stars this week`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    - [Support 0.48.x]（Reset Cursor AI MachineID & Bypass Higher Token Limit） Cursor Ai ，自动重置机器ID ， 免费升级使用Pro功能: You've reached your trial request limit. / Too many free trial accounts used on this machine. Please upgrade to pro. We have this limit in place to prevent abuse. Please let us know if you believe this is a mistake.
    - language: **Python** &nbsp;&nbsp; stars: **18,164** &nbsp;&nbsp; folks: **2,169**  &nbsp;&nbsp; `15,200 stars this month`

1. [punkpeye / awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)
    - A collection of MCP servers.
    - language: **无** &nbsp;&nbsp; stars: **38,776** &nbsp;&nbsp; folks: **2,751**  &nbsp;&nbsp; `28,848 stars this month`
...
1. [th-ch / youtube-music](https://github.com/th-ch/youtube-music)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,358** &nbsp;&nbsp; folks: **951**  &nbsp;&nbsp; `7,147 stars this month`

1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    - real time face swap and one-click video deepfake with only a single image
    - language: **Python** &nbsp;&nbsp; stars: **50,289** &nbsp;&nbsp; folks: **7,451**  &nbsp;&nbsp; `5,815 stars this month`

1. [ourongxing / newsnow](https://github.com/ourongxing/newsnow)
    - Elegant reading of real-time and hottest news
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,811** &nbsp;&nbsp; folks: **2,450**  &nbsp;&nbsp; `4,168 stars this month`

1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    - Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.
    - language: **TypeScript** &nbsp;&nbsp; stars: **82,014** &nbsp;&nbsp; folks: **21,907**  &nbsp;&nbsp; `14,388 stars this month`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **28,276** &nbsp;&nbsp; folks: **3,175**  &nbsp;&nbsp; `8,669 stars this month`
