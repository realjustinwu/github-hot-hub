...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,914** &nbsp;&nbsp; folks: **913**  &nbsp;&nbsp; `237 stars today`
...
1. [python-poetry / poetry](https://github.com/python-poetry/poetry)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,678** &nbsp;&nbsp; folks: **2,366**  &nbsp;&nbsp; `25 stars today`

1. [blakeblackshear / frigate](https://github.com/blakeblackshear/frigate)
    - NVR with realtime local object detection for IP cameras
    - language: **TypeScript** &nbsp;&nbsp; stars: **24,811** &nbsp;&nbsp; folks: **2,293**  &nbsp;&nbsp; `180 stars today`
...
1. [openssl / openssl](https://github.com/openssl/openssl)
    ...
    - language: **C** &nbsp;&nbsp; stars: **28,251** &nbsp;&nbsp; folks: **10,761**  &nbsp;&nbsp; `105 stars today`
...
1. [dstotijn / hetty](https://github.com/dstotijn/hetty)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **7,927** &nbsp;&nbsp; folks: **437**  &nbsp;&nbsp; `103 stars today`
...
1. [confident-ai / deepeval](https://github.com/confident-ai/deepeval)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,970** &nbsp;&nbsp; folks: **862**  &nbsp;&nbsp; `46 stars today`
...
1. [openai / openai-cookbook](https://github.com/openai/openai-cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **66,139** &nbsp;&nbsp; folks: **10,981**  &nbsp;&nbsp; `113 stars today`
...
1. [9001 / copyparty](https://github.com/9001/copyparty)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **21,421** &nbsp;&nbsp; folks: **740**  &nbsp;&nbsp; `8,492 stars this week`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,187** &nbsp;&nbsp; folks: **1,030**  &nbsp;&nbsp; `7,977 stars this week`
...
1. [microsoft / mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,792** &nbsp;&nbsp; folks: **2,106**  &nbsp;&nbsp; `1,634 stars this week`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **56,166** &nbsp;&nbsp; folks: **6,638**  &nbsp;&nbsp; `2,165 stars this week`
...
1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **95,248** &nbsp;&nbsp; folks: **13,942**  &nbsp;&nbsp; `991 stars this week`
...
1. [rasbt / LLMs-from-scratch](https://github.com/rasbt/LLMs-from-scratch)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **62,674** &nbsp;&nbsp; folks: **8,781**  &nbsp;&nbsp; `2,057 stars this week`

1. [comfyanonymous / ComfyUI](https://github.com/comfyanonymous/ComfyUI)
    - The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface.
    - language: **Python** &nbsp;&nbsp; stars: **84,707** &nbsp;&nbsp; folks: **9,394**  &nbsp;&nbsp; `729 stars this week`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,971** &nbsp;&nbsp; folks: **807**  &nbsp;&nbsp; `1,742 stars this week`
...
1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,187** &nbsp;&nbsp; folks: **1,030**  &nbsp;&nbsp; `8,334 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,972** &nbsp;&nbsp; folks: **807**  &nbsp;&nbsp; `7,691 stars this month`

1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    - Python tool for converting files and office documents to Markdown.
    - language: **Python** &nbsp;&nbsp; stars: **70,547** &nbsp;&nbsp; folks: **3,816**  &nbsp;&nbsp; `10,856 stars this month`

1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    - MCP Toolbox for Databases is an open source MCP server for databases.
    - language: **Go** &nbsp;&nbsp; stars: **8,997** &nbsp;&nbsp; folks: **650**  &nbsp;&nbsp; `7,252 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **28,451** &nbsp;&nbsp; folks: **1,599**  &nbsp;&nbsp; `10,775 stars this month`
...
1. [humanlayer / 12-factor-agents](https://github.com/humanlayer/12-factor-agents)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,890** &nbsp;&nbsp; folks: **796**  &nbsp;&nbsp; `5,695 stars this month`

1. [sst / opencode](https://github.com/sst/opencode)
    - AI coding agent, built for the terminal.
    - language: **Go** &nbsp;&nbsp; stars: **17,833** &nbsp;&nbsp; folks: **1,117**  &nbsp;&nbsp; `8,702 stars this month`
