...
1. [FIRST-Tech-Challenge / FtcRobotController](https://github.com/FIRST-Tech-Challenge/FtcRobotController)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **980** &nbsp;&nbsp; folks: **6,692**  &nbsp;&nbsp; `5 stars today`

1. [openwrt / openwrt](https://github.com/openwrt/openwrt)
    - This repository is a mirror of https://git.openwrt.org/openwrt/openwrt.git It is for reference only and is not active for check-ins. We will continue to accept Pull Requests here. They will be merged via staging trees then into openwrt.git.
    - language: **C** &nbsp;&nbsp; stars: **23,576** &nbsp;&nbsp; folks: **11,520**  &nbsp;&nbsp; `23 stars today`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,536** &nbsp;&nbsp; folks: **854**  &nbsp;&nbsp; `299 stars today`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **65,401** &nbsp;&nbsp; folks: **5,576**  &nbsp;&nbsp; `281 stars today`
...
1. [dockur / windows](https://github.com/dockur/windows)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **44,639** &nbsp;&nbsp; folks: **3,245**  &nbsp;&nbsp; `6,784 stars this week`

1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    - Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,761** &nbsp;&nbsp; folks: **613**  &nbsp;&nbsp; `2,671 stars this week`
...
1. [QuentinFuxa / WhisperLiveKit](https://github.com/QuentinFuxa/WhisperLiveKit)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,483** &nbsp;&nbsp; folks: **551**  &nbsp;&nbsp; `2,964 stars this week`
...
1. [resemble-ai / chatterbox](https://github.com/resemble-ai/chatterbox)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **12,188** &nbsp;&nbsp; folks: **1,525**  &nbsp;&nbsp; `1,588 stars this week`
...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    - Distributed query engine providing simple and reliable data processing for any modality and scale
    - language: **Rust** &nbsp;&nbsp; stars: **3,799** &nbsp;&nbsp; folks: **278**  &nbsp;&nbsp; `216 stars this week`
...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,342** &nbsp;&nbsp; folks: **1,750**  &nbsp;&nbsp; `7,705 stars this month`

1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **39,179** &nbsp;&nbsp; folks: **4,530**  &nbsp;&nbsp; `7,280 stars this month`

1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **44,639** &nbsp;&nbsp; folks: **3,245**  &nbsp;&nbsp; `7,923 stars this month`

1. [basecamp / omarchy](https://github.com/basecamp/omarchy)
    - Opinionated Arch/Hyprland Setup
    - language: **Shell** &nbsp;&nbsp; stars: **7,119** &nbsp;&nbsp; folks: **852**  &nbsp;&nbsp; `4,035 stars this month`
