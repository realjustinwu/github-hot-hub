...
1. [kestra-io / kestra](https://github.com/kestra-io/kestra)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **20,758** &nbsp;&nbsp; folks: **1,766**  &nbsp;&nbsp; `203 stars today`

1. [AI4Finance-Foundation / FinGPT](https://github.com/AI4Finance-Foundation/FinGPT)
    - FinGPT: Open-Source Financial Large Language Models! Revolutionize 🔥 We release the trained model on HuggingFace.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **17,199** &nbsp;&nbsp; folks: **2,466**  &nbsp;&nbsp; `49 stars today`
...
1. [apache / airflow](https://github.com/apache/airflow)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **41,875** &nbsp;&nbsp; folks: **15,520**  &nbsp;&nbsp; `22 stars today`

1. [wazuh / wazuh](https://github.com/wazuh/wazuh)
    - Wazuh - The Open Source Security Platform. Unified XDR and SIEM protection for endpoints and cloud workloads.
    - language: **C** &nbsp;&nbsp; stars: **13,272** &nbsp;&nbsp; folks: **1,959**  &nbsp;&nbsp; `14 stars today`
...
1. [dockur / windows](https://github.com/dockur/windows)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **44,390** &nbsp;&nbsp; folks: **3,228**  &nbsp;&nbsp; `7,173 stars this week`
...
1. [QuentinFuxa / WhisperLiveKit](https://github.com/QuentinFuxa/WhisperLiveKit)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,322** &nbsp;&nbsp; folks: **537**  &nbsp;&nbsp; `4,447 stars this week`

1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    - Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,986** &nbsp;&nbsp; folks: **514**  &nbsp;&nbsp; `1,696 stars this week`
...
1. [juspay / hyperswitch](https://github.com/juspay/hyperswitch)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **26,658** &nbsp;&nbsp; folks: **4,007**  &nbsp;&nbsp; `2,100 stars this week`

1. [OpenBMB / MiniCPM-V](https://github.com/OpenBMB/MiniCPM-V)
    - MiniCPM-V 4.5: A GPT-4o Level MLLM for Single Image, Multi Image and High-FPS Video Understanding on Your Phone
    - language: **Python** &nbsp;&nbsp; stars: **21,292** &nbsp;&nbsp; folks: **1,576**  &nbsp;&nbsp; `923 stars this week`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **12,845** &nbsp;&nbsp; folks: **1,067**  &nbsp;&nbsp; `10,892 stars this month`
...
1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **18,964** &nbsp;&nbsp; folks: **3,030**  &nbsp;&nbsp; `10,750 stars this month`

1. [langchain-ai / open-swe](https://github.com/langchain-ai/open-swe)
    - An Open-Source Asynchronous Coding Agent
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,597** &nbsp;&nbsp; folks: **583**  &nbsp;&nbsp; `4,545 stars this month`

1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    - Run Windows apps such as Microsoft Office/Adobe in Linux (Ubuntu/Fedora) and GNOME/KDE as if they were a part of the native OS, including Nautilus integration. Hard fork of https://github.com/Fmstrat/winapps/
    - language: **Shell** &nbsp;&nbsp; stars: **8,745** &nbsp;&nbsp; folks: **264**  &nbsp;&nbsp; `5,295 stars this month`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **38,722** &nbsp;&nbsp; folks: **4,471**  &nbsp;&nbsp; `6,960 stars this month`
...
1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **44,390** &nbsp;&nbsp; folks: **3,228**  &nbsp;&nbsp; `7,653 stars this month`
