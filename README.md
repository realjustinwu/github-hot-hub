...
1. [QuentinFuxa / WhisperLiveKit](https://github.com/QuentinFuxa/WhisperLiveKit)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,822** &nbsp;&nbsp; folks: **370**  &nbsp;&nbsp; `1,349 stars today`

1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **38,409** &nbsp;&nbsp; folks: **2,877**  &nbsp;&nbsp; `624 stars today`
...
1. [JetBrains / koog](https://github.com/JetBrains/koog)
    ...
    - language: **Kotlin** &nbsp;&nbsp; stars: **1,797** &nbsp;&nbsp; folks: **121**  &nbsp;&nbsp; `32 stars today`

1. [gunnarmorling / 1brc](https://github.com/gunnarmorling/1brc)
    - 1️⃣🐝🏎️ The One Billion Row Challenge -- A fun exploration of how quickly 1B rows from a text file can be aggregated with Java
    - language: **Java** &nbsp;&nbsp; stars: **7,172** &nbsp;&nbsp; folks: **2,062**  &nbsp;&nbsp; `24 stars today`

1. [bevyengine / bevy](https://github.com/bevyengine/bevy)
    - A refreshingly simple data-driven game engine built in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **41,291** &nbsp;&nbsp; folks: **4,078**  &nbsp;&nbsp; `24 stars today`

1. [activepieces / activepieces](https://github.com/activepieces/activepieces)
    - AI Agents & MCPs & AI Workflow Automation • (280+ MCP servers for AI agents) • AI Automation / AI Agent with MCPs • AI Workflows & AI Agents • MCPs for AI Agents
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,731** &nbsp;&nbsp; folks: **2,433**  &nbsp;&nbsp; `34 stars today`
...
1. [humanlayer / humanlayer](https://github.com/humanlayer/humanlayer)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,640** &nbsp;&nbsp; folks: **154**  &nbsp;&nbsp; `217 stars today`

1. [paperless-ngx / paperless-ngx](https://github.com/paperless-ngx/paperless-ngx)
    - A community-supported supercharged document management system: scan, index and archive all your documents
    - language: **Python** &nbsp;&nbsp; stars: **31,196** &nbsp;&nbsp; folks: **1,912**  &nbsp;&nbsp; `167 stars today`
...
1. [google / comprehensive-rust](https://github.com/google/comprehensive-rust)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **30,831** &nbsp;&nbsp; folks: **1,845**  &nbsp;&nbsp; `46 stars today`

1. [awesomedata / awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets)
    - A topic-centric list of HQ open datasets.
    - language: **无** &nbsp;&nbsp; stars: **64,890** &nbsp;&nbsp; folks: **10,271**  &nbsp;&nbsp; `125 stars today`
...
1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **17,447** &nbsp;&nbsp; folks: **2,838**  &nbsp;&nbsp; `8,812 stars this week`
...
1. [Canner / WrenAI](https://github.com/Canner/WrenAI)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,064** &nbsp;&nbsp; folks: **1,109**  &nbsp;&nbsp; `1,005 stars this week`

1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **38,410** &nbsp;&nbsp; folks: **2,877**  &nbsp;&nbsp; `1,108 stars this week`
...
1. [microsoft / qlib](https://github.com/microsoft/qlib)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **29,426** &nbsp;&nbsp; folks: **4,544**  &nbsp;&nbsp; `630 stars this week`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **37,577** &nbsp;&nbsp; folks: **4,324**  &nbsp;&nbsp; `1,494 stars this week`
...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,256** &nbsp;&nbsp; folks: **1,541**  &nbsp;&nbsp; `6,951 stars this month`

1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    - Collection of extracted System Prompts from popular chatbots like ChatGPT, Claude & Gemini
    - language: **JavaScript** &nbsp;&nbsp; stars: **17,447** &nbsp;&nbsp; folks: **2,838**  &nbsp;&nbsp; `9,334 stars this month`
...
1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **37,577** &nbsp;&nbsp; folks: **4,324**  &nbsp;&nbsp; `6,070 stars this month`
...
1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,041** &nbsp;&nbsp; folks: **1,203**  &nbsp;&nbsp; `7,211 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **56,743** &nbsp;&nbsp; folks: **9,789**  &nbsp;&nbsp; `3,256 stars this month`
