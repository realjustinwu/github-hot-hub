...
`更新时间：2025-04-18 22:21:51 +0800`

## 今日热门仓库

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **75,611** &nbsp;&nbsp; folks: **9,252**  &nbsp;&nbsp; `1,308 stars today`

1. [jlowin / fastmcp](https://github.com/jlowin/fastmcp)
    - 🚀 The fast, Pythonic way to build MCP servers and clients
    - language: **Python** &nbsp;&nbsp; stars: **5,540** &nbsp;&nbsp; folks: **282**  &nbsp;&nbsp; `232 stars today`

1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    - An AI Hedge Fund Team
    - language: **Python** &nbsp;&nbsp; stars: **25,674** &nbsp;&nbsp; folks: **4,378**  &nbsp;&nbsp; `795 stars today`

1. [microsoft / BitNet](https://github.com/microsoft/BitNet)
    - Official inference framework for 1-bit LLMs
    - language: **C++** &nbsp;&nbsp; stars: **13,674** &nbsp;&nbsp; folks: **953**  &nbsp;&nbsp; `400 stars today`

1. [linera-io / linera-protocol](https://github.com/linera-io/linera-protocol)
    - Main repository for the Linera protocol
    - language: **Rust** &nbsp;&nbsp; stars: **22,807** &nbsp;&nbsp; folks: **1,397**  &nbsp;&nbsp; `1,401 stars today`

1. [docmost / docmost](https://github.com/docmost/docmost)
    - Docmost is an open-source collaborative wiki and documentation software. It is an open-source alternative to Confluence and Notion.
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,898** &nbsp;&nbsp; folks: **670**  &nbsp;&nbsp; `412 stars today`
...
1. [NirDiamant / RAG_Techniques](https://github.com/NirDiamant/RAG_Techniques)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,057** &nbsp;&nbsp; folks: **1,512**  &nbsp;&nbsp; `340 stars today`
...
1. [opf / openproject](https://github.com/opf/openproject)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **10,697** &nbsp;&nbsp; folks: **2,558**  &nbsp;&nbsp; `111 stars today`
...
1. [1Panel-dev / 1Panel](https://github.com/1Panel-dev/1Panel)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **27,012** &nbsp;&nbsp; folks: **2,373**  &nbsp;&nbsp; `284 stars today`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **18,980** &nbsp;&nbsp; folks: **2,292**  &nbsp;&nbsp; `10,342 stars this week`
...
1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    - An AI Hedge Fund Team
    - language: **Python** &nbsp;&nbsp; stars: **25,674** &nbsp;&nbsp; folks: **4,378**  &nbsp;&nbsp; `4,135 stars this week`

1. [krillinai / KrillinAI](https://github.com/krillinai/KrillinAI)
    - A video translation and dubbing tool powered by LLMs, offering professional-grade translations and one-click full-process deployment. It can generate content optimized for platforms like YouTube，TikTok, and Shorts. 基于AI大模型的视频翻译和配音工具，专业级翻译，一键部署全流程，可以生成适配抖音，小红书，哔哩哔哩，视频号，TikTok，Youtube Shorts等形态的内容
    - language: **Go** &nbsp;&nbsp; stars: **4,995** &nbsp;&nbsp; folks: **367**  &nbsp;&nbsp; `3,379 stars this week`
...
1. [jlowin / fastmcp](https://github.com/jlowin/fastmcp)
    - 🚀 The fast, Pythonic way to build MCP servers and clients
    - language: **Python** &nbsp;&nbsp; stars: **5,540** &nbsp;&nbsp; folks: **282**  &nbsp;&nbsp; `1,066 stars this week`
...
1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **43,413** &nbsp;&nbsp; folks: **3,130**  &nbsp;&nbsp; `716 stars this week`

1. [NirDiamant / RAG_Techniques](https://github.com/NirDiamant/RAG_Techniques)
    - This repository showcases various advanced techniques for Retrieval-Augmented Generation (RAG) systems. RAG systems combine information retrieval with generative models to provide accurate and contextually rich responses.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,057** &nbsp;&nbsp; folks: **1,512**  &nbsp;&nbsp; `888 stars this week`

1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    - 10 Lessons to Get Started Building AI Agents
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,625** &nbsp;&nbsp; folks: **3,763**  &nbsp;&nbsp; `3,699 stars this week`

1. [vercel / ai-chatbot](https://github.com/vercel/ai-chatbot)
    - A full-featured, hackable Next.js AI chatbot built by Vercel
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,423** &nbsp;&nbsp; folks: **4,063**  &nbsp;&nbsp; `764 stars this week`

1. [CapSoftware / Cap](https://github.com/CapSoftware/Cap)
    - Open source Loom alternative. Beautiful, shareable screen recordings.
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,704** &nbsp;&nbsp; folks: **436**  &nbsp;&nbsp; `240 stars this week`

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **75,611** &nbsp;&nbsp; folks: **9,252**  &nbsp;&nbsp; `4,069 stars this week`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    - [Support 0.48.x]（Reset Cursor AI MachineID & Bypass Higher Token Limit） Cursor Ai ，自动重置机器ID ， 免费升级使用Pro功能: You've reached your trial request limit. / Too many free trial accounts used on this machine. Please upgrade to pro. We have this limit in place to prevent abuse. Please let us know if you believe this is a mistake.
    - language: **Python** &nbsp;&nbsp; stars: **18,980** &nbsp;&nbsp; folks: **2,292**  &nbsp;&nbsp; `15,605 stars this month`

1. [punkpeye / awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)
    - A collection of MCP servers.
    - language: **无** &nbsp;&nbsp; stars: **39,439** &nbsp;&nbsp; folks: **2,809**  &nbsp;&nbsp; `28,634 stars this month`

1. [ahmedkhaleel2004 / gitdiagram](https://github.com/ahmedkhaleel2004/gitdiagram)
    - Free, simple, fast interactive diagrams for any GitHub repository
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,806** &nbsp;&nbsp; folks: **650**  &nbsp;&nbsp; `6,994 stars this month`
...
1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    - 10 Lessons to Get Started Building AI Agents
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,625** &nbsp;&nbsp; folks: **3,763**  &nbsp;&nbsp; `10,796 stars this month`
...
1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **82,710** &nbsp;&nbsp; folks: **22,147**  &nbsp;&nbsp; `14,588 stars this month`

1. [ourongxing / newsnow](https://github.com/ourongxing/newsnow)
    - Elegant reading of real-time and hottest news
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,914** &nbsp;&nbsp; folks: **2,474**  &nbsp;&nbsp; `4,193 stars this month`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **28,449** &nbsp;&nbsp; folks: **3,202**  &nbsp;&nbsp; `8,685 stars this month`
...
1. [PatrickJS / awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules)
    ...
    - language: **无** &nbsp;&nbsp; stars: **22,348** &nbsp;&nbsp; folks: **1,687**  &nbsp;&nbsp; `6,104 stars this month`
