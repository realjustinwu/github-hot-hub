...
`更新时间：2025-02-09 23:21:52 +0800`

## 今日热门仓库

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **63,728** &nbsp;&nbsp; folks: **9,426**  &nbsp;&nbsp; `369 stars today`

1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding.
    - language: **Python** &nbsp;&nbsp; stars: **33,179** &nbsp;&nbsp; folks: **3,031**  &nbsp;&nbsp; `475 stars today`

1. [unslothai / unsloth](https://github.com/unslothai/unsloth)
    - Finetune Llama 3.3, DeepSeek-R1 & Reasoning LLMs 2x faster with 70% less memory
    - language: **Python** &nbsp;&nbsp; stars: **24,832** &nbsp;&nbsp; folks: **1,692**  &nbsp;&nbsp; `505 stars today`
...
1. [zhayujie / chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,851** &nbsp;&nbsp; folks: **8,706**  &nbsp;&nbsp; `102 stars today`

1. [microsoft / terminal](https://github.com/microsoft/terminal)
    - The new Windows Terminal and the original Windows console host, all in the same place!
    - language: **C++** &nbsp;&nbsp; stars: **96,856** &nbsp;&nbsp; folks: **8,446**  &nbsp;&nbsp; `145 stars today`
...
1. [RockChinQ / LangBot](https://github.com/RockChinQ/LangBot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,305** &nbsp;&nbsp; folks: **417**  &nbsp;&nbsp; `159 stars today`
...
1. [songquanpeng / one-api](https://github.com/songquanpeng/one-api)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **21,793** &nbsp;&nbsp; folks: **4,670**  &nbsp;&nbsp; `65 stars today`

1. [mendableai / firecrawl](https://github.com/mendableai/firecrawl)
    - 🔥 Turn entire websites into LLM-ready markdown or structured data. Scrape, crawl and extract with a single API.
    - language: **TypeScript** &nbsp;&nbsp; stars: **24,291** &nbsp;&nbsp; folks: **1,985**  &nbsp;&nbsp; `329 stars today`
...
1. [Mintplex-Labs / anything-llm](https://github.com/Mintplex-Labs/anything-llm)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **34,928** &nbsp;&nbsp; folks: **3,418**  &nbsp;&nbsp; `402 stars today`
...
1. [practical-tutorials / project-based-learning](https://github.com/practical-tutorials/project-based-learning)
    ...
    - language: **无** &nbsp;&nbsp; stars: **216,504** &nbsp;&nbsp; folks: **28,222**  &nbsp;&nbsp; `275 stars today`
...
1. [Mintplex-Labs / anything-llm](https://github.com/Mintplex-Labs/anything-llm)
    - The all-in-one Desktop & Docker AI application with built-in RAG, AI agents, and more.
    - language: **JavaScript** &nbsp;&nbsp; stars: **34,928** &nbsp;&nbsp; folks: **3,418**  &nbsp;&nbsp; `2,928 stars this week`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **70,750** &nbsp;&nbsp; folks: **8,366**  &nbsp;&nbsp; `5,606 stars this week`
...
1. [Bin-Huang / chatbox](https://github.com/Bin-Huang/chatbox)
    - User-friendly Desktop Client App for AI Models/LLMs (GPT, Claude, Gemini, Ollama...)
    - language: **TypeScript** &nbsp;&nbsp; stars: **28,993** &nbsp;&nbsp; folks: **2,785**  &nbsp;&nbsp; `2,042 stars this week`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **63,728** &nbsp;&nbsp; folks: **9,426**  &nbsp;&nbsp; `2,477 stars this week`
...
1. [assafelovic / gpt-researcher](https://github.com/assafelovic/gpt-researcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,587** &nbsp;&nbsp; folks: **2,316**  &nbsp;&nbsp; `1,497 stars this week`

1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **123,263** &nbsp;&nbsp; folks: **9,911**  &nbsp;&nbsp; `6,114 stars this week`

1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding.
    - language: **Python** &nbsp;&nbsp; stars: **33,179** &nbsp;&nbsp; folks: **3,031**  &nbsp;&nbsp; `2,053 stars this week`

1. [zhayujie / chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat)
    - 基于大模型搭建的聊天机器人，同时支持 微信公众号、企业微信应用、飞书、钉钉 等接入，可选择GPT3.5/GPT-4o/GPT-o1/ DeepSeek/Claude/文心一言/讯飞星火/通义千问/ Gemini/GLM-4/Claude/Kimi/LinkAI，能处理文本、语音和图片，访问操作系统和互联网，支持基于自有知识库进行定制企业智能客服。
    - language: **Python** &nbsp;&nbsp; stars: **33,851** &nbsp;&nbsp; folks: **8,706**  &nbsp;&nbsp; `801 stars this week`
...
1. [unslothai / unsloth](https://github.com/unslothai/unsloth)
    - Finetune Llama 3.3, DeepSeek-R1 & Reasoning LLMs 2x faster with 70% less memory
    - language: **Python** &nbsp;&nbsp; stars: **24,832** &nbsp;&nbsp; folks: **1,692**  &nbsp;&nbsp; `1,489 stars this week`
...
1. [is-a-dev / register](https://github.com/is-a-dev/register)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,602** &nbsp;&nbsp; folks: **9,976**  &nbsp;&nbsp; `1,089 stars this week`
...
1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **123,263** &nbsp;&nbsp; folks: **9,911**  &nbsp;&nbsp; `16,718 stars this month`

1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    - Make websites accessible for AI agents
    - language: **Python** &nbsp;&nbsp; stars: **25,759** &nbsp;&nbsp; folks: **2,591**  &nbsp;&nbsp; `13,766 stars this month`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **70,750** &nbsp;&nbsp; folks: **8,366**  &nbsp;&nbsp; `15,370 stars this month`

1. [TabbyML / tabby](https://github.com/TabbyML/tabby)
    - Self-hosted AI coding assistant
    - language: **Rust** &nbsp;&nbsp; stars: **29,624** &nbsp;&nbsp; folks: **1,349**  &nbsp;&nbsp; `7,263 stars this month`
...
1. [FujiwaraChoki / MoneyPrinterV2](https://github.com/FujiwaraChoki/MoneyPrinterV2)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,145** &nbsp;&nbsp; folks: **619**  &nbsp;&nbsp; `3,535 stars this month`

1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    - 🚀🤖 Crawl4AI: Open-source LLM Friendly Web Crawler & Scraper
    - language: **Python** &nbsp;&nbsp; stars: **29,395** &nbsp;&nbsp; folks: **2,363**  &nbsp;&nbsp; `6,119 stars this month`
...
1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,182** &nbsp;&nbsp; folks: **831**  &nbsp;&nbsp; `4,487 stars this month`
...
1. [Mintplex-Labs / anything-llm](https://github.com/Mintplex-Labs/anything-llm)
    - The all-in-one Desktop & Docker AI application with built-in RAG, AI agents, and more.
    - language: **JavaScript** &nbsp;&nbsp; stars: **34,928** &nbsp;&nbsp; folks: **3,418**  &nbsp;&nbsp; `4,695 stars this month`
