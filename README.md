...
1. [NationalSecurityAgency / ghidra](https://github.com/NationalSecurityAgency/ghidra)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **54,267** &nbsp;&nbsp; folks: **6,114**  &nbsp;&nbsp; `69 stars today`

1. [ValveSoftware / source-sdk-2013](https://github.com/ValveSoftware/source-sdk-2013)
    - The 2013 edition of the Source SDK
    - language: **C++** &nbsp;&nbsp; stars: **7,653** &nbsp;&nbsp; folks: **2,343**  &nbsp;&nbsp; `1,451 stars today`
...
1. [Alamofire / Alamofire](https://github.com/Alamofire/Alamofire)
    ...
    - language: **Swift** &nbsp;&nbsp; stars: **41,694** &nbsp;&nbsp; folks: **7,597**  &nbsp;&nbsp; `10 stars today`
...
1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **38,904** &nbsp;&nbsp; folks: **3,429**  &nbsp;&nbsp; `436 stars today`
...
1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,091** &nbsp;&nbsp; folks: **1,222**  &nbsp;&nbsp; `10,142 stars this week`

1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    - 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
    - language: **Python** &nbsp;&nbsp; stars: **23,717** &nbsp;&nbsp; folks: **3,464**  &nbsp;&nbsp; `1,870 stars this week`

1. [hummingbot / hummingbot](https://github.com/hummingbot/hummingbot)
    - Open source software that helps you create and deploy high-frequency crypto trading bots
    - language: **Python** &nbsp;&nbsp; stars: **11,224** &nbsp;&nbsp; folks: **3,210**  &nbsp;&nbsp; `1,539 stars this week`
...
1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding.
    - language: **TypeScript** &nbsp;&nbsp; stars: **38,904** &nbsp;&nbsp; folks: **3,429**  &nbsp;&nbsp; `2,722 stars this week`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **70,829** &nbsp;&nbsp; folks: **10,326**  &nbsp;&nbsp; `3,596 stars this week`
...
1. [microsoft / data-formulator](https://github.com/microsoft/data-formulator)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,048** &nbsp;&nbsp; folks: **610**  &nbsp;&nbsp; `1,841 stars this week`

1. [docmost / docmost](https://github.com/docmost/docmost)
    - Docmost is an open-source collaborative wiki and documentation software. It is an open-source alternative to Confluence and Notion.
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,801** &nbsp;&nbsp; folks: **446**  &nbsp;&nbsp; `1,199 stars this week`

1. [78 / xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)
    - Build your own AI friend
    - language: **C++** &nbsp;&nbsp; stars: **5,902** &nbsp;&nbsp; folks: **1,001**  &nbsp;&nbsp; `903 stars this week`
...
1. [microsoft / OmniParser](https://github.com/microsoft/OmniParser)
    - A simple screen parsing tool towards pure vision based GUI agent
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,091** &nbsp;&nbsp; folks: **1,222**  &nbsp;&nbsp; `10,328 stars this month`
...
1. [ollama / ollama](https://github.com/ollama/ollama)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **128,479** &nbsp;&nbsp; folks: **10,464**  &nbsp;&nbsp; `20,013 stars this month`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **77,530** &nbsp;&nbsp; folks: **9,218**  &nbsp;&nbsp; `20,016 stars this month`

1. [unslothai / unsloth](https://github.com/unslothai/unsloth)
    - Finetune Llama 3.3, DeepSeek-R1 & Reasoning LLMs 2x faster with 70% less memory! 🦥
    - language: **Python** &nbsp;&nbsp; stars: **31,407** &nbsp;&nbsp; folks: **2,095**  &nbsp;&nbsp; `10,396 stars this month`

1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    - Make websites accessible for AI agents
    - language: **Python** &nbsp;&nbsp; stars: **30,768** &nbsp;&nbsp; folks: **3,186**  &nbsp;&nbsp; `14,960 stars this month`
...
1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **70,829** &nbsp;&nbsp; folks: **10,326**  &nbsp;&nbsp; `11,377 stars this month`

1. [Bin-Huang / chatbox](https://github.com/Bin-Huang/chatbox)
    - User-friendly Desktop Client App for AI Models/LLMs (GPT, Claude, Gemini, Ollama...)
    - language: **TypeScript** &nbsp;&nbsp; stars: **31,730** &nbsp;&nbsp; folks: **3,009**  &nbsp;&nbsp; `6,843 stars this month`
...
1. [microsoft / generative-ai-for-beginners](https://github.com/microsoft/generative-ai-for-beginners)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **71,240** &nbsp;&nbsp; folks: **36,983**  &nbsp;&nbsp; `4,910 stars this month`
...
1. [lightpanda-io / browser](https://github.com/lightpanda-io/browser)
    ...
    - language: **Zig** &nbsp;&nbsp; stars: **6,693** &nbsp;&nbsp; folks: **139**  &nbsp;&nbsp; `5,308 stars this month`
