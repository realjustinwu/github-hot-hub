...
1. [zhayujie / chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,488** &nbsp;&nbsp; folks: **8,645**  &nbsp;&nbsp; `123 stars today`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **62,533** &nbsp;&nbsp; folks: **9,291**  &nbsp;&nbsp; `421 stars today`
...
1. [songquanpeng / one-api](https://github.com/songquanpeng/one-api)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **21,476** &nbsp;&nbsp; folks: **4,632**  &nbsp;&nbsp; `89 stars today`
...
1. [assafelovic / gpt-researcher](https://github.com/assafelovic/gpt-researcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,150** &nbsp;&nbsp; folks: **2,276**  &nbsp;&nbsp; `502 stars today`
...
1. [block / goose](https://github.com/block/goose)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **6,457** &nbsp;&nbsp; folks: **411**  &nbsp;&nbsp; `3,965 stars this week`
...
1. [ollama / ollama](https://github.com/ollama/ollama)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **121,310** &nbsp;&nbsp; folks: **9,729**  &nbsp;&nbsp; `5,951 stars this week`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **69,021** &nbsp;&nbsp; folks: **8,177**  &nbsp;&nbsp; `5,571 stars this week`

1. [volcengine / verl](https://github.com/volcengine/verl)
    - veRL: Volcano Engine Reinforcement Learning for LLM
    - language: **Python** &nbsp;&nbsp; stars: **2,422** &nbsp;&nbsp; folks: **189**  &nbsp;&nbsp; `964 stars this week`
...
1. [ocrmypdf / OCRmyPDF](https://github.com/ocrmypdf/OCRmyPDF)
    - OCRmyPDF adds an OCR text layer to scanned PDF files, allowing them to be searched
    - language: **Python** &nbsp;&nbsp; stars: **16,909** &nbsp;&nbsp; folks: **1,157**  &nbsp;&nbsp; `1,823 stars this week`

1. [n4ze3m / page-assist](https://github.com/n4ze3m/page-assist)
    - Use your locally running AI models to assist you in your web browsing
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,119** &nbsp;&nbsp; folks: **278**  &nbsp;&nbsp; `833 stars this week`
...
1. [deepseek-ai / DeepSeek-LLM](https://github.com/deepseek-ai/DeepSeek-LLM)
    ...
    - language: **Makefile** &nbsp;&nbsp; stars: **5,590** &nbsp;&nbsp; folks: **835**  &nbsp;&nbsp; `928 stars this week`
...
1. [deepseek-ai / DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **18,091** &nbsp;&nbsp; folks: **1,991**  &nbsp;&nbsp; `2,317 stars this week`

1. [Bin-Huang / chatbox](https://github.com/Bin-Huang/chatbox)
    - User-friendly Desktop Client App for AI Models/LLMs (GPT, Claude, Gemini, Ollama...)
    - language: **TypeScript** &nbsp;&nbsp; stars: **28,105** &nbsp;&nbsp; folks: **2,717**  &nbsp;&nbsp; `1,570 stars this week`
...
1. [deepseek-ai / DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
    - DeepSeek Coder: Let the Code Write Itself
    - language: **Python** &nbsp;&nbsp; stars: **18,091** &nbsp;&nbsp; folks: **1,991**  &nbsp;&nbsp; `8,337 stars this month`

1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    - Make websites accessible for AI agents
    - language: **Python** &nbsp;&nbsp; stars: **24,764** &nbsp;&nbsp; folks: **2,470**  &nbsp;&nbsp; `14,457 stars this month`
...
1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **121,310** &nbsp;&nbsp; folks: **9,729**  &nbsp;&nbsp; `15,141 stars this month`
...
1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **69,021** &nbsp;&nbsp; folks: **8,177**  &nbsp;&nbsp; `14,019 stars this month`

1. [TabbyML / tabby](https://github.com/TabbyML/tabby)
    - Self-hosted AI coding assistant
    - language: **Rust** &nbsp;&nbsp; stars: **29,506** &nbsp;&nbsp; folks: **1,343**  &nbsp;&nbsp; `7,185 stars this month`

1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **45,683** &nbsp;&nbsp; folks: **4,862**  &nbsp;&nbsp; `5,093 stars this month`

1. [KoljaB / RealtimeSTT](https://github.com/KoljaB/RealtimeSTT)
    - A robust, efficient, low-latency speech-to-text library with advanced voice activity detection, wake word activation and instant transcription.
    - language: **Python** &nbsp;&nbsp; stars: **5,439** &nbsp;&nbsp; folks: **430**  &nbsp;&nbsp; `3,111 stars this month`

1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    - 🚀🤖 Crawl4AI: Open-source LLM Friendly Web Crawler & Scraper
    - language: **Python** &nbsp;&nbsp; stars: **29,040** &nbsp;&nbsp; folks: **2,315**  &nbsp;&nbsp; `7,823 stars this month`
...
1. [PatrickJS / awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules)
    ...
    - language: **无** &nbsp;&nbsp; stars: **9,382** &nbsp;&nbsp; folks: **619**  &nbsp;&nbsp; `4,231 stars this month`
...
1. [shadps4-emu / shadPS4](https://github.com/shadps4-emu/shadPS4)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **17,526** &nbsp;&nbsp; folks: **1,083**  &nbsp;&nbsp; `4,802 stars this month`

1. [78 / xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)
    - Build your own AI friend
    - language: **C++** &nbsp;&nbsp; stars: **4,365** &nbsp;&nbsp; folks: **682**  &nbsp;&nbsp; `3,259 stars this month`
