...
1. [QuentinFuxa / WhisperLiveKit](https://github.com/QuentinFuxa/WhisperLiveKit)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,274** &nbsp;&nbsp; folks: **322**  &nbsp;&nbsp; `272 stars today`

1. [microsoft / mcp](https://github.com/microsoft/mcp)
    - Catalog of official Microsoft MCP (Model Context Protocol) server implementations for AI-powered data access and tool integration
    - language: **C#** &nbsp;&nbsp; stars: **1,310** &nbsp;&nbsp; folks: **115**  &nbsp;&nbsp; `74 stars today`
...
1. [Canner / WrenAI](https://github.com/Canner/WrenAI)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,852** &nbsp;&nbsp; folks: **1,095**  &nbsp;&nbsp; `547 stars today`

1. [OpenBMB / MiniCPM-V](https://github.com/OpenBMB/MiniCPM-V)
    - MiniCPM-V 4.5: A GPT-4o Level MLLM for Single Image, Multi Image and High-FPS Video Understanding on Your Phone
    - language: **Python** &nbsp;&nbsp; stars: **20,526** &nbsp;&nbsp; folks: **1,501**  &nbsp;&nbsp; `73 stars today`

1. [twbs / bootstrap](https://github.com/twbs/bootstrap)
    - The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web.
    - language: **MDX** &nbsp;&nbsp; stars: **173,254** &nbsp;&nbsp; folks: **79,150**  &nbsp;&nbsp; `126 stars today`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **205,221** &nbsp;&nbsp; folks: **47,557**  &nbsp;&nbsp; `195 stars today`
...
1. [humanlayer / humanlayer](https://github.com/humanlayer/humanlayer)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,554** &nbsp;&nbsp; folks: **148**  &nbsp;&nbsp; `57 stars today`
...
1. [spf13 / cobra](https://github.com/spf13/cobra)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **41,720** &nbsp;&nbsp; folks: **2,986**  &nbsp;&nbsp; `9 stars today`
...
1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **17,224** &nbsp;&nbsp; folks: **2,817**  &nbsp;&nbsp; `2,081 stars today`
...
1. [mercurjs / mercur](https://github.com/mercurjs/mercur)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **866** &nbsp;&nbsp; folks: **162**  &nbsp;&nbsp; `60 stars today`
...
1. [transformerlab / transformerlab-app](https://github.com/transformerlab/transformerlab-app)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,114** &nbsp;&nbsp; folks: **375**  &nbsp;&nbsp; `54 stars today`

1. [opf / openproject](https://github.com/opf/openproject)
    - OpenProject is the leading open source project management software.
    - language: **Ruby** &nbsp;&nbsp; stars: **12,470** &nbsp;&nbsp; folks: **2,783**  &nbsp;&nbsp; `235 stars today`
...
1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    ...
    - language: **无** &nbsp;&nbsp; stars: **60,973** &nbsp;&nbsp; folks: **6,649**  &nbsp;&nbsp; `188 stars today`
...
1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    - Collection of extracted System Prompts from popular chatbots like ChatGPT, Claude & Gemini
    - language: **JavaScript** &nbsp;&nbsp; stars: **17,224** &nbsp;&nbsp; folks: **2,817**  &nbsp;&nbsp; `8,467 stars this week`

1. [plait-board / drawnix](https://github.com/plait-board/drawnix)
    - 开源白板工具（SaaS），一体化白板，包含思维导图、流程图、自由画等。All in one open-source whiteboard tool with mind, flowchart, freehand and etc.
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,896** &nbsp;&nbsp; folks: **719**  &nbsp;&nbsp; `4,826 stars this week`
...
1. [HKUDS / DeepCode](https://github.com/HKUDS/DeepCode)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,503** &nbsp;&nbsp; folks: **459**  &nbsp;&nbsp; `3,211 stars this week`
...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,006** &nbsp;&nbsp; folks: **1,515**  &nbsp;&nbsp; `2,337 stars this week`
...
1. [TheAlgorithms / Java](https://github.com/TheAlgorithms/Java)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **63,170** &nbsp;&nbsp; folks: **20,224**  &nbsp;&nbsp; `412 stars this week`

1. [twbs / bootstrap](https://github.com/twbs/bootstrap)
    - The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web.
    - language: **MDX** &nbsp;&nbsp; stars: **173,254** &nbsp;&nbsp; folks: **79,150**  &nbsp;&nbsp; `354 stars this week`
...
1. [microsoft / qlib](https://github.com/microsoft/qlib)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **29,281** &nbsp;&nbsp; folks: **4,523**  &nbsp;&nbsp; `553 stars this week`
...
1. [Arindam200 / awesome-ai-apps](https://github.com/Arindam200/awesome-ai-apps)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,443** &nbsp;&nbsp; folks: **572**  &nbsp;&nbsp; `964 stars this week`
...
1. [plait-board / drawnix](https://github.com/plait-board/drawnix)
    - 开源白板工具（SaaS），一体化白板，包含思维导图、流程图、自由画等。All in one open-source whiteboard tool with mind, flowchart, freehand and etc.
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,896** &nbsp;&nbsp; folks: **719**  &nbsp;&nbsp; `6,830 stars this month`

1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Sim is an open-source AI agent workflow builder. Sim's interface is a lightweight, intuitive way to rapidly build and deploy LLMs that connect with your favorite tools.
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,006** &nbsp;&nbsp; folks: **1,515**  &nbsp;&nbsp; `6,780 stars this month`

1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    - Collection of extracted System Prompts from popular chatbots like ChatGPT, Claude & Gemini
    - language: **JavaScript** &nbsp;&nbsp; stars: **17,224** &nbsp;&nbsp; folks: **2,817**  &nbsp;&nbsp; `9,005 stars this month`
...
1. [9001 / copyparty](https://github.com/9001/copyparty)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **27,759** &nbsp;&nbsp; folks: **1,041**  &nbsp;&nbsp; `18,691 stars this month`
...
1. [oraios / serena](https://github.com/oraios/serena)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,436** &nbsp;&nbsp; folks: **722**  &nbsp;&nbsp; `5,082 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,933** &nbsp;&nbsp; folks: **1,194**  &nbsp;&nbsp; `7,511 stars this month`
