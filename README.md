...
1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,989** &nbsp;&nbsp; folks: **814**  &nbsp;&nbsp; `152 stars today`
...
1. [mendableai / firecrawl](https://github.com/mendableai/firecrawl)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **23,916** &nbsp;&nbsp; folks: **1,957**  &nbsp;&nbsp; `164 stars today`

1. [openai / openai-cookbook](https://github.com/openai/openai-cookbook)
    - Examples and guides for using the OpenAI API
    - language: **MDX** &nbsp;&nbsp; stars: **61,583** &nbsp;&nbsp; folks: **9,906**  &nbsp;&nbsp; `32 stars today`
...
1. [zhayujie / chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,723** &nbsp;&nbsp; folks: **8,686**  &nbsp;&nbsp; `263 stars today`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer.
    - language: **Rust** &nbsp;&nbsp; stars: **81,527** &nbsp;&nbsp; folks: **11,418**  &nbsp;&nbsp; `389 stars today`
...
1. [oumi-ai / oumi](https://github.com/oumi-ai/oumi)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,055** &nbsp;&nbsp; folks: **405**  &nbsp;&nbsp; `5,647 stars this week`

1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **122,747** &nbsp;&nbsp; folks: **9,848**  &nbsp;&nbsp; `6,040 stars this week`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **70,180** &nbsp;&nbsp; folks: **8,292**  &nbsp;&nbsp; `5,705 stars this week`
...
1. [Bin-Huang / chatbox](https://github.com/Bin-Huang/chatbox)
    - User-friendly Desktop Client App for AI Models/LLMs (GPT, Claude, Gemini, Ollama...)
    - language: **TypeScript** &nbsp;&nbsp; stars: **28,626** &nbsp;&nbsp; folks: **2,757**  &nbsp;&nbsp; `1,790 stars this week`

1. [Mintplex-Labs / anything-llm](https://github.com/Mintplex-Labs/anything-llm)
    - The all-in-one Desktop & Docker AI application with built-in RAG, AI agents, and more.
    - language: **JavaScript** &nbsp;&nbsp; stars: **34,441** &nbsp;&nbsp; folks: **3,379**  &nbsp;&nbsp; `2,422 stars this week`
...
1. [assafelovic / gpt-researcher](https://github.com/assafelovic/gpt-researcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,433** &nbsp;&nbsp; folks: **2,298**  &nbsp;&nbsp; `1,325 stars this week`

1. [n4ze3m / page-assist](https://github.com/n4ze3m/page-assist)
    - Use your locally running AI models to assist you in your web browsing
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,362** &nbsp;&nbsp; folks: **295**  &nbsp;&nbsp; `740 stars this week`
...
1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding.
    - language: **Python** &nbsp;&nbsp; stars: **32,613** &nbsp;&nbsp; folks: **2,995**  &nbsp;&nbsp; `1,550 stars this week`

1. [lobehub / lobe-chat](https://github.com/lobehub/lobe-chat)
    - 🤯 Lobe Chat - an open-source, modern-design AI chat framework. Supports Multi AI Providers( OpenAI / Claude 3 / Gemini / Ollama / Qwen / DeepSeek), Knowledge Base (file upload / knowledge management / RAG ), Multi-Modals (Vision/TTS/Plugins/Artifacts). One-click FREE deployment of your private ChatGPT/ Claude application.
    - language: **TypeScript** &nbsp;&nbsp; stars: **54,080** &nbsp;&nbsp; folks: **11,650**  &nbsp;&nbsp; `1,550 stars this week`

1. [block / goose](https://github.com/block/goose)
    - an open-source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM
    - language: **Rust** &nbsp;&nbsp; stars: **6,643** &nbsp;&nbsp; folks: **421**  &nbsp;&nbsp; `2,431 stars this week`

1. [zhayujie / chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat)
    - 基于大模型搭建的聊天机器人，同时支持 微信公众号、企业微信应用、飞书、钉钉 等接入，可选择GPT3.5/GPT-4o/GPT-o1/ DeepSeek/Claude/文心一言/讯飞星火/通义千问/ Gemini/GLM-4/Claude/Kimi/LinkAI，能处理文本、语音和图片，访问操作系统和互联网，支持基于自有知识库进行定制企业智能客服。
    - language: **Python** &nbsp;&nbsp; stars: **33,723** &nbsp;&nbsp; folks: **8,686**  &nbsp;&nbsp; `725 stars this week`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **63,165** &nbsp;&nbsp; folks: **9,372**  &nbsp;&nbsp; `2,206 stars this week`
...
1. [deepseek-ai / DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **18,456** &nbsp;&nbsp; folks: **2,033**  &nbsp;&nbsp; `8,575 stars this month`

1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **122,747** &nbsp;&nbsp; folks: **9,848**  &nbsp;&nbsp; `15,954 stars this month`
...
1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **25,179** &nbsp;&nbsp; folks: **2,533**  &nbsp;&nbsp; `13,905 stars this month`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **70,180** &nbsp;&nbsp; folks: **8,292**  &nbsp;&nbsp; `14,735 stars this month`
...
1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **45,823** &nbsp;&nbsp; folks: **4,877**  &nbsp;&nbsp; `5,157 stars this month`
...
1. [ggerganov / llama.cpp](https://github.com/ggerganov/llama.cpp)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **73,497** &nbsp;&nbsp; folks: **10,599**  &nbsp;&nbsp; `3,370 stars this month`
...
1. [Dokploy / dokploy](https://github.com/Dokploy/dokploy)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,584** &nbsp;&nbsp; folks: **851**  &nbsp;&nbsp; `5,799 stars this month`
...
1. [PatrickJS / awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules)
    ...
    - language: **无** &nbsp;&nbsp; stars: **9,545** &nbsp;&nbsp; folks: **636**  &nbsp;&nbsp; `4,225 stars this month`

1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    - 🚀🚀 「大模型」50分钟完全从0训练26M的小参数GPT！🌏 Train a 26M-parameter GPT from scratch in just 50 min!
    - language: **Python** &nbsp;&nbsp; stars: **7,989** &nbsp;&nbsp; folks: **814**  &nbsp;&nbsp; `4,459 stars this month`
...
1. [Mintplex-Labs / anything-llm](https://github.com/Mintplex-Labs/anything-llm)
    - The all-in-one Desktop & Docker AI application with built-in RAG, AI agents, and more.
    - language: **JavaScript** &nbsp;&nbsp; stars: **34,441** &nbsp;&nbsp; folks: **3,379**  &nbsp;&nbsp; `4,266 stars this month`
