...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **4,253** &nbsp;&nbsp; folks: **291**  &nbsp;&nbsp; `59 stars today`

1. [immich-app / immich](https://github.com/immich-app/immich)
    - High performance self-hosted photo and video management solution.
    - language: **TypeScript** &nbsp;&nbsp; stars: **76,266** &nbsp;&nbsp; folks: **4,034**  &nbsp;&nbsp; `510 stars today`

1. [HKUDS / AutoAgent](https://github.com/HKUDS/AutoAgent)
    - "AutoAgent: Fully-Automated and Zero-Code LLM Agent Framework"
    - language: **Python** &nbsp;&nbsp; stars: **6,352** &nbsp;&nbsp; folks: **860**  &nbsp;&nbsp; `73 stars today`
...
1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,339** &nbsp;&nbsp; folks: **692**  &nbsp;&nbsp; `2,878 stars this week`

1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **45,006** &nbsp;&nbsp; folks: **3,272**  &nbsp;&nbsp; `2,625 stars this week`

1. [LukeGus / Termix](https://github.com/LukeGus/Termix)
    - Termix is a web-based server management platform with SSH terminal, tunneling, and file editing capabilities.
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,421** &nbsp;&nbsp; folks: **133**  &nbsp;&nbsp; `1,382 stars this week`
...
1. [resemble-ai / chatterbox](https://github.com/resemble-ai/chatterbox)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **12,527** &nbsp;&nbsp; folks: **1,581**  &nbsp;&nbsp; `1,130 stars this week`

1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    - Distributed query engine providing simple and reliable data processing for any modality and scale
    - language: **Rust** &nbsp;&nbsp; stars: **4,253** &nbsp;&nbsp; folks: **291**  &nbsp;&nbsp; `786 stars this week`

1. [aquasecurity / trivy](https://github.com/aquasecurity/trivy)
    - Find vulnerabilities, misconfigurations, secrets, SBOM in containers, Kubernetes, code repositories, clouds and more
    - language: **Go** &nbsp;&nbsp; stars: **28,819** &nbsp;&nbsp; folks: **2,745**  &nbsp;&nbsp; `706 stars this week`

1. [trufflesecurity / trufflehog](https://github.com/trufflesecurity/trufflehog)
    - Find, verify, and analyze leaked credentials
    - language: **Go** &nbsp;&nbsp; stars: **21,352** &nbsp;&nbsp; folks: **2,013**  &nbsp;&nbsp; `943 stars this week`

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **11,358** &nbsp;&nbsp; folks: **899**  &nbsp;&nbsp; `2,815 stars this week`
...
1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **66,466** &nbsp;&nbsp; folks: **5,638**  &nbsp;&nbsp; `1,394 stars this week`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **13,343** &nbsp;&nbsp; folks: **1,126**  &nbsp;&nbsp; `11,404 stars this month`

1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    - Collection of extracted System Prompts from popular chatbots like ChatGPT, Claude & Gemini
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,648** &nbsp;&nbsp; folks: **3,116**  &nbsp;&nbsp; `11,489 stars this month`

1. [plait-board / drawnix](https://github.com/plait-board/drawnix)
    - 开源白板工具（SaaS），一体化白板，包含思维导图、流程图、自由画等。All in one open-source whiteboard tool with mind, flowchart, freehand and etc.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,974** &nbsp;&nbsp; folks: **823**  &nbsp;&nbsp; `7,175 stars this month`
...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,629** &nbsp;&nbsp; folks: **1,807**  &nbsp;&nbsp; `7,551 stars this month`
...
1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **45,006** &nbsp;&nbsp; folks: **3,272**  &nbsp;&nbsp; `8,289 stars this month`

1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **39,862** &nbsp;&nbsp; folks: **4,630**  &nbsp;&nbsp; `6,722 stars this month`

1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **4,074** &nbsp;&nbsp; folks: **406**  &nbsp;&nbsp; `2,664 stars this month`

1. [basecamp / omarchy](https://github.com/basecamp/omarchy)
    - Opinionated Arch/Hyprland Setup
    - language: **Shell** &nbsp;&nbsp; stars: **7,536** &nbsp;&nbsp; folks: **884**  &nbsp;&nbsp; `4,131 stars this month`
