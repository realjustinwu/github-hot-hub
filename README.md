...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,885** &nbsp;&nbsp; folks: **910**  &nbsp;&nbsp; `237 stars today`
...
1. [python-poetry / poetry](https://github.com/python-poetry/poetry)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,665** &nbsp;&nbsp; folks: **2,366**  &nbsp;&nbsp; `25 stars today`

1. [blakeblackshear / frigate](https://github.com/blakeblackshear/frigate)
    - NVR with realtime local object detection for IP cameras
    - language: **TypeScript** &nbsp;&nbsp; stars: **24,772** &nbsp;&nbsp; folks: **2,291**  &nbsp;&nbsp; `180 stars today`

1. [ethereum / solidity](https://github.com/ethereum/solidity)
    - Solidity, the Smart Contract Programming Language
    - language: **C++** &nbsp;&nbsp; stars: **24,871** &nbsp;&nbsp; folks: **6,144**  &nbsp;&nbsp; `123 stars today`
...
1. [themactep / thingino-firmware](https://github.com/themactep/thingino-firmware)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **992** &nbsp;&nbsp; folks: **126**  &nbsp;&nbsp; `82 stars today`

1. [dstotijn / hetty](https://github.com/dstotijn/hetty)
    - An HTTP toolkit for security research.
    - language: **Go** &nbsp;&nbsp; stars: **7,868** &nbsp;&nbsp; folks: **434**  &nbsp;&nbsp; `103 stars today`
...
1. [9001 / copyparty](https://github.com/9001/copyparty)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **21,354** &nbsp;&nbsp; folks: **737**  &nbsp;&nbsp; `8,492 stars this week`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,018** &nbsp;&nbsp; folks: **1,018**  &nbsp;&nbsp; `7,977 stars this week`
...
1. [microsoft / mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,745** &nbsp;&nbsp; folks: **2,101**  &nbsp;&nbsp; `1,634 stars this week`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **56,121** &nbsp;&nbsp; folks: **6,627**  &nbsp;&nbsp; `2,165 stars this week`

1. [charmbracelet / bubbletea](https://github.com/charmbracelet/bubbletea)
    - A powerful little TUI framework 🏗
    - language: **Go** &nbsp;&nbsp; stars: **34,034** &nbsp;&nbsp; folks: **963**  &nbsp;&nbsp; `325 stars this week`
...
1. [workadventure / workadventure](https://github.com/workadventure/workadventure)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,805** &nbsp;&nbsp; folks: **701**  &nbsp;&nbsp; `101 stars this week`
...
1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **95,236** &nbsp;&nbsp; folks: **13,940**  &nbsp;&nbsp; `991 stars this week`
...
1. [rasbt / LLMs-from-scratch](https://github.com/rasbt/LLMs-from-scratch)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **62,635** &nbsp;&nbsp; folks: **8,774**  &nbsp;&nbsp; `2,057 stars this week`

1. [comfyanonymous / ComfyUI](https://github.com/comfyanonymous/ComfyUI)
    - The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface.
    - language: **Python** &nbsp;&nbsp; stars: **84,687** &nbsp;&nbsp; folks: **9,393**  &nbsp;&nbsp; `729 stars this week`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,900** &nbsp;&nbsp; folks: **802**  &nbsp;&nbsp; `1,742 stars this week`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **48,485** &nbsp;&nbsp; folks: **4,463**  &nbsp;&nbsp; `6,312 stars this month`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,018** &nbsp;&nbsp; folks: **1,018**  &nbsp;&nbsp; `8,334 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,900** &nbsp;&nbsp; folks: **802**  &nbsp;&nbsp; `7,691 stars this month`
...
1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **8,989** &nbsp;&nbsp; folks: **649**  &nbsp;&nbsp; `7,252 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **28,404** &nbsp;&nbsp; folks: **1,598**  &nbsp;&nbsp; `10,775 stars this month`
