...
1. [feder-cr / Jobs_Applier_AI_Agent](https://github.com/feder-cr/Jobs_Applier_AI_Agent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **25,029** &nbsp;&nbsp; folks: **3,717**  &nbsp;&nbsp; `332 stars today`

1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
    - language: **TypeScript** &nbsp;&nbsp; stars: **304,685** &nbsp;&nbsp; folks: **39,887**  &nbsp;&nbsp; `199 stars today`

1. [Nutlope / llamacoder](https://github.com/Nutlope/llamacoder)
    - Open source Claude Artifacts – built with Llama 3.1 405B
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,736** &nbsp;&nbsp; folks: **1,039**  &nbsp;&nbsp; `111 stars today`

1. [quickwit-oss / quickwit](https://github.com/quickwit-oss/quickwit)
    - Cloud-native search engine for observability. An open-source alternative to Datadog, Elasticsearch, Loki, and Tempo.
    - language: **Rust** &nbsp;&nbsp; stars: **8,738** &nbsp;&nbsp; folks: **374**  &nbsp;&nbsp; `106 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **11,857** &nbsp;&nbsp; folks: **1,277**  &nbsp;&nbsp; `162 stars today`
...
1. [Canner / WrenAI](https://github.com/Canner/WrenAI)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,564** &nbsp;&nbsp; folks: **312**  &nbsp;&nbsp; `318 stars today`
...
1. [fixie-ai / ultravox](https://github.com/fixie-ai/ultravox)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,922** &nbsp;&nbsp; folks: **140**  &nbsp;&nbsp; `30 stars today`
...
1. [NVIDIA / nv-ingest](https://github.com/NVIDIA/nv-ingest)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,304** &nbsp;&nbsp; folks: **136**  &nbsp;&nbsp; `334 stars today`
...
1. [stanford-oval / storm](https://github.com/stanford-oval/storm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,524** &nbsp;&nbsp; folks: **1,712**  &nbsp;&nbsp; `4,911 stars this week`
...
1. [All-Hands-AI / OpenHands](https://github.com/All-Hands-AI/OpenHands)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **42,942** &nbsp;&nbsp; folks: **4,750**  &nbsp;&nbsp; `3,023 stars this week`
...
1. [NVIDIA / nv-ingest](https://github.com/NVIDIA/nv-ingest)
    - NVIDIA Ingest is an early access set of microservices for parsing hundreds of thousands of complex, messy unstructured PDFs and other enterprise documents into metadata and text to embed into retrieval systems.
    - language: **Python** &nbsp;&nbsp; stars: **1,304** &nbsp;&nbsp; folks: **136**  &nbsp;&nbsp; `745 stars this week`

1. [Canner / WrenAI](https://github.com/Canner/WrenAI)
    - 🤖 Open-source AI Agent that empowers data-driven teams to chat with their data to generate Text-to-SQL, charts, spreadsheets, reports, and BI. 📈📊📋🧑‍💻
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,564** &nbsp;&nbsp; folks: **312**  &nbsp;&nbsp; `397 stars this week`
...
1. [Cinnamon / kotaemon](https://github.com/Cinnamon/kotaemon)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **20,035** &nbsp;&nbsp; folks: **1,547**  &nbsp;&nbsp; `1,141 stars this week`
...
1. [Nutlope / llamacoder](https://github.com/Nutlope/llamacoder)
    - Open source Claude Artifacts – built with Llama 3.1 405B
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,736** &nbsp;&nbsp; folks: **1,039**  &nbsp;&nbsp; `294 stars this week`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **11,857** &nbsp;&nbsp; folks: **1,277**  &nbsp;&nbsp; `7,150 stars this month`

1. [elizaOS / eliza](https://github.com/elizaOS/eliza)
    - Autonomous agents for everyone
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,054** &nbsp;&nbsp; folks: **2,994**  &nbsp;&nbsp; `7,336 stars this month`
...
1. [stanford-oval / storm](https://github.com/stanford-oval/storm)
    - An LLM-powered knowledge curation system that researches a topic and generates a full-length report with citations.
    - language: **Python** &nbsp;&nbsp; stars: **19,524** &nbsp;&nbsp; folks: **1,712**  &nbsp;&nbsp; `5,922 stars this month`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **285,457** &nbsp;&nbsp; folks: **47,619**  &nbsp;&nbsp; `6,918 stars this month`
