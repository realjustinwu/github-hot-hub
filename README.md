...
1. [alibaba / MNN](https://github.com/alibaba/MNN)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **12,346** &nbsp;&nbsp; folks: **1,984**  &nbsp;&nbsp; `19 stars today`
...
1. [junegunn / fzf](https://github.com/junegunn/fzf)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **71,715** &nbsp;&nbsp; folks: **2,542**  &nbsp;&nbsp; `104 stars today`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **28,814** &nbsp;&nbsp; folks: **7,221**  &nbsp;&nbsp; `4,447 stars this week`
...
1. [zaidmukaddam / scira](https://github.com/zaidmukaddam/scira)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,628** &nbsp;&nbsp; folks: **1,176**  &nbsp;&nbsp; `990 stars this week`

1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    - MCP Toolbox for Databases is an open source MCP server for databases.
    - language: **Go** &nbsp;&nbsp; stars: **3,748** &nbsp;&nbsp; folks: **317**  &nbsp;&nbsp; `1,056 stars this week`
...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,651** &nbsp;&nbsp; folks: **696**  &nbsp;&nbsp; `455 stars this week`

1. [GyulyVGC / sniffnet](https://github.com/GyulyVGC/sniffnet)
    - Comfortably monitor your Internet traffic 🕵️‍♂️
    - language: **Rust** &nbsp;&nbsp; stars: **27,513** &nbsp;&nbsp; folks: **894**  &nbsp;&nbsp; `1,805 stars this week`
...
1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    ...
    - language: **Markdown** &nbsp;&nbsp; stars: **397,881** &nbsp;&nbsp; folks: **37,138**  &nbsp;&nbsp; `4,170 stars this week`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,008** &nbsp;&nbsp; folks: **321**  &nbsp;&nbsp; `2,271 stars this week`

1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 26 lessons, 52 quizzes, classic Machine Learning for all
    - language: **HTML** &nbsp;&nbsp; stars: **74,170** &nbsp;&nbsp; folks: **16,324**  &nbsp;&nbsp; `654 stars this week`

1. [commaai / openpilot](https://github.com/commaai/openpilot)
    - openpilot is an operating system for robotics. Currently, it upgrades the driver assistance system on 300+ supported cars.
    - language: **Python** &nbsp;&nbsp; stars: **55,095** &nbsp;&nbsp; folks: **9,915**  &nbsp;&nbsp; `700 stars this week`
...
1. [sindresorhus / awesome](https://github.com/sindresorhus/awesome)
    ...
    - language: **无** &nbsp;&nbsp; stars: **380,443** &nbsp;&nbsp; folks: **30,419**  &nbsp;&nbsp; `16,352 stars this month`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    - 小红书笔记 | 评论爬虫、抖音视频 | 评论爬虫、快手视频 | 评论爬虫、B 站视频 ｜ 评论爬虫、微博帖子 ｜ 评论爬虫、百度贴吧帖子 ｜ 百度贴吧评论回复爬虫 | 知乎问答文章｜评论爬虫
    - language: **Python** &nbsp;&nbsp; stars: **28,814** &nbsp;&nbsp; folks: **7,221**  &nbsp;&nbsp; `5,441 stars this month`

1. [datawhalechina / happy-llm](https://github.com/datawhalechina/happy-llm)
    - 📚 从零开始的大语言模型原理与实践教程
    - language: **无** &nbsp;&nbsp; stars: **9,889** &nbsp;&nbsp; folks: **713**  &nbsp;&nbsp; `7,263 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **18,332** &nbsp;&nbsp; folks: **1,034**  &nbsp;&nbsp; `6,357 stars this month`
...
1. [DrKLO / Telegram](https://github.com/DrKLO/Telegram)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **27,059** &nbsp;&nbsp; folks: **8,741**  &nbsp;&nbsp; `881 stars this month`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    - Open Source AI coding assistant for planning, building, and fixing code. We're a superset of Roo, Cline, and our own features. Follow us: kilocode.ai/social
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,008** &nbsp;&nbsp; folks: **321**  &nbsp;&nbsp; `3,055 stars this month`

1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    - MCP Toolbox for Databases is an open source MCP server for databases.
    - language: **Go** &nbsp;&nbsp; stars: **3,748** &nbsp;&nbsp; folks: **317**  &nbsp;&nbsp; `1,466 stars this month`
