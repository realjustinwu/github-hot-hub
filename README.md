...
`更新时间：2024-12-23 13:21:46 +0800`

## 今日热门仓库

1. [nicbarker / clay](https://github.com/nicbarker/clay)
    - High performance UI layout library in C.
    - language: **C** &nbsp;&nbsp; stars: **5,789** &nbsp;&nbsp; folks: **159**  &nbsp;&nbsp; `1,544 stars today`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **281,317** &nbsp;&nbsp; folks: **47,092**  &nbsp;&nbsp; `418 stars today`

1. [Genesis-Embodied-AI / Genesis](https://github.com/Genesis-Embodied-AI/Genesis)
    - A generative world for general-purpose robotics & embodied AI learning.
    - language: **Python** &nbsp;&nbsp; stars: **17,912** &nbsp;&nbsp; folks: **1,270**  &nbsp;&nbsp; `1,337 stars today`

1. [tldraw / tldraw](https://github.com/tldraw/tldraw)
    - whiteboard / infinite canvas SDK
    - language: **TypeScript** &nbsp;&nbsp; stars: **37,118** &nbsp;&nbsp; folks: **2,270**  &nbsp;&nbsp; `305 stars today`
...
1. [bytedance / monolith](https://github.com/bytedance/monolith)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,191** &nbsp;&nbsp; folks: **299**  &nbsp;&nbsp; `306 stars today`
...
1. [anthropics / anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **7,870** &nbsp;&nbsp; folks: **982**  &nbsp;&nbsp; `196 stars today`
...
1. [gorhill / uBlock](https://github.com/gorhill/uBlock)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **48,338** &nbsp;&nbsp; folks: **3,188**  &nbsp;&nbsp; `48 stars today`

1. [Helicone / helicone](https://github.com/Helicone/helicone)
    - 🧊 Open source LLM observability platform. One line of code to monitor, evaluate, and experiment. YC W23 🍓
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,636** &nbsp;&nbsp; folks: **279**  &nbsp;&nbsp; `26 stars today`
...
1. [google-gemini / cookbook](https://github.com/google-gemini/cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **9,222** &nbsp;&nbsp; folks: **1,089**  &nbsp;&nbsp; `2,851 stars this week`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **7,712** &nbsp;&nbsp; folks: **804**  &nbsp;&nbsp; `1,318 stars this week`

1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    - PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/Docker
    - language: **Python** &nbsp;&nbsp; stars: **10,442** &nbsp;&nbsp; folks: **728**  &nbsp;&nbsp; `3,590 stars this week`
...
1. [microsoft / PowerToys](https://github.com/microsoft/PowerToys)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **112,784** &nbsp;&nbsp; folks: **6,647**  &nbsp;&nbsp; `578 stars this week`
...
1. [LazyVim / LazyVim](https://github.com/LazyVim/LazyVim)
    ...
    - language: **Lua** &nbsp;&nbsp; stars: **18,402** &nbsp;&nbsp; folks: **1,290**  &nbsp;&nbsp; `488 stars this week`
...
1. [TEN-framework / TEN-Agent](https://github.com/TEN-framework/TEN-Agent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,651** &nbsp;&nbsp; folks: **348**  &nbsp;&nbsp; `1,002 stars this week`
...
1. [shardeum / shardeum](https://github.com/shardeum/shardeum)
    - Shardeum is an EVM based autoscaling blockchain
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,818** &nbsp;&nbsp; folks: **488**  &nbsp;&nbsp; `4,230 stars this week`
...
1. [anthropics / anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook)
    - A collection of notebooks/recipes showcasing some fun and effective ways of using Claude.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **7,870** &nbsp;&nbsp; folks: **982**  &nbsp;&nbsp; `458 stars this week`

1. [ByteByteGoHq / system-design-101](https://github.com/ByteByteGoHq/system-design-101)
    - Explain complex systems using visuals and simple terms. Help you prepare for system design interviews.
    - language: **无** &nbsp;&nbsp; stars: **66,921** &nbsp;&nbsp; folks: **7,017**  &nbsp;&nbsp; `1,459 stars this week`
...
1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    - PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/Docker
    - language: **Python** &nbsp;&nbsp; stars: **10,442** &nbsp;&nbsp; folks: **728**  &nbsp;&nbsp; `7,629 stars this month`

1. [google-gemini / cookbook](https://github.com/google-gemini/cookbook)
    - Examples and guides for using the Gemini API
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **9,222** &nbsp;&nbsp; folks: **1,089**  &nbsp;&nbsp; `3,817 stars this month`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **7,712** &nbsp;&nbsp; folks: **804**  &nbsp;&nbsp; `3,391 stars this month`
...
1. [TEN-framework / TEN-Agent](https://github.com/TEN-framework/TEN-Agent)
    - TEN Agent is a conversational AI powered by the TEN, integrating Gemini 2.0 Live, OpenAI Realtime, RTC, and more. It delivers real-time capabilities to see, hear, and speak, while being fully compatible with popular workflow platforms like Dify and Coze.
    - language: **Python** &nbsp;&nbsp; stars: **3,651** &nbsp;&nbsp; folks: **348**  &nbsp;&nbsp; `2,036 stars this month`
...
1. [krahets / hello-algo](https://github.com/krahets/hello-algo)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **103,949** &nbsp;&nbsp; folks: **13,033**  &nbsp;&nbsp; `4,709 stars this month`

1. [langflow-ai / langflow](https://github.com/langflow-ai/langflow)
    - Langflow is a low-code app builder for RAG and multi-agent AI applications. It’s Python-based and agnostic to any model, API, or database.
    - language: **Python** &nbsp;&nbsp; stars: **40,190** &nbsp;&nbsp; folks: **4,534**  &nbsp;&nbsp; `5,149 stars this month`
...
1. [2dust / v2rayN](https://github.com/2dust/v2rayN)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **72,064** &nbsp;&nbsp; folks: **11,800**  &nbsp;&nbsp; `2,273 stars this month`
...
1. [awslabs / multi-agent-orchestrator](https://github.com/awslabs/multi-agent-orchestrator)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,200** &nbsp;&nbsp; folks: **227**  &nbsp;&nbsp; `1,313 stars this month`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **HTML** &nbsp;&nbsp; stars: **342,406** &nbsp;&nbsp; folks: **62,071**  &nbsp;&nbsp; `4,024 stars this month`
...
1. [Guovin / iptv-api](https://github.com/Guovin/iptv-api)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,755** &nbsp;&nbsp; folks: **2,078**  &nbsp;&nbsp; `3,867 stars this month`
