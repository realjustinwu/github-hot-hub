...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **3,718** &nbsp;&nbsp; folks: **277**  &nbsp;&nbsp; `61 stars today`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **65,308** &nbsp;&nbsp; folks: **5,569**  &nbsp;&nbsp; `89 stars today`
...
1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,692** &nbsp;&nbsp; folks: **606**  &nbsp;&nbsp; `2,671 stars this week`
...
1. [QuentinFuxa / WhisperLiveKit](https://github.com/QuentinFuxa/WhisperLiveKit)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,458** &nbsp;&nbsp; folks: **547**  &nbsp;&nbsp; `2,964 stars this week`
...
1. [humanlayer / humanlayer](https://github.com/humanlayer/humanlayer)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,218** &nbsp;&nbsp; folks: **206**  &nbsp;&nbsp; `599 stars this week`
...
1. [chiphuyen / aie-book](https://github.com/chiphuyen/aie-book)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **8,007** &nbsp;&nbsp; folks: **1,054**  &nbsp;&nbsp; `1,874 stars this week`
...
1. [gristlabs / grist-core](https://github.com/gristlabs/grist-core)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,433** &nbsp;&nbsp; folks: **459**  &nbsp;&nbsp; `467 stars this week`
...
1. [HKUDS / DeepCode](https://github.com/HKUDS/DeepCode)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,701** &nbsp;&nbsp; folks: **750**  &nbsp;&nbsp; `1,134 stars this week`

1. [microsoft / RD-Agent](https://github.com/microsoft/RD-Agent)
    - Research and development (R&D) is crucial for the enhancement of industrial productivity, especially in the AI era, where the core aspects of R&D are mainly focused on data and models. We are committed to automating these high-value generic R&D processes through R&D-Agent, which lets AI drive data-driven AI. 🔗https://aka.ms/RD-Agent-Tech-Report
    - language: **Python** &nbsp;&nbsp; stars: **7,486** &nbsp;&nbsp; folks: **777**  &nbsp;&nbsp; `213 stars this week`

1. [google / comprehensive-rust](https://github.com/google/comprehensive-rust)
    - This is the Rust course used by the Android team at Google. It provides you the material to quickly teach Rust.
    - language: **Rust** &nbsp;&nbsp; stars: **31,709** &nbsp;&nbsp; folks: **1,876**  &nbsp;&nbsp; `904 stars this week`

1. [aquasecurity / trivy](https://github.com/aquasecurity/trivy)
    - Find vulnerabilities, misconfigurations, secrets, SBOM in containers, Kubernetes, code repositories, clouds and more
    - language: **Go** &nbsp;&nbsp; stars: **28,633** &nbsp;&nbsp; folks: **2,731**  &nbsp;&nbsp; `491 stars this week`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **13,028** &nbsp;&nbsp; folks: **1,096**  &nbsp;&nbsp; `11,231 stars this month`

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **11,683** &nbsp;&nbsp; folks: **2,023**  &nbsp;&nbsp; `6,506 stars this month`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **39,097** &nbsp;&nbsp; folks: **4,525**  &nbsp;&nbsp; `7,280 stars this month`
...
1. [basecamp / omarchy](https://github.com/basecamp/omarchy)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **7,076** &nbsp;&nbsp; folks: **849**  &nbsp;&nbsp; `4,035 stars this month`

1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **3,968** &nbsp;&nbsp; folks: **398**  &nbsp;&nbsp; `2,588 stars this month`
...
1. [oraios / serena](https://github.com/oraios/serena)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,671** &nbsp;&nbsp; folks: **809**  &nbsp;&nbsp; `4,071 stars this month`
