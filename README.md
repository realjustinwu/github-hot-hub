...
`更新时间：2025-07-20 07:27:39 +0800`

## 今日热门仓库

1. [hyprwm / Hyprland](https://github.com/hyprwm/Hyprland)
    - Hyprland is an independent, highly customizable, dynamic tiling Wayland compositor that doesn't sacrifice on its looks.
    - language: **C++** &nbsp;&nbsp; stars: **27,651** &nbsp;&nbsp; folks: **1,170**  &nbsp;&nbsp; `229 stars today`
...
1. [soxoj / maigret](https://github.com/soxoj/maigret)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,767** &nbsp;&nbsp; folks: **1,134**  &nbsp;&nbsp; `320 stars today`

1. [github / github-mcp-server](https://github.com/github/github-mcp-server)
    - GitHub's official MCP Server
    - language: **Go** &nbsp;&nbsp; stars: **17,955** &nbsp;&nbsp; folks: **1,418**  &nbsp;&nbsp; `239 stars today`
...
1. [bknd-io / bknd](https://github.com/bknd-io/bknd)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,505** &nbsp;&nbsp; folks: **73**  &nbsp;&nbsp; `138 stars today`

1. [mrdbourke / pytorch-deep-learning](https://github.com/mrdbourke/pytorch-deep-learning)
    - Materials for the Learn PyTorch for Deep Learning: Zero to Mastery course.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **14,617** &nbsp;&nbsp; folks: **4,060**  &nbsp;&nbsp; `43 stars today`

1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    - Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.
    - language: **TypeScript** &nbsp;&nbsp; stars: **121,001** &nbsp;&nbsp; folks: **36,367**  &nbsp;&nbsp; `699 stars today`
...
1. [Lightricks / LTX-Video](https://github.com/Lightricks/LTX-Video)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,375** &nbsp;&nbsp; folks: **636**  &nbsp;&nbsp; `142 stars today`
...
1. [ikawrakow / ik_llama.cpp](https://github.com/ikawrakow/ik_llama.cpp)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **727** &nbsp;&nbsp; folks: **70**  &nbsp;&nbsp; `8 stars today`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **68,368** &nbsp;&nbsp; folks: **3,630**  &nbsp;&nbsp; `7,369 stars this week`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,076** &nbsp;&nbsp; folks: **455**  &nbsp;&nbsp; `2,409 stars this week`
...
1. [GraphiteEditor / Graphite](https://github.com/GraphiteEditor/Graphite)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **19,553** &nbsp;&nbsp; folks: **816**  &nbsp;&nbsp; `6,556 stars this month`

1. [humanlayer / 12-factor-agents](https://github.com/humanlayer/12-factor-agents)
    - What are the principles we can use to build LLM-powered software that is actually good enough to put in the hands of production customers?
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,590** &nbsp;&nbsp; folks: **616**  &nbsp;&nbsp; `5,027 stars this month`
...
1. [GyulyVGC / sniffnet](https://github.com/GyulyVGC/sniffnet)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **28,793** &nbsp;&nbsp; folks: **958**  &nbsp;&nbsp; `4,330 stars this month`
...
1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **75,048** &nbsp;&nbsp; folks: **16,575**  &nbsp;&nbsp; `2,340 stars this month`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,980** &nbsp;&nbsp; folks: **411**  &nbsp;&nbsp; `3,680 stars this month`
...
1. [stanford-oval / storm](https://github.com/stanford-oval/storm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **26,792** &nbsp;&nbsp; folks: **2,412**  &nbsp;&nbsp; `2,219 stars this month`
