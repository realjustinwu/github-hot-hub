...
1. [Guovin / iptv-api](https://github.com/Guovin/iptv-api)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,230** &nbsp;&nbsp; folks: **1,605**  &nbsp;&nbsp; `344 stars today`
...
1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **64,527** &nbsp;&nbsp; folks: **7,869**  &nbsp;&nbsp; `3,118 stars this week`

1. [aidenybai / react-scan](https://github.com/aidenybai/react-scan)
    - Scan for React performance issues and eliminate slow renders in your app
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,070** &nbsp;&nbsp; folks: **88**  &nbsp;&nbsp; `3,266 stars this week`
...
1. [bluesky-social / atproto](https://github.com/bluesky-social/atproto)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,532** &nbsp;&nbsp; folks: **538**  &nbsp;&nbsp; `391 stars this week`
...
1. [jesseduffield / lazydocker](https://github.com/jesseduffield/lazydocker)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **38,935** &nbsp;&nbsp; folks: **1,237**  &nbsp;&nbsp; `1,102 stars this week`

1. [awslabs / multi-agent-orchestrator](https://github.com/awslabs/multi-agent-orchestrator)
    - Flexible and powerful framework for managing multiple AI agents and handling complex conversations
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,722** &nbsp;&nbsp; folks: **183**  &nbsp;&nbsp; `542 stars this week`

1. [Guovin / iptv-api](https://github.com/Guovin/iptv-api)
    - 📺IPTV电视直播源更新工具🚀：✨央视、📡卫视、☘️广东及各省份地方台、🌊港·澳·台、🎬电影、🎥咪咕、🏀体育、🪁动画、🎮游戏、🎵音乐、🏛经典剧场；支持IPv4/IPv6；支持自定义增加频道；支持组播源、酒店源、订阅源、关键字搜索；每天自动更新两次，结果可用于TVBox等播放软件；支持工作流、Docker(amd64/arm64/arm v7)、命令行、GUI运行方式 | IPTV live TV source update tool
    - language: **Python** &nbsp;&nbsp; stars: **7,230** &nbsp;&nbsp; folks: **1,605**  &nbsp;&nbsp; `872 stars this week`
...
1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **17,679** &nbsp;&nbsp; folks: **1,300**  &nbsp;&nbsp; `1,061 stars this week`
...
1. [trungdq88 / Awesome-Black-Friday-Cyber-Monday](https://github.com/trungdq88/Awesome-Black-Friday-Cyber-Monday)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,934** &nbsp;&nbsp; folks: **1,204**  &nbsp;&nbsp; `495 stars this week`

1. [myhhub / stock](https://github.com/myhhub/stock)
    - stock股票.获取股票数据,计算股票指标,识别股票形态,综合选股,选股策略,股票验证回测,股票自动交易,支持PC及移动设备。
    - language: **Python** &nbsp;&nbsp; stars: **4,475** &nbsp;&nbsp; folks: **832**  &nbsp;&nbsp; `2,412 stars this week`

1. [skills / introduction-to-github](https://github.com/skills/introduction-to-github)
    - Get started using GitHub in less than an hour.
    - language: **无** &nbsp;&nbsp; stars: **5,451** &nbsp;&nbsp; folks: **3,285**  &nbsp;&nbsp; `764 stars this week`

1. [mtdvio / every-programmer-should-know](https://github.com/mtdvio/every-programmer-should-know)
    - A collection of (mostly) technical things every software developer should know about
    - language: **无** &nbsp;&nbsp; stars: **85,324** &nbsp;&nbsp; folks: **7,890**  &nbsp;&nbsp; `1,714 stars this week`
...
1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    - Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue)
    - language: **Python** &nbsp;&nbsp; stars: **64,527** &nbsp;&nbsp; folks: **7,869**  &nbsp;&nbsp; `7,249 stars this month`

1. [DS4SD / docling](https://github.com/DS4SD/docling)
    - Get your documents ready for gen AI
    - language: **Python** &nbsp;&nbsp; stars: **12,134** &nbsp;&nbsp; folks: **609**  &nbsp;&nbsp; `10,219 stars this month`

1. [ai16z / eliza](https://github.com/ai16z/eliza)
    - Conversational Agent for Twitter and Discord
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,671** &nbsp;&nbsp; folks: **786**  &nbsp;&nbsp; `2,171 stars this month`

1. [opendatalab / MinerU](https://github.com/opendatalab/MinerU)
    - A high-quality tool for convert PDF to Markdown and JSON.一站式开源高质量数据提取工具，将PDF转换成Markdown和JSON格式。
    - language: **Python** &nbsp;&nbsp; stars: **19,990** &nbsp;&nbsp; folks: **1,421**  &nbsp;&nbsp; `6,483 stars this month`
...
1. [khoj-ai / khoj](https://github.com/khoj-ai/khoj)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,565** &nbsp;&nbsp; folks: **806**  &nbsp;&nbsp; `3,589 stars this month`
...
1. [payloadcms / payload](https://github.com/payloadcms/payload)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,127** &nbsp;&nbsp; folks: **1,806**  &nbsp;&nbsp; `4,313 stars this month`

1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **16,761** &nbsp;&nbsp; folks: **896**  &nbsp;&nbsp; `5,842 stars this month`

1. [CodePhiliaX / Chat2DB](https://github.com/CodePhiliaX/Chat2DB)
    - 🔥🔥🔥AI-driven database tool and SQL client, The hottest GUI client, supporting MySQL, Oracle, PostgreSQL, DB2, SQL Server, DB2, SQLite, H2, ClickHouse, and more.
    - language: **Java** &nbsp;&nbsp; stars: **17,255** &nbsp;&nbsp; folks: **1,929**  &nbsp;&nbsp; `1,668 stars this month`
...
1. [AmruthPillai / Reactive-Resume](https://github.com/AmruthPillai/Reactive-Resume)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **26,287** &nbsp;&nbsp; folks: **2,682**  &nbsp;&nbsp; `2,819 stars this month`

1. [bluesky-social / social-app](https://github.com/bluesky-social/social-app)
    - The Bluesky Social application for Web, iOS, and Android
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,467** &nbsp;&nbsp; folks: **1,722**  &nbsp;&nbsp; `3,804 stars this month`
...
1. [xtekky / gpt4free](https://github.com/xtekky/gpt4free)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **62,465** &nbsp;&nbsp; folks: **13,402**  &nbsp;&nbsp; `1,726 stars this month`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **278,138** &nbsp;&nbsp; folks: **46,591**  &nbsp;&nbsp; `4,466 stars this month`
