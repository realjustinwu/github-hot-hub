...
`更新时间：2025-09-07 18:22:11 +0800`

## 今日热门仓库

1. [zama-ai / fhevm](https://github.com/zama-ai/fhevm)
    - FHEVM, a full-stack framework for integrating Fully Homomorphic Encryption (FHE) with blockchain applications
    - language: **Rust** &nbsp;&nbsp; stars: **17,374** &nbsp;&nbsp; folks: **734**  &nbsp;&nbsp; `146 stars today`
...
1. [microsoft / BitNet](https://github.com/microsoft/BitNet)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **21,634** &nbsp;&nbsp; folks: **1,641**  &nbsp;&nbsp; `167 stars today`

1. [coleam00 / ottomator-agents](https://github.com/coleam00/ottomator-agents)
    - All the open source AI Agents hosted on the oTTomator Live Agent Studio platform!
    - language: **Python** &nbsp;&nbsp; stars: **3,960** &nbsp;&nbsp; folks: **1,430**  &nbsp;&nbsp; `71 stars today`

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **9,306** &nbsp;&nbsp; folks: **775**  &nbsp;&nbsp; `299 stars today`
...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **3,770** &nbsp;&nbsp; folks: **277**  &nbsp;&nbsp; `61 stars today`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **65,372** &nbsp;&nbsp; folks: **5,574**  &nbsp;&nbsp; `89 stars today`
...
1. [OpenBMB / MiniCPM-V](https://github.com/OpenBMB/MiniCPM-V)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **21,425** &nbsp;&nbsp; folks: **1,592**  &nbsp;&nbsp; `816 stars this week`
...
1. [JetBrains / koog](https://github.com/JetBrains/koog)
    ...
    - language: **Kotlin** &nbsp;&nbsp; stars: **2,943** &nbsp;&nbsp; folks: **199**  &nbsp;&nbsp; `1,243 stars this week`
...
1. [microsoft / RD-Agent](https://github.com/microsoft/RD-Agent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,494** &nbsp;&nbsp; folks: **778**  &nbsp;&nbsp; `213 stars this week`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **13,056** &nbsp;&nbsp; folks: **1,100**  &nbsp;&nbsp; `11,231 stars this month`

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **11,688** &nbsp;&nbsp; folks: **2,024**  &nbsp;&nbsp; `6,506 stars this month`

1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    - Collection of extracted System Prompts from popular chatbots like ChatGPT, Claude & Gemini
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,234** &nbsp;&nbsp; folks: **3,062**  &nbsp;&nbsp; `11,082 stars this month`
...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,328** &nbsp;&nbsp; folks: **1,751**  &nbsp;&nbsp; `7,705 stars this month`

1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **39,151** &nbsp;&nbsp; folks: **4,529**  &nbsp;&nbsp; `7,280 stars this month`
...
1. [Canner / WrenAI](https://github.com/Canner/WrenAI)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,733** &nbsp;&nbsp; folks: **1,174**  &nbsp;&nbsp; `2,209 stars this month`
...
1. [oraios / serena](https://github.com/oraios/serena)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,690** &nbsp;&nbsp; folks: **809**  &nbsp;&nbsp; `4,071 stars this month`

1. [OpenBMB / MiniCPM-V](https://github.com/OpenBMB/MiniCPM-V)
    - MiniCPM-V 4.5: A GPT-4o Level MLLM for Single Image, Multi Image and High-FPS Video Understanding on Your Phone
    - language: **Python** &nbsp;&nbsp; stars: **21,425** &nbsp;&nbsp; folks: **1,592**  &nbsp;&nbsp; `1,479 stars this month`
