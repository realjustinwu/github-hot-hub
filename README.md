...
1. [bknd-io / bknd](https://github.com/bknd-io/bknd)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,572** &nbsp;&nbsp; folks: **74**  &nbsp;&nbsp; `154 stars today`

1. [mrdbourke / pytorch-deep-learning](https://github.com/mrdbourke/pytorch-deep-learning)
    - Materials for the Learn PyTorch for Deep Learning: Zero to Mastery course.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **14,664** &nbsp;&nbsp; folks: **4,062**  &nbsp;&nbsp; `43 stars today`

1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    - Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.
    - language: **TypeScript** &nbsp;&nbsp; stars: **121,074** &nbsp;&nbsp; folks: **36,391**  &nbsp;&nbsp; `695 stars today`

1. [gitleaks / gitleaks](https://github.com/gitleaks/gitleaks)
    - Find secrets with Gitleaks 🔑
    - language: **Go** &nbsp;&nbsp; stars: **22,193** &nbsp;&nbsp; folks: **1,709**  &nbsp;&nbsp; `232 stars today`

1. [Kyome22 / RunCat365](https://github.com/Kyome22/RunCat365)
    - A cute running cat animation on your windows taskbar.
    - language: **C#** &nbsp;&nbsp; stars: **8,470** &nbsp;&nbsp; folks: **702**  &nbsp;&nbsp; `132 stars today`
...
1. [strapi / strapi](https://github.com/strapi/strapi)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **68,444** &nbsp;&nbsp; folks: **8,769**  &nbsp;&nbsp; `236 stars today`

1. [influxdata / telegraf](https://github.com/influxdata/telegraf)
    - Agent for collecting, processing, aggregating, and writing metrics, logs, and other arbitrary data.
    - language: **Go** &nbsp;&nbsp; stars: **15,928** &nbsp;&nbsp; folks: **5,672**  &nbsp;&nbsp; `115 stars today`
...
1. [HotCakeX / Harden-Windows-Security](https://github.com/HotCakeX/Harden-Windows-Security)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **2,783** &nbsp;&nbsp; folks: **223**  &nbsp;&nbsp; `12 stars today`

1. [ikawrakow / ik_llama.cpp](https://github.com/ikawrakow/ik_llama.cpp)
    - llama.cpp fork with additional SOTA quants and improved performance
    - language: **C++** &nbsp;&nbsp; stars: **734** &nbsp;&nbsp; folks: **71**  &nbsp;&nbsp; `8 stars today`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **68,400** &nbsp;&nbsp; folks: **3,633**  &nbsp;&nbsp; `8,235 stars this week`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,133** &nbsp;&nbsp; folks: **459**  &nbsp;&nbsp; `2,600 stars this week`

1. [gorhill / uBlock](https://github.com/gorhill/uBlock)
    - uBlock Origin - An efficient blocker for Chromium and Firefox. Fast and lean.
    - language: **JavaScript** &nbsp;&nbsp; stars: **56,422** &nbsp;&nbsp; folks: **3,603**  &nbsp;&nbsp; `1,142 stars this week`

1. [getzep / graphiti](https://github.com/getzep/graphiti)
    - Build Real-Time Knowledge Graphs for AI Agents
    - language: **Python** &nbsp;&nbsp; stars: **14,266** &nbsp;&nbsp; folks: **1,198**  &nbsp;&nbsp; `1,647 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **24,675** &nbsp;&nbsp; folks: **1,353**  &nbsp;&nbsp; `5,628 stars this week`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **5,309** &nbsp;&nbsp; folks: **751**  &nbsp;&nbsp; `886 stars this week`

1. [gitleaks / gitleaks](https://github.com/gitleaks/gitleaks)
    - Find secrets with Gitleaks 🔑
    - language: **Go** &nbsp;&nbsp; stars: **22,193** &nbsp;&nbsp; folks: **1,709**  &nbsp;&nbsp; `676 stars this week`

1. [strapi / strapi](https://github.com/strapi/strapi)
    - 🚀 Strapi is the leading open-source headless CMS. It’s 100% JavaScript/TypeScript, fully customizable, and developer-first.
    - language: **TypeScript** &nbsp;&nbsp; stars: **68,444** &nbsp;&nbsp; folks: **8,769**  &nbsp;&nbsp; `775 stars this week`

1. [RSSNext / Folo](https://github.com/RSSNext/Folo)
    - 🧡 Follow everything in one place
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,854** &nbsp;&nbsp; folks: **1,336**  &nbsp;&nbsp; `1,090 stars this week`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **32,585** &nbsp;&nbsp; folks: **7,808**  &nbsp;&nbsp; `9,069 stars this month`
...
1. [humanlayer / 12-factor-agents](https://github.com/humanlayer/12-factor-agents)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,606** &nbsp;&nbsp; folks: **616**  &nbsp;&nbsp; `5,156 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **24,675** &nbsp;&nbsp; folks: **1,353**  &nbsp;&nbsp; `10,967 stars this month`
...
1. [GyulyVGC / sniffnet](https://github.com/GyulyVGC/sniffnet)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **28,811** &nbsp;&nbsp; folks: **958**  &nbsp;&nbsp; `4,355 stars this month`

1. [datawhalechina / happy-llm](https://github.com/datawhalechina/happy-llm)
    - 📚 从零开始的大语言模型原理与实践教程
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **12,136** &nbsp;&nbsp; folks: **891**  &nbsp;&nbsp; `8,479 stars this month`
...
1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **75,066** &nbsp;&nbsp; folks: **16,579**  &nbsp;&nbsp; `2,385 stars this month`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,999** &nbsp;&nbsp; folks: **412**  &nbsp;&nbsp; `3,747 stars this month`

1. [snailyp / gemini-balance](https://github.com/snailyp/gemini-balance)
    - Gemini polling proxy service （gemini轮询代理服务）
    - language: **Python** &nbsp;&nbsp; stars: **3,451** &nbsp;&nbsp; folks: **607**  &nbsp;&nbsp; `1,671 stars this month`

1. [stanford-oval / storm](https://github.com/stanford-oval/storm)
    - An LLM-powered knowledge curation system that researches a topic and generates a full-length report with citations.
    - language: **Python** &nbsp;&nbsp; stars: **26,800** &nbsp;&nbsp; folks: **2,412**  &nbsp;&nbsp; `2,248 stars this month`
