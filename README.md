...
1. [x1xhlol / system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools)
    ...
    - language: **无** &nbsp;&nbsp; stars: **82,801** &nbsp;&nbsp; folks: **23,011**  &nbsp;&nbsp; `620 stars today`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **66,447** &nbsp;&nbsp; folks: **5,638**  &nbsp;&nbsp; `441 stars today`
...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **4,242** &nbsp;&nbsp; folks: **290**  &nbsp;&nbsp; `59 stars today`

1. [immich-app / immich](https://github.com/immich-app/immich)
    - High performance self-hosted photo and video management solution.
    - language: **TypeScript** &nbsp;&nbsp; stars: **76,248** &nbsp;&nbsp; folks: **4,034**  &nbsp;&nbsp; `510 stars today`

1. [HKUDS / AutoAgent](https://github.com/HKUDS/AutoAgent)
    - "AutoAgent: Fully-Automated and Zero-Code LLM Agent Framework"
    - language: **Python** &nbsp;&nbsp; stars: **6,339** &nbsp;&nbsp; folks: **860**  &nbsp;&nbsp; `73 stars today`
...
1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,333** &nbsp;&nbsp; folks: **690**  &nbsp;&nbsp; `2,878 stars this week`

1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **45,003** &nbsp;&nbsp; folks: **3,271**  &nbsp;&nbsp; `2,625 stars this week`

1. [LukeGus / Termix](https://github.com/LukeGus/Termix)
    - Termix is a web-based server management platform with SSH terminal, tunneling, and file editing capabilities.
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,417** &nbsp;&nbsp; folks: **132**  &nbsp;&nbsp; `1,382 stars this week`
...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    - Distributed query engine providing simple and reliable data processing for any modality and scale
    - language: **Rust** &nbsp;&nbsp; stars: **4,242** &nbsp;&nbsp; folks: **290**  &nbsp;&nbsp; `786 stars this week`

1. [aquasecurity / trivy](https://github.com/aquasecurity/trivy)
    - Find vulnerabilities, misconfigurations, secrets, SBOM in containers, Kubernetes, code repositories, clouds and more
    - language: **Go** &nbsp;&nbsp; stars: **28,817** &nbsp;&nbsp; folks: **2,745**  &nbsp;&nbsp; `706 stars this week`
...
1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **11,342** &nbsp;&nbsp; folks: **898**  &nbsp;&nbsp; `2,815 stars this week`
...
1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **66,447** &nbsp;&nbsp; folks: **5,638**  &nbsp;&nbsp; `1,394 stars this week`
...
1. [uutils / coreutils](https://github.com/uutils/coreutils)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **21,374** &nbsp;&nbsp; folks: **1,543**  &nbsp;&nbsp; `315 stars this week`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,833** &nbsp;&nbsp; folks: **2,058**  &nbsp;&nbsp; `6,630 stars this month`

1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **13,334** &nbsp;&nbsp; folks: **1,125**  &nbsp;&nbsp; `11,404 stars this month`
...
1. [plait-board / drawnix](https://github.com/plait-board/drawnix)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,969** &nbsp;&nbsp; folks: **823**  &nbsp;&nbsp; `7,175 stars this month`

1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    - Run Windows apps such as Microsoft Office/Adobe in Linux (Ubuntu/Fedora) and GNOME/KDE as if they were a part of the native OS, including Nautilus integration. Hard fork of https://github.com/Fmstrat/winapps/
    - language: **Shell** &nbsp;&nbsp; stars: **9,090** &nbsp;&nbsp; folks: **274**  &nbsp;&nbsp; `5,750 stars this month`

1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Open-source platform to build and deploy AI agent workflows.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,623** &nbsp;&nbsp; folks: **1,806**  &nbsp;&nbsp; `7,551 stars this month`
...
1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **45,003** &nbsp;&nbsp; folks: **3,271**  &nbsp;&nbsp; `8,289 stars this month`

1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **39,849** &nbsp;&nbsp; folks: **4,628**  &nbsp;&nbsp; `6,722 stars this month`
...
1. [basecamp / omarchy](https://github.com/basecamp/omarchy)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **7,534** &nbsp;&nbsp; folks: **882**  &nbsp;&nbsp; `4,131 stars this month`
