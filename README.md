...
`更新时间：2025-09-08 15:24:17 +0800`

## 今日热门仓库

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **10,251** &nbsp;&nbsp; folks: **835**  &nbsp;&nbsp; `264 stars today`

1. [zama-ai / fhevm](https://github.com/zama-ai/fhevm)
    - FHEVM, a full-stack framework for integrating Fully Homomorphic Encryption (FHE) with blockchain applications
    - language: **Rust** &nbsp;&nbsp; stars: **17,565** &nbsp;&nbsp; folks: **746**  &nbsp;&nbsp; `524 stars today`
...
1. [juspay / hyperswitch](https://github.com/juspay/hyperswitch)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **29,945** &nbsp;&nbsp; folks: **4,080**  &nbsp;&nbsp; `1,975 stars today`
...
1. [FIRST-Tech-Challenge / FtcRobotController](https://github.com/FIRST-Tech-Challenge/FtcRobotController)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **1,026** &nbsp;&nbsp; folks: **6,735**  &nbsp;&nbsp; `10 stars today`

1. [openwrt / openwrt](https://github.com/openwrt/openwrt)
    - This repository is a mirror of https://git.openwrt.org/openwrt/openwrt.git It is for reference only and is not active for check-ins. We will continue to accept Pull Requests here. They will be merged via staging trees then into openwrt.git.
    - language: **C** &nbsp;&nbsp; stars: **23,683** &nbsp;&nbsp; folks: **11,524**  &nbsp;&nbsp; `24 stars today`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,962** &nbsp;&nbsp; folks: **874**  &nbsp;&nbsp; `305 stars today`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **65,637** &nbsp;&nbsp; folks: **5,588**  &nbsp;&nbsp; `288 stars today`
...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **3,999** &nbsp;&nbsp; folks: **282**  &nbsp;&nbsp; `307 stars today`
...
1. [pathwaycom / pathway](https://github.com/pathwaycom/pathway)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **38,105** &nbsp;&nbsp; folks: **1,117**  &nbsp;&nbsp; `2,214 stars today`

1. [pathwaycom / llm-app](https://github.com/pathwaycom/llm-app)
    - Ready-to-run cloud templates for RAG, AI pipelines, and enterprise search with live data. 🐳Docker-friendly.⚡Always in sync with Sharepoint, Google Drive, S3, Kafka, PostgreSQL, real-time data APIs, and more.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **35,831** &nbsp;&nbsp; folks: **963**  &nbsp;&nbsp; `2,063 stars today`

1. [henrygd / beszel](https://github.com/henrygd/beszel)
    - Lightweight server monitoring hub with historical data, docker stats, and alerts.
    - language: **Go** &nbsp;&nbsp; stars: **14,827** &nbsp;&nbsp; folks: **453**  &nbsp;&nbsp; `53 stars today`

1. [ossu / computer-science](https://github.com/ossu/computer-science)
    - 🎓 Path to a free self-taught education in Computer Science!
    - language: **HTML** &nbsp;&nbsp; stars: **192,315** &nbsp;&nbsp; folks: **24,006**  &nbsp;&nbsp; `413 stars today`

1. [LadybirdBrowser / ladybird](https://github.com/LadybirdBrowser/ladybird)
    - Truly independent web browser
    - language: **C++** &nbsp;&nbsp; stars: **47,504** &nbsp;&nbsp; folks: **2,060**  &nbsp;&nbsp; `54 stars today`

1. [Vector-Wangel / XLeRobot](https://github.com/Vector-Wangel/XLeRobot)
    - XLeRobot: Practical Dual-Arm Mobile Home Robot for $660
    - language: **Python** &nbsp;&nbsp; stars: **2,174** &nbsp;&nbsp; folks: **208**  &nbsp;&nbsp; `225 stars today`
...
1. [dockur / windows](https://github.com/dockur/windows)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **44,740** &nbsp;&nbsp; folks: **3,251**  &nbsp;&nbsp; `6,152 stars this week`

1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    - Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,931** &nbsp;&nbsp; folks: **631**  &nbsp;&nbsp; `2,808 stars this week`
...
1. [QuentinFuxa / WhisperLiveKit](https://github.com/QuentinFuxa/WhisperLiveKit)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,556** &nbsp;&nbsp; folks: **562**  &nbsp;&nbsp; `2,535 stars this week`
...
1. [JetBrains / koog](https://github.com/JetBrains/koog)
    ...
    - language: **Kotlin** &nbsp;&nbsp; stars: **2,959** &nbsp;&nbsp; folks: **200**  &nbsp;&nbsp; `1,154 stars this week`
...
1. [aquasecurity / trivy](https://github.com/aquasecurity/trivy)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **28,723** &nbsp;&nbsp; folks: **2,739**  &nbsp;&nbsp; `610 stars this week`
...
1. [gunnarmorling / 1brc](https://github.com/gunnarmorling/1brc)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **7,365** &nbsp;&nbsp; folks: **2,081**  &nbsp;&nbsp; `176 stars this week`
...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    - Distributed query engine providing simple and reliable data processing for any modality and scale
    - language: **Rust** &nbsp;&nbsp; stars: **3,999** &nbsp;&nbsp; folks: **282**  &nbsp;&nbsp; `484 stars this week`
...
1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,361** &nbsp;&nbsp; folks: **3,073**  &nbsp;&nbsp; `11,196 stars this month`

1. [plait-board / drawnix](https://github.com/plait-board/drawnix)
    - 开源白板工具（SaaS），一体化白板，包含思维导图、流程图、自由画等。All in one open-source whiteboard tool with mind, flowchart, freehand and etc.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,838** &nbsp;&nbsp; folks: **812**  &nbsp;&nbsp; `7,175 stars this month`

1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    - Run Windows apps such as Microsoft Office/Adobe in Linux (Ubuntu/Fedora) and GNOME/KDE as if they were a part of the native OS, including Nautilus integration. Hard fork of https://github.com/Fmstrat/winapps/
    - language: **Shell** &nbsp;&nbsp; stars: **8,964** &nbsp;&nbsp; folks: **270**  &nbsp;&nbsp; `5,613 stars this month`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **39,368** &nbsp;&nbsp; folks: **4,561**  &nbsp;&nbsp; `7,377 stars this month`

1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **44,740** &nbsp;&nbsp; folks: **3,251**  &nbsp;&nbsp; `8,022 stars this month`

1. [basecamp / omarchy](https://github.com/basecamp/omarchy)
    - Opinionated Arch/Hyprland Setup
    - language: **Shell** &nbsp;&nbsp; stars: **7,216** &nbsp;&nbsp; folks: **857**  &nbsp;&nbsp; `4,010 stars this month`

1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **4,021** &nbsp;&nbsp; folks: **402**  &nbsp;&nbsp; `2,612 stars this month`

1. [langchain-ai / open-swe](https://github.com/langchain-ai/open-swe)
    - An Open-Source Asynchronous Coding Agent
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,773** &nbsp;&nbsp; folks: **594**  &nbsp;&nbsp; `4,219 stars this month`
