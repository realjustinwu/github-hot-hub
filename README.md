...
1. [shadps4-emu / shadPS4](https://github.com/shadps4-emu/shadPS4)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **24,244** &nbsp;&nbsp; folks: **1,573**  &nbsp;&nbsp; `1,005 stars today`

1. [soxoj / maigret](https://github.com/soxoj/maigret)
    - 🕵️‍♂️ Collect a dossier on a person by username from thousands of sites
    - language: **Python** &nbsp;&nbsp; stars: **16,658** &nbsp;&nbsp; folks: **1,132**  &nbsp;&nbsp; `320 stars today`

1. [github / github-mcp-server](https://github.com/github/github-mcp-server)
    - GitHub's official MCP Server
    - language: **Go** &nbsp;&nbsp; stars: **17,798** &nbsp;&nbsp; folks: **1,401**  &nbsp;&nbsp; `239 stars today`

1. [remoteintech / remote-jobs](https://github.com/remoteintech/remote-jobs)
    - A list of semi to fully remote-friendly companies (jobs) in tech.
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,507** &nbsp;&nbsp; folks: **3,383**  &nbsp;&nbsp; `360 stars today`
...
1. [bknd-io / bknd](https://github.com/bknd-io/bknd)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,369** &nbsp;&nbsp; folks: **70**  &nbsp;&nbsp; `138 stars today`

1. [mrdbourke / pytorch-deep-learning](https://github.com/mrdbourke/pytorch-deep-learning)
    - Materials for the Learn PyTorch for Deep Learning: Zero to Mastery course.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **14,510** &nbsp;&nbsp; folks: **4,054**  &nbsp;&nbsp; `43 stars today`

1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    - Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.
    - language: **TypeScript** &nbsp;&nbsp; stars: **120,778** &nbsp;&nbsp; folks: **36,320**  &nbsp;&nbsp; `699 stars today`
...
1. [strapi / strapi](https://github.com/strapi/strapi)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **68,350** &nbsp;&nbsp; folks: **8,761**  &nbsp;&nbsp; `236 stars today`

1. [influxdata / telegraf](https://github.com/influxdata/telegraf)
    - Agent for collecting, processing, aggregating, and writing metrics, logs, and other arbitrary data.
    - language: **Go** &nbsp;&nbsp; stars: **15,887** &nbsp;&nbsp; folks: **5,669**  &nbsp;&nbsp; `115 stars today`
...
1. [ikawrakow / ik_llama.cpp](https://github.com/ikawrakow/ik_llama.cpp)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **702** &nbsp;&nbsp; folks: **68**  &nbsp;&nbsp; `8 stars today`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **68,271** &nbsp;&nbsp; folks: **3,621**  &nbsp;&nbsp; `7,369 stars this week`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,969** &nbsp;&nbsp; folks: **451**  &nbsp;&nbsp; `2,409 stars this week`
...
1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    ...
    - language: **PowerShell** &nbsp;&nbsp; stars: **24,571** &nbsp;&nbsp; folks: **1,339**  &nbsp;&nbsp; `5,616 stars this week`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **5,182** &nbsp;&nbsp; folks: **733**  &nbsp;&nbsp; `647 stars this week`
...
1. [strapi / strapi](https://github.com/strapi/strapi)
    - 🚀 Strapi is the leading open-source headless CMS. It’s 100% JavaScript/TypeScript, fully customizable, and developer-first.
    - language: **TypeScript** &nbsp;&nbsp; stars: **68,350** &nbsp;&nbsp; folks: **8,761**  &nbsp;&nbsp; `578 stars this week`

1. [RSSNext / Folo](https://github.com/RSSNext/Folo)
    - 🧡 Follow everything in one place
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,812** &nbsp;&nbsp; folks: **1,335**  &nbsp;&nbsp; `1,163 stars this week`
...
1. [Alibaba-NLP / WebAgent](https://github.com/Alibaba-NLP/WebAgent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,642** &nbsp;&nbsp; folks: **346**  &nbsp;&nbsp; `3,533 stars this month`
...
1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **24,571** &nbsp;&nbsp; folks: **1,339**  &nbsp;&nbsp; `10,926 stars this month`
