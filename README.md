...
1. [datalab-to / marker](https://github.com/datalab-to/marker)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **27,811** &nbsp;&nbsp; folks: **1,817**  &nbsp;&nbsp; `108 stars today`

1. [redis / go-redis](https://github.com/redis/go-redis)
    - Redis Go client
    - language: **Go** &nbsp;&nbsp; stars: **21,384** &nbsp;&nbsp; folks: **2,484**  &nbsp;&nbsp; `70 stars today`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **71,787** &nbsp;&nbsp; folks: **3,913**  &nbsp;&nbsp; `327 stars today`
...
1. [dotnet / maui](https://github.com/dotnet/maui)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **22,908** &nbsp;&nbsp; folks: **1,871**  &nbsp;&nbsp; `15 stars today`

1. [google / wire](https://github.com/google/wire)
    - Compile-time Dependency Injection for Go
    - language: **Go** &nbsp;&nbsp; stars: **14,146** &nbsp;&nbsp; folks: **668**  &nbsp;&nbsp; `30 stars today`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,962** &nbsp;&nbsp; folks: **1,254**  &nbsp;&nbsp; `566 stars this week`

1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **35,107** &nbsp;&nbsp; folks: **4,019**  &nbsp;&nbsp; `2,482 stars this week`
...
1. [umami-software / umami](https://github.com/umami-software/umami)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,961** &nbsp;&nbsp; folks: **5,383**  &nbsp;&nbsp; `2,281 stars this week`

1. [external-secrets / external-secrets](https://github.com/external-secrets/external-secrets)
    - External Secrets Operator reads information from a third-party service like AWS Secrets Manager and automatically injects the values as Kubernetes Secrets.
    - language: **Go** &nbsp;&nbsp; stars: **5,526** &nbsp;&nbsp; folks: **1,042**  &nbsp;&nbsp; `245 stars this week`

1. [idosal / git-mcp](https://github.com/idosal/git-mcp)
    - Put an end to code hallucinations! GitMCP is a free, open-source, remote MCP server for any GitHub project
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,243** &nbsp;&nbsp; folks: **391**  &nbsp;&nbsp; `1,205 stars this week`
...
1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    - Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!
    - language: **Python** &nbsp;&nbsp; stars: **8,784** &nbsp;&nbsp; folks: **687**  &nbsp;&nbsp; `1,767 stars this week`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,492** &nbsp;&nbsp; folks: **1,457**  &nbsp;&nbsp; `920 stars this week`

1. [filamentphp / filament](https://github.com/filamentphp/filament)
    - A powerful open source UI framework for Laravel • Build and ship admin panels & apps fast with Livewire
    - language: **PHP** &nbsp;&nbsp; stars: **25,719** &nbsp;&nbsp; folks: **3,671**  &nbsp;&nbsp; `384 stars this week`

1. [patchy631 / ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)
    - In-depth tutorials on LLMs, RAGs and real-world AI agent applications.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **17,349** &nbsp;&nbsp; folks: **2,886**  &nbsp;&nbsp; `1,542 stars this week`

1. [lfnovo / open-notebook](https://github.com/lfnovo/open-notebook)
    - An Open Source implementation of Notebook LM with more flexibility and features
    - language: **Python** &nbsp;&nbsp; stars: **3,489** &nbsp;&nbsp; folks: **355**  &nbsp;&nbsp; `865 stars this week`
...
1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,291** &nbsp;&nbsp; folks: **992**  &nbsp;&nbsp; `8,887 stars this month`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **7,825** &nbsp;&nbsp; folks: **1,033**  &nbsp;&nbsp; `3,432 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,774** &nbsp;&nbsp; folks: **589**  &nbsp;&nbsp; `6,775 stars this month`
...
1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **55,373** &nbsp;&nbsp; folks: **9,410**  &nbsp;&nbsp; `3,143 stars this month`
