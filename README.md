...
1. [payloadcms / payload](https://github.com/payloadcms/payload)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **27,896** &nbsp;&nbsp; folks: **1,730**  &nbsp;&nbsp; `208 stars today`

1. [FreeCAD / FreeCAD](https://github.com/FreeCAD/FreeCAD)
    - This is the official source code of FreeCAD, a free and opensource multiplatform 3D parametric modeler.
    - language: **C++** &nbsp;&nbsp; stars: **20,691** &nbsp;&nbsp; folks: **4,103**  &nbsp;&nbsp; `311 stars today`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **338,936** &nbsp;&nbsp; folks: **61,743**  &nbsp;&nbsp; `330 stars today`

1. [openai / openai-cookbook](https://github.com/openai/openai-cookbook)
    - Examples and guides for using the OpenAI API
    - language: **MDX** &nbsp;&nbsp; stars: **60,082** &nbsp;&nbsp; folks: **9,563**  &nbsp;&nbsp; `33 stars today`

1. [RSSNext / Follow](https://github.com/RSSNext/Follow)
    - 🧡 Follow your favorites in one inbox
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,564** &nbsp;&nbsp; folks: **721**  &nbsp;&nbsp; `487 stars today`
...
1. [daytonaio / daytona](https://github.com/daytonaio/daytona)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **11,617** &nbsp;&nbsp; folks: **848**  &nbsp;&nbsp; `131 stars today`
...
1. [google / googletest](https://github.com/google/googletest)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **34,887** &nbsp;&nbsp; folks: **10,155**  &nbsp;&nbsp; `19 stars today`
...
1. [DataExpert-io / data-engineer-handbook](https://github.com/DataExpert-io/data-engineer-handbook)
    ...
    - language: **Makefile** &nbsp;&nbsp; stars: **20,453** &nbsp;&nbsp; folks: **3,042**  &nbsp;&nbsp; `7,566 stars this week`

1. [microsoft / TinyTroupe](https://github.com/microsoft/TinyTroupe)
    - LLM-powered multiagent persona simulation for imagination enhancement and business insights.
    - language: **Python** &nbsp;&nbsp; stars: **4,153** &nbsp;&nbsp; folks: **290**  &nbsp;&nbsp; `1,528 stars this week`
...
1. [ai16z / eliza](https://github.com/ai16z/eliza)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,949** &nbsp;&nbsp; folks: **512**  &nbsp;&nbsp; `981 stars this week`
...
1. [opendatalab / MinerU](https://github.com/opendatalab/MinerU)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **18,174** &nbsp;&nbsp; folks: **1,303**  &nbsp;&nbsp; `2,556 stars this week`

1. [GoogleCloudPlatform / generative-ai](https://github.com/GoogleCloudPlatform/generative-ai)
    - Sample code and notebooks for Generative AI on Google Cloud, with Gemini on Vertex AI
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **8,153** &nbsp;&nbsp; folks: **2,302**  &nbsp;&nbsp; `580 stars this week`
...
1. [payloadcms / payload](https://github.com/payloadcms/payload)
    - Payload is the open-source, fullstack Next.js framework, giving you instant backend superpowers. Get a full TypeScript backend and admin panel instantly. Use Payload as a headless CMS or for building powerful applications.
    - language: **TypeScript** &nbsp;&nbsp; stars: **27,896** &nbsp;&nbsp; folks: **1,730**  &nbsp;&nbsp; `2,092 stars this week`

1. [Bin-Huang / chatbox](https://github.com/Bin-Huang/chatbox)
    - User-friendly Desktop Client App for AI Models/LLMs (GPT, Claude, Gemini, Ollama...)
    - language: **TypeScript** &nbsp;&nbsp; stars: **22,804** &nbsp;&nbsp; folks: **2,271**  &nbsp;&nbsp; `1,079 stars this week`
...
1. [tursodatabase / libsql](https://github.com/tursodatabase/libsql)
    ...
    - language: **C** &nbsp;&nbsp; stars: **11,771** &nbsp;&nbsp; folks: **293**  &nbsp;&nbsp; `881 stars this week`

1. [krahets / hello-algo](https://github.com/krahets/hello-algo)
    - 《Hello 算法》：动画图解、一键运行的数据结构与算法教程。支持 Python, Java, C++, C, C#, JS, Go, Swift, Rust, Ruby, Kotlin, TS, Dart 代码。简体版和繁体版同步更新，English version ongoing
    - language: **Java** &nbsp;&nbsp; stars: **99,676** &nbsp;&nbsp; folks: **12,553**  &nbsp;&nbsp; `1,208 stars this week`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **277,092** &nbsp;&nbsp; folks: **46,474**  &nbsp;&nbsp; `1,507 stars this week`
...
1. [DS4SD / docling](https://github.com/DS4SD/docling)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,573** &nbsp;&nbsp; folks: **510**  &nbsp;&nbsp; `9,838 stars this month`

1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **29,570** &nbsp;&nbsp; folks: **2,018**  &nbsp;&nbsp; `11,803 stars this month`
...
1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **60,568** &nbsp;&nbsp; folks: **7,436**  &nbsp;&nbsp; `3,934 stars this month`

1. [opendatalab / MinerU](https://github.com/opendatalab/MinerU)
    - A high-quality tool for convert PDF to Markdown and JSON.一站式开源高质量数据提取工具，将PDF转换成Markdown和JSON格式。
    - language: **Python** &nbsp;&nbsp; stars: **18,174** &nbsp;&nbsp; folks: **1,303**  &nbsp;&nbsp; `5,046 stars this month`
...
1. [payloadcms / payload](https://github.com/payloadcms/payload)
    - Payload is the open-source, fullstack Next.js framework, giving you instant backend superpowers. Get a full TypeScript backend and admin panel instantly. Use Payload as a headless CMS or for building powerful applications.
    - language: **TypeScript** &nbsp;&nbsp; stars: **27,896** &nbsp;&nbsp; folks: **1,730**  &nbsp;&nbsp; `3,198 stars this month`
...
1. [OpenInterpreter / open-interpreter](https://github.com/OpenInterpreter/open-interpreter)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **55,691** &nbsp;&nbsp; folks: **4,833**  &nbsp;&nbsp; `3,145 stars this month`
...
1. [mudler / LocalAI](https://github.com/mudler/LocalAI)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **26,199** &nbsp;&nbsp; folks: **1,961**  &nbsp;&nbsp; `2,138 stars this month`
