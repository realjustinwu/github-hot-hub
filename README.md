...
`更新时间：2025-07-18 19:23:20 +0800`

## 今日热门仓库

1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    - Python tool for converting files and office documents to Markdown.
    - language: **Python** &nbsp;&nbsp; stars: **67,209** &nbsp;&nbsp; folks: **3,559**  &nbsp;&nbsp; `1,870 stars today`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **4,896** &nbsp;&nbsp; folks: **704**  &nbsp;&nbsp; `221 stars today`
...
1. [facebookresearch / segment-anything](https://github.com/facebookresearch/segment-anything)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **51,048** &nbsp;&nbsp; folks: **5,990**  &nbsp;&nbsp; `138 stars today`

1. [hyprwm / Hyprland](https://github.com/hyprwm/Hyprland)
    - Hyprland is an independent, highly customizable, dynamic tiling Wayland compositor that doesn't sacrifice on its looks.
    - language: **C++** &nbsp;&nbsp; stars: **27,082** &nbsp;&nbsp; folks: **1,147**  &nbsp;&nbsp; `66 stars today`
...
1. [soxoj / maigret](https://github.com/soxoj/maigret)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,293** &nbsp;&nbsp; folks: **1,122**  &nbsp;&nbsp; `208 stars today`
...
1. [arc53 / DocsGPT](https://github.com/arc53/DocsGPT)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,293** &nbsp;&nbsp; folks: **1,713**  &nbsp;&nbsp; `276 stars today`

1. [Lightricks / LTX-Video](https://github.com/Lightricks/LTX-Video)
    - Official repository for LTX-Video
    - language: **Python** &nbsp;&nbsp; stars: **7,189** &nbsp;&nbsp; folks: **620**  &nbsp;&nbsp; `98 stars today`
...
1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **120,008** &nbsp;&nbsp; folks: **36,129**  &nbsp;&nbsp; `741 stars today`

1. [remoteintech / remote-jobs](https://github.com/remoteintech/remote-jobs)
    - A list of semi to fully remote-friendly companies (jobs) in tech.
    - language: **JavaScript** &nbsp;&nbsp; stars: **32,062** &nbsp;&nbsp; folks: **3,371**  &nbsp;&nbsp; `60 stars today`
...
1. [pydantic / pydantic-ai](https://github.com/pydantic/pydantic-ai)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,911** &nbsp;&nbsp; folks: **1,043**  &nbsp;&nbsp; `49 stars today`

1. [strapi / strapi](https://github.com/strapi/strapi)
    - 🚀 Strapi is the leading open-source headless CMS. It’s 100% JavaScript/TypeScript, fully customizable, and developer-first.
    - language: **TypeScript** &nbsp;&nbsp; stars: **68,095** &nbsp;&nbsp; folks: **8,753**  &nbsp;&nbsp; `59 stars today`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    - Python tool for converting files and office documents to Markdown.
    - language: **Python** &nbsp;&nbsp; stars: **67,209** &nbsp;&nbsp; folks: **3,559**  &nbsp;&nbsp; `6,137 stars this week`
...
1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    ...
    - language: **PowerShell** &nbsp;&nbsp; stars: **24,303** &nbsp;&nbsp; folks: **1,319**  &nbsp;&nbsp; `5,589 stars this week`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,674** &nbsp;&nbsp; folks: **430**  &nbsp;&nbsp; `2,044 stars this week`
...
1. [Alibaba-NLP / WebAgent](https://github.com/Alibaba-NLP/WebAgent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,556** &nbsp;&nbsp; folks: **339**  &nbsp;&nbsp; `1,298 stars this week`

1. [getzep / graphiti](https://github.com/getzep/graphiti)
    - Build Real-Time Knowledge Graphs for AI Agents
    - language: **Python** &nbsp;&nbsp; stars: **14,114** &nbsp;&nbsp; folks: **1,189**  &nbsp;&nbsp; `1,737 stars this week`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **43,141** &nbsp;&nbsp; folks: **3,865**  &nbsp;&nbsp; `778 stars this week`

1. [snap-stanford / Biomni](https://github.com/snap-stanford/Biomni)
    - Biomni: a general-purpose biomedical AI agent
    - language: **Python** &nbsp;&nbsp; stars: **1,738** &nbsp;&nbsp; folks: **205**  &nbsp;&nbsp; `857 stars this week`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **32,311** &nbsp;&nbsp; folks: **7,762**  &nbsp;&nbsp; `8,762 stars this month`
...
1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **24,303** &nbsp;&nbsp; folks: **1,319**  &nbsp;&nbsp; `10,834 stars this month`
...
1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **74,942** &nbsp;&nbsp; folks: **16,529**  &nbsp;&nbsp; `2,208 stars this month`
...
1. [snailyp / gemini-balance](https://github.com/snailyp/gemini-balance)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,374** &nbsp;&nbsp; folks: **590**  &nbsp;&nbsp; `1,573 stars this month`

1. [stanford-oval / storm](https://github.com/stanford-oval/storm)
    - An LLM-powered knowledge curation system that researches a topic and generates a full-length report with citations.
    - language: **Python** &nbsp;&nbsp; stars: **26,731** &nbsp;&nbsp; folks: **2,406**  &nbsp;&nbsp; `2,186 stars this month`
