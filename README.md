...
1. [karpathy / nanoGPT](https://github.com/karpathy/nanoGPT)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **45,916** &nbsp;&nbsp; folks: **7,788**  &nbsp;&nbsp; `299 stars today`

1. [nvm-sh / nvm](https://github.com/nvm-sh/nvm)
    - Node Version Manager - POSIX-compliant bash script to manage multiple active node.js versions
    - language: **Shell** &nbsp;&nbsp; stars: **87,633** &nbsp;&nbsp; folks: **9,421**  &nbsp;&nbsp; `119 stars today`

1. [envoyproxy / envoy](https://github.com/envoyproxy/envoy)
    - Cloud-native high-performance edge/middle/service proxy
    - language: **C++** &nbsp;&nbsp; stars: **26,752** &nbsp;&nbsp; folks: **5,106**  &nbsp;&nbsp; `7 stars today`
...
1. [DigitalPlatDev / FreeDomain](https://github.com/DigitalPlatDev/FreeDomain)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **107,148** &nbsp;&nbsp; folks: **2,020**  &nbsp;&nbsp; `601 stars today`

1. [ChristianLempa / boilerplates](https://github.com/ChristianLempa/boilerplates)
    - This is my personal template collection. Here you'll find templates, and configurations for various tools, and technologies.
    - language: **Python** &nbsp;&nbsp; stars: **6,466** &nbsp;&nbsp; folks: **1,772**  &nbsp;&nbsp; `54 stars today`
...
1. [dair-ai / Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide)
    ...
    - language: **MDX** &nbsp;&nbsp; stars: **64,032** &nbsp;&nbsp; folks: **6,672**  &nbsp;&nbsp; `330 stars today`

1. [nanobrowser / nanobrowser](https://github.com/nanobrowser/nanobrowser)
    - Open-Source Chrome extension for AI-powered web automation. Run multi-agent workflows using your own LLM API key. Alternative to OpenAI Operator.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,264** &nbsp;&nbsp; folks: **1,028**  &nbsp;&nbsp; `57 stars today`

1. [czlonkowski / n8n-mcp](https://github.com/czlonkowski/n8n-mcp)
    - A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8n workflows for you
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,614** &nbsp;&nbsp; folks: **1,614**  &nbsp;&nbsp; `105 stars today`
...
1. [anthropics / prompt-eng-interactive-tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial)
    - Anthropic's Interactive Prompt Engineering Tutorial
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **23,960** &nbsp;&nbsp; folks: **2,205**  &nbsp;&nbsp; `5,108 stars this week`

1. [Stremio / stremio-web](https://github.com/Stremio/stremio-web)
    - Stremio - Freedom to Stream
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,059** &nbsp;&nbsp; folks: **894**  &nbsp;&nbsp; `3,453 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **TypeScript** &nbsp;&nbsp; stars: **39,071** &nbsp;&nbsp; folks: **2,457**  &nbsp;&nbsp; `3,378 stars this week`
...
1. [supermemoryai / supermemory](https://github.com/supermemoryai/supermemory)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,091** &nbsp;&nbsp; folks: **1,276**  &nbsp;&nbsp; `904 stars this week`

1. [MODSetter / SurfSense](https://github.com/MODSetter/SurfSense)
    - Open Source Alternative to NotebookLM / Perplexity, connected to external sources such as Search Engines, Slack, Linear, Jira, ClickUp, Confluence, Notion, YouTube, GitHub, Discord and more. Join our discord: https://discord.gg/ejRNvftDp9
    - language: **Python** &nbsp;&nbsp; stars: **9,750** &nbsp;&nbsp; folks: **766**  &nbsp;&nbsp; `1,256 stars this week`
...
1. [TibixDev / winboat](https://github.com/TibixDev/winboat)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,561** &nbsp;&nbsp; folks: **289**  &nbsp;&nbsp; `4,763 stars this week`
...
1. [dgtlmoon / changedetection.io](https://github.com/dgtlmoon/changedetection.io)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **28,023** &nbsp;&nbsp; folks: **1,555**  &nbsp;&nbsp; `481 stars this week`
...
1. [microsoft / RD-Agent](https://github.com/microsoft/RD-Agent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,627** &nbsp;&nbsp; folks: **899**  &nbsp;&nbsp; `505 stars this week`
...
1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **46,466** &nbsp;&nbsp; folks: **6,502**  &nbsp;&nbsp; `6,758 stars this month`
...
1. [anthropics / prompt-eng-interactive-tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial)
    - Anthropic's Interactive Prompt Engineering Tutorial
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **23,960** &nbsp;&nbsp; folks: **2,205**  &nbsp;&nbsp; `5,430 stars this month`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **47,711** &nbsp;&nbsp; folks: **5,756**  &nbsp;&nbsp; `6,954 stars this month`
...
1. [google-research / timesfm](https://github.com/google-research/timesfm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,793** &nbsp;&nbsp; folks: **584**  &nbsp;&nbsp; `1,303 stars this month`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **Python** &nbsp;&nbsp; stars: **372,573** &nbsp;&nbsp; folks: **64,788**  &nbsp;&nbsp; `4,767 stars this month`

1. [WebGoat / WebGoat](https://github.com/WebGoat/WebGoat)
    - WebGoat is a deliberately insecure application
    - language: **JavaScript** &nbsp;&nbsp; stars: **8,603** &nbsp;&nbsp; folks: **6,803**  &nbsp;&nbsp; `877 stars this month`
...
1. [supermemoryai / supermemory](https://github.com/supermemoryai/supermemory)
    - Memory engine and app that is extremely fast, scalable. The Memory API for the AI era.
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,091** &nbsp;&nbsp; folks: **1,276**  &nbsp;&nbsp; `1,151 stars this month`
