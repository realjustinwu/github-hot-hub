...
1. [EmenstaNougat / ESP32-BlueJammer](https://github.com/EmenstaNougat/ESP32-BlueJammer)
    ...
    - language: **无** &nbsp;&nbsp; stars: **3,524** &nbsp;&nbsp; folks: **516**  &nbsp;&nbsp; `284 stars today`

1. [9001 / copyparty](https://github.com/9001/copyparty)
    - Portable file server with accelerated resumable uploads, dedup, WebDAV, FTP, TFTP, zeroconf, media indexer, thumbnails++ all in one file, no deps
    - language: **Python** &nbsp;&nbsp; stars: **16,334** &nbsp;&nbsp; folks: **524**  &nbsp;&nbsp; `3,223 stars today`
...
1. [Canner / WrenAI](https://github.com/Canner/WrenAI)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,151** &nbsp;&nbsp; folks: **938**  &nbsp;&nbsp; `126 stars today`
...
1. [pointfreeco / swift-composable-architecture](https://github.com/pointfreeco/swift-composable-architecture)
    ...
    - language: **Swift** &nbsp;&nbsp; stars: **13,564** &nbsp;&nbsp; folks: **1,555**  &nbsp;&nbsp; `22 stars today`

1. [fastrepl / hyprnote](https://github.com/fastrepl/hyprnote)
    - Local-first AI Notepad for Private Meetings
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,653** &nbsp;&nbsp; folks: **185**  &nbsp;&nbsp; `208 stars today`

1. [NemProject / nem](https://github.com/NemProject/nem)
    - number go up 💹
    - language: **Java** &nbsp;&nbsp; stars: **67** &nbsp;&nbsp; folks: **17**  &nbsp;&nbsp; `206 stars today`
...
1. [linkwarden / linkwarden](https://github.com/linkwarden/linkwarden)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,462** &nbsp;&nbsp; folks: **523**  &nbsp;&nbsp; `34 stars today`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer.
    - language: **Rust** &nbsp;&nbsp; stars: **94,462** &nbsp;&nbsp; folks: **13,816**  &nbsp;&nbsp; `147 stars today`
...
1. [QwenLM / Qwen3-Coder](https://github.com/QwenLM/Qwen3-Coder)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,511** &nbsp;&nbsp; folks: **734**  &nbsp;&nbsp; `2,693 stars this week`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **21,080** &nbsp;&nbsp; folks: **4,209**  &nbsp;&nbsp; `5,322 stars this week`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **54,154** &nbsp;&nbsp; folks: **6,291**  &nbsp;&nbsp; `2,860 stars this week`
...
1. [roboflow / supervision](https://github.com/roboflow/supervision)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **32,445** &nbsp;&nbsp; folks: **2,584**  &nbsp;&nbsp; `2,136 stars this week`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **34,587** &nbsp;&nbsp; folks: **8,116**  &nbsp;&nbsp; `10,743 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,019** &nbsp;&nbsp; folks: **400**  &nbsp;&nbsp; `5,957 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **27,121** &nbsp;&nbsp; folks: **1,511**  &nbsp;&nbsp; `10,724 stars this month`
...
1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **6,772** &nbsp;&nbsp; folks: **905**  &nbsp;&nbsp; `2,581 stars this month`
...
1. [gorhill / uBlock](https://github.com/gorhill/uBlock)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **57,000** &nbsp;&nbsp; folks: **3,629**  &nbsp;&nbsp; `2,289 stars this month`
