...
1. [scrapy / scrapy](https://github.com/scrapy/scrapy)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **56,447** &nbsp;&nbsp; folks: **10,894**  &nbsp;&nbsp; `97 stars today`
...
1. [DavidHDev / react-bits](https://github.com/DavidHDev/react-bits)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **12,822** &nbsp;&nbsp; folks: **478**  &nbsp;&nbsp; `120 stars today`
...
1. [Daymychen / art-design-pro](https://github.com/Daymychen/art-design-pro)
    ...
    - language: **Vue** &nbsp;&nbsp; stars: **1,755** &nbsp;&nbsp; folks: **305**  &nbsp;&nbsp; `69 stars today`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **101,797** &nbsp;&nbsp; folks: **15,295**  &nbsp;&nbsp; `420 stars today`

1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **无** &nbsp;&nbsp; stars: **54,751** &nbsp;&nbsp; folks: **5,836**  &nbsp;&nbsp; `205 stars today`

1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    - A collective list of free APIs
    - language: **Python** &nbsp;&nbsp; stars: **349,864** &nbsp;&nbsp; folks: **36,786**  &nbsp;&nbsp; `231 stars today`
...
1. [iib0011 / omni-tools](https://github.com/iib0011/omni-tools)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,648** &nbsp;&nbsp; folks: **107**  &nbsp;&nbsp; `326 stars today`
...
1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **8,196** &nbsp;&nbsp; folks: **1,030**  &nbsp;&nbsp; `2,133 stars this week`

1. [anthropics / prompt-eng-interactive-tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial)
    - Anthropic's Interactive Prompt Engineering Tutorial
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **10,963** &nbsp;&nbsp; folks: **1,005**  &nbsp;&nbsp; `5,108 stars this week`

1. [anthropics / courses](https://github.com/anthropics/courses)
    - Anthropic's educational courses
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **14,757** &nbsp;&nbsp; folks: **1,258**  &nbsp;&nbsp; `2,387 stars this week`
...
1. [Fosowl / agenticSeek](https://github.com/Fosowl/agenticSeek)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,248** &nbsp;&nbsp; folks: **1,621**  &nbsp;&nbsp; `3,487 stars this week`
...
1. [netbirdio / netbird](https://github.com/netbirdio/netbird)
    - Connect your devices into a secure WireGuard®-based overlay network with SSO, MFA and granular access controls.
    - language: **Go** &nbsp;&nbsp; stars: **14,982** &nbsp;&nbsp; folks: **706**  &nbsp;&nbsp; `647 stars this week`
...
1. [MervinPraison / PraisonAI](https://github.com/MervinPraison/PraisonAI)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,784** &nbsp;&nbsp; folks: **663**  &nbsp;&nbsp; `475 stars this week`

1. [block / goose](https://github.com/block/goose)
    - an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM
    - language: **Rust** &nbsp;&nbsp; stars: **14,109** &nbsp;&nbsp; folks: **1,108**  &nbsp;&nbsp; `830 stars this week`
...
1. [scrapy / scrapy](https://github.com/scrapy/scrapy)
    - Scrapy, a fast high-level web crawling & scraping framework for Python.
    - language: **Python** &nbsp;&nbsp; stars: **56,447** &nbsp;&nbsp; folks: **10,894**  &nbsp;&nbsp; `934 stars this week`
...
1. [Fosowl / agenticSeek](https://github.com/Fosowl/agenticSeek)
    - Fully Local Manus AI. No APIs, No $200 monthly bills. Enjoy an autonomous agent that thinks, browses the web, and code for the sole cost of electricity. 🔔 Official updates only via twitter @Martin993886460. Any other account is fake.
    - language: **Python** &nbsp;&nbsp; stars: **17,248** &nbsp;&nbsp; folks: **1,621**  &nbsp;&nbsp; `15,112 stars this month`
...
1. [mem0ai / mem0](https://github.com/mem0ai/mem0)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,940** &nbsp;&nbsp; folks: **3,361**  &nbsp;&nbsp; `5,304 stars this month`
...
1. [voideditor / void](https://github.com/voideditor/void)
    - 无
    - language: **TypeScript** &nbsp;&nbsp; stars: **23,188** &nbsp;&nbsp; folks: **1,510**  &nbsp;&nbsp; `10,783 stars this month`
...
1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **无** &nbsp;&nbsp; stars: **54,751** &nbsp;&nbsp; folks: **5,836**  &nbsp;&nbsp; `4,696 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **11,699** &nbsp;&nbsp; folks: **648**  &nbsp;&nbsp; `3,309 stars this month`

1. [anthropics / courses](https://github.com/anthropics/courses)
    - Anthropic's educational courses
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **14,757** &nbsp;&nbsp; folks: **1,258**  &nbsp;&nbsp; `3,286 stars this month`
...
1. [public-apis / public-apis](https://github.com/public-apis/public-apis)
    - A collective list of free APIs
    - language: **Python** &nbsp;&nbsp; stars: **349,864** &nbsp;&nbsp; folks: **36,786**  &nbsp;&nbsp; `11,388 stars this month`
...
1. [MODSetter / SurfSense](https://github.com/MODSetter/SurfSense)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,520** &nbsp;&nbsp; folks: **388**  &nbsp;&nbsp; `3,059 stars this month`

1. [CopilotKit / CopilotKit](https://github.com/CopilotKit/CopilotKit)
    - React UI + elegant infrastructure for AI Copilots, AI chatbots, and in-app AI agents. The Agentic last-mile 🪁
    - language: **TypeScript** &nbsp;&nbsp; stars: **20,899** &nbsp;&nbsp; folks: **2,857**  &nbsp;&nbsp; `2,393 stars this month`

1. [jujumilk3 / leaked-system-prompts](https://github.com/jujumilk3/leaked-system-prompts)
    - Collection of leaked system prompts
    - language: **无** &nbsp;&nbsp; stars: **9,228** &nbsp;&nbsp; folks: **1,160**  &nbsp;&nbsp; `2,957 stars this month`
