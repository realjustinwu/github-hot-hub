...
1. [QuentinFuxa / WhisperLiveKit](https://github.com/QuentinFuxa/WhisperLiveKit)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,560** &nbsp;&nbsp; folks: **276**  &nbsp;&nbsp; `436 stars today`

1. [microsoft / mcp](https://github.com/microsoft/mcp)
    - Catalog of official Microsoft MCP (Model Context Protocol) server implementations for AI-powered data access and tool integration
    - language: **C#** &nbsp;&nbsp; stars: **920** &nbsp;&nbsp; folks: **100**  &nbsp;&nbsp; `257 stars today`
...
1. [OpenBMB / MiniCPM-V](https://github.com/OpenBMB/MiniCPM-V)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **20,436** &nbsp;&nbsp; folks: **1,495**  &nbsp;&nbsp; `90 stars today`

1. [twbs / bootstrap](https://github.com/twbs/bootstrap)
    - The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web.
    - language: **MDX** &nbsp;&nbsp; stars: **173,200** &nbsp;&nbsp; folks: **79,145**  &nbsp;&nbsp; `124 stars today`

1. [TheAlgorithms / Python](https://github.com/TheAlgorithms/Python)
    - All Algorithms implemented in Python
    - language: **Python** &nbsp;&nbsp; stars: **205,081** &nbsp;&nbsp; folks: **47,541**  &nbsp;&nbsp; `214 stars today`
...
1. [humanlayer / humanlayer](https://github.com/humanlayer/humanlayer)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,414** &nbsp;&nbsp; folks: **139**  &nbsp;&nbsp; `91 stars today`
...
1. [spf13 / cobra](https://github.com/spf13/cobra)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **41,690** &nbsp;&nbsp; folks: **2,984**  &nbsp;&nbsp; `20 stars today`

1. [microsoft / terminal](https://github.com/microsoft/terminal)
    - The new Windows Terminal and the original Windows console host, all in the same place!
    - language: **C++** &nbsp;&nbsp; stars: **99,680** &nbsp;&nbsp; folks: **8,720**  &nbsp;&nbsp; `152 stars today`
...
1. [opf / openproject](https://github.com/opf/openproject)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **12,401** &nbsp;&nbsp; folks: **2,777**  &nbsp;&nbsp; `236 stars today`

1. [juspay / hyperswitch](https://github.com/juspay/hyperswitch)
    - An open source payments switch written in Rust to make payments fast, reliable and affordable
    - language: **Rust** &nbsp;&nbsp; stars: **25,121** &nbsp;&nbsp; folks: **3,926**  &nbsp;&nbsp; `519 stars today`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer.
    - language: **Rust** &nbsp;&nbsp; stars: **96,637** &nbsp;&nbsp; folks: **14,186**  &nbsp;&nbsp; `113 stars today`
...
1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **8,046** &nbsp;&nbsp; folks: **240**  &nbsp;&nbsp; `4,227 stars this week`
...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,903** &nbsp;&nbsp; folks: **1,503**  &nbsp;&nbsp; `3,259 stars this week`
...
1. [twbs / bootstrap](https://github.com/twbs/bootstrap)
    - The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web.
    - language: **MDX** &nbsp;&nbsp; stars: **173,200** &nbsp;&nbsp; folks: **79,145**  &nbsp;&nbsp; `286 stars this week`
...
1. [microsoft / terminal](https://github.com/microsoft/terminal)
    - The new Windows Terminal and the original Windows console host, all in the same place!
    - language: **C++** &nbsp;&nbsp; stars: **99,680** &nbsp;&nbsp; folks: **8,720**  &nbsp;&nbsp; `319 stars this week`
...
1. [charmbracelet / crush](https://github.com/charmbracelet/crush)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **11,160** &nbsp;&nbsp; folks: **543**  &nbsp;&nbsp; `10,978 stars this month`
...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Sim is an open-source AI agent workflow builder. Sim's interface is a lightweight, intuitive way to rapidly build and deploy LLMs that connect with your favorite tools.
    - language: **TypeScript** &nbsp;&nbsp; stars: **12,903** &nbsp;&nbsp; folks: **1,503**  &nbsp;&nbsp; `6,510 stars this month`
...
1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    - Run Windows apps such as Microsoft Office/Adobe in Linux (Ubuntu/Fedora) and GNOME/KDE as if they were a part of the native OS, including Nautilus integration. Hard fork of https://github.com/Fmstrat/winapps/
    - language: **Shell** &nbsp;&nbsp; stars: **8,046** &nbsp;&nbsp; folks: **240**  &nbsp;&nbsp; `5,024 stars this month`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **37,295** &nbsp;&nbsp; folks: **4,282**  &nbsp;&nbsp; `5,734 stars this month`

1. [9001 / copyparty](https://github.com/9001/copyparty)
    - Portable file server with accelerated resumable uploads, dedup, WebDAV, FTP, TFTP, zeroconf, media indexer, thumbnails++ all in one file, no deps
    - language: **Python** &nbsp;&nbsp; stars: **27,633** &nbsp;&nbsp; folks: **1,035**  &nbsp;&nbsp; `22,661 stars this month`
...
1. [oraios / serena](https://github.com/oraios/serena)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,393** &nbsp;&nbsp; folks: **721**  &nbsp;&nbsp; `5,221 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,890** &nbsp;&nbsp; folks: **1,187**  &nbsp;&nbsp; `7,738 stars this month`

1. [ggml-org / llama.cpp](https://github.com/ggml-org/llama.cpp)
    - LLM inference in C/C++
    - language: **C++** &nbsp;&nbsp; stars: **85,739** &nbsp;&nbsp; folks: **12,867**  &nbsp;&nbsp; `2,326 stars this month`
