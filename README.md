...
1. [enescingoz / awesome-n8n-templates](https://github.com/enescingoz/awesome-n8n-templates)
    ...
    - language: **无** &nbsp;&nbsp; stars: **8,973** &nbsp;&nbsp; folks: **2,689**  &nbsp;&nbsp; `139 stars today`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **4,332** &nbsp;&nbsp; folks: **178**  &nbsp;&nbsp; `496 stars today`

1. [immich-app / immich](https://github.com/immich-app/immich)
    - High performance self-hosted photo and video management solution.
    - language: **TypeScript** &nbsp;&nbsp; stars: **73,147** &nbsp;&nbsp; folks: **3,859**  &nbsp;&nbsp; `75 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **59,350** &nbsp;&nbsp; folks: **7,116**  &nbsp;&nbsp; `816 stars today`
...
1. [mfts / papermark](https://github.com/mfts/papermark)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,101** &nbsp;&nbsp; folks: **979**  &nbsp;&nbsp; `64 stars today`
...
1. [ubicloud / ubicloud](https://github.com/ubicloud/ubicloud)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **9,726** &nbsp;&nbsp; folks: **422**  &nbsp;&nbsp; `3,931 stars this week`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,335** &nbsp;&nbsp; folks: **1,561**  &nbsp;&nbsp; `1,646 stars this week`

1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **2,609** &nbsp;&nbsp; folks: **263**  &nbsp;&nbsp; `711 stars this week`

1. [denizsafak / abogen](https://github.com/denizsafak/abogen)
    - Generate audiobooks from EPUBs, PDFs and text with synchronized captions.
    - language: **Python** &nbsp;&nbsp; stars: **2,750** &nbsp;&nbsp; folks: **141**  &nbsp;&nbsp; `1,280 stars this week`
...
1. [trailofbits / buttercup](https://github.com/trailofbits/buttercup)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **898** &nbsp;&nbsp; folks: **92**  &nbsp;&nbsp; `535 stars this week`

1. [menloresearch / jan](https://github.com/menloresearch/jan)
    - Jan is an open source alternative to ChatGPT that runs 100% offline on your computer
    - language: **TypeScript** &nbsp;&nbsp; stars: **37,178** &nbsp;&nbsp; folks: **2,179**  &nbsp;&nbsp; `1,377 stars this week`

1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    - Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!
    - language: **Python** &nbsp;&nbsp; stars: **9,011** &nbsp;&nbsp; folks: **706**  &nbsp;&nbsp; `1,713 stars this week`
...
1. [jitsi / jitsi-meet](https://github.com/jitsi/jitsi-meet)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **26,765** &nbsp;&nbsp; folks: **7,376**  &nbsp;&nbsp; `556 stars this week`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **22,455** &nbsp;&nbsp; folks: **4,335**  &nbsp;&nbsp; `13,297 stars this month`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,269** &nbsp;&nbsp; folks: **1,274**  &nbsp;&nbsp; `11,233 stars this month`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Financial data aggregator for humans and AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **50,100** &nbsp;&nbsp; folks: **4,677**  &nbsp;&nbsp; `6,794 stars this month`

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **8,460** &nbsp;&nbsp; folks: **1,542**  &nbsp;&nbsp; `1,987 stars this month`
...
1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,757** &nbsp;&nbsp; folks: **1,016**  &nbsp;&nbsp; `8,385 stars this month`

1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    - A high-performance algorithmic trading platform and event-driven backtester
    - language: **Rust** &nbsp;&nbsp; stars: **14,153** &nbsp;&nbsp; folks: **1,518**  &nbsp;&nbsp; `4,425 stars this month`
...
1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **7,992** &nbsp;&nbsp; folks: **1,056**  &nbsp;&nbsp; `3,326 stars this month`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **11,266** &nbsp;&nbsp; folks: **611**  &nbsp;&nbsp; `6,928 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,590** &nbsp;&nbsp; folks: **9,456**  &nbsp;&nbsp; `3,062 stars this month`
