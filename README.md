...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,080** &nbsp;&nbsp; folks: **1,234**  &nbsp;&nbsp; `1,516 stars today`
...
1. [bitwarden / clients](https://github.com/bitwarden/clients)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,922** &nbsp;&nbsp; folks: **1,462**  &nbsp;&nbsp; `172 stars today`
...
1. [Budibase / budibase](https://github.com/Budibase/budibase)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,685** &nbsp;&nbsp; folks: **1,853**  &nbsp;&nbsp; `35 stars today`

1. [firecrawl / firecrawl](https://github.com/firecrawl/firecrawl)
    - The Web Data API for AI - Turn entire websites into LLM-ready markdown or structured data 🔥
    - language: **TypeScript** &nbsp;&nbsp; stars: **50,670** &nbsp;&nbsp; folks: **4,436**  &nbsp;&nbsp; `599 stars today`

1. [HunxByts / GhostTrack](https://github.com/HunxByts/GhostTrack)
    - Useful tool to track location or mobile number
    - language: **Python** &nbsp;&nbsp; stars: **2,693** &nbsp;&nbsp; folks: **368**  &nbsp;&nbsp; `118 stars today`
...
1. [plait-board / drawnix](https://github.com/plait-board/drawnix)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,869** &nbsp;&nbsp; folks: **390**  &nbsp;&nbsp; `79 stars today`

1. [HeyPuter / puter](https://github.com/HeyPuter/puter)
    - 🌐 The Internet OS! Free, Open-Source, and Self-Hostable.
    - language: **JavaScript** &nbsp;&nbsp; stars: **35,522** &nbsp;&nbsp; folks: **2,716**  &nbsp;&nbsp; `42 stars today`

1. [puppeteer / puppeteer](https://github.com/puppeteer/puppeteer)
    - JavaScript API for Chrome and Firefox
    - language: **TypeScript** &nbsp;&nbsp; stars: **92,035** &nbsp;&nbsp; folks: **9,279**  &nbsp;&nbsp; `169 stars today`

1. [skills / introduction-to-github](https://github.com/skills/introduction-to-github)
    - Get started using GitHub in less than an hour.
    - language: **无** &nbsp;&nbsp; stars: **9,446** &nbsp;&nbsp; folks: **12,007**  &nbsp;&nbsp; `32 stars today`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **5,799** &nbsp;&nbsp; folks: **392**  &nbsp;&nbsp; `2,615 stars this week`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **61,094** &nbsp;&nbsp; folks: **7,364**  &nbsp;&nbsp; `3,526 stars this week`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,890** &nbsp;&nbsp; folks: **1,666**  &nbsp;&nbsp; `1,646 stars this week`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,143** &nbsp;&nbsp; folks: **1,763**  &nbsp;&nbsp; `4,949 stars this month`
...
1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,595** &nbsp;&nbsp; folks: **1,080**  &nbsp;&nbsp; `8,075 stars this month`

1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **5,799** &nbsp;&nbsp; folks: **392**  &nbsp;&nbsp; `3,265 stars this month`
...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Sim is an open-source AI agent workflow builder. Sim's interface is a lightweight, intuitive way to rapidly build and deploy LLMs that connect with your favorite tools.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,080** &nbsp;&nbsp; folks: **1,234**  &nbsp;&nbsp; `3,931 stars this month`
