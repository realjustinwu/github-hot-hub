...
1. [seleniumbase / SeleniumBase](https://github.com/seleniumbase/SeleniumBase)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,444** &nbsp;&nbsp; folks: **1,058**  &nbsp;&nbsp; `314 stars today`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **280,466** &nbsp;&nbsp; folks: **46,973**  &nbsp;&nbsp; `431 stars today`
...
1. [1Panel-dev / 1Panel](https://github.com/1Panel-dev/1Panel)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **23,858** &nbsp;&nbsp; folks: **2,169**  &nbsp;&nbsp; `75 stars today`
...
1. [google-gemini / cookbook](https://github.com/google-gemini/cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **9,139** &nbsp;&nbsp; folks: **1,080**  &nbsp;&nbsp; `3,214 stars this week`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **7,437** &nbsp;&nbsp; folks: **781**  &nbsp;&nbsp; `1,717 stars this week`

1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    - PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/Docker
    - language: **Python** &nbsp;&nbsp; stars: **10,088** &nbsp;&nbsp; folks: **706**  &nbsp;&nbsp; `3,825 stars this week`
...
1. [wavetermdev / waveterm](https://github.com/wavetermdev/waveterm)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,365** &nbsp;&nbsp; folks: **212**  &nbsp;&nbsp; `2,006 stars this week`
...
1. [bigskysoftware / htmx](https://github.com/bigskysoftware/htmx)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **41,499** &nbsp;&nbsp; folks: **1,350**  &nbsp;&nbsp; `2,582 stars this week`
...
1. [comet-ml / opik](https://github.com/comet-ml/opik)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,538** &nbsp;&nbsp; folks: **203**  &nbsp;&nbsp; `967 stars this week`
...
1. [shardeum / shardeum](https://github.com/shardeum/shardeum)
    - Shardeum is an EVM based autoscaling blockchain
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,247** &nbsp;&nbsp; folks: **479**  &nbsp;&nbsp; `3,395 stars this week`

1. [KRTirtho / spotube](https://github.com/KRTirtho/spotube)
    - 🎧 Open source Spotify client that doesn't require Premium nor uses Electron! Available for both desktop & mobile!
    - language: **Dart** &nbsp;&nbsp; stars: **32,781** &nbsp;&nbsp; folks: **1,367**  &nbsp;&nbsp; `597 stars this week`
...
1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    - PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/Docker
    - language: **Python** &nbsp;&nbsp; stars: **10,088** &nbsp;&nbsp; folks: **706**  &nbsp;&nbsp; `7,553 stars this month`

1. [google-gemini / cookbook](https://github.com/google-gemini/cookbook)
    - Examples and guides for using the Gemini API
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **9,139** &nbsp;&nbsp; folks: **1,080**  &nbsp;&nbsp; `3,711 stars this month`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **7,437** &nbsp;&nbsp; folks: **781**  &nbsp;&nbsp; `3,208 stars this month`

1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    - Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue)
    - language: **Python** &nbsp;&nbsp; stars: **65,945** &nbsp;&nbsp; folks: **8,014**  &nbsp;&nbsp; `5,866 stars this month`
...
1. [langflow-ai / langflow](https://github.com/langflow-ai/langflow)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **40,013** &nbsp;&nbsp; folks: **4,520**  &nbsp;&nbsp; `5,112 stars this month`

1. [seleniumbase / SeleniumBase](https://github.com/seleniumbase/SeleniumBase)
    - Python APIs for web automation, testing, and bypassing bot-detection.
    - language: **Python** &nbsp;&nbsp; stars: **7,444** &nbsp;&nbsp; folks: **1,058**  &nbsp;&nbsp; `1,911 stars this month`
...
1. [Guovin / iptv-api](https://github.com/Guovin/iptv-api)
    - 📺IPTV电视直播源更新工具🚀：✨央视、📡卫视、☘️广东及各省份地方台、🌊港·澳·台、🎬电影、🎥咪咕、🏀体育、🪁动画、🎮游戏、🎵音乐、🏛经典剧场；支持IPv4/IPv6；支持自定义增加频道；支持组播源、酒店源、订阅源、关键字搜索；每天自动更新两次，结果可用于TVBox等播放软件；支持工作流、Docker(amd64/arm64/arm v7)、命令行、GUI运行方式 | IPTV live TV source update tool
    - language: **Python** &nbsp;&nbsp; stars: **9,662** &nbsp;&nbsp; folks: **2,057**  &nbsp;&nbsp; `3,821 stars this month`

1. [DS4SD / docling](https://github.com/DS4SD/docling)
    - Get your documents ready for gen AI
    - language: **Python** &nbsp;&nbsp; stars: **16,022** &nbsp;&nbsp; folks: **816**  &nbsp;&nbsp; `5,731 stars this month`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **342,263** &nbsp;&nbsp; folks: **62,063**  &nbsp;&nbsp; `4,222 stars this month`
