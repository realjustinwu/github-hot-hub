...
1. [enescingoz / awesome-n8n-templates](https://github.com/enescingoz/awesome-n8n-templates)
    ...
    - language: **无** &nbsp;&nbsp; stars: **9,399** &nbsp;&nbsp; folks: **2,716**  &nbsp;&nbsp; `130 stars today`
...
1. [immich-app / immich](https://github.com/immich-app/immich)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **73,403** &nbsp;&nbsp; folks: **3,873**  &nbsp;&nbsp; `114 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **59,817** &nbsp;&nbsp; folks: **7,185**  &nbsp;&nbsp; `804 stars today`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **50,345** &nbsp;&nbsp; folks: **4,704**  &nbsp;&nbsp; `508 stars today`
...
1. [mfts / papermark](https://github.com/mfts/papermark)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,276** &nbsp;&nbsp; folks: **993**  &nbsp;&nbsp; `77 stars today`
...
1. [ubicloud / ubicloud](https://github.com/ubicloud/ubicloud)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **9,816** &nbsp;&nbsp; folks: **428**  &nbsp;&nbsp; `3,807 stars this week`

1. [apple / embedding-atlas](https://github.com/apple/embedding-atlas)
    - Embedding Atlas is a tool that provides interactive visualizations for large embeddings. It allows you to visualize, cross-filter, and search embeddings and metadata.
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,764** &nbsp;&nbsp; folks: **119**  &nbsp;&nbsp; `1,845 stars this week`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,512** &nbsp;&nbsp; folks: **1,599**  &nbsp;&nbsp; `1,821 stars this week`
...
1. [denizsafak / abogen](https://github.com/denizsafak/abogen)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,838** &nbsp;&nbsp; folks: **143**  &nbsp;&nbsp; `840 stars this week`
...
1. [filamentphp / filament](https://github.com/filamentphp/filament)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **25,843** &nbsp;&nbsp; folks: **3,687**  &nbsp;&nbsp; `430 stars this week`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **22,560** &nbsp;&nbsp; folks: **4,341**  &nbsp;&nbsp; `13,434 stars this month`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,347** &nbsp;&nbsp; folks: **1,285**  &nbsp;&nbsp; `11,338 stars this month`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Financial data aggregator for humans and AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **50,345** &nbsp;&nbsp; folks: **4,704**  &nbsp;&nbsp; `7,132 stars this month`

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **9,313** &nbsp;&nbsp; folks: **1,633**  &nbsp;&nbsp; `3,278 stars this month`
...
1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,912** &nbsp;&nbsp; folks: **1,028**  &nbsp;&nbsp; `8,154 stars this month`
...
1. [frappe / hrms](https://github.com/frappe/hrms)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,358** &nbsp;&nbsp; folks: **1,560**  &nbsp;&nbsp; `3,585 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,413** &nbsp;&nbsp; folks: **615**  &nbsp;&nbsp; `7,087 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,668** &nbsp;&nbsp; folks: **9,481**  &nbsp;&nbsp; `3,097 stars this month`
