...
1. [Blaizzy / mlx-audio](https://github.com/Blaizzy/mlx-audio)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,870** &nbsp;&nbsp; folks: **129**  &nbsp;&nbsp; `242 stars today`

1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
    - language: **TypeScript** &nbsp;&nbsp; stars: **319,667** &nbsp;&nbsp; folks: **41,371**  &nbsp;&nbsp; `516 stars today`

1. [lobehub / lobe-chat](https://github.com/lobehub/lobe-chat)
    - 🤯 Lobe Chat - an open-source, modern-design AI chat framework. Supports Multi AI Providers( OpenAI / Claude 3 / Gemini / Ollama / DeepSeek / Qwen), Knowledge Base (file upload / knowledge management / RAG ), Multi-Modals (Plugins/Artifacts) and Thinking. One-click FREE deployment of your private ChatGPT/ Claude / DeepSeek application.
    - language: **TypeScript** &nbsp;&nbsp; stars: **60,471** &nbsp;&nbsp; folks: **12,714**  &nbsp;&nbsp; `96 stars today`
...
1. [iptv-org / iptv](https://github.com/iptv-org/iptv)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **93,335** &nbsp;&nbsp; folks: **3,486**  &nbsp;&nbsp; `112 stars today`
...
1. [ahmedkhaleel2004 / gitdiagram](https://github.com/ahmedkhaleel2004/gitdiagram)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,667** &nbsp;&nbsp; folks: **817**  &nbsp;&nbsp; `298 stars today`

1. [comet-ml / opik](https://github.com/comet-ml/opik)
    - Debug, evaluate, and monitor your LLM applications, RAG systems, and agentic workflows with comprehensive tracing, automated evaluations, and production-ready dashboards.
    - language: **Python** &nbsp;&nbsp; stars: **7,623** &nbsp;&nbsp; folks: **524**  &nbsp;&nbsp; `100 stars today`
...
1. [GoogleCloudPlatform / kubectl-ai](https://github.com/GoogleCloudPlatform/kubectl-ai)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **4,806** &nbsp;&nbsp; folks: **340**  &nbsp;&nbsp; `4,182 stars this week`
...
1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **66,458** &nbsp;&nbsp; folks: **9,258**  &nbsp;&nbsp; `6,175 stars this week`

1. [zed-industries / zed](https://github.com/zed-industries/zed)
    - Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter.
    - language: **Rust** &nbsp;&nbsp; stars: **59,402** &nbsp;&nbsp; folks: **4,166**  &nbsp;&nbsp; `1,288 stars this week`
...
1. [ruanyf / weekly](https://github.com/ruanyf/weekly)
    - 科技爱好者周刊，每周五发布
    - language: **无** &nbsp;&nbsp; stars: **61,724** &nbsp;&nbsp; folks: **3,333**  &nbsp;&nbsp; `5,336 stars this week`
...
1. [521xueweihan / HelloGitHub](https://github.com/521xueweihan/HelloGitHub)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **108,808** &nbsp;&nbsp; folks: **10,065**  &nbsp;&nbsp; `5,061 stars this week`
...
1. [Blaizzy / mlx-audio](https://github.com/Blaizzy/mlx-audio)
    - A text-to-speech (TTS), speech-to-text (STT) and speech-to-speech (STS) library built on Apple's MLX framework, providing efficient speech analysis on Apple Silicon.
    - language: **Python** &nbsp;&nbsp; stars: **1,870** &nbsp;&nbsp; folks: **129**  &nbsp;&nbsp; `893 stars this week`
...
1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    - real time face swap and one-click video deepfake with only a single image
    - language: **Python** &nbsp;&nbsp; stars: **66,458** &nbsp;&nbsp; folks: **9,258**  &nbsp;&nbsp; `16,526 stars this month`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **25,100** &nbsp;&nbsp; folks: **3,132**  &nbsp;&nbsp; `15,402 stars this month`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **56,696** &nbsp;&nbsp; folks: **2,888**  &nbsp;&nbsp; `8,719 stars this month`

1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    - Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.
    - language: **TypeScript** &nbsp;&nbsp; stars: **91,908** &nbsp;&nbsp; folks: **25,295**  &nbsp;&nbsp; `13,078 stars this month`

1. [QwenLM / Qwen3](https://github.com/QwenLM/Qwen3)
    - Qwen3 is the large language model series developed by Qwen team, Alibaba Cloud.
    - language: **Shell** &nbsp;&nbsp; stars: **20,847** &nbsp;&nbsp; folks: **1,371**  &nbsp;&nbsp; `4,286 stars this month`

1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - Interactive roadmaps, guides and other educational content to help developers grow in their careers.
    - language: **TypeScript** &nbsp;&nbsp; stars: **319,667** &nbsp;&nbsp; folks: **41,371**  &nbsp;&nbsp; `5,990 stars this month`
