...
`更新时间：2025-04-19 05:22:44 +0800`

## 今日热门仓库

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **76,191** &nbsp;&nbsp; folks: **9,286**  &nbsp;&nbsp; `1,308 stars today`

1. [jlowin / fastmcp](https://github.com/jlowin/fastmcp)
    - 🚀 The fast, Pythonic way to build MCP servers and clients
    - language: **Python** &nbsp;&nbsp; stars: **5,701** &nbsp;&nbsp; folks: **289**  &nbsp;&nbsp; `244 stars today`
...
1. [linera-io / linera-protocol](https://github.com/linera-io/linera-protocol)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **23,115** &nbsp;&nbsp; folks: **1,416**  &nbsp;&nbsp; `1,401 stars today`

1. [docmost / docmost](https://github.com/docmost/docmost)
    - Docmost is an open-source collaborative wiki and documentation software. It is an open-source alternative to Confluence and Notion.
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,978** &nbsp;&nbsp; folks: **672**  &nbsp;&nbsp; `412 stars today`
...
1. [NirDiamant / RAG_Techniques](https://github.com/NirDiamant/RAG_Techniques)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,128** &nbsp;&nbsp; folks: **1,517**  &nbsp;&nbsp; `340 stars today`

1. [browserbase / stagehand](https://github.com/browserbase/stagehand)
    - An AI web browsing framework focused on simplicity and extensibility.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,402** &nbsp;&nbsp; folks: **576**  &nbsp;&nbsp; `310 stars today`
...
1. [1Panel-dev / 1Panel](https://github.com/1Panel-dev/1Panel)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **27,136** &nbsp;&nbsp; folks: **2,379**  &nbsp;&nbsp; `284 stars today`
...
1. [Anxcye / anx-reader](https://github.com/Anxcye/anx-reader)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **4,331** &nbsp;&nbsp; folks: **231**  &nbsp;&nbsp; `273 stars today`
...
1. [All-Hands-AI / OpenHands](https://github.com/All-Hands-AI/OpenHands)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **53,066** &nbsp;&nbsp; folks: **5,913**  &nbsp;&nbsp; `61 stars today`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,068** &nbsp;&nbsp; folks: **2,310**  &nbsp;&nbsp; `10,342 stars this week`
...
1. [jlowin / fastmcp](https://github.com/jlowin/fastmcp)
    - 🚀 The fast, Pythonic way to build MCP servers and clients
    - language: **Python** &nbsp;&nbsp; stars: **5,701** &nbsp;&nbsp; folks: **289**  &nbsp;&nbsp; `1,066 stars this week`
...
1. [NirDiamant / RAG_Techniques](https://github.com/NirDiamant/RAG_Techniques)
    - This repository showcases various advanced techniques for Retrieval-Augmented Generation (RAG) systems. RAG systems combine information retrieval with generative models to provide accurate and contextually rich responses.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,128** &nbsp;&nbsp; folks: **1,517**  &nbsp;&nbsp; `888 stars this week`

1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    - 10 Lessons to Get Started Building AI Agents
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,672** &nbsp;&nbsp; folks: **3,788**  &nbsp;&nbsp; `3,699 stars this week`
...
1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **76,191** &nbsp;&nbsp; folks: **9,286**  &nbsp;&nbsp; `4,069 stars this week`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    - [Support 0.48.x]（Reset Cursor AI MachineID & Bypass Higher Token Limit） Cursor Ai ，自动重置机器ID ， 免费升级使用Pro功能: You've reached your trial request limit. / Too many free trial accounts used on this machine. Please upgrade to pro. We have this limit in place to prevent abuse. Please let us know if you believe this is a mistake.
    - language: **Python** &nbsp;&nbsp; stars: **19,068** &nbsp;&nbsp; folks: **2,310**  &nbsp;&nbsp; `15,605 stars this month`

1. [punkpeye / awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)
    - A collection of MCP servers.
    - language: **无** &nbsp;&nbsp; stars: **39,608** &nbsp;&nbsp; folks: **2,823**  &nbsp;&nbsp; `28,634 stars this month`
...
1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    - 10 Lessons to Get Started Building AI Agents
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,672** &nbsp;&nbsp; folks: **3,788**  &nbsp;&nbsp; `10,796 stars this month`
...
1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **82,810** &nbsp;&nbsp; folks: **22,198**  &nbsp;&nbsp; `14,588 stars this month`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **28,505** &nbsp;&nbsp; folks: **3,210**  &nbsp;&nbsp; `8,685 stars this month`
...
1. [executeautomation / mcp-playwright](https://github.com/executeautomation/mcp-playwright)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,008** &nbsp;&nbsp; folks: **225**  &nbsp;&nbsp; `2,052 stars this month`

1. [PatrickJS / awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules)
    - 📄 A curated list of awesome .cursorrules files
    - language: **无** &nbsp;&nbsp; stars: **22,381** &nbsp;&nbsp; folks: **1,693**  &nbsp;&nbsp; `6,104 stars this month`
