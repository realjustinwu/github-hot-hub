...
1. [codexu / note-gen](https://github.com/codexu/note-gen)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,345** &nbsp;&nbsp; folks: **221**  &nbsp;&nbsp; `127 stars today`
...
1. [unslothai / notebooks](https://github.com/unslothai/notebooks)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **1,351** &nbsp;&nbsp; folks: **217**  &nbsp;&nbsp; `226 stars today`

1. [jwasham / coding-interview-university](https://github.com/jwasham/coding-interview-university)
    - A complete computer science study plan to become a software engineer.
    - language: **无** &nbsp;&nbsp; stars: **319,299** &nbsp;&nbsp; folks: **79,036**  &nbsp;&nbsp; `130 stars today`

1. [deepsense-ai / ragbits](https://github.com/deepsense-ai/ragbits)
    - Building blocks for rapid development of GenAI applications
    - language: **Python** &nbsp;&nbsp; stars: **890** &nbsp;&nbsp; folks: **68**  &nbsp;&nbsp; `257 stars today`

1. [rustdesk / rustdesk](https://github.com/rustdesk/rustdesk)
    - An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer.
    - language: **Rust** &nbsp;&nbsp; stars: **90,018** &nbsp;&nbsp; folks: **12,927**  &nbsp;&nbsp; `105 stars today`
...
1. [anthropics / prompt-eng-interactive-tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **10,687** &nbsp;&nbsp; folks: **975**  &nbsp;&nbsp; `5,108 stars this week`

1. [anthropics / courses](https://github.com/anthropics/courses)
    - Anthropic's educational courses
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **14,686** &nbsp;&nbsp; folks: **1,251**  &nbsp;&nbsp; `2,387 stars this week`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **304,575** &nbsp;&nbsp; folks: **50,386**  &nbsp;&nbsp; `3,221 stars this week`
...
1. [Fosowl / agenticSeek](https://github.com/Fosowl/agenticSeek)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **17,083** &nbsp;&nbsp; folks: **1,600**  &nbsp;&nbsp; `3,487 stars this week`
...
1. [livestorejs / livestore](https://github.com/livestorejs/livestore)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,271** &nbsp;&nbsp; folks: **50**  &nbsp;&nbsp; `542 stars this week`

1. [gitroomhq / postiz-app](https://github.com/gitroomhq/postiz-app)
    - 📨 The ultimate social media scheduling tool, with a bunch of AI 🤖
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,193** &nbsp;&nbsp; folks: **3,320**  &nbsp;&nbsp; `1,230 stars this week`

1. [imputnet / cobalt](https://github.com/imputnet/cobalt)
    - best way to save what you love
    - language: **Svelte** &nbsp;&nbsp; stars: **33,714** &nbsp;&nbsp; folks: **2,795**  &nbsp;&nbsp; `1,214 stars this week`

1. [duckdb / ducklake](https://github.com/duckdb/ducklake)
    - DuckLake is an integrated data lake and catalog format
    - language: **C++** &nbsp;&nbsp; stars: **1,427** &nbsp;&nbsp; folks: **54**  &nbsp;&nbsp; `270 stars this week`

1. [datawhalechina / self-llm](https://github.com/datawhalechina/self-llm)
    - 《开源大模型食用指南》针对中国宝宝量身打造的基于Linux环境快速微调（全参数/Lora）、部署国内外开源大模型（LLM）/多模态大模型（MLLM）教程
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **16,319** &nbsp;&nbsp; folks: **1,798**  &nbsp;&nbsp; `554 stars this week`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **11,618** &nbsp;&nbsp; folks: **644**  &nbsp;&nbsp; `882 stars this week`

1. [syncthing / syncthing](https://github.com/syncthing/syncthing)
    - Open Source Continuous File Synchronization
    - language: **Go** &nbsp;&nbsp; stars: **72,054** &nbsp;&nbsp; folks: **4,594**  &nbsp;&nbsp; `1,405 stars this week`

1. [anthropics / anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook)
    - A collection of notebooks/recipes showcasing some fun and effective ways of using Claude.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **12,977** &nbsp;&nbsp; folks: **1,509**  &nbsp;&nbsp; `371 stars this week`
...
1. [Fosowl / agenticSeek](https://github.com/Fosowl/agenticSeek)
    - Fully Local Manus AI. No APIs, No $200 monthly bills. Enjoy an autonomous agent that thinks, browses the web, and code for the sole cost of electricity. 🔔 Official updates only via twitter @Martin993886460. Any other account is fake.
    - language: **Python** &nbsp;&nbsp; stars: **17,083** &nbsp;&nbsp; folks: **1,600**  &nbsp;&nbsp; `15,112 stars this month`
...
1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **35,796** &nbsp;&nbsp; folks: **5,081**  &nbsp;&nbsp; `9,208 stars this month`
...
1. [bytedance / flowgram.ai](https://github.com/bytedance/flowgram.ai)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,919** &nbsp;&nbsp; folks: **351**  &nbsp;&nbsp; `3,700 stars this month`

1. [mindsdb / mindsdb](https://github.com/mindsdb/mindsdb)
    - AI's query engine - Platform for building AI that can answer questions over large scale federated data. - The only MCP Server you'll ever need
    - language: **Python** &nbsp;&nbsp; stars: **31,715** &nbsp;&nbsp; folks: **5,246**  &nbsp;&nbsp; `3,949 stars this month`

1. [mem0ai / mem0](https://github.com/mem0ai/mem0)
    - Memory for AI Agents; SOTA in AI Agent Memory; Announcing OpenMemory MCP - local and secure memory management.
    - language: **Python** &nbsp;&nbsp; stars: **33,892** &nbsp;&nbsp; folks: **3,360**  &nbsp;&nbsp; `5,304 stars this month`

1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    - The Cursor for Designers • An Open-Source Visual Vibecoding Editor • Visually build, style, and edit your React App with AI
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,041** &nbsp;&nbsp; folks: **1,042**  &nbsp;&nbsp; `7,668 stars this month`
...
1. [microsoft / qlib](https://github.com/microsoft/qlib)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **24,390** &nbsp;&nbsp; folks: **3,772**  &nbsp;&nbsp; `5,424 stars this month`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **326,285** &nbsp;&nbsp; folks: **41,991**  &nbsp;&nbsp; `9,194 stars this month`

1. [appwrite / appwrite](https://github.com/appwrite/appwrite)
    - Build like a team of hundreds_
    - language: **TypeScript** &nbsp;&nbsp; stars: **50,971** &nbsp;&nbsp; folks: **4,467**  &nbsp;&nbsp; `2,669 stars this month`

1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **无** &nbsp;&nbsp; stars: **54,616** &nbsp;&nbsp; folks: **5,824**  &nbsp;&nbsp; `4,696 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **Shell** &nbsp;&nbsp; stars: **11,618** &nbsp;&nbsp; folks: **644**  &nbsp;&nbsp; `3,309 stars this month`

1. [anthropics / courses](https://github.com/anthropics/courses)
    - Anthropic's educational courses
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **14,686** &nbsp;&nbsp; folks: **1,251**  &nbsp;&nbsp; `3,286 stars this month`
...
1. [MODSetter / SurfSense](https://github.com/MODSetter/SurfSense)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,469** &nbsp;&nbsp; folks: **386**  &nbsp;&nbsp; `3,059 stars this month`

1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    - An AI Hedge Fund Team
    - language: **Python** &nbsp;&nbsp; stars: **34,934** &nbsp;&nbsp; folks: **6,082**  &nbsp;&nbsp; `8,127 stars this month`

1. [CopilotKit / CopilotKit](https://github.com/CopilotKit/CopilotKit)
    - React UI + elegant infrastructure for AI Copilots, AI chatbots, and in-app AI agents. The Agentic last-mile 🪁
    - language: **TypeScript** &nbsp;&nbsp; stars: **20,864** &nbsp;&nbsp; folks: **2,856**  &nbsp;&nbsp; `2,393 stars this month`

1. [f / awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)
    - This repo includes ChatGPT prompt curation to use ChatGPT and other LLM tools better.
    - language: **JavaScript** &nbsp;&nbsp; stars: **128,154** &nbsp;&nbsp; folks: **16,998**  &nbsp;&nbsp; `4,385 stars this month`
