...
`更新时间：2025-04-18 23:24:12 +0800`

## 今日热门仓库

1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **75,765** &nbsp;&nbsp; folks: **9,262**  &nbsp;&nbsp; `1,308 stars today`

1. [jlowin / fastmcp](https://github.com/jlowin/fastmcp)
    - 🚀 The fast, Pythonic way to build MCP servers and clients
    - language: **Python** &nbsp;&nbsp; stars: **5,580** &nbsp;&nbsp; folks: **284**  &nbsp;&nbsp; `244 stars today`

1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    - An AI Hedge Fund Team
    - language: **Python** &nbsp;&nbsp; stars: **25,693** &nbsp;&nbsp; folks: **4,385**  &nbsp;&nbsp; `795 stars today`

1. [microsoft / BitNet](https://github.com/microsoft/BitNet)
    - Official inference framework for 1-bit LLMs
    - language: **C++** &nbsp;&nbsp; stars: **13,693** &nbsp;&nbsp; folks: **956**  &nbsp;&nbsp; `400 stars today`

1. [linera-io / linera-protocol](https://github.com/linera-io/linera-protocol)
    - Main repository for the Linera protocol
    - language: **Rust** &nbsp;&nbsp; stars: **22,879** &nbsp;&nbsp; folks: **1,401**  &nbsp;&nbsp; `1,401 stars today`

1. [docmost / docmost](https://github.com/docmost/docmost)
    - Docmost is an open-source collaborative wiki and documentation software. It is an open-source alternative to Confluence and Notion.
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,913** &nbsp;&nbsp; folks: **670**  &nbsp;&nbsp; `412 stars today`
...
1. [NirDiamant / RAG_Techniques](https://github.com/NirDiamant/RAG_Techniques)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,072** &nbsp;&nbsp; folks: **1,513**  &nbsp;&nbsp; `340 stars today`

1. [browserbase / stagehand](https://github.com/browserbase/stagehand)
    - An AI web browsing framework focused on simplicity and extensibility.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,346** &nbsp;&nbsp; folks: **571**  &nbsp;&nbsp; `310 stars today`
...
1. [1Panel-dev / 1Panel](https://github.com/1Panel-dev/1Panel)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **27,037** &nbsp;&nbsp; folks: **2,374**  &nbsp;&nbsp; `284 stars today`
...
1. [Anxcye / anx-reader](https://github.com/Anxcye/anx-reader)
    ...
    - language: **Dart** &nbsp;&nbsp; stars: **4,310** &nbsp;&nbsp; folks: **229**  &nbsp;&nbsp; `273 stars today`
...
1. [potpie-ai / potpie](https://github.com/potpie-ai/potpie)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,696** &nbsp;&nbsp; folks: **352**  &nbsp;&nbsp; `173 stars today`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,004** &nbsp;&nbsp; folks: **2,298**  &nbsp;&nbsp; `10,342 stars this week`
...
1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    - An AI Hedge Fund Team
    - language: **Python** &nbsp;&nbsp; stars: **25,693** &nbsp;&nbsp; folks: **4,385**  &nbsp;&nbsp; `4,135 stars this week`
...
1. [Zackriya-Solutions / meeting-minutes](https://github.com/Zackriya-Solutions/meeting-minutes)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,643** &nbsp;&nbsp; folks: **248**  &nbsp;&nbsp; `1,930 stars this week`
...
1. [jlowin / fastmcp](https://github.com/jlowin/fastmcp)
    - 🚀 The fast, Pythonic way to build MCP servers and clients
    - language: **Python** &nbsp;&nbsp; stars: **5,580** &nbsp;&nbsp; folks: **284**  &nbsp;&nbsp; `1,066 stars this week`
...
1. [funstory-ai / BabelDOC](https://github.com/funstory-ai/BabelDOC)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,551** &nbsp;&nbsp; folks: **141**  &nbsp;&nbsp; `1,159 stars this week`
...
1. [NirDiamant / RAG_Techniques](https://github.com/NirDiamant/RAG_Techniques)
    - This repository showcases various advanced techniques for Retrieval-Augmented Generation (RAG) systems. RAG systems combine information retrieval with generative models to provide accurate and contextually rich responses.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,072** &nbsp;&nbsp; folks: **1,513**  &nbsp;&nbsp; `888 stars this week`

1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    - 10 Lessons to Get Started Building AI Agents
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,630** &nbsp;&nbsp; folks: **3,768**  &nbsp;&nbsp; `3,699 stars this week`

1. [vercel / ai-chatbot](https://github.com/vercel/ai-chatbot)
    - A full-featured, hackable Next.js AI chatbot built by Vercel
    - language: **TypeScript** &nbsp;&nbsp; stars: **15,427** &nbsp;&nbsp; folks: **4,064**  &nbsp;&nbsp; `764 stars this week`
...
1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **75,765** &nbsp;&nbsp; folks: **9,262**  &nbsp;&nbsp; `4,069 stars this week`

1. [nautechsystems / nautilus_trader](https://github.com/nautechsystems/nautilus_trader)
    - A high-performance algorithmic trading platform and event-driven backtester
    - language: **Python** &nbsp;&nbsp; stars: **5,591** &nbsp;&nbsp; folks: **797**  &nbsp;&nbsp; `585 stars this week`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    - [Support 0.48.x]（Reset Cursor AI MachineID & Bypass Higher Token Limit） Cursor Ai ，自动重置机器ID ， 免费升级使用Pro功能: You've reached your trial request limit. / Too many free trial accounts used on this machine. Please upgrade to pro. We have this limit in place to prevent abuse. Please let us know if you believe this is a mistake.
    - language: **Python** &nbsp;&nbsp; stars: **19,004** &nbsp;&nbsp; folks: **2,298**  &nbsp;&nbsp; `15,605 stars this month`

1. [punkpeye / awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)
    - A collection of MCP servers.
    - language: **无** &nbsp;&nbsp; stars: **39,484** &nbsp;&nbsp; folks: **2,813**  &nbsp;&nbsp; `28,634 stars this month`
...
1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    - 10 Lessons to Get Started Building AI Agents
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,630** &nbsp;&nbsp; folks: **3,768**  &nbsp;&nbsp; `10,796 stars this month`
...
1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **82,727** &nbsp;&nbsp; folks: **22,158**  &nbsp;&nbsp; `14,588 stars this month`

1. [ourongxing / newsnow](https://github.com/ourongxing/newsnow)
    - Elegant reading of real-time and hottest news
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,917** &nbsp;&nbsp; folks: **2,476**  &nbsp;&nbsp; `4,193 stars this month`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **28,460** &nbsp;&nbsp; folks: **3,202**  &nbsp;&nbsp; `8,685 stars this month`

1. [mark3labs / mcp-go](https://github.com/mark3labs/mcp-go)
    - A Go implementation of the Model Context Protocol (MCP), enabling seamless integration between LLM applications and external data sources and tools.
    - language: **Go** &nbsp;&nbsp; stars: **3,487** &nbsp;&nbsp; folks: **286**  &nbsp;&nbsp; `2,622 stars this month`
...
1. [PatrickJS / awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules)
    ...
    - language: **无** &nbsp;&nbsp; stars: **22,355** &nbsp;&nbsp; folks: **1,689**  &nbsp;&nbsp; `6,104 stars this month`
