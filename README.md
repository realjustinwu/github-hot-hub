...
1. [Guovin / iptv-api](https://github.com/Guovin/iptv-api)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,085** &nbsp;&nbsp; folks: **1,576**  &nbsp;&nbsp; `344 stars today`
...
1. [4gray / iptvnator](https://github.com/4gray/iptvnator)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,425** &nbsp;&nbsp; folks: **429**  &nbsp;&nbsp; `194 stars today`

1. [keephq / keep](https://github.com/keephq/keep)
    - The open-source alert management and AIOps platform
    - language: **Python** &nbsp;&nbsp; stars: **7,706** &nbsp;&nbsp; folks: **742**  &nbsp;&nbsp; `287 stars today`

1. [codecrafters-io / build-your-own-x](https://github.com/codecrafters-io/build-your-own-x)
    - Master programming by recreating your favorite technologies from scratch.
    - language: **Markdown** &nbsp;&nbsp; stars: **315,100** &nbsp;&nbsp; folks: **29,213**  &nbsp;&nbsp; `538 stars today`
...
1. [leptos-rs / leptos](https://github.com/leptos-rs/leptos)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **16,603** &nbsp;&nbsp; folks: **664**  &nbsp;&nbsp; `39 stars today`
...
1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **64,499** &nbsp;&nbsp; folks: **7,867**  &nbsp;&nbsp; `3,118 stars this week`

1. [aidenybai / react-scan](https://github.com/aidenybai/react-scan)
    - Scan for React performance issues and eliminate slow renders in your app
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,996** &nbsp;&nbsp; folks: **88**  &nbsp;&nbsp; `3,266 stars this week`

1. [gitroomhq / postiz-app](https://github.com/gitroomhq/postiz-app)
    - 📨 The ultimate social media scheduling tool, with a bunch of AI 🤖
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,744** &nbsp;&nbsp; folks: **2,394**  &nbsp;&nbsp; `2,318 stars this week`
...
1. [jesseduffield / lazydocker](https://github.com/jesseduffield/lazydocker)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **38,919** &nbsp;&nbsp; folks: **1,237**  &nbsp;&nbsp; `1,102 stars this week`
...
1. [Guovin / iptv-api](https://github.com/Guovin/iptv-api)
    - 📺IPTV电视直播源更新工具🚀：✨央视、📡卫视、☘️广东及各省份地方台、🌊港·澳·台、🎬电影、🎥咪咕、🏀体育、🪁动画、🎮游戏、🎵音乐、🏛经典剧场；支持IPv4/IPv6；支持自定义增加频道；支持组播源、酒店源、订阅源、关键字搜索；每天自动更新两次，结果可用于TVBox等播放软件；支持工作流、Docker(amd64/arm64/arm v7)、命令行、GUI运行方式 | IPTV live TV source update tool
    - language: **Python** &nbsp;&nbsp; stars: **7,085** &nbsp;&nbsp; folks: **1,576**  &nbsp;&nbsp; `872 stars this week`
...
1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **17,647** &nbsp;&nbsp; folks: **1,298**  &nbsp;&nbsp; `1,061 stars this week`
...
1. [FortAwesome / Font-Awesome](https://github.com/FortAwesome/Font-Awesome)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **74,357** &nbsp;&nbsp; folks: **12,207**  &nbsp;&nbsp; `245 stars this week`
...
1. [myhhub / stock](https://github.com/myhhub/stock)
    - stock股票.获取股票数据,计算股票指标,识别股票形态,综合选股,选股策略,股票验证回测,股票自动交易,支持PC及移动设备。
    - language: **Python** &nbsp;&nbsp; stars: **4,394** &nbsp;&nbsp; folks: **815**  &nbsp;&nbsp; `2,412 stars this week`

1. [skills / introduction-to-github](https://github.com/skills/introduction-to-github)
    - Get started using GitHub in less than an hour.
    - language: **无** &nbsp;&nbsp; stars: **5,418** &nbsp;&nbsp; folks: **3,270**  &nbsp;&nbsp; `764 stars this week`
...
1. [SagerNet / sing-box](https://github.com/SagerNet/sing-box)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **20,409** &nbsp;&nbsp; folks: **2,437**  &nbsp;&nbsp; `191 stars this week`
...
1. [dockur / windows](https://github.com/dockur/windows)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **30,193** &nbsp;&nbsp; folks: **2,056**  &nbsp;&nbsp; `12,238 stars this month`

1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    - Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue)
    - language: **Python** &nbsp;&nbsp; stars: **64,499** &nbsp;&nbsp; folks: **7,867**  &nbsp;&nbsp; `7,249 stars this month`

1. [DS4SD / docling](https://github.com/DS4SD/docling)
    - Get your documents ready for gen AI
    - language: **Python** &nbsp;&nbsp; stars: **12,100** &nbsp;&nbsp; folks: **605**  &nbsp;&nbsp; `10,219 stars this month`

1. [ai16z / eliza](https://github.com/ai16z/eliza)
    - Conversational Agent for Twitter and Discord
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,640** &nbsp;&nbsp; folks: **779**  &nbsp;&nbsp; `2,171 stars this month`

1. [opendatalab / MinerU](https://github.com/opendatalab/MinerU)
    - A high-quality tool for convert PDF to Markdown and JSON.一站式开源高质量数据提取工具，将PDF转换成Markdown和JSON格式。
    - language: **Python** &nbsp;&nbsp; stars: **19,947** &nbsp;&nbsp; folks: **1,418**  &nbsp;&nbsp; `6,483 stars this month`
...
1. [khoj-ai / khoj](https://github.com/khoj-ai/khoj)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,547** &nbsp;&nbsp; folks: **806**  &nbsp;&nbsp; `3,589 stars this month`
...
1. [payloadcms / payload](https://github.com/payloadcms/payload)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **29,109** &nbsp;&nbsp; folks: **1,808**  &nbsp;&nbsp; `4,313 stars this month`

1. [exo-explore / exo](https://github.com/exo-explore/exo)
    - Run your own AI cluster at home with everyday devices 📱💻 🖥️⌚
    - language: **Python** &nbsp;&nbsp; stars: **16,742** &nbsp;&nbsp; folks: **894**  &nbsp;&nbsp; `5,842 stars this month`
...
1. [bluesky-social / social-app](https://github.com/bluesky-social/social-app)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,453** &nbsp;&nbsp; folks: **1,718**  &nbsp;&nbsp; `3,804 stars this month`
