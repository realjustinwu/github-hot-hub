...
1. [1Panel-dev / 1Panel](https://github.com/1Panel-dev/1Panel)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **26,988** &nbsp;&nbsp; folks: **2,371**  &nbsp;&nbsp; `284 stars today`
...
1. [nocobase / nocobase](https://github.com/nocobase/nocobase)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,218** &nbsp;&nbsp; folks: **1,609**  &nbsp;&nbsp; `38 stars today`
...
1. [All-Hands-AI / OpenHands](https://github.com/All-Hands-AI/OpenHands)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **53,008** &nbsp;&nbsp; folks: **5,907**  &nbsp;&nbsp; `61 stars today`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **18,954** &nbsp;&nbsp; folks: **2,291**  &nbsp;&nbsp; `10,342 stars this week`
...
1. [virattt / ai-hedge-fund](https://github.com/virattt/ai-hedge-fund)
    - An AI Hedge Fund Team
    - language: **Python** &nbsp;&nbsp; stars: **25,662** &nbsp;&nbsp; folks: **4,377**  &nbsp;&nbsp; `4,135 stars this week`

1. [krillinai / KrillinAI](https://github.com/krillinai/KrillinAI)
    - A video translation and dubbing tool powered by LLMs, offering professional-grade translations and one-click full-process deployment. It can generate content optimized for platforms like YouTube，TikTok, and Shorts. 基于AI大模型的视频翻译和配音工具，专业级翻译，一键部署全流程，可以生成适配抖音，小红书，哔哩哔哩，视频号，TikTok，Youtube Shorts等形态的内容
    - language: **Go** &nbsp;&nbsp; stars: **4,990** &nbsp;&nbsp; folks: **367**  &nbsp;&nbsp; `3,379 stars this week`
...
1. [Zackriya-Solutions / meeting-minutes](https://github.com/Zackriya-Solutions/meeting-minutes)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **3,632** &nbsp;&nbsp; folks: **248**  &nbsp;&nbsp; `1,930 stars this week`
...
1. [jlowin / fastmcp](https://github.com/jlowin/fastmcp)
    - 🚀 The fast, Pythonic way to build MCP servers and clients
    - language: **Python** &nbsp;&nbsp; stars: **5,523** &nbsp;&nbsp; folks: **279**  &nbsp;&nbsp; `1,066 stars this week`
...
1. [NirDiamant / RAG_Techniques](https://github.com/NirDiamant/RAG_Techniques)
    - This repository showcases various advanced techniques for Retrieval-Augmented Generation (RAG) systems. RAG systems combine information retrieval with generative models to provide accurate and contextually rich responses.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,044** &nbsp;&nbsp; folks: **1,510**  &nbsp;&nbsp; `888 stars this week`

1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    - 10 Lessons to Get Started Building AI Agents
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,613** &nbsp;&nbsp; folks: **3,762**  &nbsp;&nbsp; `3,699 stars this week`
...
1. [Anduin2017 / HowToCook](https://github.com/Anduin2017/HowToCook)
    - 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
    - language: **Dockerfile** &nbsp;&nbsp; stars: **75,492** &nbsp;&nbsp; folks: **9,242**  &nbsp;&nbsp; `4,069 stars this week`
...
1. [yeongpin / cursor-free-vip](https://github.com/yeongpin/cursor-free-vip)
    - [Support 0.48.x]（Reset Cursor AI MachineID & Bypass Higher Token Limit） Cursor Ai ，自动重置机器ID ， 免费升级使用Pro功能: You've reached your trial request limit. / Too many free trial accounts used on this machine. Please upgrade to pro. We have this limit in place to prevent abuse. Please let us know if you believe this is a mistake.
    - language: **Python** &nbsp;&nbsp; stars: **18,954** &nbsp;&nbsp; folks: **2,291**  &nbsp;&nbsp; `15,605 stars this month`

1. [punkpeye / awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)
    - A collection of MCP servers.
    - language: **无** &nbsp;&nbsp; stars: **39,422** &nbsp;&nbsp; folks: **2,808**  &nbsp;&nbsp; `28,634 stars this month`

1. [ahmedkhaleel2004 / gitdiagram](https://github.com/ahmedkhaleel2004/gitdiagram)
    - Free, simple, fast interactive diagrams for any GitHub repository
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,803** &nbsp;&nbsp; folks: **650**  &nbsp;&nbsp; `6,994 stars this month`

1. [th-ch / youtube-music](https://github.com/th-ch/youtube-music)
    - YouTube Music Desktop App bundled with custom plugins (and built-in ad blocker / downloader)
    - language: **TypeScript** &nbsp;&nbsp; stars: **18,431** &nbsp;&nbsp; folks: **953**  &nbsp;&nbsp; `7,193 stars this month`

1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    - 10 Lessons to Get Started Building AI Agents
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **15,613** &nbsp;&nbsp; folks: **3,762**  &nbsp;&nbsp; `10,796 stars this month`

1. [ageerle / ruoyi-ai](https://github.com/ageerle/ruoyi-ai)
    - RuoYi AI 是一个全栈式 AI 开发平台，旨在帮助开发者快速构建和部署个性化的 AI 应用。
    - language: **Java** &nbsp;&nbsp; stars: **2,763** &nbsp;&nbsp; folks: **627**  &nbsp;&nbsp; `2,105 stars this month`
...
1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **82,694** &nbsp;&nbsp; folks: **22,139**  &nbsp;&nbsp; `14,588 stars this month`
...
1. [mark3labs / mcp-go](https://github.com/mark3labs/mcp-go)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **3,482** &nbsp;&nbsp; folks: **286**  &nbsp;&nbsp; `2,622 stars this month`

1. [executeautomation / mcp-playwright](https://github.com/executeautomation/mcp-playwright)
    - Playwright Model Context Protocol Server - Tool to automate Browsers and APIs in Claude Desktop, Cline, Cursor IDE and More 🔌
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,994** &nbsp;&nbsp; folks: **224**  &nbsp;&nbsp; `2,052 stars this month`
