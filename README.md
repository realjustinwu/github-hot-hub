...
`更新时间：2025-08-18 03:19:35 +0800`

## 今日热门仓库

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **7,369** &nbsp;&nbsp; folks: **1,435**  &nbsp;&nbsp; `991 stars today`

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **4,670** &nbsp;&nbsp; folks: **452**  &nbsp;&nbsp; `461 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **58,670** &nbsp;&nbsp; folks: **7,030**  &nbsp;&nbsp; `442 stars today`
...
1. [aliasrobotics / cai](https://github.com/aliasrobotics/cai)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,576** &nbsp;&nbsp; folks: **395**  &nbsp;&nbsp; `152 stars today`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **3,926** &nbsp;&nbsp; folks: **162**  &nbsp;&nbsp; `490 stars today`
...
1. [MotiaDev / motia](https://github.com/MotiaDev/motia)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,148** &nbsp;&nbsp; folks: **482**  &nbsp;&nbsp; `99 stars today`
...
1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic (超级麦吉). The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **2,185** &nbsp;&nbsp; folks: **241**  &nbsp;&nbsp; `539 stars this week`
...
1. [openai / codex](https://github.com/openai/codex)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **35,312** &nbsp;&nbsp; folks: **4,034**  &nbsp;&nbsp; `2,062 stars this week`
...
1. [syncthing / syncthing](https://github.com/syncthing/syncthing)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **75,051** &nbsp;&nbsp; folks: **4,697**  &nbsp;&nbsp; `810 stars this week`

1. [idosal / git-mcp](https://github.com/idosal/git-mcp)
    - Put an end to code hallucinations! GitMCP is a free, open-source, remote MCP server for any GitHub project
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,337** &nbsp;&nbsp; folks: **397**  &nbsp;&nbsp; `1,139 stars this week`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **22,333** &nbsp;&nbsp; folks: **4,320**  &nbsp;&nbsp; `13,191 stars this month`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,160** &nbsp;&nbsp; folks: **1,259**  &nbsp;&nbsp; `11,151 stars this month`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Financial data aggregator for humans and AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **49,734** &nbsp;&nbsp; folks: **4,638**  &nbsp;&nbsp; `6,652 stars this month`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **7,369** &nbsp;&nbsp; folks: **1,435**  &nbsp;&nbsp; `934 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,054** &nbsp;&nbsp; folks: **601**  &nbsp;&nbsp; `6,821 stars this month`
