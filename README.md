...
1. [openwrt / openwrt](https://github.com/openwrt/openwrt)
    ...
    - language: **C** &nbsp;&nbsp; stars: **23,689** &nbsp;&nbsp; folks: **11,524**  &nbsp;&nbsp; `24 stars today`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,980** &nbsp;&nbsp; folks: **874**  &nbsp;&nbsp; `305 stars today`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **65,660** &nbsp;&nbsp; folks: **5,587**  &nbsp;&nbsp; `288 stars today`
...
1. [pathwaycom / pathway](https://github.com/pathwaycom/pathway)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **38,128** &nbsp;&nbsp; folks: **1,119**  &nbsp;&nbsp; `2,214 stars today`

1. [pathwaycom / llm-app](https://github.com/pathwaycom/llm-app)
    - Ready-to-run cloud templates for RAG, AI pipelines, and enterprise search with live data. 🐳Docker-friendly.⚡Always in sync with Sharepoint, Google Drive, S3, Kafka, PostgreSQL, real-time data APIs, and more.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **35,854** &nbsp;&nbsp; folks: **964**  &nbsp;&nbsp; `2,063 stars today`

1. [henrygd / beszel](https://github.com/henrygd/beszel)
    - Lightweight server monitoring hub with historical data, docker stats, and alerts.
    - language: **Go** &nbsp;&nbsp; stars: **14,845** &nbsp;&nbsp; folks: **453**  &nbsp;&nbsp; `53 stars today`

1. [ossu / computer-science](https://github.com/ossu/computer-science)
    - 🎓 Path to a free self-taught education in Computer Science!
    - language: **HTML** &nbsp;&nbsp; stars: **192,339** &nbsp;&nbsp; folks: **24,006**  &nbsp;&nbsp; `413 stars today`

1. [LadybirdBrowser / ladybird](https://github.com/LadybirdBrowser/ladybird)
    - Truly independent web browser
    - language: **C++** &nbsp;&nbsp; stars: **47,512** &nbsp;&nbsp; folks: **2,060**  &nbsp;&nbsp; `54 stars today`

1. [Vector-Wangel / XLeRobot](https://github.com/Vector-Wangel/XLeRobot)
    - XLeRobot: Practical Dual-Arm Mobile Home Robot for $660
    - language: **Python** &nbsp;&nbsp; stars: **2,211** &nbsp;&nbsp; folks: **210**  &nbsp;&nbsp; `225 stars today`
...
1. [dockur / windows](https://github.com/dockur/windows)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **44,752** &nbsp;&nbsp; folks: **3,251**  &nbsp;&nbsp; `6,152 stars this week`

1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    - Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,948** &nbsp;&nbsp; folks: **632**  &nbsp;&nbsp; `2,808 stars this week`
...
1. [JetBrains / koog](https://github.com/JetBrains/koog)
    ...
    - language: **Kotlin** &nbsp;&nbsp; stars: **2,962** &nbsp;&nbsp; folks: **200**  &nbsp;&nbsp; `1,154 stars this week`
...
1. [google / mangle](https://github.com/google/mangle)
    - 无
    - language: **Go** &nbsp;&nbsp; stars: **2,467** &nbsp;&nbsp; folks: **117**  &nbsp;&nbsp; `614 stars this week`
...
1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,370** &nbsp;&nbsp; folks: **3,074**  &nbsp;&nbsp; `11,196 stars this month`

1. [plait-board / drawnix](https://github.com/plait-board/drawnix)
    - 开源白板工具（SaaS），一体化白板，包含思维导图、流程图、自由画等。All in one open-source whiteboard tool with mind, flowchart, freehand and etc.
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,841** &nbsp;&nbsp; folks: **812**  &nbsp;&nbsp; `7,175 stars this month`

1. [winapps-org / winapps](https://github.com/winapps-org/winapps)
    - Run Windows apps such as Microsoft Office/Adobe in Linux (Ubuntu/Fedora) and GNOME/KDE as if they were a part of the native OS, including Nautilus integration. Hard fork of https://github.com/Fmstrat/winapps/
    - language: **Shell** &nbsp;&nbsp; stars: **8,972** &nbsp;&nbsp; folks: **270**  &nbsp;&nbsp; `5,613 stars this month`

1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Open-source platform to build and deploy AI agent workflows.
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,428** &nbsp;&nbsp; folks: **1,764**  &nbsp;&nbsp; `7,551 stars this month`

1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **39,385** &nbsp;&nbsp; folks: **4,563**  &nbsp;&nbsp; `7,377 stars this month`

1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **44,752** &nbsp;&nbsp; folks: **3,251**  &nbsp;&nbsp; `8,022 stars this month`

1. [basecamp / omarchy](https://github.com/basecamp/omarchy)
    - Opinionated Arch/Hyprland Setup
    - language: **Shell** &nbsp;&nbsp; stars: **7,225** &nbsp;&nbsp; folks: **857**  &nbsp;&nbsp; `4,010 stars this month`
...
1. [langchain-ai / open-swe](https://github.com/langchain-ai/open-swe)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **4,775** &nbsp;&nbsp; folks: **594**  &nbsp;&nbsp; `4,219 stars this month`
...
1. [Canner / WrenAI](https://github.com/Canner/WrenAI)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,782** &nbsp;&nbsp; folks: **1,175**  &nbsp;&nbsp; `2,203 stars this month`
