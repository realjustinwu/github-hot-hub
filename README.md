...
`更新时间：2025-01-10 19:18:10 +0800`

## 今日热门仓库

1. [78 / xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)
    - Build your own AI friend
    - language: **C** &nbsp;&nbsp; stars: **2,212** &nbsp;&nbsp; folks: **363**  &nbsp;&nbsp; `321 stars today`
...
1. [feder-cr / Jobs_Applier_AI_Agent](https://github.com/feder-cr/Jobs_Applier_AI_Agent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **24,527** &nbsp;&nbsp; folks: **3,639**  &nbsp;&nbsp; `146 stars today`

1. [browserbase / stagehand](https://github.com/browserbase/stagehand)
    - An AI web browsing framework focused on simplicity and extensibility.
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,928** &nbsp;&nbsp; folks: **159**  &nbsp;&nbsp; `662 stars today`
...
1. [jingyaogong / minimind](https://github.com/jingyaogong/minimind)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,204** &nbsp;&nbsp; folks: **503**  &nbsp;&nbsp; `94 stars today`
...
1. [Canner / WrenAI](https://github.com/Canner/WrenAI)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,100** &nbsp;&nbsp; folks: **284**  &nbsp;&nbsp; `55 stars today`

1. [khoj-ai / khoj](https://github.com/khoj-ai/khoj)
    - Your AI second brain. Self-hostable. Get answers from the web or your docs. Build custom agents, schedule automations, do deep research. Turn any online or local LLM into your personal, autonomous AI (gpt, claude, gemini, llama, qwen, mistral). Get started - free.
    - language: **Python** &nbsp;&nbsp; stars: **23,708** &nbsp;&nbsp; folks: **1,254**  &nbsp;&nbsp; `803 stars today`

1. [inkonchain / docs](https://github.com/inkonchain/docs)
    - Ink Documentation
    - language: **MDX** &nbsp;&nbsp; stars: **18,830** &nbsp;&nbsp; folks: **198**  &nbsp;&nbsp; `2,365 stars today`

1. [inkonchain / node](https://github.com/inkonchain/node)
    - How to run an Ink Node
    - language: **Shell** &nbsp;&nbsp; stars: **18,903** &nbsp;&nbsp; folks: **287**  &nbsp;&nbsp; `2,373 stars today`
...
1. [apache / thrift](https://github.com/apache/thrift)
    - Apache Thrift
    - language: **C++** &nbsp;&nbsp; stars: **10,581** &nbsp;&nbsp; folks: **4,039**  &nbsp;&nbsp; `13 stars today`
...
1. [BuilderIO / gpt-crawler](https://github.com/BuilderIO/gpt-crawler)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **19,407** &nbsp;&nbsp; folks: **2,073**  &nbsp;&nbsp; `113 stars today`
...
1. [stanford-oval / storm](https://github.com/stanford-oval/storm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,377** &nbsp;&nbsp; folks: **1,695**  &nbsp;&nbsp; `5,127 stars this week`
...
1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **23,757** &nbsp;&nbsp; folks: **1,712**  &nbsp;&nbsp; `4,528 stars this week`
...
1. [All-Hands-AI / OpenHands](https://github.com/All-Hands-AI/OpenHands)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **42,731** &nbsp;&nbsp; folks: **4,724**  &nbsp;&nbsp; `2,845 stars this week`
...
1. [78 / xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)
    - Build your own AI friend
    - language: **C** &nbsp;&nbsp; stars: **2,212** &nbsp;&nbsp; folks: **363**  &nbsp;&nbsp; `1,005 stars this week`

1. [cline / cline](https://github.com/cline/cline)
    - Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way.
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,132** &nbsp;&nbsp; folks: **1,790**  &nbsp;&nbsp; `2,409 stars this week`
...
1. [Canner / WrenAI](https://github.com/Canner/WrenAI)
    - 🤖 Open-source AI Agent that empowers data-driven teams to chat with their data to generate Text-to-SQL, charts, spreadsheets, reports, and BI. 📈📊📋🧑‍💻
    - language: **TypeScript** &nbsp;&nbsp; stars: **3,100** &nbsp;&nbsp; folks: **284**  &nbsp;&nbsp; `281 stars this week`
...
1. [OpenSPG / KAG](https://github.com/OpenSPG/KAG)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,787** &nbsp;&nbsp; folks: **228**  &nbsp;&nbsp; `939 stars this week`
...
1. [elizaOS / eliza](https://github.com/elizaOS/eliza)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,827** &nbsp;&nbsp; folks: **2,887**  &nbsp;&nbsp; `7,317 stars this month`
...
1. [stanford-oval / storm](https://github.com/stanford-oval/storm)
    - An LLM-powered knowledge curation system that researches a topic and generates a full-length report with citations.
    - language: **Python** &nbsp;&nbsp; stars: **19,377** &nbsp;&nbsp; folks: **1,695**  &nbsp;&nbsp; `5,764 stars this month`

1. [cline / cline](https://github.com/cline/cline)
    - Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way.
    - language: **TypeScript** &nbsp;&nbsp; stars: **21,132** &nbsp;&nbsp; folks: **1,790**  &nbsp;&nbsp; `6,941 stars this month`

1. [khoj-ai / khoj](https://github.com/khoj-ai/khoj)
    - Your AI second brain. Self-hostable. Get answers from the web or your docs. Build custom agents, schedule automations, do deep research. Turn any online or local LLM into your personal, autonomous AI (gpt, claude, gemini, llama, qwen, mistral). Get started - free.
    - language: **Python** &nbsp;&nbsp; stars: **23,708** &nbsp;&nbsp; folks: **1,254**  &nbsp;&nbsp; `6,281 stars this month`

1. [OpenSPG / KAG](https://github.com/OpenSPG/KAG)
    - KAG is a logical form-guided reasoning and retrieval framework based on OpenSPG engine and LLMs. It is used to build logical reasoning and factual Q&A solutions for professional domain knowledge bases. It can effectively overcome the shortcomings of the traditional RAG vector similarity calculation model.
    - language: **Python** &nbsp;&nbsp; stars: **3,787** &nbsp;&nbsp; folks: **228**  &nbsp;&nbsp; `2,941 stars this month`
...
1. [intuitem / ciso-assistant-community](https://github.com/intuitem/ciso-assistant-community)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,302** &nbsp;&nbsp; folks: **267**  &nbsp;&nbsp; `1,093 stars this month`

1. [seleniumbase / SeleniumBase](https://github.com/seleniumbase/SeleniumBase)
    - Python APIs for web automation, testing, and bypassing bot-detection.
    - language: **Python** &nbsp;&nbsp; stars: **8,877** &nbsp;&nbsp; folks: **1,156**  &nbsp;&nbsp; `3,363 stars this month`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **285,231** &nbsp;&nbsp; folks: **47,580**  &nbsp;&nbsp; `6,814 stars this month`
