...
1. [yamadashy / repomix](https://github.com/yamadashy/repomix)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,366** &nbsp;&nbsp; folks: **461**  &nbsp;&nbsp; `114 stars today`
...
1. [FujiwaraChoki / MoneyPrinterV2](https://github.com/FujiwaraChoki/MoneyPrinterV2)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,293** &nbsp;&nbsp; folks: **996**  &nbsp;&nbsp; `3,353 stars this week`

1. [harry0703 / MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)
    - 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
    - language: **Python** &nbsp;&nbsp; stars: **23,932** &nbsp;&nbsp; folks: **3,496**  &nbsp;&nbsp; `2,051 stars this week`
...
1. [hummingbot / hummingbot](https://github.com/hummingbot/hummingbot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,324** &nbsp;&nbsp; folks: **3,221**  &nbsp;&nbsp; `1,496 stars this week`
...
1. [geekan / MetaGPT](https://github.com/geekan/MetaGPT)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **47,341** &nbsp;&nbsp; folks: **5,626**  &nbsp;&nbsp; `906 stars this week`

1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **71,198** &nbsp;&nbsp; folks: **10,394**  &nbsp;&nbsp; `3,600 stars this week`

1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding.
    - language: **TypeScript** &nbsp;&nbsp; stars: **39,426** &nbsp;&nbsp; folks: **3,479**  &nbsp;&nbsp; `2,874 stars this week`
...
1. [microsoft / data-formulator](https://github.com/microsoft/data-formulator)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,185** &nbsp;&nbsp; folks: **618**  &nbsp;&nbsp; `1,748 stars this week`
...
1. [deepseek-ai / awesome-deepseek-integration](https://github.com/deepseek-ai/awesome-deepseek-integration)
    - 无
    - language: **无** &nbsp;&nbsp; stars: **19,558** &nbsp;&nbsp; folks: **2,158**  &nbsp;&nbsp; `16,936 stars this month`
...
1. [ollama / ollama](https://github.com/ollama/ollama)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **128,797** &nbsp;&nbsp; folks: **10,494**  &nbsp;&nbsp; `19,865 stars this month`
...
1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **71,198** &nbsp;&nbsp; folks: **10,394**  &nbsp;&nbsp; `11,536 stars this month`
...
1. [Mintplex-Labs / anything-llm](https://github.com/Mintplex-Labs/anything-llm)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **38,568** &nbsp;&nbsp; folks: **3,708**  &nbsp;&nbsp; `7,908 stars this month`

1. [Bin-Huang / chatbox](https://github.com/Bin-Huang/chatbox)
    - User-friendly Desktop Client App for AI Models/LLMs (GPT, Claude, Gemini, Ollama...)
    - language: **TypeScript** &nbsp;&nbsp; stars: **31,832** &nbsp;&nbsp; folks: **3,021**  &nbsp;&nbsp; `6,867 stars this month`
...
1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,319** &nbsp;&nbsp; folks: **458**  &nbsp;&nbsp; `3,960 stars this month`

1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    - Make websites accessible for AI agents
    - language: **Python** &nbsp;&nbsp; stars: **31,532** &nbsp;&nbsp; folks: **3,255**  &nbsp;&nbsp; `15,350 stars this month`
