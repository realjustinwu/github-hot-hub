...
`更新时间：2025-07-30 12:07:32 +0800`

## 今日热门仓库

1. [9001 / copyparty](https://github.com/9001/copyparty)
    - Portable file server with accelerated resumable uploads, dedup, WebDAV, FTP, TFTP, zeroconf, media indexer, thumbnails++ all in one file, no deps
    - language: **Python** &nbsp;&nbsp; stars: **10,997** &nbsp;&nbsp; folks: **331**  &nbsp;&nbsp; `4,125 stars today`

1. [cloudwego / eino](https://github.com/cloudwego/eino)
    - The ultimate LLM/AI application development framework in Golang.
    - language: **Go** &nbsp;&nbsp; stars: **5,733** &nbsp;&nbsp; folks: **459**  &nbsp;&nbsp; `92 stars today`

1. [n0-computer / iroh](https://github.com/n0-computer/iroh)
    - peer-2-peer that just works
    - language: **Rust** &nbsp;&nbsp; stars: **6,322** &nbsp;&nbsp; folks: **280**  &nbsp;&nbsp; `151 stars today`

1. [tldr-pages / tldr](https://github.com/tldr-pages/tldr)
    - 📚 Collaborative cheatsheets for console commands
    - language: **Markdown** &nbsp;&nbsp; stars: **57,638** &nbsp;&nbsp; folks: **4,627**  &nbsp;&nbsp; `379 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **53,628** &nbsp;&nbsp; folks: **6,231**  &nbsp;&nbsp; `638 stars today`

1. [microsoft / PowerToys](https://github.com/microsoft/PowerToys)
    - Windows system utilities to maximize productivity
    - language: **C#** &nbsp;&nbsp; stars: **121,508** &nbsp;&nbsp; folks: **7,227**  &nbsp;&nbsp; `96 stars today`

1. [lapce / lapce](https://github.com/lapce/lapce)
    - Lightning-fast and Powerful Code Editor written in Rust
    - language: **Rust** &nbsp;&nbsp; stars: **36,957** &nbsp;&nbsp; folks: **1,165**  &nbsp;&nbsp; `35 stars today`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **20,791** &nbsp;&nbsp; folks: **4,191**  &nbsp;&nbsp; `7,747 stars this week`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **46,952** &nbsp;&nbsp; folks: **4,280**  &nbsp;&nbsp; `2,913 stars this week`
...
1. [remoteintech / remote-jobs](https://github.com/remoteintech/remote-jobs)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **37,596** &nbsp;&nbsp; folks: **3,654**  &nbsp;&nbsp; `2,080 stars this week`

1. [roboflow / supervision](https://github.com/roboflow/supervision)
    - We write your reusable computer vision tools. 💜
    - language: **Python** &nbsp;&nbsp; stars: **31,493** &nbsp;&nbsp; folks: **2,495**  &nbsp;&nbsp; `1,833 stars this week`
...
1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **6,611** &nbsp;&nbsp; folks: **885**  &nbsp;&nbsp; `595 stars this week`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **313,583** &nbsp;&nbsp; folks: **51,491**  &nbsp;&nbsp; `1,352 stars this week`
...
1. [SillyTavern / SillyTavern](https://github.com/SillyTavern/SillyTavern)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **16,796** &nbsp;&nbsp; folks: **3,708**  &nbsp;&nbsp; `483 stars this week`

1. [spring-projects / spring-boot](https://github.com/spring-projects/spring-boot)
    - Spring Boot helps you to create Spring-powered, production-grade applications and services with absolute minimum fuss.
    - language: **Java** &nbsp;&nbsp; stars: **77,927** &nbsp;&nbsp; folks: **41,353**  &nbsp;&nbsp; `115 stars this week`

1. [QwenLM / Qwen3](https://github.com/QwenLM/Qwen3)
    - Qwen3 is the large language model series developed by Qwen team, Alibaba Cloud.
    - language: **Python** &nbsp;&nbsp; stars: **23,554** &nbsp;&nbsp; folks: **1,583**  &nbsp;&nbsp; `859 stars this week`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **53,628** &nbsp;&nbsp; folks: **6,231**  &nbsp;&nbsp; `2,539 stars this week`

1. [myshell-ai / OpenVoice](https://github.com/myshell-ai/OpenVoice)
    - Instant voice cloning by MIT and MyShell. Audio foundation model.
    - language: **Python** &nbsp;&nbsp; stars: **33,676** &nbsp;&nbsp; folks: **3,595**  &nbsp;&nbsp; `321 stars this week`

1. [langfuse / langfuse](https://github.com/langfuse/langfuse)
    - 🪢 Open source LLM engineering platform: LLM Observability, metrics, evals, prompt management, playground, datasets. Integrates with OpenTelemetry, Langchain, OpenAI SDK, LiteLLM, and more. 🍊YC W23
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,377** &nbsp;&nbsp; folks: **1,325**  &nbsp;&nbsp; `354 stars this week`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **34,343** &nbsp;&nbsp; folks: **8,076**  &nbsp;&nbsp; `10,587 stars this month`
...
1. [googleapis / genai-toolbox](https://github.com/googleapis/genai-toolbox)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **8,254** &nbsp;&nbsp; folks: **603**  &nbsp;&nbsp; `6,628 stars this month`

1. [humanlayer / 12-factor-agents](https://github.com/humanlayer/12-factor-agents)
    - What are the principles we can use to build LLM-powered software that is actually good enough to put in the hands of production customers?
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,792** &nbsp;&nbsp; folks: **709**  &nbsp;&nbsp; `5,942 stars this month`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **46,952** &nbsp;&nbsp; folks: **4,280**  &nbsp;&nbsp; `4,833 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,672** &nbsp;&nbsp; folks: **631**  &nbsp;&nbsp; `6,295 stars this month`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **7,584** &nbsp;&nbsp; folks: **377**  &nbsp;&nbsp; `5,773 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **26,756** &nbsp;&nbsp; folks: **1,479**  &nbsp;&nbsp; `10,506 stars this month`

1. [snailyp / gemini-balance](https://github.com/snailyp/gemini-balance)
    - Gemini polling proxy service （gemini轮询代理服务）
    - language: **Python** &nbsp;&nbsp; stars: **3,906** &nbsp;&nbsp; folks: **695**  &nbsp;&nbsp; `2,045 stars this month`

1. [datawhalechina / happy-llm](https://github.com/datawhalechina/happy-llm)
    - 📚 从零开始的大语言模型原理与实践教程
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **13,605** &nbsp;&nbsp; folks: **1,029**  &nbsp;&nbsp; `8,998 stars this month`
...
1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **6,611** &nbsp;&nbsp; folks: **885**  &nbsp;&nbsp; `2,519 stars this month`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,888** &nbsp;&nbsp; folks: **506**  &nbsp;&nbsp; `4,358 stars this month`
