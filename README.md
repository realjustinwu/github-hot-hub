...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **69,015** &nbsp;&nbsp; folks: **3,679**  &nbsp;&nbsp; `7,091 stars this week`

1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The personal finance app for everyone
    - language: **Ruby** &nbsp;&nbsp; stars: **50,694** &nbsp;&nbsp; folks: **3,753**  &nbsp;&nbsp; `5,414 stars this week`
...
1. [hyprwm / Hyprland](https://github.com/hyprwm/Hyprland)
    - Hyprland is an independent, highly customizable, dynamic tiling Wayland compositor that doesn't sacrifice on its looks.
    - language: **C++** &nbsp;&nbsp; stars: **28,612** &nbsp;&nbsp; folks: **1,206**  &nbsp;&nbsp; `1,560 stars this week`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,997** &nbsp;&nbsp; folks: **514**  &nbsp;&nbsp; `2,328 stars this week`

1. [gitleaks / gitleaks](https://github.com/gitleaks/gitleaks)
    - Find secrets with Gitleaks 🔑
    - language: **Go** &nbsp;&nbsp; stars: **22,463** &nbsp;&nbsp; folks: **1,723**  &nbsp;&nbsp; `968 stars this week`

1. [getzep / graphiti](https://github.com/getzep/graphiti)
    - Build Real-Time Knowledge Graphs for AI Agents
    - language: **Python** &nbsp;&nbsp; stars: **14,828** &nbsp;&nbsp; folks: **1,244**  &nbsp;&nbsp; `1,246 stars this week`
...
1. [vanna-ai / vanna](https://github.com/vanna-ai/vanna)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **19,568** &nbsp;&nbsp; folks: **1,774**  &nbsp;&nbsp; `838 stars this week`
...
1. [lastmile-ai / mcp-agent](https://github.com/lastmile-ai/mcp-agent)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,764** &nbsp;&nbsp; folks: **667**  &nbsp;&nbsp; `474 stars this week`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,237** &nbsp;&nbsp; folks: **7,908**  &nbsp;&nbsp; `9,590 stars this month`
...
1. [twentyhq / twenty](https://github.com/twentyhq/twenty)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **34,321** &nbsp;&nbsp; folks: **3,855**  &nbsp;&nbsp; `6,075 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **25,450** &nbsp;&nbsp; folks: **1,390**  &nbsp;&nbsp; `11,047 stars this month`

1. [GyulyVGC / sniffnet](https://github.com/GyulyVGC/sniffnet)
    - Comfortably monitor your Internet traffic 🕵️‍♂️
    - language: **Rust** &nbsp;&nbsp; stars: **29,202** &nbsp;&nbsp; folks: **970**  &nbsp;&nbsp; `4,734 stars this month`

1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The personal finance app for everyone
    - language: **Ruby** &nbsp;&nbsp; stars: **50,694** &nbsp;&nbsp; folks: **3,753**  &nbsp;&nbsp; `5,760 stars this month`

1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 26 lessons, 52 quizzes, classic Machine Learning for all
    - language: **HTML** &nbsp;&nbsp; stars: **75,322** &nbsp;&nbsp; folks: **16,650**  &nbsp;&nbsp; `2,602 stars this month`
...
1. [datawhalechina / happy-llm](https://github.com/datawhalechina/happy-llm)
    - 📚 从零开始的大语言模型原理与实践教程
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **12,724** &nbsp;&nbsp; folks: **945**  &nbsp;&nbsp; `8,775 stars this month`
...
1. [stanford-oval / storm](https://github.com/stanford-oval/storm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **26,950** &nbsp;&nbsp; folks: **2,422**  &nbsp;&nbsp; `2,376 stars this month`
