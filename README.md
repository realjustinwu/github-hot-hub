...
1. [openwrt / openwrt](https://github.com/openwrt/openwrt)
    ...
    - language: **C** &nbsp;&nbsp; stars: **23,620** &nbsp;&nbsp; folks: **11,522**  &nbsp;&nbsp; `23 stars today`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,724** &nbsp;&nbsp; folks: **866**  &nbsp;&nbsp; `299 stars today`

1. [Stirling-Tools / Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF)
    - #1 Locally hosted web application that allows you to perform various operations on PDF files
    - language: **Java** &nbsp;&nbsp; stars: **65,485** &nbsp;&nbsp; folks: **5,579**  &nbsp;&nbsp; `281 stars today`
...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **3,884** &nbsp;&nbsp; folks: **279**  &nbsp;&nbsp; `299 stars today`
...
1. [pathwaycom / pathway](https://github.com/pathwaycom/pathway)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **37,910** &nbsp;&nbsp; folks: **1,113**  &nbsp;&nbsp; `1,690 stars today`

1. [pathwaycom / llm-app](https://github.com/pathwaycom/llm-app)
    - Ready-to-run cloud templates for RAG, AI pipelines, and enterprise search with live data. 🐳Docker-friendly.⚡Always in sync with Sharepoint, Google Drive, S3, Kafka, PostgreSQL, real-time data APIs, and more.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **35,601** &nbsp;&nbsp; folks: **957**  &nbsp;&nbsp; `2,267 stars today`

1. [henrygd / beszel](https://github.com/henrygd/beszel)
    - Lightweight server monitoring hub with historical data, docker stats, and alerts.
    - language: **Go** &nbsp;&nbsp; stars: **14,668** &nbsp;&nbsp; folks: **452**  &nbsp;&nbsp; `97 stars today`

1. [ossu / computer-science](https://github.com/ossu/computer-science)
    - 🎓 Path to a free self-taught education in Computer Science!
    - language: **HTML** &nbsp;&nbsp; stars: **192,145** &nbsp;&nbsp; folks: **23,996**  &nbsp;&nbsp; `278 stars today`
...
1. [Vector-Wangel / XLeRobot](https://github.com/Vector-Wangel/XLeRobot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,909** &nbsp;&nbsp; folks: **187**  &nbsp;&nbsp; `284 stars today`
...
1. [dockur / windows](https://github.com/dockur/windows)
    ...
    - language: **Shell** &nbsp;&nbsp; stars: **44,686** &nbsp;&nbsp; folks: **3,247**  &nbsp;&nbsp; `6,784 stars this week`

1. [bytebot-ai / bytebot](https://github.com/bytebot-ai/bytebot)
    - Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,832** &nbsp;&nbsp; folks: **622**  &nbsp;&nbsp; `2,671 stars this week`
...
1. [QuentinFuxa / WhisperLiveKit](https://github.com/QuentinFuxa/WhisperLiveKit)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,504** &nbsp;&nbsp; folks: **555**  &nbsp;&nbsp; `2,964 stars this week`
...
1. [Eventual-Inc / Daft](https://github.com/Eventual-Inc/Daft)
    - Distributed query engine providing simple and reliable data processing for any modality and scale
    - language: **Rust** &nbsp;&nbsp; stars: **3,884** &nbsp;&nbsp; folks: **279**  &nbsp;&nbsp; `216 stars this week`
...
1. [asgeirtj / system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **19,301** &nbsp;&nbsp; folks: **3,071**  &nbsp;&nbsp; `11,082 stars this month`
...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,383** &nbsp;&nbsp; folks: **1,754**  &nbsp;&nbsp; `7,705 stars this month`

1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **39,250** &nbsp;&nbsp; folks: **4,532**  &nbsp;&nbsp; `7,280 stars this month`

1. [dockur / windows](https://github.com/dockur/windows)
    - Windows inside a Docker container.
    - language: **Shell** &nbsp;&nbsp; stars: **44,686** &nbsp;&nbsp; folks: **3,247**  &nbsp;&nbsp; `7,923 stars this month`
...
1. [dtyq / magic](https://github.com/dtyq/magic)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **3,992** &nbsp;&nbsp; folks: **399**  &nbsp;&nbsp; `2,588 stars this month`
...
1. [aliasrobotics / cai](https://github.com/aliasrobotics/cai)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,610** &nbsp;&nbsp; folks: **490**  &nbsp;&nbsp; `1,591 stars this month`
