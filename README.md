...
`更新时间：2025-07-28 22:28:49 +0800`

## 今日热门仓库

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **52,758** &nbsp;&nbsp; folks: **6,157**  &nbsp;&nbsp; `1,002 stars today`
...
1. [ashishpatel26 / 500-AI-Agents-Projects](https://github.com/ashishpatel26/500-AI-Agents-Projects)
    ...
    - language: **无** &nbsp;&nbsp; stars: **2,430** &nbsp;&nbsp; folks: **627**  &nbsp;&nbsp; `367 stars today`
...
1. [SillyTavern / SillyTavern](https://github.com/SillyTavern/SillyTavern)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **16,527** &nbsp;&nbsp; folks: **3,686**  &nbsp;&nbsp; `39 stars today`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **20,515** &nbsp;&nbsp; folks: **4,169**  &nbsp;&nbsp; `10,472 stars this week`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **46,698** &nbsp;&nbsp; folks: **4,254**  &nbsp;&nbsp; `3,213 stars this week`
...
1. [hyprwm / Hyprland](https://github.com/hyprwm/Hyprland)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **28,854** &nbsp;&nbsp; folks: **1,222**  &nbsp;&nbsp; `863 stars this week`
...
1. [spring-projects / spring-boot](https://github.com/spring-projects/spring-boot)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **77,904** &nbsp;&nbsp; folks: **41,346**  &nbsp;&nbsp; `106 stars this week`
...
1. [Lissy93 / web-check](https://github.com/Lissy93/web-check)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **25,916** &nbsp;&nbsp; folks: **2,061**  &nbsp;&nbsp; `212 stars this week`
...
1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **32,930** &nbsp;&nbsp; folks: **9,696**  &nbsp;&nbsp; `1,679 stars this week`

1. [langfuse / langfuse](https://github.com/langfuse/langfuse)
    - 🪢 Open source LLM engineering platform: LLM Observability, metrics, evals, prompt management, playground, datasets. Integrates with OpenTelemetry, Langchain, OpenAI SDK, LiteLLM, and more. 🍊YC W23
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,243** &nbsp;&nbsp; folks: **1,315**  &nbsp;&nbsp; `301 stars this week`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **7,273** &nbsp;&nbsp; folks: **363**  &nbsp;&nbsp; `2,402 stars this week`
...
1. [humanlayer / 12-factor-agents](https://github.com/humanlayer/12-factor-agents)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,588** &nbsp;&nbsp; folks: **691**  &nbsp;&nbsp; `5,789 stars this month`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **46,698** &nbsp;&nbsp; folks: **4,254**  &nbsp;&nbsp; `4,427 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **8,103** &nbsp;&nbsp; folks: **600**  &nbsp;&nbsp; `5,690 stars this month`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **7,273** &nbsp;&nbsp; folks: **363**  &nbsp;&nbsp; `5,445 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **26,423** &nbsp;&nbsp; folks: **1,455**  &nbsp;&nbsp; `10,513 stars this month`
...
1. [GyulyVGC / sniffnet](https://github.com/GyulyVGC/sniffnet)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **29,509** &nbsp;&nbsp; folks: **987**  &nbsp;&nbsp; `4,972 stars this month`
...
1. [Kilo-Org / kilocode](https://github.com/Kilo-Org/kilocode)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,759** &nbsp;&nbsp; folks: **492**  &nbsp;&nbsp; `4,284 stars this month`
...
1. [zaidmukaddam / scira](https://github.com/zaidmukaddam/scira)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **10,124** &nbsp;&nbsp; folks: **1,245**  &nbsp;&nbsp; `1,824 stars this month`

1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    - 12 weeks, 26 lessons, 52 quizzes, classic Machine Learning for all
    - language: **HTML** &nbsp;&nbsp; stars: **75,751** &nbsp;&nbsp; folks: **16,742**  &nbsp;&nbsp; `2,560 stars this month`

1. [google-gemini / gemini-cli](https://github.com/google-gemini/gemini-cli)
    - An open-source AI agent that brings the power of Gemini directly into your terminal.
    - language: **TypeScript** &nbsp;&nbsp; stars: **64,965** &nbsp;&nbsp; folks: **6,185**  &nbsp;&nbsp; `31,091 stars this month`

1. [datawhalechina / happy-llm](https://github.com/datawhalechina/happy-llm)
    - 📚 从零开始的大语言模型原理与实践教程
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **13,416** &nbsp;&nbsp; folks: **1,009**  &nbsp;&nbsp; `8,858 stars this month`
