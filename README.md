...
`更新时间：2025-08-18 06:24:23 +0800`

## 今日热门仓库

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **7,503** &nbsp;&nbsp; folks: **1,453**  &nbsp;&nbsp; `991 stars today`

1. [emcie-co / parlant](https://github.com/emcie-co/parlant)
    - LLM agents built for control. Designed for real-world use. Deployed in minutes.
    - language: **Python** &nbsp;&nbsp; stars: **4,775** &nbsp;&nbsp; folks: **461**  &nbsp;&nbsp; `461 stars today`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **58,709** &nbsp;&nbsp; folks: **7,036**  &nbsp;&nbsp; `442 stars today`
...
1. [aliasrobotics / cai](https://github.com/aliasrobotics/cai)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **2,616** &nbsp;&nbsp; folks: **398**  &nbsp;&nbsp; `152 stars today`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **3,971** &nbsp;&nbsp; folks: **162**  &nbsp;&nbsp; `490 stars today`
...
1. [dtyq / magic](https://github.com/dtyq/magic)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **2,200** &nbsp;&nbsp; folks: **242**  &nbsp;&nbsp; `287 stars today`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **49,787** &nbsp;&nbsp; folks: **4,640**  &nbsp;&nbsp; `320 stars today`
...
1. [clash-verge-rev / clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **70,520** &nbsp;&nbsp; folks: **5,330**  &nbsp;&nbsp; `118 stars today`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,226** &nbsp;&nbsp; folks: **1,545**  &nbsp;&nbsp; `1,136 stars this week`
...
1. [dtyq / magic](https://github.com/dtyq/magic)
    - Super Magic (超级麦吉). The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)
    - language: **PHP** &nbsp;&nbsp; stars: **2,200** &nbsp;&nbsp; folks: **242**  &nbsp;&nbsp; `539 stars this week`

1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    - Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!
    - language: **Python** &nbsp;&nbsp; stars: **8,944** &nbsp;&nbsp; folks: **700**  &nbsp;&nbsp; `1,912 stars this week`
...
1. [conductor-oss / conductor](https://github.com/conductor-oss/conductor)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **26,140** &nbsp;&nbsp; folks: **674**  &nbsp;&nbsp; `1,269 stars this week`
...
1. [syncthing / syncthing](https://github.com/syncthing/syncthing)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **75,065** &nbsp;&nbsp; folks: **4,698**  &nbsp;&nbsp; `810 stars this week`

1. [idosal / git-mcp](https://github.com/idosal/git-mcp)
    - Put an end to code hallucinations! GitMCP is a free, open-source, remote MCP server for any GitHub project
    - language: **TypeScript** &nbsp;&nbsp; stars: **5,350** &nbsp;&nbsp; folks: **398**  &nbsp;&nbsp; `1,139 stars this week`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **22,347** &nbsp;&nbsp; folks: **4,321**  &nbsp;&nbsp; `13,191 stars this month`

1. [dyad-sh / dyad](https://github.com/dyad-sh/dyad)
    - Free, local, open-source AI app builder ✨ v0 / lovable / Bolt alternative 🌟 Star if you like it!
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,172** &nbsp;&nbsp; folks: **1,263**  &nbsp;&nbsp; `11,151 stars this month`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Financial data aggregator for humans and AI agents.
    - language: **Python** &nbsp;&nbsp; stars: **49,787** &nbsp;&nbsp; folks: **4,640**  &nbsp;&nbsp; `6,652 stars this month`
...
1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,567** &nbsp;&nbsp; folks: **1,007**  &nbsp;&nbsp; `8,553 stars this month`

1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    - Beta release of Archon OS - the knowledge and task management backbone for AI coding assistants.
    - language: **Python** &nbsp;&nbsp; stars: **7,503** &nbsp;&nbsp; folks: **1,453**  &nbsp;&nbsp; `934 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,070** &nbsp;&nbsp; folks: **602**  &nbsp;&nbsp; `6,821 stars this month`
...
1. [microsoft / mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,237** &nbsp;&nbsp; folks: **2,537**  &nbsp;&nbsp; `4,017 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,495** &nbsp;&nbsp; folks: **9,434**  &nbsp;&nbsp; `3,093 stars this month`
