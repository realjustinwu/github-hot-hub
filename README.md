...
1. [qarmin / czkawka](https://github.com/qarmin/czkawka)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **25,251** &nbsp;&nbsp; folks: **782**  &nbsp;&nbsp; `78 stars today`

1. [Librum-Reader / Librum](https://github.com/Librum-Reader/Librum)
    - The Librum client application
    - language: **C++** &nbsp;&nbsp; stars: **5,011** &nbsp;&nbsp; folks: **168**  &nbsp;&nbsp; `86 stars today`

1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    - Python tool for converting files and office documents to Markdown.
    - language: **Python** &nbsp;&nbsp; stars: **71,804** &nbsp;&nbsp; folks: **3,914**  &nbsp;&nbsp; `327 stars today`

1. [jitsi / jitsi-meet](https://github.com/jitsi/jitsi-meet)
    - Jitsi Meet - Secure, Simple and Scalable Video Conferences that you use as a standalone app or embed in your web application.
    - language: **TypeScript** &nbsp;&nbsp; stars: **26,647** &nbsp;&nbsp; folks: **7,365**  &nbsp;&nbsp; `50 stars today`
...
1. [google / wire](https://github.com/google/wire)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **14,153** &nbsp;&nbsp; folks: **668**  &nbsp;&nbsp; `30 stars today`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,973** &nbsp;&nbsp; folks: **1,256**  &nbsp;&nbsp; `566 stars this week`

1. [openai / codex](https://github.com/openai/codex)
    - Lightweight coding agent that runs in your terminal
    - language: **Rust** &nbsp;&nbsp; stars: **35,116** &nbsp;&nbsp; folks: **4,020**  &nbsp;&nbsp; `2,482 stars this week`

1. [xiaoyaocz / dart_simple_live](https://github.com/xiaoyaocz/dart_simple_live)
    - 简简单单的看直播
    - language: **Dart** &nbsp;&nbsp; stars: **12,500** &nbsp;&nbsp; folks: **1,001**  &nbsp;&nbsp; `560 stars this week`
...
1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    - Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!
    - language: **Python** &nbsp;&nbsp; stars: **8,801** &nbsp;&nbsp; folks: **688**  &nbsp;&nbsp; `1,767 stars this week`

1. [syncthing / syncthing](https://github.com/syncthing/syncthing)
    - Open Source Continuous File Synchronization
    - language: **Go** &nbsp;&nbsp; stars: **74,965** &nbsp;&nbsp; folks: **4,694**  &nbsp;&nbsp; `757 stars this week`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,510** &nbsp;&nbsp; folks: **1,459**  &nbsp;&nbsp; `920 stars this week`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **22,179** &nbsp;&nbsp; folks: **4,311**  &nbsp;&nbsp; `13,110 stars this month`
...
1. [roboflow / supervision](https://github.com/roboflow/supervision)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,893** &nbsp;&nbsp; folks: **2,734**  &nbsp;&nbsp; `7,060 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,304** &nbsp;&nbsp; folks: **993**  &nbsp;&nbsp; `8,887 stars this month`

1. [langchain-ai / open_deep_research](https://github.com/langchain-ai/open_deep_research)
    - 无
    - language: **Python** &nbsp;&nbsp; stars: **7,830** &nbsp;&nbsp; folks: **1,033**  &nbsp;&nbsp; `3,432 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,783** &nbsp;&nbsp; folks: **588**  &nbsp;&nbsp; `6,775 stars this month`
...
1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **55,377** &nbsp;&nbsp; folks: **9,412**  &nbsp;&nbsp; `3,143 stars this month`
