...
1. [apache / echarts](https://github.com/apache/echarts)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **61,196** &nbsp;&nbsp; folks: **19,642**  &nbsp;&nbsp; `19 stars today`
...
1. [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **302,938** &nbsp;&nbsp; folks: **39,680**  &nbsp;&nbsp; `125 stars today`

1. [3b1b / manim](https://github.com/3b1b/manim)
    - Animation engine for explanatory math videos
    - language: **Python** &nbsp;&nbsp; stars: **72,509** &nbsp;&nbsp; folks: **6,349**  &nbsp;&nbsp; `43 stars today`
...
1. [ziglang / zig](https://github.com/ziglang/zig)
    ...
    - language: **Zig** &nbsp;&nbsp; stars: **35,703** &nbsp;&nbsp; folks: **2,597**  &nbsp;&nbsp; `25 stars today`

1. [OpenSPG / KAG](https://github.com/OpenSPG/KAG)
    - KAG is a logical form-guided reasoning and retrieval framework based on OpenSPG engine and LLMs. It is used to build logical reasoning and factual Q&A solutions for professional domain knowledge bases. It can effectively overcome the shortcomings of the traditional RAG vector similarity calculation model.
    - language: **Python** &nbsp;&nbsp; stars: **1,525** &nbsp;&nbsp; folks: **111**  &nbsp;&nbsp; `311 stars today`

1. [ruanyf / weekly](https://github.com/ruanyf/weekly)
    - 科技爱好者周刊，每周五发布
    - language: **无** &nbsp;&nbsp; stars: **50,428** &nbsp;&nbsp; folks: **3,020**  &nbsp;&nbsp; `85 stars today`
...
1. [XiaoMi / ha_xiaomi_home](https://github.com/XiaoMi/ha_xiaomi_home)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **15,414** &nbsp;&nbsp; folks: **684**  &nbsp;&nbsp; `4,563 stars this week`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **282,956** &nbsp;&nbsp; folks: **47,304**  &nbsp;&nbsp; `3,297 stars this week`
...
1. [gorhill / uBlock](https://github.com/gorhill/uBlock)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **48,622** &nbsp;&nbsp; folks: **3,224**  &nbsp;&nbsp; `603 stars this week`
...
1. [anthropics / anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **8,475** &nbsp;&nbsp; folks: **1,045**  &nbsp;&nbsp; `1,092 stars this week`
...
1. [cline / cline](https://github.com/cline/cline)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **16,417** &nbsp;&nbsp; folks: **1,374**  &nbsp;&nbsp; `1,045 stars this week`
...
1. [google-gemini / cookbook](https://github.com/google-gemini/cookbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **9,716** &nbsp;&nbsp; folks: **1,124**  &nbsp;&nbsp; `888 stars this week`

1. [browserbase / stagehand](https://github.com/browserbase/stagehand)
    - An AI web browsing framework focused on simplicity and extensibility.
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,579** &nbsp;&nbsp; folks: **125**  &nbsp;&nbsp; `793 stars this week`
...
1. [myhhub / stock](https://github.com/myhhub/stock)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,632** &nbsp;&nbsp; folks: **1,209**  &nbsp;&nbsp; `4,821 stars this month`
...
1. [Byaidu / PDFMathTranslate](https://github.com/Byaidu/PDFMathTranslate)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **11,573** &nbsp;&nbsp; folks: **842**  &nbsp;&nbsp; `8,448 stars this month`

1. [google-gemini / cookbook](https://github.com/google-gemini/cookbook)
    - Examples and guides for using the Gemini API
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **9,716** &nbsp;&nbsp; folks: **1,124**  &nbsp;&nbsp; `4,162 stars this month`
...
1. [lobehub / lobe-chat](https://github.com/lobehub/lobe-chat)
    - 🤯 Lobe Chat - an open-source, modern-design AI chat framework. Supports Multi AI Providers( OpenAI / Claude 3 / Gemini / Ollama / Qwen / DeepSeek), Knowledge Base (file upload / knowledge management / RAG ), Multi-Modals (Vision/TTS/Plugins/Artifacts). One-click FREE deployment of your private ChatGPT/ Claude application.
    - language: **TypeScript** &nbsp;&nbsp; stars: **50,019** &nbsp;&nbsp; folks: **10,817**  &nbsp;&nbsp; `5,117 stars this month`
...
1. [krahets / hello-algo](https://github.com/krahets/hello-algo)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **104,285** &nbsp;&nbsp; folks: **13,094**  &nbsp;&nbsp; `4,194 stars this month`

1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    - Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
    - language: **Python** &nbsp;&nbsp; stars: **282,956** &nbsp;&nbsp; folks: **47,304**  &nbsp;&nbsp; `5,748 stars this month`

1. [browserbase / stagehand](https://github.com/browserbase/stagehand)
    - An AI web browsing framework focused on simplicity and extensibility.
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,579** &nbsp;&nbsp; folks: **125**  &nbsp;&nbsp; `1,344 stars this month`

1. [imputnet / cobalt](https://github.com/imputnet/cobalt)
    - best way to save what you love
    - language: **Svelte** &nbsp;&nbsp; stars: **21,428** &nbsp;&nbsp; folks: **1,762**  &nbsp;&nbsp; `3,634 stars this month`
