...
`更新时间：2025-05-03 06:23:43 +0800`

## 今日热门仓库

1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    - real time face swap and one-click video deepfake with only a single image
    - language: **Python** &nbsp;&nbsp; stars: **57,576** &nbsp;&nbsp; folks: **8,168**  &nbsp;&nbsp; `1,488 stars today`
...
1. [aipotheosis-labs / aci](https://github.com/aipotheosis-labs/aci)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,305** &nbsp;&nbsp; folks: **86**  &nbsp;&nbsp; `243 stars today`
...
1. [unionlabs / union](https://github.com/unionlabs/union)
    ...
    - language: **Rust** &nbsp;&nbsp; stars: **56,264** &nbsp;&nbsp; folks: **2,820**  &nbsp;&nbsp; `369 stars today`

1. [cloudflare / agents](https://github.com/cloudflare/agents)
    - Build and deploy AI Agents on Cloudflare
    - language: **TypeScript** &nbsp;&nbsp; stars: **1,752** &nbsp;&nbsp; folks: **119**  &nbsp;&nbsp; `76 stars today`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **297,797** &nbsp;&nbsp; folks: **49,493**  &nbsp;&nbsp; `116 stars today`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **92,781** &nbsp;&nbsp; folks: **11,759**  &nbsp;&nbsp; `379 stars today`
...
1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    - real time face swap and one-click video deepfake with only a single image
    - language: **Python** &nbsp;&nbsp; stars: **57,577** &nbsp;&nbsp; folks: **8,168**  &nbsp;&nbsp; `5,176 stars this week`

1. [kortix-ai / suna](https://github.com/kortix-ai/suna)
    - Suna - Open Source Generalist AI Agent
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,417** &nbsp;&nbsp; folks: **1,157**  &nbsp;&nbsp; `6,461 stars this week`

1. [jujumilk3 / leaked-system-prompts](https://github.com/jujumilk3/leaked-system-prompts)
    - Collection of leaked system prompts
    - language: **无** &nbsp;&nbsp; stars: **5,743** &nbsp;&nbsp; folks: **633**  &nbsp;&nbsp; `2,985 stars this week`
...
1. [simular-ai / Agent-S](https://github.com/simular-ai/Agent-S)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **3,916** &nbsp;&nbsp; folks: **381**  &nbsp;&nbsp; `1,279 stars this week`
...
1. [microsoft / generative-ai-for-beginners](https://github.com/microsoft/generative-ai-for-beginners)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **82,005** &nbsp;&nbsp; folks: **42,110**  &nbsp;&nbsp; `2,608 stars this week`
...
1. [bregman-arie / devops-exercises](https://github.com/bregman-arie/devops-exercises)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **75,536** &nbsp;&nbsp; folks: **16,818**  &nbsp;&nbsp; `1,301 stars this week`
...
1. [LadybirdBrowser / ladybird](https://github.com/LadybirdBrowser/ladybird)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **38,130** &nbsp;&nbsp; folks: **1,584**  &nbsp;&nbsp; `611 stars this week`
...
1. [PowerShell / PowerShell](https://github.com/PowerShell/PowerShell)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **47,225** &nbsp;&nbsp; folks: **7,620**  &nbsp;&nbsp; `151 stars this week`
...
1. [mem0ai / mem0](https://github.com/mem0ai/mem0)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **28,424** &nbsp;&nbsp; folks: **2,709**  &nbsp;&nbsp; `485 stars this week`
...
1. [jujumilk3 / leaked-system-prompts](https://github.com/jujumilk3/leaked-system-prompts)
    - Collection of leaked system prompts
    - language: **无** &nbsp;&nbsp; stars: **5,743** &nbsp;&nbsp; folks: **633**  &nbsp;&nbsp; `3,474 stars this month`
...
1. [microsoft / markitdown](https://github.com/microsoft/markitdown)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **55,698** &nbsp;&nbsp; folks: **2,819**  &nbsp;&nbsp; `13,947 stars this month`
...
1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **88,243** &nbsp;&nbsp; folks: **24,056**  &nbsp;&nbsp; `14,603 stars this month`

1. [hacksider / Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam)
    - real time face swap and one-click video deepfake with only a single image
    - language: **Python** &nbsp;&nbsp; stars: **57,577** &nbsp;&nbsp; folks: **8,168**  &nbsp;&nbsp; `6,789 stars this month`
...
1. [simular-ai / Agent-S](https://github.com/simular-ai/Agent-S)
    - Agent S: an open agentic framework that uses computers like a human
    - language: **Python** &nbsp;&nbsp; stars: **3,916** &nbsp;&nbsp; folks: **381**  &nbsp;&nbsp; `2,300 stars this month`
