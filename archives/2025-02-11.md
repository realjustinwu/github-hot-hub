...
`最后更新时间：2025-02-11 00:28:00 +0800`

## 今日热门仓库

1. [unslothai / unsloth](https://github.com/unslothai/unsloth)
    - Finetune Llama 3.3, DeepSeek-R1 & Reasoning LLMs 2x faster with 70% less memory
    - language: **Python** &nbsp;&nbsp; stars: **26,024** &nbsp;&nbsp; folks: **1,745**  &nbsp;&nbsp; `969 stars today`
...
1. [ChrisTitusTech / winutil](https://github.com/ChrisTitusTech/winutil)
    ...
    - language: **PowerShell** &nbsp;&nbsp; stars: **28,849** &nbsp;&nbsp; folks: **1,674**  &nbsp;&nbsp; `59 stars today`

1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding.
    - language: **Python** &nbsp;&nbsp; stars: **34,000** &nbsp;&nbsp; folks: **3,070**  &nbsp;&nbsp; `810 stars today`

1. [albertan017 / LLM4Decompile](https://github.com/albertan017/LLM4Decompile)
    - Reverse Engineering: Decompiling Binary Code with Large Language Models
    - language: **Python** &nbsp;&nbsp; stars: **4,055** &nbsp;&nbsp; folks: **287**  &nbsp;&nbsp; `228 stars today`
...
1. [firefly-iii / firefly-iii](https://github.com/firefly-iii/firefly-iii)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **17,480** &nbsp;&nbsp; folks: **1,570**  &nbsp;&nbsp; `35 stars today`
...
1. [Mintplex-Labs / anything-llm](https://github.com/Mintplex-Labs/anything-llm)
    ...
    - language: **JavaScript** &nbsp;&nbsp; stars: **35,446** &nbsp;&nbsp; folks: **3,442**  &nbsp;&nbsp; `3,218 stars this week`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **71,556** &nbsp;&nbsp; folks: **8,458**  &nbsp;&nbsp; `5,287 stars this week`
...
1. [langgenius / dify](https://github.com/langgenius/dify)
    - Dify is an open-source LLM app development platform. Dify's intuitive interface combines AI workflow, RAG pipeline, agent capabilities, model management, observability features and more, letting you quickly go from prototype to production.
    - language: **TypeScript** &nbsp;&nbsp; stars: **65,002** &nbsp;&nbsp; folks: **9,535**  &nbsp;&nbsp; `2,816 stars this week`

1. [infiniflow / ragflow](https://github.com/infiniflow/ragflow)
    - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding.
    - language: **Python** &nbsp;&nbsp; stars: **34,000** &nbsp;&nbsp; folks: **3,070**  &nbsp;&nbsp; `2,442 stars this week`

1. [lobehub / lobe-chat](https://github.com/lobehub/lobe-chat)
    - 🤯 Lobe Chat - an open-source, modern-design AI chat framework. Supports Multi AI Providers( OpenAI / Claude 3 / Gemini / Ollama / Qwen / DeepSeek), Knowledge Base (file upload / knowledge management / RAG ), Multi-Modals (Vision/TTS/Plugins/Artifacts). One-click FREE deployment of your private ChatGPT/ Claude application.
    - language: **TypeScript** &nbsp;&nbsp; stars: **54,713** &nbsp;&nbsp; folks: **11,747**  &nbsp;&nbsp; `1,915 stars this week`
...
1. [unslothai / unsloth](https://github.com/unslothai/unsloth)
    - Finetune Llama 3.3, DeepSeek-R1 & Reasoning LLMs 2x faster with 70% less memory
    - language: **Python** &nbsp;&nbsp; stars: **26,024** &nbsp;&nbsp; folks: **1,745**  &nbsp;&nbsp; `1,942 stars this week`
...
1. [solidtime-io / solidtime](https://github.com/solidtime-io/solidtime)
    ...
    - language: **PHP** &nbsp;&nbsp; stars: **4,376** &nbsp;&nbsp; folks: **212**  &nbsp;&nbsp; `847 stars this week`
...
1. [ollama / ollama](https://github.com/ollama/ollama)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **123,905** &nbsp;&nbsp; folks: **9,984**  &nbsp;&nbsp; `5,809 stars this week`
...
1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **123,905** &nbsp;&nbsp; folks: **9,984**  &nbsp;&nbsp; `16,940 stars this month`
...
1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **71,556** &nbsp;&nbsp; folks: **8,458**  &nbsp;&nbsp; `15,646 stars this month`

1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    - Make websites accessible for AI agents
    - language: **Python** &nbsp;&nbsp; stars: **26,256** &nbsp;&nbsp; folks: **2,640**  &nbsp;&nbsp; `13,944 stars this month`
...
1. [KoljaB / RealtimeSTT](https://github.com/KoljaB/RealtimeSTT)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **5,669** &nbsp;&nbsp; folks: **448**  &nbsp;&nbsp; `3,257 stars this month`

1. [ggerganov / llama.cpp](https://github.com/ggerganov/llama.cpp)
    - LLM inference in C/C++
    - language: **C++** &nbsp;&nbsp; stars: **73,752** &nbsp;&nbsp; folks: **10,638**  &nbsp;&nbsp; `3,480 stars this month`
...
1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,158** &nbsp;&nbsp; folks: **392**  &nbsp;&nbsp; `2,844 stars this month`

1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    - 🚀🤖 Crawl4AI: Open-source LLM Friendly Web Crawler & Scraper
    - language: **Python** &nbsp;&nbsp; stars: **29,571** &nbsp;&nbsp; folks: **2,375**  &nbsp;&nbsp; `6,032 stars this month`

1. [Mintplex-Labs / anything-llm](https://github.com/Mintplex-Labs/anything-llm)
    - The all-in-one Desktop & Docker AI application with built-in RAG, AI agents, and more.
    - language: **JavaScript** &nbsp;&nbsp; stars: **35,446** &nbsp;&nbsp; folks: **3,442**  &nbsp;&nbsp; `5,040 stars this month`
...
1. [n8n-io / n8n](https://github.com/n8n-io/n8n)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **59,570** &nbsp;&nbsp; folks: **12,307**  &nbsp;&nbsp; `5,172 stars this month`
