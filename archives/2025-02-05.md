...
1. [zauberzeug / nicegui](https://github.com/zauberzeug/nicegui)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,764** &nbsp;&nbsp; folks: **643**  &nbsp;&nbsp; `11 stars today`

1. [ToolJet / ToolJet](https://github.com/ToolJet/ToolJet)
    - Low-code platform for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, Google sheets, OpenAI, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. 🚀
    - language: **JavaScript** &nbsp;&nbsp; stars: **34,352** &nbsp;&nbsp; folks: **4,412**  &nbsp;&nbsp; `248 stars today`
...
1. [Soulter / AstrBot](https://github.com/Soulter/AstrBot)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **1,552** &nbsp;&nbsp; folks: **95**  &nbsp;&nbsp; `213 stars today`
...
1. [n8n-io / self-hosted-ai-starter-kit](https://github.com/n8n-io/self-hosted-ai-starter-kit)
    ...
    - language: **无** &nbsp;&nbsp; stars: **5,634** &nbsp;&nbsp; folks: **1,135**  &nbsp;&nbsp; `441 stars this week`

1. [QwenLM / Qwen2.5](https://github.com/QwenLM/Qwen2.5)
    - Qwen2.5 is the large language model series developed by Qwen team, Alibaba Cloud.
    - language: **Shell** &nbsp;&nbsp; stars: **14,736** &nbsp;&nbsp; folks: **983**  &nbsp;&nbsp; `2,612 stars this week`

1. [lmstudio-ai / lms](https://github.com/lmstudio-ai/lms)
    - 👾 LM Studio CLI
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,317** &nbsp;&nbsp; folks: **171**  &nbsp;&nbsp; `237 stars this week`

1. [is-a-dev / register](https://github.com/is-a-dev/register)
    - Grab your own sweet-looking '.is-a.dev' subdomain.
    - language: **JavaScript** &nbsp;&nbsp; stars: **5,158** &nbsp;&nbsp; folks: **9,667**  &nbsp;&nbsp; `518 stars this week`
...
1. [deepseek-ai / DeepSeek-Coder](https://github.com/deepseek-ai/DeepSeek-Coder)
    - DeepSeek Coder: Let the Code Write Itself
    - language: **Python** &nbsp;&nbsp; stars: **17,160** &nbsp;&nbsp; folks: **1,865**  &nbsp;&nbsp; `7,647 stars this month`

1. [browser-use / browser-use](https://github.com/browser-use/browser-use)
    - Make websites accessible for AI agents
    - language: **Python** &nbsp;&nbsp; stars: **23,843** &nbsp;&nbsp; folks: **2,357**  &nbsp;&nbsp; `14,810 stars this month`
...
1. [ollama / ollama](https://github.com/ollama/ollama)
    - Get up and running with Llama 3.3, DeepSeek-R1, Phi-4, Gemma 2, and other large language models.
    - language: **Go** &nbsp;&nbsp; stars: **118,754** &nbsp;&nbsp; folks: **9,500**  &nbsp;&nbsp; `12,925 stars this month`

1. [mlabonne / llm-course](https://github.com/mlabonne/llm-course)
    - Course to get into Large Language Models (LLMs) with roadmaps and Colab notebooks.
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **45,232** &nbsp;&nbsp; folks: **4,829**  &nbsp;&nbsp; `4,670 stars this month`

1. [maybe-finance / maybe](https://github.com/maybe-finance/maybe)
    - The OS for your personal finances
    - language: **Ruby** &nbsp;&nbsp; stars: **38,690** &nbsp;&nbsp; folks: **2,745**  &nbsp;&nbsp; `3,928 stars this month`

1. [open-webui / open-webui](https://github.com/open-webui/open-webui)
    - User-friendly AI Interface (Supports Ollama, OpenAI API, ...)
    - language: **JavaScript** &nbsp;&nbsp; stars: **66,911** &nbsp;&nbsp; folks: **7,933**  &nbsp;&nbsp; `12,192 stars this month`
...
1. [78 / xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)
    ...
    - language: **C++** &nbsp;&nbsp; stars: **4,183** &nbsp;&nbsp; folks: **651**  &nbsp;&nbsp; `3,230 stars this month`
...
1. [ggerganov / llama.cpp](https://github.com/ggerganov/llama.cpp)
    - LLM inference in C/C++
    - language: **C++** &nbsp;&nbsp; stars: **72,955** &nbsp;&nbsp; folks: **10,510**  &nbsp;&nbsp; `2,987 stars this month`
...
1. [cline / cline](https://github.com/cline/cline)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **27,025** &nbsp;&nbsp; folks: **2,474**  &nbsp;&nbsp; `8,268 stars this month`

1. [khoj-ai / khoj](https://github.com/khoj-ai/khoj)
    - Your AI second brain. Self-hostable. Get answers from the web or your docs. Build custom agents, schedule automations, do deep research. Turn any online or local LLM into your personal, autonomous AI (gpt, claude, gemini, llama, qwen, mistral). Get started - free.
    - language: **Python** &nbsp;&nbsp; stars: **25,844** &nbsp;&nbsp; folks: **1,390**  &nbsp;&nbsp; `8,578 stars this month`
...
1. [onlook-dev / onlook](https://github.com/onlook-dev/onlook)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,672** &nbsp;&nbsp; folks: **360**  &nbsp;&nbsp; `2,331 stars this month`
