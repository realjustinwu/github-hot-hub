...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,586** &nbsp;&nbsp; folks: **1,174**  &nbsp;&nbsp; `1,504 stars today`
...
1. [puppeteer / puppeteer](https://github.com/puppeteer/puppeteer)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **91,985** &nbsp;&nbsp; folks: **9,279**  &nbsp;&nbsp; `169 stars today`

1. [skills / introduction-to-github](https://github.com/skills/introduction-to-github)
    - Get started using GitHub in less than an hour.
    - language: **无** &nbsp;&nbsp; stars: **9,285** &nbsp;&nbsp; folks: **11,995**  &nbsp;&nbsp; `12 stars today`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **5,075** &nbsp;&nbsp; folks: **344**  &nbsp;&nbsp; `1,080 stars this week`
...
1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    ...
    - language: **C#** &nbsp;&nbsp; stars: **5,364** &nbsp;&nbsp; folks: **215**  &nbsp;&nbsp; `2,006 stars this week`
...
1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **60,924** &nbsp;&nbsp; folks: **7,328**  &nbsp;&nbsp; `3,373 stars this week`
...
1. [syncthing / syncthing](https://github.com/syncthing/syncthing)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **75,381** &nbsp;&nbsp; folks: **4,713**  &nbsp;&nbsp; `686 stars this week`
...
1. [bytedance / UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **17,862** &nbsp;&nbsp; folks: **1,658**  &nbsp;&nbsp; `1,861 stars this week`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **10,084** &nbsp;&nbsp; folks: **1,748**  &nbsp;&nbsp; `4,785 stars this month`
...
1. [QwenLM / Qwen3-Coder](https://github.com/QwenLM/Qwen3-Coder)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **12,448** &nbsp;&nbsp; folks: **851**  &nbsp;&nbsp; `7,368 stars this month`
...
1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,505** &nbsp;&nbsp; folks: **1,078**  &nbsp;&nbsp; `8,078 stars this month`

1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **5,075** &nbsp;&nbsp; folks: **344**  &nbsp;&nbsp; `1,652 stars this month`
...
1. [srbhr / Resume-Matcher](https://github.com/srbhr/Resume-Matcher)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **22,806** &nbsp;&nbsp; folks: **4,360**  &nbsp;&nbsp; `13,341 stars this month`

1. [vllm-project / vllm](https://github.com/vllm-project/vllm)
    - A high-throughput and memory-efficient inference and serving engine for LLMs
    - language: **Python** &nbsp;&nbsp; stars: **55,948** &nbsp;&nbsp; folks: **9,553**  &nbsp;&nbsp; `3,238 stars this month`

1. [simstudioai / sim](https://github.com/simstudioai/sim)
    - Sim is an open-source AI agent workflow builder. Sim Studio's interface is a lightweight, intuitive way to quickly build and deploy LLMs that connect with your favorite tools.
    - language: **TypeScript** &nbsp;&nbsp; stars: **9,586** &nbsp;&nbsp; folks: **1,174**  &nbsp;&nbsp; `2,970 stars this month`
