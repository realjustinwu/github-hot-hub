...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **46,445** &nbsp;&nbsp; folks: **4,222**  &nbsp;&nbsp; `3,114 stars this week`
...
1. [frappe / hrms](https://github.com/frappe/hrms)
    - Open Source HR and Payroll Software
    - language: **Python** &nbsp;&nbsp; stars: **4,802** &nbsp;&nbsp; folks: **1,398**  &nbsp;&nbsp; `1,715 stars this week`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **7,020** &nbsp;&nbsp; folks: **350**  &nbsp;&nbsp; `2,434 stars this week`
...
1. [microsoft / ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **32,779** &nbsp;&nbsp; folks: **9,645**  &nbsp;&nbsp; `1,699 stars this week`
...
1. [simstudioai / sim](https://github.com/simstudioai/sim)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **6,161** &nbsp;&nbsp; folks: **845**  &nbsp;&nbsp; `1,204 stars this week`
...
1. [NanmiCoder / MediaCrawler](https://github.com/NanmiCoder/MediaCrawler)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **33,980** &nbsp;&nbsp; folks: **8,015**  &nbsp;&nbsp; `10,201 stars this month`
...
1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **7,020** &nbsp;&nbsp; folks: **350**  &nbsp;&nbsp; `5,318 stars this month`

1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    - Investment Research for Everyone, Everywhere.
    - language: **Python** &nbsp;&nbsp; stars: **46,445** &nbsp;&nbsp; folks: **4,222**  &nbsp;&nbsp; `4,291 stars this month`

1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    - Use Claude Code as the foundation for coding infrastructure, allowing you to decide how to interact with the model while enjoying updates from Anthropic.
    - language: **TypeScript** &nbsp;&nbsp; stars: **7,709** &nbsp;&nbsp; folks: **580**  &nbsp;&nbsp; `5,706 stars this month`

1. [anthropics / claude-code](https://github.com/anthropics/claude-code)
    - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands.
    - language: **PowerShell** &nbsp;&nbsp; stars: **26,266** &nbsp;&nbsp; folks: **1,444**  &nbsp;&nbsp; `10,680 stars this month`

1. [google-gemini / gemini-cli](https://github.com/google-gemini/gemini-cli)
    - An open-source AI agent that brings the power of Gemini directly into your terminal.
    - language: **TypeScript** &nbsp;&nbsp; stars: **64,611** &nbsp;&nbsp; folks: **6,137**  &nbsp;&nbsp; `39,857 stars this month`
...
1. [microsoft / ML-For-Beginners](https://github.com/microsoft/ML-For-Beginners)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **75,669** &nbsp;&nbsp; folks: **16,723**  &nbsp;&nbsp; `2,779 stars this month`
