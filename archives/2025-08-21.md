...
`最后更新时间：2025-08-21 00:30:08 +0800`
...
1. [n8n-io / self-hosted-ai-starter-kit](https://github.com/n8n-io/self-hosted-ai-starter-kit)
    ...
    - language: **无** &nbsp;&nbsp; stars: **11,592** &nbsp;&nbsp; folks: **2,826**  &nbsp;&nbsp; `157 stars today`
...
1. [DataExpert-io / data-engineer-handbook](https://github.com/DataExpert-io/data-engineer-handbook)
    ...
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **37,050** &nbsp;&nbsp; folks: **7,091**  &nbsp;&nbsp; `111 stars today`

1. [rasbt / LLMs-from-scratch](https://github.com/rasbt/LLMs-from-scratch)
    - Implement a ChatGPT-like LLM in PyTorch from scratch, step by step
    - language: **Jupyter Notebook** &nbsp;&nbsp; stars: **66,122** &nbsp;&nbsp; folks: **9,294**  &nbsp;&nbsp; `513 stars today`
...
1. [epicenter-so / epicenter](https://github.com/epicenter-so/epicenter)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,301** &nbsp;&nbsp; folks: **140**  &nbsp;&nbsp; `298 stars today`

1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **5,082** &nbsp;&nbsp; folks: **204**  &nbsp;&nbsp; `342 stars today`

1. [microsoft / BitNet](https://github.com/microsoft/BitNet)
    - Official inference framework for 1-bit LLMs
    - language: **Python** &nbsp;&nbsp; stars: **20,826** &nbsp;&nbsp; folks: **1,575**  &nbsp;&nbsp; `41 stars today`
...
1. [ubicloud / ubicloud](https://github.com/ubicloud/ubicloud)
    ...
    - language: **Ruby** &nbsp;&nbsp; stars: **9,943** &nbsp;&nbsp; folks: **432**  &nbsp;&nbsp; `3,705 stars this week`
...
1. [PixiEditor / PixiEditor](https://github.com/PixiEditor/PixiEditor)
    - PixiEditor is a Universal Editor for all your 2D needs
    - language: **C#** &nbsp;&nbsp; stars: **5,082** &nbsp;&nbsp; folks: **204**  &nbsp;&nbsp; `1,675 stars this week`

1. [tadata-org / fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)
    - Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!
    - language: **Python** &nbsp;&nbsp; stars: **9,308** &nbsp;&nbsp; folks: **719**  &nbsp;&nbsp; `1,456 stars this week`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **60,589** &nbsp;&nbsp; folks: **7,281**  &nbsp;&nbsp; `3,072 stars this week`

1. [syncthing / syncthing](https://github.com/syncthing/syncthing)
    - Open Source Continuous File Synchronization
    - language: **Go** &nbsp;&nbsp; stars: **75,304** &nbsp;&nbsp; folks: **4,711**  &nbsp;&nbsp; `948 stars this week`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **3,442** &nbsp;&nbsp; folks: **241**  &nbsp;&nbsp; `691 stars this week`
...
1. [coleam00 / Archon](https://github.com/coleam00/Archon)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **9,929** &nbsp;&nbsp; folks: **1,711**  &nbsp;&nbsp; `4,413 stars this month`
...
1. [OpenBB-finance / OpenBB](https://github.com/OpenBB-finance/OpenBB)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **50,705** &nbsp;&nbsp; folks: **4,745**  &nbsp;&nbsp; `7,393 stars this month`
...
1. [musistudio / claude-code-router](https://github.com/musistudio/claude-code-router)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **14,247** &nbsp;&nbsp; folks: **1,056**  &nbsp;&nbsp; `8,128 stars this month`
...
1. [moeru-ai / airi](https://github.com/moeru-ai/airi)
    - 💖🧸 Self hosted, you owned Grok Companion, a container of souls of waifu, cyber livings to bring them into our worlds, wishing to achieve Neuro-sama's altitude. Capable of realtime voice chat, Minecraft, Factorio playing. Web / macOS / Windows supported.
    - language: **Vue** &nbsp;&nbsp; stars: **3,442** &nbsp;&nbsp; folks: **241**  &nbsp;&nbsp; `1,380 stars this month`

1. [hesreallyhim / awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
    - A curated list of awesome commands, files, and workflows for Claude Code
    - language: **Python** &nbsp;&nbsp; stars: **11,705** &nbsp;&nbsp; folks: **629**  &nbsp;&nbsp; `7,218 stars this month`
