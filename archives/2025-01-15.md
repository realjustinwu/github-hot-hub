...
`最后更新时间：2025-01-15 16:27:31 +0800`
...
1. [elizaOS / eliza](https://github.com/elizaOS/eliza)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **11,632** &nbsp;&nbsp; folks: **3,219**  &nbsp;&nbsp; `7,286 stars this month`

1. [Shubhamsaboo / awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps)
    - Collection of awesome LLM apps with AI Agents and RAG using OpenAI, Anthropic, Gemini and opensource models.
    - language: **Python** &nbsp;&nbsp; stars: **12,461** &nbsp;&nbsp; folks: **1,336**  &nbsp;&nbsp; `6,778 stars this month`

1. [khoj-ai / khoj](https://github.com/khoj-ai/khoj)
    - Your AI second brain. Self-hostable. Get answers from the web or your docs. Build custom agents, schedule automations, do deep research. Turn any online or local LLM into your personal, autonomous AI (gpt, claude, gemini, llama, qwen, mistral). Get started - free.
    - language: **Python** &nbsp;&nbsp; stars: **24,530** &nbsp;&nbsp; folks: **1,312**  &nbsp;&nbsp; `7,431 stars this month`

1. [stanford-oval / storm](https://github.com/stanford-oval/storm)
    - An LLM-powered knowledge curation system that researches a topic and generates a full-length report with citations.
    - language: **Python** &nbsp;&nbsp; stars: **20,062** &nbsp;&nbsp; folks: **1,760**  &nbsp;&nbsp; `6,499 stars this month`

1. [cline / cline](https://github.com/cline/cline)
    - Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way.
    - language: **TypeScript** &nbsp;&nbsp; stars: **22,330** &nbsp;&nbsp; folks: **1,936**  &nbsp;&nbsp; `7,701 stars this month`
...
1. [OpenSPG / KAG](https://github.com/OpenSPG/KAG)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **4,195** &nbsp;&nbsp; folks: **261**  &nbsp;&nbsp; `3,348 stars this month`
...
1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **24,903** &nbsp;&nbsp; folks: **1,878**  &nbsp;&nbsp; `6,369 stars this month`
...
1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    ...
    - language: **HTML** &nbsp;&nbsp; stars: **347,643** &nbsp;&nbsp; folks: **62,568**  &nbsp;&nbsp; `6,751 stars this month`
