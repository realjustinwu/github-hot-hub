...
`最后更新时间：2024-12-03 00:30:02 +0800`
...
1. [lobehub / lobe-chat](https://github.com/lobehub/lobe-chat)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **45,897** &nbsp;&nbsp; folks: **10,245**  &nbsp;&nbsp; `235 stars today`

1. [LadybirdBrowser / ladybird](https://github.com/LadybirdBrowser/ladybird)
    - Truly independent web browser
    - language: **C++** &nbsp;&nbsp; stars: **22,854** &nbsp;&nbsp; folks: **1,015**  &nbsp;&nbsp; `349 stars today`
...
1. [Guovin / iptv-api](https://github.com/Guovin/iptv-api)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **6,979** &nbsp;&nbsp; folks: **1,562**  &nbsp;&nbsp; `346 stars today`
...
1. [kestra-io / kestra](https://github.com/kestra-io/kestra)
    ...
    - language: **Java** &nbsp;&nbsp; stars: **13,988** &nbsp;&nbsp; folks: **1,202**  &nbsp;&nbsp; `250 stars today`
...
1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **64,428** &nbsp;&nbsp; folks: **7,856**  &nbsp;&nbsp; `3,369 stars this week`

1. [gitroomhq / postiz-app](https://github.com/gitroomhq/postiz-app)
    - 📨 The ultimate social media scheduling tool, with a bunch of AI 🤖
    - language: **TypeScript** &nbsp;&nbsp; stars: **13,711** &nbsp;&nbsp; folks: **2,391**  &nbsp;&nbsp; `2,573 stars this week`
...
1. [wagoodman / dive](https://github.com/wagoodman/dive)
    ...
    - language: **Go** &nbsp;&nbsp; stars: **48,007** &nbsp;&nbsp; folks: **1,804**  &nbsp;&nbsp; `1,252 stars this week`
...
1. [Guovin / iptv-api](https://github.com/Guovin/iptv-api)
    - 📺IPTV电视直播源更新工具🚀：包含💰央视、📡卫视、☘️广东及各省份地方台、🌊港·澳·台、🎬电影、🎥咪咕、🏀体育、🪁动画、🎮游戏、🎵音乐、🏛经典剧场；支持自定义增加频道；支持组播源、酒店源、订阅源、关键字搜索；每天自动更新两次，结果可用于TVBox等播放软件；支持工作流、Docker(amd64/arm64/arm v7)、命令行、GUI运行方式 | IPTV live TV source update tool
    - language: **Python** &nbsp;&nbsp; stars: **6,979** &nbsp;&nbsp; folks: **1,562**  &nbsp;&nbsp; `622 stars this week`

1. [2dust / v2rayN](https://github.com/2dust/v2rayN)
    - A GUI client for Windows and Linux, support Xray core and others
    - language: **C#** &nbsp;&nbsp; stars: **70,825** &nbsp;&nbsp; folks: **11,659**  &nbsp;&nbsp; `705 stars this week`

1. [unclecode / crawl4ai](https://github.com/unclecode/crawl4ai)
    - 🔥🕷️ Crawl4AI: Crawl Smarter, Faster, Freely. For AI.
    - language: **HTML** &nbsp;&nbsp; stars: **17,582** &nbsp;&nbsp; folks: **1,293**  &nbsp;&nbsp; `874 stars this week`

1. [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books)
    - 📚 Freely available programming books
    - language: **HTML** &nbsp;&nbsp; stars: **340,715** &nbsp;&nbsp; folks: **61,887**  &nbsp;&nbsp; `1,551 stars this week`
...
1. [skills / introduction-to-github](https://github.com/skills/introduction-to-github)
    - Get started using GitHub in less than an hour.
    - language: **无** &nbsp;&nbsp; stars: **5,336** &nbsp;&nbsp; folks: **3,256**  &nbsp;&nbsp; `659 stars this week`

1. [mtdvio / every-programmer-should-know](https://github.com/mtdvio/every-programmer-should-know)
    - A collection of (mostly) technical things every software developer should know about
    - language: **无** &nbsp;&nbsp; stars: **85,266** &nbsp;&nbsp; folks: **7,886**  &nbsp;&nbsp; `1,679 stars this week`
...
1. [abi / screenshot-to-code](https://github.com/abi/screenshot-to-code)
    - Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue)
    - language: **Python** &nbsp;&nbsp; stars: **64,428** &nbsp;&nbsp; folks: **7,856**  &nbsp;&nbsp; `7,118 stars this month`

1. [DS4SD / docling](https://github.com/DS4SD/docling)
    - Get your documents ready for gen AI
    - language: **Python** &nbsp;&nbsp; stars: **11,991** &nbsp;&nbsp; folks: **599**  &nbsp;&nbsp; `11,157 stars this month`

1. [ai16z / eliza](https://github.com/ai16z/eliza)
    - Conversational Agent for Twitter and Discord
    - language: **TypeScript** &nbsp;&nbsp; stars: **2,564** &nbsp;&nbsp; folks: **759**  &nbsp;&nbsp; `2,098 stars this month`
...
1. [twentyhq / twenty](https://github.com/twentyhq/twenty)
    ...
    - language: **TypeScript** &nbsp;&nbsp; stars: **23,800** &nbsp;&nbsp; folks: **2,456**  &nbsp;&nbsp; `6,088 stars this month`
...
1. [exo-explore / exo](https://github.com/exo-explore/exo)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **16,682** &nbsp;&nbsp; folks: **891**  &nbsp;&nbsp; `5,748 stars this month`

1. [CodePhiliaX / Chat2DB](https://github.com/CodePhiliaX/Chat2DB)
    - 🔥🔥🔥AI-driven database tool and SQL client, The hottest GUI client, supporting MySQL, Oracle, PostgreSQL, DB2, SQL Server, DB2, SQLite, H2, ClickHouse, and more.
    - language: **Java** &nbsp;&nbsp; stars: **17,222** &nbsp;&nbsp; folks: **1,927**  &nbsp;&nbsp; `1,690 stars this month`
...
1. [donnemartin / system-design-primer](https://github.com/donnemartin/system-design-primer)
    ...
    - language: **Python** &nbsp;&nbsp; stars: **278,074** &nbsp;&nbsp; folks: **46,586**  &nbsp;&nbsp; `4,467 stars this month`
